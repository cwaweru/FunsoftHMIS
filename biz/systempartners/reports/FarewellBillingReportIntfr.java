 ...
 */
public class FarewellBillingReportIntfr extends javax.swing.JInternalFrame {
     ...
     */
    public FarewellBillingReportIntfr(java.sql.Connection connDb) {
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(com.afrisoftech.lib.ComboBoxModel.ComboBoxModel(connectDB, "select 'Farewell Home' from hp_wards order by 1 limit 1"));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 1;
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
        ...
        jTabbedPane1.addTab("Departmental ", jPanel5);
...
//                            } 
            ...
            Logger.getLogger(FarewellBillingReportIntfr.class.getName()).log(Level.SEVERE, null, ex);
        }
...
//        }
    ...
    private void glsymmaryActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_glsymmaryActionPerformed
        ...
        jTable6.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB, "select service, sum(dosage) as quantity,sum(debit-credit) as amount from hp_patient_card where invoice_no IN \n"
                + "(SELECT DISTINCT invoice_no FROM hp_patient_card WHERE invoice_no ilike 'FW%' and date::date between '" + com.afrisoftech.lib.SQLDateFormat.getSQLDate(beginDatePicker.getDate()) + "' AND '" + com.afrisoftech.lib.SQLDateFormat.getSQLDate(endDatePicker.getDate()) + "' )\n"
                + " and upper(main_service) IN  ( SELECT upper(activity) FROM pb_activity WHERE section_name ilike 'Farewell Home') and service != 'Receipt' GROUP BY 1 having sum(debit-credit) >0 union Select 'Total',0,0 order by 3 desc "));

        for (int p = 0; p < jTable6.getRowCount(); p++) {
            //    System.out.println("Columm total " + p);
            if (jTable6.getValueAt(p, 0).toString().equalsIgnoreCase("Total")) {
                jTable6.setValueAt(com.afrisoftech.lib.CurrencyFormatter.getFormattedDouble(com.afrisoftech.lib.TableColumnTotal.getTableColumnTotal(jTable6, 2)), p, 2);
            }
        }
        /*
    ...
    private void jTable6MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable6MouseClicked
        ...
        if (jTable6.getSelectedColumn() == 0) {
            ...
            if (glsymmary.isSelected()) {
                ...
                jTable1.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB, "select patient_no,service,invoice_no, sum(dosage) as quantity,sum(debit-credit) as amount from hp_patient_card where service ilike '"+jTable6.getValueAt(jTable6.getSelectedRow(), 0)+"' and  invoice_no IN \n"
                        + "(SELECT DISTINCT invoice_no FROM hp_patient_card WHERE   invoice_no ilike 'FW%' and date::date between '" + com.afrisoftech.lib.SQLDateFormat.getSQLDate(beginDatePicker.getDate()) + "' AND '" + com.afrisoftech.lib.SQLDateFormat.getSQLDate(endDatePicker.getDate()) + "' )\n"
                        + " and upper(main_service) IN  ( SELECT upper(activity) FROM pb_activity WHERE section_name ilike 'Farewell Home') and service != 'Receipt' GROUP BY 1 ,2,3 "));

                System.err.println("select patient_no,service,invoice_no, sum(dosage) as quantity,sum(debit-credit) as amount from hp_patient_card where invoice_no IN \n"
                        + "(SELECT DISTINCT invoice_no FROM hp_patient_card WHERE service ilike '"+jTable6.getValueAt(jTable6.getSelectedRow(), 0)+"' and  invoice_no ilike 'FW%' and date::date between '" + com.afrisoftech.lib.SQLDateFormat.getSQLDate(beginDatePicker.getDate()) + "' AND '" + com.afrisoftech.lib.SQLDateFormat.getSQLDate(endDatePicker.getDate()) + "' )\n"
                        + " and upper(main_service) IN  ( SELECT upper(activity) FROM pb_activity WHERE section_name ilike 'Farewell Home') and service != 'Receipt' GROUP BY 1 ,2,3");
            } else {
                ...
                try {
                    ...
                    String[] COLUMNS = new String[deptCount + 7];
...
//                COLUMNS[count + 7] = "INDIVIDUAL CREDITS";
//                COLUMNS[count + 8] = "CORPORATES CREDITS";
                    COLUMNS[count + 3] = "WAIVERS GRANTED";
//                COLUMNS[count + 10] = "EXEMPTED  PATIENTS";
                    COLUMNS[count + 4] = "GRAND TOTAL";
...
//                                    
                                while (rsetTable1c.next()) {
                                    jTable1.setValueAt(rsetTable1c.getString(1), z, p);
                                    total = total + rsetTable1c.getDouble(1);
                                }
                            ...
                            while (rsetTable1c.next()) {
                                jTable1.setValueAt(rsetTable1c.getString(1), z, totalCoulumn + 3);
                                total = total + rsetTable1c.getDouble(1);
                            }
...
//
//                        while (rsetTable1c.next()) {
//                            jTable1.setValueAt(rsetTable1c.getString(1), z, totalCoulumn + 4);
//                            total = total + rsetTable1c.getDouble(1);
//                        }
//
//                        //NHIF LOSS
...
//
//                        while (rsetTable1c.next()) {
//                            jTable1.setValueAt(rsetTable1c.getString(1), z, totalCoulumn + 5);
//                            total = total + rsetTable1c.getDouble(1);
//                        }
//                        
//                        
...
//
//                        while (rsetTable1c.next()) {
//                            jTable1.setValueAt(rsetTable1c.getString(1), z, totalCoulumn + 6);
//                            total = total + rsetTable1c.getDouble(1);
//                        }
//
//                        //Staff Guarantors
...
//
//                        while (rsetTable1c.next()) {
//                            jTable1.setValueAt(rsetTable1c.getString(1), z, totalCoulumn + 7);
//                            total = total + rsetTable1c.getDouble(1);
//                        }
//
//                        //Individual creditors
...
//
//                        while (rsetTable1c.next()) {
//                            jTable1.setValueAt(rsetTable1c.getString(1), z, totalCoulumn + 8);
//                            total = total + rsetTable1c.getDouble(1);
//                        }
//
//                        //Coporate Creditors
//                        rsetTable1c = stmtTable1c.executeQuery("select sum(credit-debit) from hp_patient_card where invoice_no = '" + rsetTable1329.getString(1) + "' and upper(scheme) != upper('WAIVERS BY MANAGEMENT') and upper(scheme) IN (SELECT upper(scheme_name) FROM ac_schemes WHERE payer_name != 'INDIVINDUALS' AND payer_name != 'STAFF GUARANTORS') and transaction_type ='Receipts' ");
//
//                        while (rsetTable1c.next()) {
//                            jTable1.setValueAt(rsetTable1c.getString(1), z, totalCoulumn + 9);
//                            total = total + rsetTable1c.getDouble(1);
//                        }
                            //Waived Patients
...
//                        //Exempetd Patients
//                        rsetTable1c = stmtTable1c.executeQuery("select sum(credit-debit) from hp_patient_card where invoice_no  = '" + rsetTable1329.getString(1) + "'  and upper(main_service) = upper('Exemption')  ");
//
//                        while (rsetTable1c.next()) {
//                            jTable1.setValueAt(rsetTable1c.getString(1), z, totalCoulumn + 11);
//                            total = total + rsetTable1c.getDouble(1);
//                        }
                            jTable1.setValueAt(total, z, totalCoulumn + 5);
                    ...
                    for (int p = 2; p < jTable1.getColumnCount(); p++) {
                        System.out.println("Columm total " + p);
                        jTable1.setValueAt(com.afrisoftech.lib.TableColumnTotal.getTableColumnTotal(jTable1, p), z, p);
                    }
    ...
    private void departmentsymmaryActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_departmentsymmaryActionPerformed
        ...
        try {
            ...
            int count = 1;
            java.sql.Statement stmtTable1cux = connectDB.createStatement();
            java.sql.ResultSet rsetTable1cux = stmtTable1cux.executeQuery(" SELECT COUNT(DISTINCT section_name) FROM pb_activity WHERE (  activity IN (SELECT DISTINCT main_service FROM hp_patient_card WHERE invoice_no ilike 'FW%'    AND  date::date  BETWEEN '" + com.afrisoftech.lib.SQLDateFormat.getSQLDate(beginDatePicker.getDate()) + "' AND '" + com.afrisoftech.lib.SQLDateFormat.getSQLDate(endDatePicker.getDate()) + "' )  ) AND ( activity_category ilike 'I' or activity_category ilike 'PLID' OR category_class ilike 'Bl') ");
            if (!jComboBox1.getSelectedItem().toString().equalsIgnoreCase("-All Wards-")) {
                rsetTable1cux = stmtTable1cux.executeQuery(" SELECT COUNT(DISTINCT section_name) FROM pb_activity WHERE (  activity IN (SELECT DISTINCT main_service FROM hp_patient_card WHERE invoice_no ilike 'FW%'   AND upper(main_service) = upper('" + jComboBox1.getSelectedItem().toString() + "')    AND date::date  BETWEEN '" + com.afrisoftech.lib.SQLDateFormat.getSQLDate(beginDatePicker.getDate()) + "' AND '" + com.afrisoftech.lib.SQLDateFormat.getSQLDate(endDatePicker.getDate()) + "'  )  ) AND  (activity_category ilike 'I' or activity_category ilike 'PLID' OR category_class ilike 'Bl' ) ");
            ...
            String[] COLUMNS = new String[deptCount + 6];
            COLUMNS[0] = "Ward";

            stmtTable1cux = connectDB.createStatement();
            rsetTable1cux = stmtTable1cux.executeQuery(" SELECT DISTINCT section_name from pb_activity WHERE ( activity IN (SELECT DISTINCT main_service FROM hp_patient_card WHERE invoice_no ilike 'FW%'    AND  date::date  BETWEEN '" + com.afrisoftech.lib.SQLDateFormat.getSQLDate(beginDatePicker.getDate()) + "' AND '" + com.afrisoftech.lib.SQLDateFormat.getSQLDate(endDatePicker.getDate()) + "' ) ) AND section_name is not null AND  (activity_category ilike 'I' or activity_category ilike 'PLID' OR category_class ilike 'Bl' ) ");

            if (!jComboBox1.getSelectedItem().toString().equalsIgnoreCase("-All Wards-")) {
                rsetTable1cux = stmtTable1cux.executeQuery(" SELECT DISTINCT section_name from pb_activity WHERE (  activity IN (SELECT DISTINCT main_service FROM hp_patient_card WHERE invoice_no ilike 'FW%'   AND upper(main_service) = upper('" + jComboBox1.getSelectedItem().toString() + "')    AND date::date  BETWEEN '" + com.afrisoftech.lib.SQLDateFormat.getSQLDate(beginDatePicker.getDate()) + "' AND '" + com.afrisoftech.lib.SQLDateFormat.getSQLDate(endDatePicker.getDate()) + "'  ) ) AND section_name is not null AND  (activity_category ilike 'I' or activity_category ilike 'PLID' OR category_class ilike 'Bl' ) ");
...
//            COLUMNS[count + 10] = "EXEMPTED  PATIENTS";
            ...
            if (rsetTable1cu.next()) {
                ...
                if (jComboBox1.getSelectedItem().toString().equalsIgnoreCase("Farewell Home")) {
                    cc = 1;
                }
            ...
            java.sql.Statement stmtTable1329 = connectDB.createStatement();
            java.sql.ResultSet rsetTable1329 = stmtTable1329.executeQuery("SELECT 'Farewell Home' as ward_name order by 1");
//            if (!jComboBox1.getSelectedItem().toString().equalsIgnoreCase("-All Wards-")) {
//                rsetTable1329 = stmtTable1329.executeQuery("select ward_name from hp_wards WHERE ward_name ilike '" + jComboBox1.getSelectedItem().toString() + "' order by ward_name");

            if (jComboBox1.getSelectedItem().toString().equalsIgnoreCase("Farewell Home")) {
                rsetTable1329 = stmtTable1329.executeQuery("select 'Farewell Home' as ward_name ");
...
//                    }
                    ...
                    for (int p = 1; p <= deptCount; p++) {
                        java.sql.ResultSet rsetTable1c = stmtTable1c.executeQuery("select sum(debit-credit) from hp_patient_card where invoice_no IN \n"
                                + "(SELECT DISTINCT invoice_no FROM hp_patient_card WHERE invoice_no ilike 'FW%' and date::date between '" + com.afrisoftech.lib.SQLDateFormat.getSQLDate(beginDatePicker.getDate()) + "' AND '" + com.afrisoftech.lib.SQLDateFormat.getSQLDate(endDatePicker.getDate()) + "' )\n"
                                + " and upper(main_service) IN  ( SELECT upper(activity) FROM pb_activity WHERE section_name ilike '" + jTable6.getColumnName(p) + "') and service != 'Receipt' ");
                        System.err.println("select sum(debit-credit) from hp_patient_card where invoice_no IN \n"
                                + "(SELECT invoice_no FROM hp_admission WHERE ward = '" + rsetTable1329.getString(1) + "' and discharge_date::date between '" + com.afrisoftech.lib.SQLDateFormat.getSQLDate(beginDatePicker.getDate()) + "' AND '" + com.afrisoftech.lib.SQLDateFormat.getSQLDate(endDatePicker.getDate()) + "' )\n"
                                + " and upper(main_service) = upper('" + jTable6.getColumnName(p) + "') ");
...
//                                    
                    ...
                    //Cash Cases
                    java.sql.ResultSet rsetTable1c = stmtTable1c.executeQuery("select sum(credit-debit) from hp_patient_card where "
                            + "( invoice_no IN (SELECT invoice_no FROM  hp_patient_card WHERE 'Farewell Home' = '" + rsetTable1329.getString(1) + "' "
                            + "AND date::date BETWEEN '" + com.afrisoftech.lib.SQLDateFormat.getSQLDate(beginDatePicker.getDate()) + "' "
                            + "AND '" + com.afrisoftech.lib.SQLDateFormat.getSQLDate(endDatePicker.getDate()) + "' and invoice_no ilike 'FW%' ) )"
                            + " and (upper(service) = upper('Receipt') OR upper(service) ilike upper('Deposit on Admission%') )and "
                            + "main_service not ilike '%Invoice%' ");
                    ...
                    /*    //NHIF Cases
                    rsetTable1c = stmtTable1c.executeQuery("select sum(credit-debit) from hp_patient_card where invoice_no IN \n"
                            + "(SELECT invoice_no FROM hp_patient_card WHERE 'Farewell Home' = '" + rsetTable1329.getString(1) + "' and invoice_no ilike 'FW%' and date::date between '" + com.afrisoftech.lib.SQLDateFormat.getSQLDate(beginDatePicker.getDate()) + "' AND '" + com.afrisoftech.lib.SQLDateFormat.getSQLDate(endDatePicker.getDate()) + "' )\n"
                            + " and upper(scheme) ilike upper('%NHIF%')  ");
                    ...
                    //NHIF LOSS
                    rsetTable1c = stmtTable1c.executeQuery("select sum(credit-debit) from hp_patient_card where invoice_no IN \n"
                            + "(SELECT invoice_no FROM hp_patient_card WHERE  invoice_no ilike 'FW%' and  'Farewell Home' = '" + rsetTable1329.getString(1) + "' and date::date between '" + com.afrisoftech.lib.SQLDateFormat.getSQLDate(beginDatePicker.getDate()) + "' AND '" + com.afrisoftech.lib.SQLDateFormat.getSQLDate(endDatePicker.getDate()) + "' )\n"
                            + " and upper(service) = upper('NHIF DIFF ') AND credit>0 ");
                    ...
                    rsetTable1c = stmtTable1c.executeQuery("select sum(credit-debit) from hp_patient_card where invoice_no IN \n"
                            + "(SELECT invoice_no FROM hp_patient_card WHERE  invoice_no ilike 'FW%' and  'Farewell Home' = '" + rsetTable1329.getString(1) + "' and date::date between '" + com.afrisoftech.lib.SQLDateFormat.getSQLDate(beginDatePicker.getDate()) + "' AND '" + com.afrisoftech.lib.SQLDateFormat.getSQLDate(endDatePicker.getDate()) + "' )\n"
                            + " and upper(scheme) not ilike upper('%NHIF%') and upper(scheme) != upper('WAIVERS BY MANAGEMENT') and upper(scheme) IN (SELECT upper(scheme_name) FROM ac_schemes WHERE payer_name != 'INDIVINDUALS' AND payer_name != 'STAFF GUARANTORS') and transaction_type ='Receipts' ");
                    ...
                    jTable6.setValueAt(total, z, totalCoulumn + 5);
    ...
    private void jTable4MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable4MouseClicked
        ...
        if (jTable4.getSelectedColumn() == 1 && jTable4.getSelectedRow() == 0) {
            ...
            for (int l = 0; l < jTable5.getRowCount(); l++) {
                for (int r = 0; r < jTable5.getColumnCount(); r++) {
                    jTable5.getModel().setValueAt(null, l, r);
                }
            }
            String[] COLUMNS = {"", "", "", "", "", "", "", "", ""};
            ...
            try {
                java.sql.Statement stmtTable1cu = connectDB.createStatement();
                java.sql.ResultSet rsetTable1cu = stmtTable1cu.executeQuery("select count(*) from  (select billing_time,service,debit,credit,invoice_no,user_name,patient_no from hp_patient_card where " + query + " ) s");
                //               java.sql.ResultSet rsetTable1cu = stmtTable1cu.executeQuery("select count(*) from (select debit,credit,service,date::date,user_name from hp_patient_card where invoice_no='"+jTable1.getValueAt(jTable1.getSelectedRow(), 0).toString()+"'  order by 3 asc) t");
                if (rsetTable1cu.next()) {
                    loadTable(jTable5, rsetTable1cu.getInt(1) + (jTable4.getRowCount() * 2), COLUMNS);

                }
                //populate
                jTable5.setValueAt(header.toUpperCase(), 0, 0);
                jTable5.setValueAt("DATE", 2, 0);
                jTable5.setValueAt("SERVICE", 2, 1);
                jTable5.setValueAt("DEBIT", 2, 2);
                jTable5.setValueAt("CREDIT", 2, 3);
                jTable5.setValueAt("RUNNING AMT", 2, 4);
                jTable5.setValueAt("INVOICE", 2, 5);
                jTable5.setValueAt("BILLING OFFICER", 2, 6);
                jTable5.setValueAt("PATIENT NO", 2, 7);
                jTable5.setValueAt("PATIENT NAME", 2, 8);
                double runningAmt = 0.0;
                int k = 3;
                for (int h = 3; h < jTable4.getRowCount() - 1; h++) {

                    jTable5.setValueAt(jTable4.getValueAt(h, 0), k, 0);
                    k++;
                    java.sql.Statement stmtTable1c = connectDB.createStatement();
                    java.sql.ResultSet rsetTable1c = stmtTable1c.executeQuery("select billing_time,service,debit,credit,invoice_no,user_name,patient_no from hp_patient_card where " + invoiceString + " and main_service ='" + jTable4.getValueAt(h, 0) + "'order by 1 asc");
                    String user = "", patientName = "";

                    while (rsetTable1c.next()) {
                        jTable5.setValueAt(rsetTable1c.getString(1), k, 0);
                        jTable5.setValueAt(rsetTable1c.getString(2), k, 1);
                        runningAmt = runningAmt + (rsetTable1c.getDouble(3) - rsetTable1c.getDouble(4));
                        System.out.println(runningAmt);
                        jTable5.setValueAt(com.afrisoftech.lib.CurrencyFormatter.getFormattedDouble(rsetTable1c.getDouble(3)), k, 2);
                        jTable5.setValueAt(com.afrisoftech.lib.CurrencyFormatter.getFormattedDouble(rsetTable1c.getDouble(4)), k, 3);
                        jTable5.setValueAt(com.afrisoftech.lib.CurrencyFormatter.getFormattedDouble(runningAmt), k, 4);
                        jTable5.setValueAt(rsetTable1c.getString(5), k, 5);
                        java.sql.Statement pst2v3 = connectDB.createStatement();
                        java.sql.ResultSet rsv3 = pst2v3.executeQuery("select distinct concat(f_name,' ',l_name) as name from secure_menu_access where login_name='" + rsetTable1c.getString(6) + "'");
                        if (rsv3.next()) {
                            user = rsv3.getObject(1).toString();
                        }
                        jTable5.setValueAt(user, k, 6);
                        jTable5.setValueAt(rsetTable1c.getString(7), k, 7);
                        java.sql.Statement pst2 = connectDB.createStatement();
                        java.sql.ResultSet rsv34 = pst2.executeQuery("select distinct patient_name from hp_admission where patient_no='" + rsetTable1c.getString(7) + "'");
                        if (rsv34.next()) {
                            patientName = rsv34.getObject(1).toString();
                        }
                        jTable5.setValueAt(patientName, k, 8);
