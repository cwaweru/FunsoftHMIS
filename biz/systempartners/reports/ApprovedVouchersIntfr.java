 ...
 * @author  funsoft
 */
public class ApprovedVouchersIntfr extends javax.swing.JInternalFrame {
   
    java.sql.Connection connectDB = null;
    
    /** Creates new form ReportIntfr */
    public ApprovedVouchersIntfr(java.sql.Connection connDb) {
        connectDB = connDb;
        initComponents();
      //  loadReport();
    ...
    private void invoice_noKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_invoice_noKeyReleased
        // TODO add your handling code here:
      if(evt.getKeyCode()==java.awt.event.KeyEvent.VK_ENTER){
         openReportBtn.doClick();   
        }
    }//GEN-LAST:event_invoice_noKeyReleased
