 ...
 */
public class AllocationView extends javax.swing.JInternalFrame {
 ...
 java.sql.Connection connectDB = null;
     ...
     */
    public AllocationView(java.sql.Connection connectDb) {
       connectDB = connectDb;
       initComponents();
...
jTable1.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"SELECT date, invoice_no,(SELECT DISTINCT trim(claim_no)"
        + " FROM hp_patient_discharge WHERE hp_patient_discharge.inv_no = ac_debtors.invoice_no LIMIT 1) as claim_no , admission_no as patNo," +
...
"(debit-balance)::numeric as amt_allocated,balance::numeric as NEW_BALANCE,user_name as Generated_By,(select distinct hp_inpatient_register.account_no from hp_inpatient_register where hp_inpatient_register.patient_no =ac_debtors.admission_no  )as member_no FROM ac_debtors WHERE  "
        + " account_no = '"+jTextField4.getText()+"' AND invoice_no!='' AND sent = true AND date between '"+this.datePicker1.getDate().toString()+"'  "
        + "and '"+this.datePicker2.getDate().toString()+"' order by 5 asc "));
       
        System.out.println("SELECT date, invoice_no,(SELECT DISTINCT trim(claim_no) FROM hp_patient_discharge WHERE hp_patient_discharge.inv_no = ac_debtors.invoice_no LIMIT 1) as claim_no , admission_no as patNo," +
"(select DISTINCT upper(patient_name) FROM hp_admission WHERE hp_admission.patient_no = ac_debtors.admission_no ORDER BY 1 DESC LIMIT 1)as patient_name,debit as Invoice_Amt," +
"(debit-balance)::numeric as amt_allocated,balance::numeric as NEW_BALANCE,user_name as Generated_By,(select distinct hp_inpatient_register.account_no from hp_inpatient_register where hp_inpatient_register.patient_no =ac_debtors.admission_no  )as member_no FROM ac_debtors WHERE  "
        + " account_no = '"+jTextField4.getText()+"' AND invoice_no!='' AND sent = true AND date between '"+this.datePicker1.getDate().toString()+"'  "
        + "and '"+this.datePicker2.getDate().toString()+"' order by 5 asc ");
...
"(select DISTINCT upper(patient_name) FROM hp_admission WHERE hp_admission.patient_no = ac_debtors.admission_no ORDER BY 1 DESC LIMIT 1)as patient_name,debit as Invoice_Amt," +
"(debit-balance)::numeric as amt_allocated,balance::numeric as NEW_BALANCE,user_name as Generated_By,(select distinct hp_inpatient_register.account_no from hp_inpatient_register where hp_inpatient_register.patient_no =ac_debtors.admission_no  )as member_no FROM ac_debtors WHERE   account_no = '"+jTextField4.getText()+"' AND invoice_no!='' AND sent = true AND date between '"+this.datePicker1.getDate().toString()+"'  and '"+this.datePicker2.getDate().toString()+"' order by 5 asc "));
...
"(select DISTINCT upper(patient_name) FROM hp_admission WHERE hp_admission.patient_no = ac_debtors.admission_no ORDER BY 1 DESC LIMIT 1)as patient_name,debit as Invoice_Amt," +
"(debit-balance)::numeric as amt_allocated,balance::numeric as NEW_BALANCE,user_name as Generated_By,member_no FROM ac_debtors WHERE   account_no = '"+jTextField4.getText()+"' AND invoice_no!='' AND sent = true AND paid = true  AND date between '"+this.datePicker1.getDate().toString()+"'  and '"+this.datePicker2.getDate().toString()+"' order by 6 asc "));
