 ...
 * @author  root
 */
public class DispatchedInvoicesViewIntfr extends javax.swing.JInternalFrame {
    ...
    public DispatchedInvoicesViewIntfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {
        ...
        //try {
            ...
            jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Select Scheme Here", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(255, 0, 255))); // NOI18N
    ...
    private void jSearchTable11MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jSearchTable11MouseClicked
        ...
        try {
            ...
            System.out.println("SELECT date::date, invoice_no, admission_no,initcap(item) as Name,balance::numeric as balance,sent as Dispatched,"
                        + "(SELECT DISTINCT trim(claim_no) FROM hp_patient_discharge WHERE hp_patient_discharge.inv_no = ac_debtors.invoice_no LIMIT 1) as claim_no "
                        + " FROM ac_debtors "
                        + "WHERE sent=true and "
                ...
                + "AND '"+com.afrisoftech.lib.SQLDateFormat.getSQLDate(endDatePicker.getDate())+"' and "
                        + " account_no = '"+jTextField1.getText()+"'  "
                        + "group by 2,1,3,4,5,sent having sum(debit-credit)>0 order by 4");
          
                
                jTable1.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,""
                        + "SELECT date::date, invoice_no, admission_no,initcap(item) as Name,balance::numeric as balance,sent as Dispatched,"
