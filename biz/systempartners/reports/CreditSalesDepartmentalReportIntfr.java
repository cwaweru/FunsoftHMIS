 ...
 * @author  funsoft
 */
public class CreditSalesDepartmentalReportIntfr extends javax.swing.JInternalFrame {
   
    java.sql.Connection connectDB = null;
    
    /** Creates new form ReportIntfr */
    public CreditSalesDepartmentalReportIntfr(java.sql.Connection connDb) {
        connectDB = connDb;
        initComponents();
      //  loadReport();
    ...
    private void initComponents() {
        ...
        setMaximizable(true);
        setResizable(true);
        setTitle("Funsoft Reporting Module - Departmental Credit Sales per Scheme ");
        try {
            setSelected(true);
        ...
        reportBodyTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Service_GL_Code", "Service Department", "Workload", "Amount"
            }
        ) {
            Class[] types = new Class [] {
    ...
    private void loadReport() {
        ...
        reportBodyTable.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB, "SELECT * FROM public.funsoft_departmental_credit_sales('"+beginDatePicker.getDate()+"','"+endDatePicker.getDate()+"', '"+schemeNameCmbx.getSelectedItem().toString()+"') order by 1"));
