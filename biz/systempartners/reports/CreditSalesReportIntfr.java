 ...
 * @author  funsoft
 */
public class CreditSalesReportIntfr extends javax.swing.JInternalFrame {
   
    java.sql.Connection connectDB = null;
    
    /** Creates new form ReportIntfr */
    public CreditSalesReportIntfr(java.sql.Connection connDb) {
        connectDB = connDb;
        initComponents();
      //  loadReport();
    ...
    private void initComponents() {
        ...
        setMaximizable(true);
        setResizable(true);
        setTitle("Funsoft Report Module - Credit Sales by Debtors");
        try {
            setSelected(true);
    ...
    private void loadReport() {
        ...
        reportBodyTable.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB, "SELECT * FROM funsoft_credit_sales_now('"+beginDatePicker.getDate()+"','"+endDatePicker.getDate()+"') order by 1"));
        
        this.totalCreditSalesTxt.setText(com.afrisoftech.lib.CurrencyFormatter.getFormattedDouble(com.afrisoftech.lib.TableColumnTotal.getTableColumnTotal(reportBodyTable, 1)));
