 ...
 * @author  funsoft
 */
public class GeneratedVouchersIntfr extends javax.swing.JInternalFrame {
   
    java.sql.Connection connectDB = null;
    
    /** Creates new form ReportIntfr */
    public GeneratedVouchersIntfr(java.sql.Connection connDb) {
        connectDB = connDb;
        initComponents();
      //  loadReport();
    ...
    private void initComponents() {
        ...
        setMaximizable(true);
        setResizable(true);
        setTitle("Generated Vouchers Reporter");
        try {
            setSelected(true);
