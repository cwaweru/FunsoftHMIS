 ...
 * @author Charles
 */
public class EyeUnitRegisterReportIntfr extends javax.swing.JInternalFrame {

    java.sql.Connection connectDB = null;
    /**
     * Creates new form EyeUnitRegisterReportIntfr
     */
    public EyeUnitRegisterReportIntfr(java.sql.Connection connDB) {
    ...
    private void generateReportBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_generateReportBtnActionPerformed
        ...
        registerReportTable.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB, "SELECT input_date as visit_date, entry_id,  patient_no, initcap(patient_name) as patient_name, eye_condition as diagnosed_condition,  "
                + "        patient_type,  patient_gender as gender, patient_age, "
                + "       visual_acuity_fraction as best_visual_acuity_fraction, department, data_capture_time::time(0) as service_time, visit_type, "
                + " user_name as clinician FROM public.eye_reporting_conditions WHERE input_date BETWEEN '"+startDatePicker.getDate()+"' AND '"+endDatePicker.getDate()+"' ORDER BY 1"));
