 ...
 * @author Charles
 */
public class TBScreeningProceduresReportIntfr extends javax.swing.JInternalFrame {
     ...
     */
    public TBScreeningProceduresReportIntfr(java.sql.Connection connDB) {
    ...
    private void generateReportBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_generateReportBtnActionPerformed
        ...
        registerReportTable.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB, "SELECT request_time::date as service_date, request_time::time(0) as service_time , data_index as entry_id,  patient_no, initcap(patient_name) as patient_name, requested_procedure,  "
                + " procedure_result, user_name as clinician FROM public.hp_screening_procedures WHERE request_time::date BETWEEN '" + startDatePicker.getDate() + "' AND '" + endDatePicker.getDate() + "' ORDER BY 1"));
