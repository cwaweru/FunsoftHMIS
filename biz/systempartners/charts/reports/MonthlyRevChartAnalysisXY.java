...
public class MonthlyRevChartAnalysisXY {// implements java.lang.Runnable {
    double Credit = 0.00;
    ...
    //private Date endate;
      ...
      public MonthlyRevChartAnalysisXY(java.sql.Connection connDb, java.util.Date beginDate, java.util.Date endate) {  
 //   public void MonthlyRevChart(java.sql.Connection connDb,java.util.Date begindate,java.util.Date endate) {
...
//                                            table.addCell(phrase);
                    ...
                    dataSet.setValue(TotalCount, new String(measuredEntityActivity.toString()), new String("2007"));
                    }
...
//                                table.addCell(phrase);
                System.out.println("Totals for months = ["+columnTotals[x]+"]");
...
//                            docPdf.add(table);
 ...
 /*
  ...
  /
   ...
   // public MonthlyRevChart(java.sql.Connection connectDB, java.util.Date beginDate, java.util.Date endDate) {
   // }
 */
}
