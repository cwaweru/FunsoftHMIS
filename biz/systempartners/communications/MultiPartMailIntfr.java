...
public class MultiPartMailIntfr extends javax.swing.JInternalFrame implements java.lang.Runnable {
    ...
    private void initComponents() {
        ...
        mailcomposerPanel.getContentContainer().setLayout(new java.awt.GridBagLayout());

        mailcomposerPanel.setTitle("Compose your email here");
        mailEditor.setBorder(javax.swing.BorderFactory.createEtchedBorder());
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.fill = java.awt.GridBagConstraints.BOTH;
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
        mailcomposerPanel.getContentContainer().add(mailEditor, gridBagConstraints);
        ...
        attachmentsPanel.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Mail attachments. Click on the space provided below to select files to attach.", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Dialog", 1, 12), new java.awt.Color(0, 0, 204)));
        ...
        sendMailBtn.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Icons/16x16/Email 3.png")));
