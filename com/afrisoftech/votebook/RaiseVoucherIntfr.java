...
//        getListThread = new java.lang.Thread(this, "Update_petty_cash");
    ...
    private void initComponents() {
        ...
        */
        ...
        setMaximizable(true);
        setResizable(true);
        setTitle("Accounts Payable (Expenditure) - Generating a voucher for payment processing");
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Enter payment voucher and supplier details here. The \"Supplier Identity\", \"Invoice No\" must be captured!", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, null, new java.awt.Color(51, 51, 255)));
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Supplier Code", "Ref No", "Invoice No", "Reference Type", "Commitment Type", "Commitment No", "Amount", "Amt To Pay", "Pay"
            }
        ) {
            Class[] types = new Class [] {
                java.lang.Object.class, java.lang.Object.class, java.lang.Object.class, java.lang.Object.class, java.lang.Object.class, java.lang.Object.class, java.lang.Double.class, java.lang.Double.class, java.lang.Boolean.class
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            for (int i = 0; i < jTable1.getRowCount(); i++) {
                if (jTable1.getModel().getValueAt(i, 6) != null && jTable1.getModel().getValueAt(i, 7) != null) {
                    ...
                    pstmt2.setObject(7, supplierNameTxt.getText());
                    ...
                    pstmt2.setObject(23, jTextPane1.getText());
                    pstmt2.executeUpdate();

                    java.sql.PreparedStatement pstmt1q1 = connectDB.prepareStatement("UPDATE ac_accounts_payable set voucher_no = ? WHERE invoice_no = ?");
                    pstmt1q1.setObject(1, vouchNo);
                    pstmt1q1.setObject(2, jTable1.getValueAt(i, 2));
...
// TODO add your handling code here:
    ...
    private void jTextField113CaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextField113CaretUpdate
        if (this.jTextField113.getCaretPosition() < 3) {
            ...
            jSearchTable2.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB, "SELECT DISTINCT invoice_no,supplier,committedon::TIMESTAMP AS date,aie_no, refno as LPO_LSO_NUMBER FROM ac_aie_commitment WHERE refno is not null  and supplier ILIKE '%" + jTextField113.getText() + "%' ORDER BY 1"));
    ...
    private void jSearchTable2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jSearchTable2MouseClicked
        ...
        try {
            ...
            java.sql.ResultSet rsetTable1x = stmtTable1x.executeQuery("SELECT DISTINCT v_class, vote, "
                    ...
                    + " WHERE supplier = '" + supplierNameTxt.getText() + "' AND aie_no = '" + jTextField1.getText() + "'");
...
//            jTextField8.setText("0.00");
        ...
        populateTable1(supplierNameTxt.getText());
    ...
    private void populateTable1(java.lang.String inv_no) {
        ...
        try {
            ...
            java.sql.ResultSet rsetTable1 = stmtTable1.executeQuery("SELECT refno,reftype,comtype,commitno,SUM(allocated_amount-paid_amount),false::boolean,(select invoice_no from ac_accounts_payable where ac_aie_commitment.refno = ac_accounts_payable.order_no) FROM ac_aie_commitment WHERE supplier ILIKE '" + inv_no + "' AND aie_no = '" + jTextField1.getText() + "' AND refno = '"+jSearchTable2.getValueAt(jSearchTable2.getSelectedRow(), 4)+"' GROUP BY 1,2,3,4,7 HAVING SUM(allocated_amount-paid_amount) > 0");
////           java.sql.ResultSet rsetTable1 = stmtTable1.executeQuery("SELECT refno,reftype,comtype,commitno,SUM(allocated_amount-paid_amount),false::boolean,invoice_no FROM ac_aie_commitment WHERE supplier ILIKE '" + inv_no + "' AND aie_no = '" + jTextField1.getText() + "' GROUP BY 1,2,3,4,7 HAVING SUM(allocated_amount-paid_amount) > 0");
