...
public class BudgetBalancePdf implements java.lang.Runnable {
    ...
    private double cumbal_head_amount;
    private double cumexp_head_amount;
String year=null;
    public void BudgetBalancePdf(java.sql.Connection connDb,String years) {
        connectDB = connDb;
      //  beginDate = begindate;
       // endDate = endate;
year=years;
                ...
                try {
                    ...
                    try {
                        ...
                        java.lang.Object[] listofAct2 = this.getListofActivities2();
                            ...
                            int headerwidths[] = {10, 35, 15, 15, 15};
    ...
    System.out.println("nimefika hapa "+i);
                            try {
                                ...
                                table.getDefaultCell().setBorder(Rectangle.BOTTOM);
                                    ...
                                    table.getDefaultCell().setColspan(1);
                                    table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_RIGHT);
                                    phrase = new Phrase("Expenditure" , pFontHeadere);
                                    table.addCell(phrase);
