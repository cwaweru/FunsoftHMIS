...
public class VoteheadPdf implements java.lang.Runnable {
    ...
    public void VoteheadPdf(java.sql.Connection connDb) {
        connectDB = connDb;
      //  beginDate = begindate;
       // endDate = endate;
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    com.lowagie.text.HeaderFooter footer = new com.lowagie.text.HeaderFooter(new Phrase("Voteheads - Page: ", pFontHeader), true);// FontFactory.getFont(com.lowagie.text.FontFactory.HELVETICA, 12, Font.BOLDITALIC,java.awt.Color.blue));
                    ...
                    try {
                       ...
                       // for (int i = 0; i < listofAct2.length; i++) {
                            ...
                            try {
                               ...
                               // java.util.Date endDate1 =Date. dateFormat.parse(Date.toLocaleString());//dateInstance.toLocaleString());

                                table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_CENTER);
                                phrase = new Phrase("VOTEHEADS ", pFontHeader);
...
//                                table.addCell(phrase);
                            ...
                            try {
                                ...
                                java.sql.ResultSet rset11 = st11.executeQuery("SELECT * from heads order by headname asc");
                                ...
                                table.getDefaultCell().setBorder(Rectangle.BOTTOM);
                                    phrase = new Phrase(rset11.getObject("head").toString().toUpperCase()+" - "+ rset11.getObject("headname").toString() , pFontHeader);
...
//                                
                                ...
                                java.sql.ResultSet rset15 = st15.executeQuery("select * from subheads where srccode='" + rset11.getObject("head") + "'");
                                    ...
                                    while (rset15.next()) {
                                        ...
                                        table.addCell(phrase);
                                        table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                                        phrase = new Phrase(rset15.getObject("subheadname").toString(), pFontHeader1);
                                        table.addCell(phrase);
