...
public class OrderAiecommitmentintfr extends javax.swing.JInternalFrame {
    ...
    boolean orderPayments = false;
    boolean imprestPayments = false;
    // java.lang.Thread getListThread;
    // boolean getList;
     Boolean commit_check=false;
    public OrderAiecommitmentintfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
...
//        getListThread = new java.lang.Thread(this, "Update_petty_cash");
    ...
    private void initComponents() {
        ...
        */
        ...
        orderPaymentsChkbx = new javax.swing.JCheckBox();
        ...
        */
        ...
        setMaximizable(true);
        setResizable(true);
        setTitle("Payment Commitment for Orders and Imprest");
        setPreferredSize(new java.awt.Dimension(650, 700));
        setVisible(true);
        getContentPane().setLayout(new java.awt.GridBagLayout());

        jButton1.setMnemonic('O');
        jButton1.setText("Save payment commitment");
        ...
        tableModel = orderPaymentCommitTable.getModel();
        ...
        orderPaymentCommitTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Supplier Code", "Supplier Name", "Invoice No.", "Voucher No.", "Reference Type", "Commitment Type", "Ref. No", "Amount"
            }
        ) {
        ...
        javax.swing.table.TableColumn teditor = this.orderPaymentCommitTable.getColumn("Reference Type");
        ...
        javax.swing.table.TableColumn teditor1 = this.orderPaymentCommitTable.getColumn("Commitment Type");
        ...
        /*try {
            ...
            // crset2.setExecuteOnLoad(true);
            orderPaymentCommitTable.setModel(new org.netbeans.lib.sql.models.TableModel(crset4, new org.netbeans.lib.sql.models.TableModel.Column[] {
    ...
    javax.swing.table.TableColumn column = null;
    for (int i = 0; i < 4; i++) {
        column = orderPaymentCommitTable.getColumnModel().getColumn(i);
        if (i == 0) {
    ...
    */
    ...
    buttonGroup1.add(orderPaymentsChkbx);
    orderPaymentsChkbx.setSelected(true);
    orderPaymentsChkbx.setText("LPO/LSO Payment");
    orderPaymentsChkbx.addActionListener(new java.awt.event.ActionListener() {
        public void actionPerformed(java.awt.event.ActionEvent evt) {
            orderPaymentsChkbxActionPerformed(evt);
        }
    });
    gridBagConstraints = new java.awt.GridBagConstraints();
    gridBagConstraints.gridx = 1;
    ...
    gridBagConstraints.weightx = 1.0;
    gridBagConstraints.weighty = 1.0;
    getContentPane().add(orderPaymentsChkbx, gridBagConstraints);

    buttonGroup1.add(imprestChkbx);
    imprestChkbx.setText("Imprest Payment");
    ...
    gridBagConstraints.weightx = 1.0;
    gridBagConstraints.weighty = 1.0;
    getContentPane().add(imprestChkbx, gridBagConstraints);

    jLabel26.setForeground(new java.awt.Color(0, 0, 255));
    jLabel26.setText("Tick whether Order or Imprest commitments");
    gridBagConstraints = new java.awt.GridBagConstraints();
    gridBagConstraints.gridx = 0;
    gridBagConstraints.gridy = 8;
    gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
    ...
    supplierNameCmbx.setModel(com.afrisoftech.lib.ComboBoxModel.ComboBoxModel(connectDB, "SELECT DISTINCT supplier_name FROM st_suppliers ORDER BY supplier_name"));
    supplierNameCmbx.addActionListener(new java.awt.event.ActionListener() {
        public void actionPerformed(java.awt.event.ActionEvent evt) {
            supplierNameCmbxActionPerformed(evt);
        }
    });
    gridBagConstraints = new java.awt.GridBagConstraints();
    gridBagConstraints.gridx = 1;
    ...
    gridBagConstraints.weightx = 1.0;
    gridBagConstraints.weighty = 1.0;
    getContentPane().add(supplierNameCmbx, gridBagConstraints);

    jLabel28.setText("Supplier Code");
    gridBagConstraints = new java.awt.GridBagConstraints();
    gridBagConstraints.gridx = 4;
    gridBagConstraints.gridy = 9;
    gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
    ...
    documentTargetCmbx.setBorder(javax.swing.BorderFactory.createTitledBorder("Return Target"));
    gridBagConstraints = new java.awt.GridBagConstraints();
    gridBagConstraints.gridx = 0;
    ...
    jButton2.setText("Return to sender");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            for (int i = 0; i < orderPaymentCommitTable.getRowCount(); i++) {
                if ((orderPaymentCommitTable.getModel().getValueAt(i, 2) != null)) {
                    java.sql.PreparedStatement pstmt2 = connectDB.prepareStatement("INSERT INTO ac_aie_commitment("
                            ...
                            + "donorcode, donoritem, commited_by, aie_no,cleared,commitno, invoice_no)"
                            + "VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?,"
                            + "?, ?, ?, ?, ?, ?, ?)");
                    ...
                    pstmt2.setObject(7, orderPaymentCommitTable.getValueAt(i, 1));
                    pstmt2.setObject(8, orderPaymentCommitTable.getValueAt(i, 4));
                    pstmt2.setObject(9, orderPaymentCommitTable.getValueAt(i, 2));
                    pstmt2.setTimestamp(10, new java.sql.Timestamp(java.util.Calendar.getInstance().getTimeInMillis()));
                    pstmt2.setDouble(11, java.lang.Double.valueOf(orderPaymentCommitTable.getValueAt(i, 5).toString()));
                    pstmt2.setDouble(12, java.lang.Double.valueOf(orderPaymentCommitTable.getValueAt(i, 6).toString()));
                    ...
                    pstmt2.setObject(20, orderPaymentCommitTable.getValueAt(i, 2));
                    pstmt2.execute();
    ...
    private void orderPaymentCommitTableKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_orderPaymentCommitTableKeyReleased
        if (this.orderPaymentsChkbx.isSelected()) {
...
// if (jTable1.getModel().getValueAt(jTable1.getSelectedRow(), 2) == null && !(jTable1.getModel().getValueAt(jTable1.getSelectedRow(), 0).toString().equalsIgnoreCase(questmark))) {
                if (orderPaymentCommitTable.getModel().isCellEditable(orderPaymentCommitTable.getSelectedRow(), 0)) {
                    if (orderPaymentCommitTable.getModel().isCellEditable(orderPaymentCommitTable.getSelectedRow(), 0) && !(orderPaymentCommitTable.getModel().getValueAt(orderPaymentCommitTable.getSelectedRow(), 0).toString().equalsIgnoreCase(questmark))) {
                        try {
                            ...
                            java.sql.ResultSet rs1x = pstmtx.executeQuery("SELECT supplier_name FROM st_suppliers WHERE code ILIKE '" + orderPaymentCommitTable.getValueAt(orderPaymentCommitTable.getSelectedRow(), 0) + "'");

                            while (rs1x.next()) {
                                orderPaymentCommitTable.setValueAt(rs1x.getObject(1), orderPaymentCommitTable.getSelectedRow(), 1);
                            ...
                            //}else{
                            orderPaymentCommitTable.editCellAt(orderPaymentCommitTable.getSelectedRow(), 4);
                            //}
                        } catch (java.sql.SQLException sq) {
                            javax.swing.JOptionPane.showMessageDialog(this, sq.getMessage(), "Error Message!", javax.swing.JOptionPane.ERROR_MESSAGE);
                    ...
                    if (orderPaymentCommitTable.getModel().getValueAt(orderPaymentCommitTable.getSelectedRow(), 7) != null) {
                        double totalSum = com.afrisoftech.lib.TableColumnTotal.getTableColumnTotal(orderPaymentCommitTable, 7);
                        ...
                        if (totalSum <= aieBal) {
                            ...
                            orderPaymentCommitTable.setValueAt(0, orderPaymentCommitTable.getSelectedRow(), 7);
                        }
                    }
                }
            }
                ...
                if (orderPaymentCommitTable.getModel().isCellEditable(orderPaymentCommitTable.getSelectedRow(), 0)) {
                    if (orderPaymentCommitTable.getModel().isCellEditable(orderPaymentCommitTable.getSelectedRow(), 0) && !(orderPaymentCommitTable.getModel().getValueAt(orderPaymentCommitTable.getSelectedRow(), 0).toString().equalsIgnoreCase(questmark))) {
                        try {
                            java.sql.Statement pstmtx = connectDB.createStatement();
                            // java.sql.ResultSet rs1x = pstmtx.executeQuery("SELECT product_id,product, strength,round(selling_price, 0) as selling_price, units FROM stockprices WHERE product_id ILIKE '" + jTable13.getValueAt(jTable13.getSelectedRow(), 0) + "'");
                            java.sql.ResultSet rs1x = pstmtx.executeQuery("SELECT first_name||' '||second_name||' '||others FROM hr.hr_staffresume_fileinfo WHERE code staff_id '" + orderPaymentCommitTable.getValueAt(orderPaymentCommitTable.getSelectedRow(), 0) + "'");
                            ...
                            //}else{
                            orderPaymentCommitTable.editCellAt(orderPaymentCommitTable.getSelectedRow(), 6);
                            //}
                        } catch (java.sql.SQLException sq) {
                            javax.swing.JOptionPane.showMessageDialog(this, sq.getMessage(), "Error Message!", javax.swing.JOptionPane.ERROR_MESSAGE);
...
// TODO add your handling code here:
    ...
    private void jTextField114CaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextField114CaretUpdate
        ...
        if (orderPayments) {
            if (jTextField114.getCaretPosition() > 1) {
                jSearchTable3.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB, "SELECT code,supplier_name, (select invoice_no from ac_accounts_payable where ac_accounts_payable.dealer = st_suppliers.supplier_name and credit-debit > 0), (select voucher_no from ac_accounts_payable where ac_accounts_payable.dealer = st_suppliers.supplier_name and credit-debit > 0) FROM st_suppliers WHERE supplier_name ILIKE '%" + jTextField114.getText() + "%'"));
            ...
            if (jTextField114.getCaretPosition() > 1) {
                jSearchTable3.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB, "SELECT staff_id, first_name||' '||second_name||' '||others FROM hr.hr_staffresume_fileinfo WHERE staff_id ILIKE '%" + jTextField114.getText() + "%'"));
    ...
    private void jSearchTable3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jSearchTable3MouseClicked
        ...
        orderPaymentCommitTable.setValueAt(jSearchTable3.getValueAt(jSearchTable3.getSelectedRow(), 0), orderPaymentCommitTable.getSelectedRow(), 0);
        orderPaymentCommitTable.setValueAt(jSearchTable3.getValueAt(jSearchTable3.getSelectedRow(), 1), orderPaymentCommitTable.getSelectedRow(), 1);
...
//            rss.close();
    ...
    private void orderPaymentsChkbxActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_orderPaymentsChkbxActionPerformed

        this.orderPayments = true;

        this.imprestPayments = false;
        // TODO add your handling code here:
    }//GEN-LAST:event_orderPaymentsChkbxActionPerformed

    private void imprestChkbxActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_imprestChkbxActionPerformed

        this.imprestPayments = true;
        
        this.orderPayments = false;

        // TODO add your handling code here:
    }//GEN-LAST:event_imprestChkbxActionPerformed

    private void supplierNameCmbxActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_supplierNameCmbxActionPerformed
        try {
            commit_check=true;
            java.sql.PreparedStatement pstmt = connectDB.prepareStatement("SELECT code FROM st_suppliers WHERE supplier_name = ?");
            pstmt.setString(1, supplierNameCmbx.getSelectedItem().toString());
            java.sql.ResultSet rsetCode = pstmt.executeQuery();
            while(rsetCode.next()){
                supplierCodeTxt.setText(rsetCode.getString(1));
            }
          
            this.orderPaymentCommitTable.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB, "SELECT DISTINCT '"+supplierCodeTxt.getText()+"' as supplier_name, '"+supplierNameCmbx.getSelectedItem().toString()+"' as supplier_code, invoice_no, voucher_no, date as GRN_date,credit as Invoice_Amount,0.00 as Amount_Comitted,false as Commit FROM ac_accounts_payable WHERE voucher_no is not null and invoice_no is not null and invoice_no != '' and voucher_no != '' and credit-debit > 0 AND dealer = '"+supplierNameCmbx.getSelectedItem().toString()+"'"));
        } catch (SQLException ex) {
            Logger.getLogger(OrderAiecommitmentintfr.class.getName()).log(Level.SEVERE, null, ex);
        }
        
        
        
        // TODO add your handling code here:
    }//GEN-LAST:event_supplierNameCmbxActionPerformed
    ...
    private void orderPaymentCommitTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_orderPaymentCommitTableMouseClicked
        //the late modifications done 11/12/2013
        if(commit_check=true){
        Boolean tester=(Boolean) orderPaymentCommitTable.getModel().getValueAt(orderPaymentCommitTable.getSelectedRow(), 7);
        if(tester==true){
        orderPaymentCommitTable.getModel().setValueAt(orderPaymentCommitTable.getModel().getValueAt(orderPaymentCommitTable.getSelectedRow(), 5),orderPaymentCommitTable.getSelectedRow(),6);
        
        }
        else{
         orderPaymentCommitTable.getModel().setValueAt(0.0,orderPaymentCommitTable.getSelectedRow(),6);
        }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        com.afrisoftech.lib.DocumentTracer.setDocumentLocation(connectDB, orderPaymentCommitTable.getValueAt(orderPaymentCommitTable.getSelectedRow(), 3).toString(), commentsTxt.getText(), "EXPENDITURE_VOTEBOOK", documentTargetCmbx.getSelectedItem().toString());
    ...
    public void tableModelTableChanged(javax.swing.event.TableModelEvent evt) {
        ...
        for (int j = 0; j < orderPaymentCommitTable.getRowCount(); j++) {

            System.out.println(orderPaymentCommitTable.getModel().getValueAt(j, 8).toString());

            if (Boolean.valueOf(orderPaymentCommitTable.getModel().getValueAt(j, 8).toString()) == java.lang.Boolean.FALSE) {

                totals = totals - Double.parseDouble(orderPaymentCommitTable.getModel().getValueAt(j, 6).toString());
    ...
    private javax.swing.JCheckBox orderPaymentsChkbx;
