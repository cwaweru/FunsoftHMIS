 ...
 * @author  root
 */
public class DeliveryTypeIntfr extends javax.swing.JInternalFrame {
    ...
    public DeliveryTypeIntfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {
        ...
        setIconifiable(true);
        setTitle("Types of delivery setup");
        ...
        jButton1.setText("Register types of delivery");
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Enter types of delivery & code here"));
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Delivery type code", "Delivery type description"
            }
        ));
...
// TODO add your handling code here:
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        try{
            ...
            java.sql.PreparedStatement pstmt31 = connectDB.prepareStatement("DELETE from rh.delivery_type WHERE delivery_type_code = '"+jTable1.getModel().getValueAt(jTable1.getSelectedRow(),0).toString()+"'");
            ...
            for (int i = 0; i < jTable1.getRowCount(); i++){
                if (jTable1.getModel().getValueAt(i,0) != null){
                    if(jButton1.getText().equalsIgnoreCase("Update")){
                        java.sql.PreparedStatement pstmt311 = connectDB.prepareStatement("UPDATE rh.delivery_type SET delivery_type_desc = '"+jTable1.getValueAt(i,1).toString()+"' WHERE delivery_type_code = '"+jTable1.getValueAt(i,0).toString()+"'");
                        pstmt311.executeUpdate();
                    }else{
                        java.sql.PreparedStatement pstmt1 = connectDB.prepareStatement("insert into rh.delivery_type values(?,initcap(?))");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        int i = 0;
        jTable1.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"select delivery_type_code,delivery_type_desc from rh.delivery_type ORDER BY delivery_type_desc"));
