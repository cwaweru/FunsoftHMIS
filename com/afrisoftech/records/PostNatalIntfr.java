 ...
 * @author  root
 */
public class PostNatalIntfr extends javax.swing.JInternalFrame {
    ...
    public PostNatalIntfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {
        ...
        jButton1.setText("Register Exam.Details");
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Set Post Natal Parameters Here"));
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Examination code", "Examination  Description"
            }
        ));
            ...
            for (int i = 0; i < jTable1.getRowCount(); i++){
                if (jTable1.getModel().getValueAt(i,0) != null){
                    if(jButton1.getText().equalsIgnoreCase("Update")){
                        java.sql.PreparedStatement pstmt311 = connectDB.prepareStatement("UPDATE post_natal_exam_setup SET  examination  = '"+jTable1.getValueAt(i,1).toString()+"' WHERE exam_code  = '"+jTable1.getValueAt(i,0).toString()+"'");
                        pstmt311.executeUpdate();
                    }else{
                        java.sql.PreparedStatement pstmt1 = connectDB.prepareStatement("insert into post_natal_exam_setup values(?,?)");
