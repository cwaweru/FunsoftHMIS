 ...
 * @author  root
 */
public class PatientDiagEditIntfr extends javax.swing.JInternalFrame {

    private javax.swing.JComboBox cmbox;
    java.sql.Connection connectDB = null;
    org.netbeans.lib.sql.pool.PooledConnectionSource pConnDB = null;

    public PatientDiagEditIntfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {
        ...
        */
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                " Disease Code", "Description", "Original Code"
            }
        ) {
        ...
        for (int i = 0; i < 3; i++) {
            column3 = jTable1.getColumnModel().getColumn(i);
            if (i == 1) {
        ...
        jComboBox4.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Discharge", "Died", "Transferred", "Abscond" }));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 4;
        gridBagConstraints.gridy = 4;
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
        ...
        jComboBox5.setModel(com.afrisoftech.lib.ComboBoxModel.ComboBoxModel(connectDB, "SELECT depart_name FROM pb_main_department ORDER BY 1"));
        ...
        jLabel21.setText("File Location");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 3;
        gridBagConstraints.gridy = 6;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        ...
        setBounds(0, 0, 856, 483);
    }// </editor-fold>//GEN-END:initComponents

    private void jComboBox5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBox5ActionPerformed
        jComboBox6.setModel(com.afrisoftech.lib.ComboBoxModel.ComboBoxModel(connectDB, "SELECT shelve_code, number_of_files  FROM rh.hp_records_archive WHERE department_name = '" + jComboBox5.getSelectedItem() + "' AND number_of_files > stored_files ORDER BY shelve_code ASC LIMIT 1"));
...
// TODO add your handling code here:
    ...
    private void jSearchTable2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jSearchTable2MouseClicked
        ...
        jTable1.setValueAt(jSearchTable2.getValueAt(jSearchTable2.getSelectedRow(), 0), jTable1.getSelectedRow(), 1);
        jTable1.setValueAt(jSearchTable2.getValueAt(jSearchTable2.getSelectedRow(), 1), jTable1.getSelectedRow(), 0);
    ...
    private void jTextField1112CaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextField1112CaretUpdate
        ...
        if (jRadioButton2.isSelected()) {
            ...
            if (jTextField1112.getCaretPosition() > 2) {
                jSearchTable2.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB, "SELECT (upper(disease_name)) as name,code from hp_diseases where code ILIKE '" + jTextField1112.getText() + "%' ORDER BY code"));
    ...
    private void jSearchTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jSearchTableMouseClicked
        ...
        try {
            ...
            datePicker2.setDate(sdf.parse(jSearchTable.getValueAt(jSearchTable.getSelectedRow(), 2).toString()));
            datePicker3.setDate(sdf.parse(jSearchTable.getValueAt(jSearchTable.getSelectedRow(), 3).toString()));
        ...
        try {
            if (jCheckBox2.isSelected()) {
                ...
                java.sql.ResultSet rset1 = stmt1.executeQuery("SELECT pat_age,gender,ward,marital_status,visit_id FROM hp_admission WHERE patient_no ='" + jTextField36.getText() + "' "
                        + "AND date_admitted = '" + datePicker2.getDate() + "' AND discharge_date::date = '" + datePicker3.getDate() + "'");
                while (rset1.next()) {
                    ...
                    jTextField7.setText(rset1.getObject(5).toString());
                    // java.text.DateFormat df = java.text.DateFormat.getDateInstance();
                    //java.text.SimpleDateFormat sdf = (java.text.SimpleDateFormat) df;
                ...
                java.sql.ResultSet rsetTable1r = stmtTable1r.executeQuery("SELECT main_service,disease,admission_outcome FROM hp_patient_diagnosis WHERE patient_no ='" + jTextField36.getText() + "' "
                        + "AND date_admitted = '" + datePicker2.getDate() + "' AND  date_discharged::date = '" + datePicker3.getDate() + "'");


                while (rsetTable1r.next()) {

                    jTable1.setValueAt(rsetTable1r.getObject(1), p, 0);
                    jTable1.setValueAt(rsetTable1r.getObject(2), p, 1);
                    jTable1.setValueAt(rsetTable1r.getObject(1), p, 2);
                    jComboBox4.setSelectedItem(rsetTable1r.getObject(3));
                    // jTable1.setValueAt(rsetTable1r.getObject(3), p, 2);
                    //jTable1.setValueAt(rsetTable1r.getObject(5), p, 4);
    ...
    private void jTextField111CaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextField111CaretUpdate
        ...
        if (this.jCheckBox2.isSelected() && this.jCheckBox31.isSelected()) {
            ...
            if (jTextField111.getCaretPosition() < 3) {
                ...
                jSearchTable.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB, "SELECT DISTINCT patient_no, patient_name as name,date_admitted,date_discharged FROM hp_patient_diagnosis WHERE patient_no ILIKE '" + jTextField111.getText() + "%' AND pat_category = 'IP' order by patient_no"));
            ...
            if (this.jCheckBox2.isSelected() && this.jCheckBox4.isSelected()) {
                jSearchTable.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB, "SELECT DISTINCT patient_no, patient_name as name,date_admitted,date_discharged FROM hp_patient_diagnosis WHERE patient_name ILIKE '%" + jTextField111.getText() + "%' AND pat_category = 'IP' ORDER BY patient_name"));
            ...
            if (jTextField1.getText().equalsIgnoreCase("") || jTextField1.getText().equalsIgnoreCase(" ")) {
                ...
                for (int i = 0; i < jTable1.getRowCount(); i++) {
                    if (jTable1.getModel().getValueAt(i, 1) != null) {
                        /*java.sql.ResultSet rset24 = stm121.executeQuery("SELECT COUNT(main_service) FROM hp_patient_diagnosis WHERE patient_no = '" + jTextField36.getText() + "' AND main_service = '" + jTable1.getValueAt(i, 0).toString() + "' AND date_recorded = '" + datePicker11.getDate() + "'");
                        while (rset24.next()) {
                        ...
                        if (diagnosed > 0) {
                            ...
                            java.sql.ResultSet rss = sts.executeQuery("SELECT drug_time_limit FROM hp_diseases WHERE code = '" + jTable1.getValueAt(i, 0) + "'");
                            while (rss.next()) {
                                categ = rss.getString(1);
                            }
                            java.sql.PreparedStatement pstmt = connectDB.prepareStatement("UPDATE hp_patient_diagnosis SET "
                                    + "main_service = ?, disease = ?, admission_outcome = ?, date_discharged = ?, length_of_stay = ? "
                                    + "WHERE patient_no = '" + jTextField36.getText() + "'"
                                    + "AND date_admitted = '" + datePicker2.getDate() + "'"
                                    + "AND main_service = '" + jTable1.getValueAt(i, 2).toString() + "'");
                            ...
                            pstmt.setDate(4, com.afrisoftech.lib.SQLDateFormat.getSQLDate(datePicker3.getDate()));
                            pstmt.setInt(5, incDays);
                            pstmt.executeUpdate();
                        }
                    }
                //}
                if (jCheckBox2.isSelected()) {
                    ...
                    java.sql.PreparedStatement pstmt21 = connectDB.prepareStatement("UPDATE hp_admission SET discharge = true,diagnosed = true,discharge_date = '" + datePicker3.getDate().toString() + "',discharged_by = current_user,transaction_type = '" + jComboBox4.getSelectedItem() + "', diagnosis1 = '" + jTable1.getValueAt(0, 1) + "',diagnosis2 = '" + jTable1.getValueAt(1, 1) + "',diagnosis3 = '" + jTable1.getValueAt(2, 1) + "' WHERE patient_no ilike '" + jTextField36.getText() + "' AND visit_id ilike '" + jTextField7.getText() + "'");
