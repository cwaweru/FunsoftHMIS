 ...
 * @author  root
 */
public class PlaceofDeliveryIntfr extends javax.swing.JInternalFrame {
    ...
    public PlaceofDeliveryIntfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {
        ...
        setIconifiable(true);
        setTitle("Places of child delivery setup form");
        ...
        jButton1.setText("Register places of delivery");
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Enter place of delivery description & code here"));
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Delivery place code", "Delivery place description"
            }
        ));
...
// TODO add your handling code here:
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        try{
            ...
            java.sql.PreparedStatement pstmt31 = connectDB.prepareStatement("DELETE from rh.place_of_delivery WHERE delivery_place_code = '"+jTable1.getModel().getValueAt(jTable1.getSelectedRow(),0).toString()+"'");
            ...
            for (int i = 0; i < jTable1.getRowCount(); i++){
                if (jTable1.getModel().getValueAt(i,0) != null){
                    if(jButton1.getText().equalsIgnoreCase("Update")){
                        java.sql.PreparedStatement pstmt311 = connectDB.prepareStatement("UPDATE rh.place_of_delivery SET delivery_place_desc = '"+jTable1.getValueAt(i,1).toString()+"' WHERE delivery_place_code = '"+jTable1.getValueAt(i,0).toString()+"'");
                        pstmt311.executeUpdate();
                    }else{
                        java.sql.PreparedStatement pstmt1 = connectDB.prepareStatement("insert into rh.place_of_delivery values(?,initcap(?))");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        int i = 0;
        jTable1.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"select delivery_place_code,delivery_place_desc from rh.place_of_delivery ORDER BY delivery_place_desc"));
