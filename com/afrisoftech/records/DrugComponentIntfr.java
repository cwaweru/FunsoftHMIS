 ...
 * @author root
 */
public class DrugComponentIntfr extends javax.swing.JInternalFrame {
    ...
    public DrugComponentIntfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {
        ...
        jButton1.setText("Register Drug Component");
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Drug Component"));
...
// TODO add your handling code here:
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        try {
            ...
            java.sql.PreparedStatement pstmt31 = connectDB.prepareStatement("DELETE from hp_drug_components WHERE id = '" + jTable1.getModel().getValueAt(jTable1.getSelectedRow(), 4).toString() + "'  ");
            ...
            for (int i = 0; i < jTable1.getRowCount(); i++) {
                if (jTable1.getModel().getValueAt(i, 0) != null) {
                    if (jButton1.getText().equalsIgnoreCase("Update")) {
                        java.sql.PreparedStatement pstmt311 = connectDB.prepareStatement("UPDATE hp_drug_components SET description = '" + jTable1.getValueAt(i, 0).toString() + "', component = '" + jTable1.getValueAt(i, 1).toString() + "' WHERE id = '" + jTable1.getValueAt(i, 4).toString() + "'   ");
                        pstmt311.executeUpdate();
                    } else {
                        java.sql.PreparedStatement pstmt1 = connectDB.prepareStatement("INSERT INTO hp_drug_components("
                                + "             description, component )"
                                + "    VALUES (?, ?)");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        int i = 0;
        jTable1.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB, "select description,component, user_name,input_date,id from hp_drug_components order by 1  ; "));
