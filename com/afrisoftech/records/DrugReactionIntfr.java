 ...
 * @author root
 */
public class DrugReactionIntfr extends javax.swing.JInternalFrame {
    ...
    public DrugReactionIntfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {
        ...
        jButton1.setText("Register Drug Reaction");
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Drug Reaction"));
...
// TODO add your handling code here:
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        try {
            ...
            java.sql.PreparedStatement pstmt31 = connectDB.prepareStatement("DELETE from hp_drug_reactions WHERE id = '" + jTable1.getModel().getValueAt(jTable1.getSelectedRow(), 4).toString() + "' ");
            ...
            for (int i = 0; i < jTable1.getRowCount(); i++) {
                if (jTable1.getModel().getValueAt(i, 0) != null) {
                    if (jButton1.getText().equalsIgnoreCase("Update")) {
                        java.sql.PreparedStatement pstmt311 = connectDB.prepareStatement("UPDATE hp_drug_reactions SET description = '" + jTable1.getValueAt(i, 0).toString() + "', reacting_item = '" + jTable1.getValueAt(i, 1).toString() + "' WHERE id = '" + jTable1.getValueAt(i, 4).toString() + "'  ");
                        pstmt311.executeUpdate();
                    } else {
                        java.sql.PreparedStatement pstmt1 = connectDB.prepareStatement("INSERT INTO hp_drug_reactions("
                                + "             description,reaction_type, reacting_item )"
                                + "    VALUES (?, 'Drug Interaction',?)");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        int i = 0;
        jTable1.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB, "select description,reacting_item, user_name,trans_time,id from hp_drug_reactions order by 1  ; "));
