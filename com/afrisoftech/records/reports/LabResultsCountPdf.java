                    ...
                    try {
                        ...
                        try {
                            ...
                            for (int i = 0; i < listofAct.length; i++) {
                                ...
                                java.sql.ResultSet rset = st.executeQuery("SELECT  count(DISTINCT patient_no) FROM hp_lab_results WHERE typeof_test ilike '" + listofAct[i] + "' AND date BETWEEN '" + beginDate + "' AND '" + endDate + "' AND age < 5 AND (out_come ILIKE '%posit%' OR out_come ILIKE '%+%')");
                                java.sql.ResultSet rset1 = st1.executeQuery("SELECT count(DISTINCT patient_no) FROM hp_lab_results WHERE typeof_test ilike '" + listofAct[i] + "' AND date BETWEEN '" + beginDate + "' AND '" + endDate + "' AND age >= 5 AND age < 15 AND (out_come ILIKE '%posit%' OR out_come ILIKE '%+%')");
                                java.sql.ResultSet rset2 = st2.executeQuery("SELECT count(DISTINCT patient_no) FROM hp_lab_results WHERE typeof_test ilike '" + listofAct[i] + "' AND date BETWEEN '" + beginDate + "' AND '" + endDate + "' AND age >= 15 AND (out_come ILIKE '%posit%' OR out_come ILIKE '%+%')");


                                java.sql.ResultSet rsetd = std.executeQuery("SELECT count(DISTINCT patient_no) FROM hp_lab_results WHERE typeof_test ilike '" + listofAct[i] + "' AND date BETWEEN '" + beginDate + "' AND '" + endDate + "' AND age < 5 AND (out_come NOT ILIKE '%posit%' OR out_come NOT ILIKE '%+%')");
                                java.sql.ResultSet rset1d = st1d.executeQuery("SELECT count(DISTINCT patient_no) FROM hp_lab_results WHERE typeof_test ilike '" + listofAct[i] + "' AND date BETWEEN '" + beginDate + "' AND '" + endDate + "' AND age >= 5 AND age < 15 AND (out_come NOT ILIKE '%posit%' OR out_come NOT ILIKE '%+%')");
                                java.sql.ResultSet rset2d = st2d.executeQuery("SELECT count(DISTINCT patient_no) FROM hp_lab_results WHERE typeof_test ilike '" + listofAct[i] + "' AND date BETWEEN '" + beginDate + "' AND '" + endDate + "' AND age >= 15 AND (out_come NOT ILIKE '%posit%' OR out_come NOT ILIKE '%+%')");
