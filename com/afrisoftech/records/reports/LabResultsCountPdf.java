...
public class LabResultsCountPdf implements java.lang.Runnable {
    ...
    public void LabResultsCountPdf(java.sql.Connection connDb, java.util.Date begindate, java.util.Date endate) {
                ...
                try {
                   ...
                   // //Image imgWaterMark = Image.getInstance(System.getProperty("company.watermark"));
                    ...
                    try {
                        ...
                        int headerwidths[] = {5, 7, 30, 5, 5, 5, 5, 5, 5, 5, 5, 2, 3};
                        ...
                        try {
                            ...
                            phrase = new Phrase("LAB RESULTS SUMMARY SHEET", pFontHeader2);
                            ...
                            phrase = new Phrase(">14", pFontHeader11);
                            table.addCell(phrase);
                            ...
                            table.getDefaultCell().setColspan(3);
                            phrase = new Phrase("STATUS OF RESULTS", pFontHeader11);
                            table.addCell(phrase);

                            table.getDefaultCell().setColspan(1);

                            phrase = new Phrase("+Ve", pFontHeader11);
                            table.addCell(phrase);
                            ...
                            //table.addCell(phrase);
                            table.getDefaultCell().setColspan(2);
                            phrase = new Phrase("TEST", pFontHeader11);
                            table.addCell(phrase);
                            table.getDefaultCell().setColspan(1);
                        ...
                        try {
                            ...
                            for (int i = 0; i < listofAct.length; i++) {
                                ...
                                java.sql.ResultSet rsetf = stf.executeQuery("SELECT DISTINCT typeof_test FROM hp_lab_results WHERE typeof_test ilike '" + listofAct[i] + "' AND date BETWEEN '" + beginDate + "' AND '" + endDate + "'");

                                java.sql.ResultSet rset = st.executeQuery("SELECT  count(DISTINCT patient_no) FROM hp_lab_results WHERE typeof_test ilike '" + listofAct[i] + "' AND date BETWEEN '" + beginDate + "' AND '" + endDate + "' AND age < 5 AND (out_come ILIKE '%posit%' OR out_come ILIKE '%+%' OR out_come NOT ILIKE '%NO MPS%'  )");
                                java.sql.ResultSet rset1 = st1.executeQuery("SELECT count(DISTINCT patient_no) FROM hp_lab_results WHERE typeof_test ilike '" + listofAct[i] + "' AND date BETWEEN '" + beginDate + "' AND '" + endDate + "' AND age >= 5 AND age < 15 AND (out_come ILIKE '%posit%' OR out_come ILIKE '%+%' OR out_come NOT ILIKE '%NO MPS%' )");
                                java.sql.ResultSet rset2 = st2.executeQuery("SELECT count(DISTINCT patient_no) FROM hp_lab_results WHERE typeof_test ilike '" + listofAct[i] + "' AND date BETWEEN '" + beginDate + "' AND '" + endDate + "' AND age >= 15 AND (out_come ILIKE '%posit%' OR out_come ILIKE '%+%' OR out_come NOT ILIKE '%NO MPS%' )");


                                java.sql.ResultSet rsetd = std.executeQuery("SELECT count(DISTINCT patient_no) FROM hp_lab_results WHERE typeof_test ilike '" + listofAct[i] + "' AND date BETWEEN '" + beginDate + "' AND '" + endDate + "' AND age < 5 AND (out_come NOT ILIKE '%posit%' OR out_come NOT ILIKE '%+%' OR out_come  ILIKE '%NO MPS%' )");
                                java.sql.ResultSet rset1d = st1d.executeQuery("SELECT count(DISTINCT patient_no) FROM hp_lab_results WHERE typeof_test ilike '" + listofAct[i] + "' AND date BETWEEN '" + beginDate + "' AND '" + endDate + "' AND age >= 5 AND age < 15 AND (out_come NOT ILIKE '%posit%' OR out_come NOT ILIKE '%+%' OR out_come  ILIKE '%NO MPS%' )");
                                java.sql.ResultSet rset2d = st2d.executeQuery("SELECT count(DISTINCT patient_no) FROM hp_lab_results WHERE typeof_test ilike '" + listofAct[i] + "' AND date BETWEEN '" + beginDate + "' AND '" + endDate + "' AND age >= 15 AND (out_come NOT ILIKE '%posit%' OR out_come NOT ILIKE '%+%' OR out_come  ILIKE '%NO MPS%' )");
                                ...
                                table.addCell(phrase);*/
                                totalA = underOneA + oneFourA + fiveFourteenA;
                                totalD = underOneD + oneFourD + fiveFourteenD;
                                ...
                                table.addCell(phrase);
                                table.getDefaultCell().setColspan(2);
                                phrase = new Phrase(new com.afrisoftech.sys.Format2IntCurrency().Format2IntCurrency(java.lang.String.valueOf(totalA + totalD)), pFontHeader1);
                                table.addCell(phrase);
                         ...
                         /*    table.getDefaultCell().setColspan(2);
                            ...
                            phrase = new Phrase(new com.afrisoftech.sys.Format2IntCurrency().Format2IntCurrency(java.lang.String.valueOf(tmUnderOneA)), pFontHeader1);
                            table.addCell(phrase);

                            phrase = new Phrase(new com.afrisoftech.sys.Format2IntCurrency().Format2IntCurrency(java.lang.String.valueOf(tmOneFourA)), pFontHeader1);
                            table.addCell(phrase);

                            phrase = new Phrase(new com.afrisoftech.sys.Format2IntCurrency().Format2IntCurrency(java.lang.String.valueOf(tmFiveFourteenA)), pFontHeader1);
                            table.addCell(phrase);

                            phrase = new Phrase(new com.afrisoftech.sys.Format2IntCurrency().Format2IntCurrency(java.lang.String.valueOf(tmFifteenFortyFourA)), pFontHeader1);
                            table.addCell(phrase);
...
//            if (this.ReportType.equalsIgnoreCase("Both")) {
            ...
            java.sql.ResultSet rSet1 = stmt1.executeQuery("SELECT DISTINCT typeof_test FROM hp_lab_results WHERE date BETWEEN '" + beginDate + "' AND '" + endDate + "' AND typeof_test IS NOT NULL AND typeof_test != '' ORDER BY 1 ASC");
            ...
            java.sql.ResultSet rSet1 = stmt1.executeQuery("SELECT DISTINCT type_of_test FROM hp_lab_results WHERE date BETWEEN '" + beginDate + "' AND '" + endDate + "' AND type_of_test IS NOT NULL AND main_service != '' ORDER BY 1 ASC");
