...
public class TheatreCasesPdf implements java.lang.Runnable {
    ...
    public void TheatreCasesPdf(java.sql.Connection connDb, java.util.Date begindate, java.util.Date enddate) {
...
//            double current = 0.00;
                    ...
                    try {
                        ...
                        int headerwidths[] = {10,25,25,10,25};
                        ...
                        Phrase phrase = new Phrase("THEATRE CASES");
                        ...
                        phrase = new Phrase("TYPE OF SURGERY",pFontHeader1);
                        table.addCell(phrase);
                        ...
                        try {
                            ...
                            java.sql.ResultSet rset23 = st23.executeQuery("SELECT patient_no,operation_theatre,ward_name,proc_type,procedure_1,date_recorded FROM hp_theatre_procedures WHERE date_recorded::date BETWEEN '"+beginDate+"'::date AND '"+endDate+"'::date ORDER BY date_recorded ");
                            
                            table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                            table.getDefaultCell().setColspan(1);
                            while (rset23.next()){
                                phrase = new Phrase(dbObject.getDBObject(rset23.getObject(1), "-"), pFontHeader1);
                                table.addCell(phrase);
                                phrase = new Phrase(dbObject.getDBObject(rset23.getObject(2), "-"), pFontHeader1);
                                table.addCell(phrase);
                                phrase = new Phrase(dbObject.getDBObject(rset23.getObject(3), "-"), pFontHeader1);
                                table.addCell(phrase);
                                phrase = new Phrase(dbObject.getDBObject(rset23.getObject(4), "-"), pFontHeader1);
                                table.addCell(phrase);
                                phrase = new Phrase(dbObject.getDBObject(rset23.getObject(5), "-"), pFontHeader1);
                                table.addCell(phrase);
                            }
