...
public class CondinNewbornPdf implements java.lang.Runnable {
    ...
    public void CondinNewbornPdf(java.sql.Connection connDb, java.util.Date begindate, java.util.Date endate) {
                ...
                try {
                    ...
                    try {
                        ...
                        try{
                            ...
                            phrase = new Phrase("CONDITIONS FOUND IN THE NEWBORN - "+monthString+", "+yearString , pFontHeader);
                        ...
                        try {
                            ...
                            for (int i = 0; i < listofAct.length; i++) {
                                ...
                                java.sql.ResultSet rset3 = st3.executeQuery("SELECT COUNT(condition_found),condition_found FROM rh.newborn_conditions_registered WHERE condition_category ilike'"+listofAct[i]+"' AND date_registered BETWEEN '"+beginDate+"' AND '"+endDate+"' GROUP BY condition_found");
                                ...
                                while (rset3.next()){
                                    ...
                                    table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_CENTER);
                                    totalCateg = totalCateg + rset3.getInt(1);
                                    categ = rset3.getInt(1);
                                    phrase = new Phrase(new com.afrisoftech.sys.Format2IntCurrency().Format2IntCurrency(java.lang.String.valueOf(categ)),pFontHeader1);
                                    table.addCell(phrase);
                                ...
                                table.getDefaultCell().setColspan(1);
                                table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_CENTER);
                                phrase = new Phrase(new com.afrisoftech.sys.Format2IntCurrency().Format2IntCurrency(java.lang.String.valueOf(totalCateg)),pFontHeader);
                                table.addCell(phrase);
    ...
    public java.lang.Object[] getListofActivities() {
        ...
        try {
            ...
            java.sql.ResultSet rSet1 = stmt1.executeQuery("SELECT DISTINCT condition_category FROM rh.newborn_conditions_registered WHERE date_registered BETWEEN '"+beginDate+"' AND '"+endDate+"'");
