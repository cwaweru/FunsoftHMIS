...
public class MonthlyDiagOpPdf implements java.lang.Runnable {
    double Credit = 0.00;
    // double current = 0.00;
    //double over30 = 0.00;
    // double over60 = 0.00;
                ...
                try {
                    ...
                    try {
                        ...
                        try {
                            ...
                            phrase = new Phrase("Monthly Diagnosis as at : ".toUpperCase() +dateFormat.format(endDate2), pFontHeader);
                            ...
                            for (int i = 0; i < listofAct.length; i++) {
                                ...
                                for (int t = 0; t < rangeDates.length; t++) {
                                    ...
                                    while (rset.next()){
                                        ...
                                        table.getDefaultCell().setColspan(1);
                                        table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_RIGHT);
                                        phrase = new Phrase(rset.getString(1).toString(), pFontHeader1);
                                        table.addCell(phrase);
                                        columnTotals[t] = columnTotals[t] + rset.getInt(1);
