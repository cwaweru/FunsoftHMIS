...
public class DailyWardStatementDischPdf implements java.lang.Runnable {
    ...
    public void DailyWardStatementDischPdf(java.sql.Connection connDb, java.util.Date begindate, java.util.Date endate, java.lang.String ward) {
            ...
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        int headerwidths[] = {10, 30, 10, 10, 10, 20, 10};
                        ...
                        try {
                            ...
                            phrase = new Phrase("DAILY WARD DISCHARGES", pFontHeader2);
                        ...
                        try {
                            ...
                            phrase = new Phrase("SPECIALITY", pFontHeader);
                            table.addCell(phrase);
                            ...
                            java.sql.ResultSet rset = st.executeQuery("SELECT distinct patient_no,patient_name,ROUND(pat_age),gender,'',speciality,diagnosis1 FROM hp_admission WHERE discharge_date::date = '" + endDate + "' AND ward = '" + wardName + "'  AND transaction_type NOT ILIKE 'DIE%' ORDER BY patient_no ASC");
                            ...
                            while (rset.next()) {
                                ...
                                pSpeciality = rset.getString(6);
                                fDiagnosis = rset.getString(7);
                                ...
                                table.addCell(phrase);
                                phrase = new Phrase(fDiagnosis, pFontHeader1);
                                table.addCell(phrase);
                                phrase = new Phrase(pSpeciality, pFontHeader1);
                                table.addCell(phrase);
                            }
                            ...
                            phrase = new Phrase("TRANSFERS FROM WARD \n Name", pFontHeader);
                            table.addCell(phrase);
                            ...
                            java.sql.ResultSet rset1 = st1.executeQuery("SELECT distinct patient_no,patient_name,ROUND(pat_age),gender,reason_for_transfer,'','' FROM hp_ward_to_ward_transfer WHERE date::date = '" + endDate + "' AND transfered_from = '" + wardName + "' ORDER BY patient_no ASC");
                            ...
                            phrase = new Phrase("SPECIALITY", pFontHeader);
                            table.addCell(phrase);
                            java.sql.ResultSet rset1X = st.executeQuery("SELECT distinct patient_no,patient_name,ROUND(pat_age),gender,'',speciality,diagnosis1 FROM hp_admission WHERE discharge_date::date = '" + endDate + "' AND ward = '" + wardName + "' AND transaction_type ILIKE 'DIE%' ORDER BY patient_no ASC");
                            // java.sql.ResultSet rset1 = st1.executeQuery("SELECT SUM(count_no),gender FROM patient_analysis WHERE input_date::date BETWEEN '"+beginDate+"' AND '"+endDate+"' AND age::numeric BETWEEN '"+lowerAge+"' AND '"+upperAge+"' AND comments ilike 'old' GROUP BY 2 ORDER BY gender DESC");
                            // table.getDefaultCell().setBorderColor(java.awt.Color.WHITE);

                            //table.getDefaultCell().setBorder(Rectangle.RIGHT | Rectangle.LEFT);
                            while (rset1X.next()) {
                                pNo = rset1X.getString(1);
                                pName = rset1X.getString(2);
                                ages = rset1X.getInt(3);
                                pGender = rset1X.getString(4);
                                pStatus = rset1X.getString(5);
                                pSpeciality = rset1X.getString(6);
                                fDiagnosis = rset1X.getString(7);
