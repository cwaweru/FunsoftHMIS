...
public class InPatientStatementPdf implements java.lang.Runnable {
    ...
    public void InPatientStatementPdf(java.sql.Connection connDb, java.util.Date begindate, java.util.Date endate) {
                ...
                try {
                    ...
                    try {
                        ...
                        try {
                            ...
                            phrase = new Phrase("STATEMENT OF IN-PATIENTS", pFontHeader2);
                            ...
                            table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_CENTER);
                            phrase = new Phrase("B. IN - PATIENTS",pFontHeader);
                            table.addCell(phrase);
                            ...
                            phrase = new Phrase("DISCHARGES",pFontHeader);
                            table.addCell(phrase);
                        ...
                        try {
                            ...
                            for (int i = 0; i < listofAct.length; i++) {
                                ...
                                java.sql.ResultSet rset = st.executeQuery("SELECT count(patient_no),TRIM(gender) AS gender FROM hp_admission WHERE date_admitted::date BETWEEN '"+beginDate+"' AND '"+endDate+"' AND pat_age::numeric(10,2) BETWEEN '"+lowerAge+"' AND '"+upperAge+"' AND patient_no NOT ILIKE 'OBS%' GROUP BY 2 ORDER BY gender DESC");
                                java.sql.ResultSet rset1 = st1.executeQuery("SELECT count(patient_no),TRIM(gender) AS gender FROM hp_admission WHERE discharge_date::date BETWEEN '"+beginDate+"' AND '"+endDate+"' AND pat_age::numeric(10,2) BETWEEN '"+lowerAge+"' AND '"+upperAge+"' AND transaction_type  NOT ILIKE 'DIE%'  AND patient_no NOT ILIKE 'OBS%' GROUP BY 2 ORDER BY gender DESC");
                                java.sql.ResultSet rset11 = st2.executeQuery("SELECT count(patient_no),TRIM(gender) AS gender FROM hp_admission WHERE discharge_date::date BETWEEN '"+beginDate+"' AND '"+endDate+"' AND pat_age::numeric(10,2) BETWEEN '"+lowerAge+"' AND '"+upperAge+"' AND transaction_type  ILIKE 'DIE%'  AND patient_no NOT ILIKE 'OBS%' GROUP BY 2 ORDER BY gender DESC");
                                ...
                                while (rset11.next()) {
                                    Gender2 = rset11.getString(2);
                                    oldCount2 = rset11.getInt(1);
                                ...
                                phrase = new Phrase(new com.afrisoftech.sys.Format2IntCurrency().Format2IntCurrency(java.lang.String.valueOf(oldMale2)),pFontHeader1);
                                oldMaleTotal2 = oldMaleTotal2+(oldMale2);
                                table.addCell(phrase);
                                
                                phrase = new Phrase(new com.afrisoftech.sys.Format2IntCurrency().Format2IntCurrency(java.lang.String.valueOf(oldFemale2)),pFontHeader1);
                                oldFemaleTotal2 = oldFemaleTotal2+(oldFemale2);
                                table.addCell(phrase);
                            ...
                            phrase = new Phrase(new com.afrisoftech.sys.Format2IntCurrency().Format2IntCurrency(java.lang.String.valueOf(oldMaleTotal2)),pFontHeader1);
                            table.addCell(phrase);
                            
                            phrase = new Phrase(new com.afrisoftech.sys.Format2IntCurrency().Format2IntCurrency(java.lang.String.valueOf(oldFemaleTotal2)),pFontHeader1);
                            table.addCell(phrase);
                            table.getDefaultCell().setColspan(7);
