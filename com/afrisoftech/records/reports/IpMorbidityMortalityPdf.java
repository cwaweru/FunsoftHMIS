...
public class IpMorbidityMortalityPdf implements java.lang.Runnable {
    ...
    public void IpMorbidityMortalityPdf(java.sql.Connection connDb, java.util.Date begindate, java.util.Date endate) {
            ...
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        int headerwidths[] = {7, 10, 20, 7, 7, 12, 8, 12, 12, 15, 10, 20, 20, 20, 10};
                        ...
                        try {
                            ...
                            phrase = new Phrase("INPATIENT MORBIDITY AND MORTALITY RETURNS", pFontHeader);
                        ...
                        phrase = new Phrase("Sex", pFontHeader1);
                        table.addCell(phrase);
                        ...
                        phrase = new Phrase("Speciality **", pFontHeader1);
                        table.addCell(phrase);
                        ...
                        table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                        phrase = new Phrase("Principal Diagnosis", pFontHeader1);
                        table.addCell(phrase);

                        phrase = new Phrase("Additional Diagnosis", pFontHeader1);
                        table.addCell(phrase);

                        phrase = new Phrase("Surgical Procedure", pFontHeader1);
                        table.addCell(phrase);
                        ...
                        try {
                            ...
                            phrase = new Phrase("= This is the usual resindence of the patient but not birth-place", pFontHeader);
                            table.addCell(phrase);
                            ...
                            table.getDefaultCell().setColspan(8);
                            phrase = new Phrase("= Medical, Surgical, Paediatric, Maternity, Gynaecology, Orthopaedic, Cardiology, etc", pFontHeader);
                            table.addCell(phrase);
                            ...
                            table.getDefaultCell().setColspan(8);
                            phrase = new Phrase("= Discharge, Died, Transferred, Abscond", pFontHeader);
                            table.addCell(phrase);
...
docPdf.close();  com.afrisoftech.lib.PDFRenderer.renderPDF(tempFile);
    ...
    public java.lang.Object[] getListofActivities() {
        ...
        // java.sql.ResultSet rSet1 = stmt1.executeQuery("select  patient_no from hp_admission where discharge_date::date BETWEEN '"+beginDate+"'::date AND '"+endDate+"'::date ORDER BY discharge_date::date");
