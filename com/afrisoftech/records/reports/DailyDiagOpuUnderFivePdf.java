...
public class DailyDiagOpuUnderFivePdf implements java.lang.Runnable {
    ...
    public void DailyDiagOpuUnderFivePdf(java.sql.Connection connDb, java.util.Date begindate, java.util.Date endate) {
            ...
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        com.lowagie.text.HeaderFooter headerFoter = new com.lowagie.text.HeaderFooter(new Phrase("UNDER 5 YEARS DAILY OUTPATIENT MORBIDITY SUMMARY SHEET"), false);// FontFactory.getFont(com.lowagie.text.FontFactory.HELVETICA, 14, Font.BOLDITALIC,java.awt.Color.blue)));
...
//.toUpperCase() + dateFormat.format(endDate2)
                            ...
                            try {
                                ...
                                for (int o = 0; o < rangeDates.length; o++) {
                                  ...
                                  //  java.sql.PreparedStatement psetr = connectDB.prepareStatement("SELECT count(hr.patient_no) FROM hp_patient_visit hv, hp_refferal_ext hr WHERE hr.input_date between '" + rangeDates[o][0] + "' AND '" + rangeDates[o][1] + "' AND  hv.date between '" + rangeDates[o][0] + "' AND '" + rangeDates[o][1] + "' AND hv.age < 5");//< '"+endDate+"'::date and date > '"+endDate+"'::date - 30 group by dealer");
                                    java.sql.ResultSet rsetr = psetr.executeQuery();
