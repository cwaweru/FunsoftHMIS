 ...
 * @author  root
 */
public class BloodGroup extends javax.swing.JInternalFrame {
    ...
    public BloodGroup(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {
        ...
        setIconifiable(true);
        setTitle("Blood Groups setup utility");
        ...
        jButton1.setText("Register blood group");
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Enter Blood Group Name & Code here"));
...
// TODO add your handling code here:
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        try{
            ...
            java.sql.PreparedStatement pstmt31 = connectDB.prepareStatement("DELETE from blood_group WHERE blood_group_code = '"+jTable1.getModel().getValueAt(jTable1.getSelectedRow(),0).toString()+"'");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            ...
            for (int i = 0; i < jTable1.getRowCount(); i++){
                if (jTable1.getModel().getValueAt(i,0) != null){
                    if(jButton1.getText().equalsIgnoreCase("Update")){
                        java.sql.PreparedStatement pstmt311 = connectDB.prepareStatement("UPDATE blood_group" +
                                " SET blood_group = '"+jTable1.getValueAt(i,1).toString()+"' WHERE blood_group_code = " +
                                "'"+jTable1.getValueAt(i,0).toString()+"'");
                        pstmt311.executeUpdate();
                    }else{
                        java.sql.PreparedStatement pstmt1 = connectDB.prepareStatement("insert into blood_group values(?,initcap(?))");
            ...
            connectDB.commit();
            connectDB.setAutoCommit(true);
            javax.swing.JOptionPane.showMessageDialog(this, "New blood group(s) registered","Comfirmation",javax.swing.JOptionPane.INFORMATION_MESSAGE);
            ...
            jLabel3.setText("Sorry. A blood group with similar name already exists in the database");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        int i = 0;
        jTable1.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"select blood_group_code,blood_group from blood_group ORDER BY blood_group"));
