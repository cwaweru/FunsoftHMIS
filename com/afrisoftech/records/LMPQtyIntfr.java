 ...
 * @author  root
 */
public class LMPQtyIntfr extends javax.swing.JInternalFrame {
    ...
    public LMPQtyIntfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {
        ...
        setIconifiable(true);
        setTitle("LMP quantities Setup form");
        ...
        jButton1.setText("Register LMP parameters");
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Enter LMP Qty description & Code here"));
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "LMP Qty Code", "LMP Qty description"
            }
        ));
...
// TODO add your handling code here:
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        try{
            ...
            java.sql.PreparedStatement pstmt31 = connectDB.prepareStatement("DELETE from rh.lmp_qty WHERE lmp_qty_code = '"+jTable1.getModel().getValueAt(jTable1.getSelectedRow(),0).toString()+"'");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            ...
            for (int i = 0; i < jTable1.getRowCount(); i++){
                if (jTable1.getModel().getValueAt(i,0) != null){
                    if(jButton1.getText().equalsIgnoreCase("Update")){
                        java.sql.PreparedStatement pstmt311 = connectDB.prepareStatement("UPDATE rh.lmp_qty SET lmp_qty_desc = '"+jTable1.getValueAt(i,1).toString()+"' WHERE lmp_qty_code = '"+jTable1.getValueAt(i,0).toString()+"'");
                        pstmt311.executeUpdate();
                    }else{
                        java.sql.PreparedStatement pstmt1 = connectDB.prepareStatement("insert into rh.lmp_qty values(?,initcap(?))");
            ...
            jLabel3.setText("Sorry. A similar Code already exists");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        int i = 0;
        jTable1.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"select lmp_qty_code,lmp_qty_desc from rh.lmp_qty ORDER BY lmp_qty_desc"));
