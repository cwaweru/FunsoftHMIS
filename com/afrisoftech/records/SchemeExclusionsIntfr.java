...
public class SchemeExclusionsIntfr extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        setIconifiable(true);
        setTitle("Scheme exclusions setup");
        ...
        jButton1.setText("Register scheme exclusions");
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Entre scheme exclusions parametric data here"));
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Exclusions Code", "Exclusions Description"
            }
        ));
...
// TODO add your handling code here:
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        try{
            ...
            java.sql.PreparedStatement pstmt31 = connectDB.prepareStatement("DELETE from pb_scheme_exclusions WHERE exclusions_code = '"+jTable1.getModel().getValueAt(jTable1.getSelectedRow(),0).toString()+"'");
            ...
            for (int i = 0; i < jTable1.getRowCount(); i++){
                if (jTable1.getModel().getValueAt(i,0) != null){
                    if(jButton1.getText().equalsIgnoreCase("Update")){
                        java.sql.PreparedStatement pstmt311 = connectDB.prepareStatement("UPDATE pb_scheme_exclusions SET exclusion_type = '"+jTable1.getValueAt(i,1).toString()+"' WHERE exclusions_code = '"+jTable1.getValueAt(i,0).toString()+"'");
                        pstmt311.executeUpdate();
                    }else{
                        java.sql.PreparedStatement pstmt1 = connectDB.prepareStatement("insert into pb_scheme_exclusions(exclusions_code, exclusion_type)  values(?,initcap(?))");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        int i = 0;
        jTable1.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"select exclusions_code,exclusion_type from pb_scheme_exclusions ORDER BY 2"));
