 ...
 * @author root
 */
public class AllergiesIntfr extends javax.swing.JInternalFrame {
    ...
    public AllergiesIntfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {
        ...
        setIconifiable(true);
        setTitle("Register Patient Allergies Setup ");
        ...
        jButton1.setText("Register patient allergies");
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Entre Patient Allergies parametric data here"));
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Allergy Code", "Allergy Short Description", "Allergy Long Description"
            }
        ));
...
// TODO add your handling code here:
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        try {
            ...
            java.sql.PreparedStatement pstmt31 = connectDB.prepareStatement("DELETE from pb_patient_allergies WHERE allergy_code = '" + jTable1.getModel().getValueAt(jTable1.getSelectedRow(), 0).toString() + "'");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            ...
            for (int i = 0; i < jTable1.getRowCount(); i++) {
                if (jTable1.getModel().getValueAt(i, 0) != null) {
                    if (jButton1.getText().equalsIgnoreCase("Update")) {
                        java.sql.PreparedStatement pstmt311 = connectDB.prepareStatement("UPDATE pb_patient_allergies SET allergy_short_description = '" + jTable1.getValueAt(i, 1).toString() + "', allergy_long_description = '" + jTable1.getValueAt(i, 2).toString() + "' WHERE allergy_code = '" + jTable1.getValueAt(i, 0).toString() + "'");
                        pstmt311.executeUpdate();
                    } else {
                        java.sql.PreparedStatement pstmt1 = connectDB.prepareStatement("INSERT INTO pb_patient_allergies("
                                + "             allergy_code, allergy_short_description, allergy_long_description )"
                                + "    VALUES (?, ?, ?)");
            ...
            jLabel3.setText("Sorry. Another delivery status code already exists");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        jTable1.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB, "SELECT  "
                + "allergy_code, allergy_short_description, allergy_long_description, "
                + "       allergy_serial, date_registered::date, user_name "
                + "  FROM pb_patient_allergies ORDER BY 2"));
