 ...
 * @author  root
 */
public class TypeofHospitalIntfr extends javax.swing.JInternalFrame {
    ...
    public TypeofHospitalIntfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {
        ...
        setIconifiable(true);
        setTitle("Types of hospital - Setup form");
        ...
        jButton1.setText("Register type of hospital");
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Enter type of hospital & code here"));
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Hospital type code", "Hospital type desc"
            }
        ));
...
// TODO add your handling code here:
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        try{
            ...
            java.sql.PreparedStatement pstmt31 = connectDB.prepareStatement("DELETE from hospital_type WHERE hospital_type_code = '"+jTable1.getModel().getValueAt(jTable1.getSelectedRow(),0).toString()+"'");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            ...
            for (int i = 0; i < jTable1.getRowCount(); i++){
                if (jTable1.getModel().getValueAt(i,0) != null){
                    if(jButton1.getText().equalsIgnoreCase("Update")){
                        java.sql.PreparedStatement pstmt311 = connectDB.prepareStatement("UPDATE hospital_type SET hospital_type_desc = '"+jTable1.getValueAt(i,1).toString()+"' WHERE hospital_type_code = '"+jTable1.getValueAt(i,0).toString()+"'");
                        pstmt311.executeUpdate();
                    }else{
                        java.sql.PreparedStatement pstmt1 = connectDB.prepareStatement("insert into hospital_type values(?,initcap(?))");
            ...
            jLabel3.setText("Sorry. Another hospital type code already exists");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        int i = 0;
        jTable1.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"select hospital_type_code,hospital_type_desc from hospital_type ORDER BY hospital_type_desc"));
