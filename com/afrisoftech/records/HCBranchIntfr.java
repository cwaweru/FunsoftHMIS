 ...
 * @author  root
 */
public class HCBranchIntfr extends javax.swing.JInternalFrame {
    ...
    public HCBranchIntfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {
        ...
        setIconifiable(true);
        setTitle("Healthcare centre branches setup form");
        ...
        jButton1.setText("Register healthcare branches");
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Enter healthcare branch name & code here"));
...
// TODO add your handling code here:
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        try{
            ...
            java.sql.PreparedStatement pstmt31 = connectDB.prepareStatement("DELETE from hc_branches WHERE hc_branch_code = '"+jTable1.getModel().getValueAt(jTable1.getSelectedRow(),0).toString()+"'");
            ...
            for (int i = 0; i < jTable1.getRowCount(); i++){
                if (jTable1.getModel().getValueAt(i,0) != null){
                    if(jButton1.getText().equalsIgnoreCase("Update")){
                        java.sql.PreparedStatement pstmt311 = connectDB.prepareStatement("UPDATE hc_branches SET hc_branch_name = '"+jTable1.getValueAt(i,1).toString()+"' WHERE hc_branch_code = '"+jTable1.getValueAt(i,0).toString()+"'");
                        pstmt311.executeUpdate();
                    }else{
                        java.sql.PreparedStatement pstmt1 = connectDB.prepareStatement("insert into hc_branches values(?,initcap(?))");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        int i = 0;
        jTable1.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"select hc_branch_code,hc_branch_name from hc_branches ORDER BY hc_branch_name"));
