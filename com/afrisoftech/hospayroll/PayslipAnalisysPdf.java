                        ...
                        for (int j = 0; j < listofStaffNos.length; j++) {
                            ...
                            try {
                                ...
                                for (int t = 0; t < rangeDates.length; t++) {
                                    ...
                                    rsetTotals1 = st4.executeQuery("SELECT sum(pt.amount) FROM posting pt,deductions_allowances da WHERE pt.staff_no = '"+listofStaffNos[j]+"' AND pt.date BETWEEN '"+rangeDates[t][0]+"' AND '"+rangeDates[t][1]+"' AND pt.description::text ~~* da.description::text AND da.taxable = true AND da.benefit = true and company_name ilike '"+bank+"'");
