...
public class SigleEarningsintfr extends javax.swing.JInternalFrame implements java.lang.Runnable {
    ...
    private void initComponents() {
        ...
        */
        ...
        jComboBox1.setModel(com.afrisoftech.lib.ComboBoxModel.ComboBoxModel(connectDB, "select employee_no from master_file order by employee_no"));
        ...
        jComboBox3.setModel(com.afrisoftech.lib.ComboBoxModel.ComboBoxModel(connectDB, " select '-' union  select distinct upper(description) as description from deductions_allowances order by 1"));
 ...
 //  float total_num = java.lang.Float.parseFloat(jTextField6.getText());
    ...
    private void jComboBox1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBox1ActionPerformed
        ...
        try {
         ...
         jComboBox3.setModel(com.afrisoftech.lib.ComboBoxModel.ComboBoxModel(connectDB, "select description from allowances_benefits where staff_no = '"+jComboBox1.getSelectedItem().toString()+"' order by description"));
