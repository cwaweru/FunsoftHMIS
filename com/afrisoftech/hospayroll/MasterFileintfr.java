...
public class MasterFileintfr extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        changeDatePicker = new com.afrisoftech.lib.DatePicker();
        ...
        designitionTxt = new javax.swing.JComboBox<>();
        employeeGroupLbl1 = new javax.swing.JLabel();
        directorsteCmbx = new javax.swing.JComboBox();
        sectionLbl1 = new javax.swing.JLabel();
        sectionLbl2 = new javax.swing.JLabel();
        welfareCmbx = new javax.swing.JComboBox();
        sacooCmbx = new javax.swing.JComboBox();
        ...
        monthlyHoursLbl1 = new javax.swing.JLabel();
        incrementalMonthCbx = new javax.swing.JComboBox<>();
        ...
        bankBranchTxt = new javax.swing.JComboBox<>();
        ...
        payeeChkbx = new javax.swing.JCheckBox();
        jPanel1 = new javax.swing.JPanel();
        disabledCB = new javax.swing.JCheckBox();
        pensionCB = new javax.swing.JCheckBox();
        policeTaxCB = new javax.swing.JCheckBox();
        withholdingTaxChckBox = new javax.swing.JCheckBox();
        knunCbx = new javax.swing.JCheckBox();
        wht2cb = new javax.swing.JCheckBox();
        ...
        mobileNumberLbl1 = new javax.swing.JLabel();
        ...
        staffListingScrollPane2 = new javax.swing.JScrollPane();
        suspendedStaffListingTable = new com.afrisoftech.dbadmin.JXTable();
        suspendBtn1 = new javax.swing.JButton();
        ...
        **/
        ...
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
        jPanel3.add(changeDatePicker, gridBagConstraints);
        ...
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
        emplyeeDetailsPanel.add(jPanel3, gridBagConstraints);
        ...
        */
        ...
        departmentCmbx.setModel(com.afrisoftech.lib.ComboBoxModel.ComboBoxModel(connectDB, "select distinct department from hr.hr_job_groupings order by 1"));
        ...
        designitionTxt.setModel(com.afrisoftech.lib.ComboBoxModel.ComboBoxModel(connectDB, "select '-' union select designation from hr.hr_job_designation order by 1"));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 4;
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
        ...
        employeeGroupLbl1.setText("Emp. Group");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 3;
        gridBagConstraints.gridy = 5;
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
        employmentDetailsPanel.add(employeeGroupLbl1, gridBagConstraints);
        ...
        gridBagConstraints.weighty = 1.0;
        gridBagConstraints.insets = new java.awt.Insets(0, 0, 0, 10);
        employmentDetailsPanel.add(directorsteCmbx, gridBagConstraints);

        sectionLbl1.setText("Sacco");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 3;
        gridBagConstraints.gridy = 7;
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
        employmentDetailsPanel.add(sectionLbl1, gridBagConstraints);

        sectionLbl2.setText("Section");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 6;
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
        employmentDetailsPanel.add(sectionLbl2, gridBagConstraints);

        welfareCmbx.setModel(com.afrisoftech.lib.ComboBoxModel.ComboBoxModel(connectDB, "select '-' UNION select DISTINCT description from sacco_welfare_members WHERE welfare=TRUE order by 1"));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 7;
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
        employmentDetailsPanel.add(welfareCmbx, gridBagConstraints);

        sacooCmbx.setModel(com.afrisoftech.lib.ComboBoxModel.ComboBoxModel(connectDB, "select '-' UNION select DISTINCT description from sacco_welfare_members WHERE sacco=TRUE order by 1"));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 4;
        gridBagConstraints.gridy = 7;
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
        ...
        gridBagConstraints.weighty = 1.0;
        gridBagConstraints.insets = new java.awt.Insets(0, 0, 0, 10);
        employmentDetailsPanel.add(sacooCmbx, gridBagConstraints);
        ...
        suspendBtn.setText("Suspend staff member");
        ...
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
        buttonPanel.add(suspendBtn, gridBagConstraints);
        ...
        monthlyHoursLbl.setText("Incremental Month");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 3;
        gridBagConstraints.gridy = 6;
        gridBagConstraints.weightx = 1.0;
        ...
        monthlyHoursLbl1.setText("Monthly Hours");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 3;
        gridBagConstraints.gridy = 5;
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
        jPanel4.add(monthlyHoursLbl1, gridBagConstraints);

        incrementalMonthCbx.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "-", "JANUARY", "JULY" }));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 4;
        gridBagConstraints.gridy = 6;
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
        ...
        gridBagConstraints.weighty = 1.0;
        gridBagConstraints.insets = new java.awt.Insets(0, 0, 0, 20);
        jPanel4.add(incrementalMonthCbx, gridBagConstraints);
        ...
        bankNameCmbx.setModel(com.afrisoftech.lib.ComboBoxModel.ComboBoxModel(connectDB, "select '-' union select bank_name as bank_name from banks_setup order by 1"));
        ...
        gridBagConstraints.weighty = 1.0;
        gridBagConstraints.insets = new java.awt.Insets(0, 20, 0, 0);
        bankAccountDetailsPanel.add(jLabel2, gridBagConstraints);
        ...
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
        bankAccountDetailsPanel.add(branchCodeTxt, gridBagConstraints);

        bankBranchTxt.setModel(com.afrisoftech.lib.ComboBoxModel.ComboBoxModel(connectDB, "select DISTINCT branch_name from banks_branch_setup order by 1"));
        bankBranchTxt.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                bankBranchTxtActionPerformed(evt);
            }
        });
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 5;
        ...
        payeeChkbx.setText("PAYE");
        statutoryBodiesPanel.add(payeeChkbx, new java.awt.GridBagConstraints());
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Tick Where Applicable"));
        jPanel1.setLayout(new java.awt.GridBagLayout());

        disabledCB.setText("Disabled");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 3;
        gridBagConstraints.gridy = 0;
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
        jPanel1.add(disabledCB, gridBagConstraints);

        pensionCB.setSelected(true);
        pensionCB.setText("Pension");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 3;
        gridBagConstraints.gridy = 1;
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
        jPanel1.add(pensionCB, gridBagConstraints);

        policeTaxCB.setText("Police Tax");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 5;
        gridBagConstraints.gridy = 1;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
        jPanel1.add(policeTaxCB, gridBagConstraints);

        withholdingTaxChckBox.setText("Withholding Tax 5%");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 5;
        gridBagConstraints.gridy = 0;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
        jPanel1.add(withholdingTaxChckBox, gridBagConstraints);

        knunCbx.setText("KNUN Deduction");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 6;
        gridBagConstraints.gridy = 1;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
        jPanel1.add(knunCbx, gridBagConstraints);

        wht2cb.setText("Withholding Tax 30%");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 6;
        gridBagConstraints.gridy = 0;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        gridBagConstraints.weightx = 1.0;
        jPanel1.add(wht2cb, gridBagConstraints);
        ...
        gridBagConstraints.weighty = 1.0;
        gridBagConstraints.insets = new java.awt.Insets(5, 5, 5, 5);
        paymentDetailsPanel.add(jPanel1, gridBagConstraints);
        ...
        mobileNumberLbl1.setText("Email");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 4;
        addressDetailsPanel.add(mobileNumberLbl1, gridBagConstraints);
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 4;
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
        ...
        gridBagConstraints.weighty = 1.0;
        gridBagConstraints.insets = new java.awt.Insets(0, 0, 0, 10);
        addressDetailsPanel.add(emaiTxt, gridBagConstraints);
        ...
        suspendedStaffListingTable.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB, "SELECT employee_no, first_name, middle_name, last_name, id_no,  pin_no, gender, department, section, date_employed, date_of_post as posting_date, official_desgnation as designation, suspension_date,false as reinstate from master_file where suspend = true order by employee_no"));
        suspendedStaffListingTable.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                suspendedStaffListingTableMouseClicked(evt);
            }
        });
        staffListingScrollPane2.setViewportView(suspendedStaffListingTable);
        ...
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
        jPanel2.add(staffListingScrollPane2, gridBagConstraints);

        suspendBtn1.setText("Reinstate Staff Member");
        suspendBtn1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                suspendBtn1ActionPerformed(evt);
            }
        });
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 3;
        ...
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
        jPanel2.add(suspendBtn1, gridBagConstraints);

        masterFileTabbedPane.addTab("Suspended Staff Listing", jPanel2);
    ...
    private void bankNameCmbxActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bankNameCmbxActionPerformed
        try {
            ...
            java.sql.ResultSet rset = stmt.executeQuery("SELECT bank_code from banks_setup WHERE bank_name ilike '" + bankNameCmbx.getSelectedItem().toString() + "'");
            while (rset.next()) {
                bankCodeTxt.setText(rset.getObject(1).toString());
            }

            bankBranchTxt.setModel(com.afrisoftech.lib.ComboBoxModel.ComboBoxModel(connectDB, "select DISTINCT branch_name from banks_branch_setup WHERE bank_code ='" + bankCodeTxt.getText() + "' order by 1"));
    ...
    private void clearBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_clearBtnActionPerformed
        ...
        designitionTxt.setSelectedItem("-");
    ...
    private void editBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editBtnActionPerformed
        ...
        try {
            ...
            while (rset.next()) {
                ...
                jobGroup = rset.getString(16);
                incrementalMonth = rset.getString(53);
                desgination = rset.getString(11);
                dept = rset.getString(12);
                bank = rset.getString(25);
                bank_ = rset.getString(24);
                ...
                designitionTxt.setSelectedItem(dbObject.getDBObject(rset.getObject(11), "-"));//bankNameCmbx 
                ...
                bankBranchTxt.setSelectedItem(dbObject.getDBObject(rset.getObject(14), "-"));
                ...
                if (rset.getBoolean(40) == true) {
                    payeeChkbx.setSelected(true);
                } else {
                    payeeChkbx.setSelected(false);
                }
                ...
                emaiTxt.setText(dbObject.getDBObject(rset.getObject(45), "-"));//branch_code,bank_code,pension,disabled
                if (rset.getBoolean(46) == true) {
                    withholdingTaxChckBox.setSelected(true);
                } else {
                    withholdingTaxChckBox.setSelected(false);
                }
                if (rset.getBoolean(47) == true) {
                    policeTaxCB.setSelected(true);
                } else {
                    policeTaxCB.setSelected(false);
                }
                branchCodeTxt.setText(dbObject.getDBObject(rset.getObject(48), "-"));
                bankCodeTxt.setText(dbObject.getDBObject(rset.getObject(49), "-"));
                bankNameCmbx.setSelectedItem(dbObject.getDBObject(rset.getObject(24), "-"));
                System.err.println("Bank for ......." + dbObject.getDBObject(rset.getObject(24), "-"));
                bankBranchTxt.setSelectedItem(dbObject.getDBObject(rset.getObject(52), "-"));
                if (rset.getBoolean(50) == true) {
                    pensionCB.setSelected(true);
                } else {
                    pensionCB.setSelected(false);
                }
                if (rset.getBoolean(51) == true) {
                    disabledCB.setSelected(true);
                } else {
                    disabledCB.setSelected(false);
                }
                incrementalMonthCbx.setSelectedItem(dbObject.getDBObject(rset.getObject(53), "-"));
                knunCbx.setSelected(rset.getBoolean(54));
                wht2cb.setSelected(rset.getBoolean(55));
                directorsteCmbx.setSelectedItem(dbObject.getDBObject(rset.getObject(56), "-"));
                welfareCmbx.setSelectedItem(dbObject.getDBObject(rset.getObject(57), "-"));
                sacooCmbx.setSelectedItem(dbObject.getDBObject(rset.getObject(58), "-"));
...
// Add your handling code here:
    ...
    private void saveBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveBtnActionPerformed
        ...
        if (knunCbx.isSelected()) {
            knun = true;
        } else {
            knun = false;
        }

        if (pensionCB.isSelected()) {
            pension = true;
        } else {
            pension = false;
        }
        ...
        if (payeeChkbx.isSelected()) {
            provf = true;
        } else {
            provf = false;
        }

        if (disabledCB.isSelected()) {
            disabled = true;
        }
        ...
        try {
            ...
            if (saveBtn.getLabel().equalsIgnoreCase("Update")) {
                ...
                java.sql.ResultSet rset41 = st31.executeQuery("SELECT COUNT (*) FROM master_file WHERE nhif_no = '"+nhifNumberTxt.getText()+"' AND nhif_no != ''  AND nhif_no is not null AND company_name  = '"+staffCategoryCmbx.getSelectedItem().toString()+"' AND employee_no!= '"+employeeNumberTxt.getText()+"' ");
                System.err.println("SELECT COUNT (*) FROM master_file WHERE nhif_no = '"+nhifNumberTxt.getText()+"' AND nhif_no != ''  AND nhif_no is not null AND company_name  = '"+staffCategoryCmbx.getSelectedItem().toString()+"' AND employee_no!= '"+employeeNumberTxt.getText()+"'");
                while (rset41.next()) {
                    nhifCount = rset41.getInt(1);
                }
                
                rset41 = st31.executeQuery("SELECT COUNT (*) FROM master_file WHERE nssf_no = '"+nssfNumberTxt.getText()+"' AND nssf_no != ''  AND nssf_no is not null AND company_name  = '"+staffCategoryCmbx.getSelectedItem().toString()+"' AND employee_no!='"+employeeNumberTxt.getText()+"' ");
                while (rset41.next()) {
                    nssfCount = rset41.getInt(1);
                }
                
                rset41 = st31.executeQuery("SELECT COUNT (*) FROM master_file WHERE pin_no = '"+pinNumberTxt.getText()+"' AND pin_no != ''  AND pin_no is not null AND company_name  = '"+staffCategoryCmbx.getSelectedItem().toString()+"' AND employee_no!='"+employeeNumberTxt.getText()+"' ");
                while (rset41.next()) {
                    kraCount = rset41.getInt(1);
                }
                
                rset41 = st31.executeQuery("SELECT COUNT (*) FROM master_file WHERE id_no = '"+idPassportTxt.getText()+"' AND id_no != ''   AND id_no is not null AND company_name  = '"+staffCategoryCmbx.getSelectedItem().toString()+"' AND employee_no!='"+employeeNumberTxt.getText()+"'");
                while (rset41.next()) {
                    idCount = rset41.getInt(1);
                }
                
                rset41 = st31.executeQuery("SELECT COUNT (*) FROM master_file WHERE bank_account_no = '"+accountNumberTxt.getText()+"' AND bank_account_no != '' AND bank_account_no is not null AND company_name  = '"+staffCategoryCmbx.getSelectedItem().toString()+"' AND employee_no!='"+employeeNumberTxt.getText()+"' ");
                while (rset41.next()) {
                    bankCount = rset41.getInt(1);
                }

                if (nhifCount > 0) {
                    javax.swing.JOptionPane.showMessageDialog(this, "NHIF No. MUST BE UNIQUE!!", "Error Message!", javax.swing.JOptionPane.ERROR_MESSAGE);
                } else if (nssfCount > 0) {
                    javax.swing.JOptionPane.showMessageDialog(this, "NSSF No. MUST BE UNIQUE!!", "Error Message!", javax.swing.JOptionPane.ERROR_MESSAGE);
                } else if (kraCount > 0) {
                    javax.swing.JOptionPane.showMessageDialog(this, "PIN No. MUST BE UNIQUE!!", "Error Message!", javax.swing.JOptionPane.ERROR_MESSAGE);
                } else  if (idCount > 0) {
                    javax.swing.JOptionPane.showMessageDialog(this, "ID/Passport No. MUST BE UNIQUE!!", "Error Message!", javax.swing.JOptionPane.ERROR_MESSAGE);
                } else  if (bankCount > 0) {
                    javax.swing.JOptionPane.showMessageDialog(this, "BANK ACCOUNT No. MUST BE UNIQUE!!", "Error Message!", javax.swing.JOptionPane.ERROR_MESSAGE);
                } else{
                ...
                java.sql.PreparedStatement pstmtx = connectDB.prepareStatement("UPDATE master_file SET first_name = ?,"
                        ...
                        + "monthly_hours = ?, company_name = ?,disabled=?,email_address=?, bank_branch = ? ,"
                        + "bank_code=?,branch_code=?,inremental_month = ?,knun_ded = ?,pension = ?,withholding_tax=?,police_tax=?,"
                        + "withholding_tax2 = ? , directorate = ?, welfare = ?, sacco = ? WHERE employee_no = '" + employeeNumberTxt.getText() + "'");
                ...
                pstmtx.setString(10, designitionTxt.getSelectedItem().toString());
                ...
                pstmtx.setBoolean(42, disabled);
                pstmtx.setString(43, emaiTxt.getText());
                pstmtx.setString(44, bankBranchTxt.getSelectedItem().toString());
                pstmtx.setString(45, bankCodeTxt.getText());
                pstmtx.setString(46, branchCodeTxt.getText());
                pstmtx.setString(47, incrementalMonthCbx.getSelectedItem().toString());
                pstmtx.setBoolean(48, knun);
                pstmtx.setBoolean(49, pension);
                pstmtx.setBoolean(50, withholdingTaxChckBox.isSelected());
                pstmtx.setBoolean(51, policeTaxCB.isSelected());
                pstmtx.setBoolean(52, wht2cb.isSelected());
                pstmtx.setString(53, directorsteCmbx.getSelectedItem().toString());
                pstmtx.setString(54, welfareCmbx.getSelectedItem().toString());
                pstmtx.setString(55, sacooCmbx.getSelectedItem().toString());
                pstmtx.executeUpdate(); 
                
                if(!jobGroup.equalsIgnoreCase(employeeGradeCmbx.getSelectedItem().toString())) logChange("Job Group",jobGroup );
                if(!incrementalMonth.equalsIgnoreCase(incrementalMonthCbx.getSelectedItem().toString())) logChange("incremental Month",incrementalMonth );
                if(!desgination.equalsIgnoreCase(designitionTxt.getSelectedItem().toString())) logChange("Desgination",desgination );
                if(!dept.equalsIgnoreCase(departmentCmbx.getSelectedItem().toString())) logChange("Department",dept );
                if(!bank.equalsIgnoreCase(accountNumberTxt.getText())) logChange("Account No",bank );
                if(!bank_.equalsIgnoreCase(bankNameCmbx.getSelectedItem().toString())) logChange("Bank",bank_ );
                ...
                java.sql.Statement st31 = connectDB.createStatement();
                java.sql.ResultSet rset41 = st31.executeQuery("SELECT COUNT (*) FROM master_file WHERE nhif_no = '"+nhifNumberTxt.getText()+"' AND nhif_no != ''  AND nhif_no is not null AND company_name  = '"+staffCategoryCmbx.getSelectedItem().toString()+"' ");
                while (rset41.next()) {
                    nhifCount = rset41.getInt(1);
                }
                
                rset41 = st31.executeQuery("SELECT COUNT (*) FROM master_file WHERE nssf_no = '"+nssfNumberTxt.getText()+"' AND nssf_no != ''  AND nssf_no is not null AND company_name  = '"+staffCategoryCmbx.getSelectedItem().toString()+"' ");
                while (rset41.next()) {
                    nssfCount = rset41.getInt(1);
                }
                
                rset41 = st31.executeQuery("SELECT COUNT (*) FROM master_file WHERE pin_no = '"+pinNumberTxt.getText()+"' AND pin_no != ''  AND pin_no is not null AND company_name  = '"+staffCategoryCmbx.getSelectedItem().toString()+"' ");
                while (rset41.next()) {
                    kraCount = rset41.getInt(1);
                }
                
                rset41 = st31.executeQuery("SELECT COUNT (*) FROM master_file WHERE id_no = '"+idPassportTxt.getText()+"' AND id_no != ''   AND id_no is not null AND company_name  = '"+staffCategoryCmbx.getSelectedItem().toString()+"'");
                while (rset41.next()) {
                    idCount = rset41.getInt(1);
                }
                
                rset41 = st31.executeQuery("SELECT COUNT (*) FROM master_file WHERE bank_account_no = '"+accountNumberTxt.getText()+"' AND bank_account_no != '' AND bank_account_no is not null AND company_name  = '"+staffCategoryCmbx.getSelectedItem().toString()+"'  ");
                while (rset41.next()) {
                    bankCount = rset41.getInt(1);
                }
                ...
                if (nhifCount > 0) {
                    ...
                    java.sql.PreparedStatement pstmt = connectDB.prepareStatement("insert into master_file  (  employee_no, first_name, middle_name, last_name, id_no, birth_date,  nationality, marital_status, gender, date_employed, official_desgnation, \n"
                            + "            department, section, branch, employee_group, employee_grade,  pin_no, nhif_no, nssf_no, basic_pay, tax_relief, hourly_rate, unused_relief, \n"
                            + "            bank, bank_account_no, address, tel_no, town, estate, mobile_no, division, district, village, lasc_no, date, payment_mode, nhifexempt,unionexempt, \n"
                            + "            nssfexempt, payeexempt, lascexempt, suspend, monthly_hours, company_name, bank_branch,  bank_code, branch_code,  email_address,inremental_month,knun_ded,pension,withholding_tax2,directorate,welfare,sacco)"
                            + " values(?,?,?,?,?,?,?,?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?,?,?,?,?,?,?,?,?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
                    ...
                    pstmt.setString(11, designitionTxt.getSelectedItem().toString());
                    ...
                    pstmt.setBoolean(40, payeeChkbx.isSelected());
                    ...
                    pstmt.setString(45, bankBranchTxt.getSelectedItem().toString());
                    pstmt.setString(46, bankCodeTxt.getText());
                    pstmt.setString(47, branchCodeTxt.getText());
                    pstmt.setString(48, emaiTxt.getText());
                    pstmt.setString(49, incrementalMonthCbx.getSelectedItem().toString());
                    pstmt.setBoolean(50, knunCbx.isSelected());
                    pstmt.setBoolean(51, pensionCB.isSelected());
                    pstmt.setBoolean(52, wht2cb.isSelected());
                    pstmt.setString(53, directorsteCmbx.getSelectedItem().toString());
                    pstmt.setString(54, welfareCmbx.getSelectedItem().toString());
                    pstmt.setString(55, sacooCmbx.getSelectedItem().toString());
    ...
    private void logChange(String item, String desc){
        try {
            ...
            pstmt1.setObject(3, employeeNumberTxt.getText());
            pstmt1.setDate(4, com.afrisoftech.lib.SQLDateFormat.getSQLDate(changeDatePicker.getDate()));
    ...
    private void retireBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_retireBtnActionPerformed
        ...
        if(employeeNumberTxt.getText().isEmpty()){
            javax.swing.JOptionPane.showMessageDialog(this, "Select the employee first", "Error Message!", javax.swing.JOptionPane.ERROR_MESSAGE);
            
        }else{
            com.afrisoftech.lib.RetireDateDialog chgPasswd = new com.afrisoftech.lib.RetireDateDialog(new javax.swing.JFrame(), true, connectDB, "Retire", employeeNumberTxt.getText());
...
//        }
    ...
    private void suspendBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_suspendBtnActionPerformed
        ...
        if(employeeNumberTxt.getText().isEmpty()){
            ...
            com.afrisoftech.lib.RetireDateDialog chgPasswd = new com.afrisoftech.lib.RetireDateDialog(new javax.swing.JFrame(), true, connectDB, "Suspend", employeeNumberTxt.getText());
            chgPasswd.setVisible(true);
...
//            pstmt.executeUpdate();
//            suspendedStaffListingTable.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB, "SELECT employee_no, first_name, middle_name, last_name, id_no,  pin_no, gender, department, section, date_employed, date_of_post as posting_date, official_desgnation as designation, suspension_date,false as reinstate from master_file where suspend = true order by employee_no"));
//            javax.swing.JOptionPane.showMessageDialog(this, firstNameTxt.getText() + " " + middleNameTxt.getText() + " " + lastNameTxt.getText() + " Suspended successfully from the masterfile database.");
//        } catch (java.sql.SQLException ex) {
//            ex.printStackTrace();
//        }
        // TODO add your handling code here:
    ...
    private void suspendedStaffListingTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_suspendedStaffListingTableMouseClicked
        // TODO add your handling code here:
    }//GEN-LAST:event_suspendedStaffListingTableMouseClicked

    private void suspendBtn1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_suspendBtn1ActionPerformed

        for (int i = 0; i < suspendedStaffListingTable.getRowCount(); i++) {
            if (Boolean.parseBoolean(suspendedStaffListingTable.getValueAt(i, 13).toString())) {
                try {
                    java.sql.PreparedStatement pstmt = connectDB.prepareStatement("update master_file set suspend = ?, suspension_date = ? WHERE employee_no = ?");
                    pstmt.setBoolean(1, false);
                    pstmt.setDate(2, com.afrisoftech.lib.ServerTime.getSQLDate(connectDB));
                    pstmt.setString(3, suspendedStaffListingTable.getValueAt(i, 0).toString());
                    pstmt.executeUpdate();
                    suspendedStaffListingTable.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB, "SELECT employee_no, first_name, middle_name, last_name, id_no,  pin_no, gender, department, section, date_employed, date_of_post as posting_date, official_desgnation as designation, suspension_date,false as reinstate from master_file where suspend = true order by employee_no"));
                    javax.swing.JOptionPane.showMessageDialog(this, firstNameTxt.getText() + " " + middleNameTxt.getText() + " " + lastNameTxt.getText() + " Reinstated successfully from the masterfile database.");
                } catch (java.sql.SQLException ex) {
                    ex.printStackTrace();
                }
            }
        ...
        // TODO add your handling code here:
    }//GEN-LAST:event_suspendBtn1ActionPerformed

    private void bankBranchTxtActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bankBranchTxtActionPerformed

        try {
            java.sql.Statement stmt = connectDB.createStatement();
            java.sql.ResultSet rset = stmt.executeQuery("SELECT branch_code from banks_branch_setup WHERE bank_code = '" + bankCodeTxt.getText() + "' and branch_name ilike '" + bankBranchTxt.getSelectedItem().toString() + "'");
            while (rset.next()) {
    ...
    }//GEN-LAST:event_bankBranchTxtActionPerformed
    ...
    private javax.swing.JComboBox<String> bankBranchTxt;
    ...
    private com.afrisoftech.lib.DatePicker changeDatePicker;
    ...
    private javax.swing.JComboBox<String> designitionTxt;
    private javax.swing.JComboBox directorsteCmbx;
    private javax.swing.JCheckBox disabledCB;
    ...
    private javax.swing.JLabel employeeGroupLbl1;
    ...
    private javax.swing.JComboBox<String> incrementalMonthCbx;
    ...
    private javax.swing.JCheckBox knunCbx;
    ...
    private javax.swing.JCheckBox policeTaxCB;
    ...
    private javax.swing.JComboBox sacooCmbx;
    private javax.swing.JButton saveBtn;
    private javax.swing.JButton searchButton;
    private javax.swing.JPanel searchPanel;
    private javax.swing.JComboBox sectionCmbx;
    private javax.swing.JLabel sectionLbl;
    private javax.swing.JLabel sectionLbl1;
    private javax.swing.JLabel sectionLbl2;
    ...
    private javax.swing.JScrollPane staffListingScrollPane2;
    ...
    private javax.swing.JButton suspendBtn1;
    private javax.swing.JCheckBox suspendChkbx;
    private javax.swing.JTable suspendedStaffListingTable;
    ...
    private javax.swing.JComboBox welfareCmbx;
    private javax.swing.JCheckBox wht2cb;
    private javax.swing.JCheckBox withholdingTaxChckBox;
