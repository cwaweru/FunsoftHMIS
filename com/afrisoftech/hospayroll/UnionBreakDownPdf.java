...
public class UnionBreakDownPdf implements java.lang.Runnable {
      ...
      */
                    ...
                    try {
                        ...
                        try {
                            ...
                            phrase = new Phrase("UNION" +  "  LIST: " +dateFormat.format(formattedDate), pFontHeader);
...
//                                java.sql.ResultSet rset311 = st311.executeQuery("select count(staff_no) from sacco_deductions np where np.sacco_name = '"+bank+"' and np.staff_no = '"+listofStaffNos[j]+"' group by np.staff_no");
                                ...
                                while (rset.next()){
                                    ...
                                    java.sql.ResultSet rset1 = st3.executeQuery("SELECT   sum(posting.amount) FROM posting,sacco_welfare_members WHERE posting.description ilike 'Union Due' and posting.company_name ='"+bank+"'  and  \n" +
                                    "staff_no=employee_no and staff_no='"+rset.getObject(1)+"' and staff_no='"+rset.getObject(1)+"' and  unions= true and posting.date  between '"+beginDate+"' and '"+endDate+"'  and  upper(sacco_welfare_members.description) =upper('"+listofStaffNos[j]+"')  ");
                                    while(rset1.next()){
                                        contr=rset1.getDouble(1);
                                        totalt=totalt+contr;
                                    ...
                                    table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_RIGHT);
                                    phrase = new Phrase(new com.afrisoftech.sys.Format2Currency().Format2Currency(dbObject.getDBObject(String.valueOf(contr),"0.00")),pFontHeader1);                    
                                    table.addCell(phrase);
...
docPdf.close();  com.afrisoftech.lib.PDFRenderer.renderPDF(tempFile);
    ...
    public java.lang.Object[] getListofStaffNos() {
        ...
        try {
            ...
            java.sql.ResultSet rSet1 = stmt1.executeQuery("SELECT  distinct sacco_welfare_members.description from  sacco_welfare_members where description='"+bank1+"' AND unions=true");
