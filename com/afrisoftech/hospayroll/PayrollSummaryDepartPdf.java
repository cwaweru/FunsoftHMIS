...
public class PayrollSummaryDepartPdf implements java.lang.Runnable {
    ...
    public void PayrollSummaryDepartPdf(java.sql.Connection connDb,java.util.Date begindate,java.util.Date endate,java.lang.String combox) {
    ...
    public java.lang.Object[] getListofStaffDepartment() {
        ...
        try {
            ...
            java.sql.ResultSet rSet1 = stmt1.executeQuery("SELECT DISTINCT department FROM  master_file WHERE company_name ilike '"+bank+"' ORDER BY department");
    ...
    public java.lang.Object[] getListofStaffNos(java.lang.Object dept) {
        ...
        try {
            ...
            java.sql.ResultSet rSet1 = stmt1.executeQuery("SELECT DISTINCT staff_no FROM  posting, master_file WHERE posting.date BETWEEN '"+beginDate+"' AND '"+endDate+"' and posting.company_name ilike '"+bank+"' and master_file.department = '"+dept+"' and posting.staff_no = master_file.employee_no order by posting.staff_no");
