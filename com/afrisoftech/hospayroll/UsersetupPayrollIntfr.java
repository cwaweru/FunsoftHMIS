...
public class UsersetupPayrollIntfr extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        try {
            ...
            java.sql.ResultSet rs = stmt.executeQuery("select DISTINCT item_desc from menu_item_list WHERE app_name = 'hospital_payroll' order by item_desc");
        ...
        this.jList1.setModel(dfListModel);
        */
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Manage activity domains"));
        ...
        jList1.setModel(com.afrisoftech.lib.ListModel.listModel(connectDB, "SELECT item_desc FROM menu_item_list WHERE app_name = 'hospital_payroll' ORDER BY menu_item"));
        ...
        jComboBox1.setModel(com.afrisoftech.lib.ComboBoxModel.ComboBoxModel(connectDB, "select usename from pg_catalog.pg_user where usename !='postgres'"));
        ...
        jPanel5.setBorder(javax.swing.BorderFactory.createTitledBorder("Assign Priveleges"));
        jComboBox4.setModel(com.afrisoftech.lib.ComboBoxModel.ComboBoxModel(connectDB, "select usename from pg_catalog.pg_user where usename !='postgres'"));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 1;
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
        ...
        jPanel6.setBorder(javax.swing.BorderFactory.createTitledBorder("Revoke Priveleges"));
        ...
        jComboBox42.setModel(com.afrisoftech.lib.ComboBoxModel.ComboBoxModel(connectDB, "select usename from pg_catalog.pg_user where usename !='postgres'"));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 1;
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
...
//            this.crset2.execute();
    ...
    private void jComboBox1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBox1ActionPerformed
        ...
        try {
            ...
            java.sql.ResultSet rs = stmt.executeQuery("select menu_list from secure_menu_access where login_name = '"+jComboBox1.getSelectedItem().toString()+"'  AND sys_name ilike 'Hospital_payroll'");
...
//        str = "{"+str+"}";
        ...
        try {
            ...
            java.sql.PreparedStatement pmstmt = connectDB.prepareStatement("begin work;UPDATE secure_menu_access SET menu_list = ? WHERE login_name = ? AND sys_name = 'hospital_payroll' ;commit work");
