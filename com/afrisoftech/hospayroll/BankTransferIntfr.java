 ...
 * @author root
 */
public class BankTransferIntfr extends javax.swing.JInternalFrame implements java.lang.Runnable {
    ...
    public BankTransferIntfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {
        ...
        */
        ...
        jCheckBox1.setText("Bank Transfer");
        ...
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
        jPanel52.add(jCheckBox1, gridBagConstraints);

        buttonGroup1.add(jCheckBox2);
        jCheckBox2.setText("Bank List");
        ...
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
        jPanel52.add(jCheckBox2, gridBagConstraints);
...
//            }
    ...
    private void jCheckBox1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jCheckBox1ActionPerformed
        ...
        jTable11.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB, "select upper(mf.first_name||' '||mf.middle_name||' '||last_name) as name,mf.bank,mf.branch_code,sum(ep.amount) AS net_pay,mf.bank_account_no,mf.employee_no from master_file mf, net_pay_view ep where ep.staff_no = mf.employee_no  and mf.payment_mode ='Bank Transfer'  and mf.company_name ='"+jComboBox3.getSelectedItem().toString()+"' and ep.date BETWEEN '" + datePicker1.getDate() + "' AND '" + datePicker2.getDate() + "' group by name,mf.employee_no, mf.bank,mf.branch_code,mf.bank_account_no HAVING sum(ep.amount) > 0"));
    ...
    private void jCheckBox2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jCheckBox2ActionPerformed
        jTable11.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB, "select mf.bank,sum(ep.amount) AS net_pay from master_file mf, net_pay_view ep where ep.staff_no = mf.employee_no  and mf.payment_mode ='Bank Transfer' and mf.company_name ='"+jComboBox3.getSelectedItem().toString()+"' and ep.date BETWEEN '" + datePicker1.getDate() + "' AND '" + datePicker2.getDate() + "' group by mf.bank HAVING sum(ep.amount) > 0"));

        Double total = 0.00;
        total = com.afrisoftech.lib.TableColumnTotal.getTableColumnTotal(jTable11, 1);  
        jFormattedTextField1.setText(com.afrisoftech.lib.CurrencyFormatter.getFormattedDouble(total));
// TODO add your handling code here:
