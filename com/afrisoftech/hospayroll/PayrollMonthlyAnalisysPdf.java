...
public class PayrollMonthlyAnalisysPdf implements java.lang.Runnable {
    ...
    com.lowagie.text.Font pFontHeaderx = FontFactory.getFont(FontFactory.TIMES, 11, Font.BOLD);
    ...
    public void PayrollMonthlyAnalisysPdf(java.sql.Connection connDb, java.util.Date begindate, java.util.Date endate, java.lang.String combox) {
                ...
                try {
                    ...
                    try {
                        ...
                        try {
                            ...
                            phrase = new Phrase(bank.toUpperCase()+" PAYROLL ANALYSIS", pFontHeaderx);
                            table.addCell(phrase);

                            table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT); 
                            table.getDefaultCell().setColspan(3);
                            phrase = new Phrase("Pay Period :   " + dateFormat.format(endDate11) + " To " + dateFormat.format(endDate1), pFontHeader);
                            table.addCell(phrase);
                        ...
                        try {
                            ...
                            phrase = new Phrase("Code".toUpperCase(), pFontHeader);
                            table.addCell(phrase);
                            ...
                            phrase = new Phrase("Amount".toUpperCase(), pFontHeader);
                            table.addCell(phrase);
...
//                            }
                            ...
                            for (int m = 0; m < listofAct4.length; m++) {
                                ...
                                table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                                table.getDefaultCell().setColspan(1);
                                phrase = new Phrase(getCode(listofAct4[m].toString()), pFontHeader);
                                table.addCell(phrase);
                              ...
                              //  for (int t = 0; t < rangeDates.length; t++) {
                                    java.sql.ResultSet rset1 = st31.executeQuery("select sum(amount) from posting where  description =  '" + listofAct4[m] + "' AND date BETWEEN '" + beginDate + "' AND '" + endDate + "' AND allowance_deduction ILIKE 'Earning%' and company_name ilike '" + bank + "'");
                                    ...
                                    while (rset1.next()) {
                                        ...
                                        columnTotals[0] = columnTotals[0] + rset1.getDouble(1);
                                    }
...
//                            for (int t = 0; t < rangeDates.length; t++) {
                                java.sql.ResultSet rset11 = st31.executeQuery("select sum(amount) from posting where date BETWEEN '" + beginDate + "' AND '" + endDate + "' AND allowance_deduction ILIKE 'Earning%' and company_name ilike '" + bank + "'");
...
//                            }
                            ...
                            for (int n = 0; n < listofAct5.length; n++) {
                                ...
                                table.getDefaultCell().setColspan(1);
                                phrase = new Phrase(getCode(listofAct5[n].toString()), pFontHeader);
                                table.addCell(phrase); 
...
//                                for (int s = 0; s < rangeDates.length; s++) {
                                     rset11 = st31.executeQuery("select sum(amount) from posting where description =  '" + listofAct5[n] + "' AND date BETWEEN '" + beginDate + "' AND '" + endDate + "' and company_name ilike '" + bank + "'");
                                    ...
                                    while (rset11.next()) {
                                        ...
                                        table.addCell(phrase);
                                        columnTotals[1] = columnTotals[1] + rset11.getDouble(1);
                                    }
//                                }
                            }
...
//                            for (int t = 0; t < rangeDates.length; t++) {
                                java.sql.ResultSet rset1A = st3A.executeQuery("select sum(amount) from posting where date BETWEEN '" + beginDate + "' AND '" + endDate + "'  AND allowance_deduction ILIKE 'NON CASH%' and company_name ilike '" + bank + "'");
...
//                            for (int t = 0; t < rangeDates.length; t++) {
                                rsetTotals1 = st4.executeQuery("SELECT sum(pt.amount) from posting pt WHERE pt.date BETWEEN '" + beginDate + "' AND '" + endDate + "' AND (pt.allowance_deduction ILIKE 'Earning%' OR pt.allowance_deduction ILIKE 'non%') and company_name ilike '" + bank + "'");
...
//                            }
                            ...
                            for (int n = 0; n < listofAct6.length; n++) {
                                ...
                                table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                                table.getDefaultCell().setColspan(1);
                                phrase = new Phrase(getCode(listofAct6[n].toString()), pFontHeader);
                                table.addCell(phrase);
...
//                                for (int s = 0; s < rangeDates.length; s++) {
                                     rset11 = st31.executeQuery("select sum(amount) from posting where  description ilike  '" + listofAct6[n] + "' AND date BETWEEN '" + beginDate + "' AND '" + endDate + "' and company_name ilike '" + bank + "'");
...
//                                }
                            ...
                            table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                            phrase = new Phrase("".toUpperCase(), pFontNum11);
                            table.addCell(phrase);
                            ...
                            table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_RIGHT);
//                            for (int s = 0; s < rangeDates.length; s++) {
                                 rset11 = st31.executeQuery("select sum(amount) from posting where  date BETWEEN '" + beginDate + "' AND '" + endDate + "' AND allowance_deduction ILIKE 'Less Re%' and company_name ilike '" + bank + "'");
...
//                            for (int t = 0; t < rangeDates.length; t++) {
                                ...
                                rsetTotals1 = st4.executeQuery("SELECT sum(pt.amount) from posting pt,deductions_allowances da WHERE  pt.date BETWEEN '" + beginDate + "' AND '" + endDate + "' AND pt.description::text ~~* da.description::text AND da.taxable = true AND da.benefit = true and company_name ilike '" + bank + "'");
...
//                            for (int t = 0; t < rangeDates.length; t++) {kk
 
                                java.sql.ResultSet rset14 = st14.executeQuery("select sum(tx.amount) from posting tx where  tx.date BETWEEN '" + beginDate + "' AND '" + endDate + "' AND (tx.description ILIKE 'PAYE%' OR tx.description ILIKE 'Monthly Personal Relief%' OR tx.description ILIKE 'P.A.Y.E%') and company_name ilike '" + bank + "'");
                                while (rset14.next()) {
                                    table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_RIGHT);
...
//                            for (int t = 0; t < rangeDates.length; t++) {
                                rset14 = st14.executeQuery("select sum(tx.amount) from posting tx where tx.date BETWEEN '" + beginDate + "' AND '" + endDate + "' AND tx.description ILIKE 'Monthly Personal Relief%' and company_name ilike '" + bank + "'");
                                while (rset14.next()) {
                                    table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_RIGHT);
                                    phrase = new Phrase(new com.afrisoftech.sys.Format2Currency().Format2Currency(rset14.getString(1)), pFontNum);
                                    table.addCell(phrase);
...
//                            for (int t = 0; t < rangeDates.length; t++) {
                                rset14 = st14.executeQuery("select sum(tx.amount) from posting tx where tx.date BETWEEN '" + beginDate + "' AND '" + endDate + "' AND (tx.description ILIKE 'PAYE%' OR tx.description ILIKE 'P.A.Y.E%') and company_name ilike '" + bank + "'");
                                while (rset14.next()) {
                                    table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_RIGHT);
                                    phrase = new Phrase(new com.afrisoftech.sys.Format2Currency().Format2Currency(rset14.getString(1)), pFontNum);
                                    table.addCell(phrase);
...
//                            }
                            ...
                            table.getDefaultCell().setColspan(1);
                            table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                            phrase = new Phrase(getCode(listofAct[k].toString()), pFontNum11);
                            table.addCell(phrase);
...
//                                for (int t = 0; t < rangeDates.length; t++) {
                                    ...
                                    java.sql.ResultSet rset17 = st17.executeQuery("select sum(av.amount) as amount from posting av where av.date BETWEEN '" + beginDate + "' AND '" + endDate + "' and av.description ilike '" + listofAct[k] + "' and company_name ilike '" + bank + "'");
...
//                            for (int t = 0; t < rangeDates.length; t++) {
                                java.sql.ResultSet rset18 = st18.executeQuery("select sum(dv.amount) from deduction_summary dv where dv.date BETWEEN '" + beginDate + "' AND '" + endDate + "' and dv.company_name ilike '"+bank+"' ");
                                while (rset18.next()) {
                                    table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_RIGHT);
...
//                            }
                            ...
                            int staffCount=0;
//                            for (int t = 0; t < rangeDates.length; t++) {
                                java.sql.ResultSet rset19 = st19.executeQuery("select sum(amount) from net_pay_view dv where dv.date BETWEEN '" + beginDate + "' AND '" + endDate + "' and company_name ilike '" + bank + "'");
                                while (rset19.next()) {
                                    table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_RIGHT);
                                ...
                                rset19 = st19.executeQuery("select count(distinct staff_no) from net_pay_view dv where dv.date BETWEEN '" + beginDate + "' AND '" + endDate + "' and company_name ilike '" + bank + "' AND amount !=0  ");
                                while (rset19.next()) {
                                    staffCount = rset19.getInt(1);
                                }
                                ...
                                phrase = new Phrase("",pFontNum);
                                table.addCell(phrase);
                                phrase = new Phrase("Information".toUpperCase(),pFontHeader);
                                table.addCell(phrase);
                                phrase = new Phrase("",pFontNum);
                                table.addCell(phrase);

                                java.sql.ResultSet rset1As = st3A.executeQuery("select sum(amount)*2 from posting where date BETWEEN '"+beginDate+"' AND '"+endDate+"'  AND description ILIKE 'Pension Contr. self' and company_name ilike '"+bank+"' ");
                                ...
                                while(rset1As.next()){
                                    if(rset1As.getDouble(1)>0){
                                        ...
                                        table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_RIGHT);
                                        phrase = new Phrase(new com.afrisoftech.sys.Format2Currency().Format2Currency(rset1As.getString(1)),pFontNum);
                                        table.addCell(phrase);
                                 ...
                                 rset1As = st3A.executeQuery("select sum(amount) from posting where date BETWEEN '"+beginDate+"' AND '"+endDate+"'  AND description ILIKE 'N.S.S.F' and company_name ilike '"+bank+"' ");
                                ...
                                phrase = new Phrase("",pFontNum);
                                table.addCell(phrase);
                                phrase = new Phrase("Balances".toUpperCase(),pFontHeader);
                                table.addCell(phrase);
                                phrase = new Phrase("",pFontNum);
                                table.addCell(phrase);


                                rset1As = st3A.executeQuery("SELECT sacco_name,SUM(amount),sum( deducted_amount), \n" +
...
"                                 THEN SUM(amount)+SUM(deducted_amount)   ELSE SUM(amount)-SUM(deducted_amount) END  as \n" +
"                                  balance  FROM payroll_balances2 where sacco_name not ilike 'Staff Welfare' AND sacco_name not\n" +
"                                   ilike 'UNION DUE' AND company_name ilike '"+bank+"'  GROUP BY 1 ORDER BY 1");
                                
                                
                                
                                //rset1As = st3A.executeQuery("select sacco_name, sum(amount) from payroll_balances WHERE sacco_name not ilike 'Staff Welfare' AND sacco_name not ilike 'UNION DUE' AND company_name ilike '"+bank+"' GROUP BY 1 ");
                                ...
                                while(rset1As.next()){ 
                                    ...
                                    phrase = new Phrase("",pFontNum);
                                        ...
                                        phrase = new Phrase(new com.afrisoftech.sys.Format2Currency().Format2Currency(rset1As.getString(4)), pFontHeader);
                                        table.addCell(phrase);
...
//                                rset1As = st3A.executeQuery("select description, sum(amount) from payroll_openning_bals  GROUP BY 1 ");
//                                
//                                while(rset1As.next()){
//                                    
//                                    phrase = new Phrase("",pFontNum);
...
//                                }
                                ...
                                phrase = new Phrase("",pFontNum);
                                table.addCell(phrase);
                                phrase = new Phrase("Staff count  : " .toUpperCase()+staffCount,pFontHeader);
                                table.addCell(phrase);
                                phrase = new Phrase("",pFontNum);
                                table.addCell(phrase);
...
//                            }hh
    ...
    public String getCode(String name) {
        ...
        try {
            java.sql.Statement stmt1 = connectDB.createStatement();
            java.sql.ResultSet rSet1 = stmt1.executeQuery("SELECT DISTINCT code FROM deductions_allowances  WHERE upper(description) =   '" + name.toUpperCase() + "' ");
            while (rSet1.next()) {
    ...
    public java.lang.Object[] getListofActivities4() {
        ...
        try {
            ...
            java.sql.ResultSet rSet1 = stmt1.executeQuery("SELECT DISTINCT description,(SELECT code from deductions_allowances where upper(posting.description)=upper(deductions_allowances.description) )  FROM posting where date BETWEEN '" + beginDate + "' AND '" + endDate + "' AND allowance_deduction ilike 'earning%' and company_name ilike '" + bank + "' order by 2");
