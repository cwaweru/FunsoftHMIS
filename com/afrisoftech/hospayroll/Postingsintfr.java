  ...
  */
    ...
    private void jButton152ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton152ActionPerformed
        ...
        try {
            ...
            java.sql.ResultSet rsetTable1 = stmtTable1.executeQuery("select description,amount,hoursdays from posting_journal where staff_no = '"+jTextField91.getText()+"' and processed = false and approved = false  order by amount");
                ...
                for (int k = 0; k < jTable11.getRowCount(); k++){
                    if (jTable11.getModel().getValueAt(k,0) != null){
                        ...
                        if(j < 1){
                            ...
                            java.sql.PreparedStatement pstmt31 = connectDB.prepareStatement("UPDATE posting_journal SET amount = '"+jTable11.getModel().getValueAt(k,1)+"',hoursdays = '"+jTable11.getModel().getValueAt(k,2)+"'  WHERE description ilike  '"+jTable11.getValueAt(k,0).toString()+"' AND staff_no = '"+jTextField91.getText()+"'  AND processed = false AND approved = false");
