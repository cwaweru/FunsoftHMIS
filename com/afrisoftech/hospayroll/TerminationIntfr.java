 ...
 * @author root
 */
public class TerminationIntfr extends javax.swing.JInternalFrame implements java.lang.Runnable {
    ...
    public TerminationIntfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {
        ...
        */
        ...
        reasonTxt.setModel(com.afrisoftech.lib.ComboBoxModel.ComboBoxModel(connectDB, "select '-' union select reason from payroll_termination_reasons  order by 1"));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 2;
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
        ...
        jPanel211.setBorder(javax.swing.BorderFactory.createTitledBorder("Termination List\u0000"));
        ...
        jTable11.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "A/C No", "Staff No.", "Staff Name", "Id No"
            }
        ) {
        ...
        jPanel211.getAccessibleContext().setAccessibleName("Termination List");
...
//            jFormattedTextField1.setText(com.afrisoftech.lib.CurrencyFormatter.getFormattedDouble(total));
    ...
    private void jButton202ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton202ActionPerformed
        ...
        if(reasonTxt.getSelectedItem().toString().equalsIgnoreCase("-")){
             jTable11.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB, "select  DISTINCT staff_no, staff_name, id_no, date_of_employment, gender, desgination,department, job_group, reason, comments, termination_date, user_name, trans_date::date  FROM payroll_terminations  where termination_date BETWEEN '" + datePicker1.getDate() + "' AND '" + datePicker2.getDate() + "'  order by termination_date "));

        }else{
             jTable11.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB, "select DISTINCT staff_no, staff_name, id_no, date_of_employment, gender, desgination,department, job_group, reason, comments, termination_date, user_name, trans_date::date FROM payroll_terminations  where termination_date BETWEEN '" + datePicker1.getDate() + "' AND '" + datePicker2.getDate() + "' and reason ilike '"+reasonTxt.getSelectedItem().toString()+"' order by termination_date "));
