 ...
 * @author root
 */
public class BankLoanReportIntfr extends javax.swing.JInternalFrame implements java.lang.Runnable {
    ...
    public BankLoanReportIntfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {
        ...
        */
        ...
        jComboBox4.setModel(com.afrisoftech.lib.ComboBoxModel.ComboBoxModel(connectDB, "SELECT '-' UNION select upper(description) as description from deductions_allowances    ORDER BY 1"));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 3;
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
...
//            }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        jTable11.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB, "SELECT staff_no, staff_name, description, amount, (SELECT id_no FROM master_file where employee_no=staff_no ),(SELECT pin_no FROM master_file where employee_no=staff_no )\n"
                + "   FROM posting WHERE description ilike '" + jComboBox4.getSelectedItem().toString() + "' AND date between '"+datePicker1.getDate()+"' AND '"+datePicker2.getDate()+"' AND company_name ILIKE '" + jComboBox3.getSelectedItem().toString() + "'"));
        //,'' as institution,'' as institution_no,'' as account_no
        for (int i = 0; i < jTable11.getRowCount(); i++) {
            try {
                java.sql.Statement stmtTable1 = connectDB.createStatement();
                java.sql.ResultSet rsetTable1 = stmtTable1.executeQuery("SELECT branch,sacco_no,loan_account FROM sacco_deductions where staff_no ILIKE '" + jTable11.getValueAt(i, 0) + "' and upper(sacco_name)=upper('"+jComboBox4.getSelectedItem().toString()+"') ");
