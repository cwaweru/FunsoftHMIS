...
public class SendPayslipPerStaff implements java.lang.Runnable {
    ...
    com.lowagie.text.Font pFontHeader = FontFactory.getFont(FontFactory.COURIER, 7, Font.BOLD);
    com.lowagie.text.Font pFontNum = FontFactory.getFont(FontFactory.COURIER, 6, Font.NORMAL);
    com.lowagie.text.Font pFontNum1 = FontFactory.getFont(FontFactory.COURIER, 8, Font.BOLD);
    //   com.lowagie.text.ParagraphFont pgraph = Paragraph();
    java.lang.Runtime rtThreadSample = java.lang.Runtime.getRuntime();
    java.lang.Process prThread;

    public void SendPayslipPerStaff(java.sql.Connection connDb, java.util.Date begindate, java.util.Date endate, java.lang.String staffno) {
    ...
    public void generatePdf() {
        ...
        java.io.File tempFile = new java.io.File(System.getProperty("user.dir"), com.afrisoftech.lib.StaffDetails.getStaffEmail(connectDB, StaffNo)+" "+ getDateLable()+".pdf"); //.createTempFile(getDateLable() + "_", ".pdf");
        ...
        filesVector.addElement(tempFile);
        ...
        biz.systempartners.claims.AdvancedSendFile.SendFile(connectDB, filesArray, emailsArray, null, null, "Payslip for : "+StaffNo+" "+com.afrisoftech.lib.StaffDetails.getStaffName(connectDB, StaffNo), tempFile.toString().replace(".pdf", ""));
