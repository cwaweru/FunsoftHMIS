 ...
 * @author root
 */
public class TransactionStatementintfr extends javax.swing.JInternalFrame implements java.lang.Runnable {
    ...
    public TransactionStatementintfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
...
//        jTextField1.setText(jSearchTable2.getValueAt(jSearchTable2.getSelectedRow(), 2).toString());
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
       ...
       jTable2.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB, "SELECT   description, amount, allowance_deduction,      date\n" +
"  FROM public.posting where staff_no = '"+jTextField91.getText()+"' and date between '"+datePicker1.getDate()+"' and '"+datePicker2.getDate()+"' order by 1  "));
