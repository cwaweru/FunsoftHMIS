 ...
 * @author root
 */
public class MasterFileintfr1 extends javax.swing.JInternalFrame {
    ...
    public MasterFileintfr1(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {
        ...
        */
        ...
        bankNameCmbx.setModel(com.afrisoftech.lib.ComboBoxModel.ComboBoxModel(connectDB, "select bank_name as bank_name from banks_setup order by bank_name"));
        ...
        withholdingTaxChckBox.setText("Withholding Tax");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 4;
        gridBagConstraints.gridy = 0;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
    ...
    private void editBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editBtnActionPerformed
        ...
        try {
            ...
            java.sql.ResultSet rset = stmt.executeQuery("SELECT employee_no, first_name, middle_name, last_name, id_no,"
                    ...
                    + "lascexempt, suspend, monthly_hours, company_name,email_address,withholding_tax,police_tax,branch_code,bank_code,pension,disabled,bank_branch FROM master_file where employee_no = '" + employeeNumberTxt.getText() + "'");
        ...
        try {
            ...
            if (saveBtn.getLabel().equalsIgnoreCase("Update")) {
                ...
                java.sql.PreparedStatement pstmtx = connectDB.prepareStatement("UPDATE master_file SET first_name = ?,"
                        ...
                        + "monthly_hours = ?, company_name = ?,disabled=?,email_address=?, bank_branch = ? ,bank_code=?,"
                        + "branch_code=?,pension=?,withholding_tax=?,police_tax=? WHERE employee_no = '" + employeeNumberTxt.getText() + "'");
                ...
                pstmtx.setBoolean(47, pensionCB.isSelected());
                pstmtx.setBoolean(48, withholdingTaxChckBox.isSelected());
                pstmtx.setBoolean(49, policeTaxCB.isSelected());
                ...
                java.sql.PreparedStatement pstmt = connectDB.prepareStatement("insert into master_file  (  employee_no, first_name, middle_name, last_name, id_no, birth_date,  nationality, marital_status, gender, date_employed, official_desgnation, \n"
                        ...
                        + "            nssfexempt, payeexempt, lascexempt, suspend, monthly_hours, company_name, bank_branch,  bank_code, branch_code,  email_address,disabled,withholding_tax,police_tax)"
                        + " values(?,?,?,?,?,?,?,?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?,?,?,?,?,?,?,?,?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
                ...
                pstmt.setBoolean(49, disabledCB.isSelected());
                pstmt.setBoolean(50, withholdingTaxChckBox.isSelected());
                pstmt.setBoolean(51, policeTaxCB.isSelected());
        ...
        for (int i = 0; i < suspendedStaffListingTable.getRowCount(); i++) {
            if (Boolean.parseBoolean(suspendedStaffListingTable.getValueAt(i, 13).toString())) {
                try {
                    ...
                    pstmt.setDate(2, com.afrisoftech.lib.ServerTime.getSQLDate(connectDB));
                    pstmt.setString(3, suspendedStaffListingTable.getValueAt(i, 13).toString());
                    pstmt.executeUpdate();
                    suspendedStaffListingTable.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB, "SELECT employee_no, first_name, middle_name, last_name, id_no,  pin_no, gender, department, section, date_employed, date_of_post as posting_date, official_desgnation as designation, suspension_date,false as reinstate from master_file where suspend = true order by employee_no"));
                    javax.swing.JOptionPane.showMessageDialog(this, firstNameTxt.getText() + " " + middleNameTxt.getText() + " " + lastNameTxt.getText() + " Suspended successfully from the masterfile database.");
                } catch (java.sql.SQLException ex) {
