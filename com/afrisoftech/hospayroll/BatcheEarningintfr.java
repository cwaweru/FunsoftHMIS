...
public class BatcheEarningintfr extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jComboBox4.setModel(com.afrisoftech.lib.ComboBoxModel.ComboBoxModel(connectDB, "SELECT '-' UNION SELECT DISTINCT inremental_month FROM master_file ORDER BY 1"));
        gridBagConstraints = new java.awt.GridBagConstraints();
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "STAFF NO", "NAME", "CURRENT AMOUNT", "NEW AMOUNT"
            }
        ) {
        ...
        jComboBox6.setModel(com.afrisoftech.lib.ComboBoxModel.ComboBoxModel(connectDB, "SELECT '-' UNION SELECT distinct description from deductions_allowances  ORDER BY 1"));
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        try {
            ...
            if (jComboBox6.getSelectedItem().toString().equalsIgnoreCase("-") || jComboBox5.getSelectedItem().toString().equalsIgnoreCase("-")) {
                ...
                java.sql.ResultSet rst = pss.executeQuery("select allowance_deduction from deductions_allowances where description ILIKE '" + jComboBox6.getSelectedItem().toString() + "'");
                while (rst.next()) {
                ...
                for (int i = 0; i < jTable1.getRowCount(); i++) {
                    if (jTable1.getValueAt(i, 0) != null) {
                        ...
                        System.err.println("SELECT count(description)  FROM allowances_benefits WHERE description ilike  '" + jComboBox6.getSelectedItem().toString() + "' AND staff_no = '" + jTable1.getValueAt(i, 0).toString() + "' AND  company_name  = '" + jComboBox5.getSelectedItem().toString() + "' ");
                        int j = 0;
                        java.sql.Statement stmtTable11 = connectDB.createStatement();
                        java.sql.ResultSet rsetTable11 = stmtTable11.executeQuery("SELECT count(description)  FROM allowances_benefits WHERE description ilike  '" + jComboBox6.getSelectedItem().toString() + "' AND staff_no = '" + jTable1.getValueAt(i, 0).toString() + "' AND  company_name  = '" + jComboBox5.getSelectedItem().toString() + "' ");
                        ...
                        if (j > 0) {
                            java.sql.PreparedStatement pstmt2 = connectDB.prepareStatement("UPDATE allowances_benefits SET amount = '" + Double.valueOf(jTable1.getValueAt(i, 3).toString()) + "'  "
                                    + " WHERE description = '" + jComboBox6.getSelectedItem().toString() + "' AND staff_no = '" + jTable1.getValueAt(i, 0).toString() + "' AND company_name  = '" + jComboBox5.getSelectedItem().toString() + "' ");
                            pstmt2.executeUpdate();
                        } else {
                            java.sql.PreparedStatement pstmt1 = connectDB.prepareStatement("INSERT INTO public.allowances_benefits"
                                    + "(staff_no, staff_name, grade, description, amount, department, trans_type, acc_bal, company_name)\n"
                                    + "VALUES (?, ?, ?, ?, ?, ?,  ?, ?, ?);");

                            pstmt1.setString(1, jTable1.getValueAt(i, 0).toString());
                            pstmt1.setString(2, jTable1.getValueAt(i, 1).toString());
                            pstmt1.setObject(3, "");
                            pstmt1.setString(4, jComboBox6.getSelectedItem().toString());
                            pstmt1.setDouble(5, java.lang.Double.valueOf(jTable1.getValueAt(i, 3).toString()));
                            pstmt1.setString(6, "");
                            pstmt1.setString(7, Desc2);
                ...
                javax.swing.JOptionPane.showMessageDialog(new java.awt.Frame(), jComboBox6.getSelectedItem().toString() + " Increment Effected Successfully!", "Information Message!", javax.swing.JOptionPane.INFORMATION_MESSAGE);
...
//                    + "master_file WHERE ab.company_name = '" + jComboBox5.getSelectedItem().toString() + "' AND description = '" + jComboBox6.getSelectedItem().toString() + "' AND staff_no = employee_no  "));
//        }else{
//            jTable1.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB, "SELECT staff_no, staff_name,employee_grade as scale,inremental_month  as incremental_month , official_desgnation ,amount   FROM allowances_benefits ab,\n"
//                    + "master_file WHERE ab.company_name = '" + jComboBox5.getSelectedItem().toString() + "' AND description = '" + jComboBox6.getSelectedItem().toString() + "' AND staff_no = employee_no AND inremental_month = '" + jComboBox4.getSelectedItem().toString() + "' "));
//        
