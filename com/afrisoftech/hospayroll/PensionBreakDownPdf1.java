...
public class PensionBreakDownPdf1 implements java.lang.Runnable {
      ...
      */
                    ...
                    try {
                        ...
                        try {
                            ...
                            phrase = new Phrase("PENSION" +  "  LIST: " +dateFormat.format(formattedDate), pFontHeader);
                        ...
                        phrase = new Phrase("Pension Self.",pFontHeader);
                        table.addCell(phrase);
                        
                        
                        phrase = new Phrase("Pension Self2",pFontHeader);
                        table.addCell(phrase);
                        
                        phrase = new Phrase("Company Contribution",pFontHeader);
                        table.addCell(phrase);
                        ...
                        try {
                            ...
                            Double pensionselft=0.00;
                            Double pensionself2t=0.00;
                            Double pensioncompanyt=0.00;
...
//                                    System.err.println("Working for ...................."+listofStaffNos[j]);
                                ...
                                java.sql.ResultSet rset = st.executeQuery("SELECT distinct employee_no  from master_file where company_name  ilike  '"+bank+"' order by 1");// tn,debit_note db WHERE tn.policy_no != '' and tn.policy_no = db.policy_no GROUP BY tn.policy_no,db.policy_class");
...
//                                java.sql.ResultSet rset311 = st311.executeQuery("select count(staff_no) from sacco_deductions np where np.sacco_name = '"+bank+"' and np.staff_no = '"+listofStaffNos[j]+"' group by np.staff_no");
                                ...
                                while (rset.next()){
                                    ...
                                    Double pensionself=0.00;
                                    Double pensionself2=0.00;
                                    Double pensioncompany=0.00;
                                    
                                    
                                    java.sql.ResultSet rset1 = st3.executeQuery("SELECT   sum(posting.amount) FROM posting WHERE posting.description ilike 'Pension Contr. Self' and posting.company_name ='"+bank+"'   and staff_no='"+rset.getObject(1)+"' and posting.date  between '"+beginDate+"' and '"+endDate+"'    ");
                                    while(rset1.next()){
                                        pensionself=rset1.getDouble(1);
                                        pensionselft=pensionselft+pensionself;
                                    }
                                    
                                    rset1 = st3.executeQuery("SELECT   sum(posting.amount) FROM posting WHERE posting.description ilike 'Pension Contr. Self 2' and posting.company_name ='"+bank+"'   and staff_no='"+rset.getObject(1)+"' and posting.date  between '"+beginDate+"' and '"+endDate+"'   ");
                                    while(rset1.next()){
                                        pensionself2=rset1.getDouble(1);                                 
                                        pensionself2t=pensionself2t+pensionself2;
                                    }
                                    
                                    
                                        pensioncompany=pensionself*2;
                                        pensioncompanyt=pensioncompanyt+pensioncompany;
                                    
                                   
                                    
                                    
                                    total=pensionself+pensionself2+pensioncompany;
                                    totalt=totalt+total;
                                    
                                    
                                    table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_RIGHT);
                                    phrase = new Phrase(new com.afrisoftech.sys.Format2Currency().Format2Currency(dbObject.getDBObject(String.valueOf(pensionself),"0.00")),pFontHeader1);                    
                                    table.addCell(phrase);
                                    
                                    table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_RIGHT);
                                    phrase = new Phrase(new com.afrisoftech.sys.Format2Currency().Format2Currency(dbObject.getDBObject(String.valueOf(pensionself2),"0.00")),pFontHeader1);                    
                                    table.addCell(phrase);
                                    
                                    table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_RIGHT);
                                    phrase = new Phrase(new com.afrisoftech.sys.Format2Currency().Format2Currency(dbObject.getDBObject(String.valueOf(pensioncompany),"0.00")),pFontHeader1);                    
                                    table.addCell(phrase);
                                ...
                                table.getDefaultCell().setColspan(1);
                                table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_RIGHT);
                                phrase = new Phrase(new com.afrisoftech.sys.Format2Currency().Format2Currency(dbObject.getDBObject(String.valueOf(pensionselft),"0.00")),pFontHeader);                    
                                table.addCell(phrase);
                                
                                table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_RIGHT);
                                phrase = new Phrase(new com.afrisoftech.sys.Format2Currency().Format2Currency(dbObject.getDBObject(String.valueOf(pensionself2t),"0.00")),pFontHeader);                    
                                table.addCell(phrase);
                                
                                
                                
                                table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_RIGHT);
                                phrase = new Phrase(new com.afrisoftech.sys.Format2Currency().Format2Currency(dbObject.getDBObject(String.valueOf(pensioncompanyt),"0.00")),pFontHeader);                    
                                table.addCell(phrase);
...
docPdf.close();  com.afrisoftech.lib.PDFRenderer.renderPDF(tempFile);
    ...
    public java.lang.Object[] getListofStaffNos() {
        ...
        try {
            ...
            java.sql.ResultSet rSet1 = stmt1.executeQuery("SELECT  distinct sacco_welfare_members.description from  sacco_welfare_members where description='"+bank1+"' AND pension=true");
