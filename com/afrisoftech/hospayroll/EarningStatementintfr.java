 ...
 * @author root
 */
public class EarningStatementintfr extends javax.swing.JInternalFrame implements java.lang.Runnable {
    ...
    public EarningStatementintfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {
        ...
        */
        ...
        jTabbedPane1.addTab("Earning Statement", jPanel1);
...
//        jTextField1.setText(jSearchTable2.getValueAt(jSearchTable2.getSelectedRow(), 2).toString());
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        jTable2.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB, "SELECT  date,initcap(to_char(to_timestamp ((EXTRACT(MONTH FROM posting.date))::text, 'MM'), 'TMmon')) || ',' || date_part('year', date) as period,"
                + "amount ,0 as balance  FROM posting WHERE description ilike '" + jComboBox2.getSelectedItem().toString() + "'  "
                        + "and staff_no ='" + jTextField91.getText() + "' AND date BETWEEN '"+datePicker1.getDate()+"' AND '"+datePicker2.getDate()+
                "' union SELECT  null as date,'TOTAL' as period, 0  as amount ,0 as balance   order by date "));
