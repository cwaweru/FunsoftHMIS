...
public class MessagePdf implements java.lang.Runnable {
    ...
    public void MessagePdf(java.sql.Connection connDb, java.lang.String staffno) {
        patNo = staffno;
        connectDB = connDb;
          ...
          //  com.lowagie.text.Document docPdf = new com.lowagie.text.Document(PageSize.A4.rotate());
            ...
            try {
                ...
                try {
                    ...
                    com.lowagie.text.HeaderFooter footer = new com.lowagie.text.HeaderFooter(new Phrase("Message - Page: "), true);// FontFactory.getFont(com.lowagie.text.FontFactory.HELVETICA, 12, Font.BOLDITALIC,java.awt.Color.blue));
                    ...
                    try {
                        ...
                        int headerwidths[] = {12,12,8,8,8,18};
                        ...
                        Phrase phrase = new Phrase("", pFontHeader);
                         ...
                         phrase = new Phrase("Messsage No: "+patNo , pFontHeader);
                        ...
                        phrase = new Phrase("Date Sent",pFontHeader);
                        table.addCell(phrase);
                        ...
                        table.addCell(phrase);
                        phrase = new Phrase("Message",pFontHeader);
                        table.addCell(phrase);
                        ...
                        //  table.getDefaultCell().setBorderColor(java.awt.Color.WHITE);
                          try {
                            ...
                            java.sql.ResultSet rset = st.executeQuery("select input_date::date ||input_date::time(0),initcap(sender_name),user_name,dept,priority,initcap(description) from pb_tasks where task_no = '"+patNo+"' and receipient = current_user");
