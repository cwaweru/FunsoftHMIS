...
public class AllocateAllowanceintfr extends javax.swing.JInternalFrame implements java.lang.Runnable {
    ...
    private void jTextField113CaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextField113CaretUpdate
        if(jTextField113.getCaretPosition() < 2){
            ...
            jSearchTable2.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"select employee_no,first_name||' '||middle_name||' '||last_name AS name,department,company_name from master_file where first_name||' '||middle_name||' '||last_name ILIKE '%"+jTextField113.getText()+"%'"));
