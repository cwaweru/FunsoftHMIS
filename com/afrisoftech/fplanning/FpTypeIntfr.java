 ...
 * @author  postgres
 */
public class FpTypeIntfr extends javax.swing.JInternalFrame {
    ...
    public FpTypeIntfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {
        ...
        setMaximizable(true);
        setResizable(true);
        setTitle("Family Planning Services Setup");
        setVisible(true);
        ...
        jLabel1.setText("Set FP Services here");
    ...
    private void deleteActionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteActionActionPerformed
        try{
            ...
            java.sql.PreparedStatement pstmt31 = connectDB.prepareStatement("DELETE from fp_services WHERE fp_service_code = '"+jTable1.getModel().getValueAt(jTable1.getSelectedRow(),0).toString()+"'");
    ...
    private void updateActionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateActionActionPerformed
        ...
        int i = 0;
        jTable1.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"select fp_service_code,fp_service from fp_services ORDER BY fp_service"));
            ...
            for (int i = 0; i < jTable1.getRowCount(); i++){
                if (jTable1.getModel().getValueAt(i,0) != null){
                    if(newAction.getText().equalsIgnoreCase("Update")){
                        java.sql.PreparedStatement pstmt311 = connectDB.prepareStatement("UPDATE fp_services SET fp_service = '"+jTable1.getValueAt(i,1).toString()+"' WHERE fp_service_code = '"+jTable1.getValueAt(i,0).toString()+"'");
                        pstmt311.executeUpdate();
                    }else{
                    java.sql.PreparedStatement pstmt1 = connectDB.prepareStatement("insert into fp_services values(?,initcap(?))");
