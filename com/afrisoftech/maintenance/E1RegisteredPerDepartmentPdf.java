...
public class E1RegisteredPerDepartmentPdf implements java.lang.Runnable {
    ...
    public void E1RegisteredPerDepartmentPdf(java.sql.Connection connDb, String departm, java.lang.String bDate, java.lang.String eDate){
    ...
    public void generatePdf() {
        ...
        try{
            ...
            doc.open();
                ...
                table.setWidths(new float[]{0.7f,1.2f,0.7f,1.0f,0.8f,2.4f,1.2f});
...
//                table.addCell(cell);
                ...
                java.sql.ResultSet rimula=dataStt.executeQuery("SELECT maintenance.e1_details.e1_id, maintenance.job_card_details.job_card_no||' - '||maintenance.job_card_details.section_assigned, urgency, subject, phone_ext, description, date_job_card_created FROM maintenance.e1_details "
                                                            +"INNER JOIN maintenance.job_card_details ON maintenance.e1_details.e1_id=maintenance.job_card_details.e1_id "
                                                            +"WHERE department='"+department+"' AND date_job_card_created::date BETWEEN '"+beginDate+"' AND '"+endDate+"' ORDER BY maintenance.e1_details.e1_id");
