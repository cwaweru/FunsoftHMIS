 ...
 * @author charlie
 */
public class JobcardApprovalTwo extends Interface_Alpha {
 ...
 public Connection connDb;
     ...
     */
    public JobcardApprovalTwo(Connection cd,PooledConnectionSource pc) {
      
        setVisible(true);
         setDBCOnnection(cd,pc);
         initComponents();
         uuid = "JobcardApprovaltwo";
        ...
        arrComponents[7] = lbl_req_no;
        arrComponents[8] = txtExpectedduration;
    ...
    private void initComponents() {
        ...
        lbl_req_no = new javax.swing.JLabel();
        ...
        setMaximizable(true);
        setResizable(true);
        setTitle("Job Card Details Approval With S11");
        ...
        jLabel165.setText("E1-IRQ Number:");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        ...
        lbl_req_no.setText("123123");
        lbl_req_no.setName("lbl_req_no"); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 5;
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
        jPanel11.add(lbl_req_no, gridBagConstraints);
        ...
        jButton1.setText("View S11 Form");
    ...
    private javax.swing.JLabel lbl_req_no;
