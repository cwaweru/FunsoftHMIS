 ...
 * @author charlie
 */
public class JobCardCompletionWorker extends javax.swing.JInternalFrame {
     ...
     */
    public JobCardCompletionWorker(Connection cd, PooledConnectionSource pc) {
        connectDB = cd;
        pconnDB = pc;
    ...
    private void initComponents() {
        ...
        subjectCompletedJobCardTextField = new javax.swing.JTextField();
        phoneCompletedJobCardTextField = new javax.swing.JTextField();
        expectedjTextField = new javax.swing.JTextField();
        ...
        actualDurationjTextField = new javax.swing.JTextField();
        ...
        setMaximizable(true);
        setResizable(true);
        setTitle("Job Card Completion Report - Workers - "+sectionAllocated);
        ...
        subjectCompletedJobCardTextField.setEditable(false);
        subjectCompletedJobCardTextField.setColumns(10);
        subjectCompletedJobCardTextField.setMaximumSize(new java.awt.Dimension(32767, 32767));
        subjectCompletedJobCardTextField.setMinimumSize(new java.awt.Dimension(150, 20));
        subjectCompletedJobCardTextField.setName("subjectCompletedJobCardTextField"); // NOI18N
        subjectCompletedJobCardTextField.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                subjectCompletedJobCardTextFieldActionPerformed(evt);
            }
        });
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 2;
        ...
        jPanel11.add(subjectCompletedJobCardTextField, gridBagConstraints);
        ...
        expectedjTextField.setEditable(false);
        expectedjTextField.setColumns(10);
        expectedjTextField.setFont(new java.awt.Font("Cantarell", 1, 15)); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 9;
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
        gridBagConstraints.weightx = 1.0;
        jPanel11.add(expectedjTextField, gridBagConstraints);
        ...
        e1ApproverLabel.setFont(new java.awt.Font("Tahoma", 1, 15)); // NOI18N
        e1ApproverLabel.setForeground(java.awt.Color.red);
        e1ApproverLabel.setText("Actual Duration");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 2;
        gridBagConstraints.gridy = 9;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        ...
        actualDurationjTextField.setColumns(10);
        actualDurationjTextField.setFont(new java.awt.Font("Cantarell", 1, 15)); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 3;
        gridBagConstraints.gridy = 9;
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
        gridBagConstraints.weightx = 1.0;
        jPanel11.add(actualDurationjTextField, gridBagConstraints);

        e1CreatedByLabel.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        e1CreatedByLabel.setText("Expected Duration");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 9;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        ...
        assignSectionLabel1.setText("Section Assigned");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 7;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        ...
        workPendingjLabel.setFont(new java.awt.Font("Tahoma", 1, 15)); // NOI18N
        workPendingjLabel.setForeground(java.awt.Color.red);
        workPendingjLabel.setText("Reason for Pending work");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 0;
        gridBagConstraints.insets = new java.awt.Insets(0, 12, 0, 0);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (jobCardTextField.getText().length() < 1 || jobCardTextField.getText().equals(null)) {
            javax.swing.JOptionPane.showMessageDialog(this, "Please first select a job card from the table.",
                    "Caution Message",
                    javax.swing.JOptionPane.INFORMATION_MESSAGE);
        } else if (actualDurationjTextField.getText().length() < 1 || actualDurationjTextField.getText().equals(null)) {
            javax.swing.JOptionPane.showMessageDialog(this, "Please specify the actual duration.",
                    "Caution Message",
                    javax.swing.JOptionPane.INFORMATION_MESSAGE);
        } else {
            ...
            try {
                ...
                java.sql.PreparedStatement registerPrepStt = connectDB.prepareStatement("UPDATE maintenance.job_card_details SET actual_duration=?,reason_work_pending=?,completion_worker_username=? WHERE job_card_no='" + jobCardTextField.getText() + "'");
                registerPrepStt.setString(1, actualDurationjTextField.getText());
                if (jTextArea1.getText().length() < 1) {
                    registerPrepStt.setString(2, "N/A");
                } else {
                    registerPrepStt.setString(2, jTextArea1.getText());
                }
                registerPrepStt.setString(3, currentUsr);
    ...
    private void subjectCompletedJobCardTextFieldActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_subjectCompletedJobCardTextFieldActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_subjectCompletedJobCardTextFieldActionPerformed
    ...
    private void clearjButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_clearjButtonActionPerformed
        ...
        subjectCompletedJobCardTextField.setText("");
        descriptionCompletedJobCardArea.setText("");
        expectedjTextField.setText("");
        actualDurationjTextField.setText("");
    ...
    private void completeds11jTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_completeds11jTableMouseClicked
        ...
        subjectCompletedJobCardTextField.setText(completeds11jTable.getValueAt(row, 4).toString());
        ...
        try {
            ...
            java.sql.ResultSet othersSet = othersStt.executeQuery("SELECT building,phone_ext,description,jcd.officers_assigned,jcd.section_assigned,expected_duration FROM maintenance.e1_details ed INNER JOIN maintenance.job_card_details jcd ON ed.e1_id=jcd.e1_id WHERE job_card_no='" + jobCardTextField.getText() + "'");
            ...
            while (othersSet.next()) {
                ...
                expectedjTextField.setText(othersSet.getString(6));
            }
        } catch (java.sql.SQLException sqle) {
            sqle.printStackTrace();
        }
    ...
    private void searchjTextFieldCaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_searchjTextFieldCaretUpdate
        ...
        completeds11jTable.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB, " SELECT job_card_no,ed.department,ed.floor,ed.room,ed.subject,officers_assigned FROM maintenance.job_card_details jcd "
                ...
                + "WHERE with_s11 IS NOT NULL "
                + "AND irq_job_number IS NOT NULL "
                + "AND expected_duration IS NOT NULL "
                + "AND completion_worker_username IS NULL "
                + "AND job_card_no ILIKE '" + searchjTextField.getText() + "%' "
    ...
    public javax.swing.table.DefaultTableModel completeds11jTableModel() {
        ...
        return com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB, " SELECT job_card_no,ed.department,ed.floor,ed.room,ed.subject,officers_assigned FROM maintenance.job_card_details jcd "
                ...
                + "AND expected_duration IS NOT NULL "
                + "AND completion_worker_username IS NULL "
                + "AND section_assigned = '"+sectionAllocated+"' "
                + "ORDER BY job_card_no");
    }

    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JTextField actualDurationjTextField;
    ...
    private javax.swing.JTextField expectedjTextField;
    ...
    private javax.swing.JTextField subjectCompletedJobCardTextField;
