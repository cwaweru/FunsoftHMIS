 ...
 * @author  postgres
 */
public class MaintenanceMain extends javax.swing.JFrame {
...
//    public static java.sql.Connection connectDB = null;
    ...
    public MaintenanceMain(java.sql.Connection connDB, org.netbeans.lib.sql.pool.PooledConnectionSource pConnectDB, java.lang.String path2Acrobat, java.lang.String passwd) {
        ...
        try {
            ...
            java.lang.ClassLoader classLoader = MaintenanceMain.class.getClassLoader();
    ...
    private void initComponents() {
        ...
        MaintenanceDesktopPane = new javax.swing.JDesktopPane();
        ...
        branchesmnit1 = new javax.swing.JMenuItem();
        ...
        interviewmnit1 = new javax.swing.JMenuItem();
        interviewmnit2 = new javax.swing.JMenuItem();
        ...
        hrRegistrationmnit1 = new javax.swing.JMenuItem();
        hrRegistrationmnit2 = new javax.swing.JMenuItem();
        ...
        hrInjuryIncidentmnit1 = new javax.swing.JMenuItem();
        hrInjuryIncidentmnit2 = new javax.swing.JMenuItem();
        ...
        MaintenanceDesktopPane.setBackground(new java.awt.Color(204, 204, 204));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        ...
        hrMainPanel.add(MaintenanceDesktopPane, gridBagConstraints);
        ...
        hrOrganisationalLayoutmn.setText("Assets Manager");

        branchesmnit.setText("Add Assets");
        ...
        branchesmnit1.setText("Add Vehicle");
        branchesmnit1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                branchesmnit1ActionPerformed(evt);
            }
        });
        hrOrganisationalLayoutmn.add(branchesmnit1);

        hrSetupmn.add(hrOrganisationalLayoutmn);

        unionmn.setText("Building Manager");

        unionterminationmnit.setText("Add Building");
        ...
        periodicitymnit.setText("Add Floors");
        ...
        unionauthoritymnit.setText("Add Rooms");
        ...
        hrInsuranceCoversmn.setText("Departments Manger");

        retirementBenefitsmnit.setText("Add Departments");
        ...
        policiesmnit.setText("Department Logins");
        ...
        hrRecruitmentmnit0.setText("E1 Document");
        ...
        interviewmnit1.setText("E1 Document Post Confirmation");
        interviewmnit1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                interviewmnit1ActionPerformed(evt);
            }
        });
        hrRecruitmentmnit0.add(interviewmnit1);

        interviewmnit2.setText("E1 Document Tracking");
        interviewmnit2.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                interviewmnit2ActionPerformed(evt);
            }
        });
        hrRecruitmentmnit0.add(interviewmnit2);

        hrOperationsmn.add(hrRecruitmentmnit0);
        hrOperationsmn.add(jSeparator7);

        hrUnionDetailsmnit.setText("Job Card Document");

        hrUnionisedStaffProcessesmnit.setText("Upload Job Card Details");
        ...
        hrRegistrationmnit.setText("Job Card Details");
        ...
        hrRegistrationmnit1.setText("Job Card Post Confirmation");
        hrRegistrationmnit1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                hrRegistrationmnit1ActionPerformed(evt);
            }
        });
        hrUnionDetailsmnit.add(hrRegistrationmnit1);

        hrRegistrationmnit2.setText("Job Card Approval");
        hrRegistrationmnit2.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                hrRegistrationmnit2ActionPerformed(evt);
            }
        });
        hrUnionDetailsmnit.add(hrRegistrationmnit2);

        hrOperationsmn.add(hrUnionDetailsmnit);
        hrOperationsmn.add(jSeparator9);

        hrEmployeeHealthsafetymn.setText("Completion Process");

        hrHealthSafetyPromotionmnit.setText("Gatepass ");
        ...
        hrInjuryIncidentmnit.setText("Workers Completion Report");
        ...
        hrInjuryIncidentmnit1.setText("Senders Completion Report");
        hrInjuryIncidentmnit1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                hrInjuryIncidentmnit1ActionPerformed(evt);
            }
        });
        hrEmployeeHealthsafetymn.add(hrInjuryIncidentmnit1);

        hrInjuryIncidentmnit2.setText("Maintenance Head Completion Report");
        hrInjuryIncidentmnit2.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                hrInjuryIncidentmnit2ActionPerformed(evt);
            }
        });
        hrEmployeeHealthsafetymn.add(hrInjuryIncidentmnit2);
   ...
   com.afrisoftech.hrlib.HrEmpAbsenceNamepanel absence = new com.afrisoftech.hrlib.HrEmpAbsenceNamepanel(this,pconnectDB,true,retdate,connectDB);
    ...
    private void hrInjuryIncidentmnitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_hrInjuryIncidentmnitActionPerformed
         ...
         com.afrisoftech.maintenance.CompletionWorker lmgmt = new com.afrisoftech.maintenance.CompletionWorker(connectDB, pconnectDB);
        MaintenanceDesktopPane.add(lmgmt, javax.swing.JLayeredPane.DEFAULT_LAYER);
        try {
    ...
    private void hrRptMemosmnitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_hrRptMemosmnitActionPerformed
     //com.afrisoftech.hr.MemosPdf list = new com.aCompletionWorker.hr.MemosPdf();
    //list.MemosPdf(connectCompletionWorker 
            //Add your handling code here:
...
com.afrisoftech.hr.AllApplicantResumePdf app = new com.afrisoftech.hr.AllApplicantResumePdf();
 ...
 com.afrisoftech.hr.StaffListPdf list = new com.afrisoftech.hr.StaffListPdf();
    ...
    com.afrisoftech.maintenance.MaintenanceFloors lmgmt = new com.afrisoftech.maintenance.MaintenanceFloors();
        MaintenanceDesktopPane.add(lmgmt, javax.swing.JLayeredPane.DEFAULT_LAYER);
        try {
    ...
    private void unionterminationmnitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_unionterminationmnitActionPerformed
        com.afrisoftech.maintenance.MaintenanceBuilding lmgmt = new com.afrisoftech.maintenance.MaintenanceBuilding();
        MaintenanceDesktopPane.add(lmgmt, javax.swing.JLayeredPane.DEFAULT_LAYER);
        try {
    ...
    private void hrRegistrationmnitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_hrRegistrationmnitActionPerformed
      com.afrisoftech.maintenance.JobcardDetails lmgmt = new com.afrisoftech.maintenance.JobcardDetails(connectDB,pconnectDB);
        MaintenanceDesktopPane.add(lmgmt, javax.swing.JLayeredPane.DEFAULT_LAYER);
        try {
   ...
   com.afrisoftech.maintenance.E1DocumentApproval lmgmt = new com.afrisoftech.maintenance.E1DocumentApproval(connectDB,pconnectDB);
        MaintenanceDesktopPane.add(lmgmt, javax.swing.JLayeredPane.DEFAULT_LAYER);
        try {
    ...
    private void applicantresumemnitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_applicantresumemnitActionPerformed
           com.afrisoftech.maintenance.E1appform branches123 = new com.afrisoftech.maintenance.E1appform(connectDB,pconnectDB);
        MaintenanceDesktopPane.add(branches123, javax.swing.JLayeredPane.DEFAULT_LAYER);
        try {
    ...
    private void interviewmnitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_interviewmnitActionPerformed
      com.afrisoftech.maintenance.E1ApplicationRegistration lmgmt = new com.afrisoftech.maintenance.E1ApplicationRegistration(connectDB,pconnectDB);
        MaintenanceDesktopPane.add(lmgmt, javax.swing.JLayeredPane.DEFAULT_LAYER);
        try {
    ...
    private void hrUnionisedStaffProcessesmnitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_hrUnionisedStaffProcessesmnitActionPerformed
      com.afrisoftech.maintenance.JobcardApplicationDocument lmgmt = new com.afrisoftech.maintenance.JobcardApplicationDocument(connectDB,pconnectDB);
        MaintenanceDesktopPane.add(lmgmt, javax.swing.JLayeredPane.DEFAULT_LAYER);
        try {
    ...
    private void branchesmnitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_branchesmnitActionPerformed
        com.afrisoftech.maintenance.MaintenanceEquipment branches = new com.afrisoftech.maintenance.MaintenanceEquipment();
        MaintenanceDesktopPane.add(branches, javax.swing.JLayeredPane.DEFAULT_LAYER);
        try {
    ...
    private void retirementBenefitsmnitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_retirementBenefitsmnitActionPerformed
        com.afrisoftech.maintenance.MaintenanceDepartment
                retirementBenefits = new com.afrisoftech.maintenance.MaintenanceDepartment();
        MaintenanceDesktopPane.add(retirementBenefits, javax.swing.JLayeredPane.DEFAULT_LAYER);
        try {
    ...
    private void hrAboutHRMmnitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_hrAboutHRMmnitActionPerformed
        ...
        MaintenanceDesktopPane.add(hrAboutBox, javax.swing.JLayeredPane.DEFAULT_LAYER);
        try {
    ...
    private void interviewmnit1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_interviewmnit1ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_interviewmnit1ActionPerformed

    private void branchesmnit1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_branchesmnit1ActionPerformed
        com.afrisoftech.maintenance.MaintenanceVehicle mainvehicleBox = new com.afrisoftech.maintenance.MaintenanceVehicle();
        MaintenanceDesktopPane.add(mainvehicleBox , javax.swing.JLayeredPane.DEFAULT_LAYER);
        try {
            
            
            mainvehicleBox .setSelected(true);
        } catch(java.beans.PropertyVetoException pvt){
            
            pvt.printStackTrace();
            
        }         // TODO add you
    }//GEN-LAST:event_branchesmnit1ActionPerformed

    private void hrRegistrationmnit1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_hrRegistrationmnit1ActionPerformed
        
    }//GEN-LAST:event_hrRegistrationmnit1ActionPerformed

    private void interviewmnit2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_interviewmnit2ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_interviewmnit2ActionPerformed

    private void hrRegistrationmnit2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_hrRegistrationmnit2ActionPerformed
com.afrisoftech.maintenance.JobcardApproval javeBox = new com.afrisoftech.maintenance.JobcardApproval(connectDB,pconnectDB);
        MaintenanceDesktopPane.add(javeBox , javax.swing.JLayeredPane.DEFAULT_LAYER);
        try {
            
            
            javeBox .setSelected(true);
        } catch(java.beans.PropertyVetoException pvt){
            
            pvt.printStackTrace();
            
        }         // TODO add you        // TODO add your handling code here:
    }//GEN-LAST:event_hrRegistrationmnit2ActionPerformed

    private void hrInjuryIncidentmnit1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_hrInjuryIncidentmnit1ActionPerformed
       
        com.afrisoftech.maintenance.CompletionComplainant lmgmt = new com.afrisoftech.maintenance.CompletionComplainant(connectDB,pconnectDB);
    ...
    }//GEN-LAST:event_hrInjuryIncidentmnit1ActionPerformed

    private void hrInjuryIncidentmnit2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_hrInjuryIncidentmnit2ActionPerformed
       
        com.afrisoftech.maintenance.CompletionBoss lmgmt = new com.afrisoftech.maintenance.CompletionBoss(connectDB,pconnectDB);
    ...
    }//GEN-LAST:event_hrInjuryIncidentmnit2ActionPerformed
    
    /**
     * @param args the command line arguments
     */
    public static void main(String args[]) {
        MaintenanceMain hrMainInstance = new MaintenanceMain(connect2DB(), getPooledConnectionSource(), System.getProperty("path2Acrobat"), System.getProperty("passwd"));
    ...
    public static java.sql.Connection connect2DB() {
        ...
        try {
            ...
            connectDBStock = java.sql.DriverManager.getConnection("jdbc:postgresql://localhost:5432/funsoft","postgres","robert");
        ...
        if (domainsReset) {
            ...
            try {
                ...
                for (int n = 0; n  < fieldsArray.length; n++) {
                   ...
                   //CompletionWorker   System.out.println(sq.getMessage());
// CompletionWorker                     
                            }
    ...
    public javax.swing.JDesktopPane MaintenanceDesktopPane;
    ...
    private javax.swing.JMenuItem branchesmnit1;
    ...
    private javax.swing.JMenuItem hrInjuryIncidentmnit1;
    private javax.swing.JMenuItem hrInjuryIncidentmnit2;
    ...
    private javax.swing.JMenuItem hrRegistrationmnit1;
    private javax.swing.JMenuItem hrRegistrationmnit2;
    ...
    private javax.swing.JMenuItem interviewmnit1;
    private javax.swing.JMenuItem interviewmnit2;
