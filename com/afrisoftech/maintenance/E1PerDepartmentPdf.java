...
public class E1PerDepartmentPdf implements java.lang.Runnable {
    ...
    public void E1PerDepartmentPdf(java.sql.Connection connDb, String departm, java.lang.String bDate, java.lang.String eDate){
    ...
    public void generatePdf() {
        ...
        try{
            ...
            doc.open();
                ...
                table.setWidths(new float[]{0.5f,0.7f,1.5f,1.7f,0.6f,0.8f,1.3f});
                ...
                chunk=new Chunk("E1's RAISED BETWEEN "+beginDate+" AND "+endDate,columnHeaders);
                    cell=new PdfPCell(new Paragraph(chunk));
                    cell.setColspan(7);
                    cell.setHorizontalAlignment(Element.ALIGN_CENTER);
                    cell.setBorderColor(Color.white);
                ...
                java.sql.ResultSet rimula=dataStt.executeQuery("SELECT e1_id, urgency, subject, description, phone_ext,user_name, date_e1_created FROM maintenance.e1_details WHERE department ILIKE '"+department+"' AND date_e1_created::date BETWEEN '"+beginDate+"' AND '"+endDate+"' ORDER BY date_e1_created;");
