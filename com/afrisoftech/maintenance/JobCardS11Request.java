 ...
 * @author  root
 */
public class JobCardS11Request extends javax.swing.JInternalFrame {
    ...
    private String department=null,jobCardNo=null;
    ...
    public JobCardS11Request(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB,
                                            String dept,String jobCard,javax.swing.JButton clearBttn) {
    ...
    private void initComponents() {
        ...
        */
        ...
        setMaximizable(true);
        setResizable(true);
        setTitle("Job Card S11 Requisition");
        setVisible(true);
        ...
        */
        ...
        jComboBox2.setModel(com.afrisoftech.lib.ComboBoxModel.ComboBoxModel(connectDB, "SELECT store_name FROM st_main_stores WHERE store_name ILIKE 'maint%'"));
...
/*      if(this.jComboBox2.getSelectedItem().toString().equalsIgnoreCase("Main Store")){
    ...
    private void cmbox11MouseClicked() {
        ...
        jSearchDialog1.setSize(800,200);
...
/* private void cmbox3ActionPerformed(java.awt.event.ActionEvent evt){
    ...
    private void postbtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_postbtnActionPerformed
        ...
        try {
            ...
            java.sql.ResultSet rs2 = ps.executeQuery("select 'IRQ_"+jobCardNo+"_'||lpad(nextval('req_no_seq')::text,6,'0'::text)");
            while (rs2.next()){
           ...
           java.lang.String item = null;
            ...
            java.sql.PreparedStatement s11UsedStt=connectDB.prepareStatement("UPDATE maintenance.job_card_details SET irq_job_number='"+transNo+"' WHERE job_card_no='"+jobCardNo+"'");
            s11UsedStt.executeUpdate();
