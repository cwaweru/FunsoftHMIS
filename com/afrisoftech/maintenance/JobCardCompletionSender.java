 ...
 * @author charlie
 */
public class JobCardCompletionSender extends javax.swing.JInternalFrame{
     ...
     */
     public JobCardCompletionSender(Connection cd,PooledConnectionSource pc) {
         connectDB=cd;
         pconnDB=pc;
...
//        arrComponents[8] = subjectTextField;
    ...
    private void initComponents() {
        ...
        e1ApproverLabel3 = new javax.swing.JLabel();
        ...
        setMaximizable(true);
        setResizable(true);
        setTitle("Job Card Completion Report - Sender");
        ...
        assignCompletedS11jComboBox.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "-", "1 (Least Satisfied)", "2", "3", "4", "5 (Most Satisfied)" }));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        ...
        assignSectionLabel1.setText("Job Satisfaction Level");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 9;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        ...
        workPendingjLabel.setText("Comments/ Complaints");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 0;
        gridBagConstraints.insets = new java.awt.Insets(0, 12, 0, 0);
    ...
    e1ApproverLabel3.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
    e1ApproverLabel3.setText("Select Department Here");
    gridBagConstraints = new java.awt.GridBagConstraints();
    gridBagConstraints.gridx = 0;
    gridBagConstraints.gridy = 0;
    gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
    gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
    gridBagConstraints.insets = new java.awt.Insets(0, 12, 0, 0);
    tablePanel.add(e1ApproverLabel3, gridBagConstraints);
    ...
    gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
    gridBagConstraints.weightx = 1.0;
    tablePanel.add(deptCombo, gridBagConstraints);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(assignCompletedS11jComboBox.getSelectedItem().toString().equalsIgnoreCase("-")){
        ...
        }else if (deptCombo.getSelectedItem().toString().equalsIgnoreCase("-")) {
            javax.swing.JOptionPane.showMessageDialog(this, "Please specify your department",
                    "Caution Message",
                    javax.swing.JOptionPane.INFORMATION_MESSAGE);
        }
        else{
            ...
            try{
                ...
                java.sql.PreparedStatement registerPrepStt=connectDB.prepareStatement("UPDATE maintenance.job_card_details SET satisfaction_level=?,sender_completion_remarks=?,sender_completion_time=?,completion_sender_username=? WHERE job_card_no='"+jobCardTextField.getText()+"'");
                ...
                registerPrepStt.setObject(3, java.sql.Timestamp.valueOf(sdf.format(new java.util.Date())));
                //registerPrepStt.setObject(3, java.util.Calendar.getInstance().getTimeInMillis());
                registerPrepStt.setString(4, currentUsr);
    ...
    private void completeds11jTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_completeds11jTableMouseClicked
        ...
        if(deptCombo.getSelectedItem().toString().equalsIgnoreCase("-")){
            javax.swing.JOptionPane.showMessageDialog(this, "Please first select your department",
                    "Caution Message",
                    javax.swing.JOptionPane.INFORMATION_MESSAGE);
        }
        else{
           ...
           deptCompletedJobCardjTextField.setText(completeds11jTable.getValueAt(row, 1).toString());
            ...
            try{
                ...
                java.sql.ResultSet othersSet=othersStt.executeQuery("SELECT building,phone_ext,description,jcd.officers_assigned FROM maintenance.e1_details ed INNER JOIN maintenance.job_card_details jcd ON ed.e1_id=jcd.e1_id WHERE job_card_no='"+jobCardTextField.getText()+"'");
    ...
    public javax.swing.table.DefaultTableModel completeds11jTableModel(){
        return com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB," SELECT job_card_no,ed.department,ed.floor,ed.room,ed.subject,officers_assigned FROM maintenance.job_card_details jcd "
                                                                                                                                ...
                                                                                                                                + "AND completion_sender_username IS NULL "
                                                                                                                                + "AND ed.department='"+deptCombo.getSelectedItem()+"' "
    ...
    private javax.swing.JLabel e1ApproverLabel3;
