...
public class E1RegisteredAllDepartmentsPdf implements java.lang.Runnable {
    ...
    public void E1RegisteredAllDepartmentsPdf(java.sql.Connection connDb, java.lang.String bDate, java.lang.String eDate){
    ...
    public void generatePdf() {
        ...
        //PdfPTable table=new com.lowagie.text.pdf.PdfPTable(7);
        ...
        try{
            ...
            doc.open();
                ...
                table.setWidths(new float[]{0.5f, 1.2f, 1f, 0.5f, 1.2f, 0.8f, 2f, 0.8f});
                
                    chunk=new Chunk("All Departments. ", columnHeaders);
                ...
                chunk=new Chunk("E1's REGISTERED BETWEEN "+beginDate+" AND "+endDate+" AND THEIR RESPECTIVE JOB CARD NUMBERS.",columnHeaders);
                    cell=new PdfPCell(new Paragraph(chunk));
                    cell.setColspan(8);
                    cell.setHorizontalAlignment(Element.ALIGN_CENTER);
                    cell.setBorderColor(Color.white);
                ...
                chunk=new Chunk("Department",columnHeaders);
                cell=new PdfPCell(new Paragraph(chunk));
                cell.setHorizontalAlignment(Element.ALIGN_CENTER);
                table.addCell(cell);
                
                chunk=new Chunk("Job Card No/ Section Allocated",columnHeaders);
                cell=new PdfPCell(new Paragraph(chunk));
                cell.setHorizontalAlignment(Element.ALIGN_CENTER);
                table.addCell(cell);
                
                chunk=new Chunk("Urgency",columnHeaders);
                cell=new PdfPCell(new Paragraph(chunk));
                cell.setHorizontalAlignment(Element.ALIGN_CENTER);
                table.addCell(cell);
                ...
                chunk=new Chunk("Description",columnHeaders);
                cell=new PdfPCell(new Paragraph(chunk));
                cell.setHorizontalAlignment(Element.ALIGN_CENTER);
                table.addCell(cell);
                
                
                chunk=new Chunk("Date E1 Created",columnHeaders);
                cell=new PdfPCell(new Paragraph(chunk));
                cell.setHorizontalAlignment(Element.ALIGN_CENTER);
                table.addCell(cell);
...
//                table.addCell(cell);
                ...
                java.sql.ResultSet rimula=dataStt.executeQuery("SELECT maintenance.e1_details.e1_id, maintenance.job_card_details.job_card_no||' - '||maintenance.job_card_details.section_assigned, urgency, subject, phone_ext, description, date_job_card_created, maintenance.e1_details.department FROM maintenance.e1_details "
                                                            +"INNER JOIN maintenance.job_card_details ON maintenance.e1_details.e1_id=maintenance.job_card_details.e1_id "
                                                            +"WHERE date_job_card_created::date BETWEEN '"+beginDate+"' AND '"+endDate+"' ORDER BY maintenance.e1_details.e1_id");
                ...
                while(rimula.next()){
                    ...
                    chunk=new Chunk(rimula.getString(8),normal);
                    cell=new PdfPCell(new Paragraph(chunk));
