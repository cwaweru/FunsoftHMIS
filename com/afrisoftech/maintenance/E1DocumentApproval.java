 ...
 * @author charlie
 */
public class E1DocumentApproval extends Interface_Alpha {
     ...
     */
    public E1DocumentApproval(Connection cd,PooledConnectionSource pc) {
        super();
        setVisible(true);
    ...
    private void initComponents() {
        ...
        setMaximizable(true);
        setResizable(true);
        setTitle("E1 Application Department Head Form Approval");
    ...
    int selected_id = Integer.parseInt(tblReport.getValueAt(tblReport.getSelectedRow(), 0).toString());
        ...
        tblReport = loadData(tblReport, uuid, title);
        JOptionPane.showMessageDialog(null, "This Application: " + lblSubject.getText().toString() + " has been Sent To Registry");
        txaDescription.setText("");
        lblDepartment.setText("");
        lblBuilding.setText("");
        txaDescription.setText("");
