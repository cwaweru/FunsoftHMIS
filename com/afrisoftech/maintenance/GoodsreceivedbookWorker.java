 ...
 * @author charlie
 */
public class GoodsreceivedbookWorker extends Interface_Alpha {
JComponent[] arrComponents = new JComponent[10];
 public Connection connDb;
  ...
  String roba;
     ...
     */
    public GoodsreceivedbookWorker(Connection cd,PooledConnectionSource pc) {
        setVisible(true);
     ...
     String selected_id = tblReport.getValueAt(tblReport.getSelectedRow(), 0).toString();
        ...
        lblSubject.setText("");
            ...
            try {
                ...
                ex.printStackTrace();
                Logger.getLogger(GoodsreceivedbookWorker.class.getName()).log(Level.SEVERE, null, ex);
            } catch (SQLException ex1) {
                Logger.getLogger(GoodsreceivedbookWorker.class.getName()).log(Level.SEVERE, null, ex1);
            }
        }
