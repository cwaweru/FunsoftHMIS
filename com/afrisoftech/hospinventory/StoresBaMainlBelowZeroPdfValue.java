...
public class StoresBaMainlBelowZeroPdfValue implements java.lang.Runnable {
    ...
    public void StoresBaMainlBelowZeroPdfValue(java.sql.Connection connDb, java.util.Date endate, java.util.Date begindate,java.lang.String cbox) {
                ...
                try {
                    ...
                    try {
                        ...
                        try {
                            ...
                            java.sql.PreparedStatement pset1 = connectDB.prepareStatement("select initcap(description||' '||strength) as description, sum(qty)::NUMERIC(10,0), round(sum(qty::NUMERIC*buying_price::numeric),0) AS BALANCE from stock_balance_qty_price where department ilike '"+CBox+"' AND dates <= '"+endDate+"'  GROUP BY description having sum(qty) > 0 order by description");
