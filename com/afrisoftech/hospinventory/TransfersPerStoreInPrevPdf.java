...
public class TransfersPerStoreInPrevPdf implements java.lang.Runnable {
    ...
    public void TransfersPerStoreInPrevPdf(java.sql.Connection connDb,java.util.Date begindate,java.util.Date endate,java.lang.String combox) {
            ...
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_CENTER);
                        phrase = new Phrase("TRANSFERED TO : " +bank.toUpperCase(), pFontHeader);
                        table.addCell(phrase);
