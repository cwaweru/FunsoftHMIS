...
public class ExternalRequisitionPDF implements java.lang.Runnable {
    ...
    public void ExternalRequisitionPDF(java.sql.Connection connDb, java.lang.String receivngstore, java.lang.String dept, java.lang.String order, java.lang.String UserName) {
        selectSupp = receivngstore;
        Department = dept;
        OrderNo = order;
        user = UserName;
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    com.lowagie.text.HeaderFooter footer = new com.lowagie.text.HeaderFooter(new Phrase(""+Department.toUpperCase()+"   Requisition For Purchase - Page: ", pFontHeader1), true);// FontFactory.getFont(com.lowagie.text.FontFactory.HELVETICA, 12, Font.BOLDITALIC,java.awt.Color.blue));
                    ...
                    try {
                        ...
                        try {
                            ...
                            while (rset4.next()) {
                                ...
                                table2.getDefaultCell().setColspan(10);
                                table2.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_CENTER);
                                phrase = new Phrase("EXTERNAL PURCHASE REQUISITION", pFontHeader5);
                                table2.addCell(phrase);
                                
                                 table2.getDefaultCell().setColspan(10);
                                table2.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_CENTER);
                                phrase = new Phrase("FROM HEAD OF DEPARTMENT-    "+Department+" ", pFontHeader5);
                                table2.addCell(phrase);
                                table2.getDefaultCell().setColspan(10);
                                table2.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_CENTER);
                                ...
                                phrase = new Phrase("Requisitioning Department : " + rset4.getObject(3).toString(), pFontHeader);
                                table2.addCell(phrase);
                                table2.getDefaultCell().setColspan(4);
                                phrase = new Phrase("Requisition Date: " + rset4.getObject(9).toString() , pFontHeader);
                                table2.addCell(phrase);
                                table2.getDefaultCell().setColspan(10);
                                table2.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
...
//                            table3.addCell(phrase);
                    ...
                    try{
                        ...
                        try {
                            ...
                            Logger.getLogger(ExternalRequisitionPDF.class.getName()).log(Level.SEVERE, null, ex);
                        }
...
//                            table4.getDefaultCell().setColspan(4);
//                            table4.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
//                            phrase = new Phrase("AIE HOLDER/H.O.D...............................", pFontHeader);
//                            table4.addCell(phrase);
//                            
//                            table4.getDefaultCell().setColspan(2);
//                            table4.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
...
//                            table4.addCell(phrase);
                            ...
                            table4.getDefaultCell().setColspan(9);
                            table4.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                            phrase = new Phrase("AIE HOLDER/H.O.D-  "+Department.toUpperCase(), pFontHeader5);
                            table4.addCell(phrase);
...
//                            
    ...
    public java.lang.Object[] getListofActivities() {
        ...
        java.sql.ResultSet rSet1 = stmt1.executeQuery("SELECT DISTINCT item_code from st_receive_requisation WHERE requisition_no = '"+OrderNo+"'");
