...
public class UsersetupInventoryIntfr extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jButton252.setIcon(new javax.swing.ImageIcon(getClass().getResource("/BD14755_.GIF"))); // NOI18N
        ...
        jLabel652.setFont(new java.awt.Font("SansSerif", 1, 14)); // NOI18N
        ...
        jComboBox1.setModel(com.afrisoftech.lib.ComboBoxModel.ComboBoxModel(connectDB, "select usename from pg_user where usename !='postgres' order by 1"));
...
/*
        ...
        try {
            ...
            java.sql.ResultSet rs = stmt.executeQuery("select menu_list from secure_menu_access where login_name = '"+jComboBox1.getSelectedItem().toString()+"' AND sys_name ilike 'Hospital_inventory'");
...
//        str = "{"+str+"}";
        ...
        try {
            ...
            java.sql.PreparedStatement pmstmt = connectDB.prepareStatement("begin work;UPDATE secure_menu_access SET menu_list = ? WHERE login_name = ? AND sys_name = 'hospital_inventory' ;commit work");
