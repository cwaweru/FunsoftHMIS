...
public class AmmendInvoiceintfr extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        */
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Description", "Units", "Qty", "Unit Price", "Value"
            }
        ) {
    ...
    private void jTextField11121CaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextField11121CaretUpdate
        if(this.jTextField11121.getCaretPosition() < 3){
            ...
            jSearchTable21.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"select store_code as code, store_name as name from st_stores where store_name ILIKE '"+jTextField11121.getText()+"%' order by store_name"));
    ...
    private void jTextField1112CaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextField1112CaretUpdate
        if(this.jTextField1112.getCaretPosition() < 3){
            ...
            jSearchTable2.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"select code,supplier_name as name from st_suppliers where supplier_name ILIKE '"+jTextField1112.getText()+"%' order by supplier_name"));
    ...
    private void jTextField1111CaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextField1111CaretUpdate
        if(jTextField1111.getCaretPosition() > 2){
            jSearchTable1.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"select distinct invoice_no,dealer as name,date from ac_accounts_payable where invoice_no ILIKE '"+jTextField1111.getText().toString()+"%' and date > '2005-06-27' ORDER BY invoice_no"));
            jSearchTable1.setShowHorizontalLines(false);
            jSearchScrollPane1.setViewportView(jSearchTable1);
    ...
    private void jTextField111CaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextField111CaretUpdate
        jSearchTable.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"select description,unit,price FROM st_product_list WHERE description ILIKE '"+jTextField111.getText()+"%' AND supplier = '"+jTextField361.getText()+"' order by description"));
