 ...
 * @author  root
 */
public class PackagingIntfr_1 extends javax.swing.JInternalFrame {
    ...
    public PackagingIntfr_1(java.sql.Connection connectDb, org.netbeans.lib.sql.pool.PooledConnectionSource pConnDb) {
    ...
    private void jTextField111CaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextField111CaretUpdate
     if(this.jTextField111.getCaretPosition() < 3){
            ...
            jSearchTable.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"select DISTINCT item_code,description,units FROM st_stock_item_list WHERE description ILIKE '"+jTextField111.getText()+"%' order by description"));
