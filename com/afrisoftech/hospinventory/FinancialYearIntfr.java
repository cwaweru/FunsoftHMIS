 ...
 * @author  root
 */
public class FinancialYearIntfr extends javax.swing.JInternalFrame {
    ...
    public FinancialYearIntfr(java.sql.Connection connDb) {
    ...
    private void initComponents() {
        ...
        setIconifiable(true);
        setTitle("Setting the Financial Year ");
        ...
        jButton1.setText("Register active financial year");
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Enter the active Financial Year here"));
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Financial Year Code", "Financial Year Description"
            }
        ));
...
jButton1.setLabel("Register active financial year");
// TODO add your handling code here:
...
// TODO add your handling code here:
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        try{
            ...
            java.sql.PreparedStatement pstmt31 = connectDB.prepareStatement("DELETE from pb_financial_year WHERE financial_year_code = '"+jTable1.getModel().getValueAt(jTable1.getSelectedRow(),0).toString()+"'");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            ...
            for (int i = 0; i < jTable1.getRowCount(); i++){
                if (jTable1.getModel().getValueAt(i,0) != null){
                    if(jButton1.getText().equalsIgnoreCase("Update")){
                       ...
                       // pstmt1.setObject(2,Boolean.parseBoolean(jTable1.getValueAt(i,2).toString()));
            ...
            jLabel3.setText("Sorry. Anothe Financial Year Code already exists");
    ...
    private void editBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editBtnActionPerformed
        ...
        int i = 0;
        jTable1.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"select financial_year_code,financial_year_desc, active_year from pb_financial_year ORDER BY financial_year_desc"));
