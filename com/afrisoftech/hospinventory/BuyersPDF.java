...
public class BuyersPDF implements java.lang.Runnable {
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    com.lowagie.text.HeaderFooter footer = new com.lowagie.text.HeaderFooter(new Phrase("Purchasing officers sections list - Page: ", pFontHeader1), true);// FontFactory.getFont(com.lowagie.text.FontFactory.HELVETICA, 12, Font.BOLDITALIC,java.awt.Color.blue));
                    ...
                    try {
                        ...
                        Phrase phrase = new Phrase("Procurement officers allocation list : ", com.lowagie.text.FontFactory.getFont(FontFactory.HELVETICA_BOLD, 8));
                        ...
                        phrase = new Phrase("Buyer_designation", pFontHeader);

                        table.addCell(phrase);

                        table.getDefaultCell().setColspan(4);
                        phrase = new Phrase("Buyer Name", pFontHeader);
...
//                        table.getDefaultCell().setBackgroundColor(java.awt.Color.WHITE);
                        ...
                        try {
                            ...
                            for (int k = 0; k < listofAct1.length; k++) {
                                java.sql.ResultSet rset1 = st2.executeQuery("SELECT DISTINCT user_name,designation FROM section_allocation where section ilike '" + listofAct1[k].toString() + "' and status = true  order by 1");
...
//                                    table.addCell(phrase);
    ...
    public java.lang.Object[] getListofActivities1() {
        ...
        try {
            ...
            java.sql.ResultSet rSet1 = stmt1.executeQuery("SELECT DISTINCT upper(section) FROM section_allocation order by 1");
