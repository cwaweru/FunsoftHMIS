 ...
 * @author root
 */
public class PatientsBillingIpIntfr extends javax.swing.JInternalFrame {
    ...
    public PatientsBillingIpIntfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {
        ...
        */
        ...
        //try {
            ...
            setMaximizable(true);
            setResizable(true);
            setTitle("Raise Patient Bill Estimates");
            setFrameIcon(null);
            try {
                setSelected(true);
            ...
            jTable13.setModel(new javax.swing.table.DefaultTableModel(
                ...
                new String [] {
                    "Drugs", "Qty", "Avl Qty", "Price", "Disc", "Total", "Gl Account", "Item Code", "Strength"
                }
            ) {
            ...
            */
            ...
            jComboBox3.setModel(com.afrisoftech.lib.ComboBoxModel.ComboBoxModel(connectDB, "select stores from store_allocation where user_name = current_user and type ilike 'bill'"));
            ...
            jTextField4.setText(com.afrisoftech.lib.StoreFactory.getStoreName(connectDB));
            gridBagConstraints = new java.awt.GridBagConstraints();
            gridBagConstraints.gridx = 1;
            gridBagConstraints.gridy = 9;
            gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
            ...
            jComboBox4.setModel(com.afrisoftech.lib.ComboBoxModel.ComboBoxModel(connectDB, "select stores from store_allocation where user_name = current_user and type ilike 'bill'"));
            ...
            jTabbedPane1.addTab("Raise In Patient Supplies", jPanel5);
            ...
            jTabbedPane1.getAccessibleContext().setAccessibleName("Raise In Patient Supplies");

            setBounds(0, 0, 749, 829);
...
// TODO add your handling code here:
    ...
    private void searchButton11aClicked() {
        ...
        jSearchDialog13.setSize(700, 200);
...
// TODO add your handling code here:
        ...
        try {
            ...
            for (int i = 0; i < jTable13.getRowCount(); i++) {
                if (jTable13.getModel().getValueAt(i, 0) != null) {
                    ...
                    java.sql.ResultSet rsz = pstz.executeQuery("SELECT strength FROM st_stock_prices WHERE product_id = '" + jTable13.getValueAt(i, 7).toString() + "'");
                    while (rsz.next()) {
                    ...
                    java.sql.ResultSet rsB = pstB.executeQuery("select transfer_price,units from st_stock_prices where product_id = '" + jTable13.getModel().getValueAt(i, 7) + "'");
                    ...
                    pstmt1.setString(20, jTextField93.getText());
                    pstmt1.setString(21, jTextField93.getText());
                    pstmt1.setObject(22, jTable13.getValueAt(i, 7).toString());
                    pstmt1.setObject(23, jTable13.getValueAt(i, 8).toString());
    ...
    private void jSearchTable3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jSearchTable3MouseClicked
        ...
        jTable13.setValueAt(jSearchTable3.getValueAt(jSearchTable3.getSelectedRow(), 3), jTable13.getSelectedRow(), 7);
        ...
        try {
            ...
            while (rsx.next()) {
                ...
                jTable13.setValueAt(itemPrice, jTable13.getSelectedRow(), 3);
                jTable13.setValueAt(total, jTable13.getSelectedRow(), 5);
            }

            //if (j > 0) {
            java.sql.ResultSet rs = pstmt.executeQuery("select sum(qty) from stock_balance_qty where item_code ilike '" + jSearchTable3.getValueAt(jSearchTable3.getSelectedRow(), 3) + "' and department ilike '" + jComboBox4.getSelectedItem().toString() + "' AND dates <= '" + datePicker1.getDate() + "'");
    ...
    private void jTable13MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable13MouseClicked
        if (jTable13.getSelectedColumn() == 0) {
            if (jTextField4.getText().toString().equalsIgnoreCase("") | jTextField4.getText().toString().equalsIgnoreCase(" ") | jComboBox3.getSelectedItem().toString().equalsIgnoreCase("-")) {
    ...
    private void jSearchTable2121MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jSearchTable2121MouseClicked
        ...
        jComboBox4.setModel(com.afrisoftech.lib.ComboBoxModel.ComboBoxModel(connectDB, "SELECT DISTINCT stores FROM store_allocation WHERE store_gl_account = '" + this.jTextField4.getText().toString() + "'"));
...
// Add your handling code here:
    ...
    private void searchButton2121Clicked() {
        ...
        jSearchDialog2121.setSize(700, 200);
...
/*        java.awt.Point point = this.jTextField91.getLocationOnScreen();
        ...
        try {
            ...
            if (j > 0) {
                ...
                while (rsetTable1.next()) {
                    ...
                    jTable13.setValueAt(rsetTable1.getObject(7), i, 7);
                    jTable13.setValueAt(rsetTable1.getObject(8), i, 8);

                    java.sql.ResultSet rsetTable111 = stmtTable111.executeQuery("select sum(receiving-issuing) from st_sub_stores where item_code = '" + jTable13.getValueAt(i, 7).toString() + "' AND store_name ilike '" + jComboBox4.getSelectedItem().toString() + "'");
                    while (rsetTable111.next()) {
    ...
    public static javax.swing.JDialog jSearchDialog13;
    private javax.swing.JDialog jSearchDialog212;
    private javax.swing.JDialog jSearchDialog2121;
    public static javax.swing.JDialog jSearchDialog3;
    public static javax.swing.JDialog jSearchDialog4;
