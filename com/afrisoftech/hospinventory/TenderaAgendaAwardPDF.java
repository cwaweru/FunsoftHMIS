...
public class TenderaAgendaAwardPDF implements java.lang.Runnable {
    ...
    com.lowagie.text.Font pFontHeaderCentred = FontFactory.getFont(FontFactory.HELVETICA, 10, Font.BOLD, Color.GREEN);
    ...
    private String commiteeSec;

    public void TenderaAgendaAwardPDF(java.sql.Connection connDb, java.lang.String tenderNo) {
        //  selectSupp = combox;
        //  Department = dept;
        OrderNo = tenderNo;
        // user = UserName;
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    com.lowagie.text.HeaderFooter footer = new com.lowagie.text.HeaderFooter(new Phrase("" + OrderNo + "   Agenda For Award of Tender -Printed By '"+com.afrisoftech.lib.UserName.getLoginName(connectDB).toLowerCase()+"' FOR SCM - Page: ", pFontHeader1), true);// FontFactory.getFont(com.lowagie.text.FontFactory.HELVETICA, 12, Font.BOLDITALIC,java.awt.Color.blue));
                    ...
                    try {
                        ...
                        try {
                            ...
                            try {
                                ...
                                java.sql.ResultSet rset4 = st4.executeQuery(" SELECT DISTINCT date from st_recommendation WHERE quotation_no = '" + OrderNo + "' limit 1");
                                //  java.sql.ResultSet rset5 = st5.executeQuery("SELECT distinct description from st_recommendation WHERE quotation_no = '" + OrderNo + "'");
                                ...
                                while (rset4.next()) {
                                    ...
                                    table2.getDefaultCell().setColspan(10);
                                    table2.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_CENTER);
                                    phrase = new Phrase("Application to Deliberate on and award Tender No: " + OrderNo.toUpperCase() + "  " + com.afrisoftech.lib.GetItemInfo.getITenderDesc(OrderNo, connectDB).toUpperCase(), pFontHeader5);
                                    table2.addCell(phrase);

//                                    table2.getDefaultCell().setColspan(10);
//                                    table2.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_CENTER);
//                                    phrase = new Phrase("TENDER  " + OrderNo.toUpperCase() + "  " + com.afrisoftech.lib.GetItemInfo.getITenderDesc(OrderNo, connectDB).toUpperCase(), pFontHeader5);
//                                    table2.addCell(phrase);
...
//                                table2.addCell(phrase);
                                    ...
                                    table2.getDefaultCell().setColspan(10);
                                    table2.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_CENTER);
                                    phrase = new Phrase("LIST OF RECOMMENDED BIDDERS AFTER EVALUATION OF TENDER, DATED  " + rset4.getDate(1), pFontHeader5);
                                    table2.addCell(phrase);
...
//                                    phrase = new Phrase("This report is an analysis of items in the tender per the qualified bidders, and the results of the recommendation for award by the Tender Evaluation Committee", pFontHeader2);
//                                    table2.addCell(phrase);
//
//                                    table2.getDefaultCell().setColspan(10);
//                                    table2.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
...
//                               
                        ...
                        try {
                            ...
                            java.sql.Statement st5 = connectDB.createStatement();
                            java.sql.ResultSet rset5 = st5.executeQuery("SELECT distinct description,unit from st_recommendation WHERE quotation_no = '" + OrderNo + "' group by 1,2");
//items table
                            while (rset5.next()) {
                                ...
                                phrase = new Phrase("BIDDER", pFontHeader);
                                table3.addCell(phrase);

                                //2
                                table3.getDefaultCell().setColspan(4);
                                table3.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                                phrase = new Phrase("QUANTITY AWARDED", pFontHeader);
                                table3.addCell(phrase);
...
//                            table3.addCell(phrase);
                                    ...
                                    java.sql.ResultSet rset1 = st2.executeQuery("select  unit,quantity,price,remarks from st_recommendation  where quotation_no ='" + OrderNo + "' and supplier_code  = '" + listofAct[i].toString() + "' and  description ilike '" + rset5.getObject(1).toString() + "'");

                                    //bidder_no

                                    while (rset1.next()) {
                                        System.out.println("select  unit,quantity,price,remarks from st_recommendation  where quotation_no ='" + OrderNo + "' and supplier_code  = '" + listofAct[i].toString() + "' and  description ilike '" + rset5.getObject(1).toString() + "'");
                                        cnt = cnt + 1;
                                        //BIDDER 
                                        table3.getDefaultCell().setColspan(2);
                                        table3.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                                        phrase = new Phrase("BIDDER " + listofAct[i].toString(), pFontHeader2);
                                        table3.addCell(phrase);
...
//                       
                                        ...
                                        table3.getDefaultCell().setColspan(1);
                                        table3.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                                        phrase = new Phrase(CurrencyFormatter.getFormattedDouble(rset1.getDouble(3)), pFontHeader2);
                                        table3.addCell(phrase);
...
//                            ResultSet rsetotal = st.executeQuery("SELECT distinct total_mark,passmark FROM st_technical_evaluation where quotation_no ='"+OrderNo+"' and supplier_code  = '"+listofAct[i].toString()+"' and description ilike '"+rset5.getObject(1)+"'");
//                            
//                            while(rsetotal.next()){
//                            
//                            
...
//                                 }
                    ...
                    try {
                        ...
                        try {
                            ...
                            pst = connectDB.prepareStatement("select count(distinct supplier_code) from st_technical_evaluation where quotation_no = '" + OrderNo + "' and total_mark>=passmark");
                            pst2 = connectDB.prepareStatement("select count(distinct supplier_code), approved_fin_by  from st_recommendation where quotation_no =  '" + OrderNo + "' group by 2 limit 1 ");
                            ...
                            while (rsetwon.next()) {
                                ...
                                commiteeSec= rsetwon.getObject(2).toString();

                            }

                          
                        } catch (SQLException ex) {
                            Logger.getLogger(TenderaAgendaAwardPDF.class.getName()).log(Level.SEVERE, null, ex);
                        }
                        ...
                        phrase = new Phrase("TOTAL NUMBER BIDDERS EVALUATED (qualified at Technical Evaluation) :" + total + "                  ", pFontHeader);
                        table4.addCell(phrase);
...
//                            table4.addCell(phrase);
                        ...
                        table4.getDefaultCell().setColspan(4);
                            table4.getDefaultCell().setBorderColor(java.awt.Color.WHITE);
                            table4.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                            phrase = new Phrase("PREPARED BY :"+commiteeSec+"     For Tender Evaluation Committe Secretary              ", pFontHeader);
                            table4.addCell(phrase);
                            ...
                            phrase = new Phrase("Date :"+com.afrisoftech.lib.UserName.getServerDate(connectDB)+" \n\n", pFontHeader);
                            table4.addCell(phrase);
...
//                            
    ...
    public java.lang.Object[] getListofActivities() {
        ...
        try {
            ...
            java.sql.ResultSet rSet1 = stmt1.executeQuery("select distinct supplier_code from st_recommendation  where quotation_no  = '" + OrderNo + "'  group by 1, description order by 1");
        ...
        System.out.println("Done list of Items in the finRreport ...");
