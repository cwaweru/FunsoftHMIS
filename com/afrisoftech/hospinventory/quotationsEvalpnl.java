 ...
 * @author saleem
 */
public class quotationsEvalpnl extends javax.swing.JPanel {

    /**
     * Creates new form quotationsEvalpnl
     */
    java.sql.Connection connectDB = null;
    org.netbeans.lib.sql.pool.PooledConnectionSource pConnDB = null;
    public quotationsEvalpnl(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
        connectDB = connDb;
    ...
    private void initComponents() {
        ...
        ApprovalSaveCbx = new javax.swing.JCheckBox();
        ...
        */
        ...
        jLabel21.setText("Quotation_Number");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 0;
        gridBagConstraints.weightx = 1.0;
        ...
        searchButton1.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusGained(java.awt.event.FocusEvent evt) {
                searchButton1FocusGained(evt);
            }
        });
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 2;
        ...
        ApprovalSaveCbx.setText("Approve");
        ApprovalSaveCbx.addItemListener(new java.awt.event.ItemListener() {
            public void itemStateChanged(java.awt.event.ItemEvent evt) {
                ApprovalSaveCbxItemStateChanged(evt);
            }
        });
        jPanel5.add(ApprovalSaveCbx);
        ...
        jTable2.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Item Code", "Description", "Days to Deliver", "Brand", "Country"
            }
        ));
        ...
        jScrollPane4.setBorder(javax.swing.BorderFactory.createTitledBorder("Item Specs"));
        ...
        jButton3.setText("Save Without Approval");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        try {
            ...
            if(ApprovalSaveCbx.isSelected()){
                ...
                connectDB.commit();
                javax.swing.JOptionPane.showMessageDialog(this, "Insert Done Successfully!");
                
                ///////removing the evaluated bidders from the list to await financial evaluation
             
             java.sql.PreparedStatement pstn = connectDB.prepareStatement("SELECT  distinct b.code , a.supplier  FROM st_floated_quotations a, st_suppliers b , st_technical_evaluation te where a.supplier=b.supplier_name and supplier_name not in (select supplier from st_technical_evaluation  where quotation_no = '"+tendernotxt1.getText().toString()+"' ) and a.quotation_no='"+tendernotxt1.getText().toString()+"'");
            ResultSet a = pstn.executeQuery();
            int m= 0;
    ...
    private void tenderrecordstxttCaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_tenderrecordstxttCaretUpdate
        ...
        {
            tenderrecordstblt.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB, "SELECT distinct tender  as Quotation_No   FROM st_tender_suppliers where opened=true and tender ilike 'Q%'"));
    ...
    private void ApprovalSaveCbxItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_ApprovalSaveCbxItemStateChanged
      
        if(ApprovalSaveCbx.isSelected()){
        jButton3.setText("Save [Approval]");
        }
        else{
        jButton3.setText("Save Without Approval"); 
        
        }
    }//GEN-LAST:event_ApprovalSaveCbxItemStateChanged

    private void searchButton1FocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_searchButton1FocusGained
        // TODO add your handling code here:
    }//GEN-LAST:event_searchButton1FocusGained

    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JCheckBox ApprovalSaveCbx;
