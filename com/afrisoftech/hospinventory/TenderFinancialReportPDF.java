...
public class TenderFinancialReportPDF implements java.lang.Runnable {
   ...
   // private String time=null;
    ...
    public void TenderFinancialReportPDF(java.sql.Connection connDb, java.lang.String tenderNo) {
      //  selectSupp = combox;
      //  Department = dept;
        OrderNo = tenderNo;
       // user = UserName;
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    com.lowagie.text.HeaderFooter footer = new com.lowagie.text.HeaderFooter(new Phrase(""+OrderNo+"   Tender Financial Report Report - Page: ", pFontHeader1), true);// FontFactory.getFont(com.lowagie.text.FontFactory.HELVETICA, 12, Font.BOLDITALIC,java.awt.Color.blue));
...
//                                table2.addCell(phrase);
                                ...
                                table2.getDefaultCell().setColspan(10);
                                table2.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_CENTER);
                                phrase = new Phrase("FINANCIAL EVALUATION RESULTS HELD ON  "+rset4.getDate(1), pFontHeader5);
                                table2.addCell(phrase);
                                ...
                                phrase = new Phrase("This evaluation report is an analysis of items in the tender  per bidders, and the results of the recommendation for award by the Financial Evaluation Committee", pFontHeader2);
                                table2.addCell(phrase);
...
//                                 }
                    ...
                    try{
                        ...
                        try {
                            ...
                            pst2 = connectDB.prepareStatement("select count(distinct supplier_code) from st_recommendation where quotation_no = '"+OrderNo+"' ");
                            pst3 = connectDB.prepareStatement("select count(distinct supplier_code) from st_technical_evaluation where quotation_no = '"+OrderNo+"' and total_mark>=passmark"
                                    + " and supplier_code NOT IN (select distinct supplier_code from st_recommendation where quotation_no = '"+OrderNo+"')");
                            ...
                            Logger.getLogger(TenderFinancialReportPDF.class.getName()).log(Level.SEVERE, null, ex);
                        }
