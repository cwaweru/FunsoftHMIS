 ...
 * @author  root
 */
public class CreditNoteintfr_1 extends javax.swing.JInternalFrame {
    ...
    public CreditNoteintfr_1(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void jTextField1131CaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextField1131CaretUpdate
        if(this.jTextField1131.getCaretPosition() < 3){
            ...
            jSearchTable21.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"select distinct invoice_no,supplier,date from st_stock_cardex where invoice_no ILIKE '"+jTextField1131.getText()+"%' and transaction_type ILIKE 'Receiving%' ORDER BY invoice_no"));
    ...
    private void jTextField111CaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextField111CaretUpdate
        ...
        if(this.jTextField111.getCaretPosition() < 0){
            System.out.print("Nothing");
                  ...
                  jSearchTable.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"select item,quantity_received as qty,PRICE_PER_ITEM AS PRICE,debit as total,item_code FROM st_stock_cardex WHERE item ILIKE '%"+jTextField111.getText()+"%' AND store ilike '%"+jComboBox2.getSelectedItem().toString()+"%' and invoice_no = '"+jTextField91.getText()+"' order by ITEM"));
    ...
    private void postbtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_postbtnActionPerformed
        ...
        if(datePicker1.getDate().before(periodFrom) || datePicker1.getDate().after(periodTo)){
            ...
            try{
                ...
                try {
                    nets = java.lang.Double.valueOf(jTextField2.getText());
                    ...
                    for (int i = 0; i< jTable1.getRowCount(); i++) {
                        if (jTable1.getModel().getValueAt(i,9) != null){
                            if(java.util.regex.Pattern.matches("[0-9]*",jTable1.getValueAt(i, 2).toString())){
                            ...
                            pstmt.setObject(7,jTable1.getValueAt(i,2));
                            ...
                            if(jTextField3.getText().equals("")){
                                ...
                                // pstmt.setObject(24,jComboBox1.getSelectedItem());
                            ...
                            pstmt11.setObject(12,jTable1.getValueAt(i,2));
                            pstmt11.setObject(13,jTextField7.getText());
                            pstmt11.setObject(14,jTextField7.getText());
                    ...
                    pstmt1.setDouble(13,java.lang.Double.valueOf(jTextField2.getText()));
                    ...
                    pstmt1.setString(21,"");
                    pstmt1.setDate(22,com.afrisoftech.lib.SQLDateFormat.getSQLDate(datePicker1.getDate()));
                    pstmt1.setDate(23,com.afrisoftech.lib.SQLDateFormat.getSQLDate(datePicker1.getDate()));
                    pstmt1.setDouble(24,-1*java.lang.Double.valueOf(jTextField1.getText()));
                    pstmt1.setDouble(25,nets*-1);
                    pstmt1.setDouble(26,-1*java.lang.Double.valueOf(jTextField1.getText()));
                    pstmt1.executeUpdate();
                    
                    
                    
                    java.sql.Statement pst1d1 = connectDB.createStatement();
                    java.sql.ResultSet rs1d1 = pst1d1.executeQuery("select code,activity from pb_activity where activity_category ILIKE 'GRN'");
                    while (rs1d1.next()){
                    ...
                    while (rs1d.next()){
                        ...
                        //Purchases = rs1c.getObject(2).toString();
                    }
                    ...
                    pstmt1q.setString(3,"");
                    pstmt1q.setString(4,jTextField7.getText());
                    pstmt1q.setString(6,jTextField91.getText());
                    pstmt1q.setString(5,Purchases);
                    pstmt1q.setString(7,"");
                    pstmt1q.setString(8,"");
                    pstmt1q.setString(9,"");
                    ...
                    pstmt1q.setString(14,Purchases);
                    pstmt1q.setString(15,"Stock Returns");
                    pstmt1q.setDouble(17,java.lang.Double.valueOf(jTextField2.getText()));
                    pstmt1q.setDouble(16,0.00);
                    pstmt1q.setDate(18,com.afrisoftech.lib.SQLDateFormat.getSQLDate(datePicker1.getDate()));
                    pstmt1q.setString(19,transNo);
                    pstmt1q.setBoolean(20,false);
                    pstmt1q.setBoolean(21,true);
                    pstmt1q.setBoolean(22,false);
                    pstmt1q.setDouble(23,java.lang.Double.valueOf(jTextField2.getText()));
                    pstmt1q.setString(24,"");
                    pstmt1q.setString(25,"");
                    pstmt1q.setTimestamp(26,new java.sql.Timestamp(java.util.Calendar.getInstance().getTimeInMillis()));
                    pstmt1q.executeUpdate();
                    
                    java.sql.PreparedStatement pstmt1q1 = connectDB.prepareStatement("insert into ac_ledger values(?,?,?,?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?,?,?,?,?,?,?)");
                    pstmt1q1.setObject(1,supCode);
                    pstmt1q1.setString(2,Purchases);
                    pstmt1q1.setString(3,"");
                    pstmt1q1.setString(4,jTextField7.getText());
                    pstmt1q1.setString(6,jTextField91.getText());
                    pstmt1q1.setString(5,CostofSale);
                    ...
                    pstmt1q1.setString(14,Purchases);
                    pstmt1q1.setString(15,CostofSale);
                    ...
                    pstmt1q1.setDouble(23,java.lang.Double.valueOf(jTextField2.getText()));
