...
public class StoresBalPerCategoryPdf implements java.lang.Runnable {
    ...
    public void StoresBalPerCategoryPdf(java.sql.Connection connDb,java.lang.String begindate, java.lang.String endate, java.lang.String cbox, java.lang.String stores,java.lang.String cat) {
            ...
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        Phrase phrase = new Phrase(CBox +":"+category+ " Section. Stock Balance as at: " +endDate, pFontHeader);
                        ...
                        try {
                            ...
                            for (int i = 0; i < listofAct.length; i++) {
                                ...
                                if(Store.equalsIgnoreCase("SubStore")){
                                    ...
                                    //java.sql.ResultSet rset = st.executeQuery("SELECT sum(qty)::NUMERIC(15,0) AS BALANCE FROM stock_balance_qty where department = '"+CBox+"' AND item_code = '"+listofAct[i]+"' AND dates <= '"+endDate+"'");
                                    java.sql.ResultSet rset = st.executeQuery("SELECT sum(qty)::NUMERIC(15,0) AS BALANCE FROM stock_balance_qty where initcap(department) = '"+CBox+"' AND upper(item_code) = '"+listofAct[i]+"' AND dates::date <= '"+ endDate+"'");
                                    ...
                                    java.sql.ResultSet rset3 = st3.executeQuery("SELECT DISTINCT product_id,initcap(product),initcap(strength) FROM st_stock_prices WHERE initcap(department) = '"+CBox+"' AND upper(product_id) = '"+listofAct[i]+"'");
                                    ...
                                    java.sql.ResultSet rset2 = st2.executeQuery("SELECT DISTINCT transfer_price FROM stockprices WHERE upper(product_id) =  '"+listofAct[i]+"' AND initcap(department) = '"+CBox+"'");
                                    ...
                                    double pkge = 0.00;
                                    //java.sql.ResultSet rset = st.executeQuery("SELECT sum(qty)::NUMERIC(15,0) AS BALANCE FROM stock_balance_qty where department = '"+CBox+"' AND item_code = '"+listofAct[i]+"' AND dates <= '"+endDate+"'");
                                    java.sql.ResultSet rset = st.executeQuery("SELECT sum(qty)::NUMERIC(15,0) AS BALANCE FROM stock_balance_qty where department ilike '"+CBox+"' AND item_code = '"+listofAct[i]+"' AND dates <= '"+endDate+"'");//OKAY
                                    ...
                                    java.sql.ResultSet rset3 = st3.executeQuery("SELECT DISTINCT item_code,initcap(description),initcap(strength) FROM st_stock_item WHERE department = '"+CBox+"' AND item_code = '"+listofAct[i]+"'");
                                    ...
                                    java.sql.ResultSet rset2 = st2.executeQuery("SELECT DISTINCT buying_price,packaging FROM stockitem WHERE item_code =  '"+listofAct[i]+"' AND department = '"+CBox+"'");
...
docPdf.close();  com.afrisoftech.lib.PDFRenderer.renderPDF(tempFile);
    ...
    public java.lang.Object[] getListofActivities() {
        ...
        try {
            ...
            java.sql.ResultSet rSet1 = stmt1.executeQuery("SELECT DISTINCT item_code,description FROM st_stock_item WHERE department = '"+CBox+"' AND sub_cat_code='"+category+"' ORDER BY 2,1");
            ...
            if(!rSet1.next()){
                ...
                rSet1=stmt1.executeQuery("SELECT DISTINCT product_id,product FROM st_stock_prices WHERE department ilike '"+CBox+"' AND category='"+category+"' ORDER BY 2,1");
