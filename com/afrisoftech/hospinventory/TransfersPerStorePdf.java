            ...
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        int headerwidths[] = {10,35,10,15,10,10,14};
                        ...
                        Phrase  phrase = new Phrase("Transfered Items By Store".toUpperCase(), pFontHeader1);
                        table.addCell(phrase);
                        table.getDefaultCell().setColspan(9);
                        table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_CENTER);
                        phrase = new Phrase("Store Name : " +bank.toUpperCase(), pFontHeader1);
                        table.addCell(phrase);
                        ...
                        phrase = new Phrase("Issued From",pFontHeader);
                        table.addCell(phrase);
                        ...
                        try {
                            ...
                            java.sql.ResultSet rset = st.executeQuery("select ss.trans_date::date,initcap(ss.item),sum(ss.issuing),ss.transaction_no,ss.sub_store,ss.store_name,sum(total/issuing),round(sum(total),2) from st_sub_stores ss WHERE transaction_no ILIKE 'T%' and ss.trans_date::date BETWEEN '"+beginDate+"' AND '"+endDate+"' and ss.store_name ilike '"+bank+"' AND ss.issuing > 0 group by ss.trans_date,initcap(ss.item),ss.transaction_no,ss.store_name,ss.sub_store ORDER BY ss.trans_date,ss.transaction_no");
