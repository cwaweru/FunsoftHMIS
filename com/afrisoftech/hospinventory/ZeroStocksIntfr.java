...
public class ZeroStocksIntfr extends javax.swing.JInternalFrame {
    ...
    private void jTextField111CaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextField111CaretUpdate
        if(jTextField111.getCaretPosition() < 3){
            ...
            jSearchTable.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"select distinct department as department from st_stock_prices where department ILIKE '"+jTextField111.getText().toString()+"%' UNION ALL select distinct department as department from st_stock_item where department ILIKE '"+jTextField111.getText().toString()+"%'"));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if (this.jCheckBox4.isSelected()){
            ...
            if (exitOption == javax.swing.JOptionPane.YES_OPTION) {
                ...
                try {
                    java.sql.PreparedStatement pstmt = connectDB.prepareStatement("update st_stock_prices set balance = '0.00', old_stock = balance where department ='"+jTextField36.getText()+"'");
                     pstmt.executeUpdate();
                     
                     java.sql.PreparedStatement pstmt1 = connectDB.prepareStatement("update st_stock_item set quantity_instock = '0.00', old_stock = quantity_instock where department ='"+jTextField36.getText()+"'");
                     pstmt1.executeUpdate();
                     
                     java.sql.PreparedStatement pstmt1x = connectDB.prepareStatement("delete from st_sub_stores where store_name ilike '"+jTextField36.getText()+"%'");
