...
public class PurchaseReqFormPdf implements java.lang.Runnable {
    ...
    public void PurchaseReqFormPdf(java.sql.Connection connDb, java.lang.String combox, java.lang.String order) {
                ...
                try {
                    ...
                    try {
                        ...
                        try {
                            ...
                            java.sql.ResultSet rset4 = st4.executeQuery("select DISTINCT REQUISITION_no,date_due,cost_center, case when supplier is null then '-' else supplier end as supplier,received_requisation,reason from st_receive_requisation where REQUISITION_no = '" + OrderNo + "'");// where supplier_name = 'Uchumi'member_no = '"+memNo+"'  AND date BETWEEN '"+beginDate+"' AND '"+endDate+"'");
                            ...
                            while (rset4.next()) {
                                ...
                                table1.getDefaultCell().setColspan(10);
                                table1.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_CENTER);
                                phrase = new Phrase("PURCHASE REQUISITION FORM \n FOR GOODS / WORKS / SERVICE / IMPREST", pFontHeader5);
                                table1.addCell(phrase);
                                ...
                                phrase = new Phrase("TO THE : " + rset4.getObject(3).toString(), pFontHeader);
                                table1.addCell(phrase);

                                phrase = new Phrase("USER DEPT : " + rset4.getObject(5).toString(), pFontHeader);
                                table1.addCell(phrase);
                                ...
                                phrase = new Phrase(" ", pFontHeader);
                                table1.addCell(phrase);
                                phrase = new Phrase("PROCUREMENT METHOD : ", pFontHeader);
                                table1.addCell(phrase);
                                ...
                                table1.addCell(phrase);
                                table1.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                                phrase = new Phrase("REASON FOR PURCHASE " + rset4.getObject(6).toString(), pFontHeader);
                                table1.addCell(phrase);
                                ...
                                table1.getDefaultCell().setColspan(5);
                                phrase = new Phrase("NAME OF THE SUPPLIER " + rset4.getObject(4).toString(), pFontHeader);
                                table1.addCell(phrase);
                                table1.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                                phrase = new Phrase("CONTRACT NO: ", pFontHeader);
                                table1.addCell(phrase);


                                table1.getDefaultCell().setColspan(10);
                                phrase = new Phrase("The following goods / service / works / imprest (for purchase of goods & services) are required by the user departments ", pFontHeader);
                                table1.addCell(phrase);
                    ...
                    try {
                        ...
                        int headerwidths[] = {8, 40, 14, 10, 14, 14, 15, 12, 15};
                        ...
                        phrase = new Phrase("Remark", pFontHeader);
                        table.addCell(phrase);
                        ...
                        try {
                            ...
                            java.sql.ResultSet rset1 = st1.executeQuery("SELECT initcap(item_description),units,cos_glcode,"
                                    + " quantity,price,round(quantity*price,2),mainstore_bal,terms from st_receive_requisation"
                            ...
                            table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                            phrase = new Phrase("REQUISITION OFFICER.................................", pFontHeader);
                            ...
                            table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                            phrase = new Phrase("PROCUREMENT OFFICER______________________", pFontHeader);
                            ...
                            table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                            phrase = new Phrase("TENDER COMMITTEE APPROVAL________________", pFontHeader);
                            ...
                            table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                            phrase = new Phrase("SIGN_____________________________________", pFontHeader);
                            ...
                            table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                            phrase = new Phrase("CHAIRMAN SIGN____________________________", pFontHeader);
                            ...
                            table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                            phrase = new Phrase("LEAD TIME________________________________", pFontHeader);
                            ...
                            table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                            phrase = new Phrase("DATE_____________________________________", pFontHeader);
                            ...
                            table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                            phrase = new Phrase("REMARKS TO AIE___________________________", pFontHeader);
                            ...
                            table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                            phrase = new Phrase("REMARK___________________________________", pFontHeader);

                            table.addCell(phrase);
                            table.getDefaultCell().setColspan(4);

                            table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                            phrase = new Phrase("DATE RECEIVED____________________________", pFontHeader);
                            table.addCell(phrase);
                            ...
                            table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                            phrase = new Phrase("1. Original__________ Use department", pFontHeader);

                            table.addCell(phrase);

                            table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                            phrase = new Phrase("2. Duplicate________ Procurement office", pFontHeader);

                            table.addCell(phrase);


                            table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                            phrase = new Phrase("3. Triplicate_________ Book copy", pFontHeader);
