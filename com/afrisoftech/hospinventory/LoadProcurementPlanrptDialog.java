 ...
 */
public class LoadProcurementPlanrptDialog extends javax.swing.JDialog {

    /**
     * Creates new form LoadProcurementPlanrptDialog
     */
    public static java.sql.Connection connectDB = null;
    public LoadProcurementPlanrptDialog(java.awt.Frame parent, boolean modal,java.sql.Connection connDB) {
    ...
    private void initComponents() {
        ...
        */
        ...
        jLabel1.setText("Load the Procurement Plan");
        ...
        jComboBox1.setModel(com.afrisoftech.lib.ComboBoxModel.ComboBoxModel(connectDB, "SELECT distinct financial_year FROM ac_aie_allocation ORDER BY 1"));
        gridBagConstraints = new java.awt.GridBagConstraints();
        ...
        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "all", "1st Quarter", "2nd Quarter", "3rd Quarter", "4th Quarter" }));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 1;
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
        ...
        jComboBox3.setModel(com.afrisoftech.lib.ComboBoxModel.ComboBoxModel(connectDB, "SELECT distinct concat(head,'-',subhead) FROM ac_aie_allocation ORDER BY 1"));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 3;
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
        ...
        jButton1.setText("Preview Procurement Plan");
...
////(SELECT '-' UNION SELECT distinct store_name from st_stores WHERE store_name ilike '"+jTextField1111.getText()+"')   ORDER BY 1
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       com.afrisoftech.hospinventory.mtrhreports.ProcurementPlanPdf nw=new com.afrisoftech.hospinventory.mtrhreports.ProcurementPlanPdf();
       nw.ProcurementPlanPdf(connectDB,jComboBox1.getSelectedItem().toString(),jComboBox2.getSelectedItem().toString(), jComboBox3.getSelectedItem().toString(),jTextField361.getText());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LoadProcurementPlanrptDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                LoadProcurementPlanrptDialog dialog = new LoadProcurementPlanrptDialog(new javax.swing.JFrame(), true,connectDB);
