 ...
 * @author  root
 */
public class ProqReqModifyWholeintfr extends javax.swing.JInternalFrame {
    ...
    public ProqReqModifyWholeintfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {
        ...
        */
        ...
        setMaximizable(true);
        setResizable(true);
        setTitle("Modify Requisitions For Procurement");
        setVisible(true);
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Item Description", "Units", "Quantity", "Price", "Balance"
            }
        ) {
        ...
        */
        ...
        jComboBox2.setModel(com.afrisoftech.lib.ComboBoxModel.ComboBoxModel(connectDB, "select store_name from st_main_stores where store_name ilike 'procure%' order by store_name"));
        ...
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
        gridBagConstraints.insets = new java.awt.Insets(0, 12, 0, 31);
        ...
        jLabel22.setText("Department to utilize items");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 3;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        ...
        jCheckBox1.setText("Modify Desciptions");
        ...
        */
        ...
        setBounds(0, 0, 768, 340);
    }// </editor-fold>//GEN-END:initComponents
    
    private void jCheckBox1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jCheckBox1ActionPerformed
        com.afrisoftech.hospinventory.ProqReqModifyDescintfr other = new ProqReqModifyDescintfr(connectDB, pConnDB);
  ...
  */
    ...
    private void populateTable11(java.lang.String patient_no) {
        ...
        try {
            ...
            java.sql.ResultSet rsetTable = stmtTable.executeQuery("SELECT item_description,units,quantity,price,(quantity*price)::numeric(15,2),balance FROM st_receive_requisation WHERE requisition_no ilike '"+jTextField361.getText()+"' order by item_description");
...
// int j = 0;
        ...
        jSearchTable11.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"select distinct requisition_no as Req_No from st_receive_requisation where requisition_no ILIKE '"+jTextField11111.getText().toString()+"%' and (requisition_no ilike 'PRQ%' or requisition_no ilike 'SRQ%') AND PROCESSED=FALSE ORDER BY requisition_no"));
        //   }
     /*   try {
...
/*      if(this.jComboBox2.getSelectedItem().toString().equalsIgnoreCase("Main Store")){
    ...
    private void jSearchTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jSearchTable1MouseClicked
        ...
        try {
            java.sql.Statement pstmt = connectDB.createStatement();
            java.sql.ResultSet rs = pstmt.executeQuery("select sum(receiving-issuing) from st_sub_stores WHERE item = '"+jTable1.getValueAt(jTable1.getSelectedRow(),0)+"' AND store_name ilike '"+jComboBox1.getSelectedItem()+"'");
            while (rs.next()){
    ...
    private void jTextField1111CaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextField1111CaretUpdate
        jSearchTable1.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"select distinct description,units,buying_price FROM st_stock_item WHERE description ILIKE '%"+jTextField1111.getText()+"%' ORDER BY description"));
        jSearchScrollPane1.setViewportView(jSearchTable1);
    ...
    private void postbtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_postbtnActionPerformed
        ...
        try {
          ...
          /*  java.sql.Statement ps = connectDB.createStatement();
            java.sql.ResultSet rs2 = ps.executeQuery("select 'PRQ'||lpad(nextval('proc_req_no_seq'),4,0)");
            while (rs2.next()){
...
// pstmt.setDate(8,com.afrisoftech.lib.SQLDateFormat.getSQLDate(java.util.Calendar.getInstance().getTime()));
                    ...
                    pstmt.setString(12,jTextField361.getText()+"M");
            ...
            java.sql.PreparedStatement pstmt221 = connectDB.prepareStatement("DELETE  FROM st_receive_requisation WHERE requisition_no = '"+jTextField361.getText()+"'");
            pstmt221.executeUpdate();
            
            connectDB.commit();
            connectDB.setAutoCommit(true);
            jLabel5.setForeground(java.awt.Color.blue);
            javax.swing.JOptionPane.showMessageDialog(this, "Insert Done Successfully Requisition No. is '"+jTextField361.getText()+"M"+"'","Comfirmation",javax.swing.JOptionPane.INFORMATION_MESSAGE);
            
            com.afrisoftech.hospinventory.ProcuremenrReqPdf policy = new com.afrisoftech.hospinventory.ProcuremenrReqPdf();
            
            policy.ProcuremenrReqPdf(connectDB,jComboBox1.getSelectedItem().toString(),jTextField361.getText()+"M");
