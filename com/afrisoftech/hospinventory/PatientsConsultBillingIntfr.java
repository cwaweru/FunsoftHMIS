 ...
 * @author  root
 */
public class PatientsConsultBillingIntfr extends javax.swing.JInternalFrame implements java.lang.Runnable {
    ...
    private PatientsConsultBillingIntfr.SearchThread searchThread = null;
    private PatientsConsultBillingIntfr.SearchServicesThread searchServicesThread = null;
    ...
    public PatientsConsultBillingIntfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
        ...
        searchThread = new PatientsConsultBillingIntfr.SearchThread();
    ...
    private void initComponents() {
        ...
        */
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Drugs", "Qty", "Avl Qty", "Price", "Disc", "Total", "Gl", "Code", "Available"
            }
        ) {
            Class[] types = new Class [] {
        ...
        */
        ...
        jComboBox1.setModel(com.afrisoftech.lib.ComboBoxModel.ComboBoxModel(connectDB, "select store_name from st_stores  where status ilike 'pharm%' order by store_name desc"));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 4;
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
    ...
    private void jCheckBox7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jCheckBox7ActionPerformed
        ...
        try {
            ...
            java.sql.ResultSet rsetTable1 = stmtTable1.executeQuery("select trans_date ,inv_no,doctor,paid as dispenced from pb_doctors_request where revenue_code ilike 'pharm%'  and patient_no=  '" + this.jTextField91.getText().toString() + "'  group by trans_date,inv_no,doctor,paid ORDER BY inv_no asc");
        ...
        if (PrescNo.startsWith("O")) {
            ...
            try {
                ...
                try {
                    ...
                    java.sql.ResultSet rsetTable12 = stmtTable1.executeQuery("select distinct(service) as product,amount,gl_code,0::numeric FROM pb_doctors_request WHERE patient_no ILIKE '%" + jTextField9.getText() + "%' AND revenue_code ilike '%Phar%' and inv_no= '" + jTable12.getValueAt(jTable12.getSelectedRow(), 3).toString() + "' and paid = false order by service");
            ...
            try {
                ...
                try {
                    ...
                    java.sql.ResultSet rsetTable12 = stmtTable1.executeQuery("select distinct(service) as product,amount,gl_code,0 FROM pb_doctors_request WHERE patient_no ILIKE '%" + jTextField92.getText() + "%' AND revenue_code ilike '%Phar%' and inv_no= '" + jTable12.getValueAt(jTable12.getSelectedRow(), 3).toString() + "' and paid = false order by service");
    ...
    private void jButton122ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton122ActionPerformed
        ...
        if (exitOption == javax.swing.JOptionPane.YES_OPTION) {
            ...
            try {
                ...
                com.afrisoftech.txtreports.PrescriptionTxt policy = new com.afrisoftech.txtreports.PrescriptionTxt(connectDB, jTextField92.getText(), jTextField13.getText(), prescNo, jTextField52.getText());
    ...
    private void jTextField114CaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextField114CaretUpdate
        if (jTextField114.getCaretPosition() > 0) {
            jSearchTable3.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB, "select product,selling_price,gl_code FROM st_stock_prices WHERE product ILIKE '%" + jTextField114.getText() + "%' AND department =  '" + jTextField42.getText() + "' order by product"));
...
for (int k = 0; k < jTable1.getRowCount(); k++) {
        ...
        try {
            ...
            java.sql.Statement stmt1 = connectDB.createStatement();
            java.sql.ResultSet rset1 = stmt1.executeQuery("select sum(amount) from hp_pharmacy where patient_no  ='" + jTextField9.getText() + "'");
            while (rset1.next()) {
    ...
    private void jTextField113CaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextField113CaretUpdate
        ...
        if (this.jCheckBox1.isSelected() && this.jCheckBox31.isSelected()) {
            ...
            if (jTextField113.getCaretPosition() < 3) {
                ...
                jSearchTable2.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB, "SELECT patient_no, name, year_of_birth, residence from patient_select where patient_no ILIKE '%" + jTextField113.getText() + "%' order by patient_no LIMIT 10"));
            ...
            if (this.jCheckBox1.isSelected() && this.jCheckBox4.isSelected()) {
                if (jTextField113.getCaretPosition() < 3) {
                    ...
                    jSearchTable2.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB, "SELECT patient_no, name, year_of_birth, residence from patient_select where name ILIKE '%" + jTextField113.getText() + "%' order by name  LIMIT 10"));
    ...
    private void jTextField111CaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextField111CaretUpdate
        ...
        if (jTextField111.getCaretPosition() > 0) {
            jSearchTable1.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB, "select distinct(product) as product,selling_price,gl_code FROM st_stock_prices WHERE product ILIKE '%" + jTextField111.getText() + "%' AND department ilike '" + Dept + "%' order by product"));
...
if (jTable1.getModel().getValueAt(jTable1.getSelectedRow(), 1) != null) {
    ...
    private void populateTable1(java.lang.String patient_no) {
        ...
        try {
            ...
            java.sql.ResultSet rsetTable11 = stmtTable11.executeQuery("SELECT count(patient_no)  FROM hp_pharmacy WHERE patient_no = '" + patient_no + "'");
            ...
            if (j > 0) {
                ...
                java.sql.ResultSet rsetTable1 = stmtTable1.executeQuery("SELECT description, sum(quantity),price,sum((quantity*price)-amount),sum(amount),gl_code,collected::boolean  FROM hp_pharmacy WHERE patient_no = '" + patient_no + "' AND date_prescribed > current_date - 2 group by description,price,gl_code,collected ");
...
jTable1.setValueAt(rsetTable1.getObject(7), i, 8);
                    java.sql.ResultSet rsetTable111x = stmtTable111x.executeQuery("select product_id from st_stock_prices where product = '" + jTable1.getValueAt(i, 0).toString() + "' AND department ilike '" + jComboBox1.getSelectedItem().toString() + "'");
                    while (rsetTable111x.next()) {
                        jTable1.setValueAt(rsetTable111x.getObject(1), i, 7);
                        java.sql.ResultSet rsetTable111 = stmtTable111.executeQuery("select sum(receiving-issuing) from st_sub_stores where item_code = '" + jTable1.getValueAt(i, 7).toString() + "' AND store_name ilike '" + jComboBox1.getSelectedItem().toString() + "'");
                        while (rsetTable111.next()) {
               ...
               /* java.sql.Statement psq = connectDB.createStatement();
                ...
                for (int i = 0; i < jTable1.getRowCount(); i++) {
                    ...
                    if (jTable1.getModel().getValueAt(i, 0) != null && jTable1.getModel().getValueAt(i, 8) != null) {
                        if (Boolean.valueOf(jTable1.getModel().getValueAt(i, 8).toString()) == java.lang.Boolean.TRUE) {
                        /*presc = java.lang.Double.parseDouble(jTextField8.getText());
                        ...
                        java.sql.PreparedStatement pstmt46 = connectDB.prepareStatement("UPDATE hp_pharmacy SET collected = true,quantity = '" + jTable1.getValueAt(i, 1).toString() + "',amount = '" + jTable1.getValueAt(i, 5).toString() + "' where patient_no = '" + jTextField9.getText() + "' and description = '" + jTable1.getValueAt(i, 0).toString() + "' and date_prescribed > (current_date - 2)");
                        pstmt46.executeUpdate();
                    }
                }
                }
    ...
    public void runGetListThread() {
        ...
        try {
            ...
            java.sql.ResultSet rsetTable12 = stmtTable12.executeQuery("select distinct trans_date,patient_no,patient_name,inv_no,doctor,'false' as bill from pb_doctors_request where revenue_code ilike '%pharm%' and trans_date >= current_date -1  group by trans_date,patient_no,patient_name,inv_no,doctor ORDER BY inv_no asc");
