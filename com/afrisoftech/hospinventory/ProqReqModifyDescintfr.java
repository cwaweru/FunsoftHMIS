 ...
 * @author  root
 */
public class ProqReqModifyDescintfr extends javax.swing.JInternalFrame {
    ...
    public ProqReqModifyDescintfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {
        ...
        */
        ...
        setMaximizable(true);
        setResizable(true);
        setTitle("Modify Requisitions Descriptions");
        setVisible(true);
        ...
        */
        ...
        jTabbedPane1.addTab("Requisition Details", jPanel4);
        ...
        */
        ...
        jTabbedPane1.getAccessibleContext().setAccessibleName("Requisition Details");
...
// pstmt.setDate(8,com.afrisoftech.lib.SQLDateFormat.getSQLDate(java.util.Calendar.getInstance().getTime()));
            ...
            */
             java.sql.PreparedStatement pstmt221 = connectDB.prepareStatement("update st_receive_requisation set received_requisation ='"+jComboBox4.getSelectedItem()+"', cost_center = '"+jComboBox1.getSelectedItem()+"',supplier = '"+jComboBox3.getSelectedItem()+"' WHERE requisition_no = '"+jTextField361.getText()+"'");
           ...
           com.afrisoftech.hospinventory.ProcuremenrReqPdf policy = new com.afrisoftech.hospinventory.ProcuremenrReqPdf();
                ...
                policy.ProcuremenrReqPdf(connectDB,jComboBox1.getSelectedItem().toString(),jTextField361.getText());
