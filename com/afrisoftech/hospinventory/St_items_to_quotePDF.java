...
public class St_items_to_quotePDF implements java.lang.Runnable {

    int seq = 0;
    java.lang.String quotation_no = null;
    ...
    public void St_items_to_quotePDF(java.sql.Connection connDb, java.lang.String combox) {
        quotation_no = combox;
        connectDB = connDb;
        // beginDate = begindate;
        // endDate = endate;
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    com.lowagie.text.HeaderFooter footer = new com.lowagie.text.HeaderFooter(new Phrase("Tendered Item List - Page: ", pFontHeader1), true);// FontFactory.getFont(com.lowagie.text.FontFactory.HELVETICA, 12, Font.BOLDITALIC,java.awt.Color.blue));
                    ...
                    try {
                        ...
                        int headerwidths[] = {10, 10, 35, 15, 10, 10};
                        ...
                        Phrase phrase = new Phrase("TENDERED ITEMS FOR " + quotation_no.toUpperCase() + " : ", com.lowagie.text.FontFactory.getFont(FontFactory.HELVETICA_BOLD, 10));
                        ...
                        table.addCell(phrase);
                        phrase = new Phrase("Max Tender Qty", pFontHeader);
                        table.addCell(phrase);
...
//                        table.addCell(phrase);
                        table.getDefaultCell().setColspan(2);
                        phrase = new Phrase("Entered on", pFontHeader);
                        table.addCell(phrase);
                        ...
                        try {
                          ...
                          //  for (int i = 0; i < listofAct.length; i++) {
                               ...
                               // table.addCell(phrase);
                                ...
                                java.sql.ResultSet rset1 = st2.executeQuery("SELECT distinct item_code,initcap(item_description),quantity,time_saved from st_item_to_quote where tender_no ilike '" + quotation_no + "' order by 1");
                             //int j=0;
                                while (rset1.next()) {
                                    seq = seq + 1;
                                    table.getDefaultCell().setColspan(1);
                                    ...
                                    table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                                    phrase = new Phrase(dbObject.getDBObject(CurrencyFormatter.getFormattedDouble((rset1.getDouble(3))), "-"), pFontNum);
                                    table.addCell(phrase);
...
docPdf.close();  com.afrisoftech.lib.PDFRenderer.renderPDF(tempFile);
    ...
    public java.lang.Object[] getListofActivities() {
        ...
        try {
            ...
            java.sql.ResultSet rSet1 = stmt1.executeQuery("SELECT DISTINCT sub_cat_code FROM st_stock_item  order by 1");
