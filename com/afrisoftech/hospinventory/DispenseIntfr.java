 ...
 * @author root
 */
public class DispenseIntfr extends javax.swing.JInternalFrame implements java.lang.Runnable {
    ...
    private DispenseIntfr.SearchThread searchThread = null;
    private DispenseIntfr.SearchServicesThread searchServicesThread = null;
    ...
    public DispenseIntfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
        ...
        searchThread = new DispenseIntfr.SearchThread();
    ...
    private void initComponents() {
        ...
        jTable1 = new com.afrisoftech.dbadmin.JTableEdit();
        ...
        */
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Drugs", "Qty", "Presc No", "Route", "Frequency", "No Of Days", "Dosage", "Paid", "Price", "Total"
            }
        ) {
            Class[] types = new Class [] {
        ...
        */
        ...
        javax.swing.table.TableColumn teditor2 = this.jTable1.getColumn("Route");
        ...
        javax.swing.table.TableColumn teditor1 = this.jTable1.getColumn("Frequency");
        ...
        javax.swing.table.TableColumn teditor3 = this.jTable1.getColumn("No Of Days");
        ...
        javax.swing.table.TableColumn teditor4 = this.jTable1.getColumn("Dosage");
        ...
        */
        ...
        jTabbedPane1.addTab("Dispense Drugs", jPanel5);
        ...
        jTabbedPane1.addTab("Waiting Patients", jPanel22);
        ...
        jTable121.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        ...
        jScrollPane11.setViewportView(jTable121);
        ...
        jTabbedPane1.addTab("Precription By Patient", jPanel221);
    ...
    private void jCheckBox7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jCheckBox7ActionPerformed
        ...
        try {
            ...
            java.sql.ResultSet rsetTable1 = stmtTable1.executeQuery("select trans_date ,inv_no,doctor,paid as dispensed from pb_doctors_request where revenue_code ilike 'pharm%'  and patient_no=  '" + this.jTextField91.getText().toString() + "' AND paid = true AND collected = false  group by trans_date,inv_no,doctor,paid ORDER BY inv_no asc");
    ...
    private void jTable121MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable121MouseClicked
        ...
        receiptNo = jTable121.getValueAt(jTable121.getSelectedRow(), 1).toString();
    ...
    private void jTable12MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable12MouseClicked
        ...
        PrescNo = jTable12.getValueAt(jTable12.getSelectedRow(), 3).toString();
        if (PrescNo.startsWith("O")) {
            jPanel11.setVisible(false);
            jPanel1.setVisible(true);
            jPanel13.setVisible(false);
            jTextField9.setText(jTable12.getValueAt(jTable12.getSelectedRow(), 1).toString());
            jTextField1.setText(jTable12.getValueAt(jTable12.getSelectedRow(), 2).toString());
            jTextField36.setText(jTable12.getValueAt(jTable12.getSelectedRow(), 4).toString());
            ...
            try {
                ...
                while (rsetTable1.next()) {
                    this.jTextField5.setText(rsetTable1.getString(2));
                ...
                if (this.jTextField5.getText().toString().equalsIgnoreCase("Scheme")) {
                    try {
                        ...
                        java.sql.ResultSet rset1 = stmt1.executeQuery("select nr_no,slip_no from credit_acc_slip where patient_no  ='" + jTextField9.getText() + "'  order by date desc limit 1");
                        while (rset1.next()) {

                            //  jTextField16.setText(dbObject.getDBObject(rset1.getObject(1), "-"));
                            jTextField151.setText(rset1.getObject(1).toString());
                            jTextField12.setText(dbObject.getDBObject(rset1.getObject(2), "-"));
                        }
...
//                    this.jButton1.setVisible(true);
                ...
                try {
                    ...
                    java.sql.ResultSet rsetTable12 = stmtTable1.executeQuery("select distinct(service) as product,amount,gl_code,0::numeric FROM pb_doctors_request WHERE patient_no ILIKE '%" + jTextField9.getText() + "%' AND revenue_code ilike '%Phar%' and inv_no= '" + jTable12.getValueAt(jTable12.getSelectedRow(), 3).toString() + "' order by service");

                    while (rsetTable12.next()) {

                        jTable1.setValueAt(rsetTable12.getObject(1), i, 0);
                        //  jTable1.setValueAt(rsetTable12.getObject("0"), i, 1);
                        jTable1.setValueAt(rsetTable12.getObject(3), i, 6);
                        jTable1.setValueAt(rsetTable12.getObject(2), i, 3);

                        jTable1.setValueAt(rsetTable12.getObject(4), i, 4);
                    ...
                    for (int m = 0; m < jTable1.getRowCount(); m++) {
                        ...
                        if (jTable1.getModel().getValueAt(m, 0) != null) {
                            ...
                            java.sql.ResultSet rs1 = pstmt1.executeQuery("select count(description) from stock_balance  where description ilike  '%" + jTable1.getValueAt(m, 0) + "%' and department ilike '%" + jComboBox1.getSelectedItem().toString() + "%'");
                            while (rs1.next()) {
                                l = rs1.getInt(1);
                            }
                            if (l > 0) {
                                java.sql.Statement pstmt = connectDB.createStatement();
                                java.sql.ResultSet rs = pstmt.executeQuery("select sum(qty) from stock_balance where description  ilike '%" + jTable1.getValueAt(m, 0) + "%' and department ilike '%" + jComboBox1.getSelectedItem().toString() + "%'");
                                while (rs.next()) {
                                    System.out.println("Passed 1");

                                    Qty = rs.getDouble(1);
                                    jTable1.setValueAt(Qty, m, 2);

                                }
                            } else {
                                jTable1.setValueAt("0.00", m, 2);
                            }
                    ...
                    if (Boolean.valueOf(jTable12.getModel().getValueAt(jTable12.getSelectedRow(), 5).toString()) == java.lang.Boolean.TRUE) {
            ...
            jTextField92.setText(jTable12.getValueAt(jTable12.getSelectedRow(), 1).toString());
            jTextField13.setText(jTable12.getValueAt(jTable12.getSelectedRow(), 2).toString());
            jTextField361.setText(jTable12.getValueAt(jTable12.getSelectedRow(), 4).toString());
            //  jTextField17.setText(jTable1.getValueAt(jTable1.getSelectedRow(),3).toString());
            ...
            try {
                ...
                try {
                    ...
                    java.sql.ResultSet rsetTable12 = stmtTable1.executeQuery("select distinct(service) as product,amount,gl_code,0 FROM pb_doctors_request WHERE patient_no ILIKE '%" + jTextField92.getText() + "%' AND revenue_code ilike '%Phar%' and inv_no= '" + jTable12.getValueAt(jTable12.getSelectedRow(), 3).toString() + "' order by service");
...
//                prescNo = jTable1.getValueAt(0, 2).toString();
                ...
                for (int i = 0; i < jTable1.getRowCount(); i++) {
                    ...
                    if (jTable1.getModel().getValueAt(i, 0) != null && jTable1.getModel().getValueAt(i, 7) != null) {
                        if (Boolean.valueOf(jTable1.getModel().getValueAt(i, 7).toString()) == java.lang.Boolean.TRUE) {
                            ...
                            amount1 = java.lang.Double.parseDouble(jTable1.getValueAt(i, 9).toString());
                            if (Total > presc) {
                            ...
                            pstmt1.setObject(10, jTextField36.getText());
                            ...
                            pstmt33.setString(14, jTextField9.getText() + " " + jTextField1.getText());
                            pstmt33.executeUpdate();*/
                            java.sql.PreparedStatement pstmt46 = connectDB.prepareStatement("UPDATE hp_pharmacy SET collected = true,quantity = '" + jTable1.getValueAt(i, 1).toString() + "',amount = '" + jTable1.getValueAt(i, 9).toString() + "' where patient_no = '" + jTextField9.getText() + "' and description = '" + jTable1.getValueAt(i, 0).toString() + "' and date_prescribed > (current_date - 2)");
                            pstmt46.executeUpdate();

                            java.sql.PreparedStatement pstmt46x = connectDB.prepareStatement("UPDATE pb_doctors_request SET collected = true where patient_no = '" + jTextField9.getText() + "' and service ilike '" + jTable1.getValueAt(i, 0).toString() + "' and trans_date > current_date - 2");
                ...
                for (int i = 0; i < jTable1.getRowCount(); i++) {
                    ...
                    if (jTable1.getModel().getValueAt(i, 0) != null && jTable1.getModel().getValueAt(i, 7) != null) {
                        if (Boolean.valueOf(jTable1.getModel().getValueAt(i, 7).toString()) == java.lang.Boolean.TRUE) {
                            ...
                            java.sql.PreparedStatement pstmtSel = connectDB.prepareStatement("select units,product_id,strength from st_stock_prices where product = ?");
                            ...
                            pstmt33.setDouble(4, java.lang.Double.valueOf(jTable1.getValueAt(i, 1).toString()));
                            pstmt33.setDouble(5, java.lang.Double.valueOf(jTable1.getValueAt(i, 8).toString()));
                            pstmt33.setDouble(6, java.lang.Double.valueOf(jTable1.getValueAt(i, 9).toString()));
                            ...
                            pstmt33.setString(13, jTextField42.getText());
                            pstmt33.setString(14, jTextField9.getText() + " " + jTextField1.getText());
                            pstmt33.setDouble(15, amount1 / java.lang.Double.valueOf(jTable1.getValueAt(i, 1).toString()));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if (exitOption == javax.swing.JOptionPane.YES_OPTION) {
            ...
            try {
                ...
                java.sql.ResultSet rsetd = psd.executeQuery("select back_date from ac_limit_cons");

                while (rsetd.next()) {

                    Billdays = rsetd.getInt(1);
                    //billDate1 = rset9.getDate(2);
                }
                java.sql.Statement ps9 = connectDB.createStatement();
                java.sql.ResultSet rset9 = ps9.executeQuery("select (current_date-(" + Billdays + ")),current_date");

                while (rset9.next()) {

                    billDate = rset9.getDate(1);
                    billDate1 = rset9.getDate(2);
                }

                if (this.datePicker1.getDate().before(billDate) || this.datePicker1.getDate().after(billDate1)) {
                    ...
                    Standards.add("Metropolitan Hospital");
                    Standards.add("");
                    ...
                    for (int i = 0; i < jTable1.getRowCount(); i++) {
                        ...
                        if (jTable1.getModel().getValueAt(i, 0) != null) {
                            ...
                            java.sql.ResultSet rs11 = pst21.executeQuery("select cost_of_sale,stock_code from pb_departments where income_account = '" + jTable1.getModel().getValueAt(i, 6).toString() + "'");
                            while (rs11.next()) {
                            ...
                            java.sql.ResultSet rsB = pstB.executeQuery("select transfer_price,units from st_stock_prices where product = '" + jTable1.getModel().getValueAt(i, 0).toString() + "'");
                            ...
                            pstmt1.setDate(13, com.afrisoftech.lib.SQLDateFormat.getSQLDate(datePicker1.getDate()));
                            pstmt1.setObject(14, jComboBox1.getSelectedItem().toString());
                            ...
                            java.sql.ResultSet rse121e = stm121e.executeQuery("select activity from pb_activity where code ='" + jTable1.getValueAt(i, 6).toString() + "'");
                            while (rse121e.next()) {
                            ...
                            Quantity.add(q_t);
                            Codes.add("");
                            CodeDesc.add(jTable1.getValueAt(i, 0).toString());
                            CodeType.add(glAcc);
...
//            this.jButton1.setVisible(true);
    ...
    private void jTextField113CaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextField113CaretUpdate
        ...
        if (this.jCheckBox1.isSelected() && this.jCheckBox31.isSelected()) {
            ...
            if (jTextField113.getCaretPosition() < 3) {
                ...
                jSearchTable2.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB, "SELECT DISTINCT patient_no, patient_name as name, age, gender FROM pb_doctors_request WHERE patient_no ILIKE '" + jTextField113.getText() + "%' AND paid = true and collected = false AND curr_date >= CURRENT_DATE - 5 order by patient_no LIMIT 20"));
    ...
    private void jSearchTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jSearchTableMouseClicked
        ...
        jTable1.setValueAt(jSearchTable.getValueAt(jSearchTable.getSelectedRow(), 1), jTable1.getSelectedRow(), 8);
        ...
        java.sql.ResultSet rs1 = pstmt1.executeQuery("select count(product) from st_stock_prices sc where product = '" + jSearchTable.getValueAt(jSearchTable.getSelectedRow(), 0) + "' and department ilike '" + jComboBox1.getSelectedItem().toString() + "'");
        while (rs1.next()) {
        j = rs1.getInt(1);
        }
        if (j > 0) {

        java.sql.ResultSet rs = pstmt.executeQuery("select sum(qty) from stock_balance where description = '" + jSearchTable.getValueAt(jSearchTable.getSelectedRow(), 0) + "' and department ilike '" + jComboBox1.getSelectedItem().toString() + "'");
        while (rs.next()) {
    ...
    private void jTable1KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTable1KeyReleased
        if (jTable1.getModel().getValueAt(jTable1.getSelectedRow(), 1) != null) {
            if (jTable1.getSelectedColumn() == jTable1.getSelectedColumn()) {
                ...
                float price = java.lang.Float.parseFloat(jTable1.getValueAt(jTable1.getSelectedRow(), 8).toString());
                float total = qty * price;
                jTable1.setValueAt(total, jTable1.getSelectedRow(), 9);
                double totalSum = com.afrisoftech.lib.TableColumnTotal.getTableColumnTotal(jTable1, 9);
    ...
    private void populateTable1(java.lang.String patient_no) {
        ...
        try {
            ...
            java.sql.ResultSet rsetTable11 = stmtTable11.executeQuery("SELECT count(patient_no)  FROM pb_doctors_request WHERE patient_no = '" + patient_no + "' AND trans_date >= current_date - 5 AND paid = true AND collected = false");
            ...
            if (j > 0) {
                ...
                java.sql.ResultSet rsetTable1 = stmtTable1.executeQuery("SELECT "
                        ...
                        + " AND trans_date > (CURRENT_DATE - 2) AND collected = false"
                        + " AND revenue_code ilike 'pharm%' group by service, quantity,inv_no,requisition_no,bed_no,time_due,dosage,paid,amount");
                ...
                while (rsetTable1.next()) {
                    ...
                    jTable1.setValueAt(rsetTable1.getBoolean(8), i, 7);
    ...
    private void jButton33ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton33ActionPerformed
        ...
        try {
            ...
            java.sql.ResultSet rsetTable12 = stmtTable12.executeQuery("select distinct trans_date,patient_no,patient_name,inv_no,doctor,paid  from pb_doctors_request where revenue_code ilike '%pharm%' AND "
                    + "trans_date >= current_date -5 and paid = true AND collected = false group by trans_date,patient_no,patient_name,inv_no,doctor,paid ORDER BY inv_no asc");

            while (rsetTable12.next()) {

                jTable12.setValueAt(rsetTable12.getObject(1), i, 0);
                jTable12.setValueAt(rsetTable12.getObject(2), i, 1);
                jTable12.setValueAt(rsetTable12.getObject(3), i, 2);
                jTable12.setValueAt(rsetTable12.getObject(4), i, 3);
                jTable12.setValueAt(rsetTable12.getObject(5), i, 4);

                jTable12.setValueAt(java.lang.Boolean.valueOf(false), i, 5);
    ...
    public void runGetListThread() {
        ...
        try {
            ...
            java.sql.ResultSet rsetTable12 = stmtTable12.executeQuery("select distinct trans_date,patient_no,patient_name,inv_no,doctor,paid  from pb_doctors_request where revenue_code ilike '%pharm%' "
                    + "AND trans_date >= current_date - 5 and paid = true and collected = false group by trans_date,patient_no,patient_name,inv_no,doctor,paid ORDER BY trans_date,inv_no DESC LIMIT 299");
