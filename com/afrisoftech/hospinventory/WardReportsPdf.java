...
public class WardReportsPdf implements java.lang.Runnable {
    ...
    public void WardItemsPdf(java.sql.Connection connDb,java.util.Date begindate,java.util.Date endate,java.lang.String combox) {
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    com.lowagie.text.HeaderFooter footer = new com.lowagie.text.HeaderFooter(new Phrase("Nutrition Services Offered at "+ bank +" - Page: ",pFontHeader), true);// FontFactory.getFont(com.lowagie.text.FontFactory.HELVETICA, 12, Font.BOLDITALIC,java.awt.Color.blue));
                    ...
                    try {
                        ...
                        int headerwidths[] = {12,25,10,10,8};
...
//                        table.getDefaultCell().setBorder(Rectangle.BOTTOM);
                        ...
                        Double d;
                           ...
                           try {
                                ...
                                phrase = new Phrase(bank + "\nSuppliment/Service Period : " +dateFormat.format(endDate11)+" - "+dateFormat.format(endDate1), pFontHeader);
                                table.addCell(phrase);
...
//                        table.getDefaultCell().setBorderColor(java.awt.Color.WHITE);
                        ...
                        try {
                            ...
                            java.sql.ResultSet rset2 = st2.executeQuery("SELECT DISTINCT patient_no FROM hp_admission WHERE ward ILIKE '"+bank+"'");
                            
                            System.out.println(bank);
                            
                            java.sql.ResultSet rset = st.executeQuery("SELECT DISTINCT date, patient_no, service_type, count(service_type), "
                                    + "sum(credit - debit) FROM ac_ledger WHERE EXISTS (SELECT DISTINCT patient_no FROM hp_admission "
                                    + "WHERE patient_no = ac_ledger.patient_no AND ward ILIKE 'BURNS UNIT WARD') "
                                    + "AND activity_code = '600-60601-60035' "
                                    + "AND date BETWEEN '"+beginDate+"' AND '"+endDate+"'"
                                    + "GROUP BY service_type, patient_no, date ORDER BY date");
                                ...
                                while (rset.next()) {
                                    ...
                                    phrase = new Phrase(new com.afrisoftech.sys.Format2Currency().Format2Currency(rset.getObject(5).toString()),pFontHeader);
                                    osBalance = osBalance + Double.valueOf(rset.getObject(5).toString());
                                    table.addCell(phrase);
                                    
                                    System.out.println("Yes - "+rset.getObject(2).toString());
                            ...
                            table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                            phrase = new Phrase("Gross Total Revenue from " + bank, pFontHeader);
                            table.addCell(phrase);
