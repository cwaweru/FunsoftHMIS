 ...
 * @author  root
 */
public class Stocktransfersintfr_old extends javax.swing.JInternalFrame {
    ...
    public Stocktransfersintfr_old(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {
        ...
        */
        ...
        jComboBox13.setModel(com.afrisoftech.lib.ComboBoxModel.ComboBoxModel(connectDB, "select store_name from st_stores order by store_name"));
        ...
        jComboBox131.setModel(com.afrisoftech.lib.ComboBoxModel.ComboBoxModel(connectDB, "select store_name from st_stores order by store_name"));
...
// TODO add your handling code here:
    ...
    private void jTextField111CaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextField111CaretUpdate
        if(jTextField111.getCaretPosition() > 2){
            jSearchTable.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"select product,units ,transfer_price ,selling_price,category,product_id FROM st_stock_prices WHERE product ILIKE '%"+jTextField111.getText()+"%' and department ilike '"+this.jComboBox13.getSelectedItem().toString()+"%' order by product"));
