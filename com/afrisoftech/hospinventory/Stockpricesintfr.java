 ...
 * @author  root
 */
public class Stockpricesintfr extends javax.swing.JInternalFrame implements java.lang.Runnable {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            if (jTextField2.getText().equals(null) || jTextField2.getText().equals("")) {
                javax.swing.JOptionPane.showMessageDialog(this, "YOU MUST SELECT Revenue A/C", "Caution Message!", javax.swing.JOptionPane.WARNING_MESSAGE);
            } else {
                ...
                for (int i = 0; i < jTable1.getRowCount(); i++) {
                    if (jTable1.getModel().getValueAt(i, 4) != null) {
                        if (jButton1.getLabel().equalsIgnoreCase("Update")) {
                            ...
                            //pstmt311.executeUpdate();
                            pstmt311.executeUpdate();
                            java.sql.PreparedStatement pstmt3111 = connectDB.prepareStatement("UPDATE st_stock_prices SET units = '" + jTable1.getValueAt(i, 3).toString() + "', strength= '" + jTable1.getValueAt(i, 2).toString() + "' WHERE product_id = '" + jTable1.getModel().getValueAt(i, 0).toString() + "'");
                            ...
                            if (jButton1.getLabel().equalsIgnoreCase("Save")) {
                                ...
                                if (jTable1.getValueAt(i, 5) == null) {
                                    ...
                                    pstmt.setDouble(4, java.lang.Double.valueOf(jTable1.getValueAt(i, 5).toString()));
                                }
                                pstmt.setDouble(3, java.lang.Double.valueOf(jTable1.getValueAt(i, 6).toString()));
                                ...
                                pstmt.setObject(7, jComboBox3.getSelectedItem().toString());
                                pstmt.setString(8, jTextField2.getText());
                                pstmt.setObject(9, jComboBox1.getSelectedItem().toString());
                                pstmt.setDouble(10, java.lang.Double.valueOf(jTable1.getValueAt(i, 4).toString()));
                                ...
                                pstmt.setObject(16, jTable1.getValueAt(i, 2).toString());
                                pstmt.executeUpdate();
                            }
                        }
                    }
