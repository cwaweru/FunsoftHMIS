...
public class TenderScheduleReportPDF implements java.lang.Runnable {
   ...
   // private String time=null;
    ...
    public void TenderScheduleReportPDF(java.sql.Connection connDb, java.lang.String tenderNo) {
      //  selectSupp = combox;
      //  Department = dept;
        OrderNo = tenderNo;
       // user = UserName;
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    com.lowagie.text.HeaderFooter footer = new com.lowagie.text.HeaderFooter(new Phrase(""+OrderNo+"   Tender Price Schedule Summary- Page: ", pFontHeader1), true);// FontFactory.getFont(com.lowagie.text.FontFactory.HELVETICA, 12, Font.BOLDITALIC,java.awt.Color.blue));
...
//                            }
                            ...
                            while (rset4.next()) {
                                ...
                                table2.getDefaultCell().setColspan(10);
                                table2.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_CENTER);
                                phrase = new Phrase("TENDER SCHEDULE SUMMARY", pFontHeader5);
                                table2.addCell(phrase);
                                
                                 table2.getDefaultCell().setColspan(10);
                                table2.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_CENTER);
                                phrase = new Phrase("TENDER NUMBER  -    "+OrderNo+"  "+com.afrisoftech.lib.GetItemInfo.getITenderDesc(OrderNo, connectDB).toUpperCase(), pFontHeader5);
                                table2.addCell(phrase);
...
//                             
                     ...
                     java.sql.Statement st5 = connectDB.createStatement();
                     java.sql.ResultSet rset5 = st5.executeQuery("select distinct item_description,units,quantity,item_code from st_floated_quotations where quotation_no = '" + OrderNo + "' ");// where supplier_name = 'Uchumi'member_no = '"+memNo+"'  AND date BETWEEN '"+beginDate+"' AND '"+endDate+"'");      
//items table
                      while(rset5.next()){
                       ...
                       //0 
                        ...
                        phrase = new Phrase(rset5.getObject(4).toString()+"-"+rset5.getObject(1).toString(), pFontHeadertableTitle);
                        ...
                        phrase = new Phrase("Quantities On Tender: "+CurrencyFormatter.getFormattedDouble(rset5.getDouble(3)), pFontHeadertableTitle);
                        table3.addCell(phrase);
                        //-------
                        ...
                        table3.getDefaultCell().setColspan(3);
                        phrase = new Phrase("BIDDER", pFontHeader5);
                        table3.addCell(phrase);
                        
                        //2
                        table3.getDefaultCell().setColspan(2);
                        phrase = new Phrase("COUNTRY ORIGN", pFontHeader5);
                        table3.addCell(phrase);
//                        //2
//                        table3.getDefaultCell().setColspan(2);
...
//                        table3.addCell(phrase);
                        ...
                        phrase = new Phrase("UNIT PRICE", pFontHeader5);
                        table3.addCell(phrase);
                        //4
                        table3.getDefaultCell().setColspan(2);
                        phrase = new Phrase("TOTAL", pFontHeader5);
                        table3.addCell(phrase);
...
//                          
                          ...
                          //criteria,mark_awarded,remarks,
                            java.sql.ResultSet rset1 = st2.executeQuery("SELECT  distinct country_origin,quantity,unit_price,quantity*unit_price from st_floated_quotations  where quotation_no ='"+OrderNo+"' and supplier  = '"+listofAct[i].toString()+"' and  item_description ilike '"+rset5.getObject(1).toString()+"' ");

                          //bidder_no
                            
                            while (rset1.next()) {
                               System.out.println("SELECT distinct country_origin,quantity,unit_price,quantity*unit_price from st_floated_quotations  where quotation_no ='"+OrderNo+"' and supplier  = '"+listofAct[i].toString()+"' and  item_description ilike '"+rset5.getObject(1).toString()+"'");
                               //cnt+=1;
...
//                            table3.addCell(phrase);
                            ...
                            table3.getDefaultCell().setColspan(3);
                            table3.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                            phrase = new Phrase(listofAct[i].toString().toUpperCase(), pFontHeader2);
                            table3.addCell(phrase);
                            ...
                            //cOUNTRY oRIGN
                                table3.getDefaultCell().setColspan(2);
                                table3.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                                phrase = new Phrase(dbObject.getDBObject(rset1.getObject(1), "N/A"), pFontHeader2);
                                table3.addCell(phrase);
...
//                           
                    ...
                    try{
                        ...
                        try {
                            pst = connectDB.prepareStatement("select count(distinct supplier) from st_floated_quotations where quotation_no = '"+OrderNo+"' and supplier in (select distinct supplier_name  from st_tender_suppliers  where tender='"+OrderNo+"' and opened=true) ");
                            pst2 = connectDB.prepareStatement("select count(distinct item_description) from st_floated_quotations where quotation_no = '"+OrderNo+"' ");
                            ...
                            ResultSet rsetBidders = pst.executeQuery();
                            
                             while(rsetBidders.next()){
                            total_bidders = rsetBidders.getObject(1).toString();
                            
                            }
 
                            ResultSet rsetItems= pst2.executeQuery();
                             while(rsetItems.next()){
                            total_items = rsetItems.getObject(1).toString();
                            
                            }
          
                           
                        } catch (SQLException ex) {
                            Logger.getLogger(TenderScheduleReportPDF.class.getName()).log(Level.SEVERE, null, ex);
                        }
                           ...
                           //just a white space
                            ...
                            table4.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                            phrase = new Phrase("TOTAL Number of Respondents :"+total_bidders+"                  ", pFontHeader);
                            table4.addCell(phrase);
                            ...
                            table4.getDefaultCell().setColspan(9);
                            table4.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                            phrase = new Phrase("TOTAL ITEMS ON TENDER: "+total_items, pFontHeader);
                            table4.addCell(phrase);
    ...
    public java.lang.Object[] getListofActivities() {
        ...
        java.sql.ResultSet rSet1 = stmt1.executeQuery("select distinct supplier from st_floated_quotations  where quotation_no  = '"+OrderNo+"' and supplier in (select distinct supplier_name  from st_tender_suppliers  where tender='"+OrderNo+"' and opened=true)");
