...
public class UnpricedRepPdf implements java.lang.Runnable {
    ...
    com.lowagie.text.Font pFontHeader3 = FontFactory.getFont(FontFactory.TIMES, 11, Font.BOLD);
    com.lowagie.text.Font pFontHeader31 = FontFactory.getFont(FontFactory.TIMES, 11, Font.BOLD);
    com.lowagie.text.Font pFontHeader4 = FontFactory.getFont(FontFactory.TIMES, 13, Font.BOLD);
                ...
                try {
                    ...
                    try {
                        ...
                        try {
                            ...
                            java.sql.ResultSet rset51 = st6.executeQuery("select DISTINCT supplier FROM st_orders WHERE order_no = '" + OrderNo + "'");

                            while (rset51.next()) {
                                company = rset51.getObject(1).toString();
                            }

                            java.sql.ResultSet rset2 = st2.executeQuery("select supplier_name,short_name,postal_address,tel1,initcap(street),initcap(avenue),fax_no,email_address,initcap(building_name) from st_suppliers WHERE supplier_name  ilike '" + company + "'");
                            java.sql.ResultSet rset4 = st4.executeQuery("select DISTINCT order_no,date from st_orders where order_no = '" + OrderNo + "'");
                            java.sql.ResultSet rset5 = st5.executeQuery("select DISTINCT date_due from st_orders where order_no = '" + OrderNo + "'");
                            java.sql.ResultSet rset1 = st1.executeQuery("select current_user");
                            while (rset1.next()) {
                    ...
                    try {
                        ...
                        int headerwidths[] = {10, 35, 10, 8, 10, 10, 10};
                        ...
                        phrase = new Phrase("Item(Print)", pFontHeader);
                        table.addCell(phrase);
                        ...
                        phrase = new Phrase("MEDS Remarks", pFontHeader);
                        table.addCell(phrase);
                        ...
                        try {
                            ...
                            java.sql.ResultSet rset1 = st1.executeQuery("select code,initcap(item),item_strength,units,quantity,unit_price,net_value from st_orders where order_no ='" + OrderNo + "'");// where supplier_name = 'Uchumi'member_no = '"+memNo+"'  AND date BETWEEN '"+beginDate+"' AND '"+endDate+"'");
                            ...
                            table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                            phrase = new Phrase("Terms of Payment : _______________________________", pFontHeader);
                            ...
                            table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                            phrase = new Phrase("ADMINISTRATOR \n \n Date :.........................", pFontHeader);
