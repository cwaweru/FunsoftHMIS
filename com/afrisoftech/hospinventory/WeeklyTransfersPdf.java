...
public class WeeklyTransfersPdf implements java.lang.Runnable {
    ...
    com.lowagie.text.Font pFontHeader12 = FontFactory.getFont(FontFactory.HELVETICA, 9, Font.BOLD);
    ...
    public void WeeklyTransfersPdf(java.sql.Connection connDb,java.util.Date begindate,java.util.Date endate,java.lang.String combox) {
            ...
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        int headerwidths[] = {35,10,10,10,10,12};//,13,13};
                        ...
                        try {
                            ...
                            phrase = new Phrase(memNo.toUpperCase() + " : Weekly Stock Transfers as at -: " +dateFormat.format(endDate2), pFontHeader12);
                        ...
                        phrase = new Phrase("Printed on : "+date,pFontHeader12);
                        table.addCell(phrase);
                        ...
                        try {
                            ...
                            for (int i = 0; i < listofAct.length; i++) {
                                ...
                                if (name > 0){
                                    ...
                                    java.sql.PreparedStatement pset1 = connectDB.prepareStatement("select ROUND(sum(issuing),0) from st_sub_stores WHERE item = ? and issuing > 0 AND store_name ILIKE '"+memNo+"' AND trans_date < '"+rangeDates[rangeDates.length - 1][0]+"'");
                                    pset1.setString(1,listofAct[i].toString());
                                    java.sql.ResultSet rset1 = pset1.executeQuery();
                                    
                                    java.sql.PreparedStatement pset111 = connectDB.prepareStatement("select ROUND(sum(issuing),0) from st_sub_stores WHERE item = ? and issuing > 0 AND store_name ILIKE '"+memNo+"' AND trans_date < '"+endDate+"'");
                                    ...
                                    java.sql.PreparedStatement pset112 = connectDB.prepareStatement("select ROUND(sum(issuing),0) from st_sub_stores WHERE item = ? and issuing > 0 AND store_name ILIKE '"+memNo+"' AND trans_date < '"+endDate+"'");
                                    ...
                                    for (int t = 0; t < rangeDates.length; t++) {
                                        ...
                                        java.sql.PreparedStatement pset = connectDB.prepareStatement("select ROUND(sum(issuing),0) from st_sub_stores WHERE item = ? and issuing > 0 AND store_name ILIKE '"+memNo+"' AND trans_date between '"+rangeDates[t][0]+"' AND '"+rangeDates[t][1]+"'");//< '"+endDate+"'::date and date > '"+endDate+"'::date - 30 group by dealer");
...
docPdf.close();  com.afrisoftech.lib.PDFRenderer.renderPDF(tempFile);
    ...
    public java.lang.Object[] getListofActivities() {
        ...
        try {
            ...
            java.sql.PreparedStatement pSet1 = connectDB.prepareStatement("SELECT DISTINCT item FROM st_sub_stores where item  IS NOT NULL and item  !='' and issuing > 0 and store_name ilike '"+memNo+"%' and trans_date between '"+beginDate+"' and '"+endDate+"' order by item ");
