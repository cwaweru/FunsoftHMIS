...
public class TenderItemsPDF implements java.lang.Runnable {
            ...
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        int headerwidths[] = {10, 10, 40, 20, 10};
                        ...
                        Phrase phrase = new Phrase("STOCK ITEMS FOR " + bank + " : ", com.lowagie.text.FontFactory.getFont(FontFactory.HELVETICA_BOLD, 10));
                        ...
                        try {
                            ...
                            java.sql.ResultSet rset1 = st2.executeQuery("SELECT item_code,initcap(description),strength,buying_price from st_stock_item where department ilike '" + bank + "' AND sub_cat_code = '"+listofAct[i].toString()+"' order by description");
