 ...
 * @author root
 */
public class Packingintfr extends javax.swing.JInternalFrame {
     ...
     */
    public Packingintfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Set packing types here"));
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Code", "Name", "Bulk Supply Unit", "Conversion Unit"
            }
        ) {
        ...
        setBounds(0, 0, 1024, 450);
    }// </editor-fold>//GEN-END:initComponents

    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        try {
            connectDB.setAutoCommit(false);
            java.sql.PreparedStatement pstmt31 = connectDB.prepareStatement("DELETE FROM st_packing WHERE genre_code = '" + jTable1.getModel().getValueAt(jTable1.getSelectedRow(), 0).toString() + "'");
...
// TODO add your handling code here:
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        jTable1.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB, "select genre_code as code,genre_desc,bulk_supply_unit,conversion_unit from st_packing ORDER BY 2"));
            ...
            for (int i = 0; i < jTable1.getRowCount(); i++) {
                if (jTable1.getModel().getValueAt(i, 0) != null) {
                    if (jButton1.getLabel().equalsIgnoreCase("Update")) {
                        if (jTable1.getValueAt(i, 2) != null || jTable1.getValueAt(i, 3) != null) {
                            java.sql.PreparedStatement pstmt311 = connectDB.prepareStatement("UPDATE st_packing SET genre_desc = '" + jTable1.getValueAt(i, 1).toString() + "',bulk_supply_unit='" + jTable1.getValueAt(i, 2).toString() + "',conversion_unit='" + jTable1.getValueAt(i, 3).toString() + "' WHERE genre_code = '" + jTable1.getModel().getValueAt(i, 0).toString() + "'");
                            pstmt311.executeUpdate();

                        }
                    } else {
                        java.sql.PreparedStatement pstmt = connectDB.prepareStatement("INSERT INTO st_packing VALUES(?, UPPER(?), ?,?,?)");
                        ...
                        pstmt.setDouble(5, Double.valueOf(jTable1.getValueAt(i, 3).toString()));
