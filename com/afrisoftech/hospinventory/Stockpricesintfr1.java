 ...
 * @author  root
 */
public class Stockpricesintfr1 extends javax.swing.JInternalFrame implements java.lang.Runnable {
    ...
    boolean getList;
    public Stockpricesintfr1(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {
        ...
        */
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Product", "Product ID", "Units", "Buying Price", "Selling Price", "Strength"
            }
        ) {
        ...
        */
        ...
        jComboBox2.setModel(com.afrisoftech.lib.ComboBoxModel.ComboBoxModel(connectDB, "select store_name from st_stores order by store_name"));
        ...
        jComboBox3.setModel(com.afrisoftech.lib.ComboBoxModel.ComboBoxModel(connectDB, "select UPPER(ac.activity) as activity from pb_activity ac where (ac.activity_category ilike 'I%' OR ac.activity_category = 'CA'  OR ac.activity_category = 'CF' OR ac.activity_category = 'BS'  ) ORDER BY AC.ACTIVITY"));
    ...
    private void jButton31ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton31ActionPerformed
        try{
            ...
            java.sql.PreparedStatement pstmt311 = connectDB.prepareStatement("DELETE from st_stock_prices WHERE product_id = '"+jTable1.getModel().getValueAt(jTable1.getSelectedRow(),1).toString()+"' AND department = '"+jComboBox2.getSelectedItem()+"'");
    ...
    private void jCheckBox1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jCheckBox1ActionPerformed
        ...
        if(jTextField11.getText().equalsIgnoreCase("-")){
            jTable1.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"select product as product,product_id,units,transfer_price::numeric as buying_price,selling_price::numeric, strength from st_stock_prices WHERE department ilike '"+jComboBox2.getSelectedItem()+"' AND category ilike '"+jComboBox1.getSelectedItem()+"' ORDER BY product"));
            
        }else{
            jTable1.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"select product as product,product_id,units,transfer_price::numeric as buying_price,selling_price::numeric, strength from st_stock_prices WHERE (product ILIKE '"+jTextField11.getText()+"%' OR product ILIKE '"+jTextField21.getText()+"%') AND department ilike '"+jComboBox2.getSelectedItem()+"' AND category ilike '"+jComboBox1.getSelectedItem()+"' ORDER BY product"));
        }
    ...
    private void jTextField111CaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextField111CaretUpdate
        if(jTextField111.getCaretPosition() > 2){
            jSearchTable.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"select description FROM st_stock_item WHERE description ILIKE '"+jTextField111.getText()+"%'  except select product FROM st_stock_prices WHERE department ilike '"+jComboBox2.getSelectedItem()+"%'"));
    ...
    private void jComboBox1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBox1ActionPerformed
      ...
      // jTable1.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB, "select description,item_code,units,0::numeric as buying_price,0::numeric as selling,strength FROM st_stock_item WHERE sub_cat_code ilike '"+jComboBox1.getSelectedItem()+"%'" +
      ...
      /*  
        ...
        try {
            ...
            for (int i = 0; i < jTable1.getRowCount(); i++ ) {
                ...
                java.sql.Statement pstmt = connectDB.createStatement();
                java.sql.ResultSet rsetTable1 = pstmt.executeQuery("select round((buying_price/packaging)::numeric),ROUND((buying_price/packaging)::numeric*'"+markup+"') as selling,description,units,strength FROM st_stock_item WHERE sub_cat_code ilike '"+jComboBox1.getSelectedItem()+"%' AND item_code ilike '"+jTable1.getValueAt(i,1)+"'");
                while (rsetTable1.next()){
                    jTable1.setValueAt(rsetTable1.getObject(3), i, 0);
                    jTable1.setValueAt(rsetTable1.getObject(4), i, 2);
                    jTable1.setValueAt(rsetTable1.getObject(1), i, 3);
    ...
    */   // }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        int i = 0;
        if(jTextField11.getText().equalsIgnoreCase("-")){
            jTable1.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"select product,product_id,units,transfer_price::numeric as buying_price,selling_price::numeric as selling_price,strength from st_stock_prices WHERE department ilike '"+jComboBox2.getSelectedItem()+"' AND category ilike '"+jComboBox1.getSelectedItem()+"' ORDER BY product"));
            
        }else{
            jTable1.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"select product,product_id,units,transfer_price::numeric as buying_price,selling_price::numeric as selling_price,strength from st_stock_prices WHERE (product ILIKE '"+jTextField11.getText()+"%' OR product ILIKE '"+jTextField21.getText()+"%') AND department ilike '"+jComboBox2.getSelectedItem()+"' ORDER BY product"));
        }
        jButton1.setLabel("Update");
        this.jButton1.setEnabled(true);
        // Add your handling code here:
                ...
                for (int i = 0; i < jTable1.getRowCount(); i++){
                    if (jTable1.getModel().getValueAt(i,4) != null){
                        if(jButton1.getLabel().equalsIgnoreCase("Update")){
                            java.sql.PreparedStatement pstmt31 = connectDB.prepareStatement("UPDATE st_stock_item SET description = '"+jTable1.getValueAt(i,0).toString().toUpperCase()+"',buying_price = '"+jTable1.getValueAt(i,3).toString()+"'  WHERE item_code = '"+jTable1.getModel().getValueAt(i,1).toString()+"'");
                            pstmt31.executeUpdate();
                            java.sql.PreparedStatement pstmt311 = connectDB.prepareStatement("UPDATE st_stock_prices SET product = '"+jTable1.getValueAt(i,0).toString().toUpperCase()+"',transfer_price = '"+jTable1.getValueAt(i,3).toString()+"',selling_price = '"+jTable1.getValueAt(i,4).toString()+"' WHERE product_id = '"+jTable1.getModel().getValueAt(i,1).toString()+"' AND department ilike '"+this.jComboBox2.getSelectedItem()+"'and category ilike '"+jComboBox1.getSelectedItem().toString()+"' and strength ilike '"+jTable1.getValueAt(i,5).toString().toUpperCase()+"'");
                            pstmt311.executeUpdate();
                            ...
                            if(jButton1.getLabel().equalsIgnoreCase("Save")){
                                ...
                                pstmt.setDouble(3,java.lang.Double.valueOf(jTable1.getValueAt(i,4).toString()));
                                ...
                                pstmt.setObject(16,jTable1.getValueAt(i,5).toString());
                                pstmt.executeUpdate();
                            }
                        }
                    }
