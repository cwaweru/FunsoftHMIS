...
public class TenderQtyBalancePDF implements java.lang.Runnable {
 com.afrisoftech.lib.DBObject DBObject = new com.afrisoftech.lib.DBObject();
   ...
   // private String time=null;
    ...
    public void TenderQtyBalancePDF(java.sql.Connection connDb, java.lang.String tenderNo) {
      //  selectSupp = combox;
      //  Department = dept;
        OrderNo = tenderNo;
       // user = UserName;
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    com.lowagie.text.HeaderFooter footer = new com.lowagie.text.HeaderFooter(new Phrase(""+OrderNo+"   Tender awards for all suppliers - Page: ", pFontHeader1), true);// FontFactory.getFont(com.lowagie.text.FontFactory.HELVETICA, 12, Font.BOLDITALIC,java.awt.Color.blue));
...
//                            }
                           ...
                           // while (rset4.next()) {
                                ...
                                table2.getDefaultCell().setColspan(10);
                                table2.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_CENTER);
                                phrase = new Phrase("TENDER BALANCES PER ITEM FOR TENDER "+OrderNo+"  "+com.afrisoftech.lib.GetItemInfo.getITenderDesc(OrderNo, connectDB).toUpperCase(), pFontHeader5);
...
//                 
               for (int i = 0; i < listofAct.length; i++) {
                            ...
                            table3.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                            phrase = new Phrase("M/s "+listofAct[i].toString(), pFontHeadertableTitle);
                            table3.addCell(phrase);     
                            
                     java.sql.Statement st5 = connectDB.createStatement();
                 
                        table3.getDefaultCell().setColspan(3);
                        phrase = new Phrase("ITEM/UNIT", pFontHeader);
                        table3.addCell(phrase);
                        //2
                        table3.getDefaultCell().setColspan(2);
                        phrase = new Phrase("Awarded_Qty", pFontHeader);
                        table3.addCell(phrase);
                        //3
                        table3.getDefaultCell().setColspan(2);
                        ...
                        //4
                        table3.getDefaultCell().setColspan(3);
                        phrase = new Phrase("Balance(Qty)", pFontHeader);
                        table3.addCell(phrase);
...
//                         
                          ...
                          //item,quantity_awarded,ordered,balance
                            java.sql.ResultSet rset1 = st2.executeQuery("select  distinct item,quantity,unit_price,(unit_price*quantity),SUM(unit_price*quantity),units FROM st_orders where quotation_no ='"+OrderNo+"'  and supplier ilike '"+listofAct[i].toString()+"' and order_no is null group by 1,2,3,6 order by 1");
                     ...
                     while (rset1.next()) {
                                ...
                                cnt+=1 ;
                                total_award=rset1.getDouble(2);
                           
                               
                            //item    
                            table3.getDefaultCell().setColspan(3);
                            table3.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                            phrase = new Phrase(String.valueOf(cnt)+". "+rset1.getObject(1).toString()+"/"+rset1.getObject(6).toString(), pFontHeader2);
                            table3.addCell(phrase);
                            
                            //qty_awarded
                            table3.getDefaultCell().setColspan(2);
                            table3.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                            phrase = new Phrase(CurrencyFormatter.getFormattedDouble(total_award), pFontHeader);
                            table3.addCell(phrase);
                            ...
                            table3.getDefaultCell().setColspan(2);
                            table3.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                            phrase = new Phrase(CurrencyFormatter.getFormattedDouble(getOrderBalance(OrderNo, listofAct[i].toString(), rset1.getObject(1).toString())), pFontHeader);
                            table3.addCell(phrase);

                            
                            //bal
                            table3.getDefaultCell().setColspan(3);
                            phrase = new Phrase(CurrencyFormatter.getFormattedDouble(total_award-getOrderBalance(OrderNo, listofAct[i].toString(), rset1.getObject(1).toString())), pFontHeader2);
                            table3.addCell(phrase);
            ...
            docPdf.add(table3);
                    ...
                    try{
                        ...
                        try {                     
                            ...
                            Logger.getLogger(TenderQtyBalancePDF.class.getName()).log(Level.SEVERE, null, ex);
                        }
...
//                         table4.getDefaultCell().setColspan(9);
    ...
    public java.lang.Object[] getListofActivities() {
        ...
        java.sql.ResultSet rSet1 = stmt1.executeQuery("select distinct upper(supplier) from st_orders  WHERE  quotation_no  = '"+OrderNo+"'  order by 1 ");
...
//        
//    
     private double getOrderBalance(java.lang.String tender,String supplier, String item){
        Double qty= 0.00;
        try {
            java.sql.Statement cd = connectDB.createStatement();
               
                    java.sql.ResultSet rsetbal = cd.executeQuery("select  sum(quantity) FROM st_orders where quotation_no ='"+OrderNo+"'  and supplier ilike '"+supplier+"' and item ilike '"+item+"' and order_no IS NOT NULL   ");

                        while(rsetbal.next()){
                              qty=rsetbal.getDouble(1);
