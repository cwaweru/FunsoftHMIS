...
public class SSOQuotationProcess extends javax.swing.JPanel {
 ...
 org.netbeans.lib.sql.pool.PooledConnectionSource pConnDB = null;
    ...
    public SSOQuotationProcess(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    */
    ...
    jLabel6.setText("Qoutation Opening Date");
    gridBagConstraints = new java.awt.GridBagConstraints();
    gridBagConstraints.gridx = 2;
    ...
    jLabel8.setText("Qoutation Closing Date");
    ...
    */
    ...
    jTabbedPane2.addTab("Preliminary Evaluation", jPanel36);
    ...
    jLabel32.setText("Select Creteria");
    gridBagConstraints = new java.awt.GridBagConstraints();
    gridBagConstraints.gridx = 0;
    gridBagConstraints.gridy = 1;
    gridBagConstraints.insets = new java.awt.Insets(0, 50, 0, 30);
    ...
    */
    ...
    private void postbtn1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_postbtn1ActionPerformed
                ...
                try {
                        ...
                        java.sql.Statement stmtf = connectDB.createStatement();
                        java.sql.ResultSet rsetf = stmtf.executeQuery("SELECT 'QNo' || NEXTVAL('quotation_no_seq')");
                        while (rsetf.next()) {
                        ...
                        for (int i = 0; i < jTable1.getRowCount(); i++) {
                                if (jTable1.getModel().getValueAt(i, 0) != null) {
                                        ...
                                        pstmt.setObject(22, jTextField36.getText());
            ...
            java.sql.PreparedStatement settingpr_status= connectDB.prepareStatement("UPDATE st_assign_buyers SET pr_status=true where  requisition_no='" + jTextField36.getText()+"' ");
        ...
        try {
            ...
            for (int i = 0; i < jTable11.getRowCount(); i++) {
                if (jTable11.getModel().getValueAt(i, 0) != null) {
                    ...
                    pstmt.setObject(9, jTextField37.getText());
            ...
            policy.QuotationsSentMtrhPdf(connectDB, jTextField37.getText(), jTextField91.getText());
//jTextField91.setText(null);
    ...
    private void jTextField1111CaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextField1111CaretUpdate
        jSearchTable1.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB, "SELECT DISTINCT(tender_no) AS quotation_no, quotation_date FROM st_item_to_quote WHERE tender_no ILIKE 'QNo%' AND tender_no ILIKE '" + jTextField1111.getText().toString() + "%'  ORDER BY 1"));
    ...
    private void jSearchTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jSearchTable1MouseClicked
      ...
      //  jTextField1.setText(jSearchTable1.getValueAt(jSearchTable1.getSelectedRow(), 1).toString());
        ...
        try {
            ...
            java.sql.ResultSet rsetTable11 = stmtTable11.executeQuery("SELECT count(tender_no)  FROM st_item_to_quote WHERE tender_no ILIKE '" + this.jTextField37.getText() + "'");
            ...
            java.sql.ResultSet rsetTable11X = stmtTable11X.executeQuery("SELECT buyer_details,quotation_date, openning_date"
                + " FROM st_item_to_quote WHERE tender_no ILIKE '" + this.jTextField37.getText() + "%'");
    ...
    private void jSearchTable4MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jSearchTable4MouseClicked
               // jTextField1113.setText(jSearchTable4.getValueAt(jSearchTable4.getSelectedRow(), 0).toString());
               // jTextField1113.setText(jSearchTable4.getValueAt(jSearchTable4.getSelectedRow(), 1).toString());
               // jTextField1113.setText(jSearchTable4.getValueAt(jSearchTable4.getSelectedRow(), 2).toString());
...
//                        java.sql.Statement stmtTable11X = connectDB.createStatement();
//            
//                        java.sql.ResultSet rsetTable11X = stmtTable11X.executeQuery("SELECT buyer_details, openning_date,quotation_date"
//                                + " FROM st_floated_quotations WHERE quotation_no ILIKE '" + this.jTextField38.getText() + "'");
//            
//                        while (rsetTable11X.next()) {
//                                jTextPane4.setText(rsetTable11X.getString(1));
//                                jTextField8.setText(rsetTable11X.getString(2));
//                                 jTextField5.setText(rsetTable11X.getString(3));
//                                //jTextField4.setText(rsetTable11X.getString(2));
//                            }
//            
//                        //connectDB.rollback(registerSavePoint);
...
//                this.postbtn3.setEnabled(true);
    ...
    private void jTextField111111CaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextField111111CaretUpdate
        if (this.jTextField111111.getCaretPosition() < 2) {
            ...
            jSearchTable111.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB, "SELECT requisition_no, agenda_no, date_buyer_assigned  FROM st_assign_buyers where pr_status= false order by date_buyer_assigned asc "));
...
//                                                       * 4); jTable1.setValueAt(depBal, j, 5); } } 
//     } 
//    } catch(java.sql.SQLException sqlExec) {
//               
//                javax.swing.JOptionPane.showMessageDialog(this, sqlExec.getMessage());
//}
        ...
        try {
            ...
            java.sql.ResultSet rsetTable111 = stmtTable111.executeQuery("SELECT item_code, item_description, units, quantity  FROM st_receive_requisation  where  requisition_no = '" + jTextField36.getText() + "'  ");
    ...
    private void postbtn3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_postbtn3ActionPerformed
       if(jTextField38.getText().equalsIgnoreCase("") || jTextField92.getText().equalsIgnoreCase("") )
           ...
           else
       {
        try {
            ...
            policy.QuotationsReceivedMtrhPdf(connectDB, jTextField38.getText(), jTextField92.getText());
...
if (jTextField115.getCaretPosition() < 1) {
            System.out.println("Nothing");
        } else {
            jSearchTable6.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB, "SELECT supplier_name, code as account_no FROM st_suppliers where supplier_name ILIKE '%" + jTextField113.getText() + "%' order by supplier_name"));
