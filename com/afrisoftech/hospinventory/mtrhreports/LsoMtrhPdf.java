...
public class LsoMtrhPdf implements java.lang.Runnable {
    ...
    public void LsoMtrhPdf(java.sql.Connection connDb, java.lang.String combox, java.lang.String order) {
            ...
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        int headerwidths[] = {5, 12, 30, 7, 10, 13, 10, 15};
...
java.sql.ResultSet rset4 = st4.executeQuery("select DISTINCT order_no,date,date_due,ordering_store FROM st_orders where order_no = '" + OrderNo + "'"); 
                            //where supplier_name = 'Uchumi'member_no = '"+memNo+"'  AND date BETWEEN '"+beginDate+"' AND '"+endDate+"'");
                            ...
                            while (rset4.next()) {
                                ...
                                java.sql.ResultSet rset32 = st32.executeQuery("SELECT DISTINCT vote_class, vote, head, subhead, sub_item, sub_item_desc, donor_code,"
                                        + "donor_item FROM st_item_to_quote WHERE tender_no = '" + rset4.getString(3) + "' LIMIT 1 ");
                                ...
                                while (rset2.next()) {
                                    ...
                                    while (rset32.next()) {
                                        ...
                                        table1.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_CENTER);
                                        phrase = new Phrase("LOCAL SERVICE ORDER", pFontHeader4);
                                        table1.addCell(phrase);
                                        table1.getDefaultCell().setBorderColor(java.awt.Color.white);
                                        ...
                                        table1.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                                        phrase = new Phrase("Suppliers are warned that this Order is INVALID unless availability of funds is confirmed here below by the Finance Officer.", pFontHeader);
                                        table1.addCell(phrase);
                                        ...
                                        table1.getDefaultCell().setColspan(3);
                                        phrase = new Phrase("Tender/Quotation Ref.No. : " + rset4.getObject(3).toString() + "", pFontHeader);
                                        table1.addCell(phrase);

                                        phrase = new Phrase("Contract Ref.No. : ", pFontHeader);
                                        table1.addCell(phrase);

                                        phrase = new Phrase("Date : ", pFontHeader);
                                        table1.addCell(phrase);

                                        phrase = new Phrase("Requisition No.: ", pFontHeader);
                                        table1.addCell(phrase);
                                        ...
                                        table1.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                                        phrase = new Phrase("Please carry out the srvices listed here below on terms and conditions stated on the back of this order, on or ", pFontHeader);
                                        table1.addCell(phrase);

                                        /*
                                         * table1.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                                         * phrase = new
                                         * Phrase(rset4.getObject(5).toString(),
                                         * pFontHeader31);
                                         * table1.addCell(phrase);
                                         */

                                        table1.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                                        phrase = new Phrase("before: " + rset4.getObject(4).toString() + " and send the invoices immediately to " + depart, pFontHeader);
                                        table1.addCell(phrase);
                                        ...
                                        // table1.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                                        phrase = new Phrase("Description of Services", pFontHeader);
                                        table.addCell(phrase);
                                        ...
                                        /*
                                         * table.getDefaultCell().setColspan(1);
                                         * phrase = new Phrase("Serial No ",
                                         * pFontHeader); table.addCell(phrase);
                                         * phrase = new Phrase("Code ",
                                         * pFontHeader); table.addCell(phrase);
                                         *
                                         * table.getDefaultCell().setColspan(1);
                                         * phrase = new Phrase("Item ",
                                         * pFontHeader); table.addCell(phrase);
                                         *
                                         * phrase = new Phrase("Qty. ",
                                         * pFontHeader); table.addCell(phrase);
                                         *
                                         * //
                                         * table.getDefaultCell().setColspan(2);
                                         ...
                                         * pFontHeader); table.addCell(phrase);
                                         *
                                         * phrase = new Phrase("No Of Units ",
                                         * pFontHeader); //
                                         * table.addCell(phrase);
                                         *
                                         * table.getDefaultCell().setColspan(1);
                                         *
                                         * phrase = new Phrase("Gross ",
                                         * pFontHeader); table.addCell(phrase);
                                         * table.getDefaultCell().setColspan(1);
                                         *
                                         * phrase = new Phrase("% ",
                                         ...
                                         * pFontHeader); table.addCell(phrase);
                                         *
                                         * phrase = new Phrase("Net Value ",
                                         * pFontHeader); table.addCell(phrase);
                                         *
                                         * System.out.println("First ");
                                         * System.out.println("First Bottom " +
                                         * docPdf.bottom());
                                         */
                                        ...
                                        while (rset11.next()) {
                                             ...
                                             * com.afrisoftech.sys.Format2Currency().Format2Currency(rset11.getString(4)),
                                             * pFontHeader2);
                                             *
                                             * table.addCell(phrase);
                                             *
                                             ...
                                             *
                                             * phrase = new Phrase(new
                                             * com.afrisoftech.sys.Format2Currency().Format2Currency(rset11.getString(5)),
                                             * pFontHeader2);
                                             *
                                             * table.addCell(phrase);
                                             *
                                             ...
                                             *
                                             * phrase = new Phrase(new
                                             * com.afrisoftech.sys.Format2Currency().Format2Currency(rset11.getString(6)),
                                             * pFontHeader2);
                                             *
                                             * table.addCell(phrase);
                                             *
                                             ...
                                             *
                                             * phrase = new Phrase(new
                                             * com.afrisoftech.sys.Format2Currency().Format2Currency(rset11.getString(7)),
                                             * pFontHeader2);
                                             *
                                             * table.addCell(phrase);
                                             */
                                         ...
                                         * pFontHeader);
                                         *
                                         * table.addCell(phrase); phrase = new
                                         * Phrase(new
                                         * com.afrisoftech.sys.Format2Currency().Format2Currency(java.lang.String.valueOf(vat)),
                                         * pFontHeader);
                                         *
                                         * //table.addCell(phrase);
                                         *
                                         *
                                         * phrase = new Phrase(new
                                         * com.afrisoftech.sys.Format2Currency().Format2Currency(java.lang.String.valueOf(discount)),
                                         * pFontHeader);
                                         *
                                         * //table.addCell(phrase);
                                         *
                                         * phrase = new Phrase(new
                                         * com.afrisoftech.sys.Format2Currency().Format2Currency(java.lang.String.valueOf(Total)),
                                         * pFontHeader);
                                         *
                                         * table.addCell(phrase);
                                         *
                                        ...
                                        table1.getDefaultCell().setBorder(Rectangle.BOTTOM | Rectangle.LEFT | Rectangle.RIGHT | Rectangle.TOP);
                                        ...
                                        table1.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                                        phrase = new Phrase("I confirm that funds are available and that commitment has been noted in the Vote Book " + sub_head + "-" + itemDet, pFontHeader);
                                        table1.addCell(phrase);
                                        /*
                                         * table1.getDefaultCell().setColspan(5);
                                         *
                                         * table1.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                                         * phrase = new Phrase("Vote : " +
                                         * vote_class + "-" + vote,
                            ...
                            java.sql.ResultSet rset1S = st3S.executeQuery("SELECT lso FROM pb_doc_conditions");// where supplier_name = 'Uchumi'member_no = '"+memNo+"'  AND date BETWEEN '"+beginDate+"' AND '"+endDate+"'");
                            while (rset1S.next()) {
