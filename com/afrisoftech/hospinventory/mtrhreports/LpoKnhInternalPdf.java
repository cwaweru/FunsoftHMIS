...
public class LpoKnhInternalPdf implements java.lang.Runnable {
    ...
    public void LpoKnhInternalPdf(java.sql.Connection connDb, java.lang.String combox, java.lang.String order,java.lang.String contract_no) {
            ...
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        int headerwidths[] = {15, 20, 35, 15, 20, 20, 20, 25};
                            ...
                            while (rset4.next()) {
                                ...
                                while (rset2.next()) {
                                    ...
                                    while (rset32.next()) {
                                        ...
                                        table1.getDefaultCell().setColspan(9);
                                        table1.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                                        phrase = new Phrase("............................................................................................................................................................................................................................", pFontHeader56);
                                        table1.addCell(phrase);
                                        
                                        table1.getDefaultCell().setColspan(3);

                                        table1.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                                        phrase = new Phrase("Prepared By.................................. : ", pFontHeader56);
                                        table1.addCell(phrase);

                                        table1.getDefaultCell().setColspan(3);

                                        phrase = new Phrase("Checked By................................... : ", pFontHeader56);
                                        table1.addCell(phrase);
                                        
                                         table1.getDefaultCell().setColspan(3);

                                        phrase = new Phrase("Signed....................................... : ", pFontHeader56);
                                        table1.addCell(phrase);
                                        ...
                                        table1.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                                        phrase = new Phrase("Designation...................................: ", pFontHeader56);
                                        table1.addCell(phrase);
                                        ...
                                        phrase = new Phrase("Date...................................: ", pFontHeader56);
                                        table1.addCell(phrase);
                                        ...
                                        phrase = new Phrase("Authorised By...................................: ", pFontHeader56);
                                        table1.addCell(phrase);
                                        
                                         table1.getDefaultCell().setColspan(3);

                                        phrase = new Phrase("Inspected By...................................: ", pFontHeader56);
                                        table1.addCell(phrase);
