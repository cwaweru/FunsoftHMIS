...
import com.afrisoftech.lib.MailingClass;
import com.afrisoftech.lib.MailingDetailsLib;
import com.lowagie.text.*;
import com.lowagie.text.pdf.*;
//import //java.awt.Desktop;

public class QuotationsSentMtrhPdf implements java.lang.Runnable {
    ...
    com.lowagie.text.Font pFontHeader11 = FontFactory.getFont(FontFactory.HELVETICA, 14, Font.BOLD);
    ...
    public void QuotationsSentMtrhPdf(java.sql.Connection connDb, java.lang.String order, java.lang.String vendor) {
    ...
    public void generatePdf(java.lang.String memNo) {
        ...
        try {
            ...
            java.io.File tempFile = java.io.File.createTempFile("RFQ" + selectSupp + "-" + OrderNo, ".pdf");
            ...
            try {
                ...
                try {
                     ...
                     *
                     * //com.lowagie.text.HeaderFooter footer = new
                     * com.lowagie.text.HeaderFooter(new Phrase("Internal
                     * Requisition - Page:", pFontHeader), true);//
                     * FontFactory.getFont(com.lowagie.text.FontFactory.HELVETICA,
                     * 12, Font.BOLDITALIC,java.awt.Color.blue));
                     *
                     * // docPdf.setFooter(footer); } catch
                    ...
                    try {
                        ...
                        com.lowagie.text.pdf.PdfPTable table3 = new com.lowagie.text.pdf.PdfPTable(13);

                        int headerwidths3[] = {5, 7, 35, 7, 8, 10, 8, 9, 10, 13, 10, 8, 9};
                        ...
                        try {
                            ...
                            java.sql.ResultSet rset31 = st31.executeQuery("SELECT DISTINCT sub_item_desc FROM st_item_to_quote WHERE tender_no = '" + OrderNo + "' LIMIT 1 ");
                            ...
                            while (rset3.next()) {
                                ...
                                table1.getDefaultCell().setColspan(10);
                                table1.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_CENTER);
                                phrase = new Phrase("REQUEST FOR QUOTATION", pFontHeader11);
                                table1.addCell(phrase);
...
//                              
                                ...
                                table1.getDefaultCell().setColspan(10);
                                table1.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                                phrase = new Phrase("(a) THIS IS NOT AN ORDER. Read the conditions and instructions on the back page.", pFontHeader5);
                                table1.addCell(phrase);
                                phrase = new Phrase("(b) This quotation should be submitted marked " + "Quotation No." + quoteNo + " for supply and delivery of", pFontHeader5);
                                table1.addCell(phrase);
                                // table1.getDefaultCell().setColspan(5);
                                table1.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                            ...
                            java.sql.ResultSet rset4 = st4.executeQuery("SELECT distinct item_number, item_code, item_description,units,quantity FROM st_floated_quotations WHERE quotation_no = '" + OrderNo + "' AND supplier = '" + selectSupp + "' ");// where supplier_name = 'Uchumi'member_no = '"+memNo+"'  AND date BETWEEN '"+beginDate+"' AND '"+endDate+"'");
                            cnt = 1;
                            while (rset4.next()) {

                                table3.getDefaultCell().setColspan(1);
                                table3.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_CENTER);
                                phrase = new Phrase(String.valueOf(cnt), pFontHeader5);
                                table3.addCell(phrase);
                                ...
                                phrase = new Phrase(CurrencyFormatter.getFormattedDouble(Double.valueOf(rset4.getObject(5).hashCode())), pFontHeader5);
                                table3.addCell(phrase);
                            ...
                            table3.getDefaultCell().setColspan(13);
                            table3.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                            phrase = new Phrase("", pFontHeader);
                            table3.addCell(phrase);
                            docPdf.add(table3);
...
//            System.out.println("Current Doc size "+ pdfWriter.getCurrentDocumentSize());
            ...
            try {
                ...
                mail.MailingClass(connectDB, tempFile, MailingDetailsLib.getTheToAddress(connectDB, selectSupp), MailingDetailsLib.getSenderFromAddress(connectDB, "Dispatch Quotations"), MailingDetailsLib.getSenderPassword(connectDB, "Dispatch Quotations"), "Dispatch Quotations");
            } catch (Exception edf) {
                edf.printStackTrace();
                edf.getMessage();
                if (edf.getMessage() != null) {

                    //javax.swing.JOptionPane.showMessageDialog(null, "Dispatch Done Successfully Successfully", "Confirmation Message!", javax.swing.JOptionPane.INFORMATION_MESSAGE);
                }
...
//    String pass=null;
//        try{
//    java.sql.Statement stsmt=connectDB.createStatement();
//    java.sql.ResultSet res=stsmt.executeQuery("SELECT   sender_password  FROM mailers_group_setup where mailer_category='Dispatch Quotations' ");
//    
//    while(res.next()){
...
//     private String getSenderFromAddress(){
//    String from_Address=null;
//        try{
//    java.sql.Statement stsmt=connectDB.createStatement();
//    java.sql.ResultSet res=stsmt.executeQuery("SELECT  sender_email, mailer_category, sender_password  FROM mailers_group_setup where mailer_category='Dispatch Quotations' ");
//    
//    while(res.next()){
...
//    private String getTheToAddress(){
//    String to_Address=null;
//        try{
//    java.sql.Statement stsmt=connectDB.createStatement();
//    java.sql.ResultSet res=stsmt.executeQuery("SELECT distinct email_address from st_suppliers where supplier_name='"+selectSupp+"' group by code,supplier_name");
//    
//    while(res.next()){
