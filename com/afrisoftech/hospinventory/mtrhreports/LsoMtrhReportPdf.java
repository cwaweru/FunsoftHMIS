...
public class LsoMtrhReportPdf implements java.lang.Runnable {
    ...
    public void LsoMtrhReportPdf(java.sql.Connection connDb, java.lang.String combox, java.lang.String order) {
                ...
                try {
                    ...
                    try {
                        ...
                        try {
                            ...
                            while (rset4.next()) {
                                ...
                                while (rset2.next()) {
                                    ...
                                    while (rset32.next()) {
                                        ...
                                        table1.getDefaultCell().setColspan(3);
                                        phrase = new Phrase("Requisition No. : "+rset32.getString(9), pFontHeader);
                                        table1.addCell(phrase);
                                        ...
                                        /*
                                         * .getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                                         * phrase = new
                                         ...
                                         *
                                         * table1.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                                         * phrase = new Phrase("on terms and
                                         * conditions stated on the back of this
                                         * Order, on or before : " +
                                         * rset4.getObject(4).toString(),
                                         * pFontHeader); table1.addCell(phrase);
                                         *
                                         * table1.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                                         * phrase = new Phrase("and send the
                                         * invoices immediately to
                                         * Department/Ministry : " + depart,
                                         * pFontHeader); table1.addCell(phrase);
                                         *
                                        ...
                                        table1.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                                        phrase = new Phrase("I confirm that funds are available and that commitment has been noted in the Vote Book " + head + "-" + sub_head, pFontHeader);
                                        table1.addCell(phrase);
                                        /*
                                         * table1.getDefaultCell().setColspan(5);
                                         *
                             ...
                             * rset4.getObject(2).toString(), pFontHeader);
                             * table1.addCell(phrase);
                             * table1.getDefaultCell().setColspan(9);
                             * table1.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                             * phrase = new Phrase("Tel : " +
                             * rset2.getString(4), pFontHeader);
                             *
                             * table1.addCell(phrase);
                             *
                             * table1.getDefaultCell().setColspan(9);
                             ...
                             *
                             * table1.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                             * phrase = new Phrase("Fax : " +
                             * rset2.getString(7), pFontHeader);
                             *
                             * table1.addCell(phrase);
                             *
                             * }
                             * }
                             * while (rset5.next()) {
                             * table1.getDefaultCell().setColspan(9); phrase =
                             * new Phrase("Please Supply the goods / services /
                             * works described below", pFontHeader);
                             * table1.addCell(phrase);
                             *
                             * table1.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                             * table1.getDefaultCell().setColspan(3); phrase =
                             * new Phrase("On/Before: " +
                             * rset5.getObject(1).toString(), pFontHeader);
                             * ddate = rset5.getObject(1).toString();
                             * //table1.addCell(phrase);
                             *
                             * table1.getDefaultCell().setBackgroundColor(java.awt.Color.WHITE);
                             * table1.getDefaultCell().setColspan(1); phrase =
