...
public class TendersSentMtrhPdf implements java.lang.Runnable {
    ...
    public void TendersSentMtrhPdf(java.sql.Connection connDb, java.lang.String order, java.lang.String vendor) {
    ...
    public void generatePdf(java.lang.String memNo) {
        ...
        try {
            ...
            java.io.File tempFile = java.io.File.createTempFile("PRICE SCHEDULE"+"-" +selectSupp+ "-"+OrderNo , ".pdf");
            ...
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        int headerwidths3[] = {5, 7, 35, 7, 8, 10, 8, 9, 10, 13,10,12,8};
                        ...
                        try {
                            ...
                            while (rset3.next()) {
                                ...
                                table1.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_CENTER);
                                phrase = new Phrase("TENDER DOCUMENT", pFontHeader1);
                                table1.addCell(phrase);
                                
                                table1.getDefaultCell().setColspan(10);
                                table1.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_CENTER);
                                phrase = new Phrase("SCHEDULE OF REQUIREMENTS", pFontHeader1);
                                table1.addCell(phrase);
...
//                                table1.addCell(phrase);
                                ...
                                table1.addCell(phrase);
                                phrase = new Phrase("(b) This tender should be submitted marked " + "TENDER NUMBER" + quoteNo + " for "+com.afrisoftech.lib.GetItemInfo.getITenderDesc(quoteNo, connectDB), pFontHeader5);
                                table1.addCell(phrase);
                               // table1.getDefaultCell().setColspan(5);
                                table1.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                            ...
                            table3.addCell(phrase);
                            /////added fields
                            phrase = new Phrase("DICOUNT", pFontHeader);
                            table3.addCell(phrase);
                            ...
                            java.sql.ResultSet rset4 = st4.executeQuery("SELECT item_number, item_code, item_description,units,quantity FROM st_floated_quotations WHERE quotation_no = '" + OrderNo + "' AND supplier = '" + selectSupp + "' ");// where supplier_name = 'Uchumi'member_no = '"+memNo+"'  AND date BETWEEN '"+beginDate+"' AND '"+endDate+"'");
...
MailingClass mail=new MailingClass();
            mail.MailingClass(connectDB, tempFile, MailingDetailsLib.getTheToAddress(connectDB,selectSupp),MailingDetailsLib.getSenderFromAddress(connectDB,"Dispatch Tendered Docs"), MailingDetailsLib.getSenderPassword(connectDB,"Dispatch Tendered Docs"),"Dispatch Tendered Docs");
