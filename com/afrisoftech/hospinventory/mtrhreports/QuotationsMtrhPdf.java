...
public class QuotationsMtrhPdf implements java.lang.Runnable {
                    ...
                    try {
                        ...
                        try {
                          ...
                          /*
                             ...
                             * st5.executeQuery("select DISTINCT date_due from
                             * st_receive_requisation where REQUISITION_no = '"
                             * + OrderNo + "'");// where supplier_name =
                             * 'Uchumi'member_no = '"+memNo+"' AND date BETWEEN
                             * '"+beginDate+"' AND '"+endDate+"'");
                             * java.sql.ResultSet rset11 =
                             * st11.executeQuery("select initcap(user_name) from
                             * st_receive_requisation where REQUISITION_no = '"
                             * + OrderNo + "'");// where supplier_name =
                             * 'Uchumi'member_no = '"+memNo+"' AND date BETWEEN
                             * '"+beginDate+"' AND '"+endDate+"'"); while
                             * (rset11.next()) { Username =
                             * rset11.getObject(1).toString(); }
                             * table1.getDefaultCell().setBorderColor(java.awt.Color.white);
                             */
                            while (rset4.next()) {
