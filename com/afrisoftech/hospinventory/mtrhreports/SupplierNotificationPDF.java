...
public class SupplierNotificationPDF implements java.lang.Runnable {
    ...
    public void SupplierNotificationPDF(java.sql.Connection connDb, java.lang.String tenderNo , java.lang.String vendor) {
            ...
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        int headerwidths3[] = {5, 15, 35, 7, 8, 10, 8, 9, 10, 13,13,8,10};
...
com.lowagie.text.pdf.PdfPTable table11 = new com.lowagie.text.pdf.PdfPTable(6);
                        ...
                        try {
                            ...
                            java.sql.Statement st3 = connectDB.createStatement();
                       java.sql.ResultSet rset3 = st3.executeQuery("SELECT quotation_no,quotation_date,openning_date,buyer_details,supplier FROM st_floated_quotations WHERE quotation_no = '" + OrderNo + "' AND supplier ilike '" + selectSupp + "' LIMIT 1 ");
                            ...
                            while (rset3.next()) {
                                ...
                                table1.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_CENTER);
                                phrase = new Phrase("NOTIFICATION OF AWARD", pFontHeader1);
                                table1.addCell(phrase);
                                ...
                                table1.getDefaultCell().setColspan(3);
                                table1.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                                phrase = new Phrase("Tender No: " + quoteNo + "\n Date " + quotDate, pFontHeader5);
                                table1.addCell(phrase);
                                ...
                                table1.getDefaultCell().setColspan(10);
                                table1.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                                phrase = new Phrase("You have been  Awarded the Listed Tender Items ", pFontHeader5);
                                table1.addCell(phrase);
                                ...
                                table1.addCell(phrase);
                                phrase = new Phrase("(b) You MUST sign CONTRACT before any order is generated", pFontHeader5);
                                table1.addCell(phrase);
                               // table1.getDefaultCell().setColspan(5);
                                table1.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                                phrase = new Phrase("(c) The Contract MUST be signed within 14 days of dispatch of this notification AFTER  WHICH you shall be ordered to supply the goods/services awarded." , pFontHeader5);
                                table1.addCell(phrase);
...
//                          
                            ...
                            java.sql.ResultSet rset4 = st4.executeQuery("SELECT  distinct code, item,units,quantity,unit_price,quantity*unit_price FROM st_orders where quotation_no = '" + OrderNo + "' AND supplier = '" + selectSupp + "' and quantity>0 and order_no IS NULL OR order_no =''");// where supplier_name = 'Uchumi'member_no = '"+memNo+"'  AND date BETWEEN '"+beginDate+"' AND '"+endDate+"'");
                            ...
                            while (rset4.next()) {
                              cnt1+=1;
                                table3.getDefaultCell().setColspan(1);
                                table3.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_CENTER);
                                phrase = new Phrase(String.valueOf(cnt1), pFontHeader5);
                                table3.addCell(phrase);
                                ...
                                phrase = new Phrase(rset4.getObject(3).toString(), pFontHeader5);
                                table3.addCell(phrase);

                                 table3.getDefaultCell().setColspan(2);
                                phrase = new Phrase(com.afrisoftech.lib.CurrencyFormatter.getFormattedDouble(Double.parseDouble(rset4.getObject(4).toString())), pFontHeader5);
                                table3.addCell(phrase);


                                table3.getDefaultCell().setColspan(1);
                                table3.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                                phrase = new Phrase(com.afrisoftech.lib.CurrencyFormatter.getFormattedDouble(Double.parseDouble(rset4.getObject(5).toString())), pFontHeader5);
                                table3.addCell(phrase);
                                
                                table3.getDefaultCell().setColspan(3);
                                phrase = new Phrase(com.afrisoftech.lib.CurrencyFormatter.getFormattedDouble(Double.parseDouble(rset4.getObject(6).toString())), pFontHeader5);
                                table3.addCell(phrase);
//                                
//                                ////start here 
//                                phrase = new Phrase(rset4.getObject("discount").toString(), pFontHeader5);
//                                table3.addCell(phrase);
//                                
//                                phrase = new Phrase(rset4.getObject("vat").toString(), pFontHeader5);
//                                table3.addCell(phrase);
//                                
//                                ///////generating the net value
//                                
//                                phrase = new Phrase(rset4.getObject("netvalue").toString(), pFontHeader5);
//                                table3.addCell(phrase);
//
...
//                                table3.addCell(phrase);
                            ...
                            phrase = new Phrase("", pFontHeader);
                            //table2.addCell(phrase);
                            phrase = new Phrase("Printed By:(1) "+com.afrisoftech.lib.UserName.getLoginName(connectDB).toLowerCase(), pFontHeader);
                            table2.addCell(phrase);
