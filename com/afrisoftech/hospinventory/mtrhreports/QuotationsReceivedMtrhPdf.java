...
public class QuotationsReceivedMtrhPdf implements java.lang.Runnable {
    ...
    public void QuotationsReceivedMtrhPdf(java.sql.Connection connDb, java.lang.String order, java.lang.String vendor) {
            ...
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        int headerwidths3[] = {5, 7, 35, 7, 8, 10, 8, 9, 10, 13, 13, 8, 10};
                        ...
                        try {
                            ...
                            table3.addCell(phrase);
                            phrase = new Phrase("Day's To Deliver ", pFontHeader);
                            table3.addCell(phrase);

                            //phrase = new Phrase("COUNTRY OF ORIGIN ", pFontHeader);
                            //table3.addCell(phrase);
                            table3.getDefaultCell().setColspan(2);
                            phrase = new Phrase("REMARKSS", pFontHeader);
                            table3.addCell(phrase);
                          ...
                          /* java.sql.ResultSet rset5 = st5.executeQuery("select DISTINCT date_due from st_receive_requisation where REQUISITION_no = '" + OrderNo + "'");// where supplier_name = 'Uchumi'member_no = '"+memNo+"'  AND date BETWEEN '"+beginDate+"' AND '"+endDate+"'");
                            ...
                            while (rset4.next()) {
                                ...
                                phrase = new Phrase(CurrencyFormatter.getFormattedDouble(Double.valueOf(rset4.getObject(5).toString())), pFontHeader5);
                                table3.addCell(phrase);

                                // table1.getDefaultCell().setColspan(3);
                                table3.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                                phrase = new Phrase(CurrencyFormatter.getFormattedDouble(Double.valueOf(rset4.getObject(6).toString())), pFontHeader5);
                                table3.addCell(phrase);

                                phrase = new Phrase(CurrencyFormatter.getFormattedDouble(Double.valueOf( rset4.getObject(7).toString())), pFontHeader5);
                                table3.addCell(phrase);

                                ////start here 
                                phrase = new Phrase(CurrencyFormatter.getFormattedDouble(Double.valueOf( rset4.getObject("discount").toString())), pFontHeader5);
                                table3.addCell(phrase);

                                phrase = new Phrase(CurrencyFormatter.getFormattedDouble(Double.valueOf(rset4.getObject("vat").toString())), pFontHeader5);
                                table3.addCell(phrase);

                                ///////generating the net value
                                phrase = new Phrase(CurrencyFormatter.getFormattedDouble(Double.valueOf( rset4.getObject("netvalue").toString())), pFontHeader5);
                                table3.addCell(phrase);
