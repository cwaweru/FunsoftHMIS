...
public class AmmendMainStockpricesintfr extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        */
        ...
        jComboBox2.setModel(com.afrisoftech.lib.ComboBoxModel.ComboBoxModel(connectDB, "select  store_name as name from st_main_stores order by name"));
    ...
    private void jComboBox2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBox2ActionPerformed
        if (jCheckBox2.isSelected()){
            ...
            jTable1.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"select description,item_code,units,reorder_level,buying_price,packaging from st_stock_item WHERE department ilike '"+jComboBox2.getSelectedItem().toString()+"%' order by description"));
