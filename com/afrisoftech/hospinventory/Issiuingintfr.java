...
public class Issiuingintfr extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        issuingItemsPdf1 = new com.afrisoftech.hospinventory.IssuingItemsPdf();
        ...
        transactionTimepicker = new com.afrisoftech.lib.DatePicker();
        ...
        rectifyTransferChkbx.setEnabled(false);
        rectifyTransferChkbx.setMargin(new java.awt.Insets(0, 0, 0, 0));
        ...
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
        itemSearchDialog.getContentPane().add(jSearchPanel, gridBagConstraints);
        ...
        */
        ...
        jSearchScrollPane2.setViewportView(searchTransferTable);
        ...
        */
        ...
        reprintS11dialog.getContentPane().setLayout(new java.awt.GridBagLayout());
        ...
        jSearchScrollPane3.setViewportView(jSearchTable2);
        ...
        jSearchPanel3.add(jDateChooser1, gridBagConstraints);
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
        gridBagConstraints.weightx = 0.5;
        jSearchPanel3.add(jDateChooser2, gridBagConstraints);

        jLabel8.setText("Period");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 0;
        jSearchPanel3.add(jLabel8, gridBagConstraints);
        ...
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
        reprintS11dialog.getContentPane().add(jSearchPanel3, gridBagConstraints);
        ...
        setMaximizable(true);
        setResizable(true);
        setTitle("Inventory Management - Stock Distribution - Issuing Stockable/Saleable Items");
        setToolTipText("");
        setVisible(true);
        ...
        recepientStoreCmbx.addItemListener(new java.awt.event.ItemListener() {
            public void itemStateChanged(java.awt.event.ItemEvent evt) {
                recepientStoreCmbxItemStateChanged(evt);
            }
        });
        ...
        issuingStoreCmbx.setModel(com.afrisoftech.lib.ComboBoxModel.ComboBoxModel(connectDB, "select distinct stores from store_allocation where user_name = current_user  limit 1"));
        ...
        newTransferChkbx.setSelected(true);
        ...
        newTransferChkbx.setMargin(new java.awt.Insets(0, 0, 0, 0));
        ...
        useCostPriceRdbtn.setMargin(new java.awt.Insets(0, 0, 0, 0));
        ...
        ManualS11CMBX.setText("Manual S11");
        ManualS11CMBX.addItemListener(new java.awt.event.ItemListener() {
            public void itemStateChanged(java.awt.event.ItemEvent evt) {
                ManualS11CMBXItemStateChanged(evt);
            }
        });
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 3;
        ...
        issuingItemsTable.setGridColor(new java.awt.Color(204, 204, 255));
        issuingItemsTable.setSelectionBackground(javax.swing.UIManager.getDefaults().getColor("Table.background"));
        issuingItemsTable.setSelectionForeground(java.awt.Color.red);
        ...
        totalValueTxt.setFont(new java.awt.Font("Dialog", 1, 12)); // NOI18N
        totalValueTxt.setForeground(new java.awt.Color(102, 102, 102));
        ...
        try {
            for (int j = 0; j < issuingItemsTable.getRowCount(); j++) {
                ...
                if (issuingItemsTable.getModel().getValueAt(j, 0) != null) {
                    //stock balances:receipient and issiuing

                    double storeBal = 0;
                    double depBal = 0;
                    java.sql.Statement stmtTable11 = connectDB.createStatement();
                    java.sql.ResultSet rsetTable11 = stmtTable11.executeQuery("SELECT sum(qty),1 FROM stock_balance_qty WHERE item_code ILIKE '%" + issuingItemsTable.getValueAt(j, 0).toString() + "%' AND department ILIKE '" + issuingStoreCmbx.getSelectedItem() + "%' AND dates::date <= '" + SQLDateFormat.getSQLDate(transactionTimepicker.getDate()) + "'");
                    //("select sum(qty),1 from stock_balance_qty where item_code ilike '" + issuingItemsTable.getValueAt(issuingItemsTable.getSelectedRow(), 0) + "%' and department = '" + issuingStoreCmbx.getSelectedItem().toString() + "' AND dates::date <= '" + SQLDateFormat.getSQLDate(transactionTimepicker.getDate()) + "'");
                    ...
                    java.sql.ResultSet rsetTable11x = stmtTable11x.executeQuery("SELECT sum(qty),1 FROM stock_balance_qty WHERE item_code ilike '" + issuingItemsTable.getValueAt(j, 0).toString() + "%' AND department ILIKE '" + recepientStoreCmbx.getSelectedItem() + "%' AND dates::date <= '" + SQLDateFormat.getSQLDate(transactionTimepicker.getDate()) + "'");
    ...
    private void populateTable22(java.lang.String processNumber) {
        ...
        if (this.newTransferChkbx.isSelected()) {
            ...
            if (count == 0) {
                JOptionPane.showMessageDialog(this, "IRQ Not approved!");
            }

            for (int t = 0; t < issuingItemsTable.getRowCount(); t++) {
                qtyVector.addElement(issuingItemsTable.getModel().getValueAt(t, 7));
    ...
    private void requisitionNumberSearchTxtCaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_requisitionNumberSearchTxtCaretUpdate
        if (this.requisitionNumberSearchTxt.getCaretPosition() < 7) {
            System.out.print("Nothing");
        } else {
            setFixedColumns.DisallowReordering(requisitionNumberSearchTable);
            requisitionNumberSearchTable.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB, ""
                    + "SELECT DISTINCT requisition_no as rq_number,(date) as date, store_name, cost_center \n"
                    + "FROM st_receive_requisation WHERE requisition_no ILIKE '%" + requisitionNumberSearchTxt.getText() + "%'  and store_name ILIKE '%" + issuingStoreCmbx.getSelectedItem() + "%' \n"
    ...
    private void issuingStoreCmbxActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_issuingStoreCmbxActionPerformed
        ...
        requisitionNumberSearchTable.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB, "SELECT DISTINCT requisition_no as rq_number,(date) as date, store_name, cost_center \n"
                + "FROM st_receive_requisation WHERE requisition_no ILIKE '%" + requisitionNumberSearchTxt.getText() + "%'  and store_name ILIKE '%" + issuingStoreCmbx.getSelectedItem() + "%' \n"
                + "group by requisition_no, date, store_name, cost_center having sum(qty_issued) = 0  ORDER BY requisition_no"));
...
// TODO add your handling code here:
    ...
    private void searchTransferTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_searchTransferTableMouseClicked
        recepientStoreCmbx.setSelectedItem(searchTransferTable.getValueAt(searchTransferTable.getSelectedRow(), 2).toString());
        ...
        try {
            transactionTimepicker.setDate(sdf.parse(searchTransferTable.getValueAt(searchTransferTable.getSelectedRow(), 3).toString()));
        } catch (java.text.ParseException pe) {
            javax.swing.JOptionPane.showMessageDialog(this, pe.getMessage());
        }
        issuingStoreCmbx.setSelectedItem(searchTransferTable.getValueAt(searchTransferTable.getSelectedRow(), 1).toString());
        ...
        try {
            for (int j = 0; j < issuingItemsTable.getRowCount(); j++) {
                ...
                if (issuingItemsTable.getModel().getValueAt(j, 0) != null) {
                    ...
                    java.sql.Statement stmtTable11 = connectDB.createStatement();
                    java.sql.ResultSet rsetTable11 = stmtTable11.executeQuery("SELECT sum(qty) FROM stock_balance_qty WHERE item_code ilike '" + issuingItemsTable.getValueAt(j, 0).toString() + "%' AND department = '" + issuingStoreCmbx.getSelectedItem() + "' AND dates::date <= '" + SQLDateFormat.getSQLDate(transactionTimepicker.getDate()) + "'");
                    java.sql.Statement stmtTable11x = connectDB.createStatement();
                    java.sql.ResultSet rsetTable11x = stmtTable11x.executeQuery("SELECT sum(qty) FROM stock_balance_qty WHERE item_code ilike '" + issuingItemsTable.getValueAt(j, 0).toString() + "%' AND department  '" + recepientStoreCmbx.getSelectedItem() + "' AND dates::date <= '" + SQLDateFormat.getSQLDate(transactionTimepicker.getDate()) + "'");
...
// TODO add your handling code here:
    ...
    private void searchTransferNumberTxtCaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_searchTransferNumberTxtCaretUpdate
        searchTransferTable.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB, "SELECT DISTINCT transaction_no,sub_store,store_name,trans_date FROM st_sub_stores WHERE transaction_no ILIKE '" + searchTransferNumberTxt.getText() + "%' AND receiving > 0 AND (transaction_no ilike 'T%' OR transaction_no ilike 'I%') ORDER BY transaction_no"));
        searchTransferTable.setShowHorizontalLines(false);
        jSearchScrollPane2.setViewportView(searchTransferTable);
...
// TODO add your handling code here:
    ...
    private void mainStoreCkbxActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mainStoreCkbxActionPerformed
        ...
        issuingStoreCmbx.setModel(com.afrisoftech.lib.ComboBoxModel.ComboBoxModel(connectDB, "select distinct initcap(st.store_name) from st_main_stores st, store_allocation sa where upper(st.store_name)=upper(sa.stores) and sa.user_name=current_user"));
        issuingStoreCmbx.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                //  jComboBox2ActionPerformed(evt);
            }
        ...
        recepientStoreCmbx.setModel(com.afrisoftech.lib.ComboBoxModel.ComboBoxModel(connectDB, "select store_name from st_stores ORDER BY store_name"));
        recepientStoreCmbx.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                //   jComboBox2ActionPerformed(evt);
            }
        ...
        if (totalValueTxt.getText() != "0.00") {
            if (issuingStoreCmbx.getSelectedItem() != null && recepientStoreCmbx.getSelectedItem() != null) {
                ...
                try {
                    ...
                    com.afrisoftech.lib.GetItemInfo.updateTrail("Stock transfer " + transNo + " -" + requisitionNumberTxt.getText() + " to " + recepientStoreCmbx.getSelectedItem(), connectDB);
    ...
    private void SearchTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_SearchTableMouseClicked
        ...
        if (this.mainStoreCkbx.isSelected()) {
            try {
                ...
                java.sql.ResultSet rs1 = pstmt1.executeQuery("select sum(qty),1 from stock_balance_qty where item_code ilike '" + issuingItemsTable.getValueAt(issuingItemsTable.getSelectedRow(), 0) + "%' and department ILIKE '" + issuingStoreCmbx.getSelectedItem().toString() + "%' AND dates::date <= '" + SQLDateFormat.getSQLDate(transactionTimepicker.getDate()) + "'");
        ...
        try {
            ...
            java.sql.ResultSet rs12 = pstmt12.executeQuery("select sum(qty),1 from stock_balance_qty where item_code ilike '" + issuingItemsTable.getValueAt(issuingItemsTable.getSelectedRow(), 0) + "%' and department ILIKE '" + recepientStoreCmbx.getSelectedItem().toString() + "%' AND dates::date <= '" + SQLDateFormat.getSQLDate(transactionTimepicker.getDate()) + "'");
        ...
        if (issuingItemsTable.getValueAt(i, 4) == null) {
            ...
            issuingItemsTable.setValueAt(0.00, issuingItemsTable.getSelectedRow(), 4);
            //issuingItemsTable.setValueAt(0.00, issuingItemsTable.getSelectedRow(), 5);
    ...
    private void requisitionSearchTxtCaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_requisitionSearchTxtCaretUpdate
        if (requisitionSearchTxt.getCaretPosition() < 4) {
            ...
            if (mainStoreCkbx.isSelected()) {
                SearchTable.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB, "select DISTINCT item_code,description,strength,units,packaging, round(buying_price * 1.33), round(buying_price/packaging) FROM stockitem WHERE (description ILIKE '%" + requisitionSearchTxt.getText() + "%' OR item_code ILIKE '%" + requisitionSearchTxt.getText() + "%' )AND department ILIKE '%" + issuingStoreCmbx.getSelectedItem() + "%' order by description"));

                SearchTable.setShowHorizontalLines(false);
                jSearchScrollPane.setViewportView(SearchTable);
            } else {
                if (useCostPriceRdbtn.isSelected()) {
                    SearchTable.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB, "select DISTINCT product_id,product,strength,units,(1.00)::numeric(10,2) AS packing,transfer_price::numeric(10,2) FROM stockprices WHERE product ILIKE '%" + requisitionSearchTxt.getText() + "%' AND department ILIKE '%" + issuingStoreCmbx.getSelectedItem() + "%' ORDER BY product"));

                    SearchTable.setShowHorizontalLines(false);
                    jSearchScrollPane.setViewportView(SearchTable);
                } else {
                    SearchTable.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB, "select DISTINCT product_id,product,strength,units,(1.00)::numeric(10,2) AS packing,selling_price::numeric(10,2) FROM stockprices WHERE product ILIKE '%" + requisitionSearchTxt.getText() + "%' AND department ILIKE '%" + issuingStoreCmbx.getSelectedItem() + "%' ORDER BY product"));
...
//                        double totalSum = Total + tableSum;
    ...
    private void recepientStoreCmbxActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_recepientStoreCmbxActionPerformed
        ...
        if (!recepientStoreCmbx.getSelectedItem().toString().equalsIgnoreCase(issuingStoreCmbx.getSelectedItem().toString())) {
            ...
            JOptionPane.showMessageDialog(this, "A stock outlet cannot issue itself, select a different store to proceed");
        }
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        manualS11NumberTxt.setEditable(true);
        mainStoreCkbx.setSelected(true);
        issuingStoreCmbx.setModel(com.afrisoftech.lib.ComboBoxModel.ComboBoxModel(connectDB, "select distinct stores from store_allocation where user_name = current_user limit 1"));
    ...
    private void jTextField112CaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextField112CaretUpdate
        ...
        jSearchTable2.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB, ""
                + "SELECT transaction_no,store_name,user_name as Issued_by,  sub_store,issiued_to, manual_transfer_no"
                + "  FROM st_sub_stores   where (transaction_no ilike '%" + jTextField112.getText() + "%' or manual_transfer_no ilike '%" + jTextField112.getText() + "%') and store_name ilike '" + issuingStoreCmbx.getSelectedItem().toString() + "' and "
                + "sub_store ilike '" + recepientStoreCmbx.getSelectedItem().toString() + "' and "
                + "trans_date::date between '" + com.afrisoftech.lib.SQLDateFormat.getSQLDate(jDateChooser1.getDate()) + "' and"
                + " '" + com.afrisoftech.lib.SQLDateFormat.getSQLDate(jDateChooser2.getDate()) + "'"));
    ...
    private void jSearchTable2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jSearchTable2MouseClicked
        ...
        TransferedItemsPdf policy = new TransferedItemsPdf();
        policy.TransferedItemsPdf(connectDB, jSearchTable2.getValueAt(jSearchTable2.getSelectedRow(), 0).toString());


    }//GEN-LAST:event_jSearchTable2MouseClicked

    private void jButton11ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton11ActionPerformed
        this.reprintS11dialog.dispose();
    }//GEN-LAST:event_jButton11ActionPerformed

    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed

        System.out.println("Showing dialog");
        java.awt.Point point = jLabel13.getLocationOnScreen();
        reprintS11dialog.setSize(600, 200);
        reprintS11dialog.setLocation(point);
        reprintS11dialog.setVisible(true);
    }//GEN-LAST:event_jButton1ActionPerformed

    private void ManualS11CMBXItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_ManualS11CMBXItemStateChanged
        if (ManualS11CMBX.isSelected() == true) {
            for (int i = 0; i < 100; i++) {
                qtyVector.addElement(1000000);
            }
        }
    ...
    }//GEN-LAST:event_ManualS11CMBXItemStateChanged

    private void formInternalFrameActivated(javax.swing.event.InternalFrameEvent evt) {//GEN-FIRST:event_formInternalFrameActivated
        // TODO add your handling code here:
        mainStoreCkbx.doClick();
    }//GEN-LAST:event_formInternalFrameActivated

    private void recepientStoreCmbxItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_recepientStoreCmbxItemStateChanged
        // TODO add your handling code here:
        if (recepientStoreCmbx.getSelectedItem().toString().equalsIgnoreCase(issuingStoreCmbx.getSelectedItem().toString())) {
            JOptionPane.showMessageDialog(this, "A stock outlet cannot issue itself, select a different store to proceed");
        }
...
//            }
    ...
    private com.afrisoftech.hospinventory.IssuingItemsPdf issuingItemsPdf1;
    ...
    private com.afrisoftech.lib.DatePicker transactionTimepicker;
