...
import static com.afrisoftech.lib.TenderedItems.tenderNotxt;
 ...
 * @author saleem
 */
public class TenderAdIntfr extends javax.swing.JInternalFrame {
    ...
    public TenderAdIntfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
        ...
        for (int i = 0; i < tendersGenerationtbl.getRowCount(); i++) {
            tendersGenerationtbl.setValueAt(false, i, 2);
        }
    ...
    private void initComponents() {
        ...
        tendersGenerationtbl = new com.afrisoftech.dbadmin.JTable();
        ...
        */
        ...
        tendersGenerationtbl.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Tender Number(e.g 1,2,3)", "Description Of Tender", "Activate", "Category"
            }
        ) {
        ...
        tendersGenerationtbl.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tendersGenerationtblMouseClicked(evt);
            }
        });
        ...
        buttonGroup1.add(tenderChk);
        tenderChk.setSelected(true);
        tenderChk.setText("Tenders");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 2;
        jPanel8.add(tenderChk, gridBagConstraints);

        buttonGroup1.add(rfqChk);
        rfqChk.setText("RFQs");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 2;
        gridBagConstraints.gridy = 2;
        ...
        cmbox51.setModel (new javax.swing.DefaultComboBoxModel(new String[] {"A","B","C" }));
    ...
    private void refreshTable() {
        try {
            ...
            while (gettinTenders.next()) {
                ...
                tenderItemstbl.setValueAt(gettinTenders.getObject(3), i, 2);
    ...
    private void savebtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_savebtnActionPerformed
        ...
        try {
            ...
            jLabel2.setText("Criteria Entered Successfully");
    ...
    private void editBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editBtnActionPerformed
        if (tendernotxt.getText().length() > 0) {
            ...
            try {
                PreparedStatement pst = connectDB.prepareStatement("SELECT DISTINCT pr_code, pr_item from st_preliminary_criteria where quotation_no='" + tendernotxt.getText() + "'");
                ResultSet rset = pst.executeQuery();
                int i = 0;
                while (rset.next()) {
                    criteriaTbl.setValueAt(rset.getObject(1).toString(), i, 0);
                    criteriaTbl.setValueAt(rset.getObject(2).toString(), i, 1);
                    i++;
                }
    ...
    private void jButton10ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton10ActionPerformed
        try {
            ...
            connectDB.commit();
            javax.swing.JOptionPane.showMessageDialog(this, "Bidders Coded  Successfully", "Entry Added", JOptionPane.INFORMATION_MESSAGE);
...
//        {
            tenderrecordstbl1.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB, "SELECT DISTINCT quotation_no FROM st_floated_quotations  where "
                    + "   quotation_no ilike '" + tenderrecordstxt1.getText() + "%' order by 1 desc;"));
            tenderrecordstbl1.setShowHorizontalLines(false);
...
//        {
    ...
    private void savetDbtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_savetDbtnActionPerformed
        // TODO add your handling code here:
        int exitOption = javax.swing.JOptionPane.showConfirmDialog(this, "Are you Sure To Commit Changes", "CONFIRMATION", javax.swing.JOptionPane.YES_NO_CANCEL_OPTION);
            ...
            if (savetDbtn.getLabel().toString().equalsIgnoreCase("Save Details For Financial Yr")) {
                ...
                for (int i = 0; i < tendersGenerationtbl.getRowCount(); i++) {
                    ...
                    if (tendersGenerationtbl.getValueAt(i, 0) != null && tendersGenerationtbl.getModel().getValueAt(i, 2) == java.lang.Boolean.TRUE) {
                        ...
                        try {
                            ...
                            if (occurences < 1) {
                                PreparedStatement pst = connectDB.prepareStatement("INSERT INTO st_tenders (ref_no, description,stock_sub_category) VALUES (?, ?,?);");

                                //0710 431 152
                                pst.setObject(1, tenderno);
                                pst.setObject(2, tendersGenerationtbl.getValueAt(i, 1));
                                pst.setObject(3, tendersGenerationtbl.getValueAt(i, 3));
                                pst.executeUpdate();
                ...
                try {
                    for (int i = 0; i < tendersGenerationtbl.getRowCount(); i++) {
                        ...
                        if (tendersGenerationtbl.getValueAt(i, 0) != null && tendersGenerationtbl.getModel().getValueAt(i, 2) == java.lang.Boolean.TRUE) {
                            PreparedStatement pst2 = connectDB.prepareStatement("UPDATE st_tenders SET ref_no=? ,description=?,stock_sub_category=? WHERE ref_no=? ");
                            pst2.setObject(1, tendersGenerationtbl.getModel().getValueAt(i, 0));
                            pst2.setObject(2, tendersGenerationtbl.getModel().getValueAt(i, 1));
                            pst2.setObject(3, ui);
                            pst2.setObject(4, tendersGenerationtbl.getModel().getValueAt(i, 3));

                            pst2.executeUpdate();
                            savebtn.setLabel("Save Details For Financial Yr");
                        }
                    }
                } catch (SQLException ex) {
                    ex.printStackTrace();
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        // TODO add your handling code here:
        //select distinct ref_no,date_entered from st_tenders order by 1
        tendersGenerationtbl.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB, "select distinct ref_no,description,true Active,'' CATEGORY from st_tenders order by 1"));
        savetDbtn.setLabel("Update Details For Financial Yr");

    }//GEN-LAST:event_jButton5ActionPerformed

    private void tendersGenerationtblMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tendersGenerationtblMouseClicked
        // TODO add your handling code here:
        //this.setCursor(new java.awt.Cursor(java.awt.Cursor.WAIT_CURSOR));
       
                    String tender = tendersGenerationtbl.getValueAt(tendersGenerationtbl.getSelectedRow(), 0).toString();
        if (tendersGenerationtbl.getSelectedColumn()==0 && tender.length() > 0) {
             tender = tendersGenerationtbl.getValueAt(tendersGenerationtbl.getSelectedRow(), 0).toString();
            com.afrisoftech.hospinventory.St_items_to_quotePDF policy = new com.afrisoftech.hospinventory.St_items_to_quotePDF();

            policy.St_items_to_quotePDF(connectDB, tender);
        }
       // this.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
    }//GEN-LAST:event_tendersGenerationtblMouseClicked
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        // TODO add your handling code here:
        ClearTable.removeSelectedRows(tendersGenerationtbl);
