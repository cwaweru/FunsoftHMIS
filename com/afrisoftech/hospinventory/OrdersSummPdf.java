                    ...
                    try {
                       ...
                       // Phrase phrase = new Phrase("Patients List As At:" +endDate, pFontHeader);
                        ...
                        try {
                            ...
                            java.sql.ResultSet rset = st.executeQuery("select distinct(order_no),date,upper(supplier),sum(net_value),date_due from st_orders WHERE date BETWEEN '" + beginDate + "' AND '" + endDate + "' and date IS NOT NULL AND order_no IS NOT NULL group by order_no,date,supplier,date_due ORDER BY date,order_no");
