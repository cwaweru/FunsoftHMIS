...
public class StoresBalNopricesPdf implements java.lang.Runnable {
    int seq=0;
    ...
    public void StoresBalNopricesPdf(java.sql.Connection connDb,java.util.Date begindate,java.util.Date endate,java.lang.String cbox) {
                    ...
                    try {
                        ...
                        try {
                            ...
                            //java.lang.Object[] listofAct = this.getListofActivities();
                                 ...
                                 double amount = 0.00; 
                                double qty = 0.00;
                                java.sql.ResultSet rset = st.executeQuery("select initcap(description),sum(qty)::NUMERIC(10,0) AS BALANCE from stock_balance_qty where department ilike '"+CBox+"' AND dates <= '"+endDate+"' GROUP BY description order by description");//select item,sum(receiving-issuing)::NUMERIC(10,0) AS BALANCE from stock_movement_summary where store_name ilike '"+CBox+"' AND item =  '"+listofAct[i]+"' AND trans_date <= '"+endDate+"' group by item");// WHERE transaction_no NOTNULL AND date BETWEEN '"+beginDate+"' AND '"+endDate+"' ORDER BY transaction_no ASC");// tn,debit_note db WHERE tn.policy_no != '' and tn.policy_no = db.policy_no GROUP BY tn.policy_no,db.policy_class");
...
docPdf.close();  com.afrisoftech.lib.PDFRenderer.renderPDF(tempFile);
   ...
   /* public java.lang.Object[] getListofActivities() {
        ...
        java.lang.Object[] listofActivities = null;admin    758595kh
    *
