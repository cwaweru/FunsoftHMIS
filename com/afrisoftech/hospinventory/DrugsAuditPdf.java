...
public class DrugsAuditPdf implements java.lang.Runnable {
    ...
    java.lang.String DrugCode = null;
    ...
    public void DrugsAuditPdf(java.sql.Connection connDb, java.util.Date begindate, java.util.Date endate, java.lang.String dCode) {
                ...
                try {
                    ...
                    try {
                        ...
                        try {
                            ...
                            phrase = new Phrase("ITEM(S) BALANCE SUMMARY - Period : From " + dateFormat.format(endDate11) + " To " + dateFormat.format(endDate1), pFontHeader);
                        ...
                        try {
                            ...
                            java.sql.ResultSet rset32 = st32.executeQuery("SELECT INITCAP(description)||' '||strength FROM st_stock_item WHERE item_code = '" + DrugCode + "'");

                            while (rset32.next()) {
                                phrase = new Phrase(this.DrugCode + "  " + dbObject.getDBObject(rset32.getObject(1), "-"), pFontHeader);
                            }
                            ...
                            for (int i = 0; i < listofAct.length; i++) {
                                ...
                                /*
                                 * double opStock = 0.00; double supplies =
                                 * 0.00; double sales = 0.00; double closing =
                                 * 0.00;
                                 */
                                ...
                                java.sql.ResultSet rset = st21.executeQuery("SELECT SUM(ss.issuing) FROM st_sub_stores ss WHERE ss.trans_date::date BETWEEN '" + beginDate + "' AND '" + endDate + "' AND ss.item_code = '" + DrugCode + "' AND ss.store_name ilike '" + listofAct[i] + "' group by  ss.item_code");

                                java.sql.ResultSet rset1 = st2.executeQuery("SELECT SUM(ss.receiving) FROM st_sub_stores ss WHERE ss.trans_date::date BETWEEN '" + beginDate + "' AND '" + endDate + "' AND ss.item_code = '" + DrugCode + "' AND ss.store_name ilike '" + listofAct[i] + "' group by ss.item_code");

                                java.sql.ResultSet rset2 = st3.executeQuery("SELECT SUM(qty) FROM stock_balance_qty WHERE item_code =  '" + DrugCode + "' AND department ilike '" + listofAct[i] + "' and dates <= '" + endDate + "'");
                             ...
                             *
                             * phrase = new Phrase(new
                             * com.afrisoftech.sys.Format2Currency().Format2Currency(rsetTotals.getString(2)),
                             * pFontHeader);
                             *
                             * table.addCell(phrase);
                             * table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_RIGHT);
                             *
                             * phrase = new Phrase(new
                             * com.afrisoftech.sys.Format2Currency().Format2Currency(rsetTotals.getString(3)),
                             * pFontHeader);
                             *
                             * table.addCell(phrase); }
                             */
...
docPdf.close();  com.afrisoftech.lib.PDFRenderer.renderPDF(tempFile);
    ...
    public java.lang.Object[] getListofActivities() {
        ...
        try {
            ...
            java.sql.ResultSet rSet1 = stmt1.executeQuery("SELECT DISTINCT department FROM st_stock_prices WHERE product_id ILIKE '" + this.DrugCode + "' ORDER BY 1");
