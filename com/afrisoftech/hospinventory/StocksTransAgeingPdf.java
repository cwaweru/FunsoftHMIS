                        ...
                        try {
                            ...
                            for (int i = 0; i < listofAct.length; i++) {
                                ...
                                if (name > 0){
                                    ...
                                    java.sql.PreparedStatement pset111 = connectDB.prepareStatement("select sum(qty) from stock_balance WHERE description = ?");//< '"+endDate+"'::date and date > '"+endDate+"'::date - 30 group by dealer");
                                ...
                                */
                                    java.sql.PreparedStatement pset112 = connectDB.prepareStatement("select sum(qty) from st_stock_balance WHERE description = ?");//< '"+endDate+"'::date and date > '"+endDate+"'::date - 30 group by dealer");
