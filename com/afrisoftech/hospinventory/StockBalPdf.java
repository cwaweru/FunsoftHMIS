...
public class StockBalPdf implements java.lang.Runnable {
    ...
    public void StockBalPdf(java.sql.Connection connDb,java.lang.String cbox, java.lang.String endate) {
            ...
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        int headerwidths[] = {8,12,38,12,15,10,10};
                        ...
                        Phrase phrase = new Phrase(CBox.toUpperCase() + " STOCK BALANCE AS AT : " +endDate, pFontHeader);
                        ...
                        try {
                            ...
                            for (int i = 0; i < listofAct.length; i++) {
                                double amount = 0.00; 
                                double qty = 0.00;
                                java.sql.ResultSet rset = st.executeQuery("select item_code,sum(qty) from stock_balance_qty where department ilike '"+CBox+"' AND item_code ilike  '"+listofAct[i]+"' AND dates <= '"+endDate+"' group by stock_balance_qty.item_code");
                                 java.sql.ResultSet rset2 = st2.executeQuery("select description,strength,buying_price/packaging from st_stock_item WHERE item_code ilike  '"+listofAct[i]+"'");
                                while (rset.next()) {
                                    while (rset2.next()) {
                                        seq = seq+1;
                                    table.getDefaultCell().setColspan(1);
...
docPdf.close();  com.afrisoftech.lib.PDFRenderer.renderPDF(tempFile);
    ...
    public java.lang.Object[] getListofActivities() {
        ...
        try {
            ...
            java.sql.ResultSet rSet1 = stmt1.executeQuery("SELECT DISTINCT item_code,description FROM stock_balance_qty  WHERE department ilike '"+CBox+"%' AND dates <= '"+endDate+"'  order by description ");
