...
public class AssetAllocationIntfr extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        */
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Allocate Assets here"));
    ...
    private void jTextField1111CaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextField1111CaretUpdate
        /*if (this.jTextField1111.getCaretPosition() < 1) {
            ...
            jSearchTable1.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB, "SELECT DISTINCT invoice_no FROM st_stock_cardex WHERE invoice_no ILIKE '%" + jTextField1111.getText() + "%' ORDER BY 1"));
            jSearchScrollPane1.setViewportView(jSearchTable1);
    ...
    private void jTextField111CaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextField111CaretUpdate
        if (this.jTextField111.getCaretPosition() < 3) {
            ...
            jSearchTable.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB, "select code,asset_type,name FROM pb_depreciation_rates WHERE name ilike '" + jTextField111.getText() + "%' order by name"));
