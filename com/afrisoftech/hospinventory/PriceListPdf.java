            ...
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        int headerwidths[] = {8, 12, 30, 12, 12};
                        ...
                        try {
                            ...
                            for (int i = 0; i < listofAct.length; i++) {
                                ...
                                java.sql.ResultSet rset = st.executeQuery("SELECT distinct product_id,initcap(product)||' '||strength,selling_price FROM st_stock_prices WHERE department ilike '" + bank + "%'  AND category = '" + listofAct[i].toString() + "' ORDER BY product_id");
