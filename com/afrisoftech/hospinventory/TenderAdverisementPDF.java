...
public class TenderAdverisementPDF implements java.lang.Runnable {
    ...
    com.lowagie.text.Font pFontHeaderColor = FontFactory.getFont(FontFactory.HELVETICA, 13, Font.BOLD);
   ...
   // private String time=null;
    ...
    public void TenderAdverisementPDF(java.sql.Connection connDb, java.lang.String tenderNo, java.lang.String adDate) {
      //  selectSupp = combox;
      //  Department = dept;
        OrderNo = tenderNo;
       // user = UserName;
                ...
                try {
                    ...
                    try {
                        ...
                        try {
                            ...
                            java.sql.ResultSet rset4 = st4.executeQuery(" SELECT DISTINCT date from st_tenders WHERE ref_no = '" + OrderNo + "' limit 1");
                          //  java.sql.ResultSet rset5 = st5.executeQuery("SELECT distinct description from st_recommendation WHERE quotation_no = '" + OrderNo + "'");
                            ...
                            while (rset4.next()) {
                                ...
                                table2.getDefaultCell().setColspan(10);
                                table2.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_CENTER);
                                phrase = new Phrase("OPEN TENDER NOTICE", pFontHeader5);
                                ...
                                table2.getDefaultCell().setColspan(10);
                                table2.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_CENTER);
                                phrase = new Phrase(com.afrisoftech.lib.FinancialYear.getCompanyName(connectDB)+" invites Bidders who are technically and Financially able"
                                        + "to supply the following undermentioned items as listed below", pFontHeader);
                                table2.addCell(phrase);
...
//                     java.sql.Statement st5 = connectDB.createStatement();
//                       java.sql.ResultSet rset5 = st5.executeQuery("SELECT distinct ref_no,description,opening_date,bid_bond from st_tenders WHERE ref_no = '" + OrderNo + "' group by 1,2");
////items table
//                      while(rset5.next()){
                       ...
                       //0 
                        ...
                        phrase = new Phrase("", pFontHeaderColor);
                        ...
                        table3.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                        phrase = new Phrase("TENDER ", pFontHeader);
                        table3.addCell(phrase);
                        ...
                        table3.getDefaultCell().setColspan(2);
                        table3.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                        phrase = new Phrase("CLOSING DATE", pFontHeader);
                        table3.addCell(phrase);
...
//                            java.lang.Object[] listofAct1 = this.getListofActivities1();
           ...
           for (int i = 0; i < listofAct.length; i++) {
                            ...
                            java.sql.ResultSet rset1 = st2.executeQuery("SELECT distinct ref_no,description,opening_date,bid_bond from st_tenders WHERE ref_no = '"+listofAct[i].toString()+"' group by 1,2");

                          //bidder_no
                            
                            while (rset1.next()) {
                               System.out.println("SELECT distinct ref_no,description,opening_date,bid_bond from st_tenders WHERE ref_no = '"+listofAct[i].toString()+"' group by 1,2");
                                cnt= cnt +1;
                              //#
                            table3.getDefaultCell().setColspan(1);
                            table3.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                            ...
                            //CLOSING DATE
                            table3.getDefaultCell().setColspan(2);
                            phrase = new Phrase(rset1.getDate(4).toString(), pFontHeader2);
                            table3.addCell(phrase);
...
//                                 }
                    ...
                    try{
                        ...
                        try {
                            ...
                            pst = connectDB.prepareStatement("select count(distinct supplier_code) from st_technical_evaluation where quotation_no = '"+OrderNo+"' and total_mark>99");
                            pst2 = connectDB.prepareStatement("select count(distinct supplier_code) from st_technical_evaluation where quotation_no = '"+OrderNo+"' and total_mark>99");
                            pst3 = connectDB.prepareStatement("select count(distinct supplier_code) from st_technical_evaluation where quotation_no = '"+OrderNo+"' and total_mark<100");
                            ...
                            Logger.getLogger(TenderAdverisementPDF.class.getName()).log(Level.SEVERE, null, ex);
                        }
...
//                            
    ...
    public java.lang.Object[] getListofActivities() {
        ...
        java.sql.ResultSet rSet1 = stmt1.executeQuery("SELECT DISTINCT ref_no from st_tenders  where advertisement_date = '"+beginDate+"'  group by 1 order by 1");
       ...
       // System.out.println(OrderNo);
        ...
        System.out.println("Done list of Items in the Adsreport ...");
