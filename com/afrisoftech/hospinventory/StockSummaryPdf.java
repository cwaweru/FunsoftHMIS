...
public class StockSummaryPdf implements java.lang.Runnable {
    ...
    public void StockSummaryPdf(java.sql.Connection connDb,java.util.Date begindate,java.util.Date endate) {
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    com.lowagie.text.HeaderFooter footer = new com.lowagie.text.HeaderFooter(new Phrase("Stock Count Summary list - Page: ",pFontHeader), true);// FontFactory.getFont(com.lowagie.text.FontFactory.HELVETICA, 12, Font.BOLDITALIC,java.awt.Color.blue));
                    ...
                    try {
                        ...
                        Phrase  phrase = new Phrase("Stock Count Summary", pFontHeader);
                        ...
                        phrase = new Phrase("Store Name",pFontHeader);
                        table.addCell(phrase);
                         table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_RIGHT);
                        table.getDefaultCell().setColspan(4);
                      ...
                      /*  table.getDefaultCell().setColspan(1);
                        ...
                        */
                        ...
                        try {
                            ...
                            java.sql.ResultSet rset = st.executeQuery("select department,sum(stock_value) from st_stock_count  WHERE input_date::date BETWEEN '"+beginDate+"' AND '"+endDate+"' GROUP BY department ORDER BY department");
