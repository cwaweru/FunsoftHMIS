...
public class NutritionistSummReportsPdf implements java.lang.Runnable {
    ...
    public void NutritionistReportItemsPdf(java.sql.Connection connDb,java.util.Date begindate,java.util.Date endate,java.lang.String combox) {
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    com.lowagie.text.HeaderFooter footer = new com.lowagie.text.HeaderFooter(new Phrase("Nutrition Services Offered by "+ bank +" - Page: ",pFontHeader), true);// FontFactory.getFont(com.lowagie.text.FontFactory.HELVETICA, 12, Font.BOLDITALIC,java.awt.Color.blue));
...
//                        table.getDefaultCell().setBorder(Rectangle.BOTTOM);
                        ...
                        double a, b, c, d, e, f;
                           ...
                           try {
                                ...
                                phrase = new Phrase(bank + "\nService Period : " +dateFormat.format(endDate11)+" - "+dateFormat.format(endDate1), pFontHeader);
                                table.addCell(phrase);
...
//                        table.getDefaultCell().setBorderColor(java.awt.Color.WHITE);
                        ...
                        try {
                            ...
                            java.sql.ResultSet rset2 = st2.executeQuery("select distinct login_name from secure_menu_access where initcap(f_name) || ' '|| initcap(l_name) ilike '"+bank+"' ORDER BY login_name");
                            ...
                            while (rset2.next()) {
                                ...
                                String user_n2 = user_n, user_n3 = null;
                                
                                java.sql.ResultSet rset = st.executeQuery("select distinct date, service, sum(dosage) as Quantity, user_name, sum(debit) as Amount, sum(credit) as Credit from hp_patient_card where gl_account = '600-60601-60035' and user_name ilike '"+user_n2+"' and paid = true and date between '"+beginDate+"' AND '"+endDate+"' group by date, service, user_name order by date");
                                
                                while (rset.next()) {
                                    
                                    user_n3 = rset.getObject(4).toString();
                                ...
                                if (user_n2.equals(user_n3)) {
                                   System.out.println("Yes - " + user_n2 + " FOUND!");
                                } else {
...
//                            table.getDefaultCell().setBorder(Rectangle.BOTTOM | Rectangle.TOP);
                            ...
                            table.getDefaultCell().setColspan(5);
                            table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                            phrase = new Phrase("Summary of Activities",pFontHeader);
                            table.addCell(phrase);
