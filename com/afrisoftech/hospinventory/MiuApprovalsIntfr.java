 ...
 */
public class MiuApprovalsIntfr extends javax.swing.JInternalFrame {
    ...
    public MiuApprovalsIntfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {
        ...
        miu_tbl = new com.afrisoftech.dbadmin.JTable();
        jPanel8 = new javax.swing.JPanel();
        jScrollPane2 = new javax.swing.JScrollPane();
        miu_reject_tbl = new com.afrisoftech.dbadmin.JTable();

        setClosable(true);
        setIconifiable(true);
        setMaximizable(true);
        setResizable(true);
        setTitle("MIU  APPROVAL ");
        ...
        ApprovalTbl.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"SELECT distinct order_no as LPO_LSO_NO,supplier as supplier_name from st_orders st where dispatch=false and ordered=false and chief_approval=true and aie_holder_approval=true and sad_approval=true  and miu_approval=false and order_no is not null group by supplier,order_no  order by order_no"));
        ...
        */
        ...
        miu_tbl.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        miu_tbl.setGridColor(new java.awt.Color(204, 204, 255));
        ...
        miu_tbl.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                miu_tblMouseClicked(evt);
            }
            public void mouseReleased(java.awt.event.MouseEvent evt) {
                miu_tblMouseReleased(evt);
            }
        });
        miu_tbl.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                miu_tblKeyReleased(evt);
            }
        });
        jScrollPane1.setViewportView(miu_tbl);
        ...
        miu_reject_tbl.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null, null, null, null, null},
                {null, null, null, null, null, null, null, null},
                {null, null, null, null, null, null, null, null},
        ...
        miu_reject_tbl.setGridColor(new java.awt.Color(204, 204, 255));
        //this.procurementPlanTbl.getColumnModel().getColumn(i).setCellEditor(new javax.swing.DefaultCellEditor((javax.swing.JComboBox)new com.afrisoftech.lib.DatePicker()));
        miu_reject_tbl.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                miu_reject_tblMouseClicked(evt);
            }
            public void mouseReleased(java.awt.event.MouseEvent evt) {
                miu_reject_tblMouseReleased(evt);
            }
        });
        miu_reject_tbl.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                miu_reject_tblKeyReleased(evt);
            }
        });
        jScrollPane2.setViewportView(miu_reject_tbl);
...
// v.removeAllElements();
        ...
        for (int k = 0; k < miu_tbl.getRowCount(); k++) {
            for (int r = 0; r < miu_tbl.getColumnCount(); r++) {
                miu_tbl.getModel().setValueAt(null, k, r);
            }
        }
        ...
        try {
            ...
            try {
                ...
                while (rsetSupplier.next()) {
                    ...
                    miu_tbl.setValueAt(rsetSupplier.getObject(6), k, 2);
                    miu_tbl.setValueAt(false, k, 6);
                    miu_tbl.setValueAt(rsetSupplier.getObject(2), k, 4);
                    miu_tbl.setValueAt(rsetSupplier.getObject(4), k, 1);
                    ...
                    if (rsetSupplierDate.next()) {
                        miu_tbl.setValueAt(rsetSupplierDate.getObject(1), k, 0);

                        miu_tbl.setValueAt(rsetSupplierDate.getObject(3), k, 3);
                    }
                    ...
                    if (rsetdebit.next()) {
                        ...
                        miu_tbl.setValueAt(rsetdebit.getObject(1), k, 5);
    ...
    private void SaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SaveActionPerformed
        ...
        try {
            ...
            if (Save.getText().equals("Save")) {
                //connectDB.setAutoCommit(false);                                    
                for (int k = 0; k < miu_tbl.getRowCount(); k++) {
                    if (miu_tbl.getValueAt(k, 0) != null) {
                        if (Boolean.valueOf(miu_tbl.getValueAt(k, 12).toString()) == java.lang.Boolean.TRUE) {

                            String comment;
                            if (miu_tbl.getValueAt(k, 11) == null) {
                                comment = "";
                            } else {
                                comment = miu_tbl.getValueAt(k, 11).toString();
                            }

                            java.sql.PreparedStatement pstmt81212 = connectDB.prepareStatement(""
                                    + "update st_orders set miu_approval=true, miu='" + correct_name + "', miu_date=now(), miu_remark='" + comment + "' WHERE order_no='" + lpo + "' and code='" + miu_tbl.getModel().getValueAt(k, 1).toString() + "'");
                            ...
                            System.out.println("update st_orders set miu_approval=true, miu='" + correct_name + "', miu_date=now(), miu_remark='" + comment + "' where  order_no='" + lpo + "' and  code='" + miu_tbl.getModel().getValueAt(k, 1).toString() + "'");
                ...
                if (check_update == true) {
                    ...
                    TenderTrack.TrackTable(connectDB, "miu_approval", com.afrisoftech.lib.UserName.getLoginName(connectDB) + "-" + com.afrisoftech.lib.UserName.getServerDate(connectDB), TenderTxt.getText());
                    connectDB.setAutoCommit(false);
                    connectDB.commit();
                    ...
                    cancelbtn.doClick();
//ApprovalTbl.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"SELECT distinct order_no as LPO_LSO_NO,supplier as supplier_name from st_orders st where dispatch=false and ordered=false and chief_approval=true and aie_holder_approval=true and sad_approval=true  and miu_approval=false  group by supplier,order_no  order by order_no"));
                ...
                for (int j = 0; j < miu_reject_tbl.getRowCount(); j++) {
                    if (miu_reject_tbl.getValueAt(j, 0) != null) {
                        if (Boolean.valueOf(miu_reject_tbl.getValueAt(j, 13).toString()) == java.lang.Boolean.TRUE) {

                            String comment;

                            comment = null;
                            if (miu_reject_tbl.getValueAt(j, 11).toString().equals("not rejected at this stage")) {

                                java.sql.PreparedStatement pstmt812123 = connectDB.prepareStatement("update st_orders set approval_rejected=null  where dispatch=false and ordered=false and chief_approval=true and aie_holder_approval=true and sad_approval=true  and miu_approval=false and   approval_rejected ilike '%sad%'  and quotation_no='" + TenderTxt.getText() + "' and order_no='" + lpo + "' and item ='" + miu_reject_tbl.getModel().getValueAt(j, 2).toString() + "' and code='" + miu_reject_tbl.getModel().getValueAt(j, 1).toString() + "'");
                                //        java.sql.PreparedStatement pstmt8121 = connectDB.prepareStatement("UPDATE ac_ledger SET reconciled = true WHERE cheque_no ILIKE '" + grn2PayablesLinkingTable.getValueAt(i, 1).toString() + "' AND dealer ilike '" + supplierNameTxt.getText().toString() + "' and date = '" + grn2PayablesLinkingTable.getValueAt(i, 0).toString() + "' and transaction_no = '" + grn2PayablesLinkingTable.getValueAt(i, 4).toString() + "'");

                                pstmt812123.executeUpdate();
                                check_activation = true;
                            } else {
                                java.sql.PreparedStatement pstmt812123 = connectDB.prepareStatement("update st_orders set approval_rejected=null  where dispatch=false and ordered=false and chief_approval=true and aie_holder_approval=true and sad_approval=true  and miu_approval=true and   approval_rejected ilike '%miu%'  and quotation_no='" + TenderTxt.getText() + "' and order_no='" + lpo + "' and item ='" + miu_reject_tbl.getModel().getValueAt(j, 2).toString() + "' and code='" + miu_reject_tbl.getModel().getValueAt(j, 1).toString() + "'");
                                //        java.sql.PreparedStatement pstmt8121 = connectDB.prepareStatement("UPDATE ac_ledger SET reconciled = true WHERE cheque_no ILIKE '" + grn2PayablesLinkingTable.getValueAt(i, 1).toString() + "' AND dealer ilike '" + supplierNameTxt.getText().toString() + "' and date = '" + grn2PayablesLinkingTable.getValueAt(i, 0).toString() + "' and transaction_no = '" + grn2PayablesLinkingTable.getValueAt(i, 4).toString() + "'");
                ...
                if (check_activation == true) {
                    ...
                    cancelbtn.doClick();
                    ClearTable.clearthisTable(miu_reject_tbl);
                    //ApprovalTbl.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"SELECT distinct order_no as LPO_LSO_NO,supplier as supplier_name from st_orders st where dispatch=false and ordered=false and chief_approval=true and aie_holder_approval=true and sad_approval=true  and miu_approval=false  group by supplier,order_no  order by order_no"));
                    refresh();
                } else {
                    javax.swing.JOptionPane.showMessageDialog(this, "Check Your Entries", "ERROR MESSAGE!", javax.swing.JOptionPane.ERROR_MESSAGE);
            ...
            Logger.getLogger(MiuApprovalsIntfr.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void resetbtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_resetbtnActionPerformed
        //ADDING ITEMS
        cancelbtn.doClick();
        //ApprovalTbl.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"SELECT distinct order_no as LPO_LSO_NO,supplier as supplier_name from st_orders st where dispatch=false and ordered=false and chief_approval=true and aie_holder_approval=true and sad_approval=true  and miu_approval=false OR (miu_approval=true and approval_rejected='miu')  group by supplier,order_no  order by order_no"));
        refresh();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            for (int k = 0; k < miu_tbl.getRowCount(); k++) {
                if (miu_tbl.getValueAt(k, 0) != null) {
                    if (Boolean.valueOf(miu_tbl.getModel().getValueAt(k, 12).toString()) == java.lang.Boolean.TRUE) {
                        ...
                        java.sql.PreparedStatement pstmt81212 = connectDB.prepareStatement(""
                                + "update st_orders set miu_approval=true,miu='" + correct_name + "',miu_date=now(),miu_rejected_remark='" + comment + "',approval_rejected='miu' where dispatch=false and ordered=false and chief_approval=true and aie_holder_approval=true and sad_approval=true  and miu_approval=false   and quotation_no='" + TenderTxt.getText() + "' and order_no='" + lpo + "' and item ='" + miu_tbl.getModel().getValueAt(k, 2).toString() + "' and code='" + miu_tbl.getModel().getValueAt(k, 1).toString() + "'");
                        //        java.sql.PreparedStatement pstmt8121 = connectDB.prepareStatement("UPDATE ac_ledger SET reconciled = true WHERE cheque_no ILIKE '" + grn2PayablesLinkingTable.getValueAt(i, 1).toString() + "' AND dealer ilike '" + supplierNameTxt.getText().toString() + "' and date = '" + grn2PayablesLinkingTable.getValueAt(i, 0).toString() + "' and transaction_no = '" + grn2PayablesLinkingTable.getValueAt(i, 4).toString() + "'");
            ...
            Logger.getLogger(SadApprovalsIntfr.class.getName()).log(Level.SEVERE, null, ex);
        }
    }//GEN-LAST:event_jButton1ActionPerformed

    private void miu_tblMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_miu_tblMouseClicked
        Save.setText("Save");
...
//        }
    ...
    }//GEN-LAST:event_miu_tblMouseClicked

    private void miu_tblMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_miu_tblMouseReleased
...
//        }        // TODO add your handling code here:
    }//GEN-LAST:event_miu_tblMouseReleased

    private void miu_tblKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_miu_tblKeyReleased
    ...
    }//GEN-LAST:event_miu_tblKeyReleased
    ...
    private void ApprovalTblMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_ApprovalTblMouseClicked
        try {
            ...
            TenderTxt1.setText(null);
            connectDB.setAutoCommit(false);
            ClearTable.clearthisTable(miu_tbl);
            ...
            java.sql.ResultSet rsets = stmtss.executeQuery("SELECT distinct ordering_store,quotation_no,requisition_no FROM st_orders WHERE order_no ='" + lpo + "' and  dispatch=false and ordered=false and chief_approval=true and aie_holder_approval=true and sad_approval=true  and miu_approval=false");
...
//            System.out.println("THE PR IS "+prq_new);
            ...
            miu_tbl.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB, "(SELECT distinct o.date_due,o.code,o.item,o.item_strength,o.units, o.quantity, o.unit_price,o.net_value,chief_remark  Chief_Remark,aie_holder_remark,sad_remark,null Remarks,false Approve  FROM st_orders o,st_item_to_quote q where o.order_no='" + lpo + "' and  q.tender_no ilike '" + TenderTxt.getText() + "' and o.dispatch=false and o.ordered=false and o.chief_approval=true and o.aie_holder_approval=true and o.sad_approval=true  and o.miu_approval=true and o.approval_rejected is null UNION SELECT distinct o.date_due,o.code,o.item,o.item_strength,o.units, o.quantity, o.unit_price,o.net_value,chief_remark  Chief_Remark,aie_holder_remark,sad_remark,null Remarks,false Approve  FROM st_orders o,st_item_to_quote q where o.order_no='" + lpo + "' and  q.tender_no='" + TenderTxt.getText() + "' and o.dispatch=false and o.ordered=false and o.chief_approval=true and o.aie_holder_approval=true and o.sad_approval=true  and o.miu_approval=false and o.approval_rejected is null) ORDER BY 1"));
            miu_reject_tbl.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB, "(SELECT distinct o.date_due,o.code,o.item,o.item_strength,o.units, o.quantity, o.unit_price,o.net_value,chief_rejected_remark  Chief_Rejection,aie_rejected_remark Aie_Rejection,sad_rejected_remark Sad_Rejection,miu_rejected_remark miu_rejection,null Remarks,false Activate  FROM st_orders o,st_item_to_quote q where o.order_no='" + lpo + "' and  q.tender_no='" + TenderTxt.getText() + "' and q.tender_no=o.quotation_no and o.item=q.item_description  and o.chief_approval=true and o.aie_holder_approval=true and o.sad_approval=true AND  (miu_approval=true and approval_rejected='miu') UNION SELECT distinct o.date_due,o.code,o.item,o.item_strength,o.units, o.quantity, o.unit_price,o.net_value,chief_rejected_remark  Chief_Rejection,aie_rejected_remark Aie_Rejection,sad_rejected_remark Sad_Rejection,'not rejected at this stage' miu_rejection,null Remarks,false Activate  FROM st_orders o,st_item_to_quote q where o.order_no='" + lpo + "' and  q.tender_no='" + TenderTxt.getText() + "' and q.tender_no=o.quotation_no and o.item=q.item_description  and  o.approval_rejected='sad' and o.chief_approval=true and o.aie_holder_approval=true and o.sad_approval=true) ORDER BY 1  "));
            connectDB.commit();
            connectDB.setAutoCommit(true);

//            DICKSON WAMBUA KITEME 0334287
//
//0331628
//JOSEPH WACHIRA WANJOHI
    ...
    private void jTextField1CaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextField1CaretUpdate
        ...
        if (jTextField1.getCaretPosition() > 3) {
            ...
            ApprovalTbl.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB, "SELECT distinct order_no as LPO_LSO_NO,supplier as supplier_name from st_orders st where dispatch=false and ordered=false and chief_approval=true and aie_holder_approval=true and sad_approval=true  and miu_approval=false  and  (order_no ilike '%" + jTextField1.getText() + "%' OR  supplier ILIKE '%" + jTextField1.getText() + "%')  group by supplier,order_no  order by order_no "));
    ...
    private void miu_reject_tblMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_miu_reject_tblMouseClicked
        // TODO add your handling code here:
        Save.setText("Activate Item(s)");
    }//GEN-LAST:event_miu_reject_tblMouseClicked

    private void miu_reject_tblMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_miu_reject_tblMouseReleased
        // TODO add your handling code here:
    }//GEN-LAST:event_miu_reject_tblMouseReleased

    private void miu_reject_tblKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_miu_reject_tblKeyReleased
        // TODO add your handling code here:
    }//GEN-LAST:event_miu_reject_tblKeyReleased
    ...
    private javax.swing.JTable miu_reject_tbl;
    private javax.swing.JTable miu_tbl;
