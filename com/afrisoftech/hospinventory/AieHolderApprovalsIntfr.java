 ...
 */
public class AieHolderApprovalsIntfr extends javax.swing.JInternalFrame {
    ...
    public AieHolderApprovalsIntfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {
        ...
        aie_reject_tbl = new com.afrisoftech.dbadmin.JTable();
        ...
        */
        ...
        aie_reject_tbl.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null, null, null, null, null},
                {null, null, null, null, null, null, null, null},
                {null, null, null, null, null, null, null, null},
        ...
        aie_reject_tbl.setGridColor(new java.awt.Color(204, 204, 255));
        //this.procurementPlanTbl.getColumnModel().getColumn(i).setCellEditor(new javax.swing.DefaultCellEditor((javax.swing.JComboBox)new com.afrisoftech.lib.DatePicker()));
        aie_reject_tbl.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                aie_reject_tblMouseClicked(evt);
            }
            public void mouseReleased(java.awt.event.MouseEvent evt) {
                aie_reject_tblMouseReleased(evt);
            }
        });
        aie_reject_tbl.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                aie_reject_tblKeyReleased(evt);
            }
        });
        jScrollPane2.setViewportView(aie_reject_tbl);
            ...
            if (Save.getText().equals("Save")) {
                for (int k = 0; k < aie_tbl.getRowCount(); k++) {
                    if (aie_tbl.getValueAt(k, 0) != null) {
                        if (Boolean.valueOf(aie_tbl.getValueAt(k, 10).toString()) == java.lang.Boolean.TRUE) {

                            String comment;
                            if (aie_tbl.getValueAt(k, 9) == null) {
                                comment = "";
                            } else {
                                comment = aie_tbl.getValueAt(k, 9).toString();
                            }

                            java.sql.PreparedStatement pstmt81212 = connectDB.prepareStatement(""
                                    + "update st_orders set  aie_holder_approval=true, aie_holder='" + correct_name + "', aie_holder_date=now(), aie_holder_remark='" + comment + "' where dispatch=false and ordered=false and chief_approval=true and aie_holder_approval=false and sad_approval=false  and miu_approval=false  and approval_rejected is null and quotation_no='" + TenderTxt.getText() + "' and order_no='" + lpo + "' and item ='" + aie_tbl.getModel().getValueAt(k, 2).toString() + "' and code='" + aie_tbl.getModel().getValueAt(k, 1).toString() + "'");
                ...
                for (int j = 0; j < aie_reject_tbl.getRowCount(); j++) {
                    if (aie_reject_tbl.getValueAt(j, 0) != null) {
                        if (Boolean.valueOf(aie_reject_tbl.getValueAt(j, 10).toString()) == java.lang.Boolean.TRUE) {
...
//                }
                ...
                if (check_activation == true) {
                    ...
                    cancelbtn.doClick();
                    ClearTable.clearthisTable(aie_reject_tbl);
                    //ApprovalTbl.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"SELECT distinct order_no as LPO_LSO_NO,supplier as supplier_name from st_orders st where dispatch=false and ordered=false and chief_approval=true and aie_holder_approval=false and sad_approval=false  and miu_approval=false  group by supplier,order_no  order by order_no"));
                    refresh();
                    Save.setText("Save");
                } else {
            ...
            Logger.getLogger(AieHolderApprovalsIntfr.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            for (int k = 0; k < aie_tbl.getRowCount(); k++) {
                if (aie_tbl.getValueAt(k, 0) != null) {
                    if (Boolean.valueOf(aie_tbl.getModel().getValueAt(k, 10).toString()) == java.lang.Boolean.TRUE) {
...
//        }        // TODO add your handling code here:
    ...
    private void ApprovalTblMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_ApprovalTblMouseClicked
        try {
            ...
            aie_reject_tbl.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB, "SELECT distinct o.date_due,o.code,o.item,o.item_strength,o.units, o.quantity, o.unit_price,o.net_value,chief_rejected_remark  Chief_Rejection,null Remarks,false Activate  FROM st_orders o,st_item_to_quote q where o.order_no='" + lpo + "' and  q.tender_no='" + TenderTxt.getText() + "' and q.tender_no=o.quotation_no and o.item=q.item_description  and  o.approval_rejected='chief' and o.chief_approval=true and o.aie_holder_approval=false"));
            connectDB.commit();
            connectDB.setAutoCommit(true);

            //PopulatereceivedItems();
        } catch (SQLException ex) {
            Logger.getLogger(ChiefProcurementOfficerApprovalsIntfr.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void aie_reject_tblMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_aie_reject_tblMouseClicked
        // TODO add your handling code here:
        Save.setText("Activate Item(s)");

    }//GEN-LAST:event_aie_reject_tblMouseClicked

    private void aie_reject_tblMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_aie_reject_tblMouseReleased
        // TODO add your handling code here:
    }//GEN-LAST:event_aie_reject_tblMouseReleased

    private void aie_reject_tblKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_aie_reject_tblKeyReleased
        // TODO add your handling code here:
    }//GEN-LAST:event_aie_reject_tblKeyReleased
    ...
    private javax.swing.JTable aie_reject_tbl;
