 ...
 */
public class TechnicalGuyApprovalintfr1 extends javax.swing.JInternalFrame {
    ...
    public TechnicalGuyApprovalintfr1(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {
        ...
        setMaximizable(true);
        setResizable(true);
        setTitle("Technical Inspection/ Approval ");
        ...
        */
        ...
        grn2PayablesLinkingTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Date", "Delivey No", "Item", "Price/Item", "QTY", "Total Amt", "Approve", "Remarks", "Passed By"
            }
        ) {
            Class[] types = new Class [] {
                java.lang.Object.class, java.lang.Object.class, java.lang.Object.class, java.lang.Object.class, java.lang.Object.class, java.lang.Double.class, java.lang.Boolean.class, java.lang.Object.class, java.lang.Object.class
            };
    ...
    private void ApprovalTblMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_ApprovalTblMouseClicked
        try {
            ...
            Logger.getLogger(TechnicalGuyApprovalintfr1.class.getName()).log(Level.SEVERE, null, ex);
        }
        ...
        try {
            ...
            try {
                ...
                int k = 0;
                        ...
                        + " order_no as LPO_LSO_NO, delivery_note_no, invoice_no,item,store as receiving_store,supplies_name "
                        + " from st_stock_cardex where approved=false and supplies=true and (grn_no!='rejected' or grn_no is null) and chairperson=false and technical=false and invoice_no in "
                        + "(select invoice_no from st_stock_cardex where approved=false and (grn_no!='rejected' or grn_no is null) and supplies=true and chairperson=false and technical=false and"
                        + " order_no= '" +lpo+ "') and "
                        + "order_no= '" +lpo+ "' "
...
" approved=false and supplies=true and chairperson=false and (grn_no!='rejected' or grn_no is null) and technical=false and order_no='" + rsetSupplier.getObject(3) + "' "
                ...
                if(grn2PayablesLinkingTable.getValueAt(k, 7)==null ){
                    ...
                    comment=grn2PayablesLinkingTable.getValueAt(k, 7).toString();
                                                ...
                                                java.sql.PreparedStatement pstmt81212 = connectDB.prepareStatement(""
                                                        + "update st_stock_cardex set technical=true,technical_name='"+correct_name+"',technical_date=now(),technical_remarks='"+comment+"'  where approved=false and technical=false and supplies=true and chairperson=false and delivery_note_no='" + grn2PayablesLinkingTable.getValueAt(k, 1).toString() + "' and order_no='" + lpo + "' and item ='"+grn2PayablesLinkingTable.getValueAt(k, 2).toString()+"'");
            ...
            if (Boolean.valueOf(grn2PayablesLinkingTable.getModel().getValueAt(k, 6).toString()) == java.lang.Boolean.TRUE) { 
                ...
                if(grn2PayablesLinkingTable.getValueAt(k, 7)==null ){
                    ...
                    comment=grn2PayablesLinkingTable.getValueAt(k, 7).toString();
                                                ...
                                                java.sql.PreparedStatement pstmt81212 = connectDB.prepareStatement(""
                                                        + "update st_stock_cardex set technical=false,technical_name='"+user+"',technical_date=now(),technical_remarks='"+comment+"',grn_no='rejected'  where approved=false and technical=false and supplies=true and chairperson=false and delivery_note_no='" + grn2PayablesLinkingTable.getValueAt(k, 1).toString() + "' and order_no='" + lpo + "' and item ='"+grn2PayablesLinkingTable.getValueAt(k, 2).toString()+"'");
                                                //        java.sql.PreparedStatement pstmt8121 = connectDB.prepareStatement("UPDATE ac_ledger SET reconciled = true WHERE cheque_no ILIKE '" + grn2PayablesLinkingTable.getValueAt(i, 1).toString() + "' AND dealer ilike '" + supplierNameTxt.getText().toString() + "' and date = '" + grn2PayablesLinkingTable.getValueAt(i, 0).toString() + "' and transaction_no = '" + grn2PayablesLinkingTable.getValueAt(i, 4).toString() + "'");
