...
public class DetailedPrescPerPatNosPdf implements java.lang.Runnable {
    ...
    public void DetailedPrescPerPatNosPdf(java.sql.Connection connDb, java.util.Date begindate, java.util.Date endate, java.lang.String cashPoint, java.lang.String categ) {
                ...
                try {
                    ...
                    try {
                        ...
                        try {
                            ...
                            phrase = new Phrase("PRESCRIPTIONS PER CATEGORY [ NAMES EXEMPTED ]  - Period : "  +dateFormat.format(endDate11)+" - "+dateFormat.format(endDate1), pFontHeader);
    ...
    public java.lang.Object[] getListofActivities(java.lang.Object Cate) {
        ...
        try {
            ...
            java.sql.ResultSet rSet1 = stmt1.executeQuery("SELECT DISTINCT ph.patient_no FROM hp_pharmacy ph,st_stock_item st where date_prescribed BETWEEN '"+beginDate+"' AND '"+endDate+"'  AND ph.main_service ilike '"+CashPoint+"%' and ph.description ilike st.description and st.sub_cat_code ilike '"+Cate+"%' ORDER BY ph.patient_no");
