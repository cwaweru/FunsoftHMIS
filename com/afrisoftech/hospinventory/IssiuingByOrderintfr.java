...
public class IssiuingByOrderintfr extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        */
        ...
        jComboBox11.setModel(com.afrisoftech.lib.ComboBoxModel.ComboBoxModel(connectDB, "SELECT DISTINCT store_name from st_stores WHERE  patient_store = 'true' ORDER BY store_name"));
        ...
        jComboBox1.setModel(com.afrisoftech.lib.ComboBoxModel.ComboBoxModel(connectDB, "SELECT store_name FROM st_main_stores order by store_name"));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder("Click the button you are comfortable with"));
        ...
        jComboBox111.setModel(com.afrisoftech.lib.ComboBoxModel.ComboBoxModel(connectDB, "SELECT department_name FROM pb_departments ORDER BY department_name"));
 ...
 */
        ...
        try {
            ...
            try {
                ...
                if(datePicker11.getDate().before(periodFrom) || datePicker11.getDate().after(periodTo)){
                    ...
                    java.sql.Statement pst2 = connectDB.createStatement();
                    java.sql.ResultSet rs = pst2.executeQuery("select code,activity from pb_activity where activity_category ILIKE 'SG'");
                    while (rs.next()){
                        actCode = rs.getObject(1).toString();
                        Stock = rs.getObject(2).toString();
                    }
                    ...
                    java.sql.ResultSet rsw = pst2w.executeQuery("select current_user");
                    while (rsw.next()){
                        userName = rsw.getObject(1).toString();
                    }
                    ...
                    for (int i = 0; i< jTable11.getRowCount(); i++) {
                        ...
                        if (jTable11.getModel().getValueAt(i,4) != null){
                            ...
                            pstmt.setDouble(5,java.lang.Double.valueOf(jTable11.getValueAt(i,5).toString()));
                            pstmt.setDouble(6,java.lang.Double.valueOf(jTable11.getValueAt(i,4).toString()));
                            pstmt.setObject(7,jTable11.getValueAt(i,1));
                            pstmt.setObject(8,"");
                            pstmt.setObject(9,null);
                            pstmt.setString(10,null);
                            pstmt.setDouble(11,0.00);
                            pstmt.setDouble(12,java.lang.Double.valueOf(jTable11.getValueAt(i,3).toString()));
                            ...
                            pstmt.setString(16,"");
                            pstmt.setString(17,null);
                            pstmt.setDate(18,com.afrisoftech.lib.SQLDateFormat.getSQLDate(datePicker11.getDate()));
                            pstmt.setString(19,jComboBox111.getSelectedItem().toString());
                            pstmt.setString(20,"Issuing");
                            ...
                            pstmt2.setString(14,glType);
                            pstmt2.setString(15,"Issuing");
                            pstmt2.setDouble(16,java.lang.Double.valueOf(jTable11.getValueAt(i,5).toString()));
                            ...
                            pstmt1.setDouble(5,java.lang.Double.valueOf(jTable11.getValueAt(i,4).toString()));
                            pstmt1.setDouble(6,java.lang.Double.valueOf(jTable11.getValueAt(i,5).toString()));
    ...
    private void jTextField1111CaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextField1111CaretUpdate
        if(jTextField1111.getCaretPosition() > 2){
            jSearchTable1.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"select description,units,buying_price FROM st_stock_item WHERE description ILIKE '"+jTextField1111.getText()+"%' and department ilike '"+jTextField11.getText()+"%' ORDER BY description"));
    ...
    private void jTextField111CaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextField111CaretUpdate
        if(jTextField111.getCaretPosition() > 2){
            jSearchTable.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"select product,units,transfer_price FROM st_stock_prices WHERE product ILIKE '"+jTextField111.getText()+"%' AND department = '"+jComboBox11.getSelectedItem()+"' order by product"));
        ...
        */
        ...
        if (jTable1.getModel().getValueAt(jTable1.getSelectedRow(), 5) != null) {
            if (jTable1.getSelectedColumn() == jTable1.getSelectedColumn()) {
                ...
                jTable1.setValueAt(total, jTable1.getSelectedRow(), 7);
        ...
        if(datePicker1.getDate().before(periodFrom) || datePicker1.getDate().after(periodTo)){
            ...
            try {
                ...
                try {
                    ...
                    java.sql.Statement pst2 = connectDB.createStatement();
                    java.sql.ResultSet rs = pst2.executeQuery("select code,activity from pb_activity where activity_category = 'S'");
                    while (rs.next()){
                        actCode = rs.getObject(1).toString();
                        Stock = rs.getObject(2).toString();
                    }
                    
                    java.sql.Statement pst29 = connectDB.createStatement();
                    java.sql.ResultSet rs9 = pst29.executeQuery("select current_user");
                    while (rs9.next()){
                        userName = rs9.getObject(1).toString();
                    }
                    ...
                    for (int i = 0; i< jTable1.getRowCount(); i++) {
                        ...
                        if (jTable1.getModel().getValueAt(i,5) != null){
                            ...
                            if (Qty > 0){
                                ...
                                pstmt1.setDouble(3,0.00);
                                pstmt1.setDouble(5,java.lang.Double.valueOf(jTable1.getValueAt(i,6).toString()));
                                pstmt1.setDouble(6,java.lang.Double.valueOf(jTable1.getValueAt(i,7).toString()));
                                pstmt1.setDouble(7,0.00);
                                pstmt1.setString(8,transNo);
                                pstmt1.setString(9,"");
                                ...
                                pstmt11.setDouble(5,java.lang.Double.valueOf(jTable1.getValueAt(i,6).toString()));
                                pstmt11.setDouble(6,java.lang.Double.valueOf(jTable1.getValueAt(i,7).toString()));
