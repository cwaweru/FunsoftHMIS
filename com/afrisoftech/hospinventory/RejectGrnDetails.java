 ...
 * @author root
 */
public class RejectGrnDetails extends javax.swing.JInternalFrame {
    ...
    public RejectGrnDetails(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {
        ...
        dnoteDialog = new javax.swing.JDialog();
        ...
        lpoDialog = new javax.swing.JDialog();
        ...
        deliverdtxt = new javax.swing.JTextField();
        ...
        */
        ...
        dnoteDialog.setModal(true);
        dnoteDialog.setUndecorated(true);
        dnoteDialog.getContentPane().setLayout(new java.awt.GridBagLayout());
        ...
        */
        ...
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
        dnoteDialog.getContentPane().add(jSearchPanel2, gridBagConstraints);

        lpoDialog.setModal(true);
        lpoDialog.setUndecorated(true);
        lpoDialog.getContentPane().setLayout(new java.awt.GridBagLayout());
        ...
        */
        ...
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
        lpoDialog.getContentPane().add(jSearchPanel3, gridBagConstraints);
        ...
        */
        ...
        gridBagConstraints.weighty = 1.0;
        gridBagConstraints.insets = new java.awt.Insets(0, 0, 0, 10);
        jPanel1.add(deliverdtxt, gridBagConstraints);
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 4;
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
        ...
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
        jPanel41.add(dnotetxt, gridBagConstraints);
        ...
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
        jPanel1.add(rcvdTxt, gridBagConstraints);
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 4;
        gridBagConstraints.gridy = 4;
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
        ...
        gridBagConstraints.weighty = 1.0;
        gridBagConstraints.insets = new java.awt.Insets(0, 0, 0, 10);
        jPanel1.add(receivedtxt, gridBagConstraints);

        glcodetxt.setEditable(false);
        glcodetxt.setBackground(new java.awt.Color(255, 255, 255));
        glcodetxt.setMinimumSize(new java.awt.Dimension(0, 0));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 4;
        gridBagConstraints.gridy = 2;
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
        ...
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
        jPanel42.add(lpotxt, gridBagConstraints);
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Item", "Strength", "Unit Pack", "Qty", "Unit Price", "Disc %", "Disc. Total", "Vat %", "Vat Amt.", "Value", "Batch No.", "Exp. Date", "Item Code", "Reasons for Rejection"
            }
        ) {
            Class[] types = new Class [] {
                java.lang.Object.class, java.lang.Object.class, java.lang.Object.class, java.lang.Double.class, java.lang.Double.class, java.lang.Double.class, java.lang.Double.class, java.lang.Double.class, java.lang.Double.class, java.lang.Double.class, java.lang.Object.class, java.lang.Object.class, java.lang.Object.class, java.lang.Object.class
            };
            boolean[] canEdit = new boolean [] {
                false, false, false, true, false, true, false, false, false, false, false, true, false, true
            };
...
// TODO add your handling code here:
    ...
    private void jSearchTable2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jSearchTable2MouseClicked
        ...
        dnotetxt.setText(jSearchTable2.getValueAt(jSearchTable2.getSelectedRow(), 0).toString());
        dnoteDialog.dispose();
        try {
    ...
    private void jButton52ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton52ActionPerformed
        this.dnoteDialog.dispose();        // Add your handling code here:
    ...
    private void searchButtonClicked() {
        ...
        java.awt.Point point = this.dnotetxt.getLocationOnScreen();

        dnoteDialog.setSize(700, 200);

        dnoteDialog.setLocation(point);

        dnoteDialog.setVisible(true);
...
//        }
    ...
    private void resetbtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_resetbtnActionPerformed
        ...
        try {
            ...
            java.sql.ResultSet rs = pst2.executeQuery("select code,activity from pb_activity where code ilike '" + this.glcodetxt.getText() + "%'");
            while (rs.next()) {
...
//            policy.SthirteenPdf(connectDB, this.datePicker1.getDate().toLocaleString(), this.datePicker1.getDate().toLocaleString(), jTextField91.getText().toString(), this.deliveryNoteNumberTxt.getText().toString());
    ...
    private void postbtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_postbtnActionPerformed
        ...
        if((dnotetxt.getText().toString().isEmpty() || 
                        glcodetxt.getText().toString().isEmpty()||
                                deliverdtxt.getText().toString().isEmpty() ||
                                        receivedtxt.getText().toString().isEmpty() ||
                                                rcvdTxt.getText().toString().isEmpty()))
                ...
                try {
                    ...
                    for (int i = 0; i < jTable1.getRowCount(); i++) {
                        if (jTable1.getValueAt(i, 9) != null) {
                            ...
                            pstmt.setString(1, receivedtxt.getText());
                            ...
                            pstmt.setString(9, deliverdtxt.getText());
                            ...
                            pstmt.setString(14, "");
                            pstmt.setString(15, "");
                            pstmt.setObject(16, dnotetxt.getText());
                            pstmt.setString(17, rcvdTxt.getText());//StocktransNo);
                            pstmt.setDate(18, com.afrisoftech.lib.SQLDateFormat.getSQLDate(datePicker1.getDate()));
                            pstmt.setString(19, "");
                            pstmt.setString(20, "Receiving");
                            pstmt.setDouble(21, java.lang.Double.valueOf(jTable1.getValueAt(i, 9).toString()));
                            pstmt.setDouble(22, java.lang.Double.valueOf(jTable1.getValueAt(i, 6).toString()));
                            pstmt.setString(23, glcodetxt.getText());
                            if (rcvdTxt.getText().equals("")) {
                                ...
                                pstmt.setString(24, rcvdTxt.getText());
                            }
                            ...
                            pstmt11.setObject(13, dnotetxt.getText());
                            pstmt11.setObject(14, dnotetxt.getText());
                    ...
                    pstmt1q1.setString(4, dnotetxt.getText());
                    if (rcvdTxt.getText().equals("")) {
                        javax.swing.JOptionPane.showMessageDialog(this, "delivery Note NumberTxt Missing", "Error Message!", javax.swing.JOptionPane.ERROR_MESSAGE);
                    } else {

                        pstmt1q1.setString(6, rcvdTxt.getText());
                    }
                    ...
                    pstmt1q1.setString(13, deliverdtxt.getText());
                    ...
                    com.afrisoftech.hospinventory.mtrhreports.SthirteenPdf policy = new com.afrisoftech.hospinventory.mtrhreports.SthirteenPdf();
//            policy.SthirteenPdf(connectDB, this.datePicker1.getDate().toLocaleString(), this.datePicker1.getDate().toLocaleString(), dnotetxt.getText().toString(), this.rcvdTxt.getText().toString());
                 glcodetxt.setText("");
                   cancelbtn.doClick();
                    deliverdtxt.setText("");
                    jTextField2.setText("00");
             ...
             //   java.sql.ResultSet rs = pstmt.executeQuery("select glstock_code from st_stores  where store_name ilike '" + jComboBox2.getSelectedItem().toString() + "%'");
              java.sql.ResultSet rs = pstmt.executeQuery("select gl_stock_code  FROM st_main_stores "
                ...
                while (rs.next()) {
                    ...
                    this.glcodetxt.setText(rs.getObject(1).toString());
                }
            } catch (java.sql.SQLException sqlex) {
                System.out.println(sqlex.getMessage());
            }
    ...
    private void searchButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchButton1ActionPerformed
        ...
        lpoDialog.setSize(700, 200);

        lpoDialog.setLocation(point);

        lpoDialog.setVisible(true);
 ...
 if (jTextField113.getCaretPosition() < 1) {
            ...
            jSearchTable3.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB, ""
                    + " SELECT distinct order_no as LPO_LSO_NO,supplier as supplier_name from st_stock_cardex st where st.approved=FALSE "
                    + "and order_no ilike '%" + jTextField114.getText() + "%'  group by order_no,supplier  order by supplier_name"));
    ...
    private void jSearchTable3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jSearchTable3MouseClicked
           lpotxt.setText(jSearchTable3.getValueAt(jSearchTable3.getSelectedRow(), 0).toString());
        lpoDialog.dispose();
        try {
            java.sql.Statement pstmt = connectDB.createStatement();
    ...
    private javax.swing.JTextField deliverdtxt;
    private javax.swing.JDialog dnoteDialog;
    ...
    private javax.swing.JDialog lpoDialog;
