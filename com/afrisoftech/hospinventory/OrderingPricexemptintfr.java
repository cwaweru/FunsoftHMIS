...
public class OrderingPricexemptintfr extends javax.swing.JInternalFrame {
    ...
    private void jTextField111CaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextField111CaretUpdate
        if(this.jTextField111.getCaretPosition() < 3){
            ...
            jSearchTable.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"select description,units,item_code FROM st_stock_item WHERE description ILIKE '"+jTextField111.getText()+"%' order by description"));
   ...
   */
    ...
    private void postbtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_postbtnActionPerformed
        ...
        try {
            ...
            policy.UnpricedOrdersPdf(connectDB, jComboBox1.getSelectedItem().toString());
