 ...
 */
public class UserSetupInventoryHospitalIntfr extends javax.swing.JInternalFrame {

    java.sql.Connection connectDB = null;
    org.netbeans.lib.sql.pool.PooledConnectionSource pConnDB = null;

    public UserSetupInventoryHospitalIntfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {
        ...
        setMaximizable(true);
        setResizable(true);
        setTitle("User Access Control - STORES/INVENTORY");
        ...
        jList4.setModel(com.afrisoftech.lib.ListModel.listModel(connectDB, "SELECT item_desc FROM menu_item_list WHERE app_name = 'hospital_inventory' ORDER BY item_desc"));
        ...
        jList1.setModel(com.afrisoftech.lib.ListModel.listModel(connectDB, "SELECT item_desc FROM menu_item_list WHERE app_name = 'hospital_inventory' ORDER BY item_desc"));
    ...
    private void targetGroupCmbxActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_targetGroupCmbxActionPerformed
        ...
        try {
            ...
            java.sql.ResultSet rs = stmt.executeQuery("select menu_list from secure_menu_access_group where login_name = '" + targetGroupCmbx.getSelectedItem().toString() + "'  AND sys_name ilike 'hospital_inventory' ORDER BY menu_list");
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        ...
        try {
            ...
            java.sql.PreparedStatement pmstmt = connectDB.prepareStatement("UPDATE secure_menu_access_group SET menu_list = ? WHERE login_name = ? AND sys_name ilike 'hospital_inventory'");
            ...
            java.sql.PreparedStatement pmstmt1 = connectDB.prepareStatement("UPDATE secure_menu_access SET menu_list = ? WHERE group_name = ? AND sys_name ilike 'hospital_inventory'");
    ...
    private void registerNewGroupBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_registerNewGroupBtnActionPerformed
        ...
        if (this.newGroupNameTxt.getText().equals("")) {
            ...
            try {
                ...
                pstmt1.setObject(4, "");
                pstmt1.setObject(5, "");
                pstmt1.setObject(6, "hospital_inventory");
...
// TODO add your handling code here:
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        try {
            ...
            java.sql.PreparedStatement pstmt = connectDB.prepareStatement("UPDATE secure_menu_access SET menu_list = (SELECT menu_list FROM secure_menu_access WHERE login_name = ? AND sys_name = 'hospital_inventory') WHERE login_name = ? AND sys_name = 'hospital_inventory'");
...
/*
    ...
    private void accountNameCmbxActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_accountNameCmbxActionPerformed
        ...
        try {
            ...
            java.sql.ResultSet rs = stmt.executeQuery("select menu_list from secure_menu_access where login_name = '" + accountNameCmbx.getSelectedItem().toString() + "'  AND sys_name ilike 'hospital_inventory' ORDER BY menu_list");
...
//        str = "{"+str+"}";
        ...
        try {
            ...
            java.sql.Statement pstmt = connectDB.createStatement();
            java.sql.PreparedStatement pmstmt = connectDB.prepareStatement("UPDATE secure_menu_access SET menu_list = ? WHERE login_name = ? AND sys_name ilike 'hospital_inventory'");
...
//            pmstmt.setObject(1,"{"+str+"}");
                ...
                if (this.logonNameTxt.getText().equals("")) {
                    ...
                    try {
                      ...
                      //  connectDB.setAutoCommit(false);
                        ...
                        java.sql.ResultSet rs = stmt.executeQuery("SELECT menu_list from secure_menu_access_group WHERE login_name = '" + removeGroupCmbx2.getSelectedItem().toString() + "'  AND sys_name ilike 'hospital_inventory' ORDER BY menu_list");
                        ...
                        pstmt2.setObject(4, "hospital_inventory");
    ...
    private void jButton3012ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3012ActionPerformed
        ...
        try {
            ...
            java.sql.ResultSet rs = stmt.executeQuery("SELECT menu_list from secure_menu_access_group WHERE login_name = '" + jComboBox5.getSelectedItem().toString() + "'  AND sys_name ilike 'hospital_inventory' ORDER BY menu_list");
            ...
            java.sql.Statement pstmt = connectDB.createStatement();
            java.sql.PreparedStatement pmstmt = connectDB.prepareStatement("UPDATE secure_menu_access SET menu_list = ?, group_name = ?  WHERE login_name = ? AND sys_name ilike 'hospital_inventory'");
