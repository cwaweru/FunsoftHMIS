...
public class OrdersSummPerSectionPdf implements java.lang.Runnable {
    ...
    public void OrdersSummPerSectionPdf(java.sql.Connection connDb, java.util.Date begindate, java.util.Date endate,String section) {
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    com.lowagie.text.HeaderFooter footer = new com.lowagie.text.HeaderFooter(new Phrase("Orders(Summary) For "+sec+"  - Page: ", pFontHeader), true);// FontFactory.getFont(com.lowagie.text.FontFactory.HELVETICA, 12, Font.BOLDITALIC,java.awt.Color.blue));
                    ...
                    try {
                        ...
                        try {
                            ...
                            phrase = new Phrase("Orders Summary :     Period : From " + dateFormat.format(endDate11) + " To " + dateFormat.format(endDate1)+" For "+sec, pFontHeader);
                       ...
                       // Phrase phrase = new Phrase("Patients List As At:" +endDate, pFontHeader);
                        ...
                        try {
                            ...
                            java.sql.ResultSet rset = st.executeQuery("select distinct(order_no),date,upper(supplier),sum(net_value),date_due from st_orders WHERE date BETWEEN '" + beginDate + "' AND '" + endDate + "' and date IS NOT NULL AND order_no IS NOT NULL AND ordering_store ilike '"+sec+"' group by order_no,date,supplier,date_due ORDER BY date,order_no");
