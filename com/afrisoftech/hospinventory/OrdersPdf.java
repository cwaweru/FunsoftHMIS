                ...
                try {
                    ...
                    try {
                        ...
                        try {
                            ...
                            java.sql.PreparedStatement st321 = connectDB.prepareStatement("select INITCAP(header_name) from pb_header");
                    ...
                    try {
                        ...
                        try {
                            ...
                            table1.getDefaultCell().setBorder(Rectangle.LEFT | Rectangle.RIGHT);
                            while (rset4.next()) {
                                ...
                                while (rset2.next()) {
                                    ...
                                    table1.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                                    phrase = new Phrase("P.O. BOX : " + rset2.getString(3), pFontHeader31);
                                    table1.addCell(phrase);
                                    ...
                                    phrase = new Phrase("Date : " + rset4.getObject(2).toString(), pFontHeader31);
                                    table1.addCell(phrase);
                                    table1.getDefaultCell().setBorderColor(java.awt.Color.black);
                                    ...
                                    table1.getDefaultCell().setColspan(9);
                                    table1.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                                    phrase = new Phrase("Tel : " + rset2.getString(4), pFontHeader31);
                                    ...
                                    table1.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                                    phrase = new Phrase("Fax : " + rset2.getString(7), pFontHeader31);
                            ...
                            while (rset5.next()) {
                                table1.getDefaultCell().setColspan(9);
                                phrase = new Phrase("Please Supply the goods / services / works described below", pFontHeader31);
                                table1.addCell(phrase);

                                table1.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                                table1.getDefaultCell().setColspan(3);
                                phrase = new Phrase("On/Before: " + rset5.getObject(1).toString(), pFontHeader31);
                    ...
                    try {
                        ...
                        phrase = new Phrase("Unit Price ("+ks.toUpperCase()+")", pFontHeader);
                        table.addCell(phrase);
                        ...
                        phrase = new Phrase("Net Value ("+ks.toUpperCase()+")", pFontHeader);
                        table.addCell(phrase);
