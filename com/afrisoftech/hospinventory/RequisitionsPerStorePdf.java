...
public class RequisitionsPerStorePdf implements java.lang.Runnable {
    ...
    java.lang.String Store = null;
    java.lang.Runtime rtThreadSample = java.lang.Runtime.getRuntime();
    java.lang.Process prThread;

    public void RequisitionsPerStorePdf(java.sql.Connection connDb, java.util.Date begindate, java.util.Date endate, java.lang.String store) {
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    com.lowagie.text.HeaderFooter footer = new com.lowagie.text.HeaderFooter(new Phrase("Requisitioned Items Per Store list - Page: ", pFontHeader), true);// FontFactory.getFont(com.lowagie.text.FontFactory.HELVETICA, 12, Font.BOLDITALIC,java.awt.Color.blue));
                    ...
                    try {
                        ...
                        Phrase phrase = new Phrase("Requisitioned Items Per Store " + Store, pFontHeader1);
                        ...
                        try {
                            ...
                            java.sql.ResultSet rset = st.executeQuery("select ss.requisation::date,ss.item_description,ROUND(sum(ss.quantity)),initcap(ss.user_name),ss.cost_center,ss.status,sum(ss.price),sum(ss.price*quantity),ss.requisition_no FROM st_receive_requisation ss WHERE ss.requisation::date BETWEEN '" + beginDate + "' AND '" + endDate + "' AND store_name = '" + Store + "' GROUP BY ss.requisation,ss.item_description,initcap(ss.user_name),ss.status,ss.cost_center,ss.requisition_no ORDER BY ss.requisition_no");
