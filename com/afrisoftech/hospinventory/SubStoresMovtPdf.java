...
public class SubStoresMovtPdf implements java.lang.Runnable {
    ...
    java.lang.Process prThread;
     ...
     public void SubStoresMovtPdf(java.sql.Connection connDb,java.util.Date begindate, java.util.Date endate, java.lang.String store) {
            ...
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        int headerwidths[] = {5,35,12,12,12,12,12};
                        ...
                        try {
                            ...
                            phrase = new Phrase(StoreName+ " STOCK MOVEMENT REPORT:  PERIOD FROM "  +dateFormat.format(endDate11)+" TO "+dateFormat.format(endDate1), pFontHeader);
                        ...
                        try {
                            ...
                            for (int i = 0; i < listofAct.length; i++) {
                                ...
                                java.sql.ResultSet rset = st21.executeQuery("select SUM(issuing),SUM(receiving) from stock_movement_summary WHERE trans_date::date BETWEEN '"+beginDate+"' AND '"+endDate+"' AND item ILIKE '"+listofAct[i]+"' and store_name ilike  '"+StoreName+"' ");
                                
                                
                                java.sql.ResultSet rset2 = st3.executeQuery("select sum(receiving-issuing) from stock_movement_summary WHERE item ILIKE '"+listofAct[i]+"' AND trans_date < '"+beginDate+"' and store_name ilike  '"+StoreName+"'");
                                java.sql.ResultSet rset22 = st2.executeQuery("select transfer_price from st_stock_prices WHERE product ILIKE '"+listofAct[i]+"' and department ilike  '"+StoreName+"'");
                                ...
                                table.addCell(phrase);
                                phrase = new Phrase(new com.afrisoftech.sys.Format2Currency().Format2Currency(java.lang.String.valueOf(((opStock+receivings)-sales)*price)),pFontHeader1);
                                table.addCell(phrase);
                                
                                amount = amount + ((opStock+receivings)-sales)*price;
