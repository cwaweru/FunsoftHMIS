...
public class StockCategoryPdf implements java.lang.Runnable {
    ...
    com.lowagie.text.Font pFontHeader = FontFactory.getFont(FontFactory.HELVETICA, 10, Font.BOLD);
      com.lowagie.text.Font pFontHeader2 = FontFactory.getFont(FontFactory.HELVETICA, 10, Font.BOLDITALIC);
    ...
    public void generatePdf() {
      ...
      */
                    ...
                    try {
                        ...
                        int headerwidths[] = {10,10,50,15,15,};
                        ...
                        phrase = new Phrase("STOCK CATEGORIES LIST", pFontHeader);
                        ...
                        phrase = new Phrase(bank.toUpperCase()+" :", pFontHeader2);
                       ...
                       // table.getDefaultCell().setBorderColor(java.awt.Color.WHITE);
                        ...
                        try {
                            ...
                            java.sql.ResultSet rset = st.executeQuery("select item_code,upper(description) as description,strength, buying_price from st_stock_item WHERE sub_cat_code ilike '"+bank+"%'  order by description");// tn,debit_note db WHERE tn.policy_no != '' and tn.policy_no = db.policy_no GROUP BY tn.policy_no,db.policy_class");
