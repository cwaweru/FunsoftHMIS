            ...
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        int headerwidths[] = {35,12,12,12,12,17};
                        ...
                        try {
                            ...
                            for (int i = 0; i < listofAct.length; i++) {
                                ...
                                java.sql.ResultSet rset = st21.executeQuery("select SUM(issuing),SUM(receiving) from stock_movement_summary WHERE trans_date::date BETWEEN '"+beginDate+"' AND '"+endDate+"' AND item = '"+listofAct[i]+"'");
                                
                                
                                java.sql.ResultSet rset2 = st3.executeQuery("select sum(receiving-issuing) from stock_movement_summary WHERE item = '"+listofAct[i]+"' AND trans_date < '"+beginDate+"'");
                                java.sql.ResultSet rset22 = st2.executeQuery("select sum(buying_price/packaging) from st_stock_item WHERE description = '"+listofAct[i]+"'");
...
docPdf.close();  com.afrisoftech.lib.PDFRenderer.renderPDF(tempFile);
    ...
    public java.lang.Object[] getListofActivities() {
        ...
        try {
            ...
            java.sql.ResultSet rSet1 = stmt1.executeQuery("SELECT DISTINCT item as item FROM st_substore_item ORDER BY item");
