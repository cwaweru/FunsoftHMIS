...
public class TenderPreliminaryReportPDF implements java.lang.Runnable {
   ...
   // private String time=null;
    ...
    public void TenderPreliminaryReportPDF(java.sql.Connection connDb, java.lang.String tenderNo) {
      //  selectSupp = combox;
      //  Department = dept;
        OrderNo = tenderNo;
       // user = UserName;
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    com.lowagie.text.HeaderFooter footer = new com.lowagie.text.HeaderFooter(new Phrase(""+OrderNo+"   Tender Preliminary Report - Page: ", pFontHeader1), true);// FontFactory.getFont(com.lowagie.text.FontFactory.HELVETICA, 12, Font.BOLDITALIC,java.awt.Color.blue));
                    ...
                    try {
                        ...
                        try {
                            ...
                            java.sql.ResultSet rset4 = st4.executeQuery(" SELECT DISTINCT entered_on FROM st_preliminary_results WHERE quotation_no = '" + OrderNo + "' limit 1");// where supplier_name = 'Uchumi'member_no = '"+memNo+"'  AND date BETWEEN '"+beginDate+"' AND '"+endDate+"'");
...
//                                table2.addCell(phrase);
                                ...
                                table2.getDefaultCell().setColspan(10);
                                table2.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_CENTER);
                                phrase = new Phrase("PRELIMINARY EVALUATION RESULTS HELD ON  "+rset4.getDate(1), pFontHeader5);
                                table2.addCell(phrase);
...
//                           
                            ...
                            java.sql.ResultSet rset1 = st2.executeQuery("select  criteria,mark_awarded,remarks,total_mark  from st_preliminary_results where quotation_no ='"+OrderNo+"' and supplier_code  = '"+listofAct[i].toString()+"'");
...
//                            table3.addCell(phrase);
                            ...
                            ResultSet rsetotal = st.executeQuery("SELECT distinct total_mark FROM st_preliminary_results where quotation_no ='"+OrderNo+"' and supplier_code  = '"+listofAct[i].toString()+"'");
                            while(rsetotal.next()){
                    ...
                    try{
                        ...
                        try {
                            pst = connectDB.prepareStatement("select count(distinct supplier_code) from st_preliminary_results where quotation_no = '"+OrderNo+"' ");
                            pst2 = connectDB.prepareStatement("select count(distinct supplier_code) from st_preliminary_results where quotation_no = '"+OrderNo+"' and total_mark>99");
                            pst3 = connectDB.prepareStatement("select count(distinct supplier_code) from st_preliminary_results where quotation_no = '"+OrderNo+"' and total_mark<100");
                            ...
                            Logger.getLogger(TenderPreliminaryReportPDF.class.getName()).log(Level.SEVERE, null, ex);
                        }
...
//                            
    ...
    public java.lang.Object[] getListofActivities() {
        ...
        java.sql.ResultSet rSet1 = stmt1.executeQuery("select distinct supplier_code from st_preliminary_results where quotation_no  = '"+OrderNo+"'  order by 1");
       ...
       // System.out.println(OrderNo);
        ...
        javax.swing.JOptionPane.showMessageDialog(new javax.swing.JFrame(), sqlExec.getMessage()+"Contact System Administrator");
