...
public class DirectOrderingFuelintfr extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        */
        ...
        jComboBox1.setModel(com.afrisoftech.lib.ComboBoxModel.ComboBoxModel(connectDB, "SELECT supplier_name FROM st_suppliers ORDER BY supplier_name"));
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Description", "Units", "Qty", "Unit Price", "Value", "Mileage"
            }
        ) {
    ...
    private void jTextField111CaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextField111CaretUpdate
        if(this.jTextField111.getCaretPosition() < 3){
            ...
            jSearchTable.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"select description,units,buying_price as price FROM st_stock_item WHERE description ILIKE '"+jTextField111.getText()+"%' order by description"));
                ...
                while (rs1.next()){
                    ...
                    for (int i = 0; i< jTable1.getRowCount(); i++) {
                        ...
                        if (jTable1.getModel().getValueAt(i,0) != null){
                            ...
                            pstmt2.setDouble(4,java.lang.Double.valueOf(jTable1.getValueAt(i,2).toString()));
                            pstmt2.setDouble(5,java.lang.Double.valueOf(jTable1.getValueAt(i,3).toString()));
                            pstmt2.setDouble(6,java.lang.Double.valueOf(jTable1.getValueAt(i,4).toString()));
                            pstmt2.setDouble(7,0.00);
                            pstmt2.setDouble(8,0.00);
                            pstmt2.setDouble(9,0.00);
                            pstmt2.setDouble(10,java.lang.Double.valueOf(jTable1.getValueAt(i,4).toString()));
                            ...
                            pstmt2.setDouble(18,java.lang.Double.valueOf(jTable1.getValueAt(i,5).toString()));
