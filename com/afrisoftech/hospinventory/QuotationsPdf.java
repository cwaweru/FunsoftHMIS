...
public class QuotationsPdf implements java.lang.Runnable {
    ...
    public void QuotationsPdf(java.sql.Connection connDb, java.lang.String order) {
                  ...
                  /*  try {
                    ...
                    try {
                        ...
                        try {
                            ...
                            //  java.sql.Statement st3 = conDb.createStatement();
                            java.sql.Statement st3 = connectDB.createStatement();
                            java.sql.ResultSet rset3 = st3.executeQuery("SELECT DISTINCT quotation_no,quotation_date,openning_date,buyer_details,sub_item_desc FROM st_item_to_quote WHERE quotation_no = '" + OrderNo + "' LIMIT 1 ");
                            ...
                            java.sql.ResultSet rset4 = st4.executeQuery("SELECT item_number, item_code, item_description,units,quantity FROM st_item_to_quote WHERE quotation_no = '" + OrderNo + "' ");// where supplier_name = 'Uchumi'member_no = '"+memNo+"'  AND date BETWEEN '"+beginDate+"' AND '"+endDate+"'");
