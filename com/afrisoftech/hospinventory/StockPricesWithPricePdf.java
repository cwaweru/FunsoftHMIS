...
public class StockPricesWithPricePdf implements java.lang.Runnable {
    ...
    public void StockPricesWithPricePdf(java.sql.Connection connDb, java.lang.String combox) {
        bank = combox;
        connectDB = connDb;
        // beginDate = begindate;
        // endDate = endate;
                    ...
                    try {
                        ...
                        try {
                            ...
                            for (int i = 0; i < listofAct.length; i++) {
                                ...
                                java.sql.ResultSet rset1 = st2.executeQuery("SELECT product_id,initcap(product),strength,transfer_price, selling_price from st_stock_prices where department ilike '" + bank + "' AND category = '" + listofAct[i].toString() + "' order by product");
...
docPdf.close();  com.afrisoftech.lib.PDFRenderer.renderPDF(tempFile);
    ...
    public java.lang.Object[] getListofActivities() {
        ...
        try {
            ...
            java.sql.ResultSet rSet1 = stmt1.executeQuery("SELECT DISTINCT category FROM st_stock_prices where department ilike '" + bank + "' order by category");
