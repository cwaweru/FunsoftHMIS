 ...
 */
public class StockBalPerCategoryTxt implements java.lang.Runnable {
    ...
    public StockBalPerCategoryTxt(java.sql.Connection connDb, java.util.Date endate, java.lang.String cbox, java.lang.String cashPoint) {
    ...
    public java.lang.Object[] getListofActivities() {
        ...
        try {
            ...
            java.sql.ResultSet rSet1 = stmt1.executeQuery("SELECT DISTINCT item FROM stock_movement_summary,st_stock_item  WHERE store_name ilike '"+CBox+"' AND item = st_stock_item.description AND st_stock_item.sub_cat_code = '"+CashPoint+"' AND trans_date <= '"+endDate+"' order by item");
