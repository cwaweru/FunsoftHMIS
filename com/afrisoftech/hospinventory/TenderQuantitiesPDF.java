...
public class TenderQuantitiesPDF implements java.lang.Runnable {
 com.afrisoftech.lib.DBObject DBObject = new com.afrisoftech.lib.DBObject();
   ...
   // private String time=null;
    ...
    public void QuantitiesPerTender(java.sql.Connection connDb, java.lang.String tenderNo) {
      //  selectSupp = combox;
      //  Department = dept;
        OrderNo = tenderNo;
       // user = UserName;
...
//                            }
                           ...
                           // while (rset4.next()) {
                                ...
                                table2.getDefaultCell().setColspan(10);
                                table2.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_CENTER);
                                phrase = new Phrase("TENDER AWARDED QUANTITIES WITH UNIT COSTS PER ITEM FOR TENDER "+OrderNo+"  "+com.afrisoftech.lib.GetItemInfo.getITenderDesc(OrderNo, connectDB).toUpperCase(), pFontHeader5);
...
//                        table3.addCell(phrase);
                        ...
                        phrase = new Phrase("Unit_Cost", pFontHeader);
                        table3.addCell(phrase);
                        //4
                        table3.getDefaultCell().setColspan(2);
                        phrase = new Phrase("Total_Cost", pFontHeader);
                        table3.addCell(phrase);
...
//                         
                          ...
                          //item,quantity,unit_price,total
                            java.sql.ResultSet rset1 = st2.executeQuery("select  item,quantity,unit_price,(unit_price*quantity),SUM(unit_price*quantity),units FROM st_orders where quotation_no ='"+OrderNo+"'  and supplier ilike '"+listofAct[i].toString()+"' and order_no is null group by 1,2,3,6 order by 1");

                          
                           cnt=0; 
                            while (rset1.next()) {
                               System.out.println("select  item,quantity,unit_price,(unit_price*quantity),SUM(unit_price*quantity),units FROM st_orders where quotation_no ='"+OrderNo+"'  and supplier = '"+listofAct[i].toString()+"' and quantity>0  group by 1,2,3,6 order by 1");
                                cnt+=1 ;
...
//                                phrase = new Phrase("Total Awarded Value ", pFontHeadertableTitle);
//                                table3.addCell(phrase);
//                                
//                                table3.getDefaultCell().setColspan(4);
            ...
            docPdf.add(table3);
                    ...
                    try{
                        ...
                        try {                     
                            ...
                            Logger.getLogger(TenderQuantitiesPDF.class.getName()).log(Level.SEVERE, null, ex);
                        }
...
//                            table4.addCell(phrase); 
    ...
    public java.lang.Object[] getListofActivities() {
        ...
        java.sql.ResultSet rSet1 = stmt1.executeQuery("select distinct supplier from st_orders  WHERE  quotation_no  = '"+OrderNo+"' AND order_no IS  NULL order by 1 ");
