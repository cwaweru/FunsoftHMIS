 ...
 * @author  root
 */
public class PosBillingIntfr extends javax.swing.JInternalFrame {
    ...
    public static java.lang.String shift_no = null;
    public static java.lang.String cashPoint = null;
    public static java.lang.String cash_no = null;
    public static String transNo = null;
    private boolean DirectRev;

    public PosBillingIntfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
        ...
        */
        ...
        //try {
            ...
            jTable13.setModel(new javax.swing.table.DefaultTableModel(
                ...
                new String [] {
                    "Code", "Drugs", "Strength", "Qty", "Avl Qty", "Price", "Disc", "Total", "Gl Account"
                }
            ) {
            ...
            */
            ...
            jComboBox3.setModel(com.afrisoftech.lib.ComboBoxModel.ComboBoxModel(connectDB, "select distinct  store_name as name from st_stores  where store_code ilike '%p%' order by store_name DESC"));
            gridBagConstraints = new java.awt.GridBagConstraints();
            gridBagConstraints.gridx = 1;
            gridBagConstraints.gridy = 3;
            gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
    ...
    private void jButton122ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton122ActionPerformed
        ...
        try {
            ...
            if (this.jComboBox1.getSelectedItem().toString().equalsIgnoreCase("Scheme")) {
                ...
                com.afrisoftech.txtreports.PharReceiptsTxt policy = new com.afrisoftech.txtreports.PharReceiptsTxt(connectDB, jTextField92.getText(), jTextField13.getText(), jTextField15.getText(), prescNo, jComboBox1.getSelectedItem().toString());
...
// Add your handling code here:
    ...
    private void jButton12ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton12ActionPerformed
        ...
        try {
            ...
            java.sql.ResultSet rsetfa = stmtfa.executeQuery("SELECT current_date::date");
            while (rsetfa.next()) {
        ...
        if (datePicker1.getDate().before(periodFrom) || datePicker1.getDate().after(periodTo)) {
            ...
            if (datePicker1.getDate().before(toDaysDate) || datePicker1.getDate().after(toDaysDate)) {
                saveOption = javax.swing.JOptionPane.showConfirmDialog(this, "Do you want to save without changing the date \n because its not today's date ?".toUpperCase(), "Caution on dates", javax.swing.JOptionPane.YES_NO_OPTION, javax.swing.JOptionPane.QUESTION_MESSAGE);
            }
            if (saveOption == javax.swing.JOptionPane.YES_OPTION || datePicker1.getDate().equals(toDaysDate)) {
                ...
                String intInvoice = null;
                String intReceipt = null;
                ...
                if (exitOption == javax.swing.JOptionPane.YES_OPTION) {
                    ...
                    try {
                        ...
                        while (rst11Y.next()) {
                            ...
                            userName = rst11Y.getObject(1).toString();
                        }
                        ...
                        if (jCheckBox3.isSelected()) {
                            ...
                            if (this.datePicker1.getDate().before(admDate)) {
                                ...
                                for (int i = 0; i < jTable13.getRowCount(); i++) {
                                    if (jTable13.getModel().getValueAt(i, 0) != null) {
                                        ...
                                        java.sql.ResultSet rs11c = pst21c.executeQuery("select cost_of_sale,stock_code from pb_departments where income_account = '" + jTable13.getValueAt(i, 8).toString() + "'");
                                        while (rs11c.next()) {
                                        ...
                                        if (Total > presc) {
                                            amount1 = java.lang.Double.parseDouble(jTable13.getValueAt(i, 7).toString());
                                        ...
                                        java.sql.ResultSet rsB = pstB.executeQuery("select transfer_price,units from stockprices where product_id = '" + jTable13.getModel().getValueAt(i, 0) + "'");
                                        ...
                                        qty = java.lang.Double.parseDouble(jTable13.getValueAt(i, 3).toString());
                                        sellPrice = java.lang.Double.parseDouble(jTable13.getValueAt(i, 5).toString());
                                        amount = price * qty;
                                        if (amount > 10000) {
                                        ...
                                        pstmt.setObject(2, jTable13.getValueAt(i, 1).toString() + " " + jTable13.getValueAt(i, 2).toString());
                                        ...
                                        pstmt.setString(16, jComboBox3.getSelectedItem().toString());
                                        ...
                                        pstmt2.setObject(1, jTable13.getModel().getValueAt(i, 8));
                                        ...
                                        pstmt2.setString(12, "");
                                        pstmt2.setString(13, "");
                                        pstmt2.setString(14, jTable13.getValueAt(i, 0).toString() + " " + jTable13.getValueAt(i, 2).toString());
                                        ...
                                        pstmt1.setDouble(3, qty);
                                        pstmt1.setDouble(4, TotalPrice);
                                        pstmt1.setObject(5, jTable13.getValueAt(i, 1).toString() + " " + jTable13.getValueAt(i, 8).toString());
                                        pstmt1.setDouble(7, java.lang.Double.valueOf(jTable13.getValueAt(i, 5).toString()));
                                        pstmt1.setObject(8, jTable13.getValueAt(i, 8).toString());
                                        ...
                                        pstmt1.setString(14, jComboBox3.getSelectedItem().toString());
                                        ...
                                        pstmt1a.setObject(3, jTable13.getValueAt(i, 1));
                                        pstmt1a.setString(2, jComboBox3.getSelectedItem().toString());
                                        ...
                                        pstmt1a.setString(19, jComboBox3.getSelectedItem().toString());
                                        ...
                                        pstmt1a.setString(25, jComboBox3.getSelectedItem().toString());
                                        ...
                                        pstmt1a.setString(32, jTable13.getValueAt(i, 0).toString());
                                        pstmt1a.setString(33, jTable13.getValueAt(i, 2).toString());
                                        ...
                                        pstmt2a.setString(14, jTable13.getValueAt(i, 1).toString() + " " + jTable13.getValueAt(i, 2).toString());
                                        ...
                                        pstmt33.setObject(2, jTable13.getValueAt(i, 1).toString());
                                        pstmt33.setDouble(3, 0.00);
                                        pstmt33.setDouble(4, qty);
                                        pstmt33.setDouble(5, java.lang.Double.valueOf(jTable13.getValueAt(i, 5).toString()));
                                        ...
                                        pstmt33.setString(13, jComboBox3.getSelectedItem().toString());
                                        pstmt33.setString(14, jTextField92.getText() + " " + jTextField13.getText());
                                        pstmt33.setDouble(15, amount / java.lang.Double.valueOf(jTable13.getValueAt(i, 3).toString()));
                                        pstmt33.setObject(17, jTable13.getValueAt(i, 2).toString());
                                        pstmt33.setObject(16, jTable13.getValueAt(i, 0).toString());
                                ...
                                if (discounte > 0) {
                                    ...
                                    pstmtu.setString(16, jComboBox3.getSelectedItem().toString());
                                    ...
                                    pstmt2v.setDouble(16, java.lang.Double.valueOf(jTextField1.getText()));
                                    ...
                                    pstmt1pz.setBoolean(11, true);
                                    pstmt1pz.setString(12, discglAcc);
                                    pstmt1pz.setDate(13, com.afrisoftech.lib.SQLDateFormat.getSQLDate(datePicker1.getDate()));
                                    pstmt1pz.setString(14, jComboBox3.getSelectedItem().toString());
                                    ...
                                    pstmt1pz.setString(20, jTextField93.getText());
                                    pstmt1pz.setObject(21, "");
                                    pstmt1pz.setObject(22, "");
                            ...
                            for (int i = 0; i < jTable13.getRowCount(); i++) {
                                if (jTable13.getModel().getValueAt(i, 0) != null) {
                                    ...
                                    java.sql.Statement pstB = connectDB.createStatement();
                                    java.sql.ResultSet rsB = pstB.executeQuery("select transfer_price,units from st_stock_prices where product_id = '" + jTable13.getModel().getValueAt(i, 0) + "'");

                                    while (rsB.next()) {
                                        price = rsB.getDouble(1);
                                        glAcc2 = rsB.getObject(1).toString();
                                    }
                                    // units = rsB.getString(2);
                                    qty = java.lang.Double.parseDouble(jTable13.getValueAt(i, 3).toString());
                                    sellPrice = java.lang.Double.parseDouble(jTable13.getValueAt(i, 5).toString());
                                    ...
                                    if (this.jComboBox1.getSelectedItem().toString().equalsIgnoreCase("Scheme")) {
                                        ...
                                        invoiceNo = com.afrisoftech.lib.DateLables.getDateLabel();
                                        ...
                                        if (this.jCheckBox2.isSelected() && jTextField92.getText() == "") {
                                        ...
                                        pstmt2.setString(12, "");
                                        pstmt2.setString(13, "");
                                        pstmt2.setString(14, jTable13.getValueAt(i, 1).toString() + " " + jTable13.getValueAt(i, 2).toString());
                                        pstmt2.setString(15, "Revenue");
                                        pstmt2.setDouble(16, 0.00);
                                        pstmt2.setDouble(17, TotalPrice);
                                        // pstmt2.setObject(17,jTable13.getValueAt(i,5).toString());
                                        ...
                                        pstmt212.setObject(1, jTable13.getValueAt(i, 8).toString());
                                        pstmt212.setString(2, jComboBox3.getSelectedItem().toString());
                                        pstmt212.setString(3, jTextField92.getText());
                                        if (jTextField1.getText().equals("")) {
                                            pstmt212.setString(4, jTextField13.getText());
                                        } else {
                                            pstmt212.setString(4, jTextField13.getText());
                                        }
                                        ...
                                        pstmt212.setString(14, jTable13.getValueAt(i, 1).toString() + " " + jTable13.getValueAt(i, 2).toString());
                                        pstmt212.setString(15, "Revenue");
                                        pstmt212.setDouble(16, 0.00);
                                        pstmt212.setDouble(17, java.lang.Double.valueOf(jTable13.getValueAt(i, 7).toString()));
                                        ...
                                        pstmt25.setObject(1, jTable13.getValueAt(i, 8).toString());
                                        pstmt25.setObject(2, jTable13.getValueAt(i, 1).toString() + " " + jTable13.getValueAt(i, 2).toString());
                                        pstmt25.setString(3, jTextField92.getText());
                                        pstmt25.setString(4, jTextField13.getText());
                                        ...
                                        pstmt25.setString(14, jTextField92.getText());
                                        pstmt25.setString(15, "Receipts");
                                        pstmt25.setDouble(16, java.lang.Double.valueOf(jTable13.getValueAt(i, 7).toString()));
                                        ...
                                        pstmt25.setDouble(27, java.lang.Double.valueOf(jTable13.getValueAt(i, 3).toString()));
                                    ...
                                    pstmt33.setDouble(4, java.lang.Double.valueOf(jTable13.getValueAt(i, 3).toString()));
                                    pstmt33.setDouble(5, java.lang.Double.valueOf(jTable13.getValueAt(i, 5).toString()));
                                    pstmt33.setDouble(6, TotalPrice);
                                    ...
                                    double quantity = Double.parseDouble(jTable13.getModel().getValueAt(i, 3).toString());
                                    ...
                                    pstmt1.setDouble(4, TotalPrice);
                                    //  pstmt1.setObject(4,jTable13.getValueAt(i,5).toString());
                                    pstmt1.setObject(5, jTable13.getValueAt(i, 1).toString() + " " + jTable13.getValueAt(i, 2).toString());
                                    pstmt1.setDouble(7, java.lang.Double.valueOf(jTable13.getValueAt(i, 7).toString()));
                                    pstmt1.setObject(8, jTable13.getValueAt(i, 8).toString());
                            ...
                            if (discounte > 0) {
                                if (this.jComboBox1.getSelectedItem().toString().equalsIgnoreCase("Scheme")) {
                                    ...
                                    pstmtb.setDouble(12, 0.00);
                                    pstmtb.setDate(14, com.afrisoftech.lib.SQLDateFormat.getSQLDate(datePicker1.getDate()));
                                    pstmtb.setObject(15, patientAcc);
                                    pstmtb.setString(16, jComboBox3.getSelectedItem().toString());
                                    pstmtb.setDouble(17, 1);
                                    ...
                                    pstmtb.setTimestamp(27, new java.sql.Timestamp(java.util.Calendar.getInstance().getTimeInMillis()));
                                    pstmtb.setString(28, visitid);
                                    pstmtb.executeUpdate();
                                } else {

                                    java.sql.PreparedStatement pstmt25 = connectDB.prepareStatement("insert into ac_cash_collection values(?,?,?,?,?,?,?,?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?,?,?,?,?)");
                                    pstmt25.setObject(1, discode);
                                    pstmt25.setObject(2, "Discount");
                                    pstmt25.setString(3, jTextField92.getText());
                                    pstmt25.setString(4, jTextField13.getText());
                                    pstmt25.setString(5, "Cash");
                                    pstmt25.setString(6, "");
                                    ...
                                    pstmt25.setString(17, jTextField1.getText());
                                    pstmt25.setDate(18, com.afrisoftech.lib.SQLDateFormat.getSQLDate(datePicker1.getDate()));
                                    pstmt25.setString(19, transNo);
                                    pstmt25.setBoolean(20, false);
                                    pstmt25.setBoolean(21, false);
                            ...
                            if (this.jComboBox1.getSelectedItem().toString().equalsIgnoreCase("Scheme")) {
                                ...
                                java.sql.ResultSet rsts1x = pss11x.executeQuery("select account_no from ac_schemes where scheme_name = '" + jTextField14.getText() + "'");
                                while (rsts1x.next()) {
                                ...
                                pstmt1.setObject(11, jComboBox2.getSelectedItem());
                                ...
                                while (rss1.next()) {
                                    intInvoice = rss1.getObject(1).toString();
                                }
                                java.sql.PreparedStatement pstmt112f = connectDB.prepareStatement("UPDATE ac_debtors SET invoice_no = '" + intInvoice + "' WHERE invoice_no = '" + invoiceNo + "'");
                                pstmt112f.executeUpdate();
                                java.sql.PreparedStatement pstmt112g = connectDB.prepareStatement("UPDATE hp_patient_card SET invoice_no = '" + intInvoice + "' WHERE invoice_no = '" + invoiceNo + "'");
                                pstmt112g.executeUpdate();
                                javax.swing.JOptionPane.showMessageDialog(this, "Insert Done Successfully " + intInvoice, "Confirmation Message", javax.swing.JOptionPane.INFORMATION_MESSAGE);

                            } else {
                                if (jTextField93.getText().equalsIgnoreCase("-") || jTextField93.getText().equalsIgnoreCase("")) {
                                    java.sql.Statement ps1 = connectDB.createStatement();
                                    java.sql.ResultSet rst1 = ps1.executeQuery("select nextval('receipt_no_seq')");
                                    while (rst1.next()) {
                                        intReceipt = rst1.getObject(1).toString();
                                    }
                                } else {
                                    intReceipt = jTextField93.getText();
                                }
                                java.sql.PreparedStatement pstmt112a = connectDB.prepareStatement("UPDATE ac_cash_collection SET receipt_no = '" + intReceipt + "' WHERE receipt_no = '" + receiptNo1 + "'");
                                pstmt112a.executeUpdate();
                                java.sql.PreparedStatement pstn = connectDB.prepareStatement("UPDATE ac_ledger SET receipt_no = '" + intReceipt + "' WHERE receipt_no = '" + receiptNo1 + "'");
                                pstn.executeUpdate();
                                javax.swing.JOptionPane.showMessageDialog(this, "Insert Done Successfully " + intReceipt, "Confirmation Message", javax.swing.JOptionPane.INFORMATION_MESSAGE);
    ...
    private void jTable13KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTable13KeyReleased
        boolean neg = false;
        if (jTable13.getModel().getValueAt(jTable13.getSelectedRow(), 4) != null) {
            if (jTable13.getSelectedColumn() == jTable13.getSelectedColumn()) {
                ...
                if (jTable13.getModel().getValueAt(jTable13.getSelectedRow(), 3) != null) {
                    if (jTable13.getSelectedColumn() == jTable13.getSelectedColumn()) {

                        float bal = java.lang.Float.parseFloat(jTable13.getValueAt(jTable13.getSelectedRow(), 4).toString());
                        float qty = java.lang.Float.parseFloat(jTable13.getValueAt(jTable13.getSelectedRow(), 3).toString());
                        float price = java.lang.Float.parseFloat(jTable13.getValueAt(jTable13.getSelectedRow(), 5).toString());
                       float disc = java.lang.Float.parseFloat(jTable13.getValueAt(jTable13.getSelectedRow(), 6).toString());
                        if (neg == false && bal >= qty) {
                            float total = qty * price;
                            jTable13.setValueAt(total-disc, jTable13.getSelectedRow(), 7);
                            double totalSum = com.afrisoftech.lib.TableColumnTotal.getTableColumnTotal(jTable13, 7);
                            // jTextField10.setText(com.afrisoftech.lib.CurrencyFormatter.getFormattedDouble(totalSum));
                            ...
                            if (neg == false && bal < qty) {
                                ...
                                jTable13.setValueAt(0, jTable13.getSelectedRow(), 7);
                                jTable13.setValueAt(0, jTable13.getSelectedRow(), 3);
    ...
    private void jTextField114CaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextField114CaretUpdate
        if (jTextField114.getCaretPosition() > 0) {
            jSearchTable3.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB, "SELECT product_id,product, strength,round(selling_price, 0) as selling_price, gl_code FROM stockprices WHERE product ILIKE '%" + jTextField114.getText() + "%' AND department =  '" + jComboBox3.getSelectedItem().toString() + "' order by product"));

            /* try {
            searchRowSet3.execute("select product,selling_price,gl_code FROM st_stock_prices WHERE product ILIKE '"+jTextField114.getText()+"%' AND department =  '"+jComboBox3.getSelectedItem().toString()+"' order by product");
    ...
    private void jSearchTable3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jSearchTable3MouseClicked
        ...
        jTable13.setValueAt(jSearchTable3.getValueAt(jSearchTable3.getSelectedRow(), 1), jTable13.getSelectedRow(), 1);
        jTable13.setValueAt(jSearchTable3.getValueAt(jSearchTable3.getSelectedRow(), 2), jTable13.getSelectedRow(), 2);
        jTable13.setValueAt(jSearchTable3.getValueAt(jSearchTable3.getSelectedRow(), 3), jTable13.getSelectedRow(), 5);
        jTable13.setValueAt(jSearchTable3.getValueAt(jSearchTable3.getSelectedRow(), 4), jTable13.getSelectedRow(), 8);
        jTable13.setValueAt(new java.lang.Double(0), jTable13.getSelectedRow(), 6);
        ...
        try {
            ...
            java.sql.ResultSet rs1 = pstmt1.executeQuery("select count(item_code) from stock_balance_qty sc where item_code = '" + jSearchTable3.getValueAt(jSearchTable3.getSelectedRow(), 0) + "' and department = '" + jComboBox3.getSelectedItem().toString() + "' AND dates <= '" + datePicker1.getDate() + "'");
            while (rs1.next()) {
                j = rs1.getInt(1);
            }
            if (j > 0) {

                java.sql.ResultSet rs = pstmt.executeQuery("select sum(qty) from stock_balance_qty where item_code = '" + jSearchTable3.getValueAt(jSearchTable3.getSelectedRow(), 0) + "' and department ilike '" + jComboBox3.getSelectedItem().toString() + "%' AND dates <= '" + datePicker1.getDate() + "'");
                while (rs.next()) {

                    Qty = rs.getDouble(1);
                    //  jTable1.setValueAt(Qty,jTable1.getSelectedRow(),2);
                    jTable13.setValueAt(Qty, jTable13.getSelectedRow(), 4);

                }
            } else {
                jTable13.setValueAt("0.00", jTable13.getSelectedRow(), 4);
            }
        } catch (java.sql.SQLException sqlex) {
            System.out.println(sqlex.getMessage());
        }
...
// Add your handling code here:
    ...
    private void jCheckBox3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jCheckBox3ActionPerformed
        ...
        try {
            ...
            while (rs.next()) {
                jComboBox3.setSelectedItem(rs.getObject(1).toString());
...
/*        java.awt.Point point = this.jTextField91.getLocationOnScreen();
    ...
    private void jCheckBox2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jCheckBox2ActionPerformed
        ...
        this.jTextField22.setText("General");
        ...
        try {
            ...
            if (j > 0) {
                ...
                while (rsetTable1.next()) {
                    ...
                    java.sql.ResultSet rsetTable111 = stmtTable111.executeQuery("select sum(receiving-issuing) from st_sub_stores where item = '" + jTable13.getValueAt(i, 0).toString() + "' AND store_name ilike '" + jComboBox3.getSelectedItem().toString() + "%'");
                    while (rsetTable111.next()) {
