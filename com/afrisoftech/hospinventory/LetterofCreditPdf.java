...
public class LetterofCreditPdf implements java.lang.Runnable {
    ...
    public void LetterofCreditPdf(java.sql.Connection connDb, java.lang.String combox, java.lang.String order) {
                ...
                try {
                    ...
                    try {
                        ...
                        try {
                            ...
                            java.sql.ResultSet rset5 = st5.executeQuery("SELECT Hospital_name,rep_currency from pb_hospitalprofile");// where supplier_name = 'Uchumi'member_no = '"+memNo+"'  AND date BETWEEN '"+beginDate+"' AND '"+endDate+"'");
                            ...
                            table1.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                            phrase = new Phrase("SUPPLIER ORDER FORM \n FOR GOODS/WORKS/SERVICE IMPREST", pFontHeader);
                            table1.addCell(phrase);
                            table1.getDefaultCell().setBorderColor(java.awt.Color.white);
                            ...
                            while (rset4.next()) {
                                ...
                                while (rset2.next()) {
                                    ...
                                    table1.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                                    phrase = new Phrase("TO THE : " + rset2.getObject(1).toString(), pFontHeader);
                                    table1.addCell(phrase);
                            ...
                            while (rset5.next()) {
                                table1.getDefaultCell().setColspan(9);
                                phrase = new Phrase("The following goods/services/works/imprest (for purchase of goods and service) are required. \n Please deliver the goods below to " + rset5.getString(1) + " immediately. LPO is to follow.", pFontHeader);
                                table1.addCell(phrase);
                    ...
                    try {
                        ...
                        int headerwidths[] = {7, 40, 10, 15, 20};
                        ...
                        try {
                            ...
                            table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                            phrase = new Phrase("Requisitioning officer / User : ", pFontHeader2);
                            ...
                            table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                            phrase = new Phrase("Sign: ___________________", pFontHeader2);

                            table.addCell(phrase);

                            phrase = new Phrase("Date: ___________________", pFontHeader2);
                            ...
                            table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                            phrase = new Phrase("Requisition No assigned", pFontHeader2);
                            ...
                            table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                            phrase = new Phrase("Date Received", pFontHeader2);
                            ...
                            table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                            phrase = new Phrase("Tender Committee approval", pFontHeader);
                            ...
                            table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                            phrase = new Phrase("Procurement procedure spplied", pFontHeader2);
                            ...
                            table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                            phrase = new Phrase("Chairperson's Sign", pFontHeader2);
                            ...
                            table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                            phrase = new Phrase("Remark", pFontHeader2);
                            ...
                            table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                            phrase = new Phrase("Tender / Quotation Ref No :", pFontHeader2);
                            ...
                            phrase = new Phrase("Approved / Not Approved By AIE Holder", pFontHeader);

                            table.addCell(phrase);

                            phrase = new Phrase("Account to be charged", pFontHeader2);

                            table.addCell(phrase);

                            phrase = new Phrase("Sign", pFontHeader2);

                            table.addCell(phrase);

                            phrase = new Phrase("Date", pFontHeader2);

                            table.addCell(phrase);
                            phrase = new Phrase("Acknowledge receipt of order", pFontHeader2);
                            ...
                            table.getDefaultCell().setColspan(3);
                            table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                            phrase = new Phrase("Supplier", pFontHeader2);
                            ...
                            table.getDefaultCell().setColspan(5);
                            table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                            phrase = new Phrase("1. Original__________ Use department", pFontHeader2);

                            table.addCell(phrase);

                            table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                            phrase = new Phrase("2. Duplicate________ Procurement office", pFontHeader2);

                            table.addCell(phrase);


                            table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                            phrase = new Phrase("3. Triplicate_________ Book copy", pFontHeader2);
