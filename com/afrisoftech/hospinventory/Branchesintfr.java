...
public class Branchesintfr extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        */
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Code", "Name", "Patient Store", "Markup %", "Stock GL Code", "Consumable Code"
            }
        ) {
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        if (jTable1.getSelectedColumn() == 4 || jTable1.getSelectedColumn() == 5) {
...
// TODO add your handling code here:
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        try{
            ...
            java.sql.PreparedStatement pstmt31 = connectDB.prepareStatement("DELETE from st_stores WHERE store_code = '"+jTable1.getModel().getValueAt(jTable1.getSelectedRow(),0).toString()+"'");
...
// TODO add your handling code here:
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        jTable1.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"select store_code,store_name,patient_store,mark_up,glstock_code as stock_gl_code,cs_code as consumable_code from st_stores ORDER BY store_name"));
            ...
            for (int i = 0; i < jTable1.getRowCount(); i++){
                if (jTable1.getModel().getValueAt(i,0) != null){
                    if(jButton1.getLabel().equalsIgnoreCase("Update")){
                        java.sql.PreparedStatement pstmt311 = connectDB.prepareStatement("UPDATE st_stores SET store_name = '"+jTable1.getValueAt(i,1).toString()+"',patient_store = '"+jTable1.getValueAt(i,2).toString()+"',mark_up = '"+jTable1.getValueAt(i,3).toString()+"',glstock_code= '"+jTable1.getValueAt(i,4).toString()+"',cs_code = '"+jTable1.getValueAt(i,5).toString()+"' WHERE store_code = '"+jTable1.getModel().getValueAt(i,0).toString()+"'");
