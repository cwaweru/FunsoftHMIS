...
public class RaiseExternalPrInfr extends javax.swing.JInternalFrame {
    ...
    public RaiseExternalPrInfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
        ...
        String title = "Raising an External PR";
...
//        }
    ...
    private void initComponents() {
        ...
        svaeSpecsbtn = new javax.swing.JButton();
        ...
        */
        ...
        jLabel3.setText("Requisitioning Dept");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 0;
        gridBagConstraints.weightx = 0.5;
        ...
        jPanel5.add(formProcCbx, gridBagConstraints);
        ...
        gridBagConstraints.weighty = 1.0;
        gridBagConstraints.insets = new java.awt.Insets(0, 20, 0, 100);
        jPanel5.add(ItemCategoryCbx, gridBagConstraints);
        ...
        specsTbl.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "#", "Specification(e.g DIMENSIONS: Length 4m)"
            }
        ) {
            boolean[] canEdit = new boolean [] {
                false, true
        ...
        svaeSpecsbtn.setText("Save");
        svaeSpecsbtn.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                svaeSpecsbtnActionPerformed(evt);
            }
        });
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        ...
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
        jPanel9.add(svaeSpecsbtn, gridBagConstraints);
        ...
        jLabel9.setText("Requisition Number");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 0;
        gridBagConstraints.weightx = 1.0;
        ...
        jTextField362.addCaretListener(new javax.swing.event.CaretListener() {
            public void caretUpdate(javax.swing.event.CaretEvent evt) {
                jTextField362CaretUpdate(evt);
            }
        });
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        ...
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
        jPanel10.add(jPanel62, gridBagConstraints);
    ...
    private void postbtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_postbtnActionPerformed
        ...
        try {
            ...
            if (goodsPrqChbx.isSelected()) {
                ...
                java.sql.ResultSet rs2 = ps.executeQuery("select 'SRQ'||lpad(nextval('proc_req_no_seq')::text,6,0::TEXT)");
                while (rs2.next()) {
                    transNo = rs2.getObject(1).toString();
                    jTextField362.setText(transNo);
                }
            ...
            if (externalprtbl.getModel().getValueAt(j, 0) != null) {
                ...
                for (int i = 0; i < externalprtbl.getRowCount(); i++) {
                    ...
                    if (externalprtbl.getModel().getValueAt(i, 0) != null && externalprtbl.getModel().getValueAt(i, 3) != null) {
                        ...
                        pstmt.setDate(7, com.afrisoftech.lib.SQLDateFormat.getSQLDate(duedateDatepckr.getDate()));
                        ...
                        int l = 0;
                        if (goodsPrqChbx.isSelected()) {
                            java.sql.PreparedStatement search = connectDB.prepareStatement("SELECT  buying_price FROM st_stock_item where description ilike '" + externalprtbl.getValueAt(l, 1) + "';");
                            ...
                            java.sql.PreparedStatement search2 = connectDB.prepareStatement("SELECT DISTINCT unit_price FROM services_list  where service ilike '" + externalprtbl.getValueAt(l, 1) + "' limit 1;");
                        ...
                        pstmt.setDouble(17, java.lang.Double.valueOf(externalprtbl.getValueAt(i, 4).toString()));
                        ...
                        //remarks
                        String remark = null;
                        if (externalprtbl.getValueAt(i, 5) == null) {
                            remark = "-";
                            pstmt.setObject(23, remark);
                        } else {
                            remark = externalprtbl.getValueAt(i, 5).toString();
                            pstmt.setObject(23, remark);
                        }
                        ...
                        pstmt.setObject(28, "");
                        pstmt.setObject(29, externalprtbl.getValueAt(i, 0).toString());
                        ...
                        pstmt.setDouble(34, usage);
                        pstmt.setObject(35, "External Pr");
                        pstmt.setObject(36, false);
                        // pstmt.setObject(36,"");
                        pstmt.setBoolean(37, false);
//                    String n=null;
//                    try{ n=externalprtbl.getValueAt(i, 4).toString(); if(n==null){ n="-";}  }  catch(Exception esc){ System.out.println(esc.getMessage());}
//                    pstmt.setObject(36,n);
                ...
                //to update the st_receive_requisition
...
//            pstmt221.executeUpdate();
                if (JOptionCheck == true) {
                    ...
                    if (goodsPrqChbx.isSelected()) {
                        java.sql.PreparedStatement pstmtsj = connectDB.prepareStatement("INSERT INTO st_pr_progress(purchase_req) VALUES (?)");

                        pstmtsj.setObject(1, transNo + "-" + "Goods");

                        pstmtsj.executeUpdate();

                        System.out.println("This " + transNo + "-" + "Goods");

                    } else if (servicesPrqChbx.isSelected()) {
                        java.sql.PreparedStatement pstmtsj = connectDB.prepareStatement("INSERT INTO st_pr_progress(purchase_req) VALUES (?)");

                        pstmtsj.setObject(1, transNo + "-" + "Services");

                        pstmtsj.executeUpdate();
                        System.out.println("This " + transNo + "-" + "Services");
                    ...
                    goodsPrqChbx.setSelected(true);
                    com.afrisoftech.hospinventory.ExternalRequisitionPDF policy = new com.afrisoftech.hospinventory.ExternalRequisitionPDF();
                    policy.ExternalRequisitionPDF(connectDB, receivnCmbx.getSelectedItem().toString(), deptRaising.getSelectedItem().toString(), transNo, userTxt.getText().toString());
    ...
    private void jTextField361CaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextField361CaretUpdate
        ...
        jSearchTable11.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB, "SELECT requisition_no FROM st_receive_requisation WHERE (requisition_no ilike 'PRQ%' or requisition_no ilike '%" + jTextField361.getText().toString() + "%'  ) and processed = false"));
//        }
        jSearchScrollPane11.setViewportView(jSearchTable11);
...
//        else {
        if (goodsPrqChbx.isSelected() == true) {
            ...
            jSearchTable1.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectorsCaret(connectDB, "SELECT DISTINCT service_code, service, units_rate, unit_price,specification  FROM services_list WHERE service ILIKE '%" + jTextField1111.getText() + "%'  and department='" + deptRaising.getSelectedItem() + "'  ORDER BY service_code asc"));
    ...
    private void jTextField362CaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextField362CaretUpdate
        // TODO add your handling code here:
    }//GEN-LAST:event_jTextField362CaretUpdate

    private void searchButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchButton2ActionPerformed
        // TODO add your handling code here:
        System.out.println("Showing dialog");
        java.awt.Point point = jTextField362.getLocationOnScreen();
        jSearchDialog11.setSize(350, 200);
        jSearchDialog11.setLocation(point);
        jSearchDialog11.setVisible(true);
    ...
    private void svaeSpecsbtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_svaeSpecsbtnActionPerformed
        // TODO add your handling code here:
        int r = 0;

        if (svaeSpecsbtn.getLabel().equalsIgnoreCase("Save")) {
            try {

                for (int i = 0; i < specsTbl.getRowCount(); i++) {
                    if (specsTbl.getValueAt(r, 1).toString() != null) {
                        java.sql.PreparedStatement stmt1 = connectDB.prepareStatement("INSERT INTO st_criteria(pr_no,  item_desc, specs) VALUES (?, ?, ?);");
                        stmt1.setObject(1, jTextField362.getText().toString());
                        stmt1.setObject(2, jComboBox1.getSelectedItem().toString());
            ...
            try {
                ...
                for (int i = 0; i < specsTbl.getRowCount(); i++) {
                    if (specsTbl.getValueAt(a, 1).toString() != null) {

                        java.sql.PreparedStatement stmt2 = connectDB.prepareStatement("UPDATE st_criteria SET specs='" + specsTbl.getValueAt(specsTbl.getRowCount(), 1) + "' WHERE tender_no='" + jTextField362.getText() + "' and item_desc='" + jComboBox1.getSelectedItem().toString() + "';");

                        stmt2.executeUpdate();
                    }

                }
                javax.swing.JOptionPane.showMessageDialog(this, "Update Success");
            } catch (SQLException ex) {
                ex.printStackTrace();
                javax.swing.JOptionPane.showMessageDialog(this, ex.getMessage());
    ...
    }//GEN-LAST:event_svaeSpecsbtnActionPerformed
    ...
    private void editSpecsbtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editSpecsbtnActionPerformed
        ...
        if (jComboBox1.getSelectedItem().toString().equalsIgnoreCase("-")) {
            javax.swing.JOptionPane.showMessageDialog(this, "Select Requisition Number first");

        } else {
            svaeSpecsbtn.setLabel("Update");
            ...
            try {
                ...
                java.sql.ResultSet a = b.executeQuery("SELECT distinct  specs FROM st_criteria where pr_no ='" + jTextField362.getText().toString() + "' and item_desc= '" + jComboBox1.getSelectedItem().toString() + "'   ;");
                while (a.next()) {
                    int i = 0;
    ...
    private javax.swing.JButton svaeSpecsbtn;
