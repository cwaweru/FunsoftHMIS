...
//        else {
        if (goodsPrqChbx.isSelected() == true) {
            ...
            jSearchTable1.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB, "SELECT DISTINCT service_code, service, units_rate, unit_price,specification  FROM services_list WHERE service ILIKE '%" + jTextField1111.getText() + "%'  and department='" + deptRaising.getSelectedItem() + "'  ORDER BY service_code asc"));
