...
public class TenderAdvertisementPDF implements java.lang.Runnable {
   ...
   // private String time=null;
    ...
    public void TenderAdvertisementPDF(java.sql.Connection connDb, java.lang.String adDate) {
      //  selectSupp = combox;
      //  Department = dept;
       // OrderNo = tenderNo;
       // user = UserName;
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    com.lowagie.text.HeaderFooter footer = new com.lowagie.text.HeaderFooter(new Phrase(""+com.afrisoftech.lib.FinancialYear.getCompanyName(connectDB).toUpperCase()+"   Tender Advertisement - Page: ", pFontHeader1), true);// FontFactory.getFont(com.lowagie.text.FontFactory.HELVETICA, 12, Font.BOLDITALIC,java.awt.Color.blue));
                        ...
                        try {
                          ...
                          //  java.sql.ResultSet rset5 = st5.executeQuery("SELECT distinct description from st_recommendation WHERE quotation_no = '" + OrderNo + "'");
                           ...
                           // while (rset4.next()) {
                                ...
                                table2.getDefaultCell().setColspan(10);
                                table2.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_CENTER);
                                phrase = new Phrase("ADVERTISEMENT FOR PROCUREMENT", pFontHeader5);
...
//                                table2.getDefaultCell().setColspan(10);
//                                table2.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_CENTER);
//                                phrase = new Phrase(com.afrisoftech.lib.FinancialYear.getCompanyName(connectDB).toUpperCase()+" Wishes welcome able bidders for the following items  ", pFontHeader);
//                                table2.addCell(phrase);
...
//                                phrase = new Phrase(" ", pFontHeader);
                     ...
                     java.sql.Statement st5 = connectDB.createStatement();
                     java.sql.ResultSet rset5 = st5.executeQuery("SELECT  distinct upper(ad_type),upper(concat(category ,': ', ad_type)),category  from st_tenders WHERE advertisement_date::date = '" + beginDate + "' group by 1,2,3 order by 3");//items table        System.
                      while(rset5.next()){
                        System.out.println("Todays date "+beginDate);
                        ...
                        phrase = new Phrase("CATEGORY:  "+rset5.getObject(2).toString(), pFontHeadertableTitle);
                        ...
                        table3.getDefaultCell().setColspan(2);
                        table3.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                        phrase = new Phrase("OPENING DATE", pFontHeader);
                        table3.addCell(phrase);
                        //4
                        table3.getDefaultCell().setColspan(2);
                        table3.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                        phrase = new Phrase("ELIGIBILITY", pFontHeader);
                        table3.addCell(phrase);
...
//                            java.lang.Object[] listofAct1 = this.getListofActivities1();
          ...
          // for (int i = 0; i < listofAct.length; i++) {
                            ...
                            java.sql.ResultSet rset1 = st2.executeQuery("SELECT distinct  description,opening_date,bid_bond,ref_no FROM st_tenders where ad_type ilike  '%"+rset5.getObject(1).toString()+"%' and advertisement_date::date ='"+beginDate+"' and opening_date is not null ");
                          ...
                          //bidder_no
                            ...
                            while (rset1.next()) {
                               ...
                               System.out.println("SELECT distinct description,opening_date,bid_bond,ref_no FROM st_tenders where ad_type ilike  '%"+rset5.getObject(1).toString()+"%'  ");
                                cnt= cnt +1;
                              //tender
                            table3.getDefaultCell().setColspan(2);
                            table3.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
...
//                            
    ...
    public java.lang.Object[] getListofActivities() {
        ...
        java.sql.ResultSet rSet1 = stmt1.executeQuery("select  distinct ref_no from st_tenders  where advertisement_date::date  = '"+beginDate+"'  group by 1 order by 1");
