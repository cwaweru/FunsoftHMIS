...
public class TransfersPerStoreGroupedPdf implements java.lang.Runnable {
    ...
    public void TransfersPerStoreGroupedPdf(java.sql.Connection connDb,java.util.Date begindate,java.util.Date endate,java.lang.String combox) {
                ...
                try {
                    ...
                    try {
                        ...
                        try {
                            ...
                            java.sql.ResultSet rset = st.executeQuery("select ss.item,sum(ss.issuing),sum(ss.total/ss.issuing),round(sum(ss.total),2) as total from st_sub_stores ss WHERE transaction_no ILIKE 'T%' and ss.trans_date::date BETWEEN '"+beginDate+"' AND '"+endDate+"' and ss.store_name ilike '"+bank+"' group by ss.item,ss.ISSUING having sum(ss.issuing)>0 ORDER BY 2 DESC");
