...
public class DetailedPrescPerPatDarPdf implements java.lang.Runnable {
    ...
    public void DetailedPrescPerPatDarPdf(java.sql.Connection connDb, java.util.Date begindate, java.util.Date endate, java.lang.String cashPoint, java.lang.String categ) {
                ...
                try {
                    ...
                    try {
                        ...
                        try {
                            ...
                            phrase = new Phrase("PRESCRIPTIONS PER CATEGORY [DAR]  - Period : "  +dateFormat.format(endDate11)+" - "+dateFormat.format(endDate1), pFontHeader);
                        ...
                        try {
                            ...
                            for (int k = 0; k < listofAct1.length; k++) {
                                ...
                                for (int i = 0; i < listofAct.length; i++) {
                                    ...
                                    java.sql.ResultSet rset2x = st52x.executeQuery("select distinct patient_name from hp_pharmacy where patient_no ilike '"+listofAct[i].toString()+"' and main_service = '"+CashPoint+"' AND date_prescribed BETWEEN '"+beginDate+"' AND '"+endDate+"' group by patient_name");
                                    while (rset2x.next()) {
                                        table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
