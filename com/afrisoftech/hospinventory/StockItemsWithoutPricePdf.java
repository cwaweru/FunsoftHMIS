...
public class StockItemsWithoutPricePdf implements java.lang.Runnable {
            ...
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        Phrase phrase = new Phrase("STOCK ITEMS (WITHOUT BUYING PRICES) FOR " + bank + " : ", com.lowagie.text.FontFactory.getFont(FontFactory.HELVETICA_BOLD, 10));
                        ...
                        try {
                            ...
                            for (int i = 0; i < listofAct.length; i++) {
                                ...
                                java.sql.ResultSet rset1 = st2.executeQuery("SELECT item_code,initcap(description),strength,buying_price from st_stock_item where department ilike '" + bank + "' AND sub_cat_code = '" + listofAct[i].toString() + "' order by 1");
