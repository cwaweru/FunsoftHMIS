...
public class SubstoreItemsConsumptionPdf implements java.lang.Runnable {
    ...
    public void SubstoreItemsConsumptionPdf(java.sql.Connection connDb,java.util.Date begindate, java.util.Date endate, java.lang.String dept) {
            ...
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        Phrase phrase = new Phrase(" All Pharmacy Substores Consumption Report".toUpperCase(), pFontHeader);
                        ...
                        try {
                          ...
                          //  double Mark = java.lang.Double.parseDouble(MarkUp);
                            ...
                            while(rset11.next()){
                                ...
                                java.sql.ResultSet rset = st.executeQuery("select initcap(service), sum(qty), sum(value) from consumables_view2 where date BETWEEN '"+beginDate+"' AND '"+endDate+"' and store ilike '"+Department+"'  group by service order by 2 desc");
                                while (rset.next()) {
