...
public class itemFlowTenderPDF implements java.lang.Runnable {

    java.lang.String tenderNo = null;
    java.lang.String suppCode = null;
    ...
    public void itemFlowTenderPDF(java.sql.Connection connDb, java.util.Date begindate, java.util.Date endate, java.lang.String combox, java.lang.String combox1, java.lang.String drugname) {
                ...
                try {
                    ...
                    try {
                        ...
                        try {
                            ...
                            table1.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_CENTER);
                            phrase = new Phrase("TENDER ITEM MOVEMENT REPORT", pFontHeader11);
                    ...
                    try {
                        ...
                        try {
                            ...
                            // java.sql.ResultSet rset1 = st1.executeQuery("select date_prescribed,patient_no ,patient_name,pay_mode,quantity,price,amount from hp_pharmacy where description ilike '"+suppCode+"' and main_service ilike '"+tenderNo+"%' AND date_prescribed BETWEEN '"+beginDate+"' AND '"+endDate+"' order by date_prescribed");
                            // java.sql.ResultSet rset1 = st1.executeQuery("select trans_date::date,'' ,issiued_to,receiving,issuing,price,total from st_sub_stores where item||' '||strength ilike '"+suppCode+"' and store_name ilike '"+tenderNo+"%' AND trans_date BETWEEN '"+beginDate+"' AND '"+endDate+"' order by trans_date");

                            //java.sql.ResultSet rset1 = st1.executeQuery("select trans_date::date,'' ,CASE WHEN (transaction_no ilike 'T%')THEN initcap(sub_store) ELSE initcap(issiued_to) END as issiued_to,receiving,issuing,price,total,user_name from st_sub_stores where item_code ilike '" + suppCode + "' and store_name ilike '" + tenderNo + "' AND trans_date::date BETWEEN '" + beginDate + "' AND '" + endDate + "' order by trans_date");
                            java.sql.ResultSet rset1 = st1.executeQuery("select trans_date::date,'' ,CASE WHEN (transaction_no ilike 'T%')THEN initcap(sub_store) ELSE initcap(issiued_to) END as issiued_to,receiving,issuing,price,total,user_name from st_sub_stores where item_code ilike '" + suppCode + "' and store_name ilike '" + memNo + "' AND trans_date::date BETWEEN '" + beginDate + "' AND '" + endDate + "' order by trans_date");
                            java.sql.ResultSet rset1q = st1q.executeQuery("select sum(ordered_qty) from st_recommendation where supplier ilike '" + suppName + "' and quotation_no ilike '" + memNo + "' AND  date::date BETWEEN '" + beginDate + "' AND '" + endDate + "'");
                            java.sql.ResultSet rset4 = st4.executeQuery("select buying_price/packaging from st_stock_item where item_code ilike '" + suppCode + "'");
                            java.sql.ResultSet rset11 = st11.executeQuery("select sum(quantity-ordered_qty) from st_recommendation where description ilike '" + suppCode + "' and store_name ilike '" + memNo + "' AND trans_date::date < '" + beginDate + "'");
                            //java.sql.ResultSet rset111 = st111.executeQuery("select sum(issuing),sum(total) from st_sub_stores where item ilike '"+suppCode+"' and sub_store ilike '"+tenderNo+"%' AND trans_date BETWEEN '"+beginDate+"' AND '"+endDate+"'");
                            ...
                            phrase = new Phrase("TENDER/QNO : " + memNo, pFontHeader11);
                            table.addCell(phrase);

                            table.getDefaultCell().setColspan(4);

                            table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_CENTER);
                            phrase = new Phrase("SUPPLIER : " + suppName.toUpperCase(), pFontHeader11);
                            table.addCell(phrase);

                            table.getDefaultCell().setColspan(2);

                            table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_CENTER);
                            phrase = new Phrase("SUPPLIER_CODE : " +suppCode.toUpperCase() , pFontHeader11);
                            table.addCell(phrase);
                            ...
                            phrase = new Phrase("Ordered Qtys", pFontHeader1);
                            table.addCell(phrase);

                            phrase = new Phrase("Unordered Qtys", pFontHeader1);
                            table.addCell(phrase);
