 ...
 * @author  root
 */
public class MergingCreditorsIntfr extends javax.swing.JInternalFrame {
    ...
    public MergingCreditorsIntfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {
        ...
        */
        ...
        setMaximizable(true);
        setResizable(true);
        setTitle("Merging Creditors Accounts");
    ...
    private void jSearchTable221MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jSearchTable221MouseClicked
        ...
        String code = null;
        jTextField71.setText(jSearchTable221.getValueAt(jSearchTable221.getSelectedRow(), 0).toString());
    ...
    private void jSearchTable22MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jSearchTable22MouseClicked
        ...
        String code = null;
        jTextField13.setText(jSearchTable22.getValueAt(jSearchTable22.getSelectedRow(), 0).toString());
        jTextField91.setText(jSearchTable22.getValueAt(jSearchTable22.getSelectedRow(), 1).toString());
    ...
    private void jTextField1132CaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextField1132CaretUpdate
        if(this.jTextField1132.getCaretPosition() < 0){
            ...
            jSearchTable22.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"SELECT DISTINCT supplier_name,code FROM st_suppliers WHERE supplier_name ILIKE '%"+jTextField1132.getText()+"%' ORDER BY supplier_name"));
    ...
    private void jButton11ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton11ActionPerformed
        ...
        if (exitOption == javax.swing.JOptionPane.YES_OPTION) {
            ...
            try {
                ...
                java.sql.PreparedStatement pstmt22 = connectDB.prepareStatement("UPDATE ac_accounts_payable SET account_no = '"+jTextField91.getText()+"',dealer = '"+jTextField13.getText()+"' WHERE dealer ilike '"+jTextField71.getText()+"' AND date >= '"+datePicker1.getDate()+"'");
                pstmt22.executeUpdate();
                java.sql.PreparedStatement pstmt222 = connectDB.prepareStatement("UPDATE st_stock_cardex SET supplier = '"+jTextField13.getText()+"' WHERE supplier = '"+jTextField911.getText()+"' AND date >= '"+datePicker1.getDate()+"'");
                pstmt222.executeUpdate();
                java.sql.PreparedStatement pstmt223 = connectDB.prepareStatement("UPDATE cr_allocation SET acc_no = '"+jTextField91.getText()+"' WHERE acc_no = '"+jTextField911.getText()+"' AND date >= '"+datePicker1.getDate()+"'");
                pstmt223.executeUpdate();
                java.sql.PreparedStatement pstmt221 = connectDB.prepareStatement("UPDATE st_suppliers SET closed = 'true' WHERE code = '"+jTextField911.getText()+"'");
