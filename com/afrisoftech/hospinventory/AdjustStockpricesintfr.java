...
public class AdjustStockpricesintfr extends javax.swing.JInternalFrame {
    ...
    private void jTextField111CaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextField111CaretUpdate
        if(jTextField111.getCaretPosition() > 1){
            jSearchTable.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"SELECT DISTINCT product||''||strength as product ,product_id,units ,transfer_price ,selling_price FROM st_stock_prices WHERE product ILIKE '%"+jTextField111.getText()+"%' and department like '"+jComboBox2.getSelectedItem()+"'  order by product"));
     /*      
      try {
