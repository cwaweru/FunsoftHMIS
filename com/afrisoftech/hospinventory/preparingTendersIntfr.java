 ...
 * @author saleem
 */
public class preparingTendersIntfr extends javax.swing.JInternalFrame {
    ...
    private int count;
    public preparingTendersIntfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
       ...
       saveButntender.setLabel("Update Entries");
         try {
             ...
             Logger.getLogger(preparingTendersIntfr.class.getName()).log(Level.SEVERE, null, ex);
         }
