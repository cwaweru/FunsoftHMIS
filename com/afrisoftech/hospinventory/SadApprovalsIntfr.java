 ...
 */
public class SadApprovalsIntfr extends javax.swing.JInternalFrame {
    ...
    public SadApprovalsIntfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {
        ...
        sad_tbl = new com.afrisoftech.dbadmin.JTable();
        jPanel8 = new javax.swing.JPanel();
        jScrollPane2 = new javax.swing.JScrollPane();
        sad_reject_tbl = new com.afrisoftech.dbadmin.JTable();

        setClosable(true);
        setIconifiable(true);
        setMaximizable(true);
        setResizable(true);
        setTitle("SAD  APPROVAL ");
        ...
        ApprovalTbl.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"SELECT distinct order_no as LPO_LSO_NO,supplier as supplier_name from st_orders st where dispatch=false and ordered=false and chief_approval=true and aie_holder_approval=true and sad_approval=false  and miu_approval=false and order_no is not null group by supplier,order_no  order by order_no"));
        ...
        */
        ...
        sad_tbl.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        sad_tbl.setGridColor(new java.awt.Color(204, 204, 255));
        ...
        sad_tbl.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                sad_tblMouseClicked(evt);
            }
            public void mouseReleased(java.awt.event.MouseEvent evt) {
                sad_tblMouseReleased(evt);
            }
        });
        sad_tbl.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                sad_tblKeyReleased(evt);
            }
        });
        jScrollPane1.setViewportView(sad_tbl);
        ...
        sad_reject_tbl.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null, null, null, null, null},
                {null, null, null, null, null, null, null, null},
                {null, null, null, null, null, null, null, null},
        ...
        sad_reject_tbl.setGridColor(new java.awt.Color(204, 204, 255));
        //this.procurementPlanTbl.getColumnModel().getColumn(i).setCellEditor(new javax.swing.DefaultCellEditor((javax.swing.JComboBox)new com.afrisoftech.lib.DatePicker()));
        sad_reject_tbl.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                sad_reject_tblMouseClicked(evt);
            }
            public void mouseReleased(java.awt.event.MouseEvent evt) {
                sad_reject_tblMouseReleased(evt);
            }
        });
        sad_reject_tbl.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                sad_reject_tblKeyReleased(evt);
            }
        });
        jScrollPane2.setViewportView(sad_reject_tbl);
...
// v.removeAllElements();
        ...
        for (int k = 0; k < sad_tbl.getRowCount(); k++) {
            for (int r = 0; r < sad_tbl.getColumnCount(); r++) {
                sad_tbl.getModel().setValueAt(null, k, r);
            }
        }
        ...
        try {
            ...
            try {
                ...
                while (rsetSupplier.next()) {
                    ...
                    sad_tbl.setValueAt(rsetSupplier.getObject(6), k, 2);
                    sad_tbl.setValueAt(false, k, 6);
                    sad_tbl.setValueAt(rsetSupplier.getObject(2), k, 4);
                    sad_tbl.setValueAt(rsetSupplier.getObject(4), k, 1);
                    ...
                    if (rsetSupplierDate.next()) {
                        sad_tbl.setValueAt(rsetSupplierDate.getObject(1), k, 0);

                        sad_tbl.setValueAt(rsetSupplierDate.getObject(3), k, 3);
                    }
                    ...
                    if (rsetdebit.next()) {
                        ...
                        sad_tbl.setValueAt(rsetdebit.getObject(1), k, 5);
    ...
    private void SaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SaveActionPerformed
        ...
        //connectDB.setAutoCommit(false);   
            ...
            if (Save.getText().equals("Save")) {
                //connectDB.setAutoCommit(false);                                    
                for (int k = 0; k < sad_tbl.getRowCount(); k++) {
                    if (sad_tbl.getValueAt(k, 0) != null) {
                        if (Boolean.valueOf(sad_tbl.getValueAt(k, 11).toString()) == java.lang.Boolean.TRUE) {

                            String comment;
                            if (sad_tbl.getValueAt(k, 10) == null) {
                                comment = "-";
                            } else {
                                comment = sad_tbl.getValueAt(k, 10).toString();
                            }

                            java.sql.PreparedStatement pstmt81212 = connectDB.prepareStatement(""
                                    + "update st_orders set  sad_approval=true, sad='" + correct_name + "', sad_date=now(), sad_remark='" + comment + "' where  order_no='" + lpo + "'  and code='" + sad_tbl.getModel().getValueAt(k, 1).toString() + "'");

                            System.out.println("update st_orders set  sad_approval=true, sad='" + correct_name + "', sad_date=now(), sad_remark='" + comment + "' where  order_no='" + lpo + "'  and code='" + sad_tbl.getModel().getValueAt(k, 1).toString() + "'");
                ...
                if (check_update == true) {
                    ...
                    TenderTrack.TrackTable(connectDB, "sad_approval", com.afrisoftech.lib.UserName.getLoginName(connectDB) + "-" + com.afrisoftech.lib.UserName.getServerDate(connectDB), TenderTxt.getText());
                    connectDB.commit();
                    ...
                    cancelbtn.doClick();
//ApprovalTbl.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"SELECT distinct order_no as LPO_LSO_NO,supplier as supplier_name from st_orders st where dispatch=false and ordered=false and chief_approval=true and aie_holder_approval=true and sad_approval=false  and miu_approval=false  group by supplier,order_no  order by order_no"));
                    refresh();
                } else {
                ...
                for (int j = 0; j < sad_reject_tbl.getRowCount(); j++) {
                    if (sad_reject_tbl.getValueAt(j, 0) != null) {
                        if (Boolean.valueOf(sad_reject_tbl.getValueAt(j, 11).toString()) == java.lang.Boolean.TRUE) {
...
//                }
                            ...
                            java.sql.PreparedStatement pstmt812123 = connectDB.prepareStatement("update st_orders set approval_rejected=null  where dispatch=false and ordered=false and chief_approval=true and aie_holder_approval=true and sad_approval=false  and miu_approval=false  and approval_rejected='aie' and quotation_no='" + TenderTxt.getText() + "' and order_no='" + lpo + "' and item ='" + sad_reject_tbl.getModel().getValueAt(j, 2).toString() + "' and code='" + sad_reject_tbl.getModel().getValueAt(j, 1).toString() + "'");
                ...
                if (check_activation == true) {
                    ...
                    cancelbtn.doClick();
                    ClearTable.clearthisTable(sad_reject_tbl);
                    //ApprovalTbl.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"SELECT distinct order_no as LPO_LSO_NO,supplier as supplier_name from st_orders st where dispatch=false and ordered=false and chief_approval=true and aie_holder_approval=true and sad_approval=false  and miu_approval=false  group by supplier,order_no  order by order_no"));
                    refresh();
                    Save.setText("Save");
                } else {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            for (int k = 0; k < sad_tbl.getRowCount(); k++) {
                if (sad_tbl.getValueAt(k, 0) != null) {
                    if (Boolean.valueOf(sad_tbl.getModel().getValueAt(k, 11).toString()) == java.lang.Boolean.TRUE) {
                        ...
                        java.sql.PreparedStatement pstmt81212 = connectDB.prepareStatement(""
                                + "update st_orders set sad_approval=true,sad='" + correct_name + "',sad_date=now(),sad_rejected_remark='" + comment + "',approval_rejected='sad' where dispatch=false and ordered=false and chief_approval=true and aie_holder_approval=true and sad_approval=false  and miu_approval=false   and quotation_no='" + TenderTxt.getText() + "' and order_no='" + lpo + "' and item ='" + sad_tbl.getModel().getValueAt(k, 2).toString() + "' and code='" + sad_tbl.getModel().getValueAt(k, 1).toString() + "'");
                        //        java.sql.PreparedStatement pstmt8121 = connectDB.prepareStatement("UPDATE ac_ledger SET reconciled = true WHERE cheque_no ILIKE '" + grn2PayablesLinkingTable.getValueAt(i, 1).toString() + "' AND dealer ilike '" + supplierNameTxt.getText().toString() + "' and date = '" + grn2PayablesLinkingTable.getValueAt(i, 0).toString() + "' and transaction_no = '" + grn2PayablesLinkingTable.getValueAt(i, 4).toString() + "'");
            ...
            if (check_update == true) {
                ...
                cancelbtn.doClick();
                //ApprovalTbl.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"SELECT distinct order_no as LPO_LSO_NO,supplier as supplier_name from st_orders st where dispatch=false and ordered=false and chief_approval=true and aie_holder_approval=true and sad_approval=false  and miu_approval=false  and approval_rejected is null group by supplier,order_no  order by order_no"));
                refresh();
            } else {
                javax.swing.JOptionPane.showMessageDialog(this, "Check Your Entries", "ERROR MESSAGE!", javax.swing.JOptionPane.ERROR_MESSAGE);
                connectDB.setAutoCommit(false);
    ...
    private void sad_tblMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_sad_tblMouseClicked
        Save.setText("Save");
...
//        }
    ...
    }//GEN-LAST:event_sad_tblMouseClicked

    private void sad_tblMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_sad_tblMouseReleased
...
//        }        // TODO add your handling code here:
    }//GEN-LAST:event_sad_tblMouseReleased

    private void sad_tblKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_sad_tblKeyReleased
    ...
    }//GEN-LAST:event_sad_tblKeyReleased
    ...
    private void ApprovalTblMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_ApprovalTblMouseClicked
        try {
            ...
            TenderTxt1.setText(null);
            connectDB.setAutoCommit(false);
            ClearTable.clearthisTable(sad_tbl);
            ...
            java.sql.ResultSet rsets = stmtss.executeQuery("SELECT distinct ordering_store,quotation_no,requisition_no FROM st_orders WHERE order_no ='" + lpo + "' and  dispatch=false and ordered=false and chief_approval=true and aie_holder_approval=true and sad_approval=false  and miu_approval=false");
...
//            System.out.println("THE PR IS "+prq_new);
            ...
            sad_tbl.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB, "SELECT distinct o.date_due,o.code,o.item,o.item_strength,o.units, o.quantity, o.unit_price,o.net_value,chief_remark  Chief_Remark,aie_holder_remark,null Remarks,false Approve  FROM st_orders o,st_item_to_quote q where o.order_no='" + lpo + "' and  q.tender_no='" + TenderTxt.getText() + "' and o.dispatch=false and o.ordered=false and o.chief_approval=true and o.aie_holder_approval=true and o.sad_approval=false  and o.miu_approval=false and o.approval_rejected is null"));
            sad_reject_tbl.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB, "(SELECT  distinct o.date_due,o.code,o.item,o.item_strength,o.units, o.quantity, o.unit_price,o.net_value,chief_rejected_remark  Chief_Rejection,aie_rejected_remark Aie_Rejection,null Remarks,false Activate  FROM st_orders o,st_item_to_quote q where o.order_no='" + lpo + "' and  q.tender_no='" + TenderTxt.getText() + "' and q.tender_no=o.quotation_no and o.item=q.item_description  and  o.approval_rejected='sad' and o.chief_approval=true and o.aie_holder_approval=true and sad_approval=true UNION  SELECT distinct o.date_due,o.code,o.item,o.item_strength,o.units, o.quantity, o.unit_price,o.net_value,chief_rejected_remark  Chief_Rejection,aie_rejected_remark Aie_Rejection,null Remarks,false Activate  FROM st_orders o,st_item_to_quote q where o.order_no='" + lpo + "' and  q.tender_no='" + TenderTxt.getText() + "' and q.tender_no=o.quotation_no and o.item=q.item_description  and  o.approval_rejected='aie' and o.chief_approval=true and o.aie_holder_approval=true) order by 1"));
            connectDB.commit();
            connectDB.setAutoCommit(true);
    ...
    private void jTextField1CaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextField1CaretUpdate
        ...
        if (jTextField1.getCaretPosition() > 3) {
            ...
            ApprovalTbl.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB, "SELECT distinct order_no as LPO_LSO_NO,supplier as supplier_name from st_orders st where dispatch=false and ordered=false and chief_approval=true and aie_holder_approval=true and sad_approval=false  and miu_approval=false  and  (order_no ilike '%" + jTextField1.getText() + "%' OR  supplier ILIKE '%" + jTextField1.getText() + "%')  group by supplier,order_no  order by supplier "));
    ...
    private void sad_reject_tblMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_sad_reject_tblMouseClicked
        // TODO add your handling code here:
        Save.setText("Activate Item(s)");
    }//GEN-LAST:event_sad_reject_tblMouseClicked

    private void sad_reject_tblMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_sad_reject_tblMouseReleased
        // TODO add your handling code here:
    }//GEN-LAST:event_sad_reject_tblMouseReleased

    private void sad_reject_tblKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_sad_reject_tblKeyReleased
        // TODO add your handling code here:
    }//GEN-LAST:event_sad_reject_tblKeyReleased
    ...
    private javax.swing.JTable sad_reject_tbl;
    private javax.swing.JTable sad_tbl;
