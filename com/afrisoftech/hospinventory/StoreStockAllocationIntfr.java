 ...
 * @author  root
 */
public class StoreStockAllocationIntfr extends javax.swing.JInternalFrame {
    ...
    public StoreStockAllocationIntfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {
        ...
        */
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Item Code", "Description", "Re-Order Level", "Max Level", "Min Level"
            }
        ) {
        ...
        */
        ...
        jLabel5.setText("Copy Stock List");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 0;
        gridBagConstraints.weighty = 0.3;
        ...
        jComboBox2.setModel(com.afrisoftech.lib.ComboBoxModel.ComboBoxModel(connectDB, "SELECT department_name,income_account from pb_departments WHERE department_name IN(select store_name from st_stores) UNION select store_name,cs_code from st_stores where store_name NOT LIKE '%PHARMACY%' AND cs_code ilike '600%' "));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 0;
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
        ...
        jButton1.setText("Save Stock List");
