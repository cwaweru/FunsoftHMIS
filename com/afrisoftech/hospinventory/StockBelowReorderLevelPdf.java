...
public class StockBelowReorderLevelPdf implements java.lang.Runnable {
    ...
    public void StockBelowReorderLevelPdf(java.sql.Connection connDb, java.lang.String store, java.lang.String usemethod) {
            ...
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        if(UseMethod.equalsIgnoreCase("Averages")){
                    ...
                    try {
                        ...
                        int headerwidths[] = {34,8,8, 8,10,10,10,10};
                        ...
                        if(UseMethod.equalsIgnoreCase("Averages")){
                            ...
                            phrase = new Phrase("M. Order",pFontHeader);
                            table.addCell(phrase);
                        }
                        ...
                        try {
                            ...
                            for (int l = 0; l < listofDays.length; l++) {
                                ...
                                if(UseMethod.equalsIgnoreCase("Averages")){
                                    ...
                                    if(UseMethod.equalsIgnoreCase("Straights")){
                                        java.sql.ResultSet rsetTable1 = stmtTable1.executeQuery("select item,units,sum(round(quantity)),sum(round(reorder_level)),sum(round(read_time)),sum(round(cons_average)) from stock_analysis where item = '"+listofDays[l]+"' AND store_name ilike '"+StoreName+"%' GROUP BY item,units");
                                        java.sql.Statement stmtTable11 = connectDB.createStatement();
                                        java.sql.ResultSet rsetTable11 = stmtTable11.executeQuery("select sum(qty) from stock_balance where description ilike '"+listofDays[l]+"' AND department ilike '"+StoreName+"%'");
                                        ...
                                        java.sql.ResultSet rsetTable111x = stmtTable111x.executeQuery("select reorder_level,max_stock from st_stock_item where description ilike '"+listofDays[l]+"' AND department ilike '"+StoreName+"%'");
                                        ...
                                        while (rsetTable1.next()) {
                                            ...
                                            while (rsetTable111x.next()) {
                                                rlevel = rsetTable111x.getFloat(1);
                                                avgr = rsetTable111x.getFloat(2);
                                                while (rsetTable111.next()) {
                                                    ...
                                                    while (rsetTable11.next()) {
                                                        ...
                                                        if (rlevel > qtyInstock){
                                                            ...
                                                            table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_RIGHT);
                                                            phrase = new Phrase(new com.afrisoftech.sys.Format2Currency().Format2Currency(java.lang.String.valueOf(rlevel)),pFontHeader1);
