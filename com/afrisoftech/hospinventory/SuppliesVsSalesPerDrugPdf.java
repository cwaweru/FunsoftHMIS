...
public class SuppliesVsSalesPerDrugPdf implements java.lang.Runnable {
    ...
    public void SuppliesVsSalesPerDrugPdf(java.sql.Connection connDb, java.util.Date begindate, java.util.Date endate,java.lang.String combox) {
                ...
                */
                  ...
                  */
                    ...
                    try {
                        ...
                        int headerwidths[] = {15,40,10,10,20};
                        ...
                        try {
                            ...
                            java.sql.ResultSet rset1 = st1.executeQuery("select date, supplier,case when sales > 0 then qty*-1 else qty end as qty ,purchases,sales,sales-purchases from drug_movt where item ilike '"+memNo1+"' AND date BETWEEN '"+beginDate+"' AND '"+endDate+"' and qty > 0 order by date");// UNION ALL SELECT trans_date,store_name,user_name,issuing,total from st_sub_stores where (sub_store = 'Pharmacy' OR sub_store = 'IP Pharmacy') and item ilike '"+memNo+"' AND trans_date BETWEEN '"+beginDate+"' AND '"+endDate+"'");
                            java.sql.ResultSet rset11 = st11.executeQuery("select sum(purchases),sum(sales) from drug_movt where item ilike '"+memNo1+"%'");// UNION ALL SELECT trans_date,store_name,user_name,issuing,total from st_sub_stores where (sub_store = 'Pharmacy' OR sub_store = 'IP Pharmacy') and item ilike '"+memNo+"' AND trans_date BETWEEN '"+beginDate+"' AND '"+endDate+"'");
                            ...
                            table.getDefaultCell().setColspan(5);
                            table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_CENTER);
                            phrase = new Phrase("Drug Movement(Supplies Vs Sales) " +memNo1, pFontHeader11);
                            table.addCell(phrase);
                            ...
                            table.addCell(phrase);
                            table.getDefaultCell().setColspan(1);
                            phrase = new Phrase("Supplier/Recipient",pFontHeader1);
                            table.addCell(phrase);
                            ...
                            phrase = new Phrase(new com.afrisoftech.sys.Format2Currency().Format2Currency(java.lang.String.valueOf(osBalanceQty13)),pFontHeader);
                            ...
                            phrase = new Phrase(new com.afrisoftech.sys.Format2Currency().Format2Currency(java.lang.String.valueOf(osBalanceQty14)),pFontHeader);
...
docPdf.close();  com.afrisoftech.lib.PDFRenderer.renderPDF(tempFile);
    ...
    public java.lang.Object[] getListofStaffNos() {
        ...
        try {
           ...
           java.sql.ResultSet rSet1 = stmt1.executeQuery("SELECT DISTINCT item FROM drug_movt  WHERE date::date BETWEEN '"+beginDate+"' AND '"+endDate+"'");
