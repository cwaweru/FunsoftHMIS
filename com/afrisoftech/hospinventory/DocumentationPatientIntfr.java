 ...
 * @Author root
 */
public class DocumentationPatientIntfr extends javax.swing.JInternalFrame {
    ...
    public DocumentationPatientIntfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {
        ...
        previewDocumentBtn1 = new javax.swing.JButton();
        ...
        */
        ...
        imagePreviewDialog.setModal(true);
        imagePreviewDialog.setUndecorated(true);
        imagePreviewDialog.getContentPane().setLayout(new java.awt.GridBagLayout());
        ...
        gridBagConstraints.weighty = 20.0;
        employeeSearchPanel.add(imagePrevLbl, gridBagConstraints);
        ...
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
        imagePreviewDialog.getContentPane().add(employeeSearchPanel, gridBagConstraints);
        ...
        previewDocumentBtn1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Icons/48x48/Document.png"))); // NOI18N
        previewDocumentBtn1.setText("Select Document to Upload");
        previewDocumentBtn1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                previewDocumentBtn1ActionPerformed(evt);
            }
        });
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 2;
        gridBagConstraints.gridy = 11;
        actionPanel.add(previewDocumentBtn1, gridBagConstraints);
...
//
//                pst.executeUpdate();
                //com.afrisoftech.lib.SaveBytea2DB.insertByteArray(connectDB, refNotxt.getText(), fis, "PATIENT_DIAGNOSTICS");
                //org.apache.pdfbox.pdmodel.PDDocument document = org.apache.pdfbox.pdmodel.PDDocument.load(pdffile);
                try {
                    String pdfFilename = pathToFile.getText();
                    if (pathToFile.getText().endsWith(".pdf")) {

                        org.apache.pdfbox.pdmodel.PDDocument document = org.apache.pdfbox.pdmodel.PDDocument.load(new File(pdfFilename));
                        ...
                        for (int page = 0; page < document.getNumberOfPages(); ++page) {
                            ...
                            String imgName = pdfFilename + "-" + (page + 1) + ".png";
                            org.apache.pdfbox.tools.imageio.ImageIOUtil.writeImage(bim, imgName, 300);
                            File file1 = new File(imgName);
                            System.err.println("" + imgName);
                            file1.deleteOnExit();
                            com.afrisoftech.lib.SaveBytea2DB.insertBytea(connectDB, file1, "JPG", "image/png", refNotxt.getText(), file1.getName(), "PATIENT_DIAGNOSTICS");

                        }
                        document.close();
                    } else {
                        com.afrisoftech.lib.SaveBytea2DB.insertBytea(connectDB, file, "JPG", "image/png", refNotxt.getText(), file.getName(), "PATIENT_DIAGNOSTICS");

                    }
                } catch (IOException ex) {
                    Logger.getLogger(DocumentationPatientIntfr.class.getName()).log(Level.SEVERE, null, ex);
                }
    ...
    private void previewDocumentBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_previewDocumentBtnActionPerformed
        ...
        if (!pathToFile.getText().contains("pathtofile/file.pdf")) {
            ...
            if (pathToFile.getText().endsWith(".pdf")) {
                ...
                imagePrevLbl.setIcon(new javax.swing.ImageIcon(file.getPath()));
                imagePreviewDialog.setSize(1000, 700);
...
//        requestIDTxt.setText(lpoNumberTbl.getValueAt(lpoNumberTbl.getSelectedRow(), 2).toString());
    ...
    private void previewDocumentBtn1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_previewDocumentBtn1ActionPerformed
        ...
        if (returnVal == javax.swing.JFileChooser.APPROVE_OPTION) {
            ...
            pathToFile.setText(chooserImages.getSelectedFile().getPath());

            previewDocumentBtn.doClick();

        }  // TODO add your handling code here:
    }//GEN-LAST:event_previewDocumentBtn1ActionPerformed

    private void closeSearchBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_closeSearchBtnActionPerformed
        this.imagePreviewDialog.dispose();
        // Add your handling code here:
...
//                    }
    ...
    private javax.swing.JLabel imagePrevLbl;
    private javax.swing.JDialog imagePreviewDialog;
    ...
    private javax.swing.JButton previewDocumentBtn1;
