...
public class TransferDetailedPdf implements java.lang.Runnable {
    ...
    public void TransferDetailedPdf(java.sql.Connection connDb,java.util.Date begindate,java.util.Date endate,java.lang.String combox, java.lang.String combox2) {
            ...
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        int headerwidths[] = {10,40,10,20,10,10,14};
                        ...
                        table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_CENTER);
                        phrase = new Phrase("TRANSFERED TO : " +bank2.toUpperCase(), pFontHeader);
                        table.addCell(phrase);
                        ...
                        phrase = new Phrase("TransfNo",pFontHeader);
                        table.addCell(phrase);
                        ...
                        try {
                            ...
                            java.sql.ResultSet rset = st.executeQuery("select ss.trans_date::date,ss.item,sum(ss.receiving),ss.transaction_no,upper(ss.issiued_to),ss.sub_store||'-'||initcap(ss.user_name),sum(ss.total/receiving),sum(ss.total) as total from st_sub_stores ss WHERE transaction_no ILIKE 'T%' and ss.trans_date::date BETWEEN '"+beginDate+"' AND '"+endDate+"' and ss.sub_store ilike '"+bank+"' and ss.store_name ilike '"+bank2+"'group by ss.trans_date,ss.item,ss.transaction_no,ss.sub_store,ss.store_name,ss.issiued_to,ss.user_name having sum(ss.receiving)>0 ORDER BY ss.trans_date,ss.transaction_no");
