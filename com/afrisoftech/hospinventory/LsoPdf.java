...
public class LsoPdf implements java.lang.Runnable {
    ...
    public void LsoPdf(java.sql.Connection connDb, java.lang.String combox, java.lang.String order) {
                            ...
                            while (rset4.next()) {
                                ...
                                while (rset2.next()) {
                                    ...
                                    while (rset32.next()) {
                                        ...
                                        // table1.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                                        phrase = new Phrase("Description of Service", pFontHeader);
                                        table.addCell(phrase);
