...
public class TransferedItemsConsumerPdf implements java.lang.Runnable {
    ...
    public void TransferedItemsConsumerPdf(java.sql.Connection connDb, java.lang.String receipt) {
...
//                        Phrase phrase = new Phrase("Transfered Items", pFontHeader);
                      ...
                      //  table.addCell("");
                        ...
                        try {
                            ...
                            java.sql.ResultSet rset = st.executeQuery("select initcap(ss.item),sum(ss.issuing),sum(ss.buying_price)::numeric(10,2),sum(ss.total) from st_sub_stores ss WHERE ss.transaction_no = '" + Receipt + "' AND ss.issuing > 0 group by ss.item ORDER BY ss.item");
                            java.sql.Statement stt = connectDB.createStatement();
                            ...
                            phrase = new Phrase("Received By : " + GetItemInfo.getIRQUser(Receipt, connectDB), pFontHeader);
                            table.addCell(phrase);
