 ...
 * @author  root
 */
public class RaiseProcRequisIntfrintfr extends javax.swing.JInternalFrame {
    ...
    public RaiseProcRequisIntfrintfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {
        ...
        */
        ...
        setMaximizable(true);
        setResizable(true);
        setTitle("Reversal Requisitions For Procurement");
        setVisible(true);
...
com.afrisoftech.hospinventory.RaiseProcRequisintfr other = new RaiseProcRequisintfr(connectDB, pConnDB);
...
com.afrisoftech.hospinventory.MergingReqIntfr other = new MergingReqIntfr(connectDB, pConnDB);
    ...
    private void jSearchTable11MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jSearchTable11MouseClicked
        jTextField361.setText(jSearchTable11.getValueAt(jSearchTable11.getSelectedRow(), 0).toString());
           jComboBox1.setSelectedItem(jSearchTable11.getValueAt(jSearchTable11.getSelectedRow(), 1).toString());
...
private void populateTable11(java.lang.String patient_no) {
        ...
        try {
            ...
            java.sql.ResultSet rsetTable = stmtTable.executeQuery("SELECT item_description,units,quantity*units::numeric,price,(quantity*price*units::numeric)::numeric(15,2),balance FROM st_receive_requisation WHERE requisition_no ilike '"+jTextField361.getText()+"' order by item_description");
...
// Add your handling code here:
    ...
    private void searchButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchButton1ActionPerformed
        ...
        try {
            java.sql.Statement stmt = connectDB.createStatement();
            java.sql.ResultSet rset = stmt.executeQuery("SELECT count(requisition_no) FROM st_receive_requisation WHERE requisition_no ilike '%RQ%'");
           ...
           // }
            ...
            for (int i = 0; i < jTable1.getRowCount(); i++){
                if (jTable1.getModel().getValueAt(i,2) != null){
                    ...
                    pstmt.setDouble(6,java.lang.Double.valueOf(jTable1.getValueAt(i,2).toString())*-1);
...
// pstmt.setDate(8,com.afrisoftech.lib.SQLDateFormat.getSQLDate(java.util.Calendar.getInstance().getTime()));
                    ...
                    pstmt.setString(12,jTextField361.getText());
                    ...
                    pstmt.setObject(17,jTable1.getValueAt(i,4).toString());
             ...
             java.sql.PreparedStatement pstmt221 = connectDB.prepareStatement("UPDATE st_receive_requisation set processed=true,issiued = true, analysed=true WHERE requisition_no = '"+jTextField361.getText()+"'");
            ...
            com.afrisoftech.hospinventory.ProcuremenrReqPdf policy = new com.afrisoftech.hospinventory.ProcuremenrReqPdf();
                ...
                policy.ProcuremenrReqPdf(connectDB,jComboBox1.getSelectedItem().toString(),transNo);
