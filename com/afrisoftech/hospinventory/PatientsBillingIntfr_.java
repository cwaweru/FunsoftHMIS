...
public class PatientsBillingIntfr_ extends javax.swing.JInternalFrame {
    ...
    boolean printPrescription = false;
    org.netbeans.lib.sql.pool.PooledConnectionSource pConnDB = null;
    private boolean refreshStatus;
    static com.afrisoftech.timeseries.YearyAgeing ageingSeries = null;
    ...
    private static boolean insertHpPharmacy = false;
    double schemeDrugsMarkup = 1.00;

    String userName = null;
    private boolean printPrescriptionLabels = false;
    private boolean printAllPrescriptions = false;
    ...
    public PatientsBillingIntfr_(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
        ...
        printPrescription = com.afrisoftech.lib.StoreFactory.checkPrintPrescription(connectDB);
        printPrescriptionLabels = com.afrisoftech.lib.StoreFactory.checkPrintPrescriptionLabels(connectDB);
        printAllPrescriptions = com.afrisoftech.lib.StoreFactory.checkPrintAllPrescription(connectDB);
        if (com.afrisoftech.lib.StoreFactory.getDrugsSource(connectDB)) {
            mainStoreCbx.setSelected(true);
            individualItemsCbx.setEnabled(false);
        } else {
            individualItemsCbx.setSelected(true);
            mainStoreCbx.setEnabled(false);
        }
    ...
    private void initComponents() {
        ...
        medicinesSearchPanel = new javax.swing.JPanel();
        medicinesSearchTxt = new javax.swing.JTextField();
        medicinesSearchScrollPane = new javax.swing.JScrollPane();
        medicinesSearchTable = new com.afrisoftech.dbadmin.JTable();
        medicinesSearchCloseBtn = new javax.swing.JButton();
        ...
        addServiceFeeBtn = new javax.swing.JButton();
        wardNameLbl = new javax.swing.JLabel();
        wardNameTxt = new javax.swing.JTextField();
        individualItemsCbx = new javax.swing.JRadioButton();
        ...
        viewPatientBillBtn = new javax.swing.JButton();
        patientCradBtn = new javax.swing.JButton();
        printPrescriptionLabelsBtn = new javax.swing.JButton();
        prescriptionCommentsJscrl = new javax.swing.JScrollPane();
        precsriptionCommentsTxt = new javax.swing.JTextPane();
        printAllDrugsBtn = new javax.swing.JButton();
        ...
        opChbx = new javax.swing.JCheckBox();
        ipChbx = new javax.swing.JCheckBox();
        ...
        */
        ...
        medicinesSearchdialog.setModal(true);
        medicinesSearchdialog.setUndecorated(true);
        medicinesSearchdialog.getContentPane().setLayout(new java.awt.GridBagLayout());

        medicinesSearchPanel.setBorder(javax.swing.BorderFactory.createEtchedBorder());
        medicinesSearchPanel.setLayout(new java.awt.GridBagLayout());

        medicinesSearchTxt.addCaretListener(new javax.swing.event.CaretListener() {
            public void caretUpdate(javax.swing.event.CaretEvent evt) {
                medicinesSearchTxtCaretUpdate(evt);
            }
        });
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
        ...
        medicinesSearchPanel.add(medicinesSearchTxt, gridBagConstraints);

        medicinesSearchTable.setShowHorizontalLines(false);
        /*    try {
        ...
        */
        medicinesSearchTable.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                medicinesSearchTableMouseClicked(evt);
            }
            public void mouseEntered(java.awt.event.MouseEvent evt) {
                medicinesSearchTableMouseEntered(evt);
            }
        });
        ...
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 20.0;
        medicinesSearchPanel.add(medicinesSearchScrollPane, gridBagConstraints);

        medicinesSearchCloseBtn.setText("Dispose");
        medicinesSearchCloseBtn.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                medicinesSearchCloseBtnActionPerformed(evt);
            }
        });
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
        medicinesSearchPanel.add(medicinesSearchCloseBtn, gridBagConstraints);
        ...
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
        medicinesSearchdialog.getContentPane().add(medicinesSearchPanel, gridBagConstraints);
        ...
        */
        ...
        //try {
            ...
            prescriptionNoTxt.setEditable(false);
            prescriptionNoTxt.setBorder(javax.swing.BorderFactory.createTitledBorder("Presc. No."));
            gridBagConstraints = new java.awt.GridBagConstraints();
            gridBagConstraints.gridx = 2;
            gridBagConstraints.gridy = 0;
            gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
            ...
            dispenseHeader2panel.add(prescriptionNoTxt, gridBagConstraints);
            ...
            pharmacyCmbx.setModel(com.afrisoftech.lib.ComboBoxModel.ComboBoxModel(connectDB, "select '-' union select distinct stores from store_allocation where user_name = current_user and type ilike 'bill' ORDER BY 1"));
            ...
            mainItemsTbl.setModel(new javax.swing.table.DefaultTableModel(
                ...
                new String [] {
                    "Medicine", "Qty", "Avl Qty", "Price", "Disc", "Total", "Gl Account", "Item Code", "Strength", "Prescrption No", "Dosage", "Frequency", "No. of Days"
                }
            ) {
                Class[] types = new Class [] {
                    java.lang.Object.class, java.lang.Integer.class, java.lang.Double.class, java.lang.Double.class, java.lang.Double.class, java.lang.Double.class, java.lang.Object.class, java.lang.Object.class, java.lang.Object.class, java.lang.Object.class, java.lang.Object.class, java.lang.Object.class, java.lang.Object.class
                };
            ...
            */
            ...
            javax.swing.table.TableColumn teditor1 = this.mainItemsTbl.getColumn("Frequency");
            ...
            javax.swing.table.TableColumn teditor3 = this.mainItemsTbl.getColumn("No. of Days");
            ...
            javax.swing.table.TableColumn teditor4 = this.mainItemsTbl.getColumn("Dosage");
            ...
            addServiceFeeBtn.setBackground(new java.awt.Color(204, 204, 255));
            addServiceFeeBtn.setForeground(new java.awt.Color(0, 0, 204));
            addServiceFeeBtn.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Icons/32x32/Control Panel 2.png"))); // NOI18N
            addServiceFeeBtn.setText("Add Service Fee   ");
            addServiceFeeBtn.setBorder(new javax.swing.border.MatteBorder(null));
            addServiceFeeBtn.addActionListener(new java.awt.event.ActionListener() {
                public void actionPerformed(java.awt.event.ActionEvent evt) {
                    addServiceFeeBtnActionPerformed(evt);
                }
            });
            gridBagConstraints = new java.awt.GridBagConstraints();
            gridBagConstraints.gridx = 5;
            ...
            gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
            gridBagConstraints.insets = new java.awt.Insets(0, 0, 0, 10);
            jPanel23.add(addServiceFeeBtn, gridBagConstraints);
            ...
            buttonGroup7.add(individualItemsCbx);
            individualItemsCbx.setSelected(true);
            individualItemsCbx.setText("Individual Items");
            gridBagConstraints = new java.awt.GridBagConstraints();
            gridBagConstraints.gridx = 0;
            gridBagConstraints.gridy = 12;
            jPanel23.add(individualItemsCbx, gridBagConstraints);

            buttonGroup7.add(packagesCbx);
            ...
            buttonGroup7.add(mainStoreCbx);
            mainStoreCbx.setText("Main Store Items");
            gridBagConstraints = new java.awt.GridBagConstraints();
            gridBagConstraints.gridx = 1;
            gridBagConstraints.gridy = 12;
            jPanel23.add(mainStoreCbx, gridBagConstraints);
            ...
            jPanel2.add(searchDrugByCodeChkbx);
            ...
            jPanel2.add(searchDrugByDescriptionChkbx);
            ...
            jLabel532.setText("Gross Amount");
            gridBagConstraints = new java.awt.GridBagConstraints();
            gridBagConstraints.gridx = 6;
            gridBagConstraints.gridy = 4;
            gridBagConstraints.weightx = 1.0;
            ...
            dispenseBtn.setBackground(new java.awt.Color(0, 204, 204));
            dispenseBtn.setMnemonic('s');
            dispenseBtn.setText("Bill/Dispense item(s)");
            dispenseBtn.setToolTipText("Click here enter data");
            ...
            gridBagConstraints.weightx = 1.0;
            gridBagConstraints.weighty = 1.0;
            pharmacistActionPanel.add(dispenseBtn, gridBagConstraints);
            ...
            gridBagConstraints.weightx = 1.0;
            gridBagConstraints.weighty = 1.0;
            pharmacistActionPanel.add(removeRowBtn, gridBagConstraints);
            ...
            gridBagConstraints.weightx = 1.0;
            gridBagConstraints.weighty = 1.0;
            pharmacistActionPanel.add(clearFormBtn, gridBagConstraints);
            ...
            gridBagConstraints.weightx = 1.0;
            gridBagConstraints.weighty = 1.0;
            pharmacistActionPanel.add(helpBtn, gridBagConstraints);
            ...
            gridBagConstraints.weightx = 1.0;
            gridBagConstraints.weighty = 1.0;
            pharmacistActionPanel.add(savePrintBtn, gridBagConstraints);

            reprintBtn.setMnemonic('R');
            reprintBtn.setText("Reprint");
            reprintBtn.setToolTipText("Click here enter data");
            ...
            gridBagConstraints.weightx = 1.0;
            gridBagConstraints.weighty = 1.0;
            pharmacistActionPanel.add(reprintBtn, gridBagConstraints);
            ...
            gridBagConstraints.weightx = 1.0;
            gridBagConstraints.weighty = 1.0;
            pharmacistActionPanel.add(readSmartCardBtn, gridBagConstraints);

            viewPatientBillBtn.setText("View Patient Bill");
            viewPatientBillBtn.addActionListener(new java.awt.event.ActionListener() {
                public void actionPerformed(java.awt.event.ActionEvent evt) {
                    viewPatientBillBtnActionPerformed(evt);
                }
            });
            gridBagConstraints = new java.awt.GridBagConstraints();
            gridBagConstraints.gridx = 0;
            ...
            gridBagConstraints.weightx = 1.0;
            gridBagConstraints.weighty = 1.0;
            pharmacistActionPanel.add(viewPatientBillBtn, gridBagConstraints);
            ...
            printPrescriptionLabelsBtn.setBackground(new java.awt.Color(255, 204, 204));
            printPrescriptionLabelsBtn.setText("Print Prescription");
            printPrescriptionLabelsBtn.addActionListener(new java.awt.event.ActionListener() {
                public void actionPerformed(java.awt.event.ActionEvent evt) {
                    printPrescriptionLabelsBtnActionPerformed(evt);
                }
            });
            gridBagConstraints = new java.awt.GridBagConstraints();
            gridBagConstraints.gridx = 0;
            gridBagConstraints.gridy = 6;
            gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
            pharmacistActionPanel.add(printPrescriptionLabelsBtn, gridBagConstraints);

            precsriptionCommentsTxt.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Prescription Comments", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Dialog", 1, 10), new java.awt.Color(51, 51, 255))); // NOI18N
            prescriptionCommentsJscrl.setViewportView(precsriptionCommentsTxt);
            ...
            pharmacistActionPanel.add(prescriptionCommentsJscrl, gridBagConstraints);

            printAllDrugsBtn.setMnemonic('h');
            printAllDrugsBtn.setText("Print All Drugs");
            printAllDrugsBtn.addActionListener(new java.awt.event.ActionListener() {
                public void actionPerformed(java.awt.event.ActionEvent evt) {
                    printAllDrugsBtnActionPerformed(evt);
                }
            });
            gridBagConstraints = new java.awt.GridBagConstraints();
            gridBagConstraints.gridx = 0;
            ...
            gridBagConstraints.weightx = 1.0;
            gridBagConstraints.weighty = 1.0;
            pharmacistActionPanel.add(printAllDrugsBtn, gridBagConstraints);
            ...
            buttonGroup5.add(opChbx);
            opChbx.setText("OP");
            jPanel1.add(opChbx, new java.awt.GridBagConstraints());

            buttonGroup5.add(ipChbx);
            ipChbx.setText("IP");
            gridBagConstraints = new java.awt.GridBagConstraints();
            gridBagConstraints.gridx = 1;
            gridBagConstraints.gridy = 0;
            jPanel1.add(ipChbx, gridBagConstraints);
            ...
            gridBagConstraints.weightx = 1.0;
            gridBagConstraints.weighty = 1.0;
            pharmacistWorkLoadPanel.add(jPanel1, gridBagConstraints);
            ...
            pharmacyTabbedPane.getAccessibleContext().setAccessibleName("");
...
//            java.sql.ResultSet rst11 = ps11.executeQuery("select code from pb_activity WHERE activity ilike '" + pharmacyCmbx.getSelectedItem() + "'");
    ...
    private void medicinesSearchTableMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_medicinesSearchTableMouseEntered
// TODO add your handling code here:
    }//GEN-LAST:event_medicinesSearchTableMouseEntered
    ...
    private void dispenseDiscountAmountTxtKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_dispenseDiscountAmountTxtKeyReleased
        if (dispenseDiscountAmountTxt.getText().equalsIgnoreCase("")) {
            ...
            try {
                ...
                java.sql.ResultSet rs1 = pstmt1.executeQuery("select disc_allowed from st_stock_control  WHERE UPPER(store) =  '" + pharmacyCmbx.getSelectedItem().toString().toUpperCase() + "'"); //from orders where supplier ='"+jTable1.getValueAt(i,4).toString()+"'");
...
// TODO add your handling code here:
    ...
    private void jSearchTable4MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jSearchTable4MouseClicked
        ...
        //irq036423 43359
        try {
            java.sql.PreparedStatement pstmt1 = connectDB.prepareStatement("select income_account from pb_departments WHERE UPPER(department_name) = ? ");
            ...
            pstmt1.setString(1, pharmacyCmbx.getSelectedItem().toString().toUpperCase());
...
//0794260
        ...
        try {
            for (int i = 0; i < mainItemsTbl.getRowCount(); i++) {
                if (mainItemsTbl.getModel().getValueAt(i, 0) != null) {
                    java.sql.Statement pstmt = connectDB.createStatement();
                    double Qty = 0.00;
                    java.sql.ResultSet rs = pstmt.executeQuery("select coalesce(sum(qty),0) from stock_balance_qty where item_code ilike '" + mainItemsTbl.getValueAt(i, 7) + "' and department ilike '" + pharmacyCmbx.getSelectedItem().toString() + "' AND dates::date <= '" + SQLDateFormat.getSQLDate(dispenseDatePicker.getDate()) + "'");
    ...
    private void dispenseBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_dispenseBtnActionPerformed
        ...
        try {
            ...
            java.sql.Statement pstmt1 = connectDB.createStatement();
            java.sql.ResultSet rs1 = pstmt1.executeQuery("select neg_allow from st_stock_control WHERE UPPER(store) =  '" + pharmacyCmbx.getSelectedItem().toString().toUpperCase() + "' "); //from orders where supplier ='"+jTable1.getValueAt(i,4).toString()+"'");

            while (rs1.next()) {

                neggg = rs1.getBoolean(1);
            }
            ...
            for (int i = 0; i < mainItemsTbl.getRowCount(); i++) {
                ...
                if (mainItemsTbl.getModel().getValueAt(i, 0) != null && mainItemsTbl.getModel().getValueAt(i, 5) != null) {
                    if (Double.parseDouble(mainItemsTbl.getModel().getValueAt(i, 5).toString()) > 0) {
                        float bal = java.lang.Float.parseFloat(mainItemsTbl.getValueAt(i, 2).toString());
                        float qty = java.lang.Float.parseFloat(mainItemsTbl.getValueAt(i, 1).toString());
                        if (bal >= qty) {

                        } else {
                            if (bal < qty) {

                                mainItemsTbl.setValueAt(0, i, 5);
                                mainItemsTbl.setValueAt(0, i, 1);
                                negg = true;
                                negs = negs + mainItemsTbl.getValueAt(i, 0).toString() + "\n";
                                //    com.afrisoftech.lib.ClearTable.removeRow(mainItemsTbl, i);
                            }
                        }
                    }
                }
        ...
        if (negg) {
            javax.swing.JOptionPane.showMessageDialog(this, "You are not allowed to dispense more than the available stock for the following item \n" + negs, "Error Message!", javax.swing.JOptionPane.ERROR_MESSAGE);

        } else if (pharmacyCmbx.getSelectedItem().toString().equalsIgnoreCase("-") || gLCodeTxt.getText().isEmpty()) {
        ...
        } else if (patientNumberTxt.getText().length() > 0 && patientNameTxt.getText().length() > 0) {
                    ...
                    try {
                        ...
                        if (dispenseDatePicker.getDate().before(periodFrom) || dispenseDatePicker.getDate().after(periodTo)) {
                            ...
                            if (exitOption == javax.swing.JOptionPane.YES_OPTION) {
                                ...
                                if (patientNumberTxt.getText().startsWith("WK")) {
                                    patientSource = "WI";
                                }
...
//                                            Double calc_= Quant*price_;
                                            ...
                                            if (mainItemsTbl.getModel().getValueAt(i, 0) != null && mainItemsTbl.getModel().getValueAt(i, 5) != null) {
                                                if (Double.parseDouble(mainItemsTbl.getModel().getValueAt(i, 5).toString()) >= 0) {
                                                    ...
                                                    java.sql.ResultSet rs11c1 = pst21c1.executeQuery("SELECT activity FROM pb_activity WHERE code = '" + gLCodeTxt.getText() + "'");
                                                    while (rs11c1.next()) {
                                                    ...
                                                    if (!mainItemsTbl.getValueAt(i, 0).toString().equalsIgnoreCase("DISPENSING FEE")) {
                                                        ...
                                                        pstmt33.setString(19, patientSource);
                                                    ...
                                                    if (inpatientChkbx.isSelected() == true) {
                                                        ...
                                                        System.err.println("UPDATE hp_pharmacy SET collected = true WHERE  paid = true and prescription_no='" + mainItemsTbl.getModel().getValueAt(i, 9) + "' and item_code = '" + mainItemsTbl.getModel().getValueAt(i, 7) + "' AND patient_no = '" + patientNumberTxt.getText() + "' AND gl_code = '" + mainItemsTbl.getModel().getValueAt(i, 6) + "'");
                                        ...
                                        if (discounte > 0) {
                                            ...
                                            pstmtu.setTimestamp(27, com.afrisoftech.lib.ServerTime.getSQLTimeStamp(connectDB));
                                        ...
                                        if (mainItemsTbl.getModel().getValueAt(i, 0) != null && mainItemsTbl.getModel().getValueAt(i, 5) != null) {
                                            if (Double.parseDouble(mainItemsTbl.getModel().getValueAt(i, 5).toString()) >= 0) {
                                                ...
                                                if (paymentModeCmbx.getSelectedItem().equals("Scheme")) {
                                                    ...
                                                    System.err.println("UPDATE pb_doctors_request SET collected = true WHERE  prescription_no='" + mainItemsTbl.getModel().getValueAt(i, 9) + "'  "
                                                            + " and gl_code = '" + mainItemsTbl.getModel().getValueAt(i, 7) + "' AND patient_no = '" + patientNumberTxt.getText() + "'");
                                                    pstmt311 = connectDB.prepareStatement("UPDATE pb_doctors_request SET collected = true WHERE  prescription_no='" + mainItemsTbl.getModel().getValueAt(i, 9) + "'  "
                                                            + " and gl_code = '" + mainItemsTbl.getModel().getValueAt(i, 7) + "' AND patient_no = '" + patientNumberTxt.getText() + "' ");
                                                    pstmt311.executeUpdate();
                                ...
                                for (int k = 0; k < mainItemsTbl.getRowCount(); k++) {
                                    if (mainItemsTbl.getValueAt(k, 0) != null && mainItemsTbl.getValueAt(k, 10) != null && mainItemsTbl.getValueAt(k, 12) != null) {
                                        java.sql.PreparedStatement pstmtPresc = connectDB.prepareStatement("INSERT INTO public.prescription_detail("
                                                + "            patient_no, patient_name, pharmacy_name, dosage, frequency, no_of_days, "
                                                + "            prescription_no,  doctor_prescribing, comments, "
                                                + "            medicine_name)"
                                                + "    VALUES (?, ?, ?, ?, "
                                                + "            ?, ?, ?, ?, ?, "
                                                + "            ?)");
                                        pstmtPresc.setString(1, patientNumberTxt.getText());
                                        pstmtPresc.setString(2, patientNameTxt.getText());
                                        pstmtPresc.setString(3, pharmacyCmbx.getSelectedItem().toString());
                                        pstmtPresc.setObject(4, mainItemsTbl.getValueAt(k, 10));
                                        pstmtPresc.setObject(5, mainItemsTbl.getValueAt(k, 11));
                                        pstmtPresc.setObject(6, mainItemsTbl.getValueAt(k, 12));
                                        pstmtPresc.setString(7, transNo);
                                        pstmtPresc.setObject(8, doctorPrescribingCmbx.getSelectedItem());
                                        pstmtPresc.setString(9, precsriptionCommentsTxt.getText());
                                        pstmtPresc.setObject(10, mainItemsTbl.getValueAt(k, 0));
                                        pstmtPresc.execute();

                                        // print prescription labels on separate labels per item - Needs column print_prescription_labels (boolean) default false in pb_patient_names
                                        // Requires label printers
                                        if (printPrescriptionLabels) {
                                            com.afrisoftech.reports.PrescriptionsPdf prescDetailsPdf = new com.afrisoftech.reports.PrescriptionsPdf();
                                            prescDetailsPdf.PrescriptionsPdf(connectDB, transNo, mainItemsTbl.getValueAt(k, 0).toString());
                                        }
                                    }
                                }
                                connectDB.commit();
...
//                                com.afrisoftech.reports.PrescriptionsPdf prescDetailsPdf = new com.afrisoftech.reports.PrescriptionsPdf();
//                                prescDetailsPdf.PrescriptionsPdf(connectDB, transNo);
                                //   javax.swing.JOptionPane.showMessageDialog(new java.awt.Frame(), "Insert Done Successfully " + transNo, "Confirmation Message", javax.swing.JOptionPane.INFORMATION_MESSAGE);
                                // Printout for the bill if connected to athermal printer or other printer only for scheme/insurance patients
// Changed by CWW July '22 to print bills and prescriptions - needs database columns in pb_patient_names - print_prescriptions for print bills and print_all_prescriptions for printing prescriptions
                                if (paymentModeCmbx.getSelectedItem().toString().equalsIgnoreCase("Scheme") && printPrescription) {
                                    com.afrisoftech.txtreports.GokBillingTxt billPrint = new com.afrisoftech.txtreports.GokBillingTxt(connectDB, patientNameTxt.getText(), dispenseNetBillTxt.getText(), transNo, "Scheme");
                                }
                                
                                if (printAllPrescriptions) {
                                    com.afrisoftech.txtreports.PrescriptionTxt policy = new com.afrisoftech.txtreports.PrescriptionTxt(connectDB, patientNumberTxt.getText(), patientNameTxt.getText(), prescriptionNoTxt.getText(), paymentModeCmbx.getSelectedItem().toString());
                                }
...
//            if(mainItemstbl.getValueAt(i, 0)!=null){
    ...
    private void medicinesSearchCloseBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_medicinesSearchCloseBtnActionPerformed
        this.medicinesSearchdialog.dispose();        // Add your handling code here:
    }//GEN-LAST:event_medicinesSearchCloseBtnActionPerformed

    private void medicinesSearchTxtCaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_medicinesSearchTxtCaretUpdate
        ...
        if (medicinesSearchTxt.getCaretPosition() > 3) {
            ...
            if (receiptTxt.getText().trim().length() > 1) {
                ...
                if (paymentModeCmbx.getSelectedItem().toString().equalsIgnoreCase("Scheme")) {
                    System.err.println("Scheme Patient Markup " + schemeDrugsMarkup);
                    medicinesSearchTable.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB, "select DISTINCT product AS product, CEILING(selling_price * " + schemeDrugsMarkup + ") AS selling_price , '" + gLCodeTxt.getText() + "' AS gl_code,product_id, strength FROM stockprices WHERE department ilike  '" + pharmacyCmbx.getSelectedItem().toString() + "' AND  (product_id ILIKE '%" + medicinesSearchTxt.getText().toString() + "%' OR product ILIKE '%" + medicinesSearchTxt.getText().toString() + "%') AND product not ilike '%dispensing%'  order by product"));
                } else {
                    System.err.println("Cash Patient Markup ");
                    medicinesSearchTable.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB, "select DISTINCT product AS product, selling_price, '" + gLCodeTxt.getText() + "' AS gl_code,product_id, strength FROM stockprices WHERE department ilike  '" + pharmacyCmbx.getSelectedItem().toString() + "' AND (product_id ILIKE '%" + medicinesSearchTxt.getText().toString() + "%' OR product ILIKE '%" + medicinesSearchTxt.getText().toString() + "%') AND product not ilike '%dispensing%'  order by product"));
                }
            }////  jSearchTable3.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB, "select DISTINCT product AS product, selling_price, '" + gLCodeTxt.getText() + "' AS gl_code,product_id, strength FROM stockprices WHERE  department ilike '%" + pharmacyCmbx.getSelectedItem().toString() + "%' AND (product_id ILIKE '%" + jTextField114.getText().toString() + "%' OR product ILIKE '%" + jTextField114.getText().toString() + "%') AND product not ilike '%dispensing%'  order by product"));
...
//            System.out.println("Cannot sort out");
            javax.swing.table.TableColumn column = null;
            for (int i = 0; i < medicinesSearchTable.getColumnCount(); i++) {
                column = medicinesSearchTable.getColumnModel().getColumn(i);
                if (i == 0) {
    ...
    }//GEN-LAST:event_medicinesSearchTxtCaretUpdate

    private void medicinesSearchTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_medicinesSearchTableMouseClicked
        ...
        try {
            if (individualItemsCbx.isSelected() || mainStoreCbx.isSelected()) {
                ...
                if (serviceSchemeExclusion) {
                    javax.swing.JOptionPane.showMessageDialog(this, medicinesSearchTable.getValueAt(medicinesSearchTable.getSelectedRow(), 0) + " is NOT covered by " + jTextField14.getText() + " scheme", "Caution Message", javax.swing.JOptionPane.INFORMATION_MESSAGE);

                } else {
                    mainItemsTbl.setValueAt(medicinesSearchTable.getValueAt(medicinesSearchTable.getSelectedRow(), 0), mainItemsTbl.getSelectedRow(), 0);
                    mainItemsTbl.setValueAt(medicinesSearchTable.getValueAt(medicinesSearchTable.getSelectedRow(), 1), mainItemsTbl.getSelectedRow(), 3);
                    mainItemsTbl.setValueAt(medicinesSearchTable.getValueAt(medicinesSearchTable.getSelectedRow(), 2), mainItemsTbl.getSelectedRow(), 6);
                    mainItemsTbl.setValueAt(new java.lang.Double(0), mainItemsTbl.getSelectedRow(), 4);
                    mainItemsTbl.setValueAt(medicinesSearchTable.getValueAt(medicinesSearchTable.getSelectedRow(), 3), mainItemsTbl.getSelectedRow(), 7);
                    mainItemsTbl.setValueAt(medicinesSearchTable.getValueAt(medicinesSearchTable.getSelectedRow(), 4), mainItemsTbl.getSelectedRow(), 8);
                    ...
                    double issuing = 0.00;
                    double total = 0.00;
                    double itemPrice = Double.valueOf(mainItemsTbl.getValueAt(mainItemsTbl.getSelectedRow(), 3).toString());

                    java.sql.Statement pstmt = connectDB.createStatement();
                    java.sql.Statement pstmt1 = connectDB.createStatement();
                    java.sql.Statement pstmt1x = connectDB.createStatement();

                    java.sql.ResultSet rs1 = pstmt1.executeQuery("select count(product) from stockprices sc where product ilike '" + medicinesSearchTable.getValueAt(medicinesSearchTable.getSelectedRow(), 0) + "' and department ilike '" + pharmacyCmbx.getSelectedItem().toString() + "'");
                    while (rs1.next()) {
                        j = rs1.getInt(1);
                    }

                    java.sql.ResultSet rsx = null;
                    if (paymentModeCmbx.getSelectedItem().toString().contains("Scheme")) {
                        rsx = pstmt1x.executeQuery("select balance,CEILING(selling_price * " + schemeDrugsMarkup + ") AS selling_price from st_stock_prices where product_id ilike '" + medicinesSearchTable.getValueAt(medicinesSearchTable.getSelectedRow(), 3) + "' and department ilike '" + pharmacyCmbx.getSelectedItem().toString() + "'");
                    } else {

                        rsx = pstmt1x.executeQuery("select balance,selling_price from st_stock_prices where product_id ilike '" + medicinesSearchTable.getValueAt(medicinesSearchTable.getSelectedRow(), 3) + "' and department ilike '" + pharmacyCmbx.getSelectedItem().toString() + "'");
                    }
                    while (rsx.next()) {
                    ...
                    //if (j > 0) {
                    java.sql.ResultSet rs = pstmt.executeQuery("select coalesce(sum(qty),0) from stock_balance_qty where item_code ilike '" + medicinesSearchTable.getValueAt(medicinesSearchTable.getSelectedRow(), 3) + "' and department ilike '" + pharmacyCmbx.getSelectedItem().toString() + "' AND dates::date <= '" + SQLDateFormat.getSQLDate(dispenseDatePicker.getDate()) + "'");
                ...
                itemCode = medicinesSearchTable.getValueAt(medicinesSearchTable.getSelectedRow(), 3).toString();
                itemName = medicinesSearchTable.getValueAt(medicinesSearchTable.getSelectedRow(), 0).toString();

                int combiItemCount = 1;
                int currentRow = mainItemsTbl.getSelectedRow();
                ...
                while (rsetBillCombiItems.next()) {
                    ...
                    while (rsetSetCombiItems.next()) {
                        //---------------------------------------------------------
                        System.err.println("SELECT description, ROUND(" + com.afrisoftech.lib.InventoryPricing.getSellingPrice(connectDB, rsetSetCombiItems.getString(1), pharmacyCmbx.getSelectedItem().toString()) + "), ROUND((SELECT SUM(receiving-issuing) FROM st_sub_stores WHERE item_code = '" + rsetSetCombiItems.getString(1) + "'  AND upper(store_name) = '" + pharmacyCmbx.getSelectedItem().toString().toUpperCase() + "'))  as item_balance, '" + gLCodeTxt.getText() + "', strength FROM st_stock_item WHERE item_code = '" + rsetSetCombiItems.getString(1) + "'");
                        ...
                        while (rsetSetBillingVariables.next()) {
                            mainItemsTbl.setValueAt(rsetSetBillingVariables.getString(1), currentRow, 0);

                            mainItemsTbl.setValueAt(rsetSetCombiItems.getDouble(2), currentRow, 1);
                            mainItemsTbl.setValueAt(0, currentRow, 4);
                            mainItemsTbl.setValueAt(rsetSetBillingVariables.getString(4), currentRow, 6);
                            mainItemsTbl.setValueAt(rsetSetCombiItems.getString(1), currentRow, 7);
                            mainItemsTbl.setValueAt(rsetSetBillingVariables.getString(5), currentRow, 8);
                            ...
                            java.sql.ResultSet rs1 = pstmt1.executeQuery("select count(product) from stockprices sc where product ilike '" + rsetSetBillingVariables.getString(1) + "' and department ilike '" + pharmacyCmbx.getSelectedItem().toString() + "'");
                            while (rs1.next()) {
                                j = rs1.getInt(1);
                            }

                            java.sql.ResultSet rsx = pstmt1x.executeQuery("select balance,selling_price from st_stock_prices where product_id ilike '" + rsetSetCombiItems.getString(1) + "' and department ilike '" + pharmacyCmbx.getSelectedItem().toString() + "'");
                            ...
                            while (rsx.next()) {
                                ...
                                mainItemsTbl.setValueAt(itemPrice, currentRow, 3);
                                mainItemsTbl.setValueAt(Math.round(itemPrice * rsetSetCombiItems.getDouble(2)), currentRow, 5);

                            }
                            //if (j > 0) {
                            java.sql.ResultSet rs = pstmt.executeQuery("select coalesce(sum(qty),0) from stock_balance_qty where item_code ilike '" + rsetSetCombiItems.getString(1) + "' and department ilike '" + pharmacyCmbx.getSelectedItem().toString() + "' AND dates::date <= '" + SQLDateFormat.getSQLDate(dispenseDatePicker.getDate()) + "'");
...
//        if (receiptTxt.getText().length() < 1) {
    ...
    public static void setPatDetails(String patNo, String patName) {
        // jTextField32.setText("0.00");
        patientNumberTxt.setText(patNo);
        prescriptionNoTxt.setText("");
        patientNameTxt.setText(patName);
        patientCategoryTxt.setText("");
        dispenseBtn.setEnabled(true);
        // jButton121.setEnabled(true);
        //jButton122.setEnabled(true);
        ...
        try {
            ...
            while (rset1.next()) {
                ...
                jTextField14.setText(dbObject.getDBObject(rset1.getObject(3), "-"));
                jTextField1.setText(dbObject.getDBObject(rset1.getObject(3), "-"));
                memberno = dbObject.getDBObject(rset1.getObject(4), "-");
...
//                    }
                ...
                if (appLimit) {
                    ...
                    if (outstanding >= limit) {
                        javax.swing.JOptionPane.showMessageDialog(new java.awt.Frame(), "The patient has exausted the member limit", "Error Message!", javax.swing.JOptionPane.ERROR_MESSAGE);
                    } else {
                    }
                }
            }
    ...
    private void jSearchTable2121MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jSearchTable2121MouseClicked
        ...
        try {
            ...
            java.sql.ResultSet rset1d = stmt1d.executeQuery("SELECT DISTINCT inv_no  from pb_doctors_request where revenue_code ilike '%pharm%' AND trans_date >= current_date - 1 and patient_no = '" + patientNumberTxt.getText() + "' ");
            while (rset1d.next()) {
                pres = rset1d.getObject(1).toString();
            }
        } catch (java.sql.SQLException sqlex) {
            sqlex.printStackTrace();
            javax.swing.JOptionPane.showMessageDialog(this, sqlex.getMessage());
        ...
        prescriptionNoTxt.setText(pres);
        ...
        if (inpatientChkbx.isSelected()) {
            ...
            try {
                ...
                while (rset1.next()) {
                    ...
                    jTextField1.setText(dbObject.getDBObject(rset1.getObject(3), "-").toString());
...
/*
    ...
    private void workloadBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_workloadBtnActionPerformed
        ...
        if (opChbx.isSelected()) {
            pharmacistWorkloadTbl.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB, "SELECT trans_date::date,issiued_to, store_name,item_code, item,issuing QTY,  price, total, user_name  FROM st_sub_stores WHERE store_name = '" + pharmacyCmbx.getSelectedItem() + "' AND (trans_date::date BETWEEN '" + startworkloadDate.getDate() + "'  AND '" + endworkloadDate.getDate() + "') AND issiued_to ilike 'OP%' AND receiving<1 and transaction_no not like 'Stock%' ;"));

        } else if (ipChbx.isSelected()) {
            pharmacistWorkloadTbl.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB, "SELECT trans_date::date,issiued_to, store_name,item_code, item,issuing QTY,  price, total, user_name  FROM st_sub_stores WHERE store_name = '" + pharmacyCmbx.getSelectedItem() + "' AND (trans_date::date BETWEEN '" + startworkloadDate.getDate() + "'  AND '" + endworkloadDate.getDate() + "') AND  issiued_to ilike 'IP%' AND receiving<1 and transaction_no not like 'Stock%' ;"));
        ...
        try {
            ...
            java.sql.PreparedStatement ps1 = connectDB.prepareStatement("select  count (distinct issiued_to) FROM st_sub_stores WHERE store_name = '" + pharmacyCmbx.getSelectedItem() + "' AND  (issiued_to ILIKE 'IP%' OR patient_source ILIKE 'IP')  AND (trans_date::date BETWEEN '" + startworkloadDate.getDate() + "'  AND '" + endworkloadDate.getDate() + "'   );");
...
//              schemepatientTxt.setText(count_scheme.toString());
                ...
                inpatientsTXT.setText(pts);

            }

            ps1 = connectDB.prepareStatement("select  count (distinct issiued_to) FROM st_sub_stores WHERE store_name = '" + pharmacyCmbx.getSelectedItem() + "' AND  (issiued_to ILIKE 'OP%' OR patient_source ILIKE 'OP') AND (trans_date::date BETWEEN '" + startworkloadDate.getDate() + "'  AND '" + endworkloadDate.getDate() + "'   );");
            scheme = ps1.executeQuery();
            while (scheme.next()) {
//              count_scheme=  Integer.valueOf(String.valueOf(scheme.getObject(1).toString()));
//              schemepatientTxt.setText(count_scheme.toString());
                String pts = String.valueOf(scheme.getObject(1).toString());
                schemepatientTxt.setText(pts);

            }
            patientCountTxt.setText(String.valueOf(Double.valueOf(inpatientsTXT.getText()) + Double.valueOf(schemepatientTxt.getText())));
//    //------------------------------------------------------------------------------------          
...
//            
    ...
    private void viewPatientBillBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_viewPatientBillBtnActionPerformed
        // TODO add your handling code here:
        if (patientNumberTxt.getText().length() < 1) {
            javax.swing.JOptionPane.showMessageDialog(this, "Please select the patient file first ");
            pharmacyTabbedPane.setSelectedIndex(0);
    ...
    }//GEN-LAST:event_viewPatientBillBtnActionPerformed
    ...
    private void drugsCmbxActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_drugsCmbxActionPerformed
        // TODO add your handling code here:
        availableDrugsQtysTbl.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB, "SELECT initcap(store_name) Stock_Outlet, SUM(receiving - issuing) AS AVAILABLE_QTY FROM st_sub_stores WHERE item ilike '%" + drugsCmbx.getSelectedItem() + "%' GROUP BY 1 order by 2 desc "));
    ...
    private void addServiceFeeBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addServiceFeeBtnActionPerformed
        // TODO add your handling code here:
        // TODO add your handling code here:
    ...
    }//GEN-LAST:event_addServiceFeeBtnActionPerformed
...
// TODO add your handling code here:
    ...
    private void printPrescriptionLabelsBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_printPrescriptionLabelsBtnActionPerformed
...
// TODO add your handling code here:
    }//GEN-LAST:event_printPrescriptionLabelsBtnActionPerformed

    private void printAllDrugsBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_printAllDrugsBtnActionPerformed
        if (prescriptionNoTxt.getText().length() > 1) {
    ...
    }//GEN-LAST:event_printAllDrugsBtnActionPerformed
    public static void populateTable1(java.lang.String patient_no) {
        insertHpPharmacy = false;
        int j = 0;
        int i = 0;
        double Qty = 0.00;
...
//                        + " AND collected = false AND date_prescribed::date>current_date-2 GROUP BY description,price,gl_code,item_code,strength,prescription_no ");
                ...
                while (rsetTable1.next()) {
                    ...
                    rsetTable111 = stmtTable111.executeQuery("select dosage,bed_no, time_due from pb_doctors_request where prescription_no = '" + mainItemsTbl.getValueAt(i, 9).toString() + "' AND service ilike '" + mainItemsTbl.getValueAt(i, 0).toString() + "' ");

                    while (rsetTable111.next()) {
                        mainItemsTbl.setValueAt(rsetTable111.getObject(1), i, 10);
                        mainItemsTbl.setValueAt(rsetTable111.getObject(2), i, 11);
                        mainItemsTbl.setValueAt(rsetTable111.getObject(3), i, 12);
...
//        }
    ...
    private javax.swing.JButton addServiceFeeBtn;
    ...
    private static javax.swing.JButton dispenseBtn;
    private javax.swing.JLabel dispenseDateLbl;
    private static com.afrisoftech.lib.DatePicker dispenseDatePicker;
    ...
    private javax.swing.JButton medicinesSearchCloseBtn;
    private javax.swing.JPanel medicinesSearchPanel;
    private javax.swing.JScrollPane medicinesSearchScrollPane;
    private javax.swing.JTable medicinesSearchTable;
    ...
    private static javax.swing.JTextField patientCategoryTxt;
    ...
    private static javax.swing.JComboBox paymentModeCmbx;
    ...
    private static javax.swing.JComboBox pharmacyCmbx;
    public static javax.swing.JTabbedPane pharmacyTabbedPane;
    private javax.swing.JTextPane precsriptionCommentsTxt;
    private javax.swing.JScrollPane prescriptionCommentsJscrl;
    public static javax.swing.JTextField prescriptionNoTxt;
    private javax.swing.JPanel prescriptionsHistoryPanel;
    private javax.swing.JButton printAllDrugsBtn;
    private javax.swing.JButton printInterimbtn;
    private javax.swing.JButton printPrescriptionLabelsBtn;
    ...
    private javax.swing.JButton viewPatientBillBtn;
