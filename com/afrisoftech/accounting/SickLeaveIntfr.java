    ...
    private void jTextField1111CaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextField1111CaretUpdate
        ...
        if(this.jCheckBox1.isSelected() && this.jCheckBox31.isSelected()){
            ...
            if(jTextField1111.getCaretPosition() < 3){
                ...
                jSearchTable1.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"SELECT patient_no, (upper(second_name||' '||first_name||' '||last_name)) as name, account_no,description from hp_patient_register where patient_no ILIKE '"+jTextField1111.getText()+"%' and last_visit > current_date - 20 order by second_name")); 
            ...
            if(this.jCheckBox1.isSelected() && this.jCheckBox4.isSelected()){
                if(jTextField1111.getCaretPosition() < 3){
                    System.out.println("Nothing");
                     ...
                     jSearchTable1.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"SELECT patient_no, (upper(second_name||' '||first_name||' '||last_name)) as name, account_no,description from hp_patient_register where second_name||' '||first_name||' '||last_name ILIKE '"+jTextField1111.getText()+"%' and last_visit > current_date - 20 order by second_name")); 
        ...
        if(this.jCheckBox2.isSelected() && this.jCheckBox31.isSelected()){
            ...
            if(jTextField1111.getCaretPosition() < 3){
                System.out.println("Nothing");
                 ...
                 jSearchTable1.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"SELECT patient_no, (upper(second_name||' '||first_name||' '||last_name)) as name, member_no, description from hp_inpatient_register where patient_no ILIKE '"+jTextField1111.getText()+"%' order by second_name")); 
            ...
            if(this.jCheckBox2.isSelected() && this.jCheckBox4.isSelected()){
                ...
                jSearchTable1.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"SELECT patient_no, (upper(second_name||' '||first_name||' '||last_name)) as name, member_no, description from hp_inpatient_register where second_name||' '||first_name||' '||last_name ILIKE '"+jTextField1111.getText()+"%' order by second_name")); 
