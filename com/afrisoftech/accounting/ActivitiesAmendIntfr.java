...
public class ActivitiesAmendIntfr extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        subAccountCmbx = new javax.swing.JComboBox();
        jLabel5 = new javax.swing.JLabel();
        subAccountCodeTxt = new javax.swing.JTextField();
        jCheckBox11 = new javax.swing.JCheckBox();
        jCheckBox21 = new javax.swing.JCheckBox();
        jLabel7 = new javax.swing.JLabel();
        mainCOAAccountCodeTxt = new javax.swing.JTextField();
        jLabel12 = new javax.swing.JLabel();
        branchCmbx = new javax.swing.JComboBox();
        jLabel8 = new javax.swing.JLabel();
        brachCodeTxt = new javax.swing.JTextField();
        jPanel4 = new javax.swing.JPanel();
        jScrollPane21 = new javax.swing.JScrollPane();
        coaAccountsTable = new com.afrisoftech.dbadmin.JTable();
        ...
        jButton111.setText("Save chart of accounts adjustments");
        ...
        jButton211.setText("Edit existing chart of accounts");
        ...
        subAccountCmbx.setModel(com.afrisoftech.lib.ComboBoxModel.ComboBoxModel(connectDB, "select  description from pb_sub_activities ORDER BY description"));
        subAccountCmbx.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                subAccountCmbxActionPerformed(evt);
            }
        });
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        ...
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
        jPanel3.add(subAccountCmbx, gridBagConstraints);
        ...
        subAccountCodeTxt.setEditable(false);
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 3;
        gridBagConstraints.gridy = 0;
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
        gridBagConstraints.weightx = 2.0;
        gridBagConstraints.weighty = 1.0;
        jPanel3.add(subAccountCodeTxt, gridBagConstraints);
        ...
        mainCOAAccountCodeTxt.setEditable(false);
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 3;
        gridBagConstraints.gridy = 2;
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
        gridBagConstraints.weightx = 1.0;
        jPanel3.add(mainCOAAccountCodeTxt, gridBagConstraints);
        ...
        branchCmbx.setModel(com.afrisoftech.lib.ComboBoxModel.ComboBoxModel(connectDB, "SELECT INITCAP(donor) AS BRANCH FROM ac_branch ORDER BY donor"));
        branchCmbx.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                branchCmbxActionPerformed(evt);
            }
        });
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        ...
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
        jPanel3.add(branchCmbx, gridBagConstraints);
        ...
        brachCodeTxt.setEditable(false);
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 3;
        gridBagConstraints.gridy = 1;
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
        gridBagConstraints.weightx = 1.0;
        jPanel3.add(brachCodeTxt, gridBagConstraints);
        ...
        coaAccountsTable.setFont(new java.awt.Font("Dialog", 0, 10)); // NOI18N
        coaAccountsTable.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
            ...
            new String [] {
                "Account Code", "Account Name", "Activity", "Suspend", "Account Category", "New_Sub_Code", "New_Code", "Department", "Department_Code", "Category_Class"
            }
        ));
        coaAccountsTable.setShowHorizontalLines(false);
        /*java.lang.Object[] strCmb = {"Payable","Receivable","Both"};

        javax.swing.JComboBox cmBox = new javax.swing.JComboBox(strCmb);

        javax.swing.table.TableColumn teditor = this.coaAccountsTable.getColumn("Payment Mode");

        teditor.setCellEditor(new javax.swing.DefaultCellEditor(cmBox));
        */

        java.lang.Object[] strCmb2 = {"Plid","Pled","Bl","Ba", "I"};

        javax.swing.JComboBox cmBox2 = new javax.swing.JComboBox(strCmb2);

        javax.swing.table.TableColumn teditor2 = this.coaAccountsTable.getColumn("Category_Class");

        teditor2.setCellEditor(new javax.swing.DefaultCellEditor(cmBox2));

        jScrollPane21.setViewportView(coaAccountsTable);
    ...
    private void branchCmbxActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_branchCmbxActionPerformed
        try {
            java.sql.Statement stmt = connectDB.createStatement();
            java.sql.ResultSet rset = stmt.executeQuery("SELECT code FROM ac_branch WHERE donor ='" + branchCmbx.getSelectedItem() + "'");
            while (rset.next()) {
                brachCodeTxt.setText(rset.getObject(1).toString());
    ...
    }//GEN-LAST:event_branchCmbxActionPerformed

    private void jButton13ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton13ActionPerformed
        try {
            connectDB.setAutoCommit(false);
            java.sql.PreparedStatement pstmt31 = connectDB.prepareStatement("DELETE from pb_activity WHERE code = '" + coaAccountsTable.getModel().getValueAt(coaAccountsTable.getSelectedRow(), 0).toString() + "'");
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        int rows2Delete = coaAccountsTable.getSelectedRowCount();

        int[] selectedRows = coaAccountsTable.getSelectedRows();
        ...
        if (rows2Delete < 1) {
            ...
            if (rows2Delete > 1) {
                ...
                for (int i = 0; i < selectedRows.length; i++) {
                    ...
                    javax.swing.table.DefaultTableModel defTableModel = (javax.swing.table.DefaultTableModel) coaAccountsTable.getModel();
                ...
                defTableModel.removeRow(coaAccountsTable.getSelectedRow());
            }
        }
    ...
    private void jButton311ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton311ActionPerformed
        for (int k = 0; k < coaAccountsTable.getRowCount(); k++) {
            for (int r = 0; r < coaAccountsTable.getColumnCount(); r++) {
                coaAccountsTable.getModel().setValueAt(null, k, r);
            }
        }
        subAccountCmbx.setSelectedItem(null);
        subAccountCodeTxt.setText("");
        // Add your handling code here:
    ...
    private void jButton211ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton211ActionPerformed
        ...
        int i = 0;
        coaAccountsTable.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB, "select sub_code,code,activity,payment_mode as suspend,activity_category,sub_code as new_subcode,code as new_code,'' as department,department as dept_code, category_class FROM pb_activity where sub_code = '" + subAccountCodeTxt.getText() + "'  order by code"));
        ...
        javax.swing.table.TableColumn teditor1 = this.coaAccountsTable.getColumn("DEPARTMENT");
            ...
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ...
                try {
                    ...
                    while (rset.next()) {
                        ...
                        coaAccountsTable.setValueAt(branch, coaAccountsTable.getSelectedRow(), 8);
                    }
...
// Add your handling code here:
    ...
    private void jButton111ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton111ActionPerformed
        ...
        try {
            ...
            java.sql.ResultSet rsetTable11x = stmtTable11x.executeQuery("SELECT main_code,description,class  FROM pb_accounts_setup WHERE main_code = '" + mainCOAAccountCodeTxt.getText() + "'");
            ...
            for (int n = 0; n < coaAccountsTable.getRowCount(); n++) {
                if (coaAccountsTable.getModel().getValueAt(n, 8) != null) {

                    java.sql.PreparedStatement pstmt31 = connectDB.prepareStatement("UPDATE pb_activity SET activity = '" + coaAccountsTable.getModel().getValueAt(n, 2).toString() + "',activity_category = '" + coaAccountsTable.getModel().getValueAt(n, 4).toString() + "',payment_mode = '" + coaAccountsTable.getModel().getValueAt(n, 3).toString() + "',code = '" + coaAccountsTable.getModel().getValueAt(n, 6) + "',department = '" + coaAccountsTable.getModel().getValueAt(n, 8) + "',branch = '" + brachCodeTxt.getText() + "',country_name = '" + countri + "',old_code = '" + coaAccountsTable.getModel().getValueAt(n, 1) + "',sub_code = '" + coaAccountsTable.getModel().getValueAt(n, 5) + "' WHERE code ILIKE '" + coaAccountsTable.getModel().getValueAt(n, 1) + "'");
                    pstmt31.executeUpdate();
                }
            }
            connectDB.commit();
        ...
        try {
            ...
            for (int i = 0; i < coaAccountsTable.getRowCount(); i++) {
                if (coaAccountsTable.getModel().getValueAt(i, 8) != null) {
                    System.out.println("Updating data");
                    java.sql.Statement stmtTable11xx = connectDB.createStatement();

                    java.sql.ResultSet rsetTable11xx = stmtTable11xx.executeQuery("SELECT description  FROM pb_sub_activities WHERE sub_code   ILIKE '" + coaAccountsTable.getModel().getValueAt(i, 5) + "'");

                    while (rsetTable11xx.next()) {
                        subCategory = rsetTable11xx.getString(1);

                    }
                    java.sql.PreparedStatement pstmt31m = connectDB.prepareStatement("UPDATE pb_activity SET main_code = '" + mainCode + "',main_category = '" + mainCategory + "',category_class = '" + coaAccountsTable.getModel().getValueAt(i, 9) + "'  WHERE code ILIKE '" + coaAccountsTable.getModel().getValueAt(i, 6) + "'");
                    pstmt31m.executeUpdate();
                    java.sql.PreparedStatement pstmt31x = connectDB.prepareStatement("UPDATE pb_activity SET sub_category = '" + subCategory + "'  WHERE sub_code ILIKE '" + coaAccountsTable.getModel().getValueAt(i, 5) + "'");
    ...
    private void subAccountCmbxActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_subAccountCmbxActionPerformed

        try {
            java.sql.Statement stmt = connectDB.createStatement();
            java.sql.ResultSet rset = stmt.executeQuery("select sub_code,main_code from pb_sub_activities where description ='" + subAccountCmbx.getSelectedItem() + "'");
            while (rset.next()) {
                subAccountCodeTxt.setText(rset.getObject(1).toString());
                mainCOAAccountCodeTxt.setText(rset.getObject(2).toString());
            }
            rset.close();
            stmt.close();
            //  conn.close();
        ...
        // Add your handling code here:
    }//GEN-LAST:event_subAccountCmbxActionPerformed
    ...
    private javax.swing.JTextField brachCodeTxt;
    private javax.swing.JComboBox branchCmbx;
    private javax.swing.ButtonGroup buttonGroup1;
    private javax.swing.ButtonGroup buttonGroup2;
    private javax.swing.JTable coaAccountsTable;
    ...
    private javax.swing.JTextField mainCOAAccountCodeTxt;
    private javax.swing.JComboBox subAccountCmbx;
    private javax.swing.JTextField subAccountCodeTxt;
