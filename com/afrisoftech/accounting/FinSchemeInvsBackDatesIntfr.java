 ...
 * @author root
 */
public class FinSchemeInvsBackDatesIntfr extends javax.swing.JInternalFrame {
    ...
    public FinSchemeInvsBackDatesIntfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
            ...
            try {
                ...
                if (beginDate.getDate().before(periodFrom) || endDate.getDate().after(periodTo)) {
                    ...
                    if (utilizeDepositChkbx.isSelected()) {
                        if (java.lang.Double.valueOf(totalDepositBalTxt.getText().toString()) > 0) {
                            ...
                            if (java.lang.Double.valueOf(totalDepositBalTxt.getText().toString()) >= java.lang.Double.valueOf(totalNetTxt.getText().toString())) {
                                ...
                                if (balAfterUtilization > 0) {
                                    ...
                                    pstmt2v.setDate(18, com.afrisoftech.lib.SQLDateFormat.getSQLDate(java.sql.Date.valueOf(schemeDataTable.getValueAt(0, 0).toString())));//com.afrisoftech.lib.ServerTime.getSQLDate(connectDB));
                                    ...
                                    pstmt1.setDate(14, com.afrisoftech.lib.SQLDateFormat.getSQLDate(java.sql.Date.valueOf(schemeDataTable.getValueAt(0, 0).toString())));//com.afrisoftech.lib.ServerTime.getSQLDate(connectDB)); //com.afrisoftech.lib.SQLDateFormat.getSQLDate(java.sql.Date.valueOf(SchemeDataTable.getValueAt(0, 0).toString())));
                                    pstmt1.setObject(15, actCode);
                                    pstmt1.setString(16, glCode);
                                    pstmt1.setDouble(17, 1);
                                    pstmt1.setObject(18, memberNoTxt.getText());
                                    ...
                                    pstmt2v.setDate(18, com.afrisoftech.lib.SQLDateFormat.getSQLDate(java.sql.Date.valueOf(schemeDataTable.getValueAt(0, 0).toString())));//com.afrisoftech.lib.ServerTime.getSQLDate(connectDB));//com.afrisoftech.lib.SQLDateFormat.getSQLDate(java.sql.Date.valueOf(SchemeDataTable.getValueAt(0, 0).toString())));
                                    pstmt2v.setString(19, transNo);
                                    pstmt2v.setBoolean(20, false);
                                    pstmt2v.setBoolean(21, false);
                                    pstmt2v.setBoolean(22, false);
                                ...
                                if (balAfterUtilization > 0) {
                                    ...
                                    pstmt.setDate(15, com.afrisoftech.lib.SQLDateFormat.getSQLDate(java.sql.Date.valueOf(schemeDataTable.getValueAt(0, 0).toString())));//com.afrisoftech.lib.ServerTime.getSQLDate(connectDB)); //com.afrisoftech.lib.SQLDateFormat.getSQLDate(java.sql.Date.valueOf(SchemeDataTable.getValueAt(0, 0).toString())));
                        ...
                        pstmt.setDouble(14, 0.00);
                        pstmt.setObject(15, com.afrisoftech.lib.SQLDateFormat.getSQLDate(java.sql.Date.valueOf(schemeDataTable.getValueAt(0, 0).toString())));//com.afrisoftech.lib.ServerTime.getSQLDate(connectDB)); //com.afrisoftech.lib.SQLDateFormat.getSQLDate(java.sql.Date.valueOf(SchemeDataTable.getValueAt(0, 0).toString())));
                        pstmt.setObject(16, invoiceNo);
                        pstmt.setString(17, actNames1);
                        pstmt.setBoolean(18, false);
                        pstmt.setBoolean(19, false);
                    ...
                    if (Disc > 0) {
                        ...
                        pstmt1f.setDate(14, com.afrisoftech.lib.SQLDateFormat.getSQLDate(java.sql.Date.valueOf(schemeDataTable.getValueAt(0, 0).toString())));//com.afrisoftech.lib.ServerTime.getSQLDate(connectDB)); //com.afrisoftech.lib.SQLDateFormat.getSQLDate(java.sql.Date.valueOf(SchemeDataTable.getValueAt(0, 0).toString())));
