...
public class OtherPymAdjintfr extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        */
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Select Voucher Details", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Dialog", 0, 11), new java.awt.Color(204, 0, 51)));
        ...
        jPanel4.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "New Details", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Dialog", 3, 12), new java.awt.Color(51, 0, 255)));
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Initial Details", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Dialog", 0, 11), new java.awt.Color(255, 0, 255)));
    ...
    private void jTextField1131CaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextField1131CaretUpdate
        if(this.jTextField1131.getCaretPosition() < 3){
            ...
            jSearchTable21.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"select distinct voucher_no as name from ac_cash_book where voucher_no ILIKE '"+jTextField1131.getText()+"%' order by voucher_no"));
    ...
    private void jSearchTable2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jSearchTable2MouseClicked
        ...
        try {
            ...
            while (rset.next()){
                ...
                this.jComboBox4.setSelectedItem(rset.getObject(2).toString());
    ...
    private void jTextField113CaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextField113CaretUpdate
        if(this.jTextField113.getCaretPosition() < 3){
            ...
            jSearchTable2.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"select distinct voucher_no as name from ac_cash_book WHERE voucher_no ILIKE '"+jTextField113.getText()+"%' UNION SELECT distinct voucher_no as name from ac_petty_cash WHERE voucher_no ILIKE '"+jTextField113.getText()+"%' order by name"));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            java.sql.PreparedStatement pstmt = connectDB.prepareStatement("begin work; update ac_cash_book set cheque_no = '"+jTextField2.getText()+"', account_no ='"+jComboBox2.getSelectedItem()+"',bank_name = '"+jTextField5.getText()+"', account_name ='"+jTextField4.getText()+"',gl_code = '"+jTextField11.getText()+"', description ='"+jTextField31.getText()+"',payment_mode = '"+jComboBox4.getSelectedItem()+"'  WHERE voucher_no ='"+jTextField9.getText()+"' ;commit work");
            pstmt.executeUpdate();
            
            //java.sql.PreparedStatement pstmt2z = connectDB.prepareStatement("begin work; update ac_doctors_ledger set cheque_no = '"+jTextField2.getText()+"', account_no ='"+jComboBox2.getSelectedItem()+"',bank_name = '"+jTextField5.getText()+"',account_name ='"+jTextField4.getText()+"',gl_code = '"+jTextField11.getText()+"',description ='"+jTextField31.getText()+"',payment_mode = '"+jComboBox4.getSelectedItem()+"'  WHERE voucher_no ='"+jTextField9.getText()+"' ;commit work");
            ...
            pstmt21.setDouble(7,java.lang.Double.valueOf(jTextField121.getText()));
            pstmt21.setDouble(6,0.00);
            pstmt21.setString(8,user);
            pstmt21.setString(9,jComboBox2.getSelectedItem().toString());
            pstmt21.setDate(5,com.afrisoftech.lib.SQLDateFormat.getSQLDate(datePicker1.getDate()));
            ...
            while (rset.next()){
                Vouch = rset.getInt(1);
                System.out.println("Voucher count ["+Vouch+"]");
                if(Vouch >0){
                    OtherPayVoucherPdf policy = new OtherPayVoucherPdf();
                    policy.OtherPayVoucherPdf(connectDB,jTextField9.getText());
                }else{
