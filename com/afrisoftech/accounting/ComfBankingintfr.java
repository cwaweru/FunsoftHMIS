...
public class ComfBankingintfr extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        */
        ...
        jComboBox2.setModel(com.afrisoftech.lib.ComboBoxModel.ComboBoxModel(connectDB, "select DISTINCT account_name from ac_cash_book order by account_name"));
    ...
    private void jComboBox2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBox2ActionPerformed
       ...
       try {
         ...
         jTable1.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"select cheque_no,debit from ac_cash_book where account_name ='"+jComboBox2.getSelectedItem()+"' AND debit > 0 AND date = '"+datePicker1.getDate()+"' and banked = false")); 
