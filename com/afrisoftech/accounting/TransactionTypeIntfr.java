...
public class TransactionTypeIntfr extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        setMaximizable(true);
        setResizable(true);
        setTitle("Registration Points Setup");
        setVisible(true);
        ...
        headerLabel.setText("Set registration points here");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.fill = java.awt.GridBagConstraints.BOTH;
        ...
        transactionTypesTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Registration Point Code", "Registration Point Description"
            }
        ));
    ...
    private void editActionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editActionActionPerformed
        ...
        transactionTypesTable.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB, "SELECT code, transaction_type  FROM pb_transaction_type ORDER BY 2"));
            ...
            for (int i = 0; i < transactionTypesTable.getRowCount(); i++) {
                if (transactionTypesTable.getModel().getValueAt(i, 0) != null) {
                    if (newAction.getText().equalsIgnoreCase("New")) {
                        ...
                        pstmt1.setObject(1, transactionTypesTable.getValueAt(i, 0));
                        pstmt1.setObject(2, transactionTypesTable.getValueAt(i, 1));
                        pstmt1.execute();
                    } else {
                        java.sql.PreparedStatement pstmt1 = connectDB.prepareStatement("UPDATE pb_transaction_type SET transaction_type = ? WHERE code = ?");
