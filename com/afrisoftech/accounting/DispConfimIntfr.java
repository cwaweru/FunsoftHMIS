...
jSearchDialog1.dispose();        // Add your handling code here:
 ...
 private void searchButton11Clicked() {
    ...
    private void jTextField11111CaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextField11111CaretUpdate
               ...
               jSearchTable1.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"select distinct(dispatch_no) as scheme,account_no,payee from ac_debtors where dispatch_no ILIKE '"+jTextField11111.getText().toString()+"%' and account_no ilike '"+jTextField1.getText().toString()+"%' ORDER BY dispatch_no")); 
       ...
       */ 
        ...
        try {
            ...
            if (j > 0){
                ...
                java.sql.ResultSet rsetTable1 = stmtTable1.executeQuery("SELECT date::date, invoice_no, admission_no,initcap(item),debit::numeric,null as boolean FROM ac_debtors WHERE dispatch_no = '"+patient_no+"' AND balance > 0 and approved = false order by 4 asc");// and revenue_code = '"+jTextField5.getText()+"' AND paid = false");
