    ...
    private void jTextField11111CaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextField11111CaretUpdate
        if(jTextField11111.getCaretPosition() < 3){
            ...
            if(this.jCheckBox11.isSelected()){
                ...
                jSearchTable1.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"select first_name as scheme,staff_no as code from pb_doctors_list where first_name ILIKE '"+jTextField11111.getText().toString()+"%'"));
            ...
            try {
                ...
                if(jCheckBox11.isSelected()){
                    ...
                    if(this.jCheckBox1.isSelected()){
                        ...
                        pstmt.setDouble(25,java.lang.Double.valueOf(jTextField3.getText()));
                    ...
                    pstmt.setString(21,"");
                    pstmt.setDate(22,com.afrisoftech.lib.SQLDateFormat.getSQLDate(java.util.Calendar.getInstance().getTime()));
