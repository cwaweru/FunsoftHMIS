...
public class RaiseCashJournalintfr extends javax.swing.JInternalFrame {
    ...
    private void jTextField1111CaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextField1111CaretUpdate
        jSearchTable1.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"SELECT activity,code from pb_activity where (activity_category ILIKE 'E%' OR activity_category ILIKE 'C%')  and activity ILIKE '"+jTextField1111.getText()+"%' order by activity"));
            ...
            try{
                if (jTable1.getModel().getValueAt(0,0) != null){
                    ...
                    try {
                        ...
                        java.sql.Statement ps12 = connectDB.createStatement();
                        java.sql.ResultSet rst = ps.executeQuery("select nextval('reqno_no_seq')");
                        while (rst.next()){
                            rst.getObject(1).toString();
                            voucherNo = rst.getObject(1).toString();
                        }
                        java.sql.ResultSet rst1 = ps1.executeQuery("select code,activity from pb_activity where activity_category = 'PC'");
                        while (rst1.next()){
                        ...
                        java.sql.ResultSet rst12 = ps12.executeQuery("select current_user");
                        while (rst12.next()){
                            User = rst12.getObject(1).toString();
                        }
                        for (int i = 0; i < jTable1.getRowCount(); i++){
                            if (jTable1.getModel().getValueAt(i,0) != null){
                                ...
                                pstmt.setDouble(6,java.lang.Double.valueOf(jTable1.getModel().getValueAt(i,3).toString()));
                                ...
                                pstmt.setDouble(15,java.lang.Double.valueOf(jTable1.getModel().getValueAt(i,2).toString()));
