...
public class ImpDocRegisterIntfr extends javax.swing.JInternalFrame implements java.lang.Runnable {
    ...
    private void initComponents() {
        ...
        */
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Enter Document Details"));
        jLabel612.setText("A/C Code");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        ...
        gridBagConstraints.weighty = 1.0;
        gridBagConstraints.insets = new java.awt.Insets(0, 20, 0, 0);
        jPanel1.add(jLabel613, gridBagConstraints);
    ...
    private void jComboBox1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBox1ActionPerformed
        try {
            ...
            while (rs.next()){
                jTextField5412.setText(rs.getString(1));
    ...
    private void jTextField111CaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextField111CaretUpdate
        if(jTextField111.getCaretPosition() < 3){
            ...
            jSearchTable.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"select issurer_name as name from pb_documents where issurer_name ILIKE '"+jTextField111.getText().toString()+"%'"));
        ...
        try {
            ...
            if(jTextField49221.getText().equals("")){
                ...
                for(int i = StartNo;i<= endNo;i++){
                    stmt11.execute("insert into pb_documents_register(insurer_name,doc_no,doc_name,ref,start_no,end_no,date_registered,user_name,chq_no,used) values('"+jTextField36.getText()+"','"+jTextField5412.getText()+"','"+jComboBox1.getSelectedItem()+"','"+jTextField49221.getText()+"','"+jTextField50221.getText()+"','"+jTextField56121.getText()+"','"+datePicker1.getDate().toString()+"','"+User+"',lpad("+i+",6,'0'),false)");
                }
