...
public class RetunedClaimIntfr extends javax.swing.JInternalFrame {
    ...
    private void jTextField113CaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextField113CaretUpdate
        ...
        if(this.jTextField113.getCaretPosition() < 2){
            ...
            jSearchTable2.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"select invoice_no,admission_no as pat_no,item as name,date from ac_debtors  where invoice_no ILIKE '"+jTextField113.getText()+"%' and sent='t' and balance >0 order by invoice_no"));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            if(this.jTextField11.getText().equals(null) ||this.jTextField11.getText().equals("")){
                ...
                pstmt.setString(5,"");
                pstmt.setDouble(8,java.lang.Double.valueOf(jTextField2.getText()));
                ...
                pstmt.setDate(17,com.afrisoftech.lib.SQLDateFormat.getSQLDate(datePicker111.getDate()));
                pstmt.setDate(19,com.afrisoftech.lib.SQLDateFormat.getSQLDate(datePicker11.getDate()));
                pstmt.setDate(20,com.afrisoftech.lib.SQLDateFormat.getSQLDate(java.util.Calendar.getInstance().getTime()));
                pstmt.setBoolean(16,false);
                pstmt.setString(15,user);
                pstmt.setDate(18,com.afrisoftech.lib.SQLDateFormat.getSQLDate(java.sql.Date.valueOf(jTextField4.getText())));
                pstmt.executeUpdate();
