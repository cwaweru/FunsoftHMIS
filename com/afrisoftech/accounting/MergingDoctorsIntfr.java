 ...
 * @author  root
 */
public class MergingDoctorsIntfr extends javax.swing.JInternalFrame {
    ...
    public MergingDoctorsIntfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        */
        ...
        setMaximizable(true);
        setResizable(true);
        setTitle("Merging Doctors Accounts");
...
double floatDeduct = java.lang.Double.parseDouble(jTextField15.getText());
    ...
    private void jTextField11321CaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextField11321CaretUpdate
        if(this.jTextField11321.getCaretPosition() < 2){
            ...
            jSearchTable221.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"select distinct first_name as name,staff_no,status from pb_doctors_list where first_name ILIKE '%"+jTextField11321.getText()+"%' order by first_name"));
    ...
    private void jTextField1132CaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextField1132CaretUpdate
        if(this.jTextField1132.getCaretPosition() < 0){
            ...
            jSearchTable22.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"select distinct first_name as name,staff_no,status from pb_doctors_list where first_name ILIKE '%"+jTextField1132.getText()+"%' order by first_name"));
    ...
    private void jButton11ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton11ActionPerformed
        ...
        if (exitOption == javax.swing.JOptionPane.YES_OPTION) {
            ...
            try {
                ...
                java.sql.PreparedStatement pstmt22 = connectDB.prepareStatement("UPDATE ac_doctors_ledger set acc_no = '"+jTextField91.getText()+"',doctor_name = '"+jTextField13.getText()+"' WHERE acc_no = '"+jTextField911.getText()+"'");
                pstmt22.executeUpdate();
                java.sql.PreparedStatement pstmt222 = connectDB.prepareStatement("UPDATE ac_doctors_payments set account_no = '"+jTextField91.getText()+"',doc_name = '"+jTextField13.getText()+"' WHERE account_no= '"+jTextField911.getText()+"'");
                pstmt222.executeUpdate();
                java.sql.PreparedStatement pstmt223 = connectDB.prepareStatement("UPDATE dr_allocation set acc_no = '"+jTextField91.getText()+"' WHERE acc_no = '"+jTextField911.getText()+"'");
                pstmt223.executeUpdate();
                
                java.sql.PreparedStatement pstmt221 = connectDB.prepareStatement("delete from pb_doctors_list  WHERE staff_no = '"+jTextField911.getText()+"'");
