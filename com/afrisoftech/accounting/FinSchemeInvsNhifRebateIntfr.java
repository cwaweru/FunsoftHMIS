 ...
 */
public class FinSchemeInvsNhifRebateIntfr extends javax.swing.JInternalFrame {
    ...
    public FinSchemeInvsNhifRebateIntfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
        ...
        //try {
            ...
            */
            ...
            //try {
                ...
                setMaximizable(true);
                setResizable(true);
                setTitle("Compute NHIF/NHIS Rebate");
                ...
                */
                ...
                jRadioButton1.setText("Nhif Rebate     ");
                ...
                jRadioButton1.setIconTextGap(20);
                ...
                gridBagConstraints.weighty = 1.0;
                jPanel6.add(noofDaysTxt, gridBagConstraints);

                buttonGroup2.add(jRadioButton2);
                jRadioButton2.setText("No Nhif Rebate");
                ...
                jRadioButton2.setIconTextGap(20);
                ...
                postFinalBillBtn.setText("Generate NHIF/NHIS Invoice");
                ...
                gridBagConstraints.weightx = 1.0;
                gridBagConstraints.weighty = 1.0;
                jPanel5.add(closeFormBtn, gridBagConstraints);
                ...
                removeRowBtn.setText("R A/C Row");
                ...
                gridBagConstraints.weightx = 1.0;
                gridBagConstraints.weighty = 1.0;
                jPanel7.add(netValueTxt, gridBagConstraints);
    ...
    private void refundTxtKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_refundTxtKeyReleased
        ...
        float disc = java.lang.Float.parseFloat(netValueTxt.getText());
        ...
        if (schemeInvoicingTable.getModel().getValueAt(schemeInvoicingTable.getSelectedRow(), 2) != null) {
            if (schemeInvoicingTable.getSelectedColumn() == schemeInvoicingTable.getSelectedColumn()) {
                ...
                if (jRadioButton1.isSelected()) {
                    ...
                    double totalSum = com.afrisoftech.lib.TableColumnTotal.getTableColumnTotal(schemeInvoicingTable, 2);
                    netValueTxt.setText(java.lang.String.valueOf(bill - (totalSum + deposit + rebate)));
                }
            }
        }
        /*
...
// this.tableModelTableChanged();// Add your handling code here:
    ...
    private void jRadioButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jRadioButton2ActionPerformed
        ...
        try {
            ...
            netValueTxt.setText(java.lang.String.valueOf(net + nhif));
        ...
        if (billTable.getValueAt(billTable.getSelectedRow(), 2) != null) {
            if (billTable.getModel().getValueAt(billTable.getSelectedRow(), 2) != null) {
                if (billTable.getSelectedColumn() == billTable.getSelectedColumn()) {
                    float grossTotal = java.lang.Float.parseFloat(billTotalTxt.getText().toString());
                    ...
                    netValueTxt.setText(java.lang.String.valueOf(grossTotal - totalSumDisc));
    ...
    private void jSearchTable21MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jSearchTable21MouseClicked
        ...
        try {
            ...
            while (rss111.next()) {
                ...
                noofDaysTxt.setText(java.lang.String.valueOf(noofDays));
            }
             ...
             * java.sql.ResultSet rset11 = pss1.executeQuery("select account_no
             * from ac_schemes where scheme_name = '"+jTextField71.getText()+"'
             * and payer_name = '"+jTextField41.getText()+"'"); while
             * (rset11.next()){ code = dbObject.getDBObject(rset11.getObject(1),
            ...
            java.sql.ResultSet rss11s = pss11s.executeQuery("select round(sum(debit-credit),2) from hp_patient_card where patient_no = '" + patientNumberTxt.getText() + "' AND visit_id = '" + visitIDTxt.getText() + "' AND (invoice_no NOT LIKE 'I%' OR invoice_no NOT LIKE 'O%')");
            while (rss11s.next()) {
                netValueTxt.setText(dbObject.getDBObject(rss11s.getObject(1), "0.00"));
                // jTextField23.setText(rss11.getObject(1).toString());
            }

            java.sql.Statement pss11c = connectDB.createStatement();
            java.sql.ResultSet rss11c = pss11c.executeQuery("select round(sum(credit-debit),2) from hp_patient_card where patient_no = '" + patientNumberTxt.getText() + "' AND visit_id = '" + visitIDTxt.getText() + "' AND (invoice_no NOT LIKE 'I%' OR invoice_no NOT LIKE 'O%') AND service ilike 'Receipt%'");
            while (rss11c.next()) {
    ...
    private void populateTable2(java.lang.String patient_no) {
        ...
        try {
            ...
            if (j > 0) {
                ...
                java.sql.ResultSet rsetTable1 = stmtTable1.executeQuery("select main_service,sum(debit-credit) as amount FROM hp_patient_card WHERE patient_no ='" + patientNumberTxt.getText() + "' AND (invoice_no NOT ILIKE 'O%' OR invoice_no NOT ILIKE 'I%')  AND visit_id = '" + visitIDTxt.getText() + "' GROUP BY main_service");
...
//        this.getContentPane().removeAll();
    ...
    private void postFinalBillBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_postFinalBillBtnActionPerformed
        if (Double.parseDouble(netValueTxt.getText()) <= 0) {
            ...
            if (admissionDatePicker.getDate().before(periodFrom) || dischargeDatePicker.getDate().after(periodTo)) {
                ...
                String ward = null;
                String bed_no = null;
                int exitOption = javax.swing.JOptionPane.showConfirmDialog(this, "Do you want to Finalise NHIF Invoice?", "Caution before Finalising Invoice!", javax.swing.JOptionPane.YES_NO_CANCEL_OPTION);
                ...
                if (exitOption == javax.swing.JOptionPane.YES_OPTION) {
                    ...
                    try {
                        ...
                        if (jRadioButton1.isSelected()) {
                            ...
                            double bill = java.lang.Double.parseDouble(netValueTxt.getText());
                            ...
                            // invoiceNo = this.jTextField19.getText();
                           ...
                           /* if (claims > 0) {
                                ...
                                if (exitOption1 == javax.swing.JOptionPane.YES_OPTION) {
                                    ...
                                    //ClaimNo = claimNumberTxt.getText();
                                    ...
                                    pstmt1.setDate(15, com.afrisoftech.lib.SQLDateFormat.getSQLDate(dischargeDatePicker.getDate()));
                                    pstmt1.setObject(16, ClaimNo);
...
//Post differences to hp_patient_card after computation of NHIF/NHIS rebates
...
//Post differences to ac_ledger after computation of NHIF/NHIS rebates
                                  ...
                                  //  com.afrisoftech.reports.NHIFInvoicePdf nhifInvoice = new com.afrisoftech.reports.NHIFInvoicePdf(connectDB, patientNumberTxt.getText(), admissionDatePicker.getDate(), dischargeDatePicker.getDate(), visitIDTxt.getText());
                                    
                                 //   nhifInvoice.generatePdf(invoiceNo);
                        ...
                        javax.swing.JOptionPane.showMessageDialog(this, "NHIF rebate posted successfully.", "Confirmation Message!", javax.swing.JOptionPane.INFORMATION_MESSAGE);
            ...
            javax.swing.JOptionPane.showMessageDialog(this, "You cannot finalise a bill with a balance. Please consult the chief accountant.");
        }
        // Add your handling code here:
...
/*
        float noofDays = 0;
        float balance =
                java.lang.Float.parseFloat(jTextField18.getText());
        float nhif = 0;
        float Rate = 0;
        java.util.Date admDate = datePicker12.getDate();
        java.util.Date disDate = datePicker11.getDate();


        try {
            double net = 0.00; // noofDays = disDate.getDate() -
            admDate.getDate();
            double Bill = java.lang.Double.valueOf(jTextField31.getText());
            double deposits =  java.lang.Double.valueOf(jTextField10.getText()); // double net =
            java.lang.Double.valueOf(jTextField18.getText());
            nhif = java.lang.Float.parseFloat(jTextField22.getText()); //
//            jTextField22.setText(java.lang.String.valueOf(nhif));
            ...
            //} 
            java.sql.Statement pss111xx = connectDB.createStatement();
            java.sql.ResultSet rss111xx = pss111xx.executeQuery("select ROUND('"+nhifDiff+"'  ,2)::numeric"); while (rss111xx.next()){
...
*/
    ...
    private void nhifCategoryCmbxActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_nhifCategoryCmbxActionPerformed
        float noofDays = 0;
        float balance = java.lang.Float.parseFloat(netValueTxt.getText());
        float nhif = 0;
        float Rate = 0;
        ...
        try {
            ...
            if (nhifCategoryCmbx.getSelectedItem().toString().equalsIgnoreCase("Nhif Private Wing") || nhifCategoryCmbx.getSelectedItem().toString().equalsIgnoreCase("Amenity")) {
                nhifDiff = 0;
            } else {
                nhifDiff = Bill - (nhif + deposits);
            }
            /*
            ...
            java.sql.ResultSet rss111x = pss111x.executeQuery("select ROUND('" + net + "',2)::numeric");
            while (rss111x.next()) {
                netValueTxt.setText(java.lang.String.valueOf(rss111x.getDouble(1)));
            }
        } catch (java.sql.SQLException sqlex) {
            javax.swing.JOptionPane.showMessageDialog(this, sqlex.getMessage(), "Error Message!", javax.swing.JOptionPane.ERROR_MESSAGE);
