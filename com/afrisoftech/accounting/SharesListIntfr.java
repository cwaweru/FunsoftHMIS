 ...
 * @author  root
 */
public class SharesListIntfr extends javax.swing.JInternalFrame implements java.lang.Runnable{
    ...
    public SharesListIntfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        */
        ...
        jPanel2.setBorder(new javax.swing.border.TitledBorder("Tick Here"));
 ...
 int i = 0;
        ...
        try {
                ...
                java.sql.ResultSet rset = stmt.executeQuery("select count(account_no) from  ac_shares_ledger  where transaction_type ilike 'Sh%' and date <= '"+this.datePicker3.getDate().toString()+"'");
                
                while (rset.next()) {
                    j = rset.getInt(1);
                }
                if (j > 0){
                    jTable1.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"select initcap(dealer),account_no,sum(credit-debit ) as amt from  ac_shares_ledger  where transaction_type ilike 'Sh%' and date <= '"+this.datePicker3.getDate().toString()+"' group by dealer,account_no order by amt desc"));
               ...
               // System.out.println("Date1 : "+datePicker1.getDate().toString());
                ...
                java.sql.ResultSet rsetTable1 = stmtTable1.executeQuery("select initcap(dealer),account_no,sum(credit-debit ) as amt from  ac_shares_ledger  where transaction_type ilike 'Sh%' and date <= '"+this.datePicker3.getDate().toString()+"' group by dealer,account_no order by amt desc");
        ...
        //this.populateTable2();        // Add your handling code here:
    ...
    private void populateTable2(java.lang.String patient_no) {
       ...
       // try {
         /*   if(this.jRadioButton1.isSelected()){
                ...
                if (j > 0){
                    jTable1.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"SELECT distinct date::date,admission_no||cheque_no AS doc_no,item as name,invoice_no||receipt_no AS ref_no,debit,credit,balance-credit_bal AS balance FROM ac_debtors WHERE account_no = '"+patient_no+"' and date::date between '"+this.datePicker1.getDate().toString()+"' and '"+this.datePicker3.getDate().toString()+"' and (balance != 0 or credit_bal !=0) ORDER BY date"));
               ...
               java.sql.Statement stmtTable1 = connectDB.createStatement();
                ...
                java.sql.ResultSet rsetTable1 = stmtTable1.executeQuery("SELECT distinct date::date,admission_no||cheque_no,item,invoice_no||receipt_no,debit,credit,balance-credit_bal FROM ac_debtors WHERE account_no = '"+patient_no+"' and date::date between '"+this.datePicker1.getDate().toString()+"' and '"+this.datePicker3.getDate().toString()+"' and (balance != 0 or credit_bal !=0) ORDER BY date");
                ...
                if (j > 0){
                    ...
                    jTable11.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"SELECT distinct date::date,admission_no||cheque_no AS doc_no,item as name,initcap(payee) as Scheme,invoice_no||receipt_no AS ref_no,debit,credit,balance-credit_bal AS balance FROM ac_debtors WHERE dealer ilike '"+patient_no+"' and date::date between '"+this.datePicker1.getDate().toString()+"' and '"+this.datePicker3.getDate().toString()+"' and (balance != 0 or credit_bal !=0) ORDER BY Scheme,date"));
              java.sql.Statement stmtTable1 = connectDB.createStatement();
...
//        int i = jTable2.getSelectedRow();
   ...
   */
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        com.afrisoftech.reports.ShareHoldSummPdf policy = new com.afrisoftech.reports.ShareHoldSummPdf();
        
        policy.ShareHoldSummPdf(connectDB, this.datePicker3.getDate(), this.datePicker3.getDate());
        // Add your handling code here:
