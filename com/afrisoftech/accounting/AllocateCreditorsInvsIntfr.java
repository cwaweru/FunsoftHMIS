...
public class AllocateCreditorsInvsIntfr extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        */
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Date", "Invoice No.", "A/C No", "Orig. Amt", "Amt. To Alloc.", "Balance", "Allocate"
            }
        ) {
            Class[] types = new Class [] {
                java.lang.Object.class, java.lang.Object.class, java.lang.Object.class, java.lang.Double.class, java.lang.Double.class, java.lang.Double.class, java.lang.Boolean.class
        ...
        jLabel13.setText("Allocated Amount");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 4;
        gridBagConstraints.gridy = 11;
    ...
    private void jSearchTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jSearchTable1MouseClicked
        ...
        jTextField8.setText(jSearchTable1.getValueAt(jSearchTable1.getSelectedRow(), 2).toString());
    ...
    private void jTextField1111CaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextField1111CaretUpdate
        jSearchTable1.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"select voucher_no,numeric_uminus(balance) as balance,date from ac_accounts_payable where dealer ilike '"+jTextField36.getText()+"' and balance < 0 and voucher_no ILIKE '"+jTextField1111.getText().toString()+"%'"));
        jSearchTable1.setShowHorizontalLines(false);
        jSearchScrollPane1.setViewportView(jSearchTable1);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
            ...
            try {
                ...
                java.sql.ResultSet rstsx = pss1x.executeQuery("SELECT nextval('transaction_no_seq')");
                while (rstsx.next()){
                ...
                java.sql.ResultSet rse3 = stm3.executeQuery("SELECT description,activity_code FROM ac_accounts_payable WHERE voucher_no = '"+jTextField361.getText()+"'");
                while (rse3.next()){
                    actCode1 = rse3.getObject(2).toString();
                    actNames1 = rse3.getObject(1).toString();
                }
                ...
                for (int i = 0; i < jTable1.getRowCount(); i++){
                    if (jTable1.getModel().getValueAt(i,4) != null){
                        if(java.lang.Double.parseDouble(jTable1.getValueAt(i,4).toString()) > 0){
                            ...
                            java.sql.PreparedStatement pstmt2 = connectDB.prepareStatement("insert into ac_accounts_payable values(?,?,?,?,?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?,?,?,?)");
                            pstmt2.setObject(1,actCode1);
                            pstmt2.setString(2,jTextField36.getText());
                            pstmt2.setObject(3,"Payment Allocation");
                            pstmt2.setString(4,jTextField361.getText());
                            pstmt2.setString(5,jTextField36.getText());
                            pstmt2.setString(6,"Allocation");
                            pstmt2.setString(7,jTextField4.getText());
                            pstmt2.setString(8,jTextField361.getText());
                            pstmt2.setString(9,"");
                            pstmt2.setString(10,"");
                            pstmt2.setString(11,transNo);
                            pstmt2.setString(12,"Allocation");
                            pstmt2.setDouble(13,java.lang.Double.valueOf(jTable1.getValueAt(i,4).toString()));
                            pstmt2.setDouble(14,0.00);
                            pstmt2.setObject(15,jTextField8.getText());
                            pstmt2.setObject(16,jTable1.getValueAt(i,1).toString());
                            pstmt2.setString(17,actNames1);
                            pstmt2.setBoolean(18,false);
                            pstmt2.setBoolean(19,false);
                            pstmt2.setString(20,User);
                            pstmt2.setString(21,"");
                            pstmt2.setDate(22,com.afrisoftech.lib.SQLDateFormat.getSQLDate(datenowSql));
                            pstmt2.setDate(23,com.afrisoftech.lib.SQLDateFormat.getSQLDate(datenowSql));
                            ...
                            pstmt.setDouble(8,java.lang.Double.valueOf(jTextField1.getText()));
                            ...
                            java.sql.PreparedStatement pstmt3 = connectDB.prepareStatement("UPDATE ac_accounts_payable set balance = '"+balance+"' WHERE invoice_no ILIKE '"+jTable1.getModel().getValueAt(i,1).toString()+"%' AND dealer ilike '"+jTextField36.getText().toString()+"%' and credit = '"+credit+"' AND date = '"+jTable1.getModel().getValueAt(i,0).toString()+"'");
                ...
                java.sql.PreparedStatement pstmt2x = connectDB.prepareStatement("insert into ac_accounts_payable values(?,?,?,?,?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?,?,?,?)");
                pstmt2x.setObject(1,actCode1);
                pstmt2x.setString(2,jTextField36.getText());
                pstmt2x.setObject(3,"Payment Allocation");
                pstmt2x.setString(4,jTextField361.getText());
                pstmt2x.setString(5,jTextField36.getText());
                pstmt2x.setString(6,"Allocation");
                pstmt2x.setString(7,jTextField4.getText());
                pstmt2x.setString(8,jTextField361.getText());
                pstmt2x.setString(9,"");
                pstmt2x.setString(10,"");
                pstmt2x.setString(11,transNo);
                pstmt2x.setString(12,"Allocation");
                pstmt2x.setDouble(13,0.00);
                pstmt2x.setObject(14,jTextField9.getText());
                pstmt2x.setObject(15,jTextField8.getText());
                pstmt2x.setObject(16,jTextField3.getText());
                pstmt2x.setString(17,actNames1);
                pstmt2x.setBoolean(18,false);
                pstmt2x.setBoolean(19,false);
                pstmt2x.setString(20,User);
                pstmt2x.setString(21,"");
                pstmt2x.setDate(22,com.afrisoftech.lib.SQLDateFormat.getSQLDate(datenowSql));
                pstmt2x.setDate(23,com.afrisoftech.lib.SQLDateFormat.getSQLDate(datenowSql));
                pstmt2x.setDouble(24,0.00);
                pstmt2x.executeUpdate();
                
                double quantity = Double.parseDouble(this.jTextField2.getText().toString());
                
                java.sql.PreparedStatement pstmt4 = connectDB.prepareStatement("UPDATE ac_accounts_payable set balance =  "+new java.lang.Double(-quantity)+" WHERE voucher_no = '"+this.jTextField361.getText()+"' AND dealer ilike '"+jTextField36.getText()+"%' AND balance = numeric_uminus('"+jTextField1.getText()+"')");
  ...
  */
    ...
    public void tableModelTableChanged1() {
        ...
        if(amt > 0){
            for (int j = 0; j < jTable1.getRowCount(); j++) {
                if(this.jTable1.getModel().getValueAt(j,6) != null){
                    ...
                    if (Boolean.valueOf(jTable1.getValueAt(jTable1.getSelectedRow(), 6).toString()) == java.lang.Boolean.TRUE) {
                        
                        System.out.println("\n"+jTable1.getModel().getValueAt(jTable1.getSelectedRow(), 6).toString());
                        ...
                        if(this.jTable1.getModel().getValueAt(jTable1.getSelectedRow(),6) != null){
                            ...
                            if(this.jTable1.getModel().getValueAt(j,4) != null){
                                amt = amt - Double.parseDouble(jTable1.getModel().getValueAt(j, 4).toString());
                        ...
                        if (Boolean.valueOf(jTable1.getValueAt(jTable1.getSelectedRow(), 6).toString()) == java.lang.Boolean.FALSE) {
                            
                            if(this.jTable1.getValueAt(jTable1.getSelectedRow(),6) != null){
                                
                                
                                jTextField2.setForeground(java.awt.Color.BLACK);
                                double balance = java.lang.Double.parseDouble(jTable1.getValueAt(jTable1.getSelectedRow(), 5).toString());
                                double alloc = java.lang.Double.parseDouble(jTable1.getValueAt(jTable1.getSelectedRow(), 4).toString());
                                
                                jTable1.setValueAt(new java.lang.Double(java.lang.Math.round(balance+alloc)),jTable1.getSelectedRow(),5);
                            ...
                            if (amt1 > 0) {
                                jTextField2.setText(Double.toString(amt1+java.lang.Double.parseDouble(jTable1.getValueAt(jTable1.getSelectedRow(), 4).toString())));
                            }else{
                                if (amt1 == 0) {
                                    if(this.jTable1.getModel().getValueAt(j,4) != null){
                                        amt = amt - Double.parseDouble(jTable1.getModel().getValueAt(j, 4).toString());
        ...
        this.jTextField9.setText(java.lang.String.valueOf(totalSum));
