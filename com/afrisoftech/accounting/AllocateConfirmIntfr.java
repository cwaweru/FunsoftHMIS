 ...
 * @author  root
 */
public class AllocateConfirmIntfr extends javax.swing.JInternalFrame {
    ...
    public AllocateConfirmIntfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {
        ...
        */
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Inv Date", "Invoice No.", "(Patient no) -(user)", "Invoice Amt", "Allocated Amt", "Unallocate", "Cheque_no"
            }
        ) {
        ...
        jCheckBox2.setText("Reconcile receipt");
   ...
   */
    ...
    private void jTextField1111CaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextField1111CaretUpdate
      //jSearchTable1.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"select receipt_no,sum(credit-debit) as balance from debtors_receipts where account_no ='"+jTextField4.getText()+"' and receipt_no ILIKE '"+jTextField1111.getText().toString()+"%' group by receipt_no"));
         jSearchTable1.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"select receipt_no,credit,cheque_no from ac_debtors where account_no ='"+jTextField4.getText()+"' and cheque_no ILIKE '"+jTextField1111.getText().toString()+"%' and credit >0"));
    ...
    private void jCheckBox1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jCheckBox1ActionPerformed
        ...
        this.populateTable12(this.jTextField4.getText()); 
    }else{
                ...
                if (jTable1.getModel().getValueAt(i,4) != null){
                       if (Boolean.valueOf(jTable1.getModel().getValueAt(i, 5).toString()) == java.lang.Boolean.TRUE) {
                           ...
                           credits = credits + Double.parseDouble(jTable1.getModel().getValueAt(i, 4).toString());
                                        java.sql.PreparedStatement pstmt = connectDB.prepareStatement("insert into db_allocation_unalloc values(?,?,?,?,?,?,?,?,?,?,?,?)");
                            ...
                            pstmt.setObject(3,"Un-Allocation");
                            pstmt.setObject(4,Alloc);
                            pstmt.setObject(5,jTextField361.getText());
                  ...
                  credits = credits + Double.parseDouble(jTable1.getModel().getValueAt(i, 4).toString());
                            ...
                            pstmt3.executeUpdate();
                                ...
                                java.sql.PreparedStatement pstmt3d = connectDB.prepareStatement("delete from db_allocation WHERE inv_no = '"+jTable1.getModel().getValueAt(i,1).toString()+"' AND acc_no = '"+jTextField4.getText()+"' and amount_alloc = '"+jTable1.getModel().getValueAt(i,4).toString()+"'");
                            pstmt3d.executeUpdate();
                            
                                resFloat =  Double.parseDouble(jTable1.getModel().getValueAt(i, 4).toString());
          
                            
                              java.sql.PreparedStatement pstmt4r = connectDB.prepareStatement("UPDATE ac_debtors set credit_bal = credit_bal + '"+resFloat+"' WHERE receipt_no = '"+this.jTextField361.getText()+"' and  account_no = '"+jTextField4.getText()+"'");
                pstmt4r.executeUpdate();
    ...
    private void populateTable1(java.lang.String patient_no) {
        ...
        try {
            java.sql.Statement stmt = connectDB.createStatement();
              ...
              java.sql.ResultSet rset = stmt.executeQuery("SELECT count(inv_no) FROM db_allocation WHERE acc_no = '"+patient_no+"'  and date between '"+this.datePicker1.getDate().toString()+"' and '"+this.datePicker2.getDate().toString()+"'");// and revenue_code = '"+jTextField5.getText()+"' AND paid = false");
            ...
            if (j > 0){
                ...
                //java.sql.ResultSet rsetTable1 = stmtTable1.executeQuery("SELECT date, inv_no, patient_no, amount_alloc,cheque_no FROM db_allocation WHERE acc_no = '"+patient_no+"' AND date between '"+this.datePicker1.getDate().toString()+"' and '"+this.datePicker2.getDate().toString()+"' AND amount_alloc >0 AND inv_no != '' ORDER BY inv_no");// and revenue_code = '"+jTextField5.getText()+"' AND paid = false");
               
                 java.sql.ResultSet rsetTable1 = stmtTable1.executeQuery(" SELECT db_allocation.date, db_allocation.inv_no, db_allocation.patient_no ||'-'||db_allocation.user_name, db_allocation.amount_alloc,db_allocation.cheque_no,AC_DEBTORS.DEBIT FROM db_allocation, AC_DEBTORS WHERE db_allocation.acc_no = '"+patient_no+"' AND AC_DEBTORS.INVOICE_NO = db_allocation.INV_NO AND db_allocation.date between '"+this.datePicker1.getDate().toString()+"' and '"+this.datePicker2.getDate().toString()+"' AND db_allocation.amount_alloc >0 AND db_allocation.cheque_no != '"+jTextField3.getText().toString()+"' ORDER BY db_allocation.date");// and revenue_code = '"+jTextField5.getText()+"' AND paid = false");
           ...
           java.sql.Statement stmtTable1 = connectDB.createStatement();
                ...
                //java.sql.ResultSet rsetTable1 = stmtTable1.executeQuery("SELECT date, inv_no, patient_no, amount_alloc,cheque_no FROM db_allocation WHERE acc_no = '"+patient_no+"' AND date between '"+this.datePicker1.getDate().toString()+"' and '"+this.datePicker2.getDate().toString()+"' AND amount_alloc >0 AND inv_no != '' ORDER BY inv_no");// and revenue_code = '"+jTextField5.getText()+"' AND paid = false");
                 ...
                 java.sql.ResultSet rsetTable1 = stmtTable1.executeQuery(" SELECT db_allocation.date, db_allocation.inv_no, db_allocation.patient_no ||'-'||db_allocation.user_name, db_allocation.amount_alloc,db_allocation.cheque_no,AC_DEBTORS.DEBIT FROM db_allocation, AC_DEBTORS WHERE db_allocation.acc_no = '"+patient_no+"' AND AC_DEBTORS.INVOICE_NO = db_allocation.INV_NO AND db_allocation.date between '"+this.datePicker1.getDate().toString()+"' and '"+this.datePicker2.getDate().toString()+"' AND db_allocation.amount_alloc >0 AND db_allocation.inv_no != '' ORDER BY db_allocation.date");// and revenue_code = '"+jTextField5.getText()+"' AND paid = false");
     ...
     private void populateTable12(java.lang.String patient_no) {
        ...
        try {
            ...
            if (j > 0){
                ...
                //java.sql.ResultSet rsetTable1 = stmtTable1.executeQuery("SELECT date, invoice_no, admission_no,debit::numeric,balance::numeric ,null::boolean as allocated FROM ac_debtors WHERE account_no = '"+patient_no+"' AND balance > 0 order by date");// and revenue_code = '"+jTextField5.getText()+"' AND paid = false");
                java.sql.ResultSet rsetTable1 = stmtTable1.executeQuery("SELECT date, inv_no, patient_no, amount_alloc,cheque_no FROM db_allocation WHERE acc_no = '"+patient_no+"' AND date between '"+this.datePicker1.getDate().toString()+"' and '"+this.datePicker2.getDate().toString()+"' AND amount_alloc >0 AND inv_no != '' and cheque_no = '"+jTextField3.getText()+"' ORDER BY inv_no");// and revenue_code = '"+jTextField5.getText()+"' AND paid = false");
