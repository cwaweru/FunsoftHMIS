 ...
 * @author  root
 */
public class ClosePeriodintfr extends javax.swing.JInternalFrame {
    ...
    public ClosePeriodintfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {
        ...
        setIconifiable(true);
        setTitle("Close Accounts Operations Period");
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder("Period to Close"));
        ...
        jComboBox11.setModel(com.afrisoftech.lib.ComboBoxModel.ComboBoxModel(connectDB, "SELECT period_description FROM period_setup WHERE period_status ilike 'Open' ORDER BY period_from ASC"));
        ...
        jLabel6.setText("Period To Close");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 2;
        ...
        jButton5.setText("Proceed to Close Period");
    ...
    private void jComboBox11ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBox11ActionPerformed
        ...
        try {
            ...
            java.sql.ResultSet rset = stmt.executeQuery("SELECT period_from,period_to FROM period_setup WHERE period_description = '"+jComboBox11.getSelectedItem().toString()+"'");
            while (rset.next()){
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        try {
            ...
            if(comp > 0){
                      javax.swing.JOptionPane.showMessageDialog(this,"You cannot close a period when a previous period is still open ".toUpperCase(),"Information Message",javax.swing.JOptionPane.INFORMATION_MESSAGE);
          
            }else{
                
                java.sql.PreparedStatement pstmts2 = connectDB.prepareStatement("UPDATE period_setup SET period_status = 'Closed' WHERE period_from = '"+datePicker2.getDate().toString()+"' AND period_to = '"+datePicker1.getDate().toString()+"' AND company_name = '"+jTextField1.getText()+"' AND period_status ilike 'Open%'");
                
                pstmts2.executeUpdate();
                
                
                javax.swing.JOptionPane.showMessageDialog(this,"Period closed successfully".toUpperCase(),"Information Message",javax.swing.JOptionPane.INFORMATION_MESSAGE);
            }
