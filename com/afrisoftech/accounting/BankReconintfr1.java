...
public class BankReconintfr1 extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        */
        ...
        jComboBox2.setModel(com.afrisoftech.lib.ComboBoxModel.ComboBoxModel(connectDB, "select DISTINCT bank_account_no from ac_banks_setup ORDER BY bank_account_no"));
 ...
 /*       javax.swing.JInternalFrame other = new com.afrisoftech.accounting.BankStmtRecSchdIntfr(connectDB, pConnDB);
  ...
  */
  // Add your handling code here:
    ...
    private void jCheckBox1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jCheckBox1ActionPerformed
     /*   javax.swing.JInternalFrame other = new com.afrisoftech.accounting.BankRecSchdIntfr(connectDB, pConnDB);
        this.getParent().add(other, javax.swing.JLayeredPane.DEFAULT_LAYER);
        try {
            other.setSelected(true);
        } catch(java.beans.PropertyVetoException pvt){}
    ...
    private void jComboBox2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBox2ActionPerformed
      ...
      */
      ...
      //          crset4.execute();
                ...
                jTable1.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"select date,cheque_no,debit as debit,credit as credit,reconciled::boolean from ac_cash_book where account_no ILIKE '"+jComboBox2.getSelectedItem().toString()+"%'  AND reconciled = false AND date <= '"+datePicker2.getDate().toString()+"'  ORDER BY date ASC")); 
