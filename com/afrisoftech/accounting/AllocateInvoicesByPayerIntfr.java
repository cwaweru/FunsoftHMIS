...
public class AllocateInvoicesByPayerIntfr extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        */
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Date", "Inv. No", "Admission No.", "Balance", "Allocate", "Account No."
            }
        ) {
            Class[] types = new Class [] {
                java.lang.Object.class, java.lang.Object.class, java.lang.Object.class, java.lang.Double.class, java.lang.Boolean.class, java.lang.Object.class
    ...
    private void jTable1KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTable1KeyReleased
        ...
        this.jTextField2.setText(java.lang.String.valueOf(totalSum));
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        double orig = java.lang.Double.parseDouble(jTextField1.getText().toString());
        double alloc = java.lang.Double.parseDouble(jTextField2.getText().toString());
        ...
        if (Boolean.valueOf(jTable1.getValueAt(jTable1.getSelectedRow(), 6).toString()) == java.lang.Boolean.TRUE) {
            if(balance == 0.00){
                ...
                if (jTable1.getModel().getValueAt(jTable1.getSelectedRow(), 6/*jTable1.getSelectedColumn()*/) != null) {
            ...
            if (jTable1.getValueAt(jTable1.getSelectedRow(), 6/*jTable1.getSelectedColumn()*/) != null) {
                if (jTable1.getValueAt(jTable1.getSelectedRow(), 5) != null){
                    this.tableModelTableChanged1();
                }
            }
...
//        }
    ...
    public void tableModelTableChanged(javax.swing.event.TableModelEvent evt) {
        ...
        for (int i = 0; i < jTable1.getRowCount(); i++) {
            ...
            // if ((jTable1.getModel().getValueAt(i, 3) != null) && (java.lang.Boolean.parseBoolean(jTable1.getModel().getValueAt(i, 4).toString()))) {
    ...
    private void jTextField1111CaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextField1111CaretUpdate
        jSearchTable1.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"select receipt_no,credit_bal from ac_debtors where dealer ilike'"+jTextField36.getText()+"' and credit_bal > 0 and receipt_no ILIKE '"+jTextField1111.getText().toString()+"%'"));
    ...
    private void jCheckBox1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jCheckBox1ActionPerformed
        ...
        jTable1.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"SELECT date, invoice_no, admission_no,balance::numeric,null::boolean AS Allocated,account_no FROM ac_debtors WHERE dealer ilike '"+jTextField36.getText()+"' AND balance > 0 and date between '"+this.datePicker1.getDate().toString()+"' and '"+this.datePicker2.getDate().toString()+"' order by date"));
        jScrollPane1.setViewportView(jTable1);
    ...
    private void jTextField111CaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextField111CaretUpdate
        if(jTextField111.getCaretPosition() < 3){
            ...
            jSearchTable.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"select trim(scheme_manager) as scheme ,account_no from ac_scheme_providers where scheme_manager ILIKE '"+jTextField111.getText().toString()+"%'"));
                ...
                for (int i = 0; i < jTable1.getRowCount(); i++){
                    if (jTable1.getModel().getValueAt(i,3) != null){
                        ...
                        if(java.lang.Double.parseDouble(jTable1.getValueAt(i,3).toString()) > 0){
                            ...
                            pstmt.setObject(1,jTable1.getValueAt(i,5).toString());
                            ...
                            pstmt.setObject(7,Double.parseDouble(jTextField1.getText()));
                            //  if(java.lang.Double.parseDouble(jTable1.getValueAt(i,5).toString()) > 0){
                            pstmt.setObject(8,Double.parseDouble(jTable1.getValueAt(i,3).toString()));
                            //  }else{
                            ...
                            pstmt.setObject(12,com.afrisoftech.lib.SQLDateFormat.getSQLDate(java.sql.Date.valueOf(jTable1.getValueAt(i,0).toString())));
                            
                           // pstmt.setObject(12,com.afrisoftech.lib.SQLDateFormat.getSQLDate(java.util.Date)jTable1.getValueAt(i,0).toString());
                             
                     
                 
                           //pstmt.setDate(12,com.afrisoftech.lib.SQLDateFormat.getSQLDate(dateFormat.parse(jTable1.getValueAt(i,0).toString())));
               
// pstmt.setObject(7,jTable1.getValueAt(i,0).toString());
                            pstmt.executeUpdate();
                            
                            java.sql.PreparedStatement pstmt3 = connectDB.prepareStatement("UPDATE ac_debtors set balance = "+Double.parseDouble(jTable1.getModel().getValueAt(i,3).toString())+" WHERE invoice_no = '"+jTable1.getModel().getValueAt(i,1).toString()+"'");
                ...
                jLabel7.setText("Sorry. Please double check your entries.");
            }
