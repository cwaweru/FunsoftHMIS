 ...
 * @author  root
 */
public class ShareBonusIntfr extends javax.swing.JInternalFrame {
    ...
    public ShareBonusIntfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {
        ...
        */
        ...
        jCheckBox1.setText("Share Issue");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 2;
        gridBagConstraints.gridy = 0;
        gridBagConstraints.weightx = 1.0;
        ...
        jCheckBox2.setText("Bonus Issue");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 3;
        gridBagConstraints.gridy = 0;
        gridBagConstraints.weightx = 1.0;
        ...
        jCheckBox3.setText("Rights Issue");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 4;
        gridBagConstraints.gridy = 0;
        gridBagConstraints.weightx = 1.0;
        ...
        jCheckBox4.setText("Script Dividend");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 5;
        gridBagConstraints.gridy = 0;
        gridBagConstraints.weightx = 1.0;
        ...
        jCheckBox5.setText("Original");
        jPanel1.add(jCheckBox5, new java.awt.GridBagConstraints());
    ...
    //   double total_num = java.lang.Double.parseDouble(jTextField2.getText());
        ...
        // System.out.println(total_num);
          ...
          double total_num = num_f + num_c;
      
        //double num_d = total_num - num_c;
      //  jTextField5.setText(""+num_d+"");
         jTextField2.setText(""+total_num+"");
    ...
    private void jTextField11111CaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextField11111CaretUpdate
        if(jTextField11111.getCaretPosition() < 3){
            ...
            try {
                ...
                searchRowSet1.execute("select holders_name,acc_no  from pb_share_register where holders_name ILIKE '"+jTextField11111.getText().toString()+"%'");
                ...
                jSearchTable1.setModel(new org.netbeans.lib.sql.models.TableModel(searchRowSet1, new org.netbeans.lib.sql.models.TableModel.Column[] {
                    new org.netbeans.lib.sql.models.TableModel.Column("holders_name", "Name", false),
                     new org.netbeans.lib.sql.models.TableModel.Column("acc_no", "Acc/No", false)
                }));
                jSearchTable1.setShowHorizontalLines(false);
                jSearchScrollPane1.setViewportView(jSearchTable1);
    ...
    private void jTextField1111CaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextField1111CaretUpdate
        if(jTextField1111.getCaretPosition() < 3){
            ...
            try {
                ...
                searchRowSet.execute("select holders_name,acc_no  from pb_share_register where holders_name ILIKE '"+jTextField1111.getText().toString()+"%'");
                //   searchRowSet.execute();
                //     searchRowSet.execute("SELECT patient_no, (upper(first_name||' '||second_name||' '||last_name)) as name, year_of_birth, residence from hp_patient_register where first_name '~ '~"+jTextField11.getText()+"' order by name");
...
//        javax.swing.JFrame other = new OtherReceipts(connectDB, pConnDB);
  ...
  if(this.jCheckBox1.isSelected()){
      Share = jCheckBox1.getText();
  }else{ 
       if(this.jCheckBox2.isSelected()){
      Share = jCheckBox2.getText();
  }else{ 
      if(this.jCheckBox3.isSelected()){
      Share = jCheckBox3.getText();
  }else{
       if(this.jCheckBox5.isSelected()){
      Share = jCheckBox5.getText();
  }else{
     
      Share = jCheckBox4.getText();
  }
  }
  }
  }
        ...
        transNo = rsts.getObject(1).toString();
            ...
            java.sql.PreparedStatement pstmt1 = connectDB.prepareStatement("insert into ac_shares_ledger values(?,?,?,?,?,?,?,?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?,?,?,?,?,?,?,?)");
               ...
               java.sql.PreparedStatement pstmt81 = connectDB.prepareStatement("UPDATE pb_activity SET ytd_debit = ytd_debit + '"+jTextField3.getText()+"',mtd_debit = mtd_debit + '"+jTextField3.getText()+"' where code = '"+bankAcc+"'");
