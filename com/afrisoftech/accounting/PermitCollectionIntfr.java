    ...
    private void jTextField113CaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextField113CaretUpdate
        if(jTextField113.getCaretPosition() < 2){
            ...
            if(this.jCheckBox2.isSelected()){
                jSearchTable2.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"SELECT deceased_no, (upper(diceased_name)) as name,sheet_no from hp_death_register where diceased_name ILIKE '"+jTextField113.getText()+"%' and collected = false order by diceased_name"));
                ...
                jSearchTable2.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"SELECT deceased_no, (upper(diceased_name)) as name,sheet_no from hp_death_register where diceased_no ILIKE '"+jTextField113.getText()+"%' and collected = false order by diceased_name"));
