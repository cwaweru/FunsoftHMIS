 ...
 * @author  root
 */
public class ImprestSurrenderIntfrchibeka extends javax.swing.JInternalFrame {
    ...
    public ImprestSurrenderIntfrchibeka(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {
        ...
        */
        ...
        jComboBox131.setModel(com.afrisoftech.lib.ComboBoxModel.ComboBoxModel(connectDB, "select distinct voucher_no from ac_petty_cash GROUP BY voucher_no having sum(debit-credit) > 0  ORDER BY voucher_no"));
...
//        jLabel7.setText("");
        ...
        try {
            ...
            while (rset.next()){
                ...
                jTextField37.setText(rset.getObject(2).toString());
        ...
        this.populateTable12x(this.jComboBox131.getSelectedItem().toString());
