 ...
 * @author  root
 */
public class MergingPatientBillIntfr1 extends javax.swing.JInternalFrame {
    ...
    public MergingPatientBillIntfr1(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
        ...
        if(this.jTextField1132.getCaretPosition() < 0){
            ...
            if(jCheckBox1.isSelected()){
                ...
                if(jCheckBox2.isSelected()){
                    ...
                    if(jRadioButton1.isSelected()){
                        jSearchTable221.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"select patient_no as pat_no,second_name||' '|| first_name as name,pay_mode from hp_inpatient_register where patient_no ILIKE '%"+jTextField11321.getText()+"%' order by patient_no"));
                        ...
                        if(jRadioButton2.isSelected()){
                            jSearchTable221.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"select patient_no as pat_no,second_name||' '|| first_name as name,pay_mode from hp_inpatient_register where second_name||' '|| first_name ILIKE '%"+jTextField11321.getText()+"%' order by name"));
   ...
   */
    ...
    private void jButton11ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton11ActionPerformed
        ...
        if (exitOption == javax.swing.JOptionPane.YES_OPTION) {
            ...
            try {
                connectDB.setAutoCommit(false);
                if(jTextField91.getText().toString().equalsIgnoreCase("")){
                    javax.swing.JOptionPane.showMessageDialog(this,"You cannot merge merge without \n selecting receipient no","Confirmation Message",javax.swing.JOptionPane.INFORMATION_MESSAGE);
                    ...
                    if(jCheckBox1.isSelected()){
                        ...
                        if(jCheckBox2.isSelected()){
                            ...
                            java.sql.PreparedStatement pstmt811x = connectDB.prepareStatement("DELETE FROM hp_admission where visit_id = '"+jTextField2.getText()+"' AND patient_no = '"+jTextField911.getText()+"'");
