...
public class WriteOffsInvIntfr extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        */
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Date", "Rct. No.", "Doc No.", "Org Amount", "Amt To Write Off", "Balance", "Writ Off"
            }
        ) {
    ...
    */
    ...
    private void jTextField1111CaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextField1111CaretUpdate
        jSearchTable1.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"select receipt_no,credit_bal from ac_debtors where account_no ='"+jTextField4.getText()+"' and credit_bal > 0 and receipt_no ILIKE '"+jTextField1111.getText().toString()+"%'"));
            ...
            try{
                ...
                if(jTextField31.getText() == null){
                    ...
                    try {
                        ...
                        pstmt2.setDouble(16,java.lang.Double.valueOf(jTextField2.getText()));
                        pstmt2.setDouble(17,0.00);
                        pstmt2.setDate(18,com.afrisoftech.lib.SQLDateFormat.getSQLDate(java.util.Calendar.getInstance().getTime()));
                        ...
                        pstmt.setDouble(14,java.lang.Double.valueOf(jTextField2.getText()));
                        pstmt.setString(16,"");
                        ...
                        for (int i = 0; i < jTable1.getRowCount(); i++){
                            if (jTable1.getModel().getValueAt(i,4) != null){
                                ...
                                if(java.lang.Double.parseDouble(jTable1.getValueAt(i,4).toString()) > 0){
                                    ...
                                    pstmt3.setDate(2,com.afrisoftech.lib.SQLDateFormat.getSQLDate(java.util.Calendar.getInstance().getTime()));
                                    ...
                                    pstmt3.setDouble(7,java.lang.Double.valueOf(jTextField2.getText()));
                                    pstmt3.setDouble(8,java.lang.Double.valueOf(jTable1.getValueAt(i,4).toString()));
                                    ...
                                    pstmt3.setDate(12,com.afrisoftech.lib.SQLDateFormat.getSQLDate(java.sql.Date.valueOf(jTable1.getValueAt(i,0).toString())));
