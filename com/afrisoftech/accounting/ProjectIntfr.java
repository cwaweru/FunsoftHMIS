 ...
 * @author  postgres
 */
public class ProjectIntfr extends javax.swing.JInternalFrame {
    ...
    public ProjectIntfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {
        ...
        donorCmbx = new javax.swing.JComboBox();
        ...
        jLabel1.setText("Set project here");
        ...
        jComboBox1.setModel(com.afrisoftech.lib.ComboBoxModel.ComboBoxModel(connectDB, "select distinct donor from ac_branch order by donor"));
        ...
        donorCmbx.setModel(com.afrisoftech.lib.ComboBoxModel.ComboBoxModel(connectDB, "select donor from ac_donor order by donor"));
        gridBagConstraints = new java.awt.GridBagConstraints();
        ...
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
        buttonPanel.add(donorCmbx, gridBagConstraints);
        ...
        setBounds(0, 0, 710, 300);
    }// </editor-fold>//GEN-END:initComponents

    private void jComboBox1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBox1ActionPerformed
        try {
            java.sql.Statement stmt = connectDB.createStatement();
            java.sql.ResultSet rset = stmt.executeQuery("select code from ac_branch where donor ='"+jComboBox1.getSelectedItem()+"'");
            while (rset.next()){
         ...
         try {
            ...
            for (int i = 0; i < jTable1.getRowCount(); i++){
                if (jTable1.getModel().getValueAt(i,0) != null){
                    java.sql.PreparedStatement pstmt1 = connectDB.prepareStatement("update ac_project set proj = ? WHERE code = ?");
                    pstmt1.setObject(2,jTable1.getValueAt(i,0));
                    pstmt1.setObject(1,jTable1.getValueAt(i,1));
            ...
            javax.swing.JOptionPane.showMessageDialog(this, "Projects Update Done Successfully","Comfirmation",javax.swing.JOptionPane.INFORMATION_MESSAGE);
    ...
    private void newActionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_newActionActionPerformed
        try {
            ...
            for (int i = 0; i < jTable1.getRowCount(); i++){
                if (jTable1.getModel().getValueAt(i,0) != null){
                    java.sql.PreparedStatement pstmt1 = connectDB.prepareStatement("insert into ac_project values(upper(?),initcap(?),?,?, ?)");
                    pstmt1.setObject(1,jTable1.getValueAt(i,0));
                    pstmt1.setObject(2,jTable1.getValueAt(i,1));
                    pstmt1.setObject(3,jTextField1.getText());
                    pstmt1.setObject(4,jComboBox1.getSelectedItem());
                    pstmt1.setObject(5,donorCmbx.getSelectedItem());
    ...
    private void editBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editBtnActionPerformed
        ...
        jTable1.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB, "SELECT code, proj from ac_project where branch = '"+jComboBox1.getSelectedItem().toString()+"'"));
        // TODO add your handling code here:
    ...
    private javax.swing.JComboBox donorCmbx;
