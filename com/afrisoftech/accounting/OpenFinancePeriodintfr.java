 ...
 * @author  root
 */
public class OpenFinancePeriodintfr extends javax.swing.JInternalFrame {
    ...
    public OpenFinancePeriodintfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder("Previous Financial Period"));
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder("New Financial Period"));
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        int comp = 0;
        java.util.Date periodFrom1 = datePicker2.getDate();
        ...
        try {
            ...
            if(comp > 0){
                javax.swing.JOptionPane.showMessageDialog(this,"You cannot save before or after open accounting period ".toUpperCase(),"Caution Message",javax.swing.JOptionPane.INFORMATION_MESSAGE);
                
                //  java.sql.PreparedStatement pstmts2 = connectDB.prepareStatement("UPDATE financial_period set period_from = '"+datePicker2.getDate().toString()+"',period_to ='"+datePicker1.getDate().toString()+"',company_name = '"+jTextField1.getText()+"' WHERE period_status ilike 'Open%'");
                ...
                java.sql.PreparedStatement pstmt1v = connectDB.prepareStatement("INSERT INTO financial_period values(?,?,?,?,?,?,?)");
                ...
                pstmt1v.setObject(7,periodFrom1+" - "+periodTo1);
