...
public class PettyCashPyAdjmIntfr extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        */
        ...
        jScrollPane1.setBorder(javax.swing.BorderFactory.createTitledBorder("Reason"));
        ...
        jComboBox20.setModel(com.afrisoftech.lib.ComboBoxModel.ComboBoxModel(connectDB, "select distinct admission_no from hp_admission where discharge = false ORDER BY admission_no ASC"));
    ...
    private void jTextField113CaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextField113CaretUpdate
        if(this.jTextField113.getCaretPosition() < 3){
            ...
            jSearchTable2.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"select distinct voucher_no as name,payee from ac_petty_cash WHERE voucher_no ILIKE '"+jTextField113.getText()+"%' order by voucher_no"));
    ...
    private void jButton1111ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1111ActionPerformed
        ...
        try {
            ...
            java.sql.ResultSet rse1 = stm1.executeQuery("select lpad(nextval('pet_voucher_no')::varchar,7,0::varchar),nextval('transaction_no_seq')");
            while (rse1.next())
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
            ...
            pstmt21.setDouble(5,java.lang.Double.valueOf(jTextField3.getText()));
