 ...
 * @author  root
 */
public class BillAdjustmentIntfr extends javax.swing.JInternalFrame {
    ...
    public BillAdjustmentIntfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {
        ...
        */
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Date", "Service", "Quantity", "Total", "Adjustment", "Adjust?", "GL Code"
            }
        ) {
        ...
        jLabel12.setText("Amount to adjust");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 5;
        gridBagConstraints.weightx = 1.0;
        ...
        jButton1.setText("Save to adjust bill");
        ...
        jLabel2.setText("Adjusted Amount");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 2;
        gridBagConstraints.gridy = 5;
        gridBagConstraints.weightx = 1.0;
        ...
        jTabbedPane1.addTab("Bill adjustment form", jPanel1);
...
/*
                            ...
                            */
                            ...
                            pstmt22.setString(8, jTable1.getModel().getValueAt(i, 6).toString());
                            ...
                            pstmt22.setString(13, com.afrisoftech.lib.GLCodesFactory.getActivityDescription(connectDB, jTable1.getModel().getValueAt(i, 6).toString()));
                        ...
                        if (jTable1.getModel().getValueAt(i, 4) != null) {
                            ...
                            if (java.lang.Double.valueOf(jTable1.getValueAt(i, 4).toString()) > 0) {
                                ...
                                pstmt.setDate(10, null);
                                   pstmt.setString(11, "Adjustment");
                                    pstmt.setString(16, "Adjustment");
                                ...
                                pstmt2.setString(10, jTextField7.getText());
                                    pstmt2.setString(11, "Adjustment");
                                pstmt2.setString(12, "");
                                pstmt2.setString(13, "");
