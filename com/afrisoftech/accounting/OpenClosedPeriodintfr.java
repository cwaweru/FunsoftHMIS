 ...
 * @author  root
 */
public class OpenClosedPeriodintfr extends javax.swing.JInternalFrame {
    ...
    public OpenClosedPeriodintfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder("Period to Open"));
        ...
        jComboBox11.setModel(com.afrisoftech.lib.ComboBoxModel.ComboBoxModel(connectDB, "SELECT period_description FROM period_setup WHERE period_status ilike 'Closed' ORDER BY period_from ASC"));
        ...
        jLabel6.setText("Period To Open");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 2;
        ...
        jButton5.setText("Proceed to Open Period");
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        try {
                ...
                java.sql.PreparedStatement pstmts2 = connectDB.prepareStatement("UPDATE period_setup SET period_status = 'Open' WHERE period_from = '"+datePicker2.getDate().toString()+"' AND period_to = '"+datePicker1.getDate().toString()+"' AND company_name = '"+jTextField1.getText()+"' AND period_status ilike 'Closed%'");
                
                pstmts2.executeUpdate();
                
                
                javax.swing.JOptionPane.showMessageDialog(this,"Period opened successfully".toUpperCase(),"Information Message",javax.swing.JOptionPane.INFORMATION_MESSAGE);
