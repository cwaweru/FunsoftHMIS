 ...
 * loanpymntintfr.java
 *
 * Created on May 26, 2011, 1:09 PM
 * Created for helping be able to refund Medsupt New Nyanza Hospital [Dr. Juliana]
 */
 ...
 * @author  root
 */
public class RefundsOldIntfr extends javax.swing.JInternalFrame {
    ...
    public RefundsOldIntfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
       ...
       // jTextField141.setText(System.getProperty("cashpoint"));
        ...
        jTextField2.setText(getShiftNumber());
    ...
    private void initComponents() {
        ...
        */
        ...
        jPanel4.setBackground(new java.awt.Color(235, 218, 161));
        ...
        */
        ...
        gridBagConstraints.gridx = 4;
        gridBagConstraints.gridy = 8;
        jPanel4.add(jButton611, gridBagConstraints);
...
// TODO add your handling code here:
    ...
    private void jSearchTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jSearchTableMouseClicked
        ...
        try {
            ...
            java.sql.ResultSet rset = stmt.executeQuery("select dealer,payment_mode,sum(debit-credit),receipt_time,patient_no,transaction_no,user_name,shift_no from ac_cash_collection where receipt_no ='" + jTextField91.getText() + "'  GROUP BY dealer,payment_mode,receipt_time,patient_no,transaction_no,user_name,shift_no");
            while (rset.next()) {
                ...
                //    jTextField71.setText(rset.getObject(4).toString());
//                jTextField10.setText(rset.getObject(4).toString());
                jTextField4.setText(rset.getObject(5).toString());
                jTextField5.setText(rset.getObject(6).toString());
                jTextField9.setText(rset.getObject(7).toString());
               // jTextField2.setText(rset.getObject(8).toString());
            }


            java.sql.Statement stmtTable1s = connectDB.createStatement();

            java.sql.ResultSet rsetTable1s = stmtTable1s.executeQuery("SELECT DISTINCT CASE WHEN(visit_id IS NULL) THEN '-' ELSE visit_id END AS visit_id FROM hp_patient_card WHERE requisition_no = '" + jTextField91.getText() + "'");// AND paid = false");

            while (rsetTable1s.next()) {
                jTextField8.setText(rsetTable1s.getObject(1).toString());
            }
        ...
        try {
            ...
            java.sql.ResultSet rsetTable1 = stmtTable1.executeQuery("SELECT description,quantity, sum(debit-credit),activity_code FROM ac_cash_collection WHERE receipt_no = '" + jTextField91.getText() + "' group by description,activity_code,quantity");// AND paid = false");
            ...
            java.sql.ResultSet rset1 = stmt1.executeQuery("SELECT sum(debit-credit) FROM ac_cash_collection WHERE receipt_no = '" + jTextField91.getText() + "'");// AND paid = false");
    ...
    private void jTextField111CaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextField111CaretUpdate
       if(jTextField111.getText().toCharArray().length > 3){
        jSearchTable.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB, "select distinct receipt_no FROM ac_cash_collection where receipt_no ilike '" + jTextField111.getText() + "%'  ORDER BY receipt_no ASC"));
        //jSearchTable.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"select distinct receipt_no FROM ac_cash_collection where receipt_no ilike '"+jTextField111.getText()+"%' AND user_name  ='"+jComboBox1.getSelectedItem()+"' and shift_no = '"+jTextField2.getText()+"' ORDER BY receipt_no ASC"));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       ...
       // try {
            ...
            try {
                ...
                java.sql.ResultSet rse3 = stm3.executeQuery("select gl_code,cash_point,shift_no,current_user,transaction_no from ac_cash_collection where receipt_no = '" + jTextField91.getText() + "'");
                while (rse3.next()) {
                    glCode1 = rse3.getObject(1).toString();
                    cashpoint = System.getProperty("cashpoint");
                    shiftno = jTextField2.getText();
                    ...
                    if (jTable1.getModel().getValueAt(i, 0) != null) {
                        ...
                        if (jCheckBox4.isSelected()) {
                            ...
                            if (jCheckBox1.isSelected()) {
                                ...
                                java.sql.Statement stm12ca = connectDB.createStatement();
                                java.sql.ResultSet rse12ca = stm12ca.executeQuery("SELECT visit_id FROM hp_admission WHERE patient_no = '" + jTextField4.getText() + "' ORDER BY date_admitted DESC LIMIT 1");
                                while (rse12ca.next()) {

                                    jTextField8.setText(rse12ca.getObject(1).toString());
                                    //AccDesc = rse12c.getObject(2).toString();
                                }
                                ...
                                pstmt.setString(28, jTextField8.getText());
                                pstmt.setString(29, jTextField91.getText());
                                pstmt.executeUpdate();
                            } else {
                                if (jCheckBox2.isSelected()) {
                                    ...
                                    java.sql.ResultSet rse3d1 = stm3d1.executeQuery("select account_no,payer_name from ac_schemes where scheme_name ILIKE '" + jTextField1.getText() + "'");
                                    while (rse3d1.next()) {
                                    ...
                                    pstmt.setString(8, jTextField91.getText());
                                    pstmt.setString(9, jTextField91.getText());
                                    pstmt.setString(10, "");
                                    ...
                                    if (jCheckBox3.isSelected()) {
                                        ...
                                        java.sql.Statement stm3d1 = connectDB.createStatement();
                                        java.sql.ResultSet rse3d1 = stm3d1.executeQuery("select distinct acc_no,doctor_name from ac_doctors_ledger where reference = '" + jTextField91.getText() + "'");
                                        while (rse3d1.next()) {
                                            account = rse3d1.getObject(1).toString();
                                            payer = rse3d1.getObject(2).toString();
                                        }
                        ...
                        pstmt2.setString(25, jTextField2.getText());
...
//                jComboBox1.setEnabled(false);
    ...
    private void jButton611ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton611ActionPerformed
        ...
        double totalSum = com.afrisoftech.lib.TableColumnTotal.getTableColumnTotal(jTable1, 2);
