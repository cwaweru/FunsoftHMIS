...
public class ActivitiesIntfr extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Main Code", "Descripyion", "Account Category"
            }
        ));
        ...
        jTable21.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Account Code", "Account Name", "Payment Mode", "Account Category", "Department Code", "Direct Cash Payments"
            }
        ) {
        ...
        javax.swing.table.TableColumn teditor1 = this.jTable21.getColumn("Department Code");
    ...
    private void jButton211ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton211ActionPerformed
        ...
        try {
            ...
            java.sql.ResultSet rsetTable1 = stmtTable1.executeQuery("select code,activity,payment_modes,activity_category,department,direct_cash_payment from pb_activity where sub_code = '" + jTextField2.getText() + "'  order by code");
        ...
        try {
            ...
            for (int i = 0; i < jTable21.getRowCount(); i++) {
                if (jTable21.getModel().getValueAt(i, 0) != null) {
                    ...
                    if (j <= 0) {
                        java.sql.PreparedStatement pstmt = connectDB.prepareStatement("INSERT INTO pb_activity("
                                + "sub_code, code, activity, payment_mode, date, payment_modes, activity_category,department) "
                                + "VALUES (?, ?, ?, ?, ?, ?, ?, ?)");
                        ...
                        java.sql.PreparedStatement pstmt31 = connectDB.prepareStatement("UPDATE pb_activity SET activity = '" + jTable21.getModel().getValueAt(i, 1).toString() + "',payment_modes = '" + jTable21.getModel().getValueAt(i, 2).toString() + "',activity_category = '" + jTable21.getModel().getValueAt(i, 3).toString() + "', department = '" + jTable21.getModel().getValueAt(i, 4).toString() + "',direct_cash_payment = '" + Boolean.valueOf(jTable21.getModel().getValueAt(i, 5).toString()) + "'  WHERE code ILIKE '" + jTable21.getModel().getValueAt(i, 0).toString() + "'");
                        pstmt31.executeUpdate();
                        
                        pstmt31 = connectDB.prepareStatement("UPDATE pb_operating_parameters SET direct_cash_payment = '" + Boolean.valueOf(jTable21.getModel().getValueAt(i, 5).toString()) + "'  WHERE gl_account ILIKE '" + jTable21.getModel().getValueAt(i, 0).toString() + "'");
                        pstmt31.executeUpdate();
                    }
