...
public class ActivitiesIntfr extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jTable21.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Account Code", "Account Name", "Payment Mode", "Account Category", "Department Code"
            }
        ));
    ...
    private void jButton211ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton211ActionPerformed
        ...
        try {
            ...
            java.sql.ResultSet rsetTable1 = stmtTable1.executeQuery("select code,activity,payment_modes,activity_category,department from pb_activity where sub_code = '" + jTextField2.getText() + "'  order by code");
