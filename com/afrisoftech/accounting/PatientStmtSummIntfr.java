...
//        if (jTable1.getSelectedColumn() == 2) {
            ...
            if (Boolean.valueOf(jTable1.getValueAt(jTable1.getSelectedRow(),2).toString()) == java.lang.Boolean.TRUE) {
                
                if(this.jCheckBox1.isSelected()){
                    com.afrisoftech.reports.ReceiptsCopysPdf policy = new com.afrisoftech.reports.ReceiptsCopysPdf();
                    
                    policy.ReceiptsCopysPdf(connectDB,receiptNo);
                    System.out.print("See receipt No. : "+receiptNo);
                }else{
                    if(this.jCheckBox11.isSelected() && jCheckBox2.isSelected()){
                        ...
                        if(this.jCheckBox5.isSelected() && jCheckBox2.isSelected()){
                            ...
                            policy.FinalDebtInvoicePdf(connectDB,receiptNo);
                        }
                    }
                }
            }
        ...
        if(this.jCheckBox5.isSelected() && this.jCheckBox3.isSelected()){
            ...
            if(jTextField113.getCaretPosition() < 3){
                System.out.println("Nothing");
                 ...
                 jSearchTable2.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"SELECT account_no, scheme_name as name from ac_schemes where account_no ILIKE '"+jTextField113.getText()+"%' order by account_no")); 
            ...
            if(this.jCheckBox5.isSelected() && this.jCheckBox4.isSelected()){
                jSearchTable2.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"SELECT account_no, scheme_name as name from ac_schemes where scheme_name ILIKE '"+jTextField113.getText()+"%' order by scheme_name")); 
