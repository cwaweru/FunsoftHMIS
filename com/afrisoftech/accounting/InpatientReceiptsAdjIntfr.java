    ...
    private void jButton1111ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1111ActionPerformed
        try{
            ...
            try {
                ...
                pstmtx.setDate(14,com.afrisoftech.lib.SQLDateFormat.getSQLDate(java.sql.Date.valueOf(jTextField2.getText())));
                ...
                pstmt2.setDouble(17,java.lang.Double.valueOf(jTextField17.getText()));
                pstmt2.setDouble(16,0.00);
                pstmt2.setDate(18,com.afrisoftech.lib.SQLDateFormat.getSQLDate(java.sql.Date.valueOf(jTextField2.getText())));
