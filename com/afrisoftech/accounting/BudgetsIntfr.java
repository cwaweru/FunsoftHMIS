 ...
 * @author  root
 */
public class BudgetsIntfr extends javax.swing.JInternalFrame {
    ...
    public BudgetsIntfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {
        ...
        */
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Set budget & their details here."));
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Department Name", "Account Code", "Revenue Per Day", "Cost os Sale Per Day"
            }
        ) {
        ...
        try {
            ...
            for (int i = 0; i < jTable1.getRowCount(); i++){
                if (jTable1.getModel().getValueAt(i,0) != null){
                    ...
                    java.sql.ResultSet rsetTable11 = stmtTable11.executeQuery("SELECT count(description)  FROM ac_budgets WHERE gl_code ilike  '"+jTable1.getValueAt(i,1).toString()+"%'");
                    ...
                    if (j > 0) {
                        ...
                        java.sql.PreparedStatement pstmt31 = connectDB.prepareStatement("DELETE FROM ac_budgets WHERE gl_code ILIKE '"+jTable1.getModel().getValueAt(jTable1.getSelectedRow(),1).toString()+"'");
    ...
    private void jSearchTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jSearchTable1MouseClicked
        ...
        // if(j == 0){
        jTable1.setValueAt(jSearchTable1.getValueAt(jSearchTable1.getSelectedRow(),1),jTable1.getSelectedRow(), 0);
        jTable1.setValueAt(jSearchTable1.getValueAt(jSearchTable1.getSelectedRow(),0),jTable1.getSelectedRow(), 1);
        //     }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            ...
            java.sql.ResultSet rsetTable1 = stmtTable1.executeQuery("select description,gl_code,amounts,sales_cost from ac_budgets order by description");
            ...
            for (int i = 0; i < jTable1.getRowCount(); i++){
                if (jTable1.getModel().getValueAt(i,0) != null){
                    ...
                    if (j <= 0) {
                        ...
                        java.sql.PreparedStatement pstmt = connectDB.prepareStatement("insert into ac_budgets values(?,?,?,?)");
                        
                        if (jTable1.getModel().getValueAt(i,0) == null){
                            javax.swing.JOptionPane.showMessageDialog(this,"ACCOUNT DESCRIPTION","Error Message!",javax.swing.JOptionPane.ERROR_MESSAGE);
                        }else{
                            pstmt.setObject(1,jTable1.getValueAt(i,1).toString());
                        }
                        if (jTable1.getModel().getValueAt(i,1) == null){
                            
                            javax.swing.JOptionPane.showMessageDialog(this,"ACCOUNT CODE","Error Message!",javax.swing.JOptionPane.ERROR_MESSAGE);
                        }else{
                            pstmt.setObject(2,jTable1.getValueAt(i,0).toString());
                        }
                        if (jTable1.getModel().getValueAt(i,2) == null){
                            
                            javax.swing.JOptionPane.showMessageDialog(this,"ENTER REVENUE","Error Message!",javax.swing.JOptionPane.ERROR_MESSAGE);
                        }else{
                            pstmt.setDouble(3,java.lang.Double.valueOf(jTable1.getValueAt(i,2).toString()));
                        }
                        if (jTable1.getModel().getValueAt(i,3) == null){
                            
                            javax.swing.JOptionPane.showMessageDialog(this,"ENTER COST OF SALE","Error Message!",javax.swing.JOptionPane.ERROR_MESSAGE);
                        }else{
                        ...
                        java.sql.PreparedStatement pstmt31 = connectDB.prepareStatement("UPDATE ac_budgets SET description = '"+jTable1.getModel().getValueAt(i,0).toString()+"',amounts = '"+jTable1.getModel().getValueAt(i,2).toString()+"',sales_cost  = '"+jTable1.getModel().getValueAt(i,3).toString()+"'  WHERE gl_code ILIKE '"+jTable1.getModel().getValueAt(i,1).toString()+"'");
                        pstmt31.executeUpdate();
                    }
                }
            }
