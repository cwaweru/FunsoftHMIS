 ...
 */
public class FinSchemeInvsNhifBackDatesIntfr extends javax.swing.JInternalFrame {
    ...
    public FinSchemeInvsNhifBackDatesIntfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
                        ...
                        try {
                            ...
                            for (int i = 0; i < schemeInvoicingTable.getRowCount(); i++) {
                                ...
                                if (schemeInvoicingTable.getModel().getValueAt(i, 2) != null) {
                                    ...
                                    pstmt.setDate(14, com.afrisoftech.lib.SQLDateFormat.getSQLDate(dischargeDatePicker.getDate()));//com.afrisoftech.lib.ServerTime.getSQLDate(connectDB));
                                    ...
                                    pstmt2.setDate(15, com.afrisoftech.lib.SQLDateFormat.getSQLDate(dischargeDatePicker.getDate()));//com.afrisoftech.lib.ServerTime.getSQLDate(connectDB));
                                    ...
                                    if (rebateType) {
                                        ...
                                        if (nhifDiff != 0) { //&& payModeTxt.getText().equalsIgnoreCase("Cash")
                                            ...
                                            pstmtp.setDate(14, com.afrisoftech.lib.SQLDateFormat.getSQLDate(dischargeDatePicker.getDate()));//com.afrisoftech.lib.ServerTime.getSQLDate(connectDB));
                                            ...
                                            pstmt2x.setDate(18, com.afrisoftech.lib.SQLDateFormat.getSQLDate(dischargeDatePicker.getDate()));//com.afrisoftech.lib.ServerTime.getSQLDate(connectDB));
...
//                                        }
                                    ...
                                    pstmt1.setDate(15, com.afrisoftech.lib.SQLDateFormat.getSQLDate(dischargeDatePicker.getDate()));//com.afrisoftech.lib.ServerTime.getSQLDate(connectDB));
                            ...
                            for (int i = 0; i < billTable.getRowCount(); i++) {
                                if (billTable.getModel().getValueAt(i, 3) != null && billTable.getModel().getValueAt(i, 0) != null) {
                                    ...
                                    if (Disc > 0) {
                                        ...
                                        pstmtd.setDate(14, com.afrisoftech.lib.SQLDateFormat.getSQLDate(dischargeDatePicker.getDate()));//com.afrisoftech.lib.ServerTime.getSQLDate(connectDB));
    ...
    private void consolidateDepositTxtActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_consolidateDepositTxtActionPerformed
        if (!visitIDTxt.getText().isEmpty()) {
            ...
            try {
                ...
                Logger.getLogger(FinSchemeInvsNhifBackDatesIntfr.class.getName()).log(Level.SEVERE, null, ex);
            }
