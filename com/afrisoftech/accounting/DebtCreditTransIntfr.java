...
public class DebtCreditTransIntfr extends javax.swing.JInternalFrame {
    ...
    private void jTextField11111CaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextField11111CaretUpdate
        if(jTextField11111.getCaretPosition() < 3){
            ...
            jSearchTable1.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"select (scheme_name) as scheme,account_no,payer_name from ac_schemes where scheme_name ILIKE '"+jTextField11111.getText().toString()+"%'"));
    ...
    private void jTextField1111CaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextField1111CaretUpdate
        if(jTextField1111.getCaretPosition() < 3){
            ...
            jSearchTable.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"select distinct receipt_no as scheme,payee,dealer,credit_bal,account_no from ac_debtors where receipt_no ILIKE '"+jTextField1111.getText().toString()+"%' and credit_bal > 0"));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(datePicker1.getDate().before(periodFrom) || datePicker1.getDate().after(periodTo)){
            ...
            if(jTextField36.getText().toString().equalsIgnoreCase("")){
                javax.swing.JOptionPane.showMessageDialog(this,"You must select receipt no before proceding","Caution Message!",javax.swing.JOptionPane.INFORMATION_MESSAGE);
                ...
                if (exitOption == javax.swing.JOptionPane.YES_OPTION) {
                    ...
                    if (num_c > total_num) {
                        ...
                        try {
                            ...
                            pstmt.setString(9,jTextField36.getText());
                            pstmt.setString(10,"");
                            ...
                            pstmt.setDouble(22,java.lang.Double.valueOf(jTextField5.getText()));
                            ...
                            pstmt1.setDouble(14,java.lang.Double.valueOf(jTextField3.getText()));
                            pstmt1.setDouble(13,0.00);
                            pstmt1.setDouble(24,java.lang.Double.valueOf(jTextField3.getText()));
