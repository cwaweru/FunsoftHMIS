...
public class WritOffMiscDebtsIntrIntfr extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Date", "Inv. No.", "Patient No.", "Inv Amount", "Amt To Write Off", "Balance", "Boolean"
            }
        ) {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(datePicker12.getDate().before(periodFrom) || datePicker1.getDate().after(periodTo)){
                        ...
                        for (int i = 0; i < jTable1.getRowCount(); i++){
                            if (jTable1.getModel().getValueAt(i,3) != null){
                                ...
                                if(java.lang.Double.parseDouble(jTable1.getValueAt(i,3).toString()) > 0){
                                    ...
                                    pstmt.setDouble(14,java.lang.Double.valueOf(jTable1.getValueAt(i,3).toString()));
                                    pstmt.setString(16,"");
