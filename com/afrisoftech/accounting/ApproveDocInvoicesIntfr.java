...
public class ApproveDocInvoicesIntfr extends javax.swing.JInternalFrame {
   ...
   java.sql.Statement stmt = connectDB.createStatement();
    ...
    private void jTextField11111CaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextField11111CaretUpdate
        jSearchTable1.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"select voucher_no as Voucher_No,debit_bal AS Amount,reference As Cheque_No from ac_doctors_ledger where debit_bal > 0 and voucher_no ILIKE '"+jTextField11111.getText().toString()+"%' and acc_no ='"+jTextField4.getText()+"'"));
  ...
  */
        ...
        if(this.jTextField1111.getCaretPosition() < 3){
            ...
            jSearchTable11.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"select distinct first_name as name,staff_no from pb_doctors_list where first_name ILIKE '"+jTextField1111.getText()+"%' order by first_name"));
                    ...
                    if (Boolean.valueOf(jTable1.getModel().getValueAt(jTable1.getSelectedRow(), 6).toString()) == java.lang.Boolean.TRUE) {
                        for (int i = 0; i < jTable1.getRowCount(); i++){
                            if (jTable1.getModel().getValueAt(i,4) != null){
                                ...
                                java.sql.PreparedStatement pstmt2q = connectDB.prepareStatement("UPDATE ac_doctors_ledger_off set credit_bal = (credit_bal - '"+jTable1.getModel().getValueAt(i,4).toString()+"') WHERE pat_inv = '"+jTable1.getModel().getValueAt(i,1).toString()+"' and acc_no ='"+this.jTextField4.getText()+"' AND input_date = '"+jTable1.getValueAt(i,0).toString()+"'");
                                pstmt2q.executeUpdate();
                            }
                        }
                    }
                    ...
                    if (Boolean.valueOf(jTable1.getModel().getValueAt(j, 6).toString()) == java.lang.Boolean.TRUE) {
                       ...
                       // if(this.jTable1.getModel().getValueAt(j,6) != null){
                            ...
                            if(amt1 > floatCol2) {
                                ...
                                jTable1.setValueAt(new java.lang.Double(balance), jTable1.getSelectedRow(), 4);
     
                                jTable1.setValueAt(new java.lang.Double(0.00), jTable1.getSelectedRow(), 5);
                                ...
                                if (amt1 <= floatCol2 && amt1 >= 0){
                                     double balance = java.lang.Double.parseDouble(jTable1.getValueAt(jTable1.getSelectedRow(), 5).toString());
                                     jTable1.setValueAt(new java.lang.Double(amt1), jTable1.getSelectedRow(), 4);
                                    jTable1.setValueAt(new java.lang.Double(java.lang.Math.round(balance-amt1)),jTable1.getSelectedRow(),5);
                                   // double balance = java.lang.Double.parseDouble(jTable1.getValueAt(jTable1.getSelectedRow(), 5).toString());
                            ...
                            amt1 = amt - Double.parseDouble(jTable1.getModel().getValueAt(j, 4).toString());
                             i++;
                            }
                        ...
                        if (Boolean.valueOf(jTable1.getModel().getValueAt(jTable1.getSelectedRow(), 6).toString()) == java.lang.Boolean.FALSE) {
                          ...
                          //  if(this.jTable1.getModel().getValueAt(jTable1.getSelectedRow(),6) != null){
                               ...
                               // jTable1.setValueAt(jTable1.getValueAt(jTable1.getSelectedRow(),4), jTable1.getSelectedRow(), 5);
                                jTable1.setValueAt(new java.lang.Double(0), jTable1.getSelectedRow(), 4);
