 ...
 * @author  root
 */
public class ShareTransIntfr extends javax.swing.JInternalFrame {
    ...
    public ShareTransIntfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {
        ...
        */
        ...
        jLabel54.setText("Certificate No");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 4;
        gridBagConstraints.weightx = 1.0;
        ...
        jLabel21.setText("Certificate No");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 3;
    ...
    private void jTextField3CaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextField3CaretUpdate
        ...
        double total_num = java.lang.Double.parseDouble(jTextField1.getText());
        double num_f = java.lang.Double.parseDouble(jTextField4.getText());
        
        // System.out.println(total_num);
        
        
        double num_h = num_f + num_c;
        
        double num_d = total_num - num_c;
        jTextField5.setText(""+num_d+"");
        jTextField2.setText(""+num_h+"");
    ...
    private void jSearchTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jSearchTable1MouseClicked
        ...
        jTextField10.setText(jSearchTable1.getValueAt(jSearchTable1.getSelectedRow(), 1).toString());
        //jTextField4.setText(jSearchTable1.getValueAt(jSearchTable1.getSelectedRow(), 2).toString());
        
        try {
            java.sql.Statement stmt = connectDB.createStatement();
            java.sql.ResultSet rset = stmt.executeQuery("select sum(balance) from ac_shares_ledger where account_no ='"+jTextField10.getText()+"' and transaction_type ilike 'sha%'");
            while (rset.next()){
    ...
    private void jTextField11111CaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextField11111CaretUpdate
        if(jTextField11111.getCaretPosition() < 1){
            ...
            System.out.println("Nothing");
              ...
              jSearchTable1.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"select holders_name,acc_no  from pb_share_register where holders_name ILIKE '%"+jTextField11111.getText().toString()+"%'"));
    ...
    private void jSearchTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jSearchTableMouseClicked
        ...
        jTextField7.setText(jSearchTable.getValueAt(jSearchTable.getSelectedRow(), 1).toString());
        jSearchDialog.dispose();
        this.jTextField5.setText("00");
        //this.jTextField3.setText("00");
        try {
            java.sql.Statement stmt = connectDB.createStatement();
            java.sql.ResultSet rset = stmt.executeQuery("select sum(balance) from ac_shares_ledger where account_no ='"+jTextField7.getText()+"' and transaction_type ilike 'sha%'");
            while (rset.next()){
                jTextField10.setText(rset.getObject(1).toString());
    ...
    private void jTextField1111CaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextField1111CaretUpdate
        if(jTextField1111.getCaretPosition() < 1){
            ...
            jSearchTable.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"select holders_name,acc_no  from pb_share_register where holders_name ILIKE '%"+jTextField1111.getText().toString()+"%'"));
        ...
        if (exitOption == javax.swing.JOptionPane.YES_OPTION) {
            ...
            if (num_c > total_num) {
                ...
                try {
                    ...
                    java.sql.ResultSet rse3 = stm3.executeQuery("select activity,code from pb_activity where activity_category ='SH'");
                    while (rse3.next())
                    ...
                    java.sql.ResultSet rsts = pss.executeQuery("select 'SH'||nextval('shtrans_seq_no')");
                    while (rsts.next())
                        rsts.getObject(1).toString();
                    
                    transNo = rsts.getObject(1).toString();
                    
                    java.sql.PreparedStatement pstmt = connectDB.prepareStatement("insert into ac_shares_ledger values(?,?,?,?,?,?,?,?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?,?,?,?,?,?,?,numeric_uminus(?))");
                    pstmt.setString(1,bankAcc);
                    pstmt.setString(2,jTextField36.getText());
                    pstmt.setString(3,"Transfered Out");
                    pstmt.setString(5,jTextField36.getText());
                    pstmt.setString(7,jTextField7.getText());
                    pstmt.setString(6,"Transfered In");
                    pstmt.setString(8,jTextField9.getText());
                    pstmt.setString(9,"");
                    pstmt.setString(10,"");
                    pstmt.setString(4,"");
                    pstmt.setString(12,"Shares");
                    ...
                    java.sql.PreparedStatement pstmt1 = connectDB.prepareStatement("insert into ac_shares_ledger values(?,?,?,?,?,?,?,?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?,?,?,?,?,?,?,?)");
                    pstmt1.setString(1,bankAcc);
                    pstmt1.setString(2,jTextField361.getText());
                    
                    pstmt1.setString(3,"Transfered In");
                    pstmt1.setString(5,jTextField361.getText());
                    pstmt1.setString(7,jTextField10.getText());
                    pstmt1.setString(6,"Transfered In");
                    pstmt1.setString(8,jTextField111.getText());
                    pstmt1.setString(9,"");
                    pstmt1.setString(10,"");
                     pstmt1.setString(4,"");
                    pstmt1.setString(12,"Shares");
                    pstmt1.setString(13,"00");
                    pstmt1.setString(14,jTextField3.getText());
                    pstmt1.setString(11,transNo);
                    pstmt1.setString(16,jTextField111.getText());
                    pstmt1.setString(25,jTextField3.getText());
