...
public class DispatchPerPayerInvoicesIntfr extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        //try {
            ...
            jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Select Scheme Manager Here", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Dialog", 0, 11), new java.awt.Color(255, 0, 255)));
    ...
    private void jSearchTable11MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jSearchTable11MouseClicked
        ...
        try {
            ...
            java.sql.ResultSet rset = stmt.executeQuery("SELECT count(dealer) FROM ac_debtors WHERE dealer = '"+jTextField7.getText()+"' and balance > 0 and sent = false");// and revenue_code = '"+jTextField5.getText()+"' AND paid = false");
            ...
            if (j > 0){
                ...
                jTable1.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"SELECT date::date, invoice_no, admission_no as patient_no,initcap(item) as name,balance::numeric as balance,false as discharge FROM ac_debtors WHERE dealer = '"+jTextField7.getText()+"' AND balance > 0 and sent = false order by date"));
                jScrollPane1.setViewportView(jTable1);
    ...
    private void jTextField1111CaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextField1111CaretUpdate
        if(jTextField1111.getCaretPosition() < 3){
            ...
            jSearchTable11.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"SELECT account_no,scheme_manager from ac_scheme_providers where scheme_manager ILIKE '"+jTextField1111.getText()+"%' order by scheme_manager"));
        ...
        try{
            ...
            try {
                ...
                if (j > 0){
                    ...
                    jTable1.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"SELECT date::date, invoice_no, admission_no as patient_no,initcap(item) as name,debit::numeric as balance,false as discharge FROM ac_debtors WHERE dealer = '"+jTextField7.getText()+"' AND balance > 0 and sent = false order by date"));
                    jScrollPane1.setViewportView(jTable1);
    ...
    private void populateTable1(java.lang.String patient_no) {
        ...
        try {
            ...
            if (j > 0){
                ...
                jTable1.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"SELECT date::date, invoice_no, admission_no,initcap(item),debit::numeric,null as boolean FROM ac_debtors WHERE dealer = '"+patient_no+"' AND balance > 0 and sent = false order by date"));
