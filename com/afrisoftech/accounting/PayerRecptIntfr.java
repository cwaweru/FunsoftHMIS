                ...
                if(datePicker1.getDate().before(periodFrom) || datePicker1.getDate().after(periodTo)){
                    ...
                    for (int i = 0; i < jTable1.getRowCount(); i++){
                        if (jTable1.getModel().getValueAt(i,0) != null){
                            ...
                            pstmt.setDouble(14,java.lang.Double.valueOf(jTable1.getValueAt(i,2).toString()));
                            ...
                            pstmt.setDouble(24,java.lang.Double.valueOf(jTable1.getValueAt(i,2).toString()));
                            pstmt.setString(25,"");
                            ...
                            pstmt2.setString(13,"");
                            pstmt2.setString(14,"");
                            pstmt2.setDouble(16,java.lang.Double.valueOf(jTable1.getValueAt(i,2).toString()));
   ...
   */
    ...
    private void jTextField11111CaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextField11111CaretUpdate
        if(jTextField11111.getCaretPosition() < 3){
            ...
            jSearchTable1.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"select (scheme_name) as scheme,account_no from ac_schemes where scheme_name ILIKE '"+jTextField11111.getText().toString()+"%' and payer_name = '"+jTextField36.getText().toString()+"'"));
