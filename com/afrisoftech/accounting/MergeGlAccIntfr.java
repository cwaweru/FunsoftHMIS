 ...
 * @author  root
 */
public class MergeGlAccIntfr extends javax.swing.JInternalFrame {
    ...
    public MergeGlAccIntfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        */
        ...
        jTabbedPane1.addTab("Merge GL Accounts", jPanel61);
...
double floatDeduct = java.lang.Double.parseDouble(jTextField15.getText());
    ...
    private void jTextField11321CaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextField11321CaretUpdate
        if(this.jTextField11321.getCaretPosition() < 4){
            ...
            jSearchTable221.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"select code,activity as name from pb_activity  where code ILIKE '%"+jTextField11321.getText()+"%' order by code"));
   ...
   */
    ...
    private void jTextField1132CaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextField1132CaretUpdate
        if(this.jTextField1132.getCaretPosition() < 2){
            ...
            jSearchTable22.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"select code,activity as name from pb_activity  where code ILIKE '%"+jTextField1132.getText()+"%' order by code"));
    ...
    private void jButton11ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton11ActionPerformed
        ...
        int exitOption = javax.swing.JOptionPane.showConfirmDialog(this, "Are you sure You would like to change account ?", "Caution before Changing Accounts!", javax.swing.JOptionPane.YES_NO_CANCEL_OPTION);
        ...
        if (exitOption == javax.swing.JOptionPane.YES_OPTION) {
            ...
            try {
                ...
                java.sql.PreparedStatement pstmt22 = connectDB.prepareStatement("UPDATE ac_debtors set activity_code = '"+jTextField91.getText()+"' WHERE activity_code = '"+jTextField911.getText()+"'");
                pstmt22.executeUpdate();
                java.sql.PreparedStatement pstmt22c = connectDB.prepareStatement("UPDATE ac_accounts_payable set activity_code = '"+jTextField91.getText()+"' WHERE activity_code = '"+jTextField911.getText()+"'");
                pstmt22c.executeUpdate();
                java.sql.PreparedStatement pstmt22p = connectDB.prepareStatement("UPDATE ac_payroll_ledger set activity_code = '"+jTextField91.getText()+"' WHERE activity_code = '"+jTextField911.getText()+"'");
                pstmt22p.executeUpdate();
                java.sql.PreparedStatement pstmt22s = connectDB.prepareStatement("UPDATE ac_petty_cash set activity_code = '"+jTextField91.getText()+"' WHERE activity_code = '"+jTextField911.getText()+"'");
                pstmt22s.executeUpdate();
                
                java.sql.PreparedStatement pstmt22l = connectDB.prepareStatement("UPDATE ac_ledger set activity_code = '"+jTextField91.getText()+"' WHERE activity_code = '"+jTextField911.getText()+"'");
                pstmt22l.executeUpdate();
                java.sql.PreparedStatement pstmt22x = connectDB.prepareStatement("UPDATE st_stock_cardex set activity_code = '"+jTextField91.getText()+"' WHERE activity_code = '"+jTextField911.getText()+"'");
                pstmt22x.executeUpdate();
                java.sql.PreparedStatement pstmt22b = connectDB.prepareStatement("UPDATE ac_cash_book set activity_code = '"+jTextField91.getText()+"',gl_code= '"+jTextField91.getText()+"' WHERE gl_code = '"+jTextField911.getText()+"'");
                pstmt22b.executeUpdate();
                java.sql.PreparedStatement pstmt22r = connectDB.prepareStatement("UPDATE ac_cash_collection set activity_code = '"+jTextField91.getText()+"',gl_code= '"+jTextField91.getText()+"' WHERE gl_code = '"+jTextField911.getText()+"'");
                pstmt22r.executeUpdate();
                
                java.sql.PreparedStatement pstmt22d = connectDB.prepareStatement("UPDATE ac_doctors_ledger set gl_acc = '"+jTextField91.getText()+"' WHERE gl_acc = '"+jTextField911.getText()+"'");
                pstmt22d.executeUpdate();
                
                java.sql.PreparedStatement pstmt22t = connectDB.prepareStatement("UPDATE hp_patient_card set activity_code = '"+jTextField91.getText()+"' WHERE activity_code = '"+jTextField911.getText()+"'");
                pstmt22t.executeUpdate();
