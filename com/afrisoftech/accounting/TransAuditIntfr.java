 ...
 * @author  root
 */
public class TransAuditIntfr extends javax.swing.JInternalFrame {
    ...
    public TransAuditIntfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {
        ...
        */
        ...
        jTable12.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Date", "Audit No", "Debit", "Credit", "Diff"
            }
        ) {
            Class[] types = new Class [] {
        ...
        */
        ...
        jLabel131.setText("Transaction No.");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 2;
...
//            this.cmboxMouseClicked();
    ...
    private void jTable12MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable12MouseClicked
        this.populateTable1(jTable12.getValueAt(jTable12.getSelectedRow(),1).toString());
    ...
    private void jCheckBox2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jCheckBox2ActionPerformed
        ...
        try {
          ...
          /*  java.sql.ResultSet rsetTable1 = stmtTable1.executeQuery("select date,CASE WHEN (transaction_no IS NULL) THEN '-' ELSE transaction_no END AS transaction_no,sum(debit) as debit,sum(credit) as credit,sum(balance) as balance from trans_list_summary WHERE date BETWEEN '"+datePicker1.getDate().toString()+"' and '"+datePicker3.getDate().toString()+"' AND balance <> 0 GROUP BY date,transaction_no ORDER BY date,transaction_no ASC");
            ...
            java.sql.ResultSet rsetTotals = st2.executeQuery("SELECT SUM(debit) as debit,SUM(credit) as credit,sum(balance) as balance from trans_list_summary WHERE date BETWEEN '"+datePicker1.getDate().toString()+"' and '"+datePicker3.getDate().toString()+"' AND balance <> 0");
            while (rsetTotals.next()) {
                jTextField13.setText(rsetTotals.getString(1));
                jTextField3.setText(rsetTotals.getString(2));
                jTextField15.setText(rsetTotals.getString(3));
    ...
    private void populateTable1(java.lang.String patient_no) {
        ...
        jTable1.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"select date,CASE WHEN (activity_code IS NULL) THEN '-' ELSE activity_code END AS activity_code ,CASE WHEN (transaction_no IS NULL) THEN '-' ELSE transaction_no END AS audit_no,initcap(description) as description,initcap(transaction_type) as transaction_type,sum(debit) as debit,sum(credit) as credit from transaction_list_view WHERE date BETWEEN '"+datePicker1.getDate().toString()+"' and '"+datePicker3.getDate().toString()+"' AND transaction_no = '"+jTable12.getValueAt(jTable12.getSelectedRow(),1).toString()+"' GROUP BY date,activity_code,description,transaction_no,transaction_type ORDER BY transaction_no ASC"));
    }
        /*int i = 0;
        int j = 0;
        try {
