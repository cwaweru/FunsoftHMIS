...
public class CreditorInvAmmendIntfr extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        */
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder("Creditors Details"));
...
//        jSearchDialog21.setVisible(true);
    ...
    private void jTextField113CaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextField113CaretUpdate
        if(this.jTextField113.getCaretPosition() < 2){
            ...
            jSearchTable2.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"select DISTINCT account_no as pat_no,dealer as name from ac_accounts_payable where dealer ILIKE '"+jTextField113.getText()+"%' order by dealer"));
