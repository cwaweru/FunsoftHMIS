 ...
 * @author charlie
 */
public class EditCollectionData1 extends javax.swing.JDialog {
     ...
     * @param lcid
     */
    public EditCollectionData1(java.awt.Frame parent, boolean modal, String[] lcid, Connection passedConn) {
        super(parent, modal);
        conn=passedConn;
        initComponents();
        setTitle("Edit Collection Round");
        globallcid=lcid[0];
      
        try {
            datePicker.setDate(sdf3.parse(lcid[1]));
        } catch (ParseException ex) {
            Logger.getLogger(EditCollectionData1.class.getName()).log(Level.SEVERE, null, ex);
        }
...
ResultSet.CONCUR_UPDATABLE);
            ...
            while ( rs.next() ) {
                ...
                for(int counter1b=1; counter1b<counter1; counter1b++){
                    ...
                    String sql3="select count, linenattendantid from linencollectionitem where wardid like'"+rs.getString("ward_code")+"' AND typeid like '"+linenTypeID[counter1b]+"' and lcolid like '"+lcid[0]+"'";
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        if(datePicker.getDate()!=null){
            ...
            try {
                ...
                stmt3.execute( "update linencollection set date='"+tarehe+"', time='"+currTime+"', timestamp='"+currTimeStamp+"' where lcid='"+globallcid+"'" );
                Statement stmt4 = conn.createStatement();
                stmt4.execute("delete from linencollectionitem where lcolid like '"+globallcid+"'");
                    ...
                    for(int allCols=1; allCols<totalNumCols; allCols++){
                        ...
                        if(countValue!=null&&!countValue.equals("")){
                            try {
                                ...
                                stmt2.execute( "insert into linencollectionitem (count, wardid, typeid, lcolid, linenattendantid) values('"+countValue+"','"+wards.get(r2)+"', '"+linenTypeID[allCols]+"','"+globallcid+"', '"+attendantID+"'  )" );
            ...
            JOptionPane.showMessageDialog(null,"Collection Round Edited!","Success",JOptionPane.INFORMATION_MESSAGE);
            dispose();
