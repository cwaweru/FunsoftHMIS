...
public class CondemnedLinenPdf implements java.lang.Runnable {
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    phrase = new Phrase("Condemned Linen Report for  "+tarehe , pFontHeader3);
                    ...
                    phrase = new Phrase("Unit Price",pFontHeader1);
                    table.addCell(phrase);
                    
                    phrase = new Phrase("Total Value",pFontHeader1);
                    table.addCell(phrase);
                    ...
                    try{
                        ...
                        java.sql.ResultSet rset = st2.executeQuery("select st_stock_item.item_code, st_stock_item.description, st_stock_item.buying_price, condemnedlinen.qty\n" +
                        "from st_stock_item, condemnedlinen\n" +
                        "where st_stock_item.item_code=condemnedlinen.itemcode AND condemnedlinen.datefor like '"+tareheDb+"'\n" +
                        ...
                        "order by st_stock_item.description asc");
                            ...
                            while (rset.next()) {
                                ...
                                table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_CENTER);
                                phrase = new Phrase(rset.getString("qty"), pFontHeader2);
                                table.addCell(phrase);

                                table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_CENTER);
                                phrase = new Phrase(rset.getString("buying_price"), pFontHeader2);
                                table.addCell(phrase);

                                table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_CENTER);
                                Double totalVal=rset.getDouble("qty")*rset.getDouble("buying_price");
                                phrase = new Phrase(Double.toString(totalVal), pFontHeader2);
                                table.addCell(phrase);
