 ...
 * @author charlie
 */
public final class ViewCollectionData extends javax.swing.JInternalFrame {
    ...
    public ViewCollectionData(Connection passedConn) {
    ...
    public void initialise(){
        ...
        try {
            ...
            Logger.getLogger(ViewCollectionData.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    /**
    ...
    private void initComponents() {
        ...
        setMaximizable(true);
        setResizable(true);
        setTitle("Linen Collection Data Report");
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        CollectionReportPdf newPdf= new CollectionReportPdf();
        if(cbxRound.getSelectedIndex()>=0){
            newPdf.generatePdf(lcid[cbxRound.getSelectedIndex()], (String) cbxRound.getSelectedItem(), conn);
        }
    ...
    public void refreshRoundCbx(){
        ...
        try {
            ...
            String sql2="select lcid,timestamp, time from linencollection where date like '"+tarehe+"' order by lcid desc";
    ...
    private void RefreshClientsTable(){
        jTable1.setModel(new javax.swing.table.DefaultTableModel(batch, headers) {
         @Override
    ...
    private void generateTable(String colID){
        ...
        if(collectionID.equals("")){
            ...
            jTable1.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectorsCollection(conn,colID));     
