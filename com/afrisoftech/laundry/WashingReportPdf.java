...
public class WashingReportPdf implements java.lang.Runnable {
    ...
    public void generatePdf(String tareheDb, String tarehe, java.sql.Connection conn) {
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    int headerwidths[] = {30,10,10,10,40};
                    ...
                    phrase = new Phrase("Linen Washing Report for  "+tarehe , pFontHeader3);
                    ...
                    phrase = new Phrase("Linen Type",pFontHeader1);
                    table.addCell(phrase);
                    
                    phrase = new Phrase("Load",pFontHeader1);
                    table.addCell(phrase);
                    
                    phrase = new Phrase("TimeIn",pFontHeader1);
                    table.addCell(phrase);
                    
                    phrase = new Phrase("TimeOut",pFontHeader1);
                    table.addCell(phrase);
                    ...
                    try{
                        ...
                        java.sql.ResultSet rset = st2.executeQuery("select asset_name, tag_no from public.asset_registration WHERE asset_type ~* 'Plant, mach. and Equip.' AND issued = 'TRUE' AND  location ~*'Laundry' AND tag_no in (select tagno from laundryequipment where type like 'Washer') AND tag_no in (select machineid from laundryprocessdata WHERE datedone like '"+tareheDb+"' and process like 'washing')");
                        ...
                        while (rset.next()) {
                            ...
                            table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_CENTER);
                            phrase = new Phrase(rset.getString("asset_name"), pFontHeader1);
                            
                            table.addCell(phrase);
                            table.getDefaultCell().setColspan(1);
                            
                                String sql="select * from laundryprocessdata WHERE datedone like '"+tareheDb+"' and machineid like '"+rset.getString("tag_no")+"' and process like 'washing' order by dataid asc";
                                Statement stmt = conn.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE,
                    ResultSet.CONCUR_UPDATABLE);
                                ResultSet rs = stmt.executeQuery( sql );
                                while (rs.next()){
                                    String linenTypeID=rs.getString("typeid");
                                    String sqllinen="select typename from laundrylinentype WHERE ltid = "+linenTypeID+"";
                    ...
                    ResultSet.CONCUR_UPDATABLE);
                                    ...
                                    String linenType="";
                                    if(rsLinen.next()){
                                        linenType=rsLinen.getString("typename");
                                    }

                                    
                                    table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                                    phrase = new Phrase(linenType, pFontHeader2);
                                    table.addCell(phrase);
                                    
                                    
                                    table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_CENTER);
                                    phrase = new Phrase(rs.getString("load")+" Kg", pFontHeader2);
                                    table.addCell(phrase);
                                    
                                    table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_CENTER);
                                    phrase = new Phrase(rs.getString("timein"), pFontHeader2);
                                    table.addCell(phrase);
                                    
                                    table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_CENTER);
                                    phrase = new Phrase(rs.getString("timeout"), pFontHeader2);
                                    table.addCell(phrase);
                                    
                                    table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                                    phrase = new Phrase(rs.getString("remarks"), pFontHeader2);
                                    table.addCell(phrase);
