 ...
 * @author charlie
 */
public class RecordDryingData extends javax.swing.JInternalFrame {
     ...
     */
    public RecordDryingData(Connection passedConn) {
        setVisible(true);
        initComponents();
        conn = passedConn;
        ...
        try {
            ...
            String sql = "select DISTINCT upper(asset_name), tag_no from public.asset_registration WHERE tag_no in (select tagno from laundryequipment where type like 'Drier')";
    ...
    public void populateTable() {
        ...
        try {
            ...
            String sql = "select * from laundryprocessdata WHERE datedone like '" + selectedDate + "' and machineid like '" + selectedmachine + "' and process like 'drying' order by timein asc";
            Statement stmt = conn.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE,
                    ResultSet.CONCUR_UPDATABLE);
            ResultSet rs = stmt.executeQuery(sql);
            rs.last();
    ...
    private void initComponents() {
        ...
        setMaximizable(true);
        setResizable(true);
        setTitle("Recording Drying Data");
        ...
        cbxLinenType.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));
        ...
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
        jPanel3.add(cbxMin, gridBagConstraints);
        ...
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
        jPanel3.add(cbxAMorPM, gridBagConstraints);
        ...
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
        jPanel6.add(cbxMinout, gridBagConstraints);
        ...
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
        jPanel6.add(cbxAMorPMout, gridBagConstraints);
    ...
    private void btnCommitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCommitActionPerformed
        try {
            ...
            stmt3.execute("insert into laundryprocessdata (process, typeid, timein, timeout, remarks, datedone, machineid, load) "
                    + "values('drying','" + typeID + "', '" + timein + "','" + timeout + "','" + remarks + "','" + tarehe + "','" + machineID + "','" + load + "'  )");
