...
public class ConsumableUseReportPdf implements java.lang.Runnable {
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    phrase = new Phrase("Consumable Use Report for  "+tarehe , pFontHeader3);
                    ...
                    phrase = new Phrase("Units c/f",pFontHeader1);
                    table.addCell(phrase);
                    
                    phrase = new Phrase("Units Issued",pFontHeader1);
                    table.addCell(phrase);
                    
                    phrase = new Phrase("Total Available",pFontHeader1);
                    table.addCell(phrase);
                    
                    phrase = new Phrase("Issued To",pFontHeader1);
                    table.addCell(phrase);
                    ...
                    try{
                        ...
                        table.getDefaultCell().setColspan(5);
                                ...
                                table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_CENTER);
                                phrase = new Phrase("Shift "+i, pFontHeader1);

                                table.addCell(phrase);
                        java.sql.ResultSet rset = st2.executeQuery("select st_stock_item.item_code, st_stock_item.description, detergentuse.unitsissued, detergentuse.unitscf, detergentuse.issuedto\n" +
                                "from st_stock_item\n" +
                                "left join detergentuse\n" +
                                "on st_stock_item.item_code=detergentuse.itemcode AND detergentuse.datefor like '"+tareheDb+"' AND detergentuse.shift ='"+i+"'\n" +
                            ...
                            while (rset.next()) {
                                ...
                                table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                                phrase = new Phrase(rset.getString("description"), pFontHeader2);
                                table.addCell(phrase);


                                table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_CENTER);
                                phrase = new Phrase(rset.getString("unitscf"), pFontHeader2);
                                table.addCell(phrase);

                                table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_CENTER);
                                phrase = new Phrase(rset.getString("unitsissued"), pFontHeader2);
                                table.addCell(phrase);

                                table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_CENTER);
                                int total=rset.getInt("unitscf")+rset.getInt("unitsissued");
                                phrase = new Phrase(Integer.toString(total), pFontHeader2);
                                table.addCell(phrase);

                                table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                                phrase = new Phrase(rset.getString("issuedto"), pFontHeader2);
                                table.addCell(phrase);
