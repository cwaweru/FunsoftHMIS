...
public class FinishingReportPdf implements java.lang.Runnable {
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    phrase = new Phrase("Finishing Report for  "+tarehe , pFontHeader3);
                    ...
                    phrase = new Phrase("Machine",pFontHeader1);
                    table.addCell(phrase);
                    ...
                    try{
                        ...
                        java.sql.ResultSet rset = st2.executeQuery("select * from laundryprocessdata WHERE datedone like '"+tareheDb+"' and process like 'finishing' order by dataid asc");
                        ...
                        while (rset.next()) {
                            ...
                            table.getDefaultCell().setColspan(1);
                                ...
                                String machineID=rset.getString("machineid");
                                String sqlmachine="select asset_name from public.asset_registration WHERE tag_no like '"+machineID+"'";
                ...
                ResultSet.CONCUR_UPDATABLE);
                                ...
                                String machine="";
                                if(rsmachine.next()){
                                    machine=rsmachine.getString("asset_name");
                                }
                                table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                                phrase = new Phrase(machine, pFontHeader2);
                                table.addCell(phrase);
                                
                                table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                                phrase = new Phrase(rset.getString("load"), pFontHeader2);
                                table.addCell(phrase);
                                
                                table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                                phrase = new Phrase(rset.getString("Remarks"), pFontHeader2);
                                table.addCell(phrase);
