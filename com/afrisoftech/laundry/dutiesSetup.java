 ...
 * @author charlie
 */
public class dutiesSetup extends javax.swing.JInternalFrame {
     ...
     */
    public dutiesSetup(Connection passedConn) {
        setVisible(true);
        initComponents();
        conn=passedConn;
        populateTable();
    ...
    private void initComponents() {
        ...
        txtDutyDesc = new javax.swing.JTextArea();
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder("New Duty"));
        ...
        txtDutyDesc.setColumns(20);
        txtDutyDesc.setRows(5);
        jScrollPane2.setViewportView(txtDutyDesc);
        ...
        jPanel4.setBorder(javax.swing.BorderFactory.createTitledBorder("Current Duties"));
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        if(currFunction.equals("new")){
            try {
            String dutyCode=txtCode.getText();
            String desc=txtDutyDesc.getText();
            String sql="insert into hr.duty (dutycode, description, deptid) values('"+dutyCode+"','"+desc+"','58')";
            Statement stmt = conn.createStatement();
            stmt.execute( sql );
            populateTable();
            JOptionPane.showMessageDialog(null,"Duty Added!","Success",JOptionPane.INFORMATION_MESSAGE);
            txtCode.setText("");
            txtDutyDesc.setText("");
        } 
            ...
            String sql="update hr.duty set dutycode='"+dutyCode+"', description='"+desc+"' where did = "+dutyidedit+"";
            System.out.println(currFuncInt+", "+currFunction+", "+dutyidedit);
            Statement stmt = conn.createStatement();
            stmt.execute( sql );
            populateTable();
            JOptionPane.showMessageDialog(null,"Duty Edited!","Success",JOptionPane.INFORMATION_MESSAGE);
            txtCode.setText("");
            txtDutyDesc.setText("");
            currFunction="new";
            btnEdit.setEnabled(false);
    ...
    private void btnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditActionPerformed
        ...
        txtCode.setText(editCode);
        txtDutyDesc.setText(dutyid[currFuncInt][1]);
    ...
    private void btnRemoveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRemoveActionPerformed
        if(!currFunction.equals("new")){
            try {
                ...
                int currFuncInt=Integer.parseInt(currFunction);
                String dutyidedit=dutyid[currFuncInt][0];
                String sql="delete from hr.duty where did = "+dutyidedit+"";
                System.out.println(currFuncInt+", "+currFunction+", "+dutyidedit);
                Statement stmt = conn.createStatement();
                stmt.execute( sql );
                populateTable();
                JOptionPane.showMessageDialog(null,"Duty Deleted!","Success",JOptionPane.INFORMATION_MESSAGE);
                txtCode.setText("");
                txtDutyDesc.setText("");
                currFunction="new";
                btnEdit.setEnabled(false);
    ...
    public void populateTable(){
        try {
            ...
            String sql2="select dutycode, did, description from hr.duty order by dutycode asc";
...
ResultSet.CONCUR_UPDATABLE);
            ...
            if(rs2.getRow()>0){
                ...
                int counter=0;
                while(rs2.next()){
                    batch[counter][0]=(rs2.getString("dutycode"));
                    dutyid[counter][0]=rs2.getString("did");
                    dutyid[counter][1]=rs2.getString("description");
                    counter++;
                }
...
)
{
    ...
    private javax.swing.JTextArea txtDutyDesc;
