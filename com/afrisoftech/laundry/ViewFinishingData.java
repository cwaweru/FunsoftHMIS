 ...
 * @author charlie
 */
public class ViewFinishingData extends javax.swing.JInternalFrame {
     ...
     */
    public ViewFinishingData(Connection passedConn) {
        setVisible(true);
        initComponents();
        conn=passedConn;
    ...
    public void populateTable(){
        ...
        try {
            ...
            String sql="select * from laundryprocessdata WHERE datedone like '"+selectedDate+"' and process like 'finishing' order by dataid asc";
...
ResultSet.CONCUR_UPDATABLE);
            ...
            while (rs.next()){
                ...
                String sqlmachine="select upper(asset_name) from public.asset_registration WHERE tag_no like '"+machineID+"'";
...
ResultSet.CONCUR_UPDATABLE);
                ...
                String machine="";
                if(rsmachine.next()){
                    machine=rsmachine.getObject(1).toString();
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        FinishingReportPdf newPdf= new FinishingReportPdf();
