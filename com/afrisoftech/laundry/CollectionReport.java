 ...
 * @author charlie
 */
public final class CollectionReport extends javax.swing.JInternalFrame {
     ...
     * @param passedConn
     */
    public CollectionReport(Connection passedConn) {
        setVisible(true);
        initComponents();
        conn= passedConn;
    ...
    private void btnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditActionPerformed
        com.afrisoftech.laundry.CollectionReportPdf list = new com.afrisoftech.laundry.CollectionReportPdf();
        list.StaffListPdf(conn, lcids[jTable1.getSelectedRow()]);
    ...
    public void populateTable(){
        ...
        lcids=new String[0][3];
        RefreshClientsTable();
        
        try {
            
            String sql2="select lcid,timestamp, time from linencollection where date like '"+sdf2.format(datePicker.getDate())+"' order by lcid desc";
