...
public class DryingReportPdf implements java.lang.Runnable {
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    phrase = new Phrase("Linen Drying Report for  "+tarehe , pFontHeader3);
                    ...
                    try{
                        ...
                        java.sql.ResultSet rset = st2.executeQuery("select asset_name, tag_no from public.asset_registration WHERE asset_type ~* 'Plant, mach. and Equip.' AND issued = 'TRUE' AND  location ~*'Laundry' AND tag_no in (select tagno from laundryequipment where type like 'Drier') AND tag_no in (select machineid from laundryprocessdata WHERE datedone like '"+tareheDb+"' and process like 'drying')");
                        ...
                        while (rset.next()) {
                            ...
                            table.getDefaultCell().setColspan(1);
                                ...
                                String sql="select * from laundryprocessdata WHERE datedone like '"+tareheDb+"' and machineid like '"+rset.getString("tag_no")+"' and process like 'drying' order by dataid asc";
