 ...
 * @author charlie
 */
public class DistributionData extends javax.swing.JInternalFrame {
    ...
    public DistributionData(Connection passedConn) {
...
ResultSet.CONCUR_UPDATABLE);
            ...
            sql2="select CONCAT(first_name,' ',middle_name) AS \"Name\", employee_no from master_file WHERE department ILIKE '%Laundry Unit%' order by first_name asc";
...
ResultSet.CONCUR_UPDATABLE);
    ...
    private void initComponents() {
        ...
        setMaximizable(true);
        setResizable(true);
        setTitle("Linen Distribution Data");
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        if(datePicker.getDate()!=null){
            ...
            try {
                ...
                stmt3.execute( "insert into linendistribution (date, time, timestamp, lcid) values('"+tarehe+"','"+currTime+"', '"+currTimeStamp+"','"+lcid+"'  )" );
                    ...
                    for(int allCols=1; allCols<totalNumCols; allCols++){
                        ...
                        if(countValue!=null&&!countValue.equals("")){
                            try {
                                ...
                                stmt2.execute( "insert into linendistributionitem (count, wardid, typeid, lcolid, linenattendantid) values('"+countValue+"','"+wards.get(r2)+"', '"+linenTypeID[allCols]+"','"+lcid+"', '"+attendantID+"'  )" );
                ...
                int another=JOptionPane.showOptionDialog(null,"Distribution Round Saved!","Success", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE, null, options, options[0]);
