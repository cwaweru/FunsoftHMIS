 ...
 * @author  root
 */
public class SecureLogin2Hospital22 extends javax.swing.JDialog {
    ...
    com.afrisoftech.hospital.HospitalMain hospitalMainInst;
    ...
    public SecureLogin2Hospital22(java.awt.Frame parent, boolean modal, java.sql.Connection connectDB, org.netbeans.lib.sql.pool.PooledConnectionSource pconnectDB, java.lang.String logonName) {
...
//    }
    ...
    public com.afrisoftech.hospital.HospitalMain logOn2System() {
        
        com.afrisoftech.hospital.HospitalMain secureHospitalMain = null;
        ...
        java.sql.Statement resStatement = null;
            ...
            try {
                ...
                while (reSet.next()) {
                    ...
                    hospitalMainInst = new com.afrisoftech.hospital.HospitalMain(connDB, pconnDB,null,null,null,null,null);//, this.path2Acrobat, this.pwdInfo.getPassword());
                    ...
                    hospitalMainInst.menuItemsDisabler(menuList2enable);
                    
                    secureHospitalMain = hospitalMainInst;

                    System.out.println(reSet.getString(1));
                    com.afrisoftech.sys.SplashScreenDialog.statusLabel.setText(reSet.getString(1));
    ...
    public java.lang.String[] getMenuItems2Enable(java.lang.String logiName) {
        ...
        try {
            ...
            java.sql.PreparedStatement stmtDB = connDB.prepareStatement("SELECT menu_list FROM secure_menu_access WHERE login_name ='"+logiName+"' AND sys_name = 'hospital_main'");
            
            stmtDB.setObject(1,logiName);
        ...
        for (int k = 0; k < menus2enable.length; k++) {
            ...
            com.afrisoftech.sys.SplashScreenDialog.statusLabel.setText(menus2enable[k]);
    ...
    public java.lang.Object[] getSystemMenuItems2Enable(java.lang.String[] menus2enable) {
        ...
        for (int i = 0; i < menus2enable.length; i++) {
            ...
            try {
                ...
                java.sql.PreparedStatement stmtDB = connDB.prepareStatement("SELECT menu_item FROM menu_item_list WHERE item_desc = ? AND app_name = 'hospital_main'");
                
                stmtDB.setObject(1, menus2enable[i]);
                
                java.sql.ResultSet rSet = stmtDB.executeQuery();
                //java.sql.ResultSet rSet = stmtDB.executeQuery("SELECT menu_item FROM menu_item_list WHERE item_desc='"+menus2enable[i]+"' AND app_name = 'hospital_main'");
