 ...
 * @author  root
 */
public class Login2HospInventory extends javax.swing.JDialog {
    ...
    public Login2HospInventory(java.awt.Frame parent, boolean modal) {
        ...
        if (!userName.equals("") && !passWord.equals("")) {
            ...
            try {
                ...
                while (reSet.next()) {
                    ...
                    hospitalStockInst = new com.afrisoftech.hospinventory.StockMain(connDB, pconnDB);//, this.path2Acrobat, this.pwdInfo.getPassword());
