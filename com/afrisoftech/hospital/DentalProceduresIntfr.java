...
public class DentalProceduresIntfr extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        */
        ...
        jLabel13.setText("Dental File No");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
    ...
    private void jSearchTable2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jSearchTable2MouseClicked
        ...
        try {
            if(this.jCheckBox11.isSelected()){
             ...
             java.sql.Statement stmt1a = connectDB.createStatement();
                        java.sql.ResultSet rset1a = stmt1a.executeQuery("select dental_no from hp_dental_register where patient_no  ='"+jTextField9.getText()+"'");
                        while (rset1a.next()){
                            jTextField20.setText(rset1a.getObject(1).toString());
                        }
        } catch (java.sql.SQLException sqe) {
            sqe.printStackTrace();
            //  System.out.println("Insert not successful");
            ...
            if(jTextField1.getText().equalsIgnoreCase("")){
                ...
                try {
                    ...
                    while (rst.next()){
                        ...
                        billNo = rst.getObject(1).toString();
                    }
                    ...
                    for (int i = 0; i < jTable1.getRowCount(); i++){
                        if (jTable1.getValueAt(i,0) != null){
                            java.sql.PreparedStatement pstmt2 = connectDB.prepareStatement("insert into hp_dental_results values(?,?,?,?,?,?, ?, ?, ?, ?, ?, ?, ?, ?,trim(?))");
                            
                            pstmt2.setString(1,jTextField9.getText());
                            
                            pstmt2.setString(2,jTextField1.getText());
                            pstmt2.setString(3,billNo);
                            pstmt2.setInt(4,0);
                            if(jCheckBox1.isSelected()){
                                pstmt2.setString(5,"Male");
                            }else{
                                pstmt2.setString(5,"Female");
                            }
                            pstmt2.setObject(6,jTable1.getValueAt(i,2).toString());
                            pstmt2.setObject(7,jTable1.getValueAt(i,0).toString());
                            pstmt2.setObject(8,jTable1.getValueAt(i,1).toString());
                            pstmt2.setDate(10,com.afrisoftech.lib.SQLDateFormat.getSQLDate(datePicker1.getDate()));//java.sql.Date.valueOf(String.format("%1$tY-%1$tm-%1$te",datePicker1.getDate())));
                            pstmt2.setString(9,"-");
                            pstmt2.setString(14,user);
                            pstmt2.setString(12,jTextField9.getText().toString()+" "+jTextField21.getText().toString());
                            pstmt2.setString(13,jTextPane1.getText());
                            pstmt2.setTimestamp(11,new java.sql.Timestamp(java.util.Calendar.getInstance().getTimeInMillis()));
                            pstmt2.setString(15,jTextField8.getText().toString());
                            pstmt2.executeUpdate();
                    ...
                    java.sql.ResultSet rst11x = ps11x.executeQuery("select count(patient_no) from hp_dental_register WHERE patient_no = '"+jTextField9.getText()+"'");
                    while (rst11x.next()){
                        
                        patNo = rst11x.getInt(1);
                        // user = rst11.getObject(2).toString();
                    }
                    if(patNo > 0){
                        ...
                        java.sql.Statement ps11 = connectDB.createStatement();
                        java.sql.ResultSet rst11 = ps11.executeQuery("select nextval('dental_no_seq')");
                        while (rst11.next()){
                            
                            transNo = rst11.getObject(1).toString();
                            // user = rst11.getObject(2).toString();
                        }
                        
                        jTextField20.setText(transNo);
                        java.sql.PreparedStatement pstmt21 = connectDB.prepareStatement("insert into hp_dental_register values(?,?,?,?,?)");
                        pstmt21.setString(1,jTextField9.getText());
                        pstmt21.setString(2,transNo);
                        pstmt21.setString(3,jTextField1.getText());
                        pstmt21.setDate(4,com.afrisoftech.lib.SQLDateFormat.getSQLDate(datePicker1.getDate()));
                        if(jCheckBox1.isSelected()){
                            pstmt21.setString(5,"Male");
                        }else{
                            pstmt21.setString(5,"Female");
                        }
