 ...
 * @author  root
 */
public class CloseSchemeMemberAccIntfr extends javax.swing.JInternalFrame {
    ...
    public CloseSchemeMemberAccIntfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {
        ...
        */
        ...
        jTextField2.setText("HR MANAGER");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
        ...
        activate.setActionCommand("jCheckBox1");
        activate.setBorder(javax.swing.BorderFactory.createEmptyBorder(0, 0, 0, 0));
        activate.setMargin(new java.awt.Insets(0, 0, 0, 0));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 5;
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
        jPanel1.add(activate, gridBagConstraints);
        ...
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
        jPanel1.add(jTextField362, gridBagConstraints);

        jLabel5822.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel5822.setText("Acc. No");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 2;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        ...
        gridBagConstraints.weighty = 1.0;
        gridBagConstraints.insets = new java.awt.Insets(0, 30, 0, 0);
        jPanel1.add(jLabel5822, gridBagConstraints);
        ...
        jButton1.setText("Check Register");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
      ...
      */  
        com.afrisoftech.reports.SchemeStaffKarenPdf policy = new  com.afrisoftech.reports.SchemeStaffKarenPdf();
        policy.SchemeStaffKarenPdf(connectDB, jTextField361.getText(),jTextField362.getText());
  
  // TODO add your handling code here:
    }//GEN-LAST:event_jButton3ActionPerformed

    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
  com.afrisoftech.hospital.SchemeAlloteesKarenIntfr other = new com.afrisoftech.hospital.SchemeAlloteesKarenIntfr(connectDB, pConnDB);
    ...
    private void jSearchTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jSearchTable1MouseClicked
        ...
        jTextField362.setText(jSearchTable1.getValueAt(jSearchTable1.getSelectedRow(), 1).toString());
    ...
    private void jTextField1111CaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextField1111CaretUpdate
        if(jTextField1111.getCaretPosition() < 1){
            ...
            jSearchTable1.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"select scheme_name as scheme, account_no as accout_no from ac_schemes where scheme_name ILIKE '"+jTextField1111.getText().toString()+"%'"));
