...
public class DiseasesIntfr extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jTable2.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Disease Code", "Description", "Common ?", "Oid"
            }
        ) {
            Class[] types = new Class [] {
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        try{
            ...
            java.sql.PreparedStatement pstmt31 = connectDB.prepareStatement("DELETE from hp_diseases WHERE oid = '"+jTable2.getModel().getValueAt(jTable2.getSelectedRow(),3).toString()+"'");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            ...
            java.sql.ResultSet rsetTable1 = stmtTable1.executeQuery("select code,disease_name,common::boolean,oid AS oid From hp_diseases WHERE diseases_category ilike '"+jComboBox1.getSelectedItem()+"' order by disease_name");
        ...
        try {
            for (int i = 0; i < jTable2.getRowCount(); i++){
                if (jTable2.getModel().getValueAt(i,0) != null){
                    ...
                    if (jButton1.getText().equalsIgnoreCase("Save Data")) {
                        ...
                        java.sql.PreparedStatement pstmt31 = connectDB.prepareStatement("UPDATE hp_diseases SET disease_name = '"+jTable2.getModel().getValueAt(i,1).toString()+"',common = '"+jTable2.getModel().getValueAt(i,2).toString()+"', code = '"+jTable2.getModel().getValueAt(i,0).toString()+"'  WHERE oid = '"+jTable2.getModel().getValueAt(i,3).toString()+"'");
                        pstmt31.executeUpdate();

                        java.sql.PreparedStatement pstmt31x = connectDB.prepareStatement("UPDATE hp_patient_diagnosis SET main_service = '"+jTable2.getModel().getValueAt(i,0).toString()+"' WHERE disease = '"+jTable2.getModel().getValueAt(i,1).toString()+"'");
                        pstmt31x.executeUpdate();

                        //java.sql.PreparedStatement pstmt31xz = connectDB.prepareStatement("UPDATE hp_patient_diagnosis SET disease = '"+jTable2.getModel().getValueAt(i,0).toString()+"' WHERE main_service = '"+jTable2.getModel().getValueAt(i,0).toString()+"'");
                        //pstmt31xz.executeUpdate();
                    }
                }
            }
