...
public class NhifDebtsIntfr extends javax.swing.JInternalFrame {
    ...
    private void jCheckBox1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jCheckBox1ActionPerformed
        this.jTextField10.setEditable(true);        // Add your handling code here:
    ...
    private void jButton11ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton11ActionPerformed
        ...
        try {
            ...
            java.sql.ResultSet rst1q = ps1q.executeQuery("select count(service) from hp_patient_card where service ilike 'n.h.i.%'  AND visit_id = '"+jTextField1.getText()+"'");
            while (rst1q.next()){
            ...
            if (claims > 0){
                ...
                if (bill >= 0){
                    ...
                    if (exitOption == javax.swing.JOptionPane.YES_OPTION) {
                        ...
                        java.sql.ResultSet rss1h = pss1h.executeQuery("select lpad('"+invoiceNos+"',5,'0')");
                        while (rss1h.next()){
