        ...
        */
        ...
        //try {
            ...
            jTable1.setModel(new javax.swing.table.DefaultTableModel(
                ...
                new String [] {
                    "Staff No.", "Staff Name", "Expiry Date", "OP Limit", "IP Limit", "Desgination"
                }
            ) {
            ...
            */
            ...
            jButton1.setText("Register beneficiaries");
...
//        lpay.setVisible(true);        // Add your handling code here:
    ...
    private void jButton11ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton11ActionPerformed
        ...
        try {
            ...
            java.sql.ResultSet rs22 = ps22.executeQuery("select 'ST'||lpad(nextval('staff_reg_no')::text,6,0::text)");
            while (rs22.next()) {
        ...
        try {
            ...
            for (int i = 0; i < jTable1.getRowCount(); i++) {
                if (jTable1.getModel().getValueAt(i, 0) != null) {
                    java.sql.PreparedStatement pstmt = connectDB.prepareStatement("INSERT INTO hp_schemestaff("
                            + " provider, staff_no, staff_name, sheme_name, expiry_date, relation, "
                            + " limit_amount, date_set, suspended, birth_date, account_no, instruction_date,"
                            + " receipt_date, sign_name, inst_ref, staff_reg_no, iplimit, applylimit, "
                            + " date_closed, closed_by, authorised_by, department)"
                            + " VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?,"
                            + " ?, ?, ?, ?)");
                    //+ "insert into hp_schemestaff values(?,?,initcap(?),?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
