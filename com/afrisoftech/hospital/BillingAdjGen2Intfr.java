...
public class BillingAdjGen2Intfr extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        adjustMentTable = new com.afrisoftech.dbadmin.JTable();
        ...
        revenueDeptCmb = new javax.swing.JComboBox();
        ...
        doctorsTxt = new javax.swing.JTextField();
        searchButton2 = new javax.swing.JButton();
        jLabel8 = new javax.swing.JLabel();
        doctorsNameTxt = new javax.swing.JTextField();
        normalRateRdi = new javax.swing.JRadioButton();
        specialRateRdi = new javax.swing.JRadioButton();
        viewInsertNoTxt = new javax.swing.JTextField();
        viewInsertChk = new javax.swing.JCheckBox();
        jLabel12 = new javax.swing.JLabel();
        enteredToTxt = new javax.swing.JTextField();
        jLabel13 = new javax.swing.JLabel();
        deptTxt = new javax.swing.JTextField();
        jLabel14 = new javax.swing.JLabel();
        insertDateTxt = new javax.swing.JTextField();
        ...
        outPatientChk = new javax.swing.JCheckBox();
        inPatientChk = new javax.swing.JCheckBox();
        ...
        jSearchPanel2.add(searchNameTxt, gridBagConstraints);
        ...
        */
        ...
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
        patientsDialog.getContentPane().add(jSearchPanel2, gridBagConstraints);
        ...
        */
        ...
        adjustMentTable.setGridColor(new java.awt.Color(153, 153, 255));
        javax.swing.table.TableColumn column = null;
        for (int i = 0; i < 5; i++) {
            column = adjustMentTable.getColumnModel().getColumn(i);
            if (i == 0) {
        ...
        adjustMentTable.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                adjustMentTableMouseClicked(evt);
            }
        });
        adjustMentTable.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                adjustMentTableKeyReleased(evt);
            }
        });
        jScrollPane2.setViewportView(adjustMentTable);
        ...
        revenueDeptCmb.setBackground(new java.awt.Color(204, 204, 255));
        revenueDeptCmb.setModel(com.afrisoftech.lib.ComboBoxModel.ComboBoxModel(connectDB, "SELECT '-' UNION ALL SELECT distinct UPPER(activity) FROM pb_activity WHERE category_class ilike 'plid' EXCEPT select main_service from pb_operating_parameters WHERE category = 'CA' ORDER BY 1"));
        revenueDeptCmb.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                revenueDeptCmbActionPerformed(evt);
            }
        });
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        ...
        jPanel2.add(revenueDeptCmb, gridBagConstraints);
        ...
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
        jPanel42.add(doctorsTxt, gridBagConstraints);
        ...
        doctorsNameTxt.setEditable(false);
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 4;
        gridBagConstraints.gridy = 6;
        gridBagConstraints.gridwidth = 3;
        ...
        gridBagConstraints.weighty = 1.0;
        gridBagConstraints.insets = new java.awt.Insets(0, 0, 0, 10);
        jPanel2.add(doctorsNameTxt, gridBagConstraints);

        buttonGroup4.add(normalRateRdi);
        normalRateRdi.setSelected(true);
        normalRateRdi.setText("Normal Rate");
        normalRateRdi.setBorder(javax.swing.BorderFactory.createEmptyBorder(0, 0, 0, 0));
        normalRateRdi.setMargin(new java.awt.Insets(0, 0, 0, 0));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 7;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.insets = new java.awt.Insets(0, 20, 0, 0);
        jPanel2.add(normalRateRdi, gridBagConstraints);

        buttonGroup4.add(specialRateRdi);
        specialRateRdi.setText("Special Rate");
        specialRateRdi.setBorder(javax.swing.BorderFactory.createEmptyBorder(0, 0, 0, 0));
        specialRateRdi.setMargin(new java.awt.Insets(0, 0, 0, 0));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 7;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
        jPanel2.add(specialRateRdi, gridBagConstraints);
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 4;
        gridBagConstraints.gridy = 1;
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
        gridBagConstraints.weightx = 3.0;
        gridBagConstraints.weighty = 1.0;
        jPanel2.add(viewInsertNoTxt, gridBagConstraints);

        viewInsertChk.setBackground(new java.awt.Color(255, 204, 204));
        viewInsertChk.setText("View Insert No.");
        viewInsertChk.setBorder(javax.swing.BorderFactory.createEmptyBorder(0, 0, 0, 0));
        viewInsertChk.setMargin(new java.awt.Insets(0, 0, 0, 0));
        viewInsertChk.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                viewInsertChkActionPerformed(evt);
            }
        });
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 3;
        ...
        gridBagConstraints.weighty = 1.0;
        gridBagConstraints.insets = new java.awt.Insets(0, 20, 0, 10);
        jPanel2.add(viewInsertChk, gridBagConstraints);
        ...
        enteredToTxt.setEditable(false);
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 4;
        gridBagConstraints.gridy = 2;
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
        gridBagConstraints.weightx = 10.0;
        gridBagConstraints.weighty = 1.0;
        jPanel2.add(enteredToTxt, gridBagConstraints);
        ...
        gridBagConstraints.weightx = 10.0;
        gridBagConstraints.weighty = 1.0;
        jPanel2.add(deptTxt, gridBagConstraints);
        ...
        insertDateTxt.setEditable(false);
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 6;
        gridBagConstraints.gridy = 1;
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
        gridBagConstraints.weightx = 10.0;
        gridBagConstraints.weighty = 1.0;
        jPanel2.add(insertDateTxt, gridBagConstraints);
        ...
        gridBagConstraints.weighty = 1.0;
        gridBagConstraints.insets = new java.awt.Insets(0, 0, 0, 10);
        jPanel12.add(accountCodeTxt, gridBagConstraints);

        codeTxt.setEditable(false);
        codeTxt.setHorizontalAlignment(javax.swing.JTextField.RIGHT);
        codeTxt.setMinimumSize(new java.awt.Dimension(2, 7));
        codeTxt.setPreferredSize(new java.awt.Dimension(2, 19));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 2;
        gridBagConstraints.gridy = 7;
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
        ...
        gridBagConstraints.weighty = 1.0;
        gridBagConstraints.insets = new java.awt.Insets(0, 0, 0, 10);
        jPanel12.add(codeTxt, gridBagConstraints);
        ...
        jLabel15.setText("Waiver/Exemption No.");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 3;
        gridBagConstraints.gridy = 7;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        ...
        buttonGroup1.add(outPatientChk);
        outPatientChk.setForeground(new java.awt.Color(51, 51, 255));
        outPatientChk.setMnemonic('o');
        outPatientChk.setText("Out Patients");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 1;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        ...
        gridBagConstraints.weighty = 1.0;
        gridBagConstraints.insets = new java.awt.Insets(0, 20, 0, 0);
        jPanel31.add(outPatientChk, gridBagConstraints);

        buttonGroup1.add(inPatientChk);
        inPatientChk.setForeground(new java.awt.Color(255, 0, 51));
        inPatientChk.setMnemonic('i');
        inPatientChk.setSelected(true);
        inPatientChk.setText("InPatients");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 1;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        ...
        gridBagConstraints.weighty = 1.0;
        gridBagConstraints.insets = new java.awt.Insets(0, 20, 0, 0);
        jPanel31.add(inPatientChk, gridBagConstraints);

        buttonGroup3.add(patientNoChk);
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        gridBagConstraints.insets = new java.awt.Insets(0, 20, 0, 0);
        jPanel31.add(patientNoChk, gridBagConstraints);

        buttonGroup3.add(patientNameChk);
        ...
        gridBagConstraints.weighty = 1.0;
        gridBagConstraints.insets = new java.awt.Insets(0, 20, 0, 0);
        jPanel31.add(patientNameChk, gridBagConstraints);
        ...
        setBounds(0, 0, 815, 521);
    }// </editor-fold>//GEN-END:initComponents
    
    private void viewInsertChkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_viewInsertChkActionPerformed
        
        
        for (int m = 0; m < adjustMentTable.getRowCount(); m++ ) {
            for (int r = 0; r < adjustMentTable.getColumnCount(); r++ ) {
                adjustMentTable.getModel().setValueAt(null,m,r);
            }
        }
        ...
        try {
            ...
            java.sql.ResultSet rset = stmt.executeQuery("SELECT count(service) FROM hp_patient_card WHERE reference = '"+viewInsertNoTxt.getText()+"'");
            ...
            if (j > 0){
                ...
                java.sql.ResultSet rsetTable1 = st1.executeQuery("select DISTINCT hp_patient_card.patient_no,patient_bill.description, hp_patient_card.dosage as quantity,round(hp_patient_card.debit/hp_patient_card.dosage::numeric,2)as price, hp_patient_card.debit,pb_activity.code as gl_code,hp_patient_card.main_service,hp_patient_card.date::date from hp_patient_card, pb_activity, patient_bill WHERE hp_patient_card.main_service ilike pb_activity.activity and hp_patient_card.reference = '"+viewInsertNoTxt.getText()+"' and patient_bill.description = hp_patient_card.service AND hp_patient_card.transaction_type ilike 'billing' and hp_patient_card.credit = '0' and hp_patient_card.DOSAGE > 0 ");
                while (rsetTable1.next()) {
                    enteredToTxt.setText(rsetTable1.getObject(1).toString());
                    insertDateTxt.setText(rsetTable1.getObject(8).toString());
                    deptTxt.setText(rsetTable1.getObject(7).toString());
                    System.out.println("Working at table row "+i);
                    adjustMentTable.setValueAt(rsetTable1.getObject(2), i, 0);
                    adjustMentTable.setValueAt(rsetTable1.getObject(3), i, 1);
                    adjustMentTable.setValueAt(rsetTable1.getObject(4), i, 2);
                    adjustMentTable.setValueAt(rsetTable1.getObject(5), i, 3);
                    // jTable1.setValueAt(rsetTable1.getObject(5), i, 4);
                    adjustMentTable.setValueAt(rsetTable1.getObject(6), i, 4);
                ...
                java.sql.ResultSet rsetTotals = st2.executeQuery("SELECT SUM(debit-credit) from hp_patient_card WHERE reference = '"+viewInsertNoTxt.getText()+"'");
...
// TODO add your handling code here:
    }//GEN-LAST:event_viewInsertChkActionPerformed
    ...
    private void searchButtonClickedw() {
        ...
        java.awt.Point point = this.doctorsTxt.getLocationOnScreen();
    ...
    private void jSearchTable31MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jSearchTable31MouseClicked
        doctorsTxt.setText(jSearchTable31.getValueAt(jSearchTable31.getSelectedRow(), 0).toString());
        doctorsNameTxt.setText(jSearchTable31.getValueAt(jSearchTable31.getSelectedRow(), 1).toString());
        ...
        try {
            ...
            for (int i = 0; i < jTable111.getRowCount(); i++){
                if (jTable111.getValueAt(i,0) != null){
                    ...
                    pstmt21.setDouble(8,0.00);
                    pstmt21.setDouble(7,java.lang.Double.valueOf(jTable111.getValueAt(i,3).toString()));
                    pstmt21.setString(9,"");
                    ...
                    pstmt21.setDouble(18,0);
                    pstmt21.setString(16,jTextField121.getText());
                    
                    pstmt21.setDouble(17,java.lang.Double.valueOf(jTable111.getValueAt(i,3).toString()));
                    ...
                    pstmt.setDouble(13,java.lang.Double.valueOf(jTable111.getValueAt(i,3).toString()));
                    ...
                    pstmt.setDouble(17,java.lang.Double.valueOf(jTable111.getValueAt(i,1).toString()));
                    ...
                    if(patientNoTxt.getText().contains("INT") || patientNoTxt.getText().contains("BID") ){
                                        pstmt.setString(28,patientNoTxt.getText());
                                        }
                                        else pstmt.setString(28,visitid);
                    pstmt.executeUpdate();
                    /*
                ...
                try {
                    ...
                    for (int i = 0; i < jTable11.getRowCount(); i++){
                        if (jTable11.getValueAt(i,0) != null){
                            ...
                            pstmt2.setDouble(6,-1*java.lang.Double.valueOf(jTable11.getValueAt(i,1).toString()));
                            pstmt2.setDouble(7,-1*java.lang.Double.valueOf(jTable11.getValueAt(i,3).toString()));
                            ...
                            pstmt21.setString(6,"Doctors Fee");
                            pstmt21.setDouble(8,00);
                            pstmt21.setDouble(7,java.lang.Double.valueOf(jTable11.getValueAt(i,3).toString()));
                            pstmt21.setString(9,"");
                            ...
                            pstmt29.setDate(18,com.afrisoftech.lib.SQLDateFormat.getSQLDate(datePicker2.getDate()));
...
// Add your handling code here:
    ...
    private void jSearchTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jSearchTableMouseClicked
        adjustMentTable.setValueAt(jSearchTable.getValueAt(jSearchTable.getSelectedRow(),0),adjustMentTable.getSelectedRow(), 0);
        adjustMentTable.setValueAt(jSearchTable.getValueAt(jSearchTable.getSelectedRow(),1),adjustMentTable.getSelectedRow(), 2);
        adjustMentTable.setValueAt(jSearchTable.getValueAt(jSearchTable.getSelectedRow(),2),adjustMentTable.getSelectedRow(), 4);
    ...
    private void adjustMentTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_adjustMentTableMouseClicked
        ...
        if (adjustMentTable.getSelectedColumn() == 0) {
            
            this.cmboxMouseClicked();
        }          // Add your handling code here:
    }//GEN-LAST:event_adjustMentTableMouseClicked
    ...
    private void jSearchTable2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jSearchTable2MouseClicked
        ...
        if(this.outPatientChk.isSelected()){
            try {
                ...
                java.sql.PreparedStatement stmt1 = connectDB.prepareStatement("select category,pay_mode from hp_patient_register where patient_no  = ?");
                stmt1.setString(1, patientNoTxt.getText());
            ...
            try {
                ...
                java.sql.Statement stmt1 = connectDB.createStatement();
                java.sql.ResultSet rset1 = stmt1.executeQuery("select category,pay_mode from hp_inpatient_register where patient_no  ='"+patientNoTxt.getText()+"'");
                while (rset1.next()){
                    patientCategoryTxt.setText(rset1.getObject(1).toString());
                    paymentModeTxt.setText(rset1.getObject(2).toString());
                }
...
//        }else{
            if(this.outPatientChk.isSelected() && this.patientNameChk.isSelected()){
                ...
                if(this.outPatientChk.isSelected() && this.patientNoChk.isSelected()){
                    jSearchTable2.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"SELECT patient_no, name, year_of_birth, residence, unit_number from patient_select where patient_no ILIKE '"+searchNameTxt.getText()+"%' or unit_number ilike '"+searchNameTxt.getText()+"%'  order by patient_no"));
    ...
    private void revenueDeptCmbActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_revenueDeptCmbActionPerformed
        ...
        try{
            ...
            java.sql.Statement ps11 = connectDB.createStatement();
            java.sql.ResultSet rst11 = ps11.executeQuery("select code,sub_code from pb_activity WHERE activity ilike '"+revenueDeptCmb.getSelectedItem()+"'");
            while (rst11.next()){
                
                accountCodeTxt.setText(rst11.getString(1));
                codeTxt.setText(rst11.getString(2));
            }
        } catch (java.sql.SQLException sqe) {
            sqe.printStackTrace();
            System.out.println("Select not successful");
        ...
        // Add your handling code here:
    }//GEN-LAST:event_revenueDeptCmbActionPerformed
    
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        
        int rows2Delete = adjustMentTable.getSelectedRowCount();
        
        int[] selectedRows = adjustMentTable.getSelectedRows();
        ...
        if (rows2Delete < 1) {
            ...
            if (rows2Delete > 1) {
                ...
                for (int i = 0; i < selectedRows.length; i++) {
                    ...
                    javax.swing.table.DefaultTableModel defTableModel = (javax.swing.table.DefaultTableModel)adjustMentTable.getModel();
                ...
                defTableModel.removeRow(adjustMentTable.getSelectedRow());
            }
        }
        tableModelTableChanged();
    ...
    public void tableModelTableChanged() {
        ...
        for (int i = 0; i < adjustMentTable.getRowCount(); i++) {
            
            if (adjustMentTable.getModel().getValueAt(i, 1) != null) {
                
                resFloat = resFloat + Double.parseDouble(adjustMentTable.getValueAt(i, 3).toString());
    ...
    private void adjustMentTableKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_adjustMentTableKeyReleased
        double resFloat = 0.00;
        //  double totalSum = 0.00;
        double floatTotal = java.lang.Double.parseDouble(jTextField3.getText());
        
        if (adjustMentTable.getValueAt(adjustMentTable.getSelectedRow(), 1) != null) {
            double floatCol2 = java.lang.Double.parseDouble(adjustMentTable.getValueAt(adjustMentTable.getSelectedRow(), 1).toString());
            
            double floatCol3 = java.lang.Double.parseDouble(adjustMentTable.getValueAt(adjustMentTable.getSelectedRow(), 2).toString());
            
            double resVal = floatCol2 * floatCol3;
            
            
            adjustMentTable.setValueAt(new java.lang.Float(resVal), adjustMentTable.getSelectedRow(), 3);
            
            for (int i = 0; i < adjustMentTable.getRowCount(); i++) {
                
                if (adjustMentTable.getValueAt(i, 0) != null) {//toString().compareToIgnoreCase(null) {
    ...
    }//GEN-LAST:event_adjustMentTableKeyReleased
...
//        int i = jTable2.getSelectedRow();
   ...
   */
    ...
    private void cmboxActionPerformed(java.awt.event.ActionEvent evt){
        ...
        int i = adjustMentTable.getSelectedRow();
        ...
        if (selectedGuaran != null) {
            ...
            try {
                ...
                while (rs.next()){
                    //jTextField4.setText(rs.getObject(1).toString());
                    adjustMentTable.setValueAt(rs.getObject(1),i,2);
                    adjustMentTable.setValueAt(rs.getObject(2),i,4);
                }
            } catch(java.sql.SQLException sqlex){
                System.out.println(sqlex.getMessage());
            }
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        jTextField3.setText("");
        for (int k = 0; k < adjustMentTable.getRowCount(); k++ ) {
            for (int r = 0; r < adjustMentTable.getColumnCount(); r++ ) {
                adjustMentTable.setValueAt(null,k,r);
            }
        }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(datePicker1.getDate().before(periodFrom) || datePicker1.getDate().after(periodTo)){
            ...
            if(adjustMentTable.isEditing()){
                adjustMentTable.getCellEditor().stopCellEditing();
            }
            if(patientName.getText().equalsIgnoreCase("")){
                javax.swing.JOptionPane.showMessageDialog(this,"You cannot save without the name","Confirmation Message",javax.swing.JOptionPane.INFORMATION_MESSAGE);
                
            }else{
                adjustMentTable.setEditingRow(-1);
                //     tableModelTableChanged();
                java.util.Calendar calendar = java.util.Calendar.getInstance();
                    ...
                    try {
                     ...
                     try {
                        ...
                        if(this.outPatientChk.isSelected()){
                            ...
                            // pstmRemove.executeUpdate();
                            java.sql.Statement stm1 = connectDB.createStatement();
                            java.sql.ResultSet rse1 = stm1.executeQuery("select pay_mode,account_no,description,payer,payer,expiry_date,account_no from hp_patient_register where patient_no ='"+patientNoTxt.getText()+"'");
                            while (rse1.next()){
                            ...
                            for (int i = 0; i < adjustMentTable.getRowCount(); i++){
                                if (adjustMentTable.getValueAt(i,0) != null){
                                    java.sql.Statement stm121 = connectDB.createStatement();
                                    java.sql.ResultSet rse121 = stm121.executeQuery("select activity,current_user from pb_activity where code ='"+adjustMentTable.getValueAt(i,4).toString()+"'");
                                    while (rse121.next()){
                                    ...
                                    if(this.paymentModeTxt.getText().equalsIgnoreCase("Scheme")){
                                        
                                        java.sql.PreparedStatement pstmt22 = connectDB.prepareStatement("insert into hp_patient_billing values(?,?,?,?,?,?,?, ?, ?, ?, ?, ?, ?,?,?)");
                                        pstmt22.setString(1,patientNoTxt.getText());
                                        pstmt22.setString(10,"");
                                        pstmt22.setString(2,patientName.getText());
                                        pstmt22.setString(3,paymentModeTxt.getText());
                                        pstmt22.setString(4,patientCategoryTxt.getText());
                                        pstmt22.setString(5,adjustMentTable.getValueAt(i,0).toString());
                                        pstmt22.setDouble(6,-1*java.lang.Double.valueOf(adjustMentTable.getValueAt(i,1).toString()));
                                        pstmt22.setDouble(7,-1*java.lang.Double.valueOf(adjustMentTable.getValueAt(i,3).toString()));
                                        pstmt22.setObject(8,adjustMentTable.getValueAt(i,4).toString());
                                        ...
                                        pstmt.setObject(2,adjustMentTable.getValueAt(i,0).toString());
                                        ...
                                        pstmt.setDate(10,null);
                                        pstmt.setString(11,"");
                                        pstmt.setDouble(13,java.lang.Double.valueOf(adjustMentTable.getValueAt(i,3).toString()));
                                        pstmt.setDouble(12,0.00);
                                        pstmt.setDate(14,com.afrisoftech.lib.SQLDateFormat.getSQLDate(datePicker1.getDate()));
                                        pstmt.setObject(15,patientAcc);
                                        pstmt.setString(16,glAcc);
                                        pstmt.setDouble(17,-1*java.lang.Double.valueOf(adjustMentTable.getValueAt(i,1).toString()));
                                        pstmt.setObject(18,staffNo);
                                        pstmt.setBoolean(19,false);
                                        pstmt.setString(20,"Billing");
                                        pstmt.setBoolean(21,false);
                                        ...
                                        java.sql.PreparedStatement pstmt2 = connectDB.prepareStatement("insert into ac_ledger values(?,?,?,?,?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?,?,?,?)");
                                        pstmt2.setObject(1,adjustMentTable.getValueAt(i,4).toString());
                                        pstmt2.setString(2,glAcc);
                                        pstmt2.setString(3,patientNoTxt.getText());
                                        pstmt2.setString(4,patientName.getText());
                                        pstmt2.setString(5,"");
                                        pstmt2.setString(6,cardNo);
                                        pstmt2.setString(7,cardName);
                                        pstmt2.setString(8,"OP");
                                        pstmt2.setString(9,doctorsNameTxt.getText());
                                        pstmt2.setString(10,paymentModeTxt.getText());
                                        pstmt2.setString(11,"");
                                        pstmt2.setString(12,"");
                                        pstmt2.setString(13,"");
                                        pstmt2.setString(14,adjustMentTable.getValueAt(i,0).toString());
                                        pstmt2.setString(15,"Revenue");
                                        pstmt2.setDouble(17,0.00);
                                        pstmt2.setDouble(16,java.lang.Double.valueOf(adjustMentTable.getValueAt(i,3).toString()));
                            ...
                            for (int i = 0; i < adjustMentTable.getRowCount(); i++){
                                if (adjustMentTable.getValueAt(i,0) != null){
                                    ...
                                    java.sql.ResultSet rsBx = pstBx.executeQuery("select count(product) from st_stock_prices where product = '"+adjustMentTable.getValueAt(i,0)+"' and gl_code =  '"+adjustMentTable.getValueAt(i,4)+"'");
                                    ...
                                    if (itemInt > 0){
                                        ...
                                        java.sql.ResultSet rsB = pstB.executeQuery("select transfer_price,units,department from st_stock_prices where product = '"+adjustMentTable.getValueAt(i,0)+"' and gl_code =  '"+adjustMentTable.getValueAt(i,4)+"'");
                                        ...
                                        java.sql.ResultSet rs111 = pst211.executeQuery("select cost_of_sale,stock_code from pb_departments where income_account = '"+adjustMentTable.getValueAt(i,4)+"'");
                                        while (rs111.next()){
                                            glCode = rs111.getObject(1).toString();
                                            actCode = rs111.getObject(2).toString();
                                        }
                                        
                                        qty = java.lang.Double.parseDouble(adjustMentTable.getValueAt(i, 1).toString());
                                        amount = price*qty;
                                        if (amount > 10000){
                                        ...
                                        java.sql.ResultSet rse1211q = stm1211q.executeQuery("select units from st_stock_prices where product ='"+adjustMentTable.getModel().getValueAt(i,0).toString()+"'");
                                        while (rse1211q.next()){
                                        ...
                                        pstmt1.setString(2,patientName.getText());
                                        pstmt1.setDouble(3,-1*java.lang.Double.valueOf(adjustMentTable.getValueAt(i,1).toString()));
                                        pstmt1.setDouble(4,-1*java.lang.Double.valueOf(adjustMentTable.getValueAt(i,3).toString()));
                                        pstmt1.setObject(5,adjustMentTable.getValueAt(i,0).toString());
                                        pstmt1.setDouble(7,java.lang.Double.valueOf(adjustMentTable.getValueAt(i,2).toString()));
                                        pstmt1.setObject(8,adjustMentTable.getValueAt(i,4).toString());
                                        pstmt1.setBoolean(6,true);
                                        pstmt1.setString(9,transNo);
                                        pstmt1.setObject(10,doctorsNameTxt.getText());
                                        ...
                                        pstmt1a.setObject(3,adjustMentTable.getValueAt(i,0));
                                        ...
                                        pstmt1a.setString(14,patientName.getText());
                                        ...
                                        pstmt1a.setDouble(27,-1*java.lang.Double.valueOf(adjustMentTable.getValueAt(i,1).toString()));
                                        ...
                                        pstmt2a.setObject(2,revenueDeptCmb.getSelectedItem());
                                        pstmt2a.setString(3,patientNoTxt.getText());
                                        pstmt2a.setString(4,patientName.getText());
                                        pstmt2a.setString(5,"");
                                        pstmt2a.setString(6,"");
                                        pstmt2a.setString(7,"");
                                        pstmt2a.setString(8,"");
                                        ...
                                        pstmt2a.setString(14,adjustMentTable.getValueAt(i,0).toString());
                                        ...
                                        pstmt33.setObject(2,adjustMentTable.getValueAt(i,0).toString());
                                        pstmt33.setDouble(4,0.00);
                                        pstmt33.setDouble(7,0.00);
                                        pstmt33.setDouble(5,java.lang.Double.valueOf(adjustMentTable.getValueAt(i,2).toString()));
                                        pstmt33.setDouble(6,java.lang.Double.valueOf(adjustMentTable.getValueAt(i,3).toString()));
                                        pstmt33.setString(8,transNo);
                                        pstmt33.setDouble(3,java.lang.Double.valueOf(adjustMentTable.getValueAt(i,1).toString()));
                                        pstmt33.setObject(9,doctorsNameTxt.getText());
                                        ...
                                        pstmt33.setString(14,patientNoTxt.getText()+ " " +patientName.getText());
                            ...
                            if(this.inPatientChk.isSelected()){
                                
                                if (!(jTextField4.getText().equals("Cash"))){
                                    java.sql.Statement stm1 = connectDB.createStatement();
                                    java.sql.ResultSet rse1 = stm1.executeQuery("select pay_mode,account_no,description,payer,payer,expiry_date,account_no from hp_inpatient_register where patient_no ='"+patientNoTxt.getText()+"'");
                                    while (rse1.next()){
                                ...
                                for (int i = 0; i < adjustMentTable.getRowCount(); i++){
                                    if (adjustMentTable.getValueAt(i,0) != null){
                                        if(adjustMentTable.getValueAt(i,0).toString().startsWith("Exemp") && waiverTxt.getText().equalsIgnoreCase("") || adjustMentTable.getValueAt(i,0).toString().startsWith("Waiv") && waiverTxt.getText().equalsIgnoreCase("")){
                                             javax.swing.JOptionPane.showMessageDialog(this,"You Must put waiver/exemption number before you proceed","Information Message",javax.swing.JOptionPane.INFORMATION_MESSAGE);
                                        }else{
                                        java.sql.Statement stm121 = connectDB.createStatement();
                                        java.sql.ResultSet rse121 = stm121.executeQuery("select activity,current_user from pb_activity where code ='"+adjustMentTable.getValueAt(i,4).toString()+"'");
                                        while (rse121.next()){
                                       ...
                                       // pstmt.setString(28,visitid);
                                        ...
                                        pstmt.setString(29,waiverTxt.getText());
                                        ...
                                        pstmt2.setString(11,"");
                                        pstmt2.setString(12,"");
                                        pstmt2.setString(13,waiverTxt.getText());
                                        pstmt2.setString(14,adjustMentTable.getValueAt(i,0).toString());
                                        pstmt2.setString(15,"Revenue");
                                        pstmt2.setDouble(17,0.00);
                                        pstmt2.setDouble(16,java.lang.Double.valueOf(adjustMentTable.getValueAt(i,3).toString()));
                                ...
                                for (int i = 0; i < adjustMentTable.getRowCount(); i++){
                                    if (adjustMentTable.getValueAt(i,0) != null){
                                        ...
                                        if (itemInt > 0){
                                            ...
                                            qty = java.lang.Double.parseDouble(adjustMentTable.getValueAt(i, 1).toString());
                                            sellPrice = java.lang.Double.parseDouble(adjustMentTable.getValueAt(i, 2).toString());
                                            amount = price*qty;
                                            if (amount > 10000){
                                                amount = (qty*sellPrice)*0.67;
                                            }else{
    ...
    private javax.swing.JTextField doctorsNameTxt;
    private javax.swing.JTextField doctorsTxt;
    private javax.swing.JTextField enteredToTxt;
    private javax.swing.JCheckBox inPatientChk;
    private javax.swing.JTextField insertDateTxt;
    ...
    private javax.swing.JRadioButton normalRateRdi;
    private javax.swing.JCheckBox outPatientChk;
    ...
    private javax.swing.JComboBox revenueDeptCmb;
