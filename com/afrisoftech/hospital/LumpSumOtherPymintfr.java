...
// TODO add your handling code here:
    ...
    */
    ...
    private void jCheckBox4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jCheckBox4ActionPerformed
        try {
            java.sql.Statement stmt = connectDB.createStatement();
            java.sql.ResultSet rset = stmt.executeQuery("select code,activity from pb_activity where category_class ilike 'ba%'");
            while (rset.next()){
                jTextField311.setText(rset.getObject(1).toString());
                this.jComboBox131.setSelectedItem(rset.getObject(2).toString());
            }
...
// Add your handling code here:
    ...
    private void jCheckBox52ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jCheckBox52ActionPerformed
        try {
            java.sql.Statement stmt = connectDB.createStatement();
            java.sql.ResultSet rset = stmt.executeQuery("select code,activity from pb_activity where activity_category ilike 'pc'");
            while (rset.next()){
                jTextField311.setText(rset.getObject(1).toString());
                this.jComboBox131.setSelectedItem(rset.getObject(2).toString());
            }
...
// TODO add your handling code here:
    ...
    private void jCheckBox5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jCheckBox5ActionPerformed
        try {
            java.sql.Statement stmt = connectDB.createStatement();
            java.sql.ResultSet rset = stmt.executeQuery("select code,activity from pb_activity where activity_category ilike 'pr'");
            while (rset.next()){
                jTextField311.setText(rset.getObject(1).toString());
                this.jComboBox131.setSelectedItem(rset.getObject(2).toString());
            }
    ...
    private void jCheckBox3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jCheckBox3ActionPerformed
        try {
            java.sql.Statement stmt = connectDB.createStatement();
            java.sql.ResultSet rset = stmt.executeQuery("select code,activity from pb_activity where category_class ilike 'bl%'");
            while (rset.next()){
                jTextField311.setText(rset.getObject(1).toString());
                this.jComboBox131.setSelectedItem(rset.getObject(2).toString());
            }
    ...
    private void jCheckBox1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jCheckBox1ActionPerformed
        try {
            java.sql.Statement stmt = connectDB.createStatement();
            java.sql.ResultSet rset = stmt.executeQuery("select code,activity from pb_activity where activity_category ilike 'ca'");
            while (rset.next()){
                jTextField311.setText(rset.getObject(1).toString());
                this.jComboBox131.setSelectedItem(rset.getObject(2).toString());
            }
...
// Add your handling code here:
    ...
    private void jTextField1131CaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextField1131CaretUpdate
        if(this.jTextField1131.getCaretPosition() < 3){
            ...
            if(this.jCheckBox1.isSelected()){
                jSearchTable21.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"select distinct first_name||' '||middle_name as name,staff_no from pb_doctors_list where first_name ILIKE '"+jTextField1131.getText()+"%' ORDER BY first_name||' '||middle_name"));
                ...
                if(this.jCheckBox3.isSelected() || jCheckBox2.isSelected()){
                    ...
                    if(this.jCheckBox4.isSelected()){
                        ...
                        if(this.jCheckBox5.isSelected()){
                            jSearchTable21.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"select distinct second_name||' '||first_name||' '||last_name as name,patient_no as code from hp_inpatient_register where second_name||' '||first_name||' '||last_name ILIKE '"+jTextField1131.getText()+"%' order by second_name||' '||first_name||' '||last_name"));
