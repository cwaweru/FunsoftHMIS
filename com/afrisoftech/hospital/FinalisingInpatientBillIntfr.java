        ...
        try {
            ...
            if(datePicker2.getDate().before(periodFrom) || datePicker2.getDate().after(periodTo)){
                ...
                if (balance>Limit){
                    ...
                    java.sql.Statement pss112 = connectDB.createStatement();
                    java.sql.ResultSet rsts12 = pss112.executeQuery("select current_user");
                    while (rsts12.next()){
                      user = rsts12.getObject(1).toString();
                    }
                   ...
                   /* pstmt.setString(25,"{Nothing}");
                    ...
                    pstmt.setString(27,"");
                    pstmt.setString(28,"");
                    pstmt.setDate(29,com.afrisoftech.lib.SQLDateFormat.getSQLDate(datePicker2.getDate()));
                    pstmt.setString(30,"");
                    pstmt.setString(31,"");
                    pstmt.setDate(32,com.afrisoftech.lib.SQLDateFormat.getSQLDate(datePicker2.getDate()));
                    ...
                    pstmtA.setDate(10,null);
                    pstmtA.setString(11,"");
                    pstmtA.setDouble(13,java.lang.Double.valueOf(jTextField3111.getText()));
                    pstmtA.setDouble(12,0.00);
                    pstmtA.setDate(14,com.afrisoftech.lib.SQLDateFormat.getSQLDate(datePicker2.getDate()));
                    pstmtA.setObject(15,actCode);
                    pstmtA.setString(16,"");
                    pstmtA.setDouble(17,1);
                    pstmtA.setObject(18,jTextField9.getText());
                    pstmtA.setBoolean(19,true);
                    pstmtA.setString(20,"Receipts");
                    pstmtA.setBoolean(21,true);
                    ...
                    pstmt2.setDouble(13,java.lang.Double.valueOf(jTextField3111.getText()));
                    pstmt2.setDouble(14,0.00);
                    pstmt2.setDate(15,com.afrisoftech.lib.SQLDateFormat.getSQLDate(datePicker2.getDate()));
                    ...
                    pstmt2.setString(21,"");
                    pstmt2.setDouble(22,java.lang.Double.valueOf(jTextField3111.getText()));
                    ...
                    if (bill < balance){
                        ...
                        if (bill == balance){
                            ...
                            if (balance<Limit){
                                ...
                                if(balance <=0){
                                    pstmt2.setDouble(17,java.lang.Double.valueOf(jTextField1.getText()));
                                    pstmt2.setDouble(16,0.00);
                                }else{
                                    pstmt2.setDouble(17,0.00);
                                    pstmt2.setDouble(16,java.lang.Double.valueOf(jTextField1.getText()));
                                }
                                ...
                                pstmt1.setString(11,"");
                                if(balance <=0){
                                    pstmt1.setDouble(12,java.lang.Double.valueOf(jTextField1.getText()));
                                    pstmt1.setDouble(13,0.00);
                                }else{
                                    pstmt1.setDouble(13,java.lang.Double.valueOf(jTextField1.getText()));
                               ...
                               // pstmt1.setString(28,jTextField16.getText());
                                ...
                                java.sql.PreparedStatement pstmt12 = connectDB.prepareStatement("UPDATE hp_admission SET invoice_no = '"+invoiceNo+"',balance = '"+jTextField3111.getText()+"',check_out = true WHERE patient_no = '"+this.jTextField9.getText()+"' AND visit_id = '"+jTextField16.getText()+"'");
                                pstmt12.executeUpdate();
