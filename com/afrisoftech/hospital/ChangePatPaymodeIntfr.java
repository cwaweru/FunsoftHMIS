...
public class ChangePatPaymodeIntfr extends javax.swing.JInternalFrame {
    ...
    private void jTextField1112CaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextField1112CaretUpdate
        if(jTextField1112.getCaretPosition() < 3){
            ...
            if(this.jCheckBox5.isSelected()){
                jSearchTable1.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectorsCaret(connectDB,"select trim(staff_no) as scheme, staff_name as name,sheme_name from scheme_members_view where staff_name ILIKE '"+jTextField1112.getText().toString()+"%' and sheme_name = '"+jTextField3611.getText().toString()+"' ORDER BY staff_name"));
                ...
                */
                ...
                jSearchTable1.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectorsCaret(connectDB,"select trim(staff_no) as scheme, staff_name as name,sheme_name from scheme_members_view where staff_no ILIKE '"+jTextField1112.getText().toString()+"%' and sheme_name = '"+jTextField3611.getText().toString()+"' ORDER BY staff_no"));
    ...
    private void jTextField1111CaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextField1111CaretUpdate
        if(jTextField1111.getCaretPosition() < 3){
            ...
            jSearchTable11.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectorsCaret(connectDB,"SELECT account_no,scheme_name,payer_name from ac_schemes where scheme_name ILIKE '"+jTextField1111.getText()+"%' and (allowed ilike 'Both' or allowed ilike 'IP%') order by scheme_name"));
        ...
        if(jTextField111.getCaretPosition() < 4){
            ...
            if(jRadioButton2.isSelected()){
                if(jCheckBox1.isSelected()){
                    jSearchTable.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectorsCaret(connectDB,"select trim(patient_no) as patient_no,second_name||' '||first_name as name from hp_inpatient_register where patient_no ILIKE '%"+jTextField111.getText().toString()+"%' order by patient_no"));
                    
                    jSearchTable.setShowHorizontalLines(false);
                    jSearchScrollPane.setViewportView(jSearchTable);
                }else{
                    jSearchTable.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectorsCaret(connectDB,"select trim(patient_no) as patient_no,second_name||' '||first_name as name from hp_inpatient_register where second_name||' '||first_name ILIKE '%"+jTextField111.getText().toString()+"%' order by second_name"));
                ...
                if(jRadioButton1.isSelected()){
                    if(jCheckBox1.isSelected()){
                        jSearchTable.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectorsCaret(connectDB,"SELECT patient_no, name, year_of_birth, residence from patient_select where patient_no ILIKE '%"+jTextField111.getText()+"%' order by patient_no"));
                        jSearchTable.setShowHorizontalLines(false);
                        jSearchScrollPane.setViewportView(jSearchTable);
                        
                    }else{
                        jSearchTable.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectorsCaret(connectDB,"SELECT patient_no, name, year_of_birth, residence from patient_select where name ILIKE '%"+jTextField111.getText()+"%' order by name"));
                        jSearchTable.setShowHorizontalLines(false);
                        jSearchScrollPane.setViewportView(jSearchTable);
                    }
                }
        ...
        if(jRadioButton2.isSelected()){
           /* try {
            ...
            if (jComboBox1.getSelectedItem().toString().equalsIgnoreCase("Scheme")) {
                ...
                try {
                    java.sql.PreparedStatement pstmt = connectDB.prepareStatement("begin work; UPDATE hp_inpatient_register set description = '',pay_mode = '"+this.jComboBox1.getSelectedItem().toString()+"',payer = '',account_no = '',member_no ='',expiry_date = null,member_name ='' WHERE patient_no  ='"+jTextField36.getText()+"';commit work");
