    ...
    private void jButton11111ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton11111ActionPerformed
        ...
        try{
            ...
            try{
                ...
                java.sql.Statement stm1z = connectDB.createStatement();
                java.sql.ResultSet rse1z = stm1z.executeQuery("select currval('pet_voucher_no')");
                while (rse1z.next()){
                    
                    voucherNo1 = rse1z.getObject(1).toString();
                }
                
                java.sql.Statement stm1 = connectDB.createStatement();
                java.sql.ResultSet rse1 = stm1.executeQuery("select lpad('"+voucherNo1+"',5,'0')");
                while (rse1.next()){
                ...
                try {
                    ...
                    if(jRadioButton1.isSelected()){
                        ...
                        while (rse1211.next()){
                            ...
                            userName = rse1211.getObject(1).toString();
                        }
                        
                        String voucherNo1 = null;
                        java.sql.Statement stm11x = connectDB.createStatement();
                        java.sql.ResultSet rse11x = stm11x.executeQuery("select nextval('pet_voucher_no')");
                        while (rse11x.next()){
                            
                            voucherNo1 = rse11x.getObject(1).toString();
                        }
                        java.sql.Statement stm1 = connectDB.createStatement();
                        java.sql.ResultSet rse1 = stm1.executeQuery("select lpad('"+voucherNo1+"',5,'0')");
                        while (rse1.next()){
                        ...
                        java.sql.Statement stm1w = connectDB.createStatement();
                        java.sql.ResultSet rse1w = stm1w.executeQuery("select nextval('transaction_no_seq')");
                        while (rse1w.next()){
                            
                             transNo = rse1w.getObject(1).toString();
                        }
                        for (int i = 0; i < jTable1.getRowCount(); i++){
    ...
    private void jButton1111ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1111ActionPerformed
        ...
        if(datePicker1.getDate().before(periodFrom) || datePicker1.getDate().after(periodTo)){
          ...
          */
                ...
                java.sql.Statement stm1s = connectDB.createStatement();
                java.sql.ResultSet rse1s = stm1s.executeQuery("select nextval('pet_voucher_no')");
                while (rse1s.next()){
                    
                    voucherNo1 = rse1s.getObject(1).toString();
                ...
                pstmt21.setDouble(5,0.00);
                pstmt21.setDate(7,com.afrisoftech.lib.SQLDateFormat.getSQLDate(datePicker2.getDate()));
                pstmt21.setString(8,userName);
                pstmt21.setBoolean(9,true);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
            ...
            try{
                ...
                java.sql.Statement stm1x = connectDB.createStatement();
                java.sql.ResultSet rse1x = stm1x.executeQuery("select currval('pet_voucher_no')");
                while (rse1x.next()){
                    
                    voucherNo1 = rse1x.getObject(1).toString();
                }
                java.sql.Statement stm1 = connectDB.createStatement();
                java.sql.ResultSet rse1 = stm1.executeQuery("select lpad('"+voucherNo1+"',5,'0')");
                while (rse1.next()){
