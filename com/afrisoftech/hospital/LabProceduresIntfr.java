...
public class LabProceduresIntfr extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        */
        ...
        jComboBox1.setModel(com.afrisoftech.lib.ComboBoxModel.ComboBoxModel(connectDB, "SELECT distinct UPPER(activity) from pb_activity  where department ilike 'LAB' AND activity_category ILIKE 'I%' "));
        ...
        if(this.jCheckBox42.isSelected()){
            ...
            if(jTextField11.getCaretPosition() < 1){
                ...
                if(jRadioButton1.isSelected()){
                    jSearchTable.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"select service_type,rate,'"+jTextField12.getText()+"',code FROM pb_operating_parameters WHERE code ILIKE '%"+jTextField11.getText()+"%' AND gl_account ilike '"+jTextField12.getText()+"' order by service_type"));
                }else{
                    jSearchTable.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"select service_type,anaesthetist_rate,'"+jTextField12.getText()+"',code FROM pb_operating_parameters WHERE code ILIKE '%"+jTextField11.getText()+"%' AND gl_account ilike '"+jTextField12.getText()+"' order by service_type"));
            ...
            if(jTextField11.getCaretPosition() < 1){
                ...
                if(jRadioButton1.isSelected()){
                    jSearchTable.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"select service_type,rate as price,'"+jTextField12.getText()+"' as glcode,code FROM pb_operating_parameters WHERE service_type ILIKE '%"+jTextField11.getText()+"%' AND gl_account ilike '"+jTextField12.getText()+"' order by service_type"));
                }else{
                    jSearchTable.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"select service_type,anaesthetist_rate as price,'"+jTextField12.getText()+"' as glcode,code FROM pb_operating_parameters WHERE service_type ILIKE '%"+jTextField11.getText()+"%' AND gl_account ilike '"+jTextField12.getText()+"'  order by service_type"));
