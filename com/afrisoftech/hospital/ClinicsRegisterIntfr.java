...
public class ClinicsRegisterIntfr extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Clinic ID", "Clinic Code", "Clinic Name", "Capacity"
            }
        ) {
    ...
    private void deleteActionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteActionActionPerformed
           ...
           java.sql.PreparedStatement pstmt1 = connectDB.prepareStatement("DELETE from pb_clinics where clinic_id = ? ");
                    pstmt1.setObject(1,jTable1.getValueAt(jTable1.getSelectedRow(),0));
                                        
                    pstmt1.execute();
                    ClearTable.removeSelectedRows(jTable1);
           ...
           try {
            ...
            for (int i = 0; i < jTable1.getRowCount(); i++){
                if (jTable1.getModel().getValueAt(i,0) != null){
                    java.sql.PreparedStatement pstmt1 = connectDB.prepareStatement("UPDATE pb_clinics set code = ?, clinics =  ?, patients_per_day = ? where clinic_id = ?");
                    pstmt1.setObject(1,jTable1.getValueAt(i,1));
                    pstmt1.setObject(2,jTable1.getValueAt(i,2));
                    pstmt1.setInt(3,Integer.parseInt(jTable1.getValueAt(i,3).toString()));
                  ...
                  //  pstmt1.setInt(5,Integer.parseInt(jTable1.getValueAt(i,3).toString()));
                    pstmt1.setObject(4,jTable1.getValueAt(i,0));
    ...
    private void newActionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_newActionActionPerformed
        try {
            ...
            for (int i = 0; i < jTable1.getRowCount(); i++){
                if (jTable1.getModel().getValueAt(i,0) != null){
                    java.sql.PreparedStatement pstmt1 = connectDB.prepareStatement("insert into pb_clinics values(upper(?),initcap(?), upper(?), ?, ?, ?)");
                    pstmt1.setObject(1,jTable1.getValueAt(i,0));
                    pstmt1.setObject(2,jTable1.getValueAt(i,2));
                    pstmt1.setObject(3,jTable1.getValueAt(i,1));
                    pstmt1.setInt(4,Integer.parseInt(jTable1.getValueAt(i,3).toString()));
                    pstmt1.setInt(5,Integer.parseInt(jTable1.getValueAt(i,3).toString()));
                    pstmt1.setInt(6,Integer.parseInt(jTable1.getValueAt(i,3).toString()));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        jTable1.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB, "SELECT DISTINCT clinic_id, code, clinics, patients_per_day FROM pb_clinics order by 3"));
        // TODO add your handling code here:
