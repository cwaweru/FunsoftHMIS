 ...
 * @author  root
 */
public class GeneralBillingPackageIntfr extends javax.swing.JInternalFrame {
    ...
    public GeneralBillingPackageIntfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
        ...
        //      GeneralBillingIntfrcurr.SearchThread();
...
//        System.setProperty("docsdir",System.getProperty("user.dir"));
        ...
        com.afrisoftech.hospital.GeneralBillingIntfr.schemeNameTxt.setText(claimFile.medicalAidCode);
        com.afrisoftech.hospital.GeneralBillingIntfr.payerNameTxt.setText(claimFile.medicalAidPlan);
                            ...
                            for (int i = 0; i < jTable1.getRowCount(); i++){
                                if (jTable1.getValueAt(i,0) != null){
                                    ...
                                    if (itemInt > 0){
                                        ...
                                        pstmt2a.setString(8,"");
                                        pstmt2a.setString(9,"");
                                        pstmt2a.setString(10,jComboBox2.getSelectedItem().toString());
                                        pstmt2a.setString(11,"");
                                        pstmt2a.setString(12,"");
                                        pstmt2a.setString(13,"");
                                        pstmt2a.setString(14,jTable1.getValueAt(i,0).toString());
