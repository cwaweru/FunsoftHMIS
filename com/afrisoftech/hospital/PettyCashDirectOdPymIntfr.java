...
public class PettyCashDirectOdPymIntfr extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        */
        ...
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.insets = new java.awt.Insets(0, 30, 0, 0);
        jPanel212.add(jLabel14, gridBagConstraints);
                ...
                try {
                    if(jRadioButton1.isSelected()){
                        ...
                        if(jTextField4.getText().equalsIgnoreCase("-")){
                            ...
                            java.sql.ResultSet rse1x = stm1x.executeQuery("select nextval('pet_voucher_no')");
                            while (rse1x.next()){
                                
                                vouch = rse1x.getObject(1).toString();
                                
                            }
                            
                            java.sql.Statement stm1 = connectDB.createStatement();
                            java.sql.ResultSet rse1 = stm1.executeQuery("select lpad('"+vouch+"',5,'0'),nextval('transaction_no_seq')");
                            while (rse1.next()){
                        ...
                        for (int i = 0; i < jTable1.getRowCount(); i++){
                            if (jTable1.getModel().getValueAt(i,0) != null){
                                ...
                                java.sql.ResultSet rs1x = pst1.executeQuery("select code,activity from pb_activity where activity_category = 'CP'");
                                while (rs1x.next()){
                                    accountCode = rs1x.getObject(1).toString();
                                    glType = rs1x.getObject(2).toString();
                                }
