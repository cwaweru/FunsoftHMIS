 ...
 */
public class UsersetupHospitalIntfr1 extends javax.swing.JInternalFrame {
    ...
    public UsersetupHospitalIntfr1(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {
        ...
        jButton202.setText("Cancel operation");
...
//        str = "{"+str+"}";
        ...
        try{
            ...
            // java.sql.PreparedStatement pmstmtArray = connectDB.prepareStatement("SELECT '{"+str+"}'");
    ...
    private void jButton301ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton301ActionPerformed
     ...
     //   java.lang.String str = this.getSqlString(selectedValues);
       ...
       /* java.util.Vector item2add = new java.util.Vector(1, 1);
        ...
        java.lang.Object[] exitSQLArray = item2add.toArray();
        
        java.sql.Array arraySet = null;
        
        try {
            
            arraySet = connectDB.createArrayOf("varchar", exitSQLArray);
        } catch (SQLException ex) {
            ex.printStackTrace();
        }
        */
