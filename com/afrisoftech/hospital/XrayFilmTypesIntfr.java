 ...
 * @author  root
 */
public class XrayFilmTypesIntfr extends javax.swing.JInternalFrame {
    ...
    public XrayFilmTypesIntfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {
        ...
        setMaximizable(true);
        setResizable(true);
        setTitle("Types of Xray Films - Form");
        ...
        jButton1.setText("Register Xray Film types");
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Enter Film types & code here"));
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Film type code", "Film type description"
            }
        ));
...
// TODO add your handling code here:
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        try{
            ...
            java.sql.PreparedStatement pstmt31 = connectDB.prepareStatement("DELETE from xray_films WHERE film_type_id = '"+jTable1.getValueAt(jTable1.getSelectedRow(),0).toString()+"'");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            ...
            for (int i = 0; i < jTable1.getRowCount(); i++){
                if (jTable1.getModel().getValueAt(i,0) != null){
                    if(jButton1.getText().equalsIgnoreCase("Update")){
                        java.sql.PreparedStatement pstmt311 = connectDB.prepareStatement("UPDATE xray_films SET film_type_desc = '"+jTable1.getValueAt(i,1).toString()+"' WHERE film_type_id = '"+jTable1.getValueAt(i,0).toString()+"'");
                        pstmt311.executeUpdate();
                    }else{
                        java.sql.PreparedStatement pstmt1 = connectDB.prepareStatement("INSERT INTO xray_films(film_type_code, film_type_desc) VALUES (?, initcap(?))");
            ...
            jLabel3.setText("Sorry. Another Film type code already exists");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        int i = 0;
        jTable1.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"SELECT film_type_id, film_type_desc, film_type_code  FROM xray_films"));
