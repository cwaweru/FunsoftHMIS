...
public class XrayProceduresIntfr extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        */
        ...
        jComboBox1.setModel(com.afrisoftech.lib.ComboBoxModel.ComboBoxModel(connectDB, "SELECT distinct UPPER(activity) FROM pb_activity  where department ilike 'XRY' AND activity_category ILIKE 'I%'"));
...
// TODO add your handling code here:
    ...
    private void cmboxMouseClicked() {
        ...
        if (jTable1.isFocusable()) {
            point = jScrollPane2.getLocationOnScreen();
            jSearchDialog.setSize(400, 200);
            jSearchDialog.setLocation(point);
        } else {
            if (jButton7.isSelected()) {
                point = jButton7.getLocationOnScreen();
                jSearchDialog.setSize(400, 200);
                jSearchDialog.setLocation(point);
            }
        }
    ...
    private void jSearchTable2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jSearchTable2MouseClicked
        ...
        if (this.jCheckBox11.isSelected()) {
            ...
            try {
                ...
                java.sql.Statement stmt1 = connectDB.createStatement();
                java.sql.ResultSet rset1 = stmt1.executeQuery("select category,pay_mode,description,residence,sex,(current_date::date-year_of_birth::date)/352 from hp_patient_register where patient_no  ='" + jTextField9.getText() + "'");
                while (rset1.next()) {
                    ...
                    jTextField5.setText(dbObject.getDBObject(rset1.getObject(4), "-").toString());
                    jTextField4.setText(dbObject.getDBObject(rset1.getObject(6), "-").toString());
                    jComboBox2.setSelectedItem(rset1.getObject(5));
            ...
            if (this.jCheckBox21.isSelected()) {
                ...
                if (bal > (limit + rect)) {
                    ...
                    try {
                        ...
                        java.sql.Statement stmt1 = connectDB.createStatement();
                        java.sql.ResultSet rset1 = stmt1.executeQuery("select category,pay_mode,description,residence,sex,(current_date::date-year_of_birth::date)/352 from hp_inpatient_register where patient_no  ='" + jTextField9.getText() + "'");
                        while (rset1.next()) {
                            jTextField2.setText(rset1.getObject(1).toString());
                            jTextField7.setText(rset1.getObject(2).toString());
                            jTextField10.setText(dbObject.getDBObject(rset1.getObject(3), "-").toString());
        ...
        if (datePicker1.getDate().before(periodFrom) || datePicker1.getDate().after(periodTo)) {
            ...
            if (jTextField1.getText().equalsIgnoreCase("")) {
                ...
                try {
                    ...
                    java.sql.Statement stm121g = connectDB.createStatement();
                    java.sql.Statement ps11g = connectDB.createStatement();
                    java.sql.ResultSet rst11g = ps11g.executeQuery("select 'X'||nextval('xray_no_seq'),current_user");
                    while (rst11g.next()) {
                        rst11g.getObject(1).toString();

                        billNo = rst11g.getObject(1).toString();
                        user = rst11g.getObject(2).toString();
                    }

                    for (int i = 0; i < jTable1.getRowCount(); i++) {
                        if (jTable1.getValueAt(i, 0) != null) {
                            String mainService = "";
                            java.sql.ResultSet rst11g1 = stm121g.executeQuery("SELECT sub_category FROM pb_operating_parameters WHERE service_type = '"+jTable1.getValueAt(i, 0)+"'");
                            while (rst11g1.next()) {
                                mainService = rst11g1.getString(1);
                    }
                            ...
                            pstmt.setObject(5, jComboBox2.getSelectedItem());
                            pstmt.setString(6, "");
                            pstmt.setString(7, jTable1.getValueAt(i, 0).toString());
                            pstmt.setDate(8, com.afrisoftech.lib.SQLDateFormat.getSQLDate(datePicker1.getDate()));
                            ...
                            pstmt.setString(17, jTextField92.getText());
                            pstmt.setInt(18, 1);
                            pstmt.setString(19, "N/A");
                            pstmt.setString(20, "");
                            pstmt.setString(21, "");
                            pstmt.setString(22, "");
                            pstmt.setString(23, "");
                            pstmt.setString(24, "");
                            pstmt.setString(25, mainService);
                            pstmt.executeUpdate();

                            // java.sql.PreparedStatement pstmt112 = connectDB.prepareStatement("UPDATE hp_xray_results SET receipt_no = '" + receiptNo2 + "' WHERE receipt_no = '" + receiptNo1 + "'");
