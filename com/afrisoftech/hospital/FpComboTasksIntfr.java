 ...
 * @author  root
 */
public class FpComboTasksIntfr extends javax.swing.JInternalFrame implements java.lang.Runnable {
    ...
    com.afrisoftech.accounting.BillPaymentsFpIntfr billPayments = null;
    
    com.afrisoftech.fplanning.FpRegisterIntfr patientRegister = null;
    ...
    com.afrisoftech.accounting.CafeteriaBillPaymentsIntfr govPos = null;
    
    public final javax.swing.JButton registrationButton;// = null;
    
    javax.swing.JButton adjPatientbillButton = null;
    
    public FpComboTasksIntfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB, com.afrisoftech.hospital.HospitalMain parentHospitalFrame) {
        ...
        javax.swing.JButton govReceiptsButton = new javax.swing.JButton("GOK Pos");
   ...
   /*    patientRegister.jRadioButton1.addActionListener(new java.awt.event.ActionListener() {
        ...
        /*if (parentHospitalFrame.patientregstmnit.isVisible()){
            ...
            // comboButtonBar.add(patientButton);
        }else{*/
        if (parentHospitalFrame.fpregistermnit.isVisible()){
            comboButtonBar.add(registrationButton); //Patient Registration
            // comboButtonBar.add(patientButton);
        }
        //}
        ...
        if (parentHospitalFrame.generalmnit.isVisible()){
            ...
            if (parentHospitalFrame.fprecordsmnit.isVisible()){
                comboButtonBar.add(schemeButton);
            }
        }*/
       ...
       /* if (parentHospitalFrame.receiptsmnit.isVisible()){
        ...
        if(parentHospitalFrame.fpPosmnit.isVisible()){
            comboButtonBar.add(salesButton);
        }
        // }
    ...
    private void registrationButtonActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        if(patientRegister == null){
            patientRegister = new com.afrisoftech.fplanning.FpRegisterIntfr(connectDB,pConnDB);
        }
 ...
 // GeneralBillingIntfrcurreralBillingIGeneralBillingIntfrcurr GeneralBillingIntfr(connectDB,pConnDB);
    ...
    private void govReceiptsButtonActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        try {
            ...
            if (rowsNo < 1) {
                ...
                comboTaskPanels.removeAll();
                this.setTitle("FRONT END OPERATIONS :: GOK Pos".toUpperCase());
        ...
        if (java.lang.Thread.currentThread().getName().matches("Patient")) {
            ...
            while (cashRunning) {
                ...
                if (billPayments == null){
                    billPayments = new com.afrisoftech.accounting.BillPaymentsFpIntfr(connectDB,pConnDB);
                }
...
//                        jCheckBox3ActionPerformed(evt);
    ...
    public com.afrisoftech.hospital.FpComboTasksIntfr getMainClass() {
