...
public class CloseSuspSchemeIntfr extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        terminationDatetxt = new javax.swing.JTextField();
        ...
        */
        ...
        terminationDatetxt.setEditable(false);
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 3;
        gridBagConstraints.gridy = 7;
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
        ...
        gridBagConstraints.weighty = 1.0;
        gridBagConstraints.insets = new java.awt.Insets(0, 0, 0, 5);
        jPanel1.add(terminationDatetxt, gridBagConstraints);
        ...
        gridBagConstraints.weighty = 1.0;
        gridBagConstraints.insets = new java.awt.Insets(0, 0, 0, 5);
        jPanel1.add(expiryDatePicker, gridBagConstraints);
    ...
    private void jSearchTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jSearchTableMouseClicked
        ...
        try {
            ...
            while (rset1.next()){
                terminationDatetxt.setText(rset1.getObject(6).toString());
...
//        java.util.Date date = simpleDateFormat.parse("").getTime();
        
//        new java.sql.Date()
        
        System.out.println("Date to parse : ["+endDateSpinner.getValue().toString()+"]");
        ...
        try {
            ...
            try {
                pstmt = connectDB.prepareStatement("begin work; update ac_schemes set scheme_limit = '" + jTextField2.getText() + "', expiry_date ='" + this.expiryDatePicker.getDate() + "',allowed = '" + this.jComboBox11.getSelectedItem().toString() + "',contact3 ='" + this.jComboBox1.getSelectedItem().toString() + "',marketing_contact = '" + this.jComboBox2.getSelectedItem().toString() + "',contact2 ='" + jTextField6.getText() + "',sig_name = '" + jTextField6.getText() + "', source ='" + Chkbx + "',doc_ref = '" + jTextField9.getText() + "',comm_mode ='" + this.jComboBox3.getSelectedItem().toString() + "',rec_date ='" + new java.sql.Date(simpleDateFormat.parse(beginDateSpinner.getValue().toString()).getTime()) + "',term_date = '" + new java.sql.Date(simpleDateFormat.parse(endDateSpinner.getValue().toString()).getTime()) + "',trans_date = current_date where scheme_name ='" + jTextField36.getText() + "' and account_no = '" + jTextField1.getText() + "';commit work");
    ...
    private javax.swing.JTextField terminationDatetxt;
