 ...
 * @author  root
 */
public class VoteDepartmentIntfr extends javax.swing.JInternalFrame {
    ...
    public VoteDepartmentIntfr(java.sql.Connection connDb) {
    ...
    private void initComponents() {
        ...
        setIconifiable(true);
        setTitle("Vote Department setup");
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Register Vote Departments on this form"));
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Department Code", "Department Name", "Comments"
            }
        ));
...
// TODO add your handling code here:
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        try{
            ...
            java.sql.PreparedStatement pstmt31 = connectDB.prepareStatement("DELETE from vote_departments WHERE department_id = ? ");
            pstmt31.setString(1, jTable1.getValueAt(jTable1.getSelectedRow(),0).toString());
            ...
            for (int i = 0; i < jTable1.getRowCount(); i++){
                if (jTable1.getModel().getValueAt(i,0) != null){
                    if(jButton1.getText().equalsIgnoreCase("Update")){
                        java.sql.PreparedStatement pstmt311 = connectDB.prepareStatement("UPDATE vote_departments SET department_desc = ? ,  department_comment = ? WHERE department_id = ?");
                        pstmt311.setString(1, jTable1.getValueAt(i,1).toString());
                        pstmt311.setString(2, jTable1.getValueAt(i,2).toString());
                        pstmt311.setString(3, jTable1.getValueAt(i,0).toString());
                        pstmt311.executeUpdate();
                    }else{
                        java.sql.PreparedStatement pstmt1 = connectDB.prepareStatement("insert into vote_departments values(?,initcap(?), ?)");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        int i = 0;
        jTable1.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"select department_id,department_desc, department_comment from vote_departments ORDER BY department_desc"));
