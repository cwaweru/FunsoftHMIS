 ...
 * @author root
 */
public class OpeningBalanceGeneralBillingIntfr extends javax.swing.JInternalFrame {
    ...
    public OpeningBalanceGeneralBillingIntfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {
        ...
        */
        ...
        jSearchTable.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                jSearchTableKeyReleased(evt);
            }
        });
        jSearchScrollPane.setViewportView(jSearchTable);
        ...
        */
        ...
        //try {
            ...
            */
            ...
            setMaximizable(true);
            setResizable(true);
            setTitle("Billing Form for posting Opening Balances");
            setFrameIcon(null);
            try {
                setSelected(true);
            ...
            jTable3.setFont(new java.awt.Font("Lucida Sans", 0, 12)); // NOI18N
            ...
            */
            ...
            jComboBox1.setModel(com.afrisoftech.lib.ComboBoxModel.ComboBoxModel(connectDB, "SELECT DISTINCT department FROM department_allocation WHERE user_name ilike current_user ORDER BY 1"));
            ...
            jPanel5.setMinimumSize(new java.awt.Dimension(100, 220));
            jPanel5.setPreferredSize(new java.awt.Dimension(100, 220));
            ...
            jButton5.setText("Del Package Row");
            ...
            jCheckBox42.setMargin(new java.awt.Insets(0, 0, 0, 0));
            ...
            jCheckBox51.setMargin(new java.awt.Insets(0, 0, 0, 0));
            ...
            jCheckBox8.setBackground(new java.awt.Color(153, 255, 102));
            jCheckBox8.setText("<< BACK");
            ...
            jCheckBox9.setBackground(new java.awt.Color(255, 204, 102));
            buttonGroup5.add(jCheckBox9);
            jCheckBox9.setFont(new java.awt.Font("Lucida Sans", 1, 12)); // NOI18N
            jCheckBox9.setForeground(new java.awt.Color(0, 0, 204));
            jCheckBox9.setText(">>APPLY");
            ...
            gridBagConstraints.fill = java.awt.GridBagConstraints.BOTH;
            gridBagConstraints.weightx = 1.0;
            jPanel1.add(imgPanel, gridBagConstraints);
            ...
            jTextField23.addVetoableChangeListener(new java.beans.VetoableChangeListener() {
                public void vetoableChange(java.beans.PropertyChangeEvent evt)throws java.beans.PropertyVetoException {
                    jTextField23VetoableChange(evt);
                }
            });
            gridBagConstraints = new java.awt.GridBagConstraints();
            gridBagConstraints.gridx = 1;
            ...
            jComboBox4.setModel(com.afrisoftech.lib.ComboBoxModel.ComboBoxModel(connectDB, "SELECT '-' UNION ALL SELECT main_service from pb_operating_parameters WHERE category = 'CA' ORDER BY 1"));
            jComboBox4.setMinimumSize(new java.awt.Dimension(32, 20));
        ...
        if (jTextField16.getText().equalsIgnoreCase("")) {
            ...
            try {
                ...
                while (rsetTable1.next()) {
                    ...
                    jTextField13.setText(rsetTable1.getString(2));
...
// TODO add your handling code here:
    ...
    private void jCheckBox7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jCheckBox7ActionPerformed
        ...
        try {
            ...
            java.sql.ResultSet rsBx2 = pstBx2.executeQuery("select count(package) from packages where package ilike '" + jTable1.getValueAt(i, 0) + "' and glcode =  '" + jTable1.getValueAt(i, 4) + "'");
            ...
            if (j > 0) {
                java.sql.Statement st1 = connectDB.createStatement();
                java.sql.ResultSet rsetTable1 = st1.executeQuery("select item_service,price,qty,total,glcode FROM packages WHERE package ILIKE '" + jTable1.getValueAt(i, 0) + "' AND glcode = '" + jTextField7.getText() + "' and department ilike '" + jComboBox1.getSelectedItem().toString() + "'");
                while (rsetTable1.next()) {
...
// TODO add your handling code here:
    ...
    private void jTextField14CaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextField14CaretUpdate
        String codes = this.jTextField7.getText();
        if (codes.equalsIgnoreCase("") || codes.equals(null)) {
            ...
            if (codeType.equalsIgnoreCase("subcode")) {
                if (jTextField14.getCaretPosition() < 1) {
                    ...
                    jSearchTable4.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB, "SELECT DISTINCT service_type,rate as price,gl_account, main_service as department as glcode FROM pb_operating_parameters WHERE service_type ILIKE '%" + jTextField14.getText().toString() + "%'"));// AND sub_code ILIKE '%" + jTextField22.getText() + "%'"));
//                   jSearchTable4.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB, "SELECT DISTINCT service_type,rate as price,'" + jTextField7.getText() + "' as glcode FROM pb_operating_parameters WHERE service_type ILIKE '%" + jTextField14.getText().toString() + "%' AND sub_code ILIKE '%" + jTextField22.getText() + "%'"));
                ...
                if (jTextField14.getCaretPosition() < 1) {
                    ...
                    //  jSearchTable4.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"SELECT service_type,rate as price,'"+jTextField7.getText()+"' as glcode FROM pb_operating_parameters WHERE service_type ILIKE '%"+jTextField14.getText().toString()+"%' AND sub_code ILIKE '%"+jTextField22.getText()+"%'"));

                    jSearchTable4.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB, "SELECT DISTINCT service_type,rate as price, gl_account as glcode, main_service as department FROM pb_operating_parameters WHERE service_type ILIKE '%" + jTextField14.getText().toString() + "%'"));// AND gl_account ILIKE '%" + jTextField7.getText() + "%'"));
...
// Add your handling code here:
    ...
    /*   public abstract class MyDocumentLister implements DocumentListener(){
     //jTextField3.addActionListener(new myTextActionListener());
     }
    
     public abstract class myTextActionListener implements ActionListener{
     ...
     javax.swing.JOptionPane.showMessageDialog(new java.awt.Frame(), "THE BILL IS GREATER THAN THE CARD BALANCE");
    ...
    private void jTable3KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTable3KeyReleased
        ...
        double totalSum = com.afrisoftech.lib.TableColumnTotal.getTableColumnTotal(jTable3, 3);
        //jTextField10.setText(com.afrisoftech.lib.CurrencyFormatter.getFormattedDouble(totalSum));
        jTextField10.setText(java.lang.String.valueOf(totalSum));
        //  jTextField3.setText(java.lang.String.valueOf(totalSum));
        double balance = java.lang.Double.valueOf(jTextField20.getText());
        //    double bill = java.lang.Double.valueOf(jTextField3.getText());
...
// TODO add your handling code here:
    ...
    private void jSearchTable13MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jSearchTable13MouseClicked
        ...
        try {
            ...
            java.sql.ResultSet rset1cz3 = stmt1cz3.executeQuery("SELECT account_no,payer_name,usesmartcard FROM ac_schemes WHERE scheme_name  ILIKE '" + jTextField13.getText() + "'");
            while (rset1cz3.next()) {
    ...
    private void jTable1KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTable1KeyReleased
        float billNo = 0;
        double smartTotal = 0;
        double bedAmt = java.lang.Double.valueOf(jTextField23.getText());
        try {
            java.sql.Statement ps11 = connectDB.createStatement();
            java.sql.ResultSet rst11 = ps11.executeQuery("select discount from pb_smartcards WHERE card_name = '" + jTextField13.getText() + "'");
            while (rst11.next()) {
        ...
        if (jTable1.getModel().getValueAt(jTable1.getSelectedRow(), 1) != null) {
            if (jTable1.getSelectedColumn() == jTable1.getSelectedColumn()) {
                ...
                if (billNo > 0) {
                    ...
                    double totalSum = com.afrisoftech.lib.TableColumnTotal.getTableColumnTotal(jTable1, 3) + bedAmt;
...
// TODO add your handling code here:
    ...
    private void jButton12ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton12ActionPerformed
        ...
        /*   try {
         ...
         java.sql.Statement ps11 = connectDB.createStatement();
         java.sql.ResultSet rst11 = ps11.executeQuery("select currval('transaction_no_seq')");
         while (rst11.next()){
                ...
                try {
                    ...
                    for (int i = 0; i < jTable11.getRowCount(); i++) {
                        if (jTable11.getValueAt(i, 0) != null) {
                            java.sql.Statement stm121 = connectDB.createStatement();
                            java.sql.ResultSet rse121 = stm121.executeQuery("select main_service from pb_operating_parameters where gl_account ='" + jTable11.getValueAt(i, 4).toString() + "'");
                            while (rse121.next()) {
                            ...
                            pstmt2.setDouble(6, java.lang.Double.parseDouble(jTable11.getValueAt(i, 1).toString()));
                            pstmt2.setDouble(7, java.lang.Double.parseDouble(jTable11.getValueAt(i, 3).toString()));
                            ...
                            pstmt21.setDouble(7, Double.parseDouble(jTable11.getValueAt(i, 1).toString()));
                            pstmt21.setDouble(9, Double.parseDouble(jTable11.getValueAt(i, 3).toString()));
                            ...
                            pstmt211.setDouble(8, Double.parseDouble(jTable11.getValueAt(i, 3).toString()));
                            ...
                            pstmt211.setDouble(18, Double.parseDouble(jTable11.getValueAt(i, 3).toString()));
                            ...
                            pstmt.setObject(2, jTable11.getValueAt(i, 0).toString() + "-" + jTable11.getValueAt(i, 5).toString());
                            ...
                            pstmt.setString(9, isurer);
                            pstmt.setDate(10, null);
                            pstmt.setString(11, jTable11.getValueAt(i, 5).toString());
                            pstmt.setDouble(12, Double.parseDouble(jTable11.getValueAt(i, 3).toString()));
                            pstmt.setDouble(13, 0.00);
                            pstmt.setDate(14, com.afrisoftech.lib.SQLDateFormat.getSQLDate(datePicker2.getDate()));
                            pstmt.setObject(15, patientAcc);
                            pstmt.setString(16, glAcc);
                            pstmt.setDouble(17, Double.parseDouble(jTable11.getValueAt(i, 1).toString()));
                            pstmt.setObject(18, staffNo);
                            pstmt.setBoolean(19, false);
                            pstmt.setString(20, "Billing");
                            pstmt.setBoolean(21, false);
    ...
    private void jTable11KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTable11KeyReleased
        ...
        if (jTable11.getValueAt(jTable11.getSelectedRow(), 1) != null) {
            ...
            //float total = qty * price;
            jTable11.setValueAt(resVal, jTable11.getSelectedRow(), 3);
    ...
    private void jTextField111CaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextField111CaretUpdate
        jSearchTable1.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB, "select service_type,"
                + "CASE WHEN ('" + jTextField71.getText() + "' ILIKE 'Scheme') THEN anaesthetist_rate ELSE rate END AS price,"
                + "gl_account as gl_code FROM pb_operating_parameters WHERE "
                + "service_type ILIKE '" + jTextField111.getText() + "%' AND main_service = '" + jComboBox4.getSelectedItem().toString() + "' order by service_type"));
    ...
    private void searchButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchButton1ActionPerformed
        ...
        try {
            ...
            while (rset2.next()) {
                jComboBox4.setSelectedItem(rset2.getObject(1).toString());
            }
        } catch (java.sql.SQLException sqe) {
            sqe.printStackTrace();
            //  System.out.println("Insert not successful");
...
// Add your handling code here:
    ...
    private void jTextField11CaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextField11CaretUpdate
        ...
        if (codeType.equalsIgnoreCase("subcode")) {
            ...
            if (this.jCheckBox42.isSelected()) {
                ...
                if (jTextField11.getCaretPosition() < 1) {
                    ...
                    if (jRadioButton1.isSelected()) {
                        ...
                        jSearchTable.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB, "SELECT DISTINCT service_type,rate as price,'" + jTextField7.getText() + "' as glcode, code, main_service FROM pb_operating_parameters WHERE code ILIKE '%" + jTextField11.getText().toString() + "%' AND service_type ILIKE '%opening%' AND service_type NOT ILIKE '%bed%' UNION ALL select DISTINCT product,selling_price,'" + jTextField7.getText() + "' as service_type,product_id, department as main_service FROM stockprices WHERE product ILIKE '%" + jTextField11.getText() + "%'"));

                    } else {
                        jSearchTable.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB, "SELECT DISTINCT service_type,anaesthetist_rate as price,'" + jTextField7.getText() + "' as glcode, code, main_service FROM pb_operating_parameters WHERE code ILIKE '%" + jTextField11.getText().toString() + "%' AND service_type ILIKE '%opening%' AND  service_type NOT ILIKE '%bed%' UNION ALL select DISTINCT product,selling_price,'" + jTextField7.getText() + "' as service_type,product_id, department as main_service FROM stockprices WHERE product ILIKE '%" + jTextField11.getText() + "%'"));
                ...
                if (jTextField11.getCaretPosition() < 1) {
                    ...
                    if (jRadioButton1.isSelected()) {
                        jSearchTable.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB, "SELECT DISTINCT service_type,rate as price,'" + jTextField7.getText() + "' as glcode, code, main_service FROM pb_operating_parameters WHERE service_type ILIKE '%" + jTextField11.getText().toString() + "%' AND service_type ILIKE '%opening%' AND service_type NOT ILIKE '%bed%' UNION ALL select product DISTINCT as service_type,selling_price,gl_code, department as main_service FROM stockprices WHERE product ILIKE '%" + jTextField11.getText() + "%'"));

                    } else {
                        jSearchTable.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB, "SELECT DISTINCT service_type,anaesthetist_rate as price,'" + jTextField7.getText() + "' as glcode, code, main_service FROM pb_operating_parameters WHERE service_type ILIKE '%" + jTextField11.getText().toString() + "%' AND service_type ILIKE '%opening%'  AND service_type NOT ILIKE '%bed%' UNION ALL select DISTINCT product as service_type,selling_price,gl_code, department as main_service FROM stockprices WHERE product ILIKE '%" + jTextField11.getText() + "%'"));
            ...
            try {
                ...
                java.sql.ResultSet rsetTable11 = stmtTable11.executeQuery("SELECT pat_nationality AS nationility,category FROM hp_patient_register WHERE patient_no = '" + jTextField9.getText() + "' UNION ALL SELECT nationality,wing FROM hp_admission WHERE visit_id = '" + jTextField16.getText() + "'");
                    ...
                    if (jTextField11.getCaretPosition() < 1) {
                        ...
                        if (jRadioButton1.isSelected()) {
                            if (patNationality.startsWith("NON")) {
                                jSearchTable.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB, "SELECT DISTINCT "
                                        + "service_type,other_prices as price,gl_account as glcode,code,main_service FROM pb_operating_parameters "
                                        + "WHERE code ILIKE '%" + jTextField11.getText().toString() + "%' "
                                        + "AND service_type NOT ILIKE '%bed%' AND service_type ilike '%opening%' "
                                        + "UNION ALL SELECT DISTINCT service_type,other_prices as price,gl_account "
                                        + "AS glcode,code,main_service FROM pb_operating_parameters WHERE code ILIKE '%" + jTextField11.getText().toString() + "%' "
                                        + " AND service_type ILIKE '%bed%' AND service_type ILIKE '%opening%' "
                                        + "AND (main_service ILIKE '%ICU%' OR main_service ILIKE '%I.C.U.%') "
                                        + " UNION ALL select DISTINCT product,selling_price,gl_code as service_type,"
                                        + "product_id, department FROM stockprices WHERE product ILIKE '%" + jTextField11.getText() + "%'  AND product ILIKE '%opening%'  ORDER BY 1"));
                                ...
                                if (patCateg.startsWith("PRI")) {
                                    jSearchTable.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB, "SELECT DISTINCT "
                                            ...
                                            + "WHERE code ILIKE '%" + jTextField11.getText().toString() + "%'  AND service_type ILIKE '%opening%' "
                                            + "AND service_type NOT ILIKE '%bed%'"
                                            + "UNION ALL SELECT DISTINCT service_type,anaesthetist_rate as price,gl_account "
                                            + "AS glcode,code,main_service FROM pb_operating_parameters WHERE code ILIKE '%" + jTextField11.getText().toString() + "%' "
                                            + " AND service_type ILIKE '%bed%' AND service_type ILIKE 'opening'  AND service_type ILIKE '%opening%' "
                                            + "AND (main_service ILIKE '%ICU%' OR main_service ILIKE '%I.C.U.%') "
                                            + " UNION ALL select DISTINCT product,selling_price,gl_code as service_type,"
                                            + "product_id,department FROM stockprices WHERE product ILIKE '%" + jTextField11.getText() + "%'  AND product ILIKE '%opening%' ORDER BY 1"));
                            ...
                            jSearchTable.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB, "SELECT DISTINCT service_type,anaesthetist_rate "
                                    + "AS price,gl_account as glcode,code,main_service FROM pb_operating_parameters WHERE code "
                                    + "ILIKE '%" + jTextField11.getText().toString() + "%'  AND service_type ILIKE '%opening%'  "
                                    + "AND service_type NOT ILIKE '%bed%'"
                                    + "UNION ALL  SELECT DISTINCT service_type,rate as price,gl_account "
                                    + "AS glcode,code,main_service FROM pb_operating_parameters WHERE code ILIKE '%" + jTextField11.getText().toString() + "%' "
                                    + " AND service_type ILIKE '%bed%' AND service_type ILIKE '%opening%' "
                                    ...
                                    + "stockprices WHERE product ILIKE '%" + jTextField11.getText() + "%'  AND product ILIKE '%opening%' ORDER BY 1"));
                    ...
                    if (jTextField11.getCaretPosition() < 1) {
                        ...
                        if (jRadioButton1.isSelected()) {
                            ...
                            if (patNationality.startsWith("NON")) {
                                jSearchTable.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB, "SELECT DISTINCT "
                                        + "service_type,other_prices as price,gl_account as glcode,code,main_service FROM pb_operating_parameters "
                                        + "WHERE service_type ILIKE '%" + jTextField11.getText().toString() + "%' "
                                        + "AND service_type NOT ILIKE '%bed%' AND service_type ILIKE '%opening%' "
                                        + "UNION ALL SELECT DISTINCT service_type,other_prices as price,gl_account "
                                        + "AS glcode,code,main_service FROM pb_operating_parameters WHERE service_type ILIKE '%" + jTextField11.getText().toString() + "%' "
                                        + " AND service_type ILIKE '%bed%' AND service_type ILIKE '%opening%' "
                                        + "AND (main_service ILIKE '%ICU%' OR main_service ILIKE '%I.C.U.%') "
                                ...
                                if (patCateg.startsWith("PRI")) {
                                    jSearchTable.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB, "SELECT DISTINCT "
                                            ...
                                            + "AND (main_service ILIKE '%ICU%' OR main_service ILIKE '%I.C.U.%') "
                                            + " UNION ALL select DISTINCT product AS service_type,selling_price, gl_code as service_type,"
                                            + "product_id,department FROM stockprices WHERE product ILIKE '%" + jTextField11.getText() + "%' AND product ILIKE '%opening%' "
                                            + " ORDER BY 1"));

                                } else {

                                    jSearchTable.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB, "SELECT DISTINCT service_type,rate AS price,"
                                            + "gl_account as glcode, main_service FROM pb_operating_parameters WHERE service_type "
                                            + "ILIKE '%" + jTextField11.getText().toString() + "%'"
                                            + "AND service_type NOT ILIKE '%bed%' AND service_type ILIKE '%opening%' "
                                            ...
                                            + "ILIKE '%" + jTextField11.getText() + "%' AND product ILIKE '%opening%'  ORDER BY 1"));
                                }
                            }
                            ...
                            jSearchTable.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB, "SELECT DISTINCT service_type,anaesthetist_rate"
                                    ...
                                    + "AND (main_service ILIKE '%ICU%' OR main_service ILIKE '%I.C.U.%') "
                                    + "UNION ALL select DISTINCT product as service_type,selling_price,gl_code,department FROM stockprices WHERE product"
                                    + " ILIKE '%" + jTextField11.getText() + "%' AND product ILIKE '%opening%' "));
    ...
    private void jSearchTable2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jSearchTable2MouseClicked
        ...
        try {
            ...
            java.sql.ResultSet rss111 = pss111.executeQuery("select (CURRENT_DATE::date - date_admitted::date),deposit,visit_id FROM hp_admission WHERE patient_no = '" + jTextField9.getText() + "' ORDER BY visit_id DESC LIMIT 1");
            while (rss111.next()) {
                noofDays = rss111.getFloat(1);
                amount = rss111.getFloat(2);
                visitId = rss111.getString(3);
                jTextField16.setText(visitId);
                totalAmt = noofDays * amount;

            }

            java.sql.Statement pss1111 = connectDB.createStatement();
            java.sql.ResultSet rss1111 = pss1111.executeQuery("SELECT SUM(dosage) FROM hp_patient_card WHERE patient_no = '" + jTextField9.getText() + "' AND visit_id = '" + visitId + "' AND service ILIKE '%bed%' AND debit > 0");
            while (rss1111.next()) {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        //}else{
        //     javax.swing.JOptionPane.showMessageDialog(this,"You cannot save a negative or a zero bill".toUpperCase(),"Caution Message",javax.swing.JOptionPane.INFORMATION_MESSAGE);
...
// Add your handling code here:
    ...
    private void jSearchTableKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jSearchTableKeyReleased
        if (jSearchTable.editCellAt(jSearchTable.getSelectedRow(), jSearchTable.getSelectedColumn())) {
        ...
        // TODO add your handling code here:
    }//GEN-LAST:event_jSearchTableKeyReleased
    ...
    private void jTextField23VetoableChange(java.beans.PropertyChangeEvent evt)throws java.beans.PropertyVetoException {//GEN-FIRST:event_jTextField23VetoableChange
        // TODO add your handling code here:
    }//GEN-LAST:event_jTextField23VetoableChange
    ...
    private void jComboBox2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBox2ActionPerformed
        ...
        if (jComboBox2.getSelectedItem().toString() == "Cash") {
            jRadioButton1.setSelected(true);
    ...
    private void saveData() {
        ...
        if (jTextField1.getText().equalsIgnoreCase("")) {
            ...
            try {
                ...
                if (jCheckBox11.isSelected()) {
                    java.sql.Statement stmt1cz3 = connectDB.createStatement();
                    java.sql.ResultSet rset1cz3 = stmt1cz3.executeQuery("SELECT account_no,payer_name,usesmartcard FROM ac_schemes WHERE account_no  = '" + jTextField17.getText() + "'");
                    while (rset1cz3.next()) {
                        smartcard = rset1cz3.getBoolean(3);
                    }
                    if (smartcard) {
                        ...
                        claimInstance.createXMLDoc(jTable1, connectDB);
                    }
                } else {
                    //this for inpatient;
                }
                ...
                if (this.jCheckBox11.isSelected() || jCheckBox6.isSelected()) {
                    ...
                    if (this.jCheckBox21.isSelected()) {
                        ...
                        float amtCharged = java.lang.Float.parseFloat(this.jTextField23.getText());
                        ...
                        java.sql.Statement pss111 = connectDB.createStatement();
                        java.sql.ResultSet rss111 = pss111.executeQuery("select ward,deposit,visit_id FROM hp_admission WHERE patient_no = '" + jTextField9.getText() + "' AND visit_id = '" + jTextField16.getText() + "'");
                        while (rss111.next()) {
                        ...
                        if (this.datePicker1.getDate().before(admDate)) {
                            ...
                            if (!(jTextField4.getText().equals("Cash"))) {
                                ...
                                /*if (amtCharged > 0) {
                                 ...
                                 pstmtf.setString(1, jTextField9.getText());
                                 pstmtf.setObject(2, bedDescr);
                                 pstmtf.setString(3, jTextField2.getText());
                                 pstmtf.setString(4, jComboBox2.getSelectedItem().toString());
                                 pstmtf.setString(5, transNo);
                                 pstmtf.setString(7, scheme);
                                 pstmtf.setString(6, cardNo);
                                 pstmtf.setString(8, cardName);
                                 pstmtf.setString(9, isurer);
                                 pstmtf.setDate(10, null);//java.sql.Date.valueOf(expDate.toString()));
                                 pstmtf.setString(11, "");
                                 pstmtf.setDouble(12, amtCharged);
                                 pstmtf.setDouble(13, 0.00);
                                 pstmtf.setDate(14, com.afrisoftech.lib.SQLDateFormat.getSQLDate(datePicker1.getDate()));
                                 pstmtf.setObject(15, patientAcc);
                                 pstmtf.setString(16, glAcc);
                                 pstmtf.setDouble(17, amtCharged / amtPerDay);
                                 pstmtf.setObject(18, staffNo);
                                 pstmtf.setBoolean(19, false);
                                 pstmtf.setString(20, "Billing");
                                 pstmtf.setBoolean(21, false);
                                 pstmtf.setString(22, AccDesc);
                                 pstmtf.setInt(23, visitid);
                                 pstmtf.setString(24, user);
                                 pstmtf.setString(25, billNo);
                                 pstmtf.setString(26, "IP");
                                 pstmtf.setTimestamp(27, new java.sql.Timestamp(java.util.Calendar.getInstance().getTimeInMillis()));//com.afrisoftech.lib.SQLDateFormat.getSQLDate(java.util.Calendar.getInstance().getTime()));
                                 pstmtf.setInt(28, visitid);
                                 pstmtf.executeUpdate();


                                 java.sql.PreparedStatement pstmt2x = connectDB.prepareStatement("insert into ac_ledger values(?,?,?,?,?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?,?,?,?)");
                                 pstmt2x.setObject(1, revcodes);
                                 pstmt2x.setString(2, glAcc);
                                 pstmt2x.setString(3, jTextField9.getText());
                                 pstmt2x.setString(4, jTextField1.getText());
                                 pstmt2x.setString(5, "");
                                 pstmt2x.setString(6, cardNo);
                                 pstmt2x.setString(7, cardName);
                                 pstmt2x.setString(8, "IP");
                                 pstmt2x.setString(9, jTextField8.getText());
                                 pstmt2x.setString(10, jComboBox2.getSelectedItem().toString());
                                 pstmt2x.setString(11, "");
                                 pstmt2x.setString(12, "");
                                 pstmt2x.setString(13, "");
                                 pstmt2x.setString(14, bedDescr);
                                 pstmt2x.setString(15, "Revenue");
                                 pstmt2x.setDouble(16, 0.00);
                                 pstmt2x.setDouble(17, amtCharged);
                                 pstmt2x.setDate(18, com.afrisoftech.lib.SQLDateFormat.getSQLDate(datePicker1.getDate()));
                ...
                for (int i = 0; i < jTable1.getRowCount(); i++) {
                    if (jTable1.getValueAt(i, 0) != null) {
                        ...
                        java.sql.ResultSet rsBx = pstBx.executeQuery("select count(product) from stockprices where product = '" + jTable1.getValueAt(i, 0) + "' and gl_code =  '" + jTable1.getValueAt(i, 4) + "'");
                        ...
                        if (itemInt > 0) {
                            ...
                            java.sql.ResultSet rsB = pstB.executeQuery("select transfer_price,units,department from stockprices where product = '" + jTable1.getValueAt(i, 0) + "' and gl_code =  '" + jTable1.getValueAt(i, 4) + "'");
                            ...
                            sellPrice = java.lang.Double.parseDouble(jTable1.getValueAt(i, 2).toString());
                            amount = price * qty;
                        ...
                        if (pack > 0) {
                            ...
                            if (this.jCheckBox9.isSelected()) {
                                ...
                                item = jTable1.getValueAt(jTable3.getSelectedRow(), 0).toString();
                                quant = java.lang.Double.valueOf(jTable3.getValueAt(i, 1).toString());
                                pRice = java.lang.Double.valueOf(jTable3.getValueAt(i, 2).toString());
                                tTotal = java.lang.Double.valueOf(jTable3.getValueAt(i, 3).toString());
                                gcode = jTable1.getValueAt(jTable3.getSelectedRow(), 4).toString();


                                java.sql.Statement pstBv = connectDB.createStatement();
                                java.sql.ResultSet rsBv = pstBv.executeQuery("select transfer_price,units,department from stockprices where product = '" + item + "' and gl_code =  '" + gcode + "'");
                            ...
                            javax.swing.JOptionPane.showMessageDialog(this, "You must select APPLY to save package", "Confirmation Message", javax.swing.JOptionPane.INFORMATION_MESSAGE);
