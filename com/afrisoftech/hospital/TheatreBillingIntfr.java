 ...
 * @author  root
 */
public class TheatreBillingIntfr extends javax.swing.JInternalFrame {
    ...
    public TheatreBillingIntfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {
        ...
        try{
            ...
            java.sql.ResultSet rset1xx = st.executeQuery("SELECT DISTINCT current_time::time(0)");
            while (rset1xx.next()) {
                jTextField6.setText(rset1xx.getTime(1).toString());
        ...
        try{
            ...
            java.sql.ResultSet rset1xx = st.executeQuery("SELECT DISTINCT current_time::time(0)");
            while (rset1xx.next()) {
                jTextField20.setText(rset1xx.getTime(1).toString());
        ...
        */
        ...
        java.lang.Object[] strCmb1 = {"Minor Elective Operation","Major Elective Operation","Minor Emergency Operation","Major Emergency Operation"};
        ...
        jTextField25.setPreferredSize(new java.awt.Dimension(0, 0));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 3;
        gridBagConstraints.gridy = 9;
        ...
        jComboBox4.setModel(com.afrisoftech.lib.ComboBoxModel.ComboBoxModel(connectDB, "SELECT '-' UNION ALL select service_type as name from pb_operating_parameters WHERE (main_service ilike '%thea%' or main_service ilike '%surg%')  order by 1"));
        ...
        jComboBox5.setModel(com.afrisoftech.lib.ComboBoxModel.ComboBoxModel(connectDB, "SELECT '-' UNION ALL select service_type as name from pb_operating_parameters WHERE (main_service ilike '%thea%' or main_service ilike '%surg%')  order by 1"));
        ...
        jComboBox1.setModel(com.afrisoftech.lib.ComboBoxModel.ComboBoxModel(connectDB, "SELECT '-' UNION ALL SELECT DISTINCT (upper(f_name||' '||l_name)) as name from secure_menu_access where group_name ILIKE 'nurse%' order by 1"));
        ...
        jComboBox6.setModel(com.afrisoftech.lib.ComboBoxModel.ComboBoxModel(connectDB, "SELECT '-' UNION ALL SELECT DISTINCT (upper(f_name||' '||l_name)) as name from secure_menu_access where group_name ILIKE 'nurse%' order by 1"));
        ...
        jComboBox7.setModel(com.afrisoftech.lib.ComboBoxModel.ComboBoxModel(connectDB, "SELECT '-' UNION ALL SELECT DISTINCT (upper(f_name||' '||l_name)) as name from secure_menu_access where group_name ILIKE 'tech%' order by 1"));
        ...
        jComboBox8.setModel(com.afrisoftech.lib.ComboBoxModel.ComboBoxModel(connectDB, "SELECT '-' UNION ALL SELECT DISTINCT (upper(f_name||' '||l_name)) as name from secure_menu_access where group_name ILIKE 'tech%' order by 1"));
        ...
        jLabel17.setText("Time Commenced");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 0;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        ...
        jLabel26.setText("Time Completed");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 1;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
...
// TODO add your handling code here:
    ...
    private void jTextField112CaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextField112CaretUpdate
        if (jTextField112.getCaretPosition() < 3) {
            ...
            jSearchTable3.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB, "SELECT patient_no, (upper(second_name||' '||first_name||' '||last_name)) as name, (current_date::date-year_of_birth::date)/352, residence from hp_patient_register where patient_no ILIKE '" + jTextField112.getText() + "%' and last_visit > current_date - 5 order by second_name"));
    ...
    private void jTextField11111CaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextField11111CaretUpdate
        if (jTextField11111.getCaretPosition() < 1) {
            ...
            jSearchTable111.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB, "SELECT DISTINCT (upper(f_name||' '||l_name)) as name from secure_menu_access where (upper(f_name||' '||l_name)) ILIKE '" + jTextField11111.getText() + "%' AND group_name ILIKE 'docto%' order by 1"));
    ...
    private void jSearchTable211MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jSearchTable211MouseClicked
        ...
        jTextField15.setText(jSearchTable211.getValueAt(jSearchTable211.getSelectedRow(), 0).toString());
    ...
    private void jTextField11311CaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextField11311CaretUpdate
        if (jTextField11311.getCaretPosition() < 1) {
            ...
            jSearchTable211.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB, "SELECT DISTINCT (upper(f_name||' '||l_name)) as name from secure_menu_access where (upper(f_name||' '||l_name)) ILIKE '%" + jTextField11311.getText() + "%' AND (group_name ilike 'Doct%' OR group_name ILIKE 'clinic%') order by 1"));
    ...
    private void jSearchTable11MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jSearchTable11MouseClicked
         ...
         */
        jTextField14.setText(jSearchTable11.getValueAt(jSearchTable11.getSelectedRow(), 0).toString());
    ...
    private void jTextField1111CaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextField1111CaretUpdate
        if (jTextField1111.getCaretPosition() < 1) {
            ...
            jSearchTable11.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB, "SELECT DISTINCT (upper(f_name||' '||l_name)) as name from secure_menu_access where (upper(f_name||' '||l_name)) ILIKE '%" + jTextField1111.getText() + "%' AND group_name ILIKE 'doctor%' order by 1"));
        ...
        if (this.jCheckBox42.isSelected()) {
            ...
            if (jTextField11.getCaretPosition() < 1) {
                ...
                if (jRadioButton1.isSelected()) {
                    jSearchTable.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB, "select service_type,rate as price,gl_account as glcode FROM pb_operating_parameters WHERE service_type ILIKE '%" + jTextField11.getText() + "%' AND (main_service ILIKE 'surg%' OR main_service ILIKE '%theat%' OR main_service ILIKE '%non%') UNION ALL select product as service_type,selling_price,gl_code FROM st_stock_prices WHERE product ILIKE '%" + jTextField11.getText() + "%' AND department ilike '%theatre%' order by service_type"));
                } else {
                    jSearchTable.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB, "select service_type,anaesthetist_rate as price,gl_account as glcode FROM pb_operating_parameters WHERE service_type ILIKE '%" + jTextField11.getText() + "%'  AND (main_service ILIKE 'surg%' OR main_service ILIKE '%theat%' OR main_service ILIKE '%non%') UNION ALL select product as service_type,selling_price,gl_code FROM st_stock_prices WHERE product ILIKE '%" + jTextField11.getText() + "%' AND department ilike '%theatre%' order by service_type"));
            ...
            if (jTextField11.getCaretPosition() < 1) {
                ...
                if (jRadioButton1.isSelected()) {
                    ...
                    jSearchTable.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB, "select service_type,anaesthetist_rate as price,gl_account as glcode FROM pb_operating_parameters WHERE service_type ILIKE '%" + jTextField11.getText() + "%' (main_service ILIKE 'surg%' OR main_service ILIKE '%theat%' OR main_service ILIKE '%non%') UNION ALL select product as service_type,selling_price,gl_code FROM st_stock_prices WHERE product ILIKE '%" + jTextField11.getText() + "%' AND department ilike '%theatre%' order by service_type"));
    ...
    private void jSearchTable2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jSearchTable2MouseClicked
        ...
        if (this.jCheckBox11.isSelected()) {
            try {
                ...
                java.sql.Statement stmt1 = connectDB.createStatement();
                java.sql.ResultSet rset1 = stmt1.executeQuery("select category,pay_mode,(current_date::date-year_of_birth::date)/352,sex from hp_patient_register where patient_no  ='" + jTextField9.getText() + "'");
                while (rset1.next()) {
                    jTextField2.setText(rset1.getObject(1).toString());
                    jTextField7.setText(rset1.getObject(2).toString());
            ...
            if (this.jCheckBox21.isSelected()) {
                ...
                if (bal > (limit + rect)) {
                    ...
                    try {
                        ...
                        java.sql.ResultSet rset1 = stmt1.executeQuery("select category,pay_mode,(current_date::date-year_of_birth::date)/352,sex from hp_inpatient_register where patient_no  ='" + jTextField9.getText() + "'");
                        while (rset1.next()) {
                            jTextField2.setText(rset1.getObject(1).toString());
                            jTextField7.setText(rset1.getObject(2).toString());
                            jTextField10.setText(rset1.getObject(3).toString());
    ...
    private void jTextField113CaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextField113CaretUpdate
        if (this.jCheckBox11.isSelected() && this.jCheckBox3.isSelected()) {
            ...
            if (jTextField113.getCaretPosition() < 1) {
                ...
                jSearchTable2.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB, "SELECT patient_no, name, (current_date::date-year_of_birth::date)/352, residence from patient_select where patient_no ILIKE '%" + jTextField113.getText() + "%' order by patient_no"));
            ...
            if (this.jCheckBox11.isSelected() && this.jCheckBox4.isSelected()) {
                if (jTextField113.getCaretPosition() < 1) {
                    ...
                    jSearchTable2.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB, "SELECT patient_no, name, (current_date::date-year_of_birth::date)/352, residence from patient_select where name ILIKE '%" + jTextField113.getText() + "%' order by name"));
        ...
        if (datePicker1.getDate().before(periodFrom) || datePicker1.getDate().after(periodTo)) {
            ...
            if (jTextField1.getText().equalsIgnoreCase("")) {
                ...
                try {
                    ...
                    java.sql.ResultSet rstt = pst.executeQuery("select code,activity from pb_activity where activity_category ='I' AND (ACTIVITY ILIKE '%THEAT%' OR ACTIVITY ILIKE '%surge%')");
                    ...
                    if (this.jCheckBox11.isSelected() || jCheckBox6.isSelected()) {
                        ...
                        pstmt2at1.setDouble(7, 0.00);
                        pstmt2at1.setDouble(8, Double.parseDouble(jTextField17.getText()));
                        pstmt2at1.setString(9, jTextField14.getText());
                        pstmt2at1.setDouble(10, 0);
                        ...
                        pstmt2at1.setTime(29, java.sql.Time.valueOf(jTextField6.getText()));
                        pstmt2at1.setTime(30, java.sql.Time.valueOf(jTextField20.getText()));
                        ...
                        pstmt2c.setString(5, "Theatre Time Per Minute");
                        pstmt2c.setDouble(6, 1.00);
                        ...
                        pstmtr.setObject(2, "Theatre Time Per Minute");
                        ...
                        pstmt22v.setString(12, "");
                        pstmt22v.setString(13, "");
                        pstmt22v.setString(14, "Use Of Theatre Per Minute");
                        ...
                        for (int i = 0; i < jTable1.getRowCount(); i++) {
                            if (jTable1.getValueAt(i, 0) != null) {
                                ...
                                pstmt2at.setString(5, "Theatre");
                                pstmt2at.setString(6, jTable1.getValueAt(i, 0).toString());
                                pstmt2at.setDouble(7, Double.parseDouble(jTable1.getValueAt(i, 1).toString()));
                                pstmt2at.setDouble(8, Double.parseDouble(jTable1.getValueAt(i, 3).toString()));
                                pstmt2at.setString(9, jTextField14.getText());
                                pstmt2at.setDouble(10, 0);
                                ...
                                pstmt2at.setTime(29, java.sql.Time.valueOf(jTextField6.getText()));
                                pstmt2at.setTime(30, java.sql.Time.valueOf(jTextField20.getText()));
