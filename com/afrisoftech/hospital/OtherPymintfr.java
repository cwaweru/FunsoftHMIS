...
public class OtherPymintfr extends javax.swing.JInternalFrame {
    ...
    public OtherPymintfr(Connection connDb, PooledConnectionSource pconnDB) {
        ...
        jTextField14.setText(getShiftNumber()); //To change body of generated methods, choose Tools | Templates.
    }
   /* public void OtherPymintfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    */
    ...
    private void initComponents() {
        ...
        */
        ...
        jButton1.setText("Make Payment & Print");
        ...
        jButton12.setText("Make Payment");
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
      ...
      /////getting the GLCODE
      jTable1.getModel().setValueAt(jTextField11.getText(),jTable1.getSelectedRow(),7);
            }
            
        }else{
            if (Boolean.valueOf(jTable1.getModel().getValueAt(jTable1.getSelectedRow(), 5).toString()) == java.lang.Boolean.FALSE) {
                jTable1.getModel().setValueAt("",jTable1.getSelectedRow(),7);
                if (jTable1.getValueAt(jTable1.getSelectedRow(), 5) != null) {
    ...
    private void jButton12ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton12ActionPerformed
        ...
        try {
            ...
            java.sql.ResultSet rsetf = stmtf.executeQuery("SELECT period_from,period_to FROM period_setup WHERE period_status ilike 'Open' AND '"+datePicker12.getDate()+"' BETWEEN period_from AND period_to");
            while (rsetf.next()){
                    ...
                    try {
                        ...
                        if(jComboBox1.getSelectedItem().toString().equalsIgnoreCase("Cash")){
                            for (int x = 0; x < jTable1.getRowCount(); x++){
                                if (jTable1.getModel().getValueAt(x,5) != null){
                                    
                                    if(java.lang.Double.parseDouble(jTable1.getValueAt(x,4).toString()) > 0){
                                        ...
                                        pstmt1.setObject(4,jTable1.getValueAt(x,1).toString());
                                        pstmt1.setDouble(5,0.00);
                                        pstmt1.setDouble(6,java.lang.Double.valueOf(jTable1.getValueAt(x,4).toString()));
                                        pstmt1.setDate(7,com.afrisoftech.lib.SQLDateFormat.getSQLDate(datePicker12.getDate()));
                                        pstmt1.setString(8,user);
                                        pstmt1.setBoolean(9,true);
                                        pstmt1.setString(10,vouchNo);
                                        pstmt1.setDate(11,com.afrisoftech.lib.SQLDateFormat.getSQLDate(datePicker12.getDate()));
                                        pstmt1.setBoolean(12,true);
                                        pstmt1.setString(13,"Accounts");
                                        pstmt1.setString(14,jTextField9.getText());
                                        pstmt1.setObject(15,jTable1.getValueAt(x,1).toString());
                                        pstmt1.setObject(16,jTable1.getValueAt(x,4).toString());
                                        ...
                                        pstmt1.setObject(21,jTable1.getValueAt(x,7).toString());
                            ...
                            for (int x = 0; x < jTable1.getRowCount(); x++){
                                if (jTable1.getModel().getValueAt(x,5) != null){
                                    ...
                                    if(java.lang.Double.parseDouble(jTable1.getValueAt(x,4).toString()) > 0){
                                        ...
                                        pstmt.setObject(1,jTable1.getValueAt(x,7).toString());
                                        pstmt.setString(4,vouchNo);
                                        pstmt.setObject(3,jTextField31.getText());
                                        pstmt.setString(2,jTextField9.getText());
                                        pstmt.setString(5,jTextField9.getText());
                                        ...
                                        pstmt.setString(11,transNo);
                                        pstmt.setString(12,"Payment");
                                        pstmt.setDouble(13,java.lang.Double.valueOf(jTable1.getValueAt(x,4).toString()));
                                        pstmt.setDouble(14,0.00);
                                        pstmt.setDate(15,com.afrisoftech.lib.SQLDateFormat.getSQLDate(datePicker12.getDate()));
                                        pstmt.setObject(16,jTable1.getValueAt(x,0).toString());
                                        pstmt.setString(17,jTextField8.getText());
                                        pstmt.setBoolean(18,false);
                                        pstmt.setBoolean(19,false);
                                        pstmt.setString(20,user);
                        ...
                        for (int i = 0; i < jTable1.getRowCount(); i++){
                            if (jTable1.getModel().getValueAt(i,5) != null){
                                ...
                                if(java.lang.Double.parseDouble(jTable1.getValueAt(i,4).toString()) > 0){
                                    ...
                                    pstmtq.setInt(7,Integer.parseInt(jTextField92.getText()));
                            ...
                            if (jTable1.getModel().getValueAt(i,5) != null){
                                if(java.lang.Double.parseDouble(jTable1.getValueAt(i,6).toString()) > 0){
                                    ...
                                    pstmtd.setObject(1,jTable1.getValueAt(i,7).toString());
                                    pstmtd.setString(4,"");
    ...
    private void jSearchTable2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jSearchTable2MouseClicked
        ...
        if(this.jCheckBox4.isSelected()){
            ...
            try {
                java.sql.Statement stmt = connectDB.createStatement();
                java.sql.ResultSet rset = stmt.executeQuery("select activity_code,sum(credit),item,description from ac_payroll_ledger where dealer ='"+this.jTextField9.getText()+"' AND approved = true and paid =false GROUP BY activity_code,item,description");
                while (rset.next()){
            ...
            try {
                java.sql.Statement stmt = connectDB.createStatement();
                java.sql.ResultSet rset = stmt.executeQuery("select activity_code,sum(credit),item,description from ac_accounts_payable where dealer ='"+this.jTextField9.getText()+"' AND approved = true and paid =false GROUP BY activity_code,item,description");
                while (rset.next()){
                    jTextField7.setText(rset.getObject(1).toString());
                    // jTextField3.setText(rset.getObject(2).toString());
                    jTextField31.setText(rset.getObject(3).toString());
    ...
    private void populateTable11(java.lang.String patient_name) {
        ...
        try {
            ...
            if (j > 0) {
                ...
                java.sql.ResultSet rsetTable11 = stmtTable11.executeQuery("SELECT invoice_no, sum(credit),sum(balance),0.00,sum(vat_balance),activity_code,reason FROM ac_accounts_payable WHERE dealer = '"+patient_name+"' AND approved = true and balance >0 GROUP BY invoice_no,activity_code,reason");
