...
public class FoodSchedulePdf implements java.lang.Runnable {
    ...
    public void FoodSchedulePdf(java.sql.Connection connDb) {
    ...
    public void run() {
        ...
        while (threadCheck) {
            ...
            try {
                ...
                Logger.getLogger(FoodSchedulePdf.class.getName()).log(Level.SEVERE, null, ex);
            }
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    phrase = new Phrase("Food Shedule " , pFontHeader3);
                    
                    table.addCell(phrase);
                    
                   
                   java.sql.Statement st54 = connectDB.createStatement();
                   java.sql.ResultSet rset2 = st54.executeQuery("SELECT  value FROM catering.\"Application_Details\" ad INNER JOIN catering.\"Application\" a ON a.id = ad.application_id WHERE interface_item_id IN ( 5) AND (a.interface_id = 3 OR a.id IN (SELECT a.id FROM catering.\"Application\" a INNER JOIN catering.\"Process\" p ON a.interface_id = p.previous_interface AND p.interface_id = 3) OR a.id IN (SELECT application_id FROM catering.\"Authorization\" a INNER JOIN catering.\"Process\" p ON a.interface_id = p.previous_interface AND p.interface_id = 3)) AND a.id NOT IN (SELECT application_id FROM catering.\"Authorization\" a WHERE interface_id = 3) ORDER BY a.id, interface_item_id");
                   String kitchenName;   
                   while(rset2.next()){
                        kitchenName = rset2.getObject(1).toString();
                        phrase = new Phrase(kitchenName , pFontHeader);
                    ...
                    phrase = new Phrase("Kitchen Name",pFontHeader1);
                    table.addCell(phrase);
                    
                    phrase = new Phrase("Month",pFontHeader1);
                    table.addCell(phrase);
                    
                    phrase = new Phrase("Day",pFontHeader1);
                    table.addCell(phrase);
                    
                    phrase = new Phrase("Item Name",pFontHeader1);
                    table.addCell(phrase);
                    
                    phrase = new Phrase("Quantity",pFontHeader1);
                    table.addCell(phrase);
                    
                    phrase = new Phrase("Units of Measure",pFontHeader1);
                    table.addCell(phrase);
                    ...
                    try{
                        ...
                        java.sql.ResultSet rset = st2.executeQuery("SELECT  value FROM catering.\"Application_Details\" ad INNER JOIN catering.\"Application\" a ON a.id = ad.application_id WHERE interface_item_id IN ( 5, 6, 7, 46, 47, 66) AND (a.interface_id = 3 OR a.id IN (SELECT a.id FROM catering.\"Application\" a INNER JOIN catering.\"Process\" p ON a.interface_id = p.previous_interface AND p.interface_id = 3) OR a.id IN (SELECT application_id FROM catering.\"Authorization\" a INNER JOIN catering.\"Process\" p ON a.interface_id = p.previous_interface AND p.interface_id = 3)) AND a.id NOT IN (SELECT application_id FROM catering.\"Authorization\" a WHERE interface_id = 3) ORDER BY a.id, interface_item_id");
