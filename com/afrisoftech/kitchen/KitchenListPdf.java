...
public class KitchenListPdf implements java.lang.Runnable {
    ...
    public void KitchenListPdf(java.sql.Connection connDb) {
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    phrase = new Phrase("Kitchen " , pFontHeader3);
                    ...
                    phrase = new Phrase("Kitchen No.",pFontHeader1);
                    table.addCell(phrase);
                    ...
                    try{
                        ...
                        java.sql.ResultSet rset = st2.executeQuery("SELECT ad.id, interface_item_id, application_id, value FROM catering.\"Application_Details\" ad INNER JOIN catering.\"Application\" a ON a.id = ad.application_id WHERE interface_item_id IN ( 2, 3, 4) AND (a.interface_id = 2 OR a.id IN (SELECT a.id FROM catering.\"Application\" a INNER JOIN catering.\"Process\" p ON a.interface_id = p.previous_interface AND p.interface_id = 2) OR a.id IN (SELECT application_id FROM catering.\"Authorization\" a INNER JOIN catering.\"Process\" p ON a.interface_id = p.previous_interface AND p.interface_id = 2)) AND a.id NOT IN (SELECT application_id FROM catering.\"Authorization\" a WHERE interface_id = 2) ORDER BY a.id, interface_item_id");
