...
public class HosCreditorsVouchPanel extends javax.swing.JDialog {
    ...
    private void jTextField1111CaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextField1111CaretUpdate
        jSearchTable1.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"select (voucher_no) as scheme from ac_cash_book where voucher_no ILIKE '"+jTextField1111.getText().toString()+"%' and transaction_type ='Payment' ORDER BY voucher_no"));
        jSearchTable1.setShowHorizontalLines(false);
        jSearchScrollPane1.setViewportView(jSearchTable1);
   ...
   //     switch (reportName) {
        ...
        switch (reportName) {
                ...
                
            {
                ...
                policy.DocVoucherPdf(connectDB,jTextField36.getText(), printState);
                ...
                
            {
                ...
                policy.VoucherPdf(connectDB,jTextField36.getText(), printState);
                ...
                
            {
                ...
                policy.OtherPayVoucherPdf(connectDB,jTextField36.getText(),printState);
