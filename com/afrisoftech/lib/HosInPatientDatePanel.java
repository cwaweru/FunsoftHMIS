        ...
        if (this.jTextField1111.getCaretPosition() < 5) {
            ...
            if (this.jCheckBox1.isSelected()) {
                if (reportName == 201 || reportName == 202 || reportName == 203) {
                    ...
                    jSearchTable1.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectorsCaret(connectDB, "SELECT trim(patient_no) as patient_no,patient_name as name,date_admitted as adm_date,visit_id, sub_chief as unit_no from hp_admission where patient_no ILIKE '%" + jTextField1111.getText().toString() + "%' or sub_chief ilike '%" + jTextField1111.getText().toString() + "%'  AND check_out = false "
                ...
                if (reportName == 201 || reportName == 202 || reportName == 203) {
                    ...
                    jSearchTable1.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectorsCaret(connectDB, "SELECT DISTINCT trim(patient_no) as patient_no,patient_name as name,date_admitted as adm_date,visit_id, sub_chief as unit_no from hp_admission where patient_name ILIKE '%" + jTextField1111.getText().toString() + "%' AND check_out = false "
