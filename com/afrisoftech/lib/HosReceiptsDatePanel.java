...
public class HosReceiptsDatePanel extends javax.swing.JDialog {
    ...
    private void jTextField1111CaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextField1111CaretUpdate
        jSearchTable1.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"select distinct (trim(receipt_no)) as receipt_no,date from ac_cash_collection where receipt_no ILIKE '"+jTextField1111.getText().toString()+"%' AND receipt_no is not null AND receipt_no !='' AND receipt_no != '-' ORDER BY receipt_no ORDER BY receipt_no"));
