 ...
 * @author  root
 */
public class OrderSummaryPerTender extends javax.swing.JDialog {
    ...
    public OrderSummaryPerTender(java.awt.Frame parent, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB, boolean modal, int repName, java.sql.Connection connectDb) {
    ...
    private void initComponents() {
        ...
        */
        ...
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
        jPanel42.add(orderNotxt, gridBagConstraints);
        ...
        supplierTxt.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                supplierTxtMouseClicked(evt);
            }
        });
        ...
        gridBagConstraints.weighty = 1.0;
        gridBagConstraints.insets = new java.awt.Insets(0, 0, 0, 10);
        jPanel4.add(supplierTxt, gridBagConstraints);

        schedulesbtngrp.add(jCheckBox1);
        jCheckBox1.setText("Orders Per Tender");
        ...
        jCheckBox2.setText("Orders Per Bidders");
...
//        }
    ...
    private void jSearchTable4MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jSearchTable4MouseClicked
        ...
        bidderSearchTable.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB, "SELECT distinct order_no from st_orders where quotation_no='"+tenderNotxt.getText()+"' and unit_price>0 and order_no is not null"));
    ...
    private void supplierTxtMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_supplierTxtMouseClicked
        // TODO add your handling code here:
        java.awt.Point p = supplierTxt.getLocationOnScreen();
        
        jPopupMenu1.setVisible(true);
         
         jPopupMenu1.setLocation(p);
    }//GEN-LAST:event_supplierTxtMouseClicked

    private void whatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_whatActionPerformed
        // TODO add your handling code here:
        jPopupMenu1.setVisible(false);
        if(supplierTxt.getText().length()>0)  {
        ShowTenderedItemsDialog sht = new ShowTenderedItemsDialog(null,true,connectDB,orderNotxt.getText());
    ...
    public void getReport(int reportName) {
        ...
        switch (reportName) {
            ...
            {
                com.afrisoftech.hospinventory.TenderSummaryReportPDF policy = new com.afrisoftech.hospinventory.TenderSummaryReportPDF();
                
                policy.TenderSummaryReportPDF(connectDB, tenderNotxt.getText());
            ...
            {
                            com.afrisoftech.hospinventory.mtrhreports.LpoKnhPdf policys = new com.afrisoftech.hospinventory.mtrhreports.LpoKnhPdf();

                            policys.LpoKnhPdf(connectDB,supplierTxt.getText(),orderNotxt.getText(),tenderNotxt.getText().toString());
