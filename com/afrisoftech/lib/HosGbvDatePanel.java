 ...
 * @author  root
 */
public class HosGbvDatePanel extends javax.swing.JDialog {
  ...
  //  javax.swing.JSpinner beginDateSpinner = null;
   ...
   // javax.swing.JSpinner endDateSpinner = null;
    ...
    public HosGbvDatePanel(java.awt.Frame parent, boolean modal, int repName, java.sql.Connection connectDb) {
    ...
    private void initComponents() {
        ...
        setBounds((screenSize.width-490)/2, (screenSize.height-271)/2, 490, 271);
    ...
    public void getReport(int reportName) {
        ...
        switch (reportName) {
            ...
            {
                com.afrisoftech.gbv.GbvMonthlyReportPdf policy = new com.afrisoftech.gbv.GbvMonthlyReportPdf();
                
                policy.GbvMonthlyReportPdf(connectDB, this.datePicker1.getDate(), this.datePicker2.getDate());
            ...
            {
                com.afrisoftech.gbv.GbvSurvivorProfilePdf policy = new com.afrisoftech.gbv.GbvSurvivorProfilePdf();

                policy.GbvSurvivorProfilePdf(connectDB, this.datePicker1.getDate(), this.datePicker2.getDate());
            ...
            {
                com.afrisoftech.gbv.PepetratorProfilePdf policy = new com.afrisoftech.gbv.PepetratorProfilePdf();

                policy.PepetratorProfilePdf(connectDB, this.datePicker1.getDate(), this.datePicker2.getDate());
