...
public class HosDispartchDatePanel extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        perpayerrbtn = new javax.swing.JRadioButton();
        perSchemerbtn = new javax.swing.JRadioButton();
        ...
        */
        ...
        setTitle("Generate Dispatch Schedule Report");
        setResizable(false);
        ...
        jButton1.setText("Generate detailed dispatch report");
        ...
        jPanel4.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Select Dispatch No. here", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(0, 0, 255))); // NOI18N
        ...
        dispatchNotxt.setEditable(false);
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 1;
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
        jPanel6.add(dispatchNotxt, gridBagConstraints);
        ...
        jPanel4.add(accNotxt, gridBagConstraints);

        buttonGroup1.add(perpayerrbtn);
        perpayerrbtn.setText("Dispatch Per Payer");
        perpayerrbtn.setHorizontalAlignment(javax.swing.SwingConstants.TRAILING);
        perpayerrbtn.setHorizontalTextPosition(javax.swing.SwingConstants.LEADING);
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
        jPanel4.add(perpayerrbtn, gridBagConstraints);

        buttonGroup1.add(perSchemerbtn);
        perSchemerbtn.setSelected(true);
        perSchemerbtn.setText("Dispatch Per Scheme");
        perSchemerbtn.setHorizontalTextPosition(javax.swing.SwingConstants.LEADING);
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
        jPanel4.add(perSchemerbtn, gridBagConstraints);
        ...
        setSize(new java.awt.Dimension(430, 264));
    ...
    private void jSearchTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jSearchTable1MouseClicked
        dispatchNotxt.setText(jSearchTable1.getValueAt(jSearchTable1.getSelectedRow(), 0).toString());
        accNotxt.setText(jSearchTable1.getValueAt(jSearchTable1.getSelectedRow(), 1).toString());
    ...
    private void jTextField1111CaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextField1111CaretUpdate
      jSearchTable1.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"select distinct(dispatch_no) as scheme,account_no,payee from ac_debtors where dispatch_no ILIKE '"+jTextField1111.getText().toString()+"%' ORDER BY dispatch_no"));
    ...
    private void searchButton11Clicked() {
        ...
        java.awt.Point point = this.dispatchNotxt.getLocationOnScreen();
    ...
    public void getReport(int reportName) {
        ...
        switch (reportName) {
            ...
            {
                if(perSchemerbtn.isSelected()){
                    com.afrisoftech.reports.DispatchSchPdf policy = new com.afrisoftech.reports.DispatchSchPdf();
                    
                    policy.DispatchSchPdf(connectDB, dispatchNotxt.getText(),this.accNotxt.getText());
                    
                }
                else{
                   if(perpayerrbtn.isSelected()){
                     com.afrisoftech.reports.DispatchPerPayerPdf policy = new com.afrisoftech.reports.DispatchPerPayerPdf();
                    
                     policy.DispatchPerPayerPdf(connectDB, dispatchNotxt.getText(),this.accNotxt.getText());
                    }
                }
                ...
                
            {
                ...
                policy.NHIFDispPdf(connectDB, dispatchNotxt.getText(),this.accNotxt.getText());
    ...
    private javax.swing.JRadioButton perSchemerbtn;
    private javax.swing.JRadioButton perpayerrbtn;
