...
public class HosProjectedConPanel extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        setBounds((screenSize.width-358)/2, (screenSize.height-207)/2, 358, 207);
  ...
  */
  ...
  
            {
                ...
                policy.ItemsAvgConsPdf(connectDB, this.jTextField2.getText(), this.jTextField3.getText(),jComboBox1.getSelectedItem().toString());
            ...
            {
                com.afrisoftech.hospinventory.DormantDrugsPdf policy = new com.afrisoftech.hospinventory.DormantDrugsPdf();
  
                policy.DormantDrugsPdf(connectDB, this.jTextField2.getText(), this.jTextField3.getText(),jComboBox1.getSelectedItem().toString());
