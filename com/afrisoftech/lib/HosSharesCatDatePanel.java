 ...
 * @author  root
 */
public class HosSharesCatDatePanel extends javax.swing.JDialog {
    ...
    public HosSharesCatDatePanel(java.awt.Frame parent, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB, boolean modal, int repName, java.sql.Connection connectDb) {
   ...
   // public void getReport(int reportName) {
      public void getReport(int reportName, boolean printState) {
        ...
        switch (reportName) {
            ...
            {
                com.afrisoftech.reports.ShareByCatPdf policy = new com.afrisoftech.reports.ShareByCatPdf();
                
                policy.ShareByCatPdf(connectDB, this.datePicker1.getDate(), this.datePicker2.getDate(),jComboBox11.getSelectedItem().toString());
