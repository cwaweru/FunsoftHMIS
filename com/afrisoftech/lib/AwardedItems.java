 ...
 * @author  root
 */
public class AwardedItems extends javax.swing.JDialog {
    ...
    public AwardedItems(java.awt.Frame parent, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB, boolean modal, int repName, java.sql.Connection connectDb) {
    ...
    public void getReport(int reportName) {
        ...
        switch (reportName) {
            ...
            {
                com.afrisoftech.hospinventory.TenderQuantitiesPDF policy = new com.afrisoftech.hospinventory.TenderQuantitiesPDF();
                
                policy.QuantitiesPerTender(connectDB, tenderNotxt.getText());
