 ...
 * @author root
 */
public class HosInspectionPanel extends javax.swing.JDialog {
     ...
     */
    public HosInspectionPanel(java.awt.Frame parent, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB, boolean modal, int repName, java.sql.Connection connectDb) {
    ...
    private void initComponents() {
        ...
        */
        ...
        jPanel4.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Select Letter No. here", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, null, new java.awt.Color(0, 0, 255)));
        ...
        jLabel3.setText("Certificate No.");
        gridBagConstraints = new java.awt.GridBagConstraints();
        ...
        setBounds((screenSize.width-544)/2, (screenSize.height-230)/2, 544, 230);
    ...
    private void jSearchTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jSearchTable1MouseClicked
        ...
        jTextField1.setText(jSearchTable1.getValueAt(jSearchTable1.getSelectedRow(), 2).toString());
        jTextField5.setText(jSearchTable1.getValueAt(jSearchTable1.getSelectedRow(), 1).toString());
        jTextField3.setText(jSearchTable1.getValueAt(jSearchTable1.getSelectedRow(), 3).toString());
        jTextField4.setText(jSearchTable1.getValueAt(jSearchTable1.getSelectedRow(), 4).toString());
        jSearchDialog1.dispose();        // Add your handling code here:
    }//GEN-LAST:event_jSearchTable1MouseClicked

    private void jTextField1111CaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextField1111CaretUpdate
        jSearchTable1.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB, "SELECT DISTINCT(lpo) AS Order,quotation_no,supplier,cert_no,dr_no "
                + "FROM st_certificate WHERE lpo ILIKE '" + jTextField1111.getText().toString() + "%' ORDER BY lpo"));
    ...
    public void getReport(int reportName) {
        ...
        switch (reportName) {
            ...
            case 5278: {
                ...
                policy.ComplianceCertificatePdf(connectDB, this.jTextField4.getText().toString(), jTextField36.getText().toString());
            }
            break;
