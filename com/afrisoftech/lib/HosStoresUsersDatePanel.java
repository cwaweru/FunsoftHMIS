...
public class HosStoresUsersDatePanel extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jPanel4.setBorder(javax.swing.BorderFactory.createTitledBorder("Select User here"));
        ...
        jComboBox11.setModel(com.afrisoftech.lib.ComboBoxModel.ComboBoxModel(connectDB, "select DISTINCT user_name from st_sub_stores order by user_name"));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 1;
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
...
this.dispose();            // Add your handling code here:
    ...
    public void getReport(int reportName) {
        ...
        switch (reportName) {
            ...
            {
                com.afrisoftech.reports.PatientsAttSheetPerUserPdf policy = new com.afrisoftech.reports.PatientsAttSheetPerUserPdf();

                policy.PatientsAttSheetPerUserPdf(connectDB, this.datePicker1.getDate(), this.datePicker2.getDate(),jComboBox11.getSelectedItem().toString());
