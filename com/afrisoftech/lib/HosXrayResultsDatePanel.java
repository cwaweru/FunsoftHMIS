 ...
 * @author  root
 */
public class HosXrayResultsDatePanel extends javax.swing.JDialog {
    ...
    public HosXrayResultsDatePanel(java.awt.Frame parent, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB, boolean modal, int repName, java.sql.Connection connectDb) {
    ...
    private void initComponents() {
        ...
        */
        ...
        setBounds((screenSize.width-434)/2, (screenSize.height-243)/2, 434, 243);
    ...
    private void jTextField1111CaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextField1111CaretUpdate
        if(this.jTextField1111.getCaretPosition() < 2){
            ...
            if(this.jCheckBox1.isSelected()){
                jSearchTable1.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"SELECT DISTINCT trim(patient_no) as scheme,patient_name as name FROM"
                        + " hp_xray_results WHERE patient_no ILIKE '"+jTextField1111.getText().toString()+"%' ORDER BY 1"));
        ...
        */
              ...
              */
                ...
                jSearchTable1.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"SELECT DISTINCT trim(patient_no) as scheme,patient_name as name FROM"
                        + " hp_xray_results WHERE patient_name ILIKE '"+jTextField1111.getText().toString()+"%' ORDER BY 1"));
