...
public class HosDiagDatePanel extends javax.swing.JDialog {
    ...
    public HosDiagDatePanel(java.awt.Frame parent, boolean modal, int repName, java.sql.Connection connectDb) {
    ...
    private void initComponents() {
        ...
        jRadioButton1.setText("Morbidity");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        ...
        jRadioButton2.setText("Mortality");
        ...
        setBounds((screenSize.width-467)/2, (screenSize.height-297)/2, 467, 297);
        ...
        switch (reportName) {
            ...
            case 157:
...

                 {
                    ...
                    policy.DiagnosisSumPdf(connectDB, this.datePicker1.getDate(), this.datePicker2.getDate(), Categ, ReportType);
            ...
            case 585694:
                 ...
                 {
                    com.afrisoftech.records.reports.DiagnosisSumPerSexPdf policy = new com.afrisoftech.records.reports.DiagnosisSumPerSexPdf();

                    policy.DiagnosisSumPerSexPdf(connectDB, this.datePicker1.getDate(), this.datePicker2.getDate(), Categ, ReportType);
