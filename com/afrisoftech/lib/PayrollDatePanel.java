...
public class PayrollDatePanel extends javax.swing.JDialog {
    ...
    public PayrollDatePanel(java.awt.Frame parent, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB, boolean modal, int repName, java.sql.Connection connectDb) {
    ...
    public void getReport(int reportName) {
        ...
        switch (reportName) {
                            ...
                            
            {
                ...
                policy.ProcessPayrollPdf(connectDB, this.datePicker1.getDate(), this.datePicker2.getDate(),jComboBox1.getSelectedItem().toString());
                            ...
                            
            {
                ...
                policy.DeductionsPdf(connectDB, this.datePicker1.getDate().toLocaleString(), this.datePicker2.getDate().toLocaleString(),jComboBox1.getSelectedItem().toString());
           ...
           case 3:
                            ...
                            
            {
                ...
                policy.PayeListPdf(connectDB, this.datePicker1.getDate().toLocaleString(), this.datePicker2.getDate().toLocaleString(),jComboBox1.getSelectedItem().toString());
           ...
           case 5:
                            
            {
                ...
                policy.CashPaymentsPdf(connectDB, this.datePicker1.getDate().toLocaleString(), this.datePicker2.getDate().toLocaleString(),jComboBox1.getSelectedItem().toString());
           ...
           case 7:
                            
            {
                ...
                policy.NetSalaryPdf(connectDB, this.datePicker1.getDate().toLocaleString(), this.datePicker2.getDate().toLocaleString(),jComboBox1.getSelectedItem().toString());
        ...
        case 9: 
                            
            {
                ...
                policy.PayMasterPdf(connectDB, this.datePicker1.getDate().toLocaleString(), this.datePicker2.getDate().toLocaleString(),jComboBox1.getSelectedItem().toString());
                            ...
                            
            {
                ...
                policy.StaffEarningsPdf(connectDB, this.datePicker1.getDate().toLocaleString(), this.datePicker2.getDate().toLocaleString(),jComboBox1.getSelectedItem().toString());
