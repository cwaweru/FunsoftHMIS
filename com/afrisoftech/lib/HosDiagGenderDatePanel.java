 ...
 * @author  root
 */
public class HosDiagGenderDatePanel extends javax.swing.JDialog {
    ...
    public HosDiagGenderDatePanel(java.awt.Frame parent, boolean modal, int repName, java.sql.Connection connectDb) {
    ...
    private void initComponents() {
        ...
        setBounds((screenSize.width-489)/2, (screenSize.height-331)/2, 489, 331);
    ...
    public void getReport(int reportName) {
        ...
        if (this.jComboBox1.getSelectedItem().toString().equalsIgnoreCase("Male")) {
            ReportType = "Male";
        } else {
            ReportType = "Female";
        }
        ...
        switch (reportName) {
            ...
            case 5856981:
                 ...
                 {
                    com.afrisoftech.records.reports.DiagnosisPerAgeSexPdf policy = new com.afrisoftech.records.reports.DiagnosisPerAgeSexPdf();

                    policy.DiagnosisPerAgeSexPdf(connectDB, this.datePicker1.getDate(), this.datePicker2.getDate(), ReportType,  Categ);
