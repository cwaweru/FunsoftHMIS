 ...
 * @author  root
 */
public class HosSharesDatePanel extends javax.swing.JDialog {
    ...
    public HosSharesDatePanel(java.awt.Frame parent, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB, boolean modal, int repName, java.sql.Connection connectDb) {
    ...
    private void initComponents() {
        ...
        */
        ...
        jPanel4.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Select Share here", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Dialog", 0, 11), new java.awt.Color(153, 0, 153)));
        ...
        setBounds((screenSize.width-410)/2, (screenSize.height-240)/2, 410, 240);
...
if(this.jTextField1111.getCaretPosition() < 2){
        ...
        if(this.jCheckBox1.isSelected()){
        try {
                    searchRowSet1.execute("select holders_name as scheme,acc_no from pb_share_register where acc_no ILIKE '"+jTextField1111.getText().toString()+"%' ORDER BY holders_name");
            ...
            try {
                    searchRowSet1.execute("select holders_name as scheme,acc_no from pb_share_register where holders_name ILIKE '"+jTextField1111.getText().toString()+"%' ORDER BY holders_name");
...
this.dispose();        // Add your handling code here:
    ...
    public void getReport(int reportName) {
        ...
        switch (reportName) {
            ...
            {
                com.afrisoftech.reports.SharesStatementPdf policy = new com.afrisoftech.reports.SharesStatementPdf();
                
                policy.SharesStatementPdf(connectDB,this.datePicker1.getDate(), this.datePicker2.getDate(), this.jTextField2.getText());
