 ...
 * @author  root
 */
public class HosShareJournalPanel extends javax.swing.JDialog {
    ...
    public HosShareJournalPanel(java.awt.Frame parent, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB, boolean modal, int repName, java.sql.Connection connectDb) {
    ...
    private void initComponents() {
        ...
        */
        ...
        jLabel4.setText("Share Trans. No.");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 1;
        gridBagConstraints.weightx = 1.0;
 ...
 try {
                    searchRowSet1.execute("select distinct(reference_no) as scheme from ac_shares_ledger  WHERE reference_no ilike 'Sh%' and reference_no ILIKE '"+jTextField1111.getText().toString()+"%'  ORDER BY reference_no");
    ...
    public void getReport(int reportName) {
        ...
        switch (reportName) {
           ...
           */
            ...
            {
                com.afrisoftech.reports.ShareTransJournlPdf policy = new com.afrisoftech.reports.ShareTransJournlPdf();
                
                policy.ShareTransPdf(connectDB,jTextField36.getText());
