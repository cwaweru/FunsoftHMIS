...
public class HosPayrollStaffDatePanel extends javax.swing.JDialog {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        */
        ...
        setSize(new java.awt.Dimension(393, 197));
        setLocation((screenSize.width-393)/2,(screenSize.height-197)/2);
    ...
    private void jTextField1111CaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextField1111CaretUpdate
       jSearchTable1.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"select trim(employee_no) as scheme,first_name||' '||middle_name||' '||last_name as name from master_file where first_name||' '||middle_name||' '||last_name ILIKE '"+jTextField1111.getText().toString()+"%' ORDER BY name"));
    ...
    public void getReport(int reportName) {
        ...
        switch (reportName) {
            ...
            {
                com.afrisoftech.hospayroll.P9PerStaffPdf policy = new com.afrisoftech.hospayroll.P9PerStaffPdf();
                
                policy.P9PerStaffPdf(connectDB,datePicker1.getDate(),datePicker2.getDate(),jTextField36.getText());
