 ...
 */
public class HosPatientLabDatePanel extends javax.swing.JDialog {
     ...
     */
    public HosPatientLabDatePanel(java.awt.Frame parent, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB, boolean modal, int repName, java.sql.Connection connectDb) {
    ...
    private void initComponents() {
        ...
        */
        ...
        patientSearchTxt.addAncestorListener(new javax.swing.event.AncestorListener() {
            public void ancestorAdded(javax.swing.event.AncestorEvent evt) {
            }
            public void ancestorRemoved(javax.swing.event.AncestorEvent evt) {
            }
            public void ancestorMoved(javax.swing.event.AncestorEvent evt) {
                patientSearchTxtAncestorMoved(evt);
            }
        });
        gridBagConstraints = new java.awt.GridBagConstraints();
        ...
        */
        ...
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
        patientSearchPanel.add(jButton412, gridBagConstraints);
        ...
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
        patientSearchPanel.add(jButton513, gridBagConstraints);
        ...
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
        previousVisitIDDialog.getContentPane().add(patientSearchPanel, gridBagConstraints);
        ...
        labResultsTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Date", "Lab No.", "Result No", "Procedure"
            }
        ) {
        ...
        jScrollPane1.setViewportView(labResultsTable);
        ...
        closeDialogBtn.setMnemonic('c');
        closeDialogBtn.setText("Close dialog");
        ...
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
        jPanel3.add(closeDialogBtn, gridBagConstraints);

        viewReportBtn.setMnemonic('P');
        viewReportBtn.setText("View Laboratory Report");
        ...
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
        jPanel3.add(viewReportBtn, gridBagConstraints);
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 3;
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
        ...
        setSize(new java.awt.Dimension(511, 452));
    ...
    private void jSearchTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jSearchTable1MouseClicked
        ...
        System.out.println("Lab list of resilts done 1");
        
        labResultsTable.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB, "SELECT DISTINCT date, lab_no, request_id, typeof_test as lab_procedure FROM hp_lab_results WHERE patient_no = '"+patientNoTxt.getText()+"' AND date BETWEEN '"+datePicker1.getDate()+"' AND '"+datePicker2.getDate()+"' ORDER BY 1,2,3,4"));
        
        System.out.println("Lab list of resilts done 2");
        ...
        if (patientSearchTxt.getCaretPosition() < 4) {
            ...
            if (this.namechkbx.isSelected()) {
                patientSearchTable.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB, ""
                        ...
                        + " from hp_inpatient_register hd where (upper(hd.second_name||' '||hd.first_name||' '||hd.last_name)) ILIKE '%" + patientSearchTxt.getText().toString() + "%' ORDER BY second_name"));
                patientSearchTable.setShowHorizontalLines(false);
                patientSearchScrollPane.setViewportView(patientSearchTable);
                ...
                if (this.nochkbx.isSelected()) {
                    patientSearchTable.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB, ""
                            ...
                            + "(SELECT hp.sub_chief FROM hp_admission hp WHERE hp.patient_no = hd.patient_no order by 1 LIMIT 1) as unit_number, "
                            + "(SELECT hp.visit_id FROM hp_admission hp WHERE hp.patient_no = hd.patient_no order by 1 LIMIT 1) as VisitId "
                            + "from hp_inpatient_register hd where hd.patient_no ILIKE '%" + patientSearchTxt.getText().toString() + "%' or (SELECT hp.sub_chief FROM hp_admission hp WHERE hp.patient_no = hd.patient_no order by 1 LIMIT 1) ilike '%" + patientSearchTxt.getText().toString() + "%' ORDER BY second_name"));
                    patientSearchTable.setShowHorizontalLines(false);
                    patientSearchScrollPane.setViewportView(patientSearchTable);
    ...
    private void patientSearchTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_patientSearchTableMouseClicked
        ...
        visitID = this.patientSearchTable.getValueAt(this.patientSearchTable.getSelectedRow(), 4).toString().trim();
        this.patientNoTxt.setText(this.patientSearchTable.getValueAt(this.patientSearchTable.getSelectedRow(), 0).toString().trim());
    ...
    private void patientSearchTxtAncestorMoved(javax.swing.event.AncestorEvent evt) {//GEN-FIRST:event_patientSearchTxtAncestorMoved
        // TODO add your handling code here:
    }//GEN-LAST:event_patientSearchTxtAncestorMoved
    ...
    public void getReport(int reportName) {
        ...
        switch (reportName) {
            ...
            case 9011: {
                ...
                String labNo = labResultsTable.getValueAt(labResultsTable.getSelectedRow(), 1).toString();
