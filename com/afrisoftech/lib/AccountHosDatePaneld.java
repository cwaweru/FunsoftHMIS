 ...
 * @author  root
 */
public class AccountHosDatePaneld extends javax.swing.JDialog {
    ...
    public AccountHosDatePaneld(java.awt.Frame parent, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB, boolean modal, int repName, java.sql.Connection connectDb) {
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(com.afrisoftech.lib.ComboBoxModel.ComboBoxModel(connectDB, "select fp_clients from fp_clients"));
        ...
        setBounds((screenSize.width-446)/2, (screenSize.height-285)/2, 446, 285);
 ...
 try {
                ...
                java.sql.ResultSet rs = pstmt.executeQuery("select code from fp_clients where fp_clients = '"+jComboBox1.getSelectedItem().toString()+"'");
                while (rs.next()){
...
this.dispose();            // Add your handling code here:
    ...
    public void getReport(int reportName) {
        ...
        switch (reportName) {
            ...
            {
                com.afrisoftech.reports.FpCatSummaryPdf policy = new com.afrisoftech.reports.FpCatSummaryPdf();
                
                policy.FpCatSummaryPdf(connectDB, this.datePicker1.getDate(), this.datePicker2.getDate(),jTextField1.getText());
