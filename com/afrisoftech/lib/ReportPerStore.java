 ...
 * @author  root
 */
public class ReportPerStore extends javax.swing.JDialog {
    ...
    public ReportPerStore(java.awt.Frame parent, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB, boolean modal, int repName, java.sql.Connection connectDb) {
    ...
    private void initComponents() {
        ...
        jComboBox11.setModel(com.afrisoftech.lib.ComboBoxModel.ComboBoxModel(connectDB, "select DISTINCT sub_cat_code from st_stock_item order by sub_cat_code"));
        ...
        jPanel4.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Select Drug here", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Dialog", 1, 12), new java.awt.Color(0, 0, 255))); // NOI18N
        ...
        setSize(new java.awt.Dimension(408, 237));
    ...
    public void getReport(int reportName) {
        ...
        switch (reportName) {
            ...
            {
                com.afrisoftech.hospinventory.DetailedPrescPerPatPdf policy = new com.afrisoftech.hospinventory.DetailedPrescPerPatPdf();
                
                policy.DetailedPrescPerPatPdf(connectDB, this.datePicker1.getDate(), this.datePicker2.getDate(),this.jComboBox1.getSelectedItem().toString(),this.jComboBox11.getSelectedItem().toString());
            ...
            {
                com.afrisoftech.hospinventory.DetailedPrescPerPatNosPdf policy = new com.afrisoftech.hospinventory.DetailedPrescPerPatNosPdf();
                
                policy.DetailedPrescPerPatNosPdf(connectDB, this.datePicker1.getDate(), this.datePicker2.getDate(),this.jComboBox1.getSelectedItem().toString(),this.jComboBox11.getSelectedItem().toString());
            ...
            {
                com.afrisoftech.hospinventory.DetailedPrescPerPatDatePdf policy = new com.afrisoftech.hospinventory.DetailedPrescPerPatDatePdf();
                
                policy.DetailedPrescPerPatDatePdf(connectDB, this.datePicker1.getDate(), this.datePicker2.getDate(),this.jComboBox1.getSelectedItem().toString(),this.jComboBox11.getSelectedItem().toString());
            ...
            {
                com.afrisoftech.hospinventory.PatientsPerStorePdf policy = new com.afrisoftech.hospinventory.PatientsPerStorePdf();
                
                policy.PatientsPerStorePdf(connectDB, this.datePicker1.getDate(), this.datePicker2.getDate(),this.jComboBox1.getSelectedItem().toString(),this.jComboBox11.getSelectedItem().toString());
...
//                
//            {
//                com.afrisoftech.hospinventory.DetailedDispensePerStorePdf policy = new com.afrisoftech.hospinventory.DetailedDispensePerStorePdf();
//                
//                policy.DetailedDispensePerStorePdf(connectDB, this.datePicker1.getDate(), this.datePicker2.getDate(),this.jComboBox1.getSelectedItem().toString(),this.jComboBox11.getSelectedItem().toString());
//                
//                
//                this.dispose();
//                
//            } break;
                ...
                
            {
                ...
                com.afrisoftech.hospinventory.StockBalPerCategoryTxt policy = new com.afrisoftech.hospinventory.StockBalPerCategoryTxt(connectDB, this.datePicker2.getDate(), jComboBox1.getSelectedItem().toString(), this.jComboBox11.getSelectedItem().toString());
         ...
         /*    case 522:
            ...
            {
                com.afrisoftech.hospinventory.DetailedPrescPerPatDarPdf policy = new com.afrisoftech.hospinventory.DetailedPrescPerPatDarPdf();
                
                policy.DetailedPrescPerPatDarPdf(connectDB, this.datePicker1.getDate(), this.datePicker2.getDate(),this.jComboBox1.getSelectedItem().toString(),this.jComboBox11.getSelectedItem().toString());
