 ...
 * @author  root
 */
public class HosDoctDepPanel extends javax.swing.JDialog {
    ...
    public HosDoctDepPanel(java.awt.Frame parent, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB, boolean modal, int repName, java.sql.Connection connectDb) {
    ...
    private void initComponents() {
        ...
        */
        ...
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
        jPanel61.add(jTextField362, gridBagConstraints);
        ...
        jLabel41.setText("Doctor's Name");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 1;
        gridBagConstraints.weightx = 1.0;
        ...
        setBounds((screenSize.width-505)/2, (screenSize.height-365)/2, 505, 365);
    ...
    private void jSearchTable11MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jSearchTable11MouseClicked
        ...
        jTextField1.setText(jSearchTable11.getValueAt(jSearchTable11.getSelectedRow(), 1).toString());
    ...
    private void jTextField11111CaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextField11111CaretUpdate
       if(jTextField11111.getCaretPosition() < 1){
        ...
        jSearchTable11.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"select activity,code from pb_activity where activity  ILIKE '%"+jTextField11111.getText().toString()+"%' and category_class ilike 'pli' ORDER BY activity"));
        
             
        jSearchTable11.setShowHorizontalLines(true);
        jSearchScrollPane11.setViewportView(jSearchTable11);
    ...
    private void jTextField1111CaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextField1111CaretUpdate
        jSearchTable1.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"select DISTINCT (f_name||' '||l_name) as name from secure_menu_access where f_name||' '||l_name ILIKE '%"+jTextField1111.getText().toString()+"%' ORDER BY 1"));
    ...
    public void getReport(int reportName) {
        ...
        switch (reportName) {
            ...
            {
              //  com.afrisoftech.laboratory.LabReqByDocDetPdf policy = new com.afrisoftech.laboratory.LabReqByDocDetPdf();
                
              //  policy.LabReqByDocDetPdf(connectDB,this.datePicker1.getDate(), this.datePicker2.getDate(),jTextField36.getText().toString(),jTextField1.getText().toString());
