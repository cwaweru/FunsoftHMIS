 ...
 * @author  root
 */
public class HosReprintingGrnPanel extends javax.swing.JDialog {
    ...
    public HosReprintingGrnPanel(java.awt.Frame parent, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB, boolean modal, int repName, java.sql.Connection connectDb) {
    ...
    private void initComponents() {
        ...
        */
        ...
        jLabel3.setText("LPO/GRN/CERT NO");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 3;
        gridBagConstraints.weightx = 1.0;
        ...
        setSize(new java.awt.Dimension(435, 277));
    ...
    private void jSearchTable2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jSearchTable2MouseClicked
        ...
        lpoNo=jSearchTable2.getValueAt(jSearchTable2.getSelectedRow(), 0).toString();
  ...
  // if(reportName==36){
                /*jSearchTable2.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"SELECT distinct supplier as supplier_name,  order_no as LPO_LSO_NO from st_stock_cardex st where st.approved=FALSE "
                    + "and order_no ilike '%" + jTextField113.getText() + "%' and st.transaction_type ilike 'Receiving' and delivered_by!= 'Reversal' group by supplier,order_no  order by supplier_name"));*/
           jSearchTable2.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"SELECT distinct  supplier_name   from st_suppliers where supplier_name  ilike '%" + jTextField113.getText() + "%'   order by  supplier_name "));
...
//            }
    ...
    private void jTextField11111CaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextField11111CaretUpdate
        jSearchTable11.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"select distinct order_no as LPO,grn_no as GRN,certficate_no as CERT_NO from st_stock_cardex where supplier='"+jTextField9.getText()+"' and date between '"+this.datePicker1.getDate()+"' and '"+this.datePicker2.getDate()+"' and grn_no!='' and grn_no is not null ORDER BY order_no,grn_no,certficate_no"));
        jSearchTable11.setShowHorizontalLines(false);
        jSearchScrollPane11.setViewportView(jSearchTable11); 
            /*
        try {
    ...
    private void jSearchTable11MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jSearchTable11MouseClicked
        jTextField361.setText(jSearchTable11.getValueAt(jSearchTable11.getSelectedRow(), 0).toString()+"-"+jSearchTable11.getValueAt(jSearchTable11.getSelectedRow(), 1).toString()+"-"+jSearchTable11.getValueAt(jSearchTable11.getSelectedRow(), 2).toString());
...
//            {
                ...
                policy.ComplianceCertificatePdf(connectDB,jSearchTable11.getValueAt(jSearchTable11.getSelectedRow(),2).toString(),jSearchTable11.getValueAt(jSearchTable11.getSelectedRow(),0).toString());
               ...
               com.afrisoftech.hospinventory.mtrhreports.MtrhSthirteenPdf policy1 = new com.afrisoftech.hospinventory.mtrhreports.MtrhSthirteenPdf();
                ...
                policy1.MtrhSthirteenPdf(connectDB,jSearchTable11.getValueAt(jSearchTable11.getSelectedRow(),0).toString(),jTextField9.getText(),jSearchTable11.getValueAt(jSearchTable11.getSelectedRow(),1).toString());
...
//    
 /*           case 37:
  
            {
                ...
                policy.AgeingPerCreditorsPdf(connectDB, this.datePicker1.getDate().toLocaleString(), this.datePicker2.getDate().toLocaleString(),jTextField9.getText().toString());
