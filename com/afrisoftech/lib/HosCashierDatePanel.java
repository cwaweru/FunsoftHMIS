 ...
 */
public class HosCashierDatePanel extends javax.swing.JDialog {
    ...
    public HosCashierDatePanel(java.awt.Frame parent, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB, boolean modal, int repName, java.sql.Connection connectDb) {
    ...
    private void initComponents() {
        ...
        */
        ...
        jButton1.setText("Generate shift report");
        ...
        jPanel4.setBorder(javax.swing.BorderFactory.createTitledBorder("Select Cashier here"));
        ...
        jComboBox2.setModel(com.afrisoftech.lib.ComboBoxModel.ComboBoxModel(connectDB, "SELECT DISTINCT description FROM ac_cash_points_setup ORDER BY description"));
        ...
        setBounds((screenSize.width-497)/2, (screenSize.height-296)/2, 497, 296);
...
//        jTextField36.setText(jSearchTable1.getValueAt(jSearchTable1.getSelectedRow(), 0).toString());
 //       jTextField1.setText(jSearchTable1.getValueAt(jSearchTable1.getSelectedRow(), 1).toString());
    ...
    private void jTextField1111CaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextField1111CaretUpdate
       jSearchTable1.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"select shift_no as shift,status,start_date::date from ac_shifts where shift_no::CHARACTER VARYING ILIKE '"+jTextField1111.getText().toString()+"%' and user_name ilike '"+jComboBox2.getSelectedItem()+"' ORDER BY shift_no::int DESC"));
                 
        
      /*  try {
            searchRowSet1.execute("select trim(shift_no) as scheme,status,start_date::date from ac_shifts where shift_no ILIKE '"+jTextField1111.getText().toString()+"%' and user_name ilike '"+jComboBox2.getSelectedItem()+"' AND cash_point ILIKE '"+jComboBox21.getSelectedItem()+"' ORDER BY start_date::date DESC");
    ...
    public void getReport(int reportName) {
        ...
        switch (reportName) {
           ...
           {
                com.afrisoftech.reports.ShiftsTotalPerCashierPdf policy = new com.afrisoftech.reports.ShiftsTotalPerCashierPdf();

                policy.ShiftsTotalPerCashierPdf(connectDB,this.datePicker1.getDate(), this.datePicker2.getDate(),jComboBox2.getSelectedItem().toString());
