...
public final class DrawingPanel3 extends FileFilter
    implements ActionListener, MouseMotionListener, Runnable, WindowListener {

    public javax.swing.JFrame getDrawingPanel() {
       return frame;
    }
    ...
    */
    ...
    private long createTime;               // time at which DrawingPanel3 was constructed
    ...
    public DrawingPanel3(int width, int height) {
        ...
        synchronized (getClass()) {
            instances++;
            instanceNumber = instances;  // each DrawingPanel3 stores its own int number
    ...
    // called when DrawingPanel3 closes, to potentially exit the program
    ...
    // compares current DrawingPanel3 image to an image file on disk
    ...
    // compares current DrawingPanel3 image to an image file on the web
...
*/
    ...
    // saves DrawingPanel3 image to a temporary file and returns file's name
    ...
    // initializes DrawingPanel3's menu bar items
