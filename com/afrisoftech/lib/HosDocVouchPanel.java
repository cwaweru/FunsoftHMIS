...
public class HosDocVouchPanel extends javax.swing.JDialog {
    ...
    private void jTextField1111CaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextField1111CaretUpdate
        jSearchTable1.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"select distinct(voucher_no) as scheme from ac_doctors_ledger where voucher_no ILIKE '"+jTextField1111.getText().toString()+"%' and voucher_no !='' and voucher_no is not null ORDER BY voucher_no"));
  ...
  //      switch (reportName) {
        ...
        switch (reportName) {            
                ...
                
            {
                ...
                policy.DoctorsVoucherPdf(connectDB,jTextField36.getText(), printState);
                ...
                
            {
                ...
                policy.DoctorsVouchDetPdf(connectDB,jTextField36.getText(), printState);
