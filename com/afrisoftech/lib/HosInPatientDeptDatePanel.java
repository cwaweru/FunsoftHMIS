 ...
 * @author  root
 */
public class HosInPatientDeptDatePanel extends javax.swing.JDialog {
    ...
    public HosInPatientDeptDatePanel(java.awt.Frame parent, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB, boolean modal, int repName, java.sql.Connection connectDb) {
    ...
    public void getReport(int reportName, boolean printState) {
        ...
        switch (reportName) {
          ...
          /*  case 29:
            ...
            {
                com.afrisoftech.reports.FinalDescInPatientIntmDeptlnvPdf policy = new com.afrisoftech.reports.FinalDescInPatientIntmDeptlnvPdf();
                
                policy.FinalDescInPatientIntmDeptlnvPdf(connectDB,jTextField2.getText(),jComboBox1.getSelectedItem().toString());
