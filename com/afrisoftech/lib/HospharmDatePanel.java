 ...
 * @author  root
 */
public class HospharmDatePanel extends javax.swing.JDialog {
    ...
    public HospharmDatePanel(java.awt.Frame parent, boolean modal, int repName, java.sql.Connection connectDb) {
...
//            ReportType = jRadioButton1.getText();
//        } else {
//            ReportType = jRadioButton2.getText();
//        }
        ...
        switch (reportName) {
            ...
            case 76867701:
                 ...
                 {
                    com.afrisoftech.reports.PrescriptionSumPdf policy = new com.afrisoftech.reports.PrescriptionSumPdf();

                    policy.PrescriptionSumPdf(connectDB, this.datePicker1.getDate(), this.datePicker2.getDate(), Categ, ReportType);
                ...
                break;
                 ...
                 {
                    com.afrisoftech.reports.PrescriptionSumPerSexPdf policy = new com.afrisoftech.reports.PrescriptionSumPerSexPdf();

                    policy.PrescriptionSumPerSexPdf(connectDB, this.datePicker1.getDate(), this.datePicker2.getDate(), Categ, ReportType);
                ...
                break;
                 ...
                 {
                    com.afrisoftech.reports.PrescriptionSumPerAgePdf policy = new com.afrisoftech.reports.PrescriptionSumPerAgePdf();

                    policy.PrescriptionSumPerAgePdf(connectDB, this.datePicker1.getDate(), this.datePicker2.getDate(), Categ, ReportType);
            ...
            case 585694:
                 ...
                 {
//                    sagnosisSumPerSexPdf(connectDB, this.datePicker1.getDate(), this.datePicker2.getDate(), Categ, ReportType);
                ...
                case 585695:
                 ...
                 {
                    com.afrisoftech.records.reports.DiagnosisPerAgePdf policy = new com.afrisoftech.records.reports.DiagnosisPerAgePdf();

                    policy.DiagnosisPerAgePdf(connectDB, this.datePicker1.getDate(), this.datePicker2.getDate(), Categ, ReportType);
