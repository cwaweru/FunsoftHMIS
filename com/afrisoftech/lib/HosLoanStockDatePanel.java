...
public class HosLoanStockDatePanel extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        */
        ...
        jComboBox1.setModel(com.afrisoftech.lib.ComboBoxModel.ComboBoxModel(connectDB, "select DISTINCT lender_name from pb_loan order by lender_name"));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 1;
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
    ...
    private void jTextField11111CaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextField11111CaretUpdate
        ...
        jSearchTable11.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"select trim(invoice_no) as scheme,date as name from ac_accounts_payable where invoice_no ILIKE '"+jTextField11111.getText().toString()+"%' and dealer = '"+this.jComboBox1.getSelectedItem()+"' and date between '"+this.datePicker1.getDate()+"' and '"+this.datePicker2.getDate()+"' ORDER BY date"));
