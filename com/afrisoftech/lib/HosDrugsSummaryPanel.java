 ...
 * @author root
 */
public class HosDrugsSummaryPanel extends javax.swing.JDialog {
     ...
     */
    public HosDrugsSummaryPanel(java.awt.Frame parent, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB, boolean modal, int repName, java.sql.Connection connectDb) {
    ...
    private void initComponents() {
        ...
        */
        ...
        setBounds((screenSize.width-453)/2, (screenSize.height-271)/2, 453, 271);
    ...
    private void jSearchTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jSearchTable1MouseClicked
        ...
        jTextField3.setText(jSearchTable1.getValueAt(jSearchTable1.getSelectedRow(), 0).toString());
    ...
    private void jTextField1111CaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextField1111CaretUpdate
        if (this.jTextField1111.getCaretPosition() < 2) {
            ...
            jSearchTable1.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB, "select distinct item_code,description,strength from st_stock_item where description ILIKE '" + jTextField1111.getText().toString() + "%' ORDER BY description"));

            /*
             * searchRowSet1.execute("select distinct product as scheme from
             * st_stock_prices where product ILIKE
             * '"+jTextField1111.getText().toString()+"%' ORDER BY product");
             *
             ...
             * "Scheme_name", false), // new
             * org.netbeans.lib.sql.models.TableModel.Column("name", "Payer",
             * false), // new
    ...
    public void getReport(int reportName) {
        ...
        switch (reportName) {
             ...
             *
             * {
             * com.afrisoftech.hospinventory.DrugFlowPdf policy = new
             * com.afrisoftech.hospinventory.DrugFlowPdf();
             *
             * policy.DrugFlowPdf(connectDB, this.datePicker1.getDate(),
             * this.datePicker2.getDate(),jTextField36.getText(),this.jTextField2.getText());
             *
             *
             * this.dispose();
             *
             ...
             *
             * {
             * com.afrisoftech.hospinventory.DrugMovementPdf policy = new
             * com.afrisoftech.hospinventory.DrugMovementPdf();
             *
             * policy.DrugMovementPdf(connectDB, this.datePicker1.getDate(),
             * this.datePicker2.getDate(),jTextField36.getText());
             *
             *
             * this.dispose();
             *
            ...
            case 5277: {
                ...
                com.afrisoftech.hospinventory.DrugsAuditPdf policy = new com.afrisoftech.hospinventory.DrugsAuditPdf();

                policy.DrugsAuditPdf(connectDB, this.datePicker1.getDate(), this.datePicker2.getDate(), jTextField3.getText());
