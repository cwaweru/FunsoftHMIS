 ...
 * @author  root
 */
public class HosIpanalysisPanel extends javax.swing.JDialog {
    ...
    public HosIpanalysisPanel(java.awt.Frame parent, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB, boolean modal, int repName, java.sql.Connection connectDb) {
    ...
    private void initComponents() {
        ...
        */
        ...
        jPanel4.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Select report no here", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Dialog", 0, 11), new java.awt.Color(0, 0, 255)));
        ...
        setBounds((screenSize.width-354)/2, (screenSize.height-212)/2, 354, 212);
    ...
    private void jTextField1111CaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextField1111CaretUpdate
        jSearchTable1.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"select distinct(instance_no) as report_no,insert_time as report_time from ipstatus_bill where instance_no ILIKE '"+jTextField1111.getText().toString()+"%' AND insert_time::date between '"+datePicker1.getDate()+"' AND '"+datePicker2.getDate()+"'  ORDER BY instance_no"));
  ...
  //      switch (reportName) {
        ...
        switch (reportName) {            
            ...
            {
                com.afrisoftech.reports.IpanalysisStatusPdf policy = new com.afrisoftech.reports.IpanalysisStatusPdf();
                
                policy.IpanalysisStatusPdf(connectDB,jTextField36.getText(), printState);
