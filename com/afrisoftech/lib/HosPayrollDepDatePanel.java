...
public class HosPayrollDepDatePanel extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(com.afrisoftech.lib.ComboBoxModel.ComboBoxModel(connectDB, "SELECT DISTINCT department_name FROM pb_departments ORDER BY department_name"));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 1;
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
        ...
        setBounds((screenSize.width-415)/2, (screenSize.height-248)/2, 415, 248);
