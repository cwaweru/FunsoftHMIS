...
public class HosCreditorsDatePanel extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        */
        ...
        jButton1.setText("Generate creditor statement");
        ...
        deliveryNoteNumberTxt.setEditable(false);
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 1;
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
        jPanel61.add(deliveryNoteNumberTxt, gridBagConstraints);
    ...
    private void jSearchTable2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jSearchTable2MouseClicked
        ...
        if (reportName == 17) {
            ...
            deliveryNoteNumberTxt.setText(jSearchTable2.getValueAt(jSearchTable2.getSelectedRow(), 3).toString());
    ...
    private void jSearchTable11MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jSearchTable11MouseClicked
        deliveryNoteNumberTxt.setText(jSearchTable11.getValueAt(jSearchTable11.getSelectedRow(), 0).toString());
    ...
    private void searchButton111Clicked() {
        ...
        java.awt.Point point = this.deliveryNoteNumberTxt.getLocationOnScreen();
    ...
    public void getReport(int reportName, boolean printState) {
        ...
        switch (reportName) {
            ...
            case 3600: {
                ...
                policy.GRTPdf(connectDB, this.datePicker1.getDate().toLocaleString(), this.datePicker2.getDate().toLocaleString(), supplierTxt.getText().toString(), this.deliveryNoteNumberTxt.getText());
            ...
            case 47: {
                ...
                if (byTransactionDateChbx.isSelected()) {
                    policy.CreditorsStatementPdf(connectDB, this.datePicker1.getDate(), this.datePicker2.getDate(), supplierTxt.getText().toString(), true);
                } else {
                    policy.CreditorsStatementPdf(connectDB, this.datePicker1.getDate(), this.datePicker2.getDate(), supplierTxt.getText().toString(), false);
                }
                //   this.dispose();
            }
            break;
            ...
            case 68: {
                ...
                policy.InvPerCreditorsPdf(connectDB, this.datePicker1.getDate(), this.datePicker2.getDate(), supplierTxt.getText().toString());
            ...
            case 69: {
                ...
                policy.PaymentsPerCreditorsPdf(connectDB, this.datePicker1.getDate(), this.datePicker2.getDate(), supplierTxt.getText().toString());
            ...
            case 180: {
                ...
                policy.CreditorsStmtPdf(connectDB, this.datePicker1.getDate(), this.datePicker2.getDate(), supplierTxt.getText().toString());
            ...
            case 1102: {
                ...
                policy.OrdersSummBySuppPdf(connectDB, this.datePicker1.getDate(), this.datePicker2.getDate(), supplierTxt.getText().toString());
            ...
            case 17: {
                ...
                voucher.GeneratedVoucherCrdNotePdf(connectDB, lpoNo, supplierTxt.getText(), deliveryNoteNumberTxt.getText(), VoucherNo);
