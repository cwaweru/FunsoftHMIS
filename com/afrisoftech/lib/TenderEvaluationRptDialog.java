 ...
 * @author  root
 */
public class TenderEvaluationRptDialog extends javax.swing.JDialog {
    ...
    public TenderEvaluationRptDialog(java.awt.Frame parent, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB, boolean modal, int repName, java.sql.Connection connectDb) {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if(tenderNotxt.getText().length()<1){
            javax.swing.JOptionPane.showMessageDialog(null, "Please specify the store name before you attempt to produce the report.");
        }
        else{
    ...
    private void jTextField115CaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextField115CaretUpdate
        if (jTextField115.getCaretPosition() > 3) {
    ...
    private void whatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_whatActionPerformed
        ...
        ShowTenderedItemsDialog sht = new ShowTenderedItemsDialog(null,true,connectDB,tenderNotxt.getText());
    ...
    public void getReport(int reportName) {
        ...
        switch (reportName) {
            ...
            {
                com.afrisoftech.hospinventory.TenderPreliminaryReportPDF policy = new com.afrisoftech.hospinventory.TenderPreliminaryReportPDF();
            ...
            {
                com.afrisoftech.hospinventory.TenderTechnicalReportPDF policy = new com.afrisoftech.hospinventory.TenderTechnicalReportPDF();
