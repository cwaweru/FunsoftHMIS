...
public class HosChqsPanel extends javax.swing.JDialog {
    ...
    private void jTextField1111CaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextField1111CaretUpdate
        jSearchTable1.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"select distinct cheque_no as scheme,acc_no from db_allocation where cheque_no ILIKE '"+jTextField1111.getText().toString()+"%' ORDER BY cheque_no"));
    ...
    public void getReport(int reportName) {
        ...
        switch (reportName) {
            ...
            {
                com.afrisoftech.reports.AllocPerChqPdf policy = new com.afrisoftech.reports.AllocPerChqPdf();
                
                policy.AllocPerChqPdf(connectDB, jTextField36.getText(),this.jTextField2.getText());
