 ...
 * @author root
 */
public class ScheduleDocuments extends javax.swing.JDialog {
     ...
     */
    public ScheduleDocuments(java.awt.Frame parent, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB, boolean modal, int repName, java.sql.Connection connectDb) {
    ...
    private void initComponents() {
        ...
        */
        ...
        jCheckBox1.setText("Schedules Per Tender");
        ...
        jCheckBox2.setText("Schedules For Bidders");
    ...
    private void jTextField115CaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextField115CaretUpdate
        if (jTextField115.getCaretPosition() > 2) {
            ...
            jSearchTable4.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectorsCaret(connectDB, "select distinct quotation_no from st_floated_quotations where quotation_no ilike '%" + jTextField115.getText() + "%'"));
            jSearchScrollPane4.setViewportView(jSearchTable4);
    ...
    private void jSearchTable4MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jSearchTable4MouseClicked
        ...
        bidderSearchTable.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB, "SELECT distinct supplier from st_floated_quotations where quotation_no='" + tenderNotxt.getText() + "' and unit_price>0"));
...
//0794260
    ...
    private void jButton94ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton94ActionPerformed
        // TODO add your handling code here:
        this.bidderSearch.dispose();        // Add your handling code here:
    ...
    public void getReport(int reportName) {
        ...
        switch (reportName) {
            ...
            case 2015: {
                ...
                policy.TenderScheduleReportPDF(connectDB, tenderNotxt.getText());

            }
            break;

            case 2016: {
                TendersReceivedMtrhPdf policy = new TendersReceivedMtrhPdf();
                policy.TendersReceivedMtrhPdf(connectDB, tenderNotxt.getText(), supplierTxt.getText());
