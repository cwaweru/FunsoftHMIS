 ...
 * @author  root
 */
public class HosChequeReqPanel extends javax.swing.JDialog {
    ...
    public HosChequeReqPanel(java.awt.Frame parent, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB, boolean modal, int repName, java.sql.Connection connectDb) {
    ...
    private void initComponents() {
        ...
        */
        ...
        jPanel4.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Select Voucher here", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Dialog", 0, 11), new java.awt.Color(0, 0, 255)));
        jLabel4.setText("Requistion No.");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 1;
        gridBagConstraints.weightx = 1.0;
    ...
    private void jTextField1111CaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextField1111CaretUpdate
        jSearchTable1.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"select DISTINCT cash_point from ac_accounts_payable WHERE cash_point ILIKE '"+jTextField1111.getText().toString()+"%' AND cash_point is not null and cash_point !='' ORDER BY cash_point"));
        jSearchTable1.setShowHorizontalLines(false);
        jSearchScrollPane1.setViewportView(jSearchTable1);
    ...
    public void getReport(int reportName) {
        ...
        switch (reportName) {
                ...
                
            {
                ...
                policy.ChequeRequisitionPdf(connectDB,jTextField36.getText());
