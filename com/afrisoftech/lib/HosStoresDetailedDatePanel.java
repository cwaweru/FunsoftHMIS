 ...
 * @author  root
 */
public class HosStoresDetailedDatePanel extends javax.swing.JDialog {
    ...
    public HosStoresDetailedDatePanel(java.awt.Frame parent, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB, boolean modal, int repName, java.sql.Connection connectDb) {
    ...
    private void initComponents() {
        ...
        setBounds((screenSize.width-516)/2, (screenSize.height-292)/2, 516, 292);
        ...
        switch (reportName) {
            ...
            case 82:

                 {
                    ...
                    policy.StockBalPdf(connectDB, jComboBox1.getSelectedItem().toString(), this.datePicker2.getDate().toString());
            ...
            case 2900:
                 ...
                 {
                    com.afrisoftech.hospinventory.SubStoresMovtPdf policy = new com.afrisoftech.hospinventory.SubStoresMovtPdf();

                    policy.SubStoresMovtPdf(connectDB, this.datePicker1.getDate(), this.datePicker2.getDate(), jComboBox1.getSelectedItem().toString());
            ...
            case 160:

                 {
                    if (jCheckBox1.isSelected()) {
                        ...
                        com.afrisoftech.hospinventory.TransfersPerStoreInPdf policy = new com.afrisoftech.hospinventory.TransfersPerStoreInPdf();

                        policy.TransfersPerStoreInPdf(connectDB, this.datePicker1.getDate(), this.datePicker2.getDate(), jComboBox1.getSelectedItem().toString());


                    } else if (jCheckBox3.isSelected()) {

                        com.afrisoftech.hospinventory.TransfersPerStoreGroupedPdf policy = new com.afrisoftech.hospinventory.TransfersPerStoreGroupedPdf();

                        policy.TransfersPerStoreGroupedPdf(connectDB, this.datePicker1.getDate(), this.datePicker2.getDate(), jComboBox1.getSelectedItem().toString());
            ...
            case 18700:
                 ...
                 {
                    com.afrisoftech.hospinventory.SuppliesVsSalesAllDrugsPdf policy = new com.afrisoftech.hospinventory.SuppliesVsSalesAllDrugsPdf();

                    policy.SuppliesVsSalesAllDrugsPdf(connectDB, this.datePicker1.getDate(), this.datePicker2.getDate(), jComboBox1.getSelectedItem().toString());
            ...
            policy.StockBelowReorderLevelPdf(connectDB, jComboBox1.getSelectedItem().toString());
