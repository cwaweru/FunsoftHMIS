 ...
 * @author  root
 */
public class HosDispartchNhifDatePanel extends javax.swing.JDialog {
    ...
    public HosDispartchNhifDatePanel(java.awt.Frame parent, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB, boolean modal, int repName, java.sql.Connection connectDb) {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        */
        ...
        jRadioButton1.setText("Dispatch Per Payer");
        ...
        jRadioButton2.setText("Dispatch Per Scheme");
        ...
        setLocation((screenSize.width-400)/2,(screenSize.height-219)/2);
    ...
    public void getReport(int reportName) {
        ...
        switch (reportName) {
            ...
            {
                com.afrisoftech.reports.NHIFCreditsDispatchPdf policy = new com.afrisoftech.reports.NHIFCreditsDispatchPdf();
                
                policy.NHIFCreditsDispatchPdf(connectDB, this.datePicker1.getDate(), this.datePicker2.getDate(),jTextField36.getText());
