 ...
 * @author  root
 */
public class HosMainStoresDrugsDatePanel extends javax.swing.JDialog {
    ...
    public HosMainStoresDrugsDatePanel(java.awt.Frame parent, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB, boolean modal, int repName, java.sql.Connection connectDb) {
    ...
    private void initComponents() {
        ...
        */
        ...
        jPanel4.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Select Drug here", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(0, 0, 255)));
    ...
    private void jSearchTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jSearchTable1MouseClicked
        ...
        jTextField3.setText(jSearchTable1.getValueAt(jSearchTable1.getSelectedRow(), 1).toString());
...
// jTextField2.setText(jSearchTable1.getValueAt(jSearchTable1.getSelectedRow(), 2).toString());
    ...
    private void jTextField1111CaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextField1111CaretUpdate
        if(this.jTextField1111.getCaretPosition() < 2){
            ...
            jSearchTable1.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"select distinct description||' '||strength,item_code from st_stock_item where description ILIKE '"+jTextField1111.getText().toString()+"%' and department ilike '"+this.jComboBox1.getSelectedItem().toString()+"' ORDER BY 1"));
    ...
    public void getReport(int reportName) {
        ...
        switch (reportName) {
                ...
                
            {
                ...
                policy.DrugFlowPdf(connectDB, this.datePicker1.getDate(), this.datePicker2.getDate(),jTextField3.getText(),this.jComboBox1.getSelectedItem().toString(),jTextField36.getText());
