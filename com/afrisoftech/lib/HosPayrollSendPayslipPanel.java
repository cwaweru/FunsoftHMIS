 ...
 * @author root
 */
public class HosPayrollSendPayslipPanel extends javax.swing.JDialog {
     ...
     */
    public HosPayrollSendPayslipPanel(java.awt.Frame parent, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB, boolean modal, int repName, java.sql.Connection connectDb) {
    ...
    private void initComponents() {
        ...
        */
        ...
        jButton1.setText("Send Payslips on Email");
    ...
    public void getReport(int reportName) {
        ...
        for (int i = 0; i < staffNumbers.length; i++) {
            ...
            if (com.afrisoftech.lib.StaffDetails.getStaffEmail(connectDB, staffNumbers[i].toString()) != null) {
                ...
                com.afrisoftech.hospayroll.SendPayslipPerStaffPdf1 policy = new com.afrisoftech.hospayroll.SendPayslipPerStaffPdf1();

                policy.SendPayslipPerStaffPdf1(connectDB, datePicker1.getDate(), datePicker2.getDate(), staffNumbers[i].toString());
