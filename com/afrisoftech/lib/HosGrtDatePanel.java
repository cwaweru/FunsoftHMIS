...
public class HosGrtDatePanel extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        */
        ...
        jComboBox1.setModel(com.afrisoftech.lib.ComboBoxModel.ComboBoxModel(connectDB, "select DISTINCT supplier_name from st_suppliers order by supplier_name"));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 1;
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
        ...
        setBounds((screenSize.width-435)/2, (screenSize.height-277)/2, 435, 277);
    ...
    private void jTextField11111CaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextField11111CaretUpdate
        jSearchTable11.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"select trim(voucher_no) as scheme,date as name from ac_accounts_payable where voucher_no ILIKE '"+jTextField11111.getText().toString()+"%' and dealer = '"+this.jComboBox1.getSelectedItem()+"' and date between '"+this.datePicker1.getDate()+"' and '"+this.datePicker2.getDate()+"' ORDER BY date"));
