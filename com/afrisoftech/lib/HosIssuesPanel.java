...
public class HosIssuesPanel extends javax.swing.JDialog {
    ...
    private void jTextField1111CaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextField1111CaretUpdate
        if(this.jCheckBox1.isSelected()){
            jSearchTable1.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"select distinct (transaction_no) as scheme from st_sub_stores where transaction_no ILIKE '"+jTextField1111.getText().toString()+"%' and transaction_no ilike 't%' ORDER BY transaction_no"));
            ...
            jSearchTable1.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"select distinct (transaction_no) as scheme from st_sub_stores where transaction_no ILIKE '"+jTextField1111.getText().toString()+"%' and transaction_no ilike 'i%' ORDER BY transaction_no"));
