...
public class HosPetCashVouchPanel extends javax.swing.JDialog {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        */
        ...
        setSize(new java.awt.Dimension(357, 190));
        setLocation((screenSize.width-357)/2,(screenSize.height-190)/2);
    ...
    private void jTextField1111CaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextField1111CaretUpdate
        if(this.jCheckBox1.isSelected()){
            jSearchTable1.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"select (voucher_no) as scheme from ac_petty_cash where voucher_no ILIKE '"+jTextField1111.getText().toString()+"%' ORDER BY date"));
    ...
    */
            ...
            jSearchTable1.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"select (requisition_no) as scheme from ac_petty_cash_requisition where requisition_no ILIKE '"+jTextField1111.getText().toString()+"%' ORDER BY date_required"));
           ...
           */
                ...
                
            {
                if(this.jCheckBox2.isSelected()){
                    ...
                    ///{
                    com.afrisoftech.reports.PettyNgoPayCopyVoucherPdf policy = new com.afrisoftech.reports.PettyNgoPayCopyVoucherPdf();
                    
                    policy.PettyNgoPayCopyVoucherPdf(connectDB,jTextField36.getText());
