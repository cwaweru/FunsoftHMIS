...
public class HosOrdersPanel extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        */
        ...
        jPanel4.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Select Order No. here", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(0, 0, 255))); // NOI18N
        ...
        jCheckBox1.setText("Fuel Orders");
        ...
        setBounds((screenSize.width-405)/2, (screenSize.height-230)/2, 405, 230);
    ...
    private void jTextField1111CaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextField1111CaretUpdate
        jSearchTable1.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB, "SELECT DISTINCT(order_no) AS order_no,supplier FROM st_orders WHERE order_no ILIKE '" + jTextField1111.getText().toString() + "%' AND doc_type ILIKE '" + jComboBox11.getSelectedItem() + "' ORDER BY order_no"));
    ...
    public void getReport(int reportName) {
        ...
        switch (reportName) {
            ...
            case 9: {
                if (jComboBox11.getSelectedItem().toString().equalsIgnoreCase("Lpo")) {
                    com.afrisoftech.hospinventory.LpoPdf policy = new com.afrisoftech.hospinventory.LpoPdf();

                    policy.LpoPdf(connectDB, jTextField1.getText(), jTextField36.getText());
                } else {
                    com.afrisoftech.hospinventory.LsoPdf policy = new com.afrisoftech.hospinventory.LsoPdf();

                    policy.LsoPdf(connectDB, jTextField1.getText(), jTextField36.getText());
                }
