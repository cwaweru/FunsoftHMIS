...
import com.afrisoftech.laboratory.*;
import com.lowagie.text.*;
import com.lowagie.text.pdf.*;

public class InPatientFilePdf implements java.lang.Runnable {
    ...
    public void InPatientFilePdf(java.sql.Connection connDb, java.util.Date begindate, java.util.Date endate, java.lang.String combox) {
        MNo = combox;
                ...
                try {
                    ...
                    try {
                        ...
                        try {
                            ...
                            phrase = new Phrase("PATIENT'S NURSING CARDEX", pFontHeader11);
                            table.addCell(phrase);
                            java.sql.ResultSet rsetp = stp.executeQuery("select distinct patient_no,initcap(patient_name),wing,residence,tel,date_admitted,gender,nok,pat_age,mode_of_payment from hp_admission where patient_no = '" + memNo + "' ORDER BY 1");
                            ...
                            for (int j = 0; j < listofStaffNos.length; j++) {
                                ...
                                while (rset1xx.next()) {
                                    ...
                                    java.sql.ResultSet rset13 = st13.executeQuery("select initcap(service),requisition_no,bed_no,time_due from pb_doctors_request where patient_no = '" + memNo + "' and revenue_code ilike '%labo%' and trans_date  = '" + listofStaffNos[j] + "' AND doctor = '" + docs + "' AND curr_date::time(0) = '" + dates + "' order by curr_date::time");// union select date::date,initcap(service) as service,dosage,reference,credit from hp_patient_card where patient_no = '"+memNo+"' and credit > 0 order by date");
                                    java.sql.ResultSet rset14 = st14.executeQuery("select initcap(service),requisition_no,bed_no,time_due||'          '||dosage from pb_doctors_request where patient_no = '" + memNo + "' and revenue_code ilike '%Pharm%' and trans_date  = '" + listofStaffNos[j] + "' AND doctor = '" + docs + "'  AND curr_date::time(0) = '" + dates + "'  order by curr_date::time");// union select date::date,initcap(service) as service,dosage,reference,credit from hp_patient_card where patient_no = '"+memNo+"' and credit > 0 order by date");

                                    java.sql.ResultSet rset2e = st2e.executeQuery(" select Distinct typeof_test, comments,description,doctor,input_date from hp_clinical_results where patient_no = '" + memNo + "' and date  = '" + listofStaffNos[j] + "' AND doctor = '" + docs + "' AND input_date::time(0) = '" + dates + "' GROUP BY typeof_test, comments,description,doctor,input_date ORDER BY input_date");
                                    java.sql.ResultSet rset2e1 = st2e1.executeQuery(" select distinct doctor,input_date from hp_clinical_results where patient_no = '" + memNo + "' and date  = '" + listofStaffNos[j] + "' AND doctor = '" + docs + "' AND input_date::time(0) = '" + dates + "' ORDER BY INPUT_DATE");
                                    ...
                                    java.sql.ResultSet rset2c1 = st2c1.executeQuery(" select distinct treatment from hp_clinical_results where patient_no = '" + memNo + "' and date  = '" + listofStaffNos[j] + "' AND doctor = '" + docs + "' AND input_date::time(0) = '" + dates + "'");
                                    java.sql.ResultSet rset2c11 = st2c11.executeQuery(" select description from hp_clinical_results where patient_no = '" + memNo + "' and date  = '" + listofStaffNos[j] + "' AND doctor = '" + docs + "' AND input_date::time(0) = '" + dates + "'");

                                    java.sql.ResultSet rset2c = st2c.executeQuery(" select distinct comments , treatment,doctor,input_date from hp_clinical_results where patient_no = '" + memNo + "' and date  = '" + listofStaffNos[j] + "' AND doctor = '" + docs + "' AND input_date::time(0) = '" + dates + "' GROUP BY comments , treatment,doctor,input_date ORDER BY input_date");
                                    java.sql.ResultSet rset2g = st2g.executeQuery(" select result,comm_reason from hp_clinical_results where patient_no = '" + memNo + "' and date  = '" + listofStaffNos[j] + "' AND doctor = '" + docs + "' AND input_date::time(0) = '" + dates + "'");
                                    ...
                                    phrase = new Phrase("ON DATE " + listofStaffNos[j] + " " + dates + "               DOCTOR:  " + Doctor, pFontHeader11);
                                    table.addCell(phrase);
...
docPdf.close();  com.afrisoftech.lib.PDFRenderer.renderPDF(tempFile);
    ...
    public java.lang.Object[] getListofStaffNos() {
        ...
        try {
            ...
            java.sql.ResultSet rSet1 = stmt1.executeQuery("SELECT DISTINCT date::date FROM hp_patient_card WHERE patient_no = '" + MNo + "'  ORDER BY 1");
