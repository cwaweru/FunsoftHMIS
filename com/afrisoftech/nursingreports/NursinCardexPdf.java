...
public class NursinCardexPdf implements java.lang.Runnable {
    ...
    public void NursinCardexPdf(java.sql.Connection connDb, java.lang.String combox, java.lang.String comboxs, java.lang.String comboxse) {
        MNo = combox;
        visitId=comboxs;
        MName = comboxse;
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    com.lowagie.text.HeaderFooter footer = new com.lowagie.text.HeaderFooter(new Phrase("Nursing Notes - Page: "), true);// FontFactory.getFont(com.lowagie.text.FontFactory.HELVETICA, 12, Font.BOLDITALIC,java.awt.Color.blue));
...
//table one
                        ...
                        try {
                            ...
                            while (rset4.next()) {
                                ...
                                phrase = new Phrase("Nurses Notes as On  :" +date , pFontHeader);
...
//table 2    
                        ...
                        Phrase phrase = new Phrase("Time", pFontHeader11);
                        table2.addCell(phrase);
                        table2.getDefaultCell().setColspan(4); 
                        phrase = new Phrase("Cardex", pFontHeader11);
                        table2.addCell(phrase);
                        table2.getDefaultCell().setColspan(2);
                        ...
                        try {
                            ...
                            java.sql.Statement st3 = connectDB.createStatement();
                            java.sql.ResultSet rset3 = st3.executeQuery("select urgency,transaction_time,cardex,nurse_name from nursing.nurse_cardex where patient_no='"+MNo+"' AND visit_id='"+visitId+"' ");
                            

                            while (rset3.next()) {
                                if(rset3.getBoolean("urgency")==false){
                                ...
                                }else if(rset3.getBoolean("urgency")==true){
                                    table2.getDefaultCell().setColspan(1);
                                    table2.getDefaultCell().setBackgroundColor(java.awt.Color.red);
                                    table2.getDefaultCell().setBorderColor(java.awt.Color.BLACK);
                                }
                                table2.getDefaultCell().setColspan(2);
                                ...
                                table2.getDefaultCell().setColspan(2);
                                phrase = new Phrase(rset3.getObject("transaction_time").toString(), pFontHeader);
                                table2.addCell(phrase);
                                
                                table2.getDefaultCell().setColspan(4);
                                phrase = new Phrase(rset3.getObject("cardex").toString(), pFontHeader);
                                table2.addCell(phrase);
                                
                                table2.getDefaultCell().setColspan(2);
                                phrase = new Phrase(rset3.getObject("nurse_name").toString(), pFontHeader);
                                table2.addCell(phrase);
