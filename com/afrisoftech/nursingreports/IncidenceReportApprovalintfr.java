 ...
 * @author saqlever
 */
public class IncidenceReportApprovalintfr extends javax.swing.JInternalFrame {
    ...
    public IncidenceReportApprovalintfr(java.sql.Connection connDB) {
        connectDB = connDB;
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTabbedPane1.addTab("Reports Sent", jScrollPane5);
        ...
        jTabbedPane1.addTab("Approve Reports", jScrollPane1);
            ...
            if (patCheckBox.isSelected() || staffCheckBox.isSelected()) {
                ...
                try {
                    ...
                    java.sql.PreparedStatement pstmt = connectDB.prepareStatement(
                            ...
                            + "to_date_time=?, to_actiontaken=?, comment=?,approved=?, approved_on=localtimestamp, approved_by=current_user\n"
                            + "WHERE oid=? ;");

/////reported to
                    pstmt.setObject(1, reportedTable.getValueAt(0, 0));
                    pstmt.setObject(2, reportedTable.getValueAt(0, 1));
                    pstmt.setObject(3, reportedTable.getValueAt(0, 2));
                    pstmt.setObject(4, reportedTable.getValueAt(0, 3));
                    pstmt.setObject(5, reportedTable.getValueAt(0, 4));
                    pstmt.setObject(6, reportedTable.getValueAt(0, 5));
                    pstmt.setObject(7, reportedTable.getValueAt(0, 6));
                    pstmt.setObject(8, reportedTable.getValueAt(0, 7));
                    pstmt.setObject(9, reportedTable.getValueAt(0, 8));
                    pstmt.setObject(10, reportedTable.getValueAt(0, 9));
                    pstmt.setObject(11, reportedTable.getValueAt(0, 10));
                    pstmt.setObject(7, departmentComboBox.getSelectedItem());
