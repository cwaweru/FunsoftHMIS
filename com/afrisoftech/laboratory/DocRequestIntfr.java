 ...
 * @author  root
 */
public class DocRequestIntfr extends javax.swing.JInternalFrame {
    ...
    private DocRequestIntfr.SearchThread searchThread = null;
    private DocRequestIntfr.SearchServicesThread searchServicesThread = null;
    
    org.netbeans.lib.sql.pool.PooledConnectionSource pConnDB = null;
    
    
    public DocRequestIntfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        */
        ...
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
        jPanel2.add(jTextField92, gridBagConstraints);
        ...
        javax.swing.table.TableColumn teditor2 = this.jTable11.getColumn("Route");
        ...
        javax.swing.table.TableColumn teditor1 = this.jTable11.getColumn("Freqcy");
        ...
        javax.swing.table.TableColumn teditor3 = this.jTable11.getColumn("No.of Days");

        teditor3.setCellEditor(new javax.swing.DefaultCellEditor(cmBox3));

        jTable11.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusGained(java.awt.event.FocusEvent evt) {
                jTable11FocusGained(evt);
            }
        });
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        if (jCheckBox11.isSelected()){
          ...
          try{
              ...
              java.sql.PreparedStatement pstmt1x = connectDB.prepareStatement("delete from pb_doctors_request where inv_no = '"+jTextField91.getText()+"' and patient_no = '"+jTextField9.getText()+"'");
        ...
        try {
            ...
            billNo =jTextField91.getText().toString();
            ...
            for (int i = 0; i < jTable1.getRowCount(); i++){
                if (jTable1.getValueAt(i,0) != null){
                    ...
                    while (rse121.next()){
                        ...
                        pstmt2.setString(10,jTextField91.getText().toString());
                        pstmt2.setString(12,"false");
                        pstmt2.setString(11,user);
                        pstmt2.setString(13,glAcc);
                        pstmt2.setString(14,jTextField91.getText().toString());
            ...
            for (int i = 0; i < jTable11.getRowCount(); i++){
                if (jTable11.getValueAt(i,0) != null){
                  //  this.jTable11.setCellSelectionEnabled(false);
                    ...
                    while (rse121.next()){
                        ...
                        pstmt2.setString(7,jTable11.getValueAt(i,1).toString());
                        ...
                        pstmt2.setString(13,glAcc);
                        pstmt2.setString(14,jTextField91.getText().toString());
                        pstmt2.setString(15,jTable11.getValueAt(i,2).toString());
                        
                        pstmt2.setString(17,"false");
                        pstmt2.setObject(18,jTable11.getValueAt(i,3).toString());
                        pstmt2.setString(19,jTable11.getValueAt(i,4).toString());
                        pstmt2.setString(16,"false");
                        pstmt2.setString(20,"'now'");
                       
                         pstmt2.setObject(21,jTable11.getValueAt(i,5).toString());
    ...
    private void jSearchTable21MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jSearchTable21MouseClicked
        ...
        try {
            ...
            java.sql.ResultSet rset1 = stmt1.executeQuery("select service,amount,requisition_no,bed_no,time_due,dosage from pb_doctors_request where inv_no = '"+jTextField91.getText()+"'");
            while (rset1.next()){
                jTable11.setValueAt(rset1.getObject(1),i,0);
                jTable11.setValueAt(rset1.getObject(2),i,1);
                jTable11.setValueAt(rset1.getObject(3),i,2);
                jTable11.setValueAt(rset1.getObject(4),i,3);
                 jTable11.setValueAt(rset1.getObject(5),i,4);
                  jTable11.setValueAt(rset1.getObject(6),i,5);
                   i++;
            }
    ...
    private void jTextField1131CaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextField1131CaretUpdate
            ...
            if(jTextField1131.getCaretPosition() < 1){
                
                System.out.println("Nothing");
            }else{
                jSearchTable21.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"select distinct inv_no,patient_no,patient_name FROM pb_doctors_request WHERE inv_no ILIKE '%"+jTextField1131.getText()+"%' and revenue_code ilike '%pharm%' and patient_no='"+jTextField9.getText()+"'  order by inv_no"));
    ...
    private void jTable11FocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_jTable11FocusGained
        // Add your handling code here:
    }//GEN-LAST:event_jTable11FocusGained
    
    private void jCheckBox2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jCheckBox2ActionPerformed
        this.jPanel7.setVisible(true);
        this.jPanel3.setVisible(false);    // Add your handling code here:
    ...
    private void jSearchTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jSearchTable1MouseClicked
        ...
        try {
            ...
            java.sql.Statement stmt1 = connectDB.createStatement();
            java.sql.ResultSet rset1 = stmt1.executeQuery("select admin_mode,genre,days,strength from st_stock_item where description ilike '"+jTable11.getValueAt(i,0)+"'");
            while (rset1.next()){
                jTable11.setValueAt(rset1.getObject(1),i,2);
                jTable11.setValueAt(rset1.getObject(2),i,3);
                jTable11.setValueAt(rset1.getObject(3),i,4);
                jTable11.setValueAt(rset1.getObject(4),i,5);
            }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if (this.jCheckBox2.isSelected()){
            ...
            pol.OutPatPrescPdf(connectDB, jTextField91.getText());
        }else{
            com.afrisoftech.reports.ProcedureSlipPdf pol = new com.afrisoftech.reports.ProcedureSlipPdf();
            pol.ProcedureSlipPdf(connectDB, jTextField91.getText());
        }
    ...
    private void jTextField11CaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextField11CaretUpdate
        if(this.jCheckBox42.isSelected()){
            ...
            if(jTextField11.getCaretPosition() < 1){
                ...
                jSearchTable.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"select service_type,rate as price,gl_account as gl_code FROM pb_operating_parameters WHERE code ILIKE '%"+jTextField11.getText()+"%' AND main_service ilike '"+jComboBox1.getSelectedItem()+"%'  order by service_type"));
            ...
            if(jTextField11.getCaretPosition() < 1){
                ...
                jSearchTable.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"select service_type,rate as price,gl_account as gl_code FROM pb_operating_parameters WHERE service_type ILIKE '%"+jTextField11.getText()+"%' AND main_service ILIKE '"+jComboBox1.getSelectedItem()+"%'  order by service_type"));
    ...
    private void jTextField113CaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextField113CaretUpdate
        ...
        if(this.jCheckBox5.isSelected() && this.jCheckBox3.isSelected()){
            ...
            if(jTextField113.getCaretPosition() < 3){
                ...
                jSearchTable2.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"SELECT patient_no, patient_name from hp_admission where patient_no ILIKE '"+jTextField113.getText()+"%' order by patient_no"));
            ...
            if(this.jCheckBox5.isSelected() && this.jCheckBox4.isSelected()){
                if(jTextField113.getCaretPosition() < 3){
                    ...
                    jSearchTable2.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"SELECT patient_no, patient_name from hp_admission where name ILIKE '%"+jTextField113.getText()+"%' order by Patient_name"));
        ...
        try {
            ...
            if(this.jCheckBox11.isSelected()){
                ...
                while (rst11.next()){
                    ...
                    this.jTextField91.setText(billNo);
                }
            }else{
                if(this.jCheckBox5.isSelected()){
                    java.sql.Statement ps11 = connectDB.createStatement();
