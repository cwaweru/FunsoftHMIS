 ...
 * @author  root
 */
public class ClinicalExamIntfr extends javax.swing.JInternalFrame {
    ...
    public ClinicalExamIntfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        */
        ...
        setMaximizable(true);
        setResizable(true);
        setTitle("Clinical Examinations");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Sign", "Absent", "Low", "Moderate", "Marked", "Description"
            }
        ) {
            Class[] types = new Class [] {
                java.lang.Object.class, java.lang.Boolean.class, java.lang.Boolean.class, java.lang.Boolean.class, java.lang.Boolean.class, java.lang.Object.class
            };
        ...
        if(this.jCheckBox11.isSelected() && this.jCheckBox3.isSelected()){
            ...
            if(jTextField113.getCaretPosition() < 3){
                System.out.println("Nothing");
                     ...
                     jSearchTable2.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"SELECT patient_no, (upper(second_name||' '||first_name||' '||last_name)) as name, year_of_birth, residence from hp_patient_register where patient_no ILIKE '%"+jTextField113.getText()+"%' and last_visit > current_date - 5 order by second_name")); 
            ...
            if(this.jCheckBox11.isSelected() && this.jCheckBox4.isSelected()){
                if(jTextField113.getCaretPosition() < 3){
                    System.out.println("Nothing");
                         ...
                         jSearchTable2.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"SELECT patient_no, (upper(second_name||' '||first_name||' '||last_name)) as name, year_of_birth, residence from hp_patient_register where second_name||' '||first_name||' '||last_name ILIKE '%"+jTextField113.getText()+"%' and last_visit > current_date - 5 order by second_name")); 
        ...
        if(this.jCheckBox21.isSelected() && this.jCheckBox3.isSelected()){
            ...
            if(jTextField113.getCaretPosition() < 3){
                System.out.println("Nothing");
                       ...
                       jSearchTable2.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"SELECT patient_no, (upper(second_name||' '||first_name||' '||last_name)) as name, year_of_birth, residence from hp_inpatient_register where patient_no ILIKE '"+jTextField113.getText()+"%' order by patient_no")); 
                ...
                user = rse121.getObject(1).toString();
                  for (int i = 0; i < jTable1.getRowCount(); i++){
                    if (jTable1.getModel().getValueAt(i,0) != null){
                      ...
                      pstmt21.setString(4,jTable1.getValueAt(i,0).toString());
                       
                        pstmt21.setString(5,cat);
                         // pstmt21.setString(6,jTable1.getValueAt(i,0).toString());
                        pstmt21.setString(6,jTextField911.getText());
                      
                           
                        pstmt21.setString(7,datePicker1.getDate().toString());
                      ...
                      pstmt21.setString(9,jEditorPane1.getText());
                        ...
                        pstmt21.setString(11,user);
                         if (jTable1.getModel().getValueAt(i,5) != null){
                              pstmt21.setString(12,jTable1.getValueAt(i,5).toString());
                          }else{
                               pstmt21.setString(12,"None");
                          }
