 ...
 * @author  root
 */
public class LabResultsIntfr1 extends javax.swing.JInternalFrame implements java.lang.Runnable {

    /** Creates new form loanpymntintfr */
    private javax.swing.JComboBox cmbox;
    java.sql.Connection connectDB = null;
    private LabResultsIntfr1.SearchThread searchThread = null;
    private LabResultsIntfr1.SearchServicesThread searchServicesThread = null;
    com.afrisoftech.lib.DBObject dbObject;
    org.netbeans.lib.sql.pool.PooledConnectionSource pConnDB = null;
    java.lang.Thread getListThread;
    boolean getList;

    public LabResultsIntfr1(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
        ...
        searchThread = new LabResultsIntfr1.SearchThread();
    ...
    private void jButton31ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton31ActionPerformed
        ...
        try {
            ...
            java.sql.ResultSet rsetTable1 = stmtTable1.executeQuery("select trans_date,patient_no,patient_name,payment_mode,service,quantity,amount,inv_no,doctor,'false' as bill,bed_no,curr_date::time(0) from pb_doctors_request where revenue_code ilike 'lab%' and paid = true AND collected = false and trans_date >= current_date -2 ORDER BY curr_date asc");
            ...
            java.sql.ResultSet rsetTable11 = stmtTable11.executeQuery("select trans_date,patient_no,patient_name,payment_mode,service,quantity,amount,inv_no,doctor,'false' as bill,bed_no,curr_date::time(0) from pb_doctors_request where revenue_code ilike 'ext%' and paid = true AND collected = false and trans_date>=current_date -1 ORDER BY trans_date asc");
    ...
    private void jTable11MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable11MouseClicked
        jTextField9.setText(jTable11.getValueAt(jTable11.getSelectedRow(), 1).toString());
        jTextField1.setText(jTable11.getValueAt(jTable11.getSelectedRow(), 2).toString());
        jTable3.setValueAt(jTable11.getValueAt(jTable11.getSelectedRow(), 4).toString(), 0, 0);
        ...
        try {
            ...
            java.sql.ResultSet rset1x = stmt1x.executeQuery("SELECT DISTINCT code FROM pb_operating_parameters WHERE service_type = '" + jTable3.getValueAt(0, 0).toString() + "'");
            while (rset1x.next()) {
            ...
            if (jTable11.getValueAt(i, 9) != null) {
                if (Boolean.valueOf(jTable11.getModel().getValueAt(i, 9).toString()) == java.lang.Boolean.TRUE) {
                    ...
                    if (request.startsWith("I")) {
                        ...
                        java.sql.PreparedStatement pstmt46 = connectDB.prepareStatement("UPDATE pb_doctors_request SET paid = true,collected = true where inv_no = '" + jTable11.getValueAt(jTable11.getSelectedRow(), 7).toString() + "' AND service = '" + jTable11.getValueAt(jTable11.getSelectedRow(), 4).toString() + "'");
        ...
        try {
            ...
            java.sql.ResultSet rsetTable1 = stmtTable1.executeQuery("select trans_date,patient_no,patient_name,payment_mode,service,quantity,amount,inv_no,doctor,'false' as bill,bed_no,curr_date::time(0) from pb_doctors_request where revenue_code ilike 'lab%' and paid = true AND collected = false and trans_date >= current_date - 2 ORDER BY trans_date asc");
            ...
            java.sql.ResultSet rsetTable11 = stmtTable11.executeQuery("select trans_date,patient_no,patient_name,payment_mode,service,quantity,amount,inv_no,doctor,'false' as bill,bed_no,curr_date::time(0) from pb_doctors_request where revenue_code ilike 'ext%' and paid = true AND collected = false and trans_date>=current_date -10 ORDER BY trans_date asc");
...
//        jTextField91.setText(jSearchTable211.getValueAt(jSearchTable211.getSelectedRow(), 0).toString());
    ...
    private void jSearchTable2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jSearchTable2MouseClicked
        ...
        jTextField1.setText(jSearchTable2.getValueAt(jSearchTable2.getSelectedRow(), 1).toString());
        jTextField9.setText(jSearchTable2.getValueAt(jSearchTable2.getSelectedRow(), 0).toString());
        jTextField911.setText(jSearchTable2.getValueAt(jSearchTable2.getSelectedRow(), 3).toString());
        if (jTextField9.getText().equalsIgnoreCase("")) {
            jTextField9.setText("WK" + jTextField911.getText());
        }
        this.jSearchDialog2.dispose();
        int k = 0;
        if (this.jCheckBox11.isSelected()) {
            try {
                ...
                java.sql.ResultSet rset1xv = stmt1xv.executeQuery("SELECT DISTINCT service FROM "
                        + "hp_patient_billing WHERE patient_no = '" + jTextField9.getText() + "' AND "
                        + "revenue_code ilike 'labo%' AND paid = true and collected = false "
                        ...
                        + "UNION ALL SELECT DISTINCT description FROM ac_cash_collection WHERE "
                        + "receipt_no = '" + jTextField911.getText() + "' ");
            ...
            try {
                ...
                java.sql.Statement stmt1xv = connectDB.createStatement();
                java.sql.ResultSet rset1xv = stmt1xv.executeQuery("SELECT DISTINCT service FROM hp_patient_billing WHERE patient_no = '" + jTextField9.getText() + "' AND collected = false AND revenue_code ILIKE 'labo%'");
...
//        other.setVisible(true);  // Add your handling code here:
                    ...
                    if (this.jPanel11.isVisible()) {
                        for (int i = 0; i < jTable1.getRowCount(); i++) {
                            if (jTable1.getModel().getValueAt(i, 0) != null) {
                                ...
                                java.sql.PreparedStatement pstmt31 = connectDB.prepareStatement("UPDATE pb_doctors_request set collected = true WHERE service = '" + this.jTable3.getValueAt(jTable3.getSelectedRow(), 0).toString() + "' and patient_no ='" + jTextField9.getText() + "'");
                                ...
                                pstmt21.setDouble(15, java.lang.Double.valueOf(jTextField4.getText()));
                                pstmt21.setString(20, user);
                                pstmt21.setObject(17, jTextField82.getText());
                        ...
                        for (int i = 0; i < jTable2.getRowCount(); i++) {
                            if (jTable2.getModel().getValueAt(i, 0) != null) {
                                ...
                                pstmt21.executeUpdate();
                                java.sql.PreparedStatement pstmt31 = connectDB.prepareStatement("UPDATE pb_doctors_request set collected = true WHERE service = '" + jTable3.getValueAt(jTable3.getSelectedRow(), 0).toString() + "' AND patient_no ='" + jTextField9.getText() + "'");
                                pstmt31.executeUpdate();

                                java.sql.PreparedStatement pstmt31x = connectDB.prepareStatement("UPDATE pb_doctors_request set collected = true WHERE service = '" + jTable3.getValueAt(jTable3.getSelectedRow(), 0).toString() + "' AND patient_no ='" + jTextField9.getText() + "'");
 ...
 System.out.println("Have you passed here ehh ??????");
                    if (jCheckBox21.isSelected()) {
                        System.out.println(datenowSql.toString());
                        //   try{
                        String billNo = null;
