 ...
 * @author  root
 */
public class XrayPendingRequestsIntfr extends javax.swing.JInternalFrame implements java.lang.Runnable {
    ...
    public XrayPendingRequestsIntfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {
        ...
        jScrollPane1.setViewportView(confirmrequeststable);
        ...
        try {
            ...
            for (int i = 0; i < confirmrequeststable.getRowCount(); i++) {
                if (confirmrequeststable.getValueAt(i, 9) != null) {
                    ...
                    if (Boolean.valueOf(confirmrequeststable.getModel().getValueAt(i, 9).toString()) == java.lang.Boolean.TRUE) {
 java.sql.ResultSet rse121 = stm121q.executeQuery("SELECT distinct gl_account,main_service from pb_operating_parameters pb, pb_activity pa WHERE "
         + "pb.gl_account = pa.code AND pa.department ILIKE 'XRY' AND service_type ILIKE '"+confirmrequeststable.getValueAt(i, 4)+"'");
                ...
                glAcc = rse121.getObject(2).toString();
                        ...
                        if (request.startsWith("I")) {
                            ...
                            if (!(confirmrequeststable.getValueAt(i, 3).toString().equals("Cash"))) {
                                java.sql.ResultSet rse1 = stm1.executeQuery("select pay_mode,account_no,description,payer,payer,expiry_date,account_no from hp_inpatient_register where patient_no ='" + confirmrequeststable.getValueAt(i, 1).toString() + "'");
                                while (rse1.next()) {
                            ...
                            while (rse121.next()) {
                                ...
                                pstmt.setString(11, "");
                                pstmt.setObject(12, confirmrequeststable.getValueAt(i, 6).toString());
                                pstmt.setString(13, "0.00");
                                pstmt.setString(14, confirmrequeststable.getValueAt(i, 0).toString());
                                pstmt.setObject(15, patientAcc);
                                pstmt.setString(16, glAcc);
                                pstmt.setObject(17, confirmrequeststable.getValueAt(i, 5).toString());
                                ...
                                pstmt2.setObject(17, confirmrequeststable.getValueAt(i, 6).toString());
                                pstmt2.setString(18, confirmrequeststable.getValueAt(i, 0).toString());
                            ...
                            java.sql.PreparedStatement pstmt46 = connectDB.prepareStatement("UPDATE pb_doctors_request SET paid = true,collected = false where inv_no = '" + confirmrequeststable.getValueAt(confirmrequeststable.getSelectedRow(), 7).toString() + "' AND service = '" + confirmrequeststable.getValueAt(confirmrequeststable.getSelectedRow(), 4).toString() + "'");
                            ...
                            java.sql.Statement ps11w1 = connectDB.createStatement();
                            java.sql.ResultSet rst11w1 = ps11w1.executeQuery("select distinct slip_no from credit_acc_slip where patient_no = '" + confirmrequeststable.getValueAt(confirmrequeststable.getSelectedRow(), 1).toString() + "' order by date desc limit 1");
                            while (rst11w1.next()) {
                            ...
                            while (rse121.next()) {
                                ...
                                pstmt2v.setObject(17, confirmrequeststable.getValueAt(i, 6).toString());
                                pstmt2v.setString(18, confirmrequeststable.getValueAt(i, 0).toString());
    ...
    private void confirmrequeststableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_confirmrequeststableMouseClicked
        ...
        try {
            ...
            java.sql.ResultSet rse121 = stm121q.executeQuery("select distinct gl_account,main_service from pb_operating_parameters where main_service ilike '%xra%'");
            ...
            int i = confirmrequeststable.getSelectedRow();
...
*/
                        ...
                        java.sql.PreparedStatement pstmt46 = connectDB.prepareStatement("UPDATE pb_doctors_request SET paid = false,collected = false where inv_no = '" + confirmrequeststable.getValueAt(confirmrequeststable.getSelectedRow(), 7).toString() + "' AND service = '" + confirmrequeststable.getValueAt(confirmrequeststable.getSelectedRow(), 4).toString() + "'");
                        pstmt46.executeUpdate();
                        java.sql.PreparedStatement pstmt461 = connectDB.prepareStatement("UPDATE hp_patient_billing SET paid = false,collected = true where inpatient_no = '" + confirmrequeststable.getValueAt(confirmrequeststable.getSelectedRow(), 7).toString() + "' AND service = '" + confirmrequeststable.getValueAt(confirmrequeststable.getSelectedRow(), 4).toString() + "'");
    ...
    public void runGetListThread() {
        ...
        try {
            ...
            java.sql.ResultSet rsetTable11 = stmtTable11.executeQuery("SELECT DISTINCT count(patient_no) from pb_doctors_request pb, pb_activity pa "
                    + "WHERE pb.requisition_no='LAB' AND "
                    + " pb.gl_code = pa.code AND pa.department ILIKE 'XRY' and paid = false AND collected = false and trans_date >= (select current_timestamp(0)::date -2) ");
            ...
            java.sql.ResultSet rsetTable1 = stmtTable1.executeQuery(""
                    + "select trans_date,patient_no,patient_name,pb.payment_mode,service,quantity,amount,inv_no,doctor,'false' as bill,"
                    + "bed_no,time_due from pb_doctors_request pb, pb_activity pa"
                    + " WHERE pb.requisition_no='LAB' and  pb.gl_code = pa.code AND pa.department ILIKE 'XRY' and paid = false AND collected = false and trans_date >= "
                    + "(select current_timestamp(0)::date -2) ORDER BY trans_date asc");


            while (rsetTable1.next()) {

                confirmrequeststable.setValueAt(rsetTable1.getObject(1), i, 0);
                confirmrequeststable.setValueAt(rsetTable1.getObject(2), i, 1);
                confirmrequeststable.setValueAt(rsetTable1.getObject(3), i, 2);
                confirmrequeststable.setValueAt(rsetTable1.getObject(4), i, 3);
                confirmrequeststable.setValueAt(rsetTable1.getObject(5), i, 4);
                confirmrequeststable.setValueAt(rsetTable1.getObject(6), i, 5);
                confirmrequeststable.setValueAt(rsetTable1.getObject(7), i, 6);
                confirmrequeststable.setValueAt(rsetTable1.getObject(8), i, 7);
                confirmrequeststable.setValueAt(rsetTable1.getObject(9), i, 8);
                confirmrequeststable.setValueAt(java.lang.Boolean.valueOf(false), i, 9);
                confirmrequeststable.setValueAt(rsetTable1.getObject(11), i, 10);
                confirmrequeststable.setValueAt(rsetTable1.getObject(12), i, 11);
