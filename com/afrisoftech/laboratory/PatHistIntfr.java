 ...
 * @author  root
 */
public class PatHistIntfr extends javax.swing.JInternalFrame {
    ...
    public PatHistIntfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        crset4.setCommand("SELECT disease_name FROM HP_DISEASES where diseases_category  ilike 'Life%' order by disease_name");
        ...
        */
        ...
        crset41.setCommand("SELECT description FROM pb_contraceptives where category  ilike 'contr%' order by description");
        crset41.setConnectionSource(pConnDB);
        crset411.setCommand("SELECT description FROM pb_contraceptives where category  ilike 'drug%' order by description");
        ...
        jComboBox1.setModel(new org.netbeans.lib.sql.models.ComboBoxModel (crset41, "description", null, null, null));
        ...
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
        gridBagConstraints.weightx = 1.0;
        jPanel2.add(jPanel91, gridBagConstraints);
        ...
        jComboBox11.setModel(new org.netbeans.lib.sql.models.ComboBoxModel (crset4, "disease_name", null, null, null));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 3;
        gridBagConstraints.gridy = 1;
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
        gridBagConstraints.weightx = 1.0;
        jPanel911.add(jComboBox11, gridBagConstraints);
        ...
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
        gridBagConstraints.weightx = 1.0;
        jPanel2.add(jPanel911, gridBagConstraints);
        ...
        jComboBox111.setModel(new org.netbeans.lib.sql.models.ComboBoxModel (crset411, "description", null, null, null));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 3;
        gridBagConstraints.gridy = 1;
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
        gridBagConstraints.weightx = 1.0;
        jPanel9111.add(jComboBox111, gridBagConstraints);
        ...
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
        gridBagConstraints.weightx = 1.0;
        jPanel2.add(jPanel9111, gridBagConstraints);
        ...
        gridBagConstraints.ipady = -10;
        gridBagConstraints.weightx = 1.0;
        jPanel2.add(jPanel92, gridBagConstraints);
        ...
        gridBagConstraints.ipady = -10;
        gridBagConstraints.weightx = 1.0;
        jPanel2.add(jPanel921, gridBagConstraints);
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Symptom", "Absent", "Duration(days)", "Low", "Moderate", "Marked", "Description"
            }
        ) {
            Class[] types = new Class [] {
                java.lang.Object.class, java.lang.Boolean.class, java.lang.Object.class, java.lang.Boolean.class, java.lang.Boolean.class, java.lang.Boolean.class, java.lang.Object.class
            };
        ...
        jLabel11.setText("Degree of Severity");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 3;
        gridBagConstraints.gridy = 0;
        ...
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 1;
        jPanel3.add(jCheckBox32, gridBagConstraints);
    ...
    private void jTextField11311CaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextField11311CaretUpdate
        try {
            ...
            searchRowSet211.execute("select first_name||' '||middle_name as name from pb_doctors_list where status ilike  'active' and  first_name||' '||middle_name ILIKE '%"+jTextField11311.getText()+"%'  order by name");
    ...
    private void jTextField1131CaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextField1131CaretUpdate
        ...
        try {
            ...
            searchRowSet21.execute("SELECT distinct initcap(test) as test from pb_clinical where test ILIKE '"+jTextField1131.getText()+"%'  order by test");
        ...
        try {
            ...
            for (int i = 0; i < jTable1.getRowCount(); i++){
                if (jTable1.getModel().getValueAt(i,0) != null){
                        /*
                          if (Boolean.valueOf(jTable1.getModel().getValueAt(i, 1).toString()) == java.lang.Boolean.TRUE) {
                      Rst = "Absent";
                          }else{
                          }
                                  if (Boolean.valueOf(jTable1.getModel().getValueAt(i, 2).toString()) == java.lang.Boolean.TRUE) {
                  ...
                  pstmt21.setString(10,jComboBox11.getSelectedItem().toString());
                    ...
                    //                      pstmt21.setString(9,jEditorPane1.getText());
                      ...
                      pstmt21.setString(16,jTable1.getValueAt(i,0).toString());
                      pstmt21.setString(17,Rst);
                     if (jTable1.getModel().getValueAt(i,2) != null){
                        pstmt21.setString(18,jTable1.getValueAt(i,2).toString());
                    }else{
                        pstmt21.setString(18,"00");
                    }
                      if (jTable1.getModel().getValueAt(i,6) != null){
                        pstmt21.setString(19,jTable1.getValueAt(i,6).toString());
                    }else{
