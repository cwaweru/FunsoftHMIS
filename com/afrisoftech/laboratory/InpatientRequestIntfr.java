...
public class InpatientRequestIntfr extends javax.swing.JInternalFrame implements java.lang.Runnable {
    ...
    public InpatientRequestIntfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB, com.afrisoftech.hospital.HospitalMain parentHospitalFrame) {
    ...
    private void initComponents() {
        ...
        */
        ...
        jTextField13.setBorder(javax.swing.BorderFactory.createTitledBorder("Type of Xray"));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 0;
        gridBagConstraints.gridwidth = 7;
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
        jPanel34.add(jTextField13, gridBagConstraints);
        ...
        jPanel25.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Has the patient Been Previously X-rayed", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.BELOW_TOP));
        ...
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
        jPanel82.add(jPanel25, gridBagConstraints);

        jScrollPane131.setMinimumSize(new java.awt.Dimension(0, 0));
        jScrollPane131.setPreferredSize(new java.awt.Dimension(0, 0));

        jEditorPane112.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Notes/Observations", javax.swing.border.TitledBorder.LEFT, javax.swing.border.TitledBorder.DEFAULT_POSITION));
        ...
        jPanel82.add(jScrollPane131, gridBagConstraints);
        ...
        jComboBox13.setModel(com.afrisoftech.lib.ComboBoxModel.ComboBoxModel(connectDB, "select ward_name from hp_wards order by ward_name"));
        ...
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
        jPanel23.add(jComboBox13, gridBagConstraints);
        ...
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 4;
        jPanel23.add(jCheckBox52, gridBagConstraints);
        ...
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 4;
        jPanel23.add(jCheckBox63, gridBagConstraints);

        jLabel94.setText("Patient No");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 1;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        ...
        jTextField15.setMinimumSize(new java.awt.Dimension(50, 20));
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        gridBagConstraints.weightx = 1.0;
        jPanel23.add(jTextField15, gridBagConstraints);
        ...
        jTextPane2.setMinimumSize(new java.awt.Dimension(0, 0));
        jTextPane2.setPreferredSize(new java.awt.Dimension(0, 0));
        ...
        gridBagConstraints.weighty = 1.0;
        gridBagConstraints.insets = new java.awt.Insets(0, 10, 0, 0);
        jPanel93.add(jScrollPane4, gridBagConstraints);
    ...
    private void jButton541ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton541ActionPerformed
        ...
        pol.RefferalExtPdf(connectDB, jTextField923.getText(), jTextField923.getText());   // Add your handling code here:
    ...
    private void jButton122ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton122ActionPerformed
        if (this.jTextField115.getText().equals("") || jTextField115.getText().equals(null)) {
            ...
            try {
                ...
                com.afrisoftech.laboratory.RefferalExtPdf pol = new com.afrisoftech.laboratory.RefferalExtPdf();
                pol.RefferalExtPdf(connectDB, jTextField923.getText(), jTextField923.getText());
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        policy.InPatientFilePdf(connectDB, datePicker11.getDate(), datePicker11.getDate(), jTextField92.getText());
    ...
    private void jButton13ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton13ActionPerformed
        ...
        diagnosis = jTable2.getValueAt(0, 1) + " " + jTable2.getValueAt(1, 1) + " " + jTextField13.getText();
...
//            this.jEditorPane113.setText("");
    ...
    private void jButton82ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton82ActionPerformed
        String receiptNo = null;
        receiptNo = this.jTextField92.getText().toString();
    ...
    private void searchButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchButton2ActionPerformed
        if (jComboBox13.getSelectedItem().toString().equalsIgnoreCase("-")) {
            javax.swing.JOptionPane.showMessageDialog(this, "Please choose type of Ward you are Located", "Information Message!", javax.swing.JOptionPane.INFORMATION_MESSAGE);
    ...
    private void jSearchTable2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jSearchTable2MouseClicked
        ...
        if (jSearchTable2.getValueAt(jSearchTable2.getSelectedRow(), 4).toString().startsWith("M")) {
            jCheckBox52.setSelected(true);
        } else {
            jCheckBox63.setSelected(true);
        }
        jTextField15.setText(jSearchTable2.getValueAt(jSearchTable2.getSelectedRow(), 2).toString());
       ...
       /* try {
            ...
            rset1s = stmt1s.executeQuery("SELECT COUNT(patient_no) FROM ac_cash_collection WHERE patient_no ='" + jTextField92.getText() + "' AND date >= current_date -1 ");
            while (rset1s.next()) {
                p = rset1s.getInt(1);
            }
            ...
            /*if (p < 1 && !jTextField7.getText().startsWith("Schem") && !exempt) {
               ...
               /* if (jTextField7.getText().startsWith("Schem")) {
                    ...
                    rset1 = stmt1.executeQuery("select sex,ROUND((current_date - year_of_birth::date)/365) AS age ,account_no,description,card_no from hp_patient_register where patient_no ='" + jTextField92.getText() + "' ");
                    while (rset1.next()) {
                    ...
                    //rset = st.executeQuery("select  'WEIGHT '||weight||' HEGHT '||height||' DIASTOLIC '||diastolic||' SYSTOLIC '||systolic||' PULSE '||pulse||' TEMP ' ||temp||' RESP ' ||resp||' BLOOD SUGAR '||rbs|| 'COMMENTS' ||comments FROM hp_signs_record WHERE  input_date::date = current_date AND patient_no ='" + jTextField92.getText() + "'");
...
*
    ...
    private void populateTable1g(java.lang.String patient_no) {
        ...
        try {
            if (this.jCheckBox21.isSelected()) {
                ...
                java.sql.ResultSet rset = stmt.executeQuery("SELECT count(main_service) FROM hp_patient_diagnosis WHERE patient_no = '" + patient_no + "' and date_recorded = CURRENT_DATE");
                ...
                if (j > 0) {
                    ...
                    java.sql.ResultSet rsetTable1 = stmtTable1.executeQuery("SELECT main_service,disease FROM hp_patient_diagnosis WHERE patient_no = '" + patient_no + "' and date_recorded = CURRENT_DATE");
    ...
    private void jTextField113CaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextField113CaretUpdate
        ...
        if (this.jCheckBox21.isSelected() && this.jCheckBox32.isSelected()) {
            ...
            if (jTextField113.getCaretPosition() < 3) {
                ...
                jSearchTable2.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB, "SELECT patient_no, patient_name AS name,pat_age, ward,gender FROM hp_admission WHERE patient_no ILIKE '%" + jTextField113.getText() + "%' AND discharge = false AND ward = '"+jComboBox13.getSelectedItem()+"' ORDER BY 1"));
            ...
            if (this.jCheckBox21.isSelected() && this.jCheckBox4.isSelected()) {
                jSearchTable2.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB, "SELECT patient_no, patient_name AS name,pat_age, ward,gender FROM hp_admission WHERE patient_name ILIKE '%" + jTextField113.getText() + "%' AND discharge = false AND ward = '"+jComboBox13.getSelectedItem()+"' ORDER BY 2"));
    ...
    private void jSearchTable211MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jSearchTable211MouseClicked
        jTextField92.setText(jSearchTable211.getValueAt(jSearchTable211.getSelectedRow(), 0).toString());
    ...
    private void jSearchTable21MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jSearchTable21MouseClicked
        jTextField92.setText(jSearchTable21.getValueAt(jSearchTable21.getSelectedRow(), 0).toString());
        //        jTextField3.setText(jSearchTable21.getValueAt(jSearchTable21.getSelectedRow(), 1).toString());
    ...
    private void jSearchTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jSearchTable1MouseClicked
        ...
        try {
            ...
            if (j > 0) {
                java.sql.ResultSet rs = pstmt.executeQuery("select sum(qty) from stock_balance_qty where item_code ilike '" + jTable111.getValueAt(jTable111.getSelectedRow(), 8) + "' and department ilike 'Pharma%' AND dates <= '" + datePicker11.getDate() + "'");
    ...
    private void cmboxMouseClicked() {
        ...
        System.out.println("Showing dialog");
        java.awt.Point point = jCheckBox42.getLocationOnScreen();
...
//      this.jLabel16.setVisible(false);
    ...
    private void jTextField111CaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextField111CaretUpdate
        if (this.jCheckBox42.isSelected()) {
            ...
            if (jTextField111.getCaretPosition() < 2) {
                ...
                jSearchTable1.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB, "select product as Drug,selling_price as price,gl_code as gl_code,product_id FROM st_stock_prices,st_stock_item WHERE product_id ILIKE '%" + jTextField111.getText() + "%' and opd = true AND product_id = item_code order by 1"));
                //  select product as service_type,selling_price as price,gl_code FROM st_stock_prices WHERE product ILIKE '%"+jTextField11.getText()+"%' AND department ilike '"+jComboBox1.getSelectedItem()+"%' order by service_type
            ...
            if (jTextField111.getCaretPosition() < 2) {
                ...
                jSearchTable1.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB, "select product as Drug,selling_price as price,gl_code,product_id FROM st_stock_prices,st_stock_item WHERE product ILIKE '%" + jTextField111.getText() + "%' and opd = true AND product_id = item_code ORDER BY 1"));
    ...
    private void searchButtonClicked() {
        ...
        System.out.println("Showing dialog");
        java.awt.Point point = jScrollPane131.getLocationOnScreen();
