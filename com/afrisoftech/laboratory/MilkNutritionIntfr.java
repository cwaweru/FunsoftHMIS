 ...
 * @author  root
 */
public class MilkNutritionIntfr extends javax.swing.JInternalFrame {
    ...
    public MilkNutritionIntfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        jCheckBox1.setText("View Patients");
    ...
    private void jCheckBox1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jCheckBox1ActionPerformed
        ...
        try {
           ...
           // java.sql.ResultSet rsetTable1 = stmtTable1.executeQuery("select adno ,ward,bedno,charges,upper(name) as name from bed_charges_view");
             java.sql.ResultSet rsetTable1 = stmtTable1.executeQuery("select patient_no ,bed_no,upper(patient_name) as name from hp_admission  where discharge = false and ward ilike '"+jComboBox1.getSelectedItem().toString()+"' order by patient_no");
