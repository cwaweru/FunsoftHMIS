...
public class RefferalExtPdf implements java.lang.Runnable {
    ...
    public void RefferalExtPdf(java.sql.Connection connDb, java.lang.String combox,java.lang.String combox1) {
        MNo = combox;
        MNo1 = combox1;
        connectDB = connDb;
                ...
                try {
                    ...
                    try {
                        ...
                        try {
                            ...
                            java.sql.ResultSet rset = st.executeQuery("select patient_no,patient_name,rank,unit,transfer_to,ward,diag,reason,initcap(notes),sex,consultant,nurse,doctor,bed_no as age from hp_refferal_ext where patient_no = '"+MNo+"' order by input_date desc limit 1");
                            //  java.sql.ResultSet rset1 = st1.executeQuery("select date_admitted from hp_admission where visit_id = '"+MNo1+"' ");
                            table.getDefaultCell().setColspan(3);
                            table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_CENTER);
                            phrase = new Phrase("REFERRAL LETTER", pFontHeader1);
                            table.addCell(phrase);
                            table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_CENTER);
                            phrase = new Phrase(" ", pFontHeader);
                            table.addCell(phrase);
