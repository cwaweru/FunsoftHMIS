 ...
 * @author  root
 */
public class TurningChartIntfr extends javax.swing.JInternalFrame {
    ...
    public TurningChartIntfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        */
        ...
        gridBagConstraints.gridy = 6;
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
        jPanel212.add(jTextField3, gridBagConstraints);
    ...
    private void jSearchTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jSearchTableMouseClicked
      ...
      try {
         ...
         java.sql.Statement stm11 = connectDB.createStatement();
                            java.sql.ResultSet rse11 = stm11.executeQuery("select ward,bed_no,visit_id from hp_admissions where patient_no='"+jTextField9.getText()+"'");
                            
                            while (rse11.next()){
                             jTextField16.setText(rse11.getObject(1).toString());
                           jTextField25.setText(rse11.getObject(2).toString());
                             
                           jTextField1.setText(rse11.getObject(3).toString());
    ...
    private void jButton1111ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1111ActionPerformed
        ...
        try {
           ...
           // pstmtx.setObject(4,jTextField3.getText());
            ...
            pstmtx.setObject(8,jTextField2.getText());
           
            

            pstmtx.setString(11,user);
           pstmtx.setString(10,"'now'");
          pstmtx.setObject(12,jTextField3.getText());
