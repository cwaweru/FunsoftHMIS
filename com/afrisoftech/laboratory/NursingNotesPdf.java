...
public class NursingNotesPdf implements java.lang.Runnable {
    ...
    public void NursingNotesPdf(java.sql.Connection connDb, java.lang.String combox,java.lang.String combox1) {
        MNo = combox;
        MNo1 = combox1;
        connectDB = connDb;
            ...
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        Phrase phrase = new Phrase("");
                           phrase = new Phrase("NURSING CARE REPORT", pFontHeader);
                                table.addCell(phrase);
                            ...
                            java.sql.ResultSet rset = st.executeQuery("select patient_no,initcap(first_name||' '||second_name),upper(category),initcap(unit) from hp_inpatient_register where patient_no = '"+MNo+"'");
                              table.getDefaultCell().setColspan(2);
                               java.sql.ResultSet rseta = sta.executeQuery("select distinct ward,bed_no,admission_reason,date_admitted from hp_admission where patient_no = '"+MNo+"' order by date_admitted asc limit 1");
                                  ...
                                  java.sql.ResultSet rsetN = st1.executeQuery("select user_name||' '||DATE||' '|| input_date::time(0),notes from hp_clinical_ip where patient_no = '"+MNo+"'");
