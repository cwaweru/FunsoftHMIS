    ...
    private void jTextField1111CaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextField1111CaretUpdate
        ...
        if(this.jCheckBox3.isSelected()){
            if(jTextField1111.getCaretPosition() < 3){
                ...
                jSearchTable1.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"SELECT patient_no, (upper(second_name||' '||first_name||' '||last_name)) as name from hp_patient_register where (upper(second_name||' '||first_name||' '||last_name))  ILIKE '"+jTextField1111.getText()+"%' order by second_name"));
            ...
            if(this.jCheckBox4.isSelected()){
                if(jTextField1111.getCaretPosition() < 3){
                    ...
                    jSearchTable1.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"SELECT patient_no, (upper(second_name||' '||first_name||' '||last_name)) as name from hp_inpatient_register where second_name||' '||first_name||' '||last_name ILIKE '"+jTextField1111.getText()+"%' order by second_name"));
                ...
                if(this.jCheckBox1.isSelected()){
                    if(jTextField1111.getCaretPosition() < 3){
                        ...
                        jSearchTable1.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"SELECT 'wk' as wk,patient_name from pb_walkins where patient_name ILIKE '"+jTextField1111.getText()+"%' order by patient_name"));
    ...
    private void jTextField111CaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextField111CaretUpdate
        ...
        if(this.jCheckBox3.isSelected()){
            if(jTextField111.getCaretPosition() < 3){
                ...
                jSearchTable.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"SELECT patient_no, (upper(second_name||' '||first_name||' '||last_name)) as name from hp_patient_register where patient_no ILIKE '"+jTextField111.getText()+"%' order by patient_no"));
            ...
            if(this.jCheckBox4.isSelected()){
                if(jTextField111.getCaretPosition() < 3){
                   ...
                   jSearchTable.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"SELECT patient_no, (upper(second_name||' '||first_name||' '||last_name)) as name from hp_inpatient_register where patient_no ILIKE '"+jTextField111.getText()+"%' order by patient_no"));
