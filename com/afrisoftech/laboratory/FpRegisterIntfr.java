                ...
                //try {
                    ...
                    //try {
                        ...
                        //try {
                            ...
                            setMaximizable(true);
                            setResizable(true);
                            setTitle("FP Client Registration");
                            ...
                            jCheckBox8.setText("Search By Client No");
                            ...
                            jRadioButton1.setText("Create new Client File");
                            ...
                            jCheckBox1.setText("Consultation Fee?");
                            ...
                            gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
                            gridBagConstraints.insets = new java.awt.Insets(0, 20, 0, 0);
                            jPanel8.add(jLabel241, gridBagConstraints);
                            ...
                            gridBagConstraints.weighty = 1.0;
                            gridBagConstraints.insets = new java.awt.Insets(0, 20, 0, 0);
                            jPanel8.add(jLabel572, gridBagConstraints);
                            ...
                            gridBagConstraints.weighty = 1.0;
                            gridBagConstraints.insets = new java.awt.Insets(0, 20, 0, 0);
                            jPanel8.add(jLabel582, gridBagConstraints);
                            ...
                            gridBagConstraints.weightx = 1.0;
                            gridBagConstraints.insets = new java.awt.Insets(0, 20, 0, 0);
                            jPanel8.add(jLabel66, gridBagConstraints);
                            ...
                            gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTH;
                            gridBagConstraints.weightx = 1.0;
                            jPanel8.add(jPanel4111, gridBagConstraints);
                            ...
                            gridBagConstraints.weightx = 1.0;
                            gridBagConstraints.weighty = 1.0;
                            jPanel8.add(jTextField171, gridBagConstraints);

                            jLabel6.setText("Information Source");
                            gridBagConstraints = new java.awt.GridBagConstraints();
                            gridBagConstraints.gridx = 0;
                            gridBagConstraints.gridy = 9;
                            gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
                            ...
                            jComboBox2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Radio", "Television", "Newspapers", "Journals & Periodicals", "Bill boards", "Social groupings", "Bronchure", "Client", "Community Health Worker" }));
                            gridBagConstraints = new java.awt.GridBagConstraints();
                            gridBagConstraints.gridx = 1;
                            gridBagConstraints.gridy = 9;
                            gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
                            ...
                            gridBagConstraints.weightx = 1.0;
                            gridBagConstraints.weighty = 1.0;
                            jPanel8.add(datePicker41, gridBagConstraints);
                            ...
                            gridBagConstraints.weighty = 1.0;
                            gridBagConstraints.insets = new java.awt.Insets(0, 20, 0, 0);
                            jPanel9.add(idNoLbl, gridBagConstraints);
                            ...
                            gridBagConstraints.weighty = 1.0;
                            gridBagConstraints.insets = new java.awt.Insets(0, 0, 0, 10);
                            jPanel9.add(idNoTxt, gridBagConstraints);

                            passPortNoLbl.setText("Pass Port No.");
                            gridBagConstraints = new java.awt.GridBagConstraints();
                            gridBagConstraints.gridx = 3;
                            gridBagConstraints.gridy = 6;
                            gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
                            ...
                            gridBagConstraints.weighty = 1.0;
                            gridBagConstraints.insets = new java.awt.Insets(0, 20, 0, 0);
                            jPanel9.add(passPortNoLbl, gridBagConstraints);
                            ...
                            gridBagConstraints.weighty = 1.0;
                            gridBagConstraints.insets = new java.awt.Insets(0, 0, 0, 10);
                            jPanel9.add(passPortNoTxt, gridBagConstraints);
                            ...
                            jComboBox6.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Teacher" }));
                            gridBagConstraints = new java.awt.GridBagConstraints();
                            gridBagConstraints.gridx = 4;
                            gridBagConstraints.gridy = 10;
                            gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
                            ...
                            gridBagConstraints.weightx = 1.0;
                            gridBagConstraints.weighty = 1.0;
                            jPanel9.add(jComboBox6, gridBagConstraints);
                            ...
                            jComboBox5.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Never attended school", "Primary level", "Secondary level", "College level" }));
                            gridBagConstraints = new java.awt.GridBagConstraints();
                            gridBagConstraints.gridx = 4;
                            gridBagConstraints.gridy = 9;
                            gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
    ...
    private void jSearchTable111MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jSearchTable111MouseClicked
        ...
        try {
            ...
            while (rset.next()){
                ...
                try {
                    datePicker41.setDate(sdf.parse(dbObject.getDBObject(rset.getObject(3), "-")));
            ...
            try {
                ...
                if(this.jComboBox1.getSelectedItem().equals("Cash")){
                    if (jRadioButton2.isSelected()){
                        ...
                        java.sql.PreparedStatement pstmt1 = connectDB.prepareStatement("UPDATE hp_patient_register set pay_mode = '"+jComboBox1.getSelectedItem().toString()+"',category = '"+jComboBox4.getSelectedItem().toString()+"',last_visit = '"+datePicker4.getDate().toString()+"'  WHERE patient_no = '"+jTextField3.getText()+"'");
                        ...
                        if (jRadioButton1.isSelected()){
                            ...
                            if(this.jTextField3.getText().equalsIgnoreCase(patientNo)){
                                ...
                                pstmt.setString(8,datePicker41.getDate().toString());
                                ...
                                pstmt.setString(11,datePicker4.getDate().toString());
                                ...
                                pstmt.setString(18,datePicker4.getDate().toString());
                                pstmt.setObject(19,"");
                                pstmt.setString(20,"");
                                pstmt.setString(21,"");
                    ...
                    if(this.jPanel2.isShowing()){
                        if(jRadioButton2.isSelected()){
                            java.sql.PreparedStatement pstmt = connectDB.prepareStatement("UPDATE hp_patient_register set description = '"+jComboBox3.getSelectedItem().toString()+"',payer = '"+jTextField7.getText()+"',account_no ='"+jTextField8.getText()+"',expiry_date = '"+datePicker1.getDate().toString()+"',last_visit = '"+datePicker4.getDate().toString()+"',pay_mode = '"+jComboBox1.getSelectedItem().toString()+"' WHERE patient_no ilike '"+jTextField3.getText()+"%'");
                            pstmt.executeUpdate();
                        }else{
                            if (jRadioButton1.isSelected()){
                                    ...
                                    if (exp.before(date)){
                                        ...
                                        if (term.before(time)){
                                            ...
                                            if (balance > limit){
                                                ...
                                                if(jRadioButton2.isSelected()){
                                                    java.sql.PreparedStatement pstmt11 = connectDB.prepareStatement("UPDATE hp_patient_register set description = '"+jTextField361.getText()+"',payer = '"+jTextField2.getText()+"',account_no ='"+jTextField13.getText()+"',expiry_date = '"+jTextField18.getText().toString()+"',member_name ='"+jTextField36.getText()+"',last_visit = '"+datePicker4.getDate().toString()+"',pay_mode = '"+jComboBox1.getSelectedItem().toString()+"' WHERE patient_no ilike '"+jTextField3.getText()+"'");
                ...
                pstmt21a.setString(5,slipNo);
                pstmt21a.setString(6,activity);
                pstmt21a.setString(7,"1");
                pstmt21a.setString(8,mainAcc);
                pstmt21a.setString(9,"0.00");
                pstmt21a.setString(11,datePicker4.getDate().toString());
                pstmt21a.setString(10,"");
                pstmt21a.setString(12,"0");
                pstmt21a.setString(14,user);
                pstmt21a.setString(13,"");
                pstmt21a.setString(15,"'now'");
