...
public class ClinicianNotesPdf implements java.lang.Runnable {
    ...
    public void ClinicianNotesPdf(java.sql.Connection connDb, java.lang.String combox,java.lang.String combox1) {
        MNo = combox;
        MNo1 = combox1;
        connectDB = connDb;
            ...
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        Phrase phrase = new Phrase("");
                           phrase = new Phrase("Clinician's Notes", pFontHeader);
                                table.addCell(phrase);
                            ...
                            java.sql.ResultSet rset = st.executeQuery("select patient_no,initcap(first_name||' '||second_name),upper(category),initcap(unit) from hp_inpatient_register where patient_no = '"+MNo+"'");
                              table.getDefaultCell().setColspan(2);
                               java.sql.ResultSet rseta = sta.executeQuery("select distinct ward,bed_no,admission_reason,date_admitted from hp_admission where patient_no = '"+MNo+"' order by date_admitted asc limit 1");
                                  ...
                                  java.sql.ResultSet rsetN = st1.executeQuery("select input_by||' '||input_date||' '||input_time::time(0),notes from hp_doc_notes  where patient_no = '"+MNo+"'");
                                ...
                                table.getDefaultCell().setColspan(1);
                                table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                                phrase = new Phrase("SERVICE NO   " +rset.getObject(1).toString(), pFontHeader);
                                table.addCell(phrase);
                                 while (rseta.next()) 
                                 table.getDefaultCell().setColspan(1);
                                table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                                phrase = new Phrase("DOA   " +rseta.getObject(4).toString(), pFontHeader);
                                table.addCell(phrase);
                                 while (rset.next()) 
                                table.getDefaultCell().setColspan(1);
                                table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                                ...
                                table.addCell(phrase);
                                 while (rseta.next()) 
                                 table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                                phrase = new Phrase("WARD : "+rseta.getObject(1).toString(), pFontHeader);
                                table.addCell(phrase);
                                table.getDefaultCell().setColspan(1);
                                 while (rset.next()) 
                                table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                                ...
                                table.addCell(phrase);
                                 while (rseta.next()) 
                                 table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                                phrase = new Phrase("BED NO : "+rseta.getObject(2).toString(), pFontHeader);
                                table.addCell(phrase);
                                table.getDefaultCell().setColspan(1);
                                 while (rset.next()) 
                                table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                                ...
                                while (rseta.next()) 
                                 table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                                phrase = new Phrase("DIAGNOSIS : "+rseta.getObject(3).toString(), pFontHeader);
                                table.addCell(phrase);
