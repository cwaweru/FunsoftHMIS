                ...
                try {
                    ...
                    try {
                        ...
                        try {
                            ...
                            java.sql.ResultSet rsetS1 = stmtS1.executeQuery("SELECT DISTINCT pb_lab_standards.test_status  from pb_lab_standards, hp_lab_results where pb_lab_standards.test = hp_lab_results.typeof_test AND hp_lab_results.lab_no = '"+INV01+"'");
                            
                            while (rsetS1.next()) {
                                
                                teststatus = rsetS1.getString(1);
                                
                            }
                            
                            java.sql.ResultSet rset = st.executeQuery("select DISTINCT patient_no,initcap(patient_name),gender,age,doctor,lab_no,date from hp_lab_results where lab_no = '"+INV01+"'");
                            while (rset.next()){
                            ...
                            for (int j = 0; j < listofStaffNos.length; j++) {
                                ...
                                for (int k = 0; k < listofStaffNos1.length; k++) {
                                    ...
                                    java.sql.ResultSet rset11 = st11.executeQuery("select DISTINCT date from hp_lab_results where lab_no = '"+listofStaffNos[j]+"' AND typeof_test ilike '"+listofStaffNos1[k]+"'");
                                    
                                    java.sql.ResultSet rset1 = st1.executeQuery("select DISTINCT date,parameter,result,lower_limit,upper_limit,result from hp_lab_results where lab_no = '"+listofStaffNos[j]+"' AND typeof_test ilike '"+listofStaffNos1[k]+"' ORDER BY parameter");
                                    while (rset11.next()){
                                        table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                                        table.getDefaultCell().setColspan(4);
                                        phrase = new Phrase(listofStaffNos1[k].toString()+ "  Date Requested : "+dbObject.getDBObject(rset11.getObject(1), "-"),pFontHeader1);
                                        
                                        table.addCell(phrase);
                                        
                                        table.getDefaultCell().setColspan(2);
                                        phrase = new Phrase("Specimen From : ",pFontHeader1);
                                        //phrase = new Phrase("Specimen From : "+dbObject.getDBObject(rset11.getObject(2), "-"),pFontHeader1);

                                        table.addCell(phrase);
                                        
                                    }
                                    
                                    //if (teststatus.equalsIgnoreCase("true")){
                                        while (rset1.next()){
                                    ...
                                    /*}else{
                                        ...
                                        if (teststatus.equalsIgnoreCase("PN")){
                                            ...
                                            while (rset1.next()){
                                                ...
                                                results =  rset1.getObject(3).toString();
                                                if (results.equalsIgnoreCase("true")){
                                                    ...
                                                    phrase = new Phrase("Negative", pFontHeader);
                                            ...
                                            if (teststatus.equalsIgnoreCase("PR")){
                                                 while (rset1.next()){
                                    ...
                                    java.sql.ResultSet rset12 = st121.executeQuery("select comments from hp_lab_results where typeof_test ilike '"+listofStaffNos1[k]+"' AND lab_no = '"+listofStaffNos[j]+"'  ORDER BY parameter");
                                    ...
                                    while (rset12.next()){
                                       ...
                                       // interpret = rset12.getObject(2).toString();
                                        // table.addCell(phrase);
                                    }
                            ...
                            phrase = new Phrase("Interpretition", pFontHeader11);
                            table.addCell(phrase);
                            
                            table.getDefaultCell().setColspan(6);
                            
                           // phrase = new Phrase(interpret,pFontHeader);
                            phrase = new Phrase("",pFontHeader);
...
docPdf.close();  com.afrisoftech.lib.PDFRenderer.renderPDF(tempFile);
    ...
    public java.lang.Object[] getListofStaffNos1(java.lang.Object InvoiceNo) {
        ...
        try {
            ...
            java.sql.PreparedStatement pSet1 = connectDB.prepareStatement("SELECT distinct upper(typeof_test) FROM hp_lab_results WHERE lab_no = '"+InvoiceNo+"' AND typeof_test is not null order by upper(typeof_test)");
            java.sql.ResultSet rSet1 = pSet1.executeQuery();
