...
public class PhyPendingRequestsIntfr extends javax.swing.JInternalFrame implements java.lang.Runnable {
    ...
    private void initComponents() {
        ...
        setMaximizable(true);
        setResizable(true);
        setTitle("Physiotherapy Requests");
        setFrameIcon(null);
        try {
            setSelected(true);
    ...
    public void runGetListThread() {
        ...
        try {
            ...
            java.sql.ResultSet rsetTable11 = stmtTable11.executeQuery("select distinct count(patient_no) from pb_doctors_request where revenue_code ilike 'phy%' and paid = false AND collected = false and trans_date>=(select current_timestamp(0)::date -2)");
            ...
            java.sql.ResultSet rsetTable1 = stmtTable1.executeQuery("select trans_date,patient_no,patient_name,payment_mode,service,quantity,amount,inv_no,doctor,'false' as bill,bed_no,time_due from pb_doctors_request where revenue_code ilike 'phy%' and paid = false AND collected = false and trans_date>=(select current_timestamp(0)::date -2) ORDER BY trans_date asc");
