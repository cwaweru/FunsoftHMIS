...
public class LabProceduresIntfr extends javax.swing.JInternalFrame {
    ...
    private void jTextField11121CaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextField11121CaretUpdate
        if(jTextField11121.getCaretPosition() > 2){
            ...
            jSearchTable111.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"select distinct patient_name from hp_patient_billing where patient_name ILIKE '"+jTextField11121.getText()+"%' AND (patient_no ='' and inpatient_no ='') ORDER BY patient_name ASC"));
    ...
    private void jTextField1111CaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextField1111CaretUpdate
        if(jTextField1111.getCaretPosition() > 2){
            ...
            if (jCheckBox1.isSelected() && jCheckBox5.isSelected()){
                jSearchTable1.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"select trim(patient_no) as scheme,second_name||' '||first_name||' '||last_name as name from hp_patient_register where second_name||' '||first_name||' '||last_name ILIKE '"+jTextField1111.getText().toString()+"%' and last_visit > current_date - 5  order by second_name"));
                ...
                if (jCheckBox1.isSelected() && jCheckBox4.isSelected()){
                    jSearchTable1.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"select trim(patient_no) as scheme,second_name||' '||first_name||' '||last_name as name from hp_patient_register where patient_no ILIKE '"+jTextField1111.getText().toString()+"%' and last_visit > current_date - 5  order by patient_no"));
                    ...
                    if (jCheckBox2.isSelected() && jCheckBox5.isSelected()){
                        jSearchTable1.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"select trim(patient_no) as scheme,second_name||' '||first_name||' '||last_name as name from hp_inpatient_register where second_name||' '||first_name||' '||last_name ILIKE '"+jTextField1111.getText().toString()+"%' ORDER BY second_name"));
                        ...
                        if (jCheckBox2.isSelected() && jCheckBox4.isSelected()){
                            jSearchTable1.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"select trim(patient_no) as scheme,second_name||' '||first_name||' '||last_name as name from hp_inpatient_register where patient_no ILIKE '"+jTextField1111.getText().toString()+"%' ORDER BY patient_no"));
    ...
    private void jButton11ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton11ActionPerformed
        ...
        if(datePicker1.getDate().before(periodFrom) || datePicker1.getDate().after(periodTo)){
            ...
            try {
                ...
                java.sql.ResultSet rset = stmtz.executeQuery("select visit_id  from hp_admission where patient_no ='"+jTextField36.getText()+"' and discharge = false");
                while (rset.next()){
                ...
                java.sql.Statement ps0 = connectDB.createStatement();
                java.sql.ResultSet rst110 = ps0.executeQuery("select nextval('visit_no_seq')");
                while (rst110.next()){
                    transNo1 = rst110.getObject(1).toString();
...
// Add your handling code here:
    ...
    private void jTextField111CaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextField111CaretUpdate
        jSearchTable.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"select service_type,rate as price,gl_account as gl_code FROM pb_operating_parameters,pb_activity pa WHERE service_type ILIKE '"+jTextField111.getText()+"%' AND pb.gl_account = pa.code AND pa.department ILIKE 'LAB' AND collected = false order by service_type"));
