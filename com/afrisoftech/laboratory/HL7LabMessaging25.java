 ...
 */
public class HL7LabMessaging25 {

    private static final org.apache.log4j.Logger log = Logger.getLogger(HL7LabMessaging25.class);
...
//    }
    public static void main(String args[]) throws LLPException {
        ...
        //  link.loadProperties();
        // link.start();
        HL7LabMessaging25 hl7Messaging = new HL7LabMessaging25();

    }

    public HL7LabMessaging25() {
    }
    ...
    public static void setPATIENT_CITIZENSHIP(String PATIENT_CITIZENSHIP) {
        HL7LabMessaging25.PATIENT_CITIZENSHIP = PATIENT_CITIZENSHIP;
    }
    ...
    public static void setPATIENT_LAB_SERVICE(String PATIENT_LAB_SERVICE) {
        HL7LabMessaging25.PATIENT_LAB_SERVICE = PATIENT_LAB_SERVICE;
    }
    ...
    public static void setLAB_DEPARTMENT(String LAB_DEPARTMENT) {
        HL7LabMessaging25.LAB_DEPARTMENT = LAB_DEPARTMENT;
    }
    ...
    public static void setLAB_SERVICE_CODE(String LAB_SERVICE_CODE) {
        HL7LabMessaging25.LAB_SERVICE_CODE = LAB_SERVICE_CODE;
    }
    ...
    public static void setLAB_REQUEST_NO(String LAB_REQUEST_NO) {
        HL7LabMessaging25.LAB_REQUEST_NO = LAB_REQUEST_NO;
    }
    ...
    public static void setLAB_REQUESTED_BY(String LAB_REQUESTED_BY) {
        HL7LabMessaging25.LAB_REQUESTED_BY = LAB_REQUESTED_BY;
    }
    ...
    public static void setLAB_RADIOGRAPHER(String LAB_RADIOGRAPHER) {
        HL7LabMessaging25.LAB_RADIOGRAPHER = LAB_RADIOGRAPHER;
    }
    ...
    public static void setLAB_RESULT_NUMBER(String LAB_RESULT_NUMBER) {
        HL7LabMessaging25.LAB_RESULT_NUMBER = LAB_RESULT_NUMBER;
    }
    ...
    public static void setLAB_RESULTS_FINDING(String LAB_RESULTS_FINDING) {
        HL7LabMessaging25.LAB_RESULTS_FINDING = LAB_RESULTS_FINDING;
    }
    ...
    public static void setLAB_SERVICE_DATE(String LAB_SERVICE_DATE) {
        HL7LabMessaging25.LAB_SERVICE_DATE = LAB_SERVICE_DATE;
    }
    ...
    public static void setLAB_REASON(String LAB_REASON) {
        HL7LabMessaging25.LAB_REASON = LAB_REASON;
    }
    ...
    public static void setLAB_REMARKS(String LAB_REMARKS) {
        HL7LabMessaging25.LAB_REMARKS = LAB_REMARKS;
    }
    ...
    public static void setLAB_OWN_REMARKS(String LAB_OWN_REMARKS) {
        HL7LabMessaging25.LAB_OWN_REMARKS = LAB_OWN_REMARKS;
    }
    ...
    public static void setPOINT_OF_CARE(String POINT_OF_CARE) {
        HL7LabMessaging25.POINT_OF_CARE = POINT_OF_CARE;
    }
    ...
    public static void setLAB_CATEGORY(String LAB_CATEGORY) {
        HL7LabMessaging25.LAB_CATEGORY = LAB_CATEGORY;
    }
    ...
    public static void setPATIENT_DATE_OF_BIRTH_STRING(String PATIENT_DATE_OF_BIRTH_STRING) {
        HL7LabMessaging25.PATIENT_DATE_OF_BIRTH_STRING = PATIENT_DATE_OF_BIRTH_STRING;
    }
    ...
    public static void setLAB_REQUEST_TIME(String LAB_REQUEST_TIME) {
        HL7LabMessaging25.LAB_REQUEST_TIME = LAB_REQUEST_TIME;
    }
...
//        hl7Dao.getHL7Messaging(connectDB, patientNo);
//
//        // return revArray;
//        adt = new ADT_A01();
...
//            
//            
//            mshSegment.getReceivingFacility().getNamespaceID().setValue("CPGH");//getFACILITY_NAME()
//            mshSegment.getReceivingFacility().getUniversalID().setValue("4333.2333");
//           
//            
//            
...
//            
//            createRadiologyOrderMessage(socketORM);
//
...
//        createRadiologyOrderMessage(socket, null, "", "");
...
//        }
//    }
    public static OML_O33 createLaboratoryOrderMessage(Socket socket, java.sql.Connection connectDB, String patientNo,
            String type, String specimenID, String universalDescription, String universalCode, String doctor, String date, String rackNo, String tubePosition, String machineModel, boolean setpositioning) throws HL7Exception, IOException {
...
//
        ...
        msh.getReceivingApplication().getNamespaceID().setValue(machineModel);

        String receivingFacility = com.afrisoftech.laboratory.HL7LabMessaging.getFacilityCode(connectDB, patientNo, type);
        String[] parts = receivingFacility.split("-");
        String facilityName = parts[0]; // 004
        String facilityCode = parts[1];

        msh.getReceivingFacility().getNamespaceID().setValue("Laboratory");//facilityName
        //msh.getReceivingFacility().getUniversalID().setValue(facilityCode);

        HL7Utils25.populateMessageHeader(msh, new Date(), "OML", "O33", "CGTRH");//FACILITY_NAME
        msh.getSendingFacility().getUniversalID().setValue("");
        ...
        msh.getMessageProfileIdentifier(0).getEi1_EntityIdentifier().setValue("LAB-28");
        ...
        ca.uhn.hl7v2.model.v25.group.OML_O33_PATIENT patient = message.getPATIENT();
        ...
        pid.getAlternatePatientIDPID(0).getCx1_IDNumber().setValue(PATIENT_ID);//added by sam
        ...
        pid.getDateTimeOfBirth().getTime().setValue(PATIENT_DATE_OF_BIRTH_STRING);
        pid.getAdministrativeSex().setValue(PATIENT_GENDER);
...
//        patient.getNTE(1).getSetIDNTE().setValue("1");
        ...
        pv1.getAssignedPatientLocation().getPersonLocationType().setValue("Funsoft EMR");
        // pv1.getPreadmitNumber().getID().setValue(PATIENT_ID);
        pv1.getPv119_VisitNumber().getIDNumber().setValue(PATIENT_VISIT_ID);
        // pv1.getAlternateVisitID().getID().setValue(PATIENT_VISIT_ID);
...
//        orc.getOrderStatus().setValue("DC");
        ...
        // http://www.mexi.be/documents/hl7/ch400024.htm  http://www.mexi.be/documents/hl7/ch700010.htm
////        obr.getPlacerOrderNumber().getEntityIdentifier().setValue(PATIENT_ID);
...
//            pslab.setString(1, patientNo);
        ...
        try {
            pslab = connectDB.prepareStatement(""
                    ...
                    + "  WHERE patient_no = ? AND  universal_code != '' and activity_code IN (SELECT code FROM pb_activity WHERE department = 'LAB') and dr.service_type = op.service_type "
                    + "  and activity_code = gl_account AND dr.date = CURRENT_DATE AND service_posted = FALSE   "
                    + "  ORDER BY 2,1");
            pslab.setString(1, patientNo);
...
//                HL7LabMessaging.setLAB_CATEGORY(rslab.getString("category"));
            ...
            String activitytime = date; //rslab.getString("curr_date");
            ...
            //---------------------------------------------------------------------------
            HL7LabMessaging25.setPATIENT_LAB_SERVICE(universalDescription);//service
            HL7LabMessaging25.setLAB_DEPARTMENT("LABORATORY");
            HL7LabMessaging25.setLAB_SERVICE_CODE(universalCode);//code
            HL7LabMessaging25.setLAB_REQUEST_NO((specimenID));//row_id
            HL7LabMessaging25.setLAB_REQUESTED_BY(doctor);
            HL7LabMessaging25.setLAB_RESULT_NUMBER("");
            HL7LabMessaging25.setLAB_RESULTS_FINDING("");
            HL7LabMessaging25.setLAB_SERVICE_DATE(date);
            HL7LabMessaging25.setLAB_REASON("notes");
            HL7LabMessaging25.setLAB_REMARKS("");
            HL7LabMessaging25.setLAB_OWN_REMARKS("");
            HL7LabMessaging25.setPOINT_OF_CARE("clinic");
            HL7LabMessaging25.setPATIENT_VISIT_ID(specimenID);
            HL7LabMessaging25.setLAB_CATEGORY("category");
            HL7LabMessaging25.setLAB_REQUEST_TIME(activitytime);

            String trayID = rackNo;
            //int tubePositionInTray = Integer.p(tubePosition);

            //SPM spm = new SPM(message, message.getModelClassFactory());
            SPM spm = message.getSPECIMEN().getSPM();
//                ca.uhn.hl7v2.model.v25.segment.SPM sp = null;
            //spm.getSpecimenID().getFillerAssignedIdentifier().getUniversalID().setValue("SPM001");
            spm.getSetIDSPM().setValue("1"); //CWW
            //spm.getSpecimenID().getPlacerAssignedIdentifier().getUniversalID().setValue("SPM001");
            spm.getSpm11_SpecimenRole(0).getCwe1_Identifier().setValue("P");
            spm.getSpm11_SpecimenRole(0).getCwe3_NameOfCodingSystem().setValue("HL70369");

            ca.uhn.hl7v2.model.v25.segment.SAC sac = message.getSPECIMEN().getSAC();
            
            if(setpositioning){
                sac.getCarrierIdentifier().getEntityIdentifier().setValue(trayID);
                sac.getPositionInCarrier().getValue1().setValue(String.valueOf(tubePosition));
            }else{
                sac.getContainerIdentifier().getEntityIdentifier().setValue(specimenID);
            
            }
//                sac.getTrayIdentifier().getEntityIdentifier().setValue(trayID);
//                sac.getPositionInTray().getValue1().setValue(String.valueOf(tubePositionInTray));

            //message.getORDER(1).getORC().getPlacerOrderNumber().getUniversalID().setValue("XR0001");
            //ca.uhn.hl7v2.model.v25.segment.ORC orc = message.getORDER().getORC();
            ca.uhn.hl7v2.model.v25.segment.ORC orc = message.getSPECIMEN().getORDER().getORC();

            //message.getORDER(i).getORC().getPlacerOrderNumber().getUniversalID().setValue("XR0001");
//                message.getORDER(i).getORC().getPlacerOrderNumber().getEntityIdentifier().setValue(PATIENT_ID);
//                message.getORDER(i).getORC().getFillerOrderNumber().getEntityIdentifier().setValue(PATIENT_VISIT_ID);
            message.getSPECIMEN().getORDER().getORC().getOrderControl().setValue("NW");
            message.getSPECIMEN().getORDER(i).getORC().getOrderControl().setValue("NW");

            //orc.getOrderingProvider(0).getGivenName().setValue("LABWARE");
//                message.getORDER(i).getORC().getOrderingProvider(0).getIdentifierTypeCode().setValue("Funsoft HMIS");
//                message.getORDER(i).getORC().getOrderingProvider(0).getIDNumber().setValue("DrSTING"); //ORDERING PHYSICIAON
//
//                //orc.getOrc21_OrderingFacilityName(0).getIDNumber().setValue("CPGH");
//                message.getORDER(i).getORC().getOrc21_OrderingFacilityName(0).getOrganizationIdentifier().setValue("CGTRH");
            ca.uhn.hl7v2.model.v25.segment.OBR obr = message.getSPECIMEN().getORDER().getOBSERVATION_REQUEST().getOBR();

            obr.getPlacerOrderNumber().getEntityIdentifier().setValue("OID0001");
//                obr.getFillerOrderNumber().getEntityIdentifier().setValue(PATIENT_VISIT_ID);
            obr.getUniversalServiceIdentifier().getIdentifier().setValue("CBC"); //LAB_SERVICE_CODE
            obr.getUniversalServiceIdentifier().getCe3_NameOfCodingSystem().setValue("99UNK");
            // obr.getUniversalServiceIdentifier().getText().setValue(PATIENT_LAB_SERVICE);//PATIENT_LAB_SERVICE

            //----------------
            ca.uhn.hl7v2.model.v25.segment.OBR obrx = message.getSPECIMEN().getORDER(i).getOBSERVATION_REQUEST().getOBR();

            obrx.getPlacerOrderNumber().getEntityIdentifier().setValue("OID0001");
//                obr.getFillerOrderNumber().getEntityIdentifier().setValue(PATIENT_VISIT_ID);
            obrx.getUniversalServiceIdentifier().getIdentifier().setValue("DIFF"); //
            obrx.getUniversalServiceIdentifier().getCe3_NameOfCodingSystem().setValue("99UNK");

            //obr.getResultStatus().setValue("F");
            //services = services + PATIENT_LAB_SERVICE + " | " ;
            ...
            //obr.getScheduledDateTime().getTime().setValue(getCurrentDate());
            i++;
...
//        nte.getComment(1).setValue(LAB_REMARKS);
        ...
        System.out.println(encodedMessage);
        System.out.println("Path to output file: " + System.getProperty("user.dir", "/root") + "/ORMMessage.er7");
//        writeToFile(testHL7MessageToTransmit.toString(), "D:\\HL7/ORMMessage.er7");

        //writeToFile(encodedMessage.toString(), System.getProperty("user.dir", "/root") + "/ORMMessage.er7");
        testHL7MessageToTransmit.toString();
        InputStream in = socket.getInputStream();
        OutputStream out = socket.getOutputStream();
        // Send the MLLP-wrapped HL7 message to the server
        ...
        out.write(testHL7MessageToTransmit.toString().getBytes());
        com.afrisoftech.laboratory.HL7LabMessaging.logRequest(connectDB, PATIENT_ID, PATIENT_FAMILY_SURNAME + " " + PATIENT_GIVEN_NAME, services, "", "ORM", encodedMessage);

        //out.write(encodedMessage.getBytes());
        byte[] byteBuffer = new byte[200];
        in.read(byteBuffer);

        System.err.println("-------------ee-----------" + services);
        ...
        if (response.contains("Received")) {
            try {
                java.sql.PreparedStatement psUpdateUpload = null;
                java.sql.PreparedStatement pstmtData = null;
                psUpdateUpload = connectDB.prepareStatement(""
                        + " UPDATE hp_specimen_register SET service_posted = ? "
                        + " WHERE specimen_id = ? ");
                psUpdateUpload.setBoolean(1, Boolean.valueOf("TRUE"));
                psUpdateUpload.setString(2, specimenID);
                // psUpdateUpload.setString(4, rsetActivityCode.getString("sub_rev_type_name"));
                psUpdateUpload.execute();
                psUpdateUpload.close();
                psUpdateUpload = null;
