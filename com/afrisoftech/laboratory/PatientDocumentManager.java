 ...
 * @author root
 */
public class PatientDocumentManager extends javax.swing.JInternalFrame {
     ...
     */
    public PatientDocumentManager(java.sql.Connection dbConn) {
    ...
    private void initComponents() {
        ...
        */
        ...
        headerPanel.setBorder(javax.swing.BorderFactory.createTitledBorder("Please set the patient file number before proceeding"));
        headerPanel.setLayout(new java.awt.GridBagLayout());

        staffNoLbl.setText("Service Number");
        gridBagConstraints = new java.awt.GridBagConstraints();
        ...
        staffNameLbl.setText("Patient Name");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 1;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        ...
        designationLbl.setText("Residence");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        ...
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
        headerPanel.add(patNameTxt, gridBagConstraints);
        ...
        gridBagConstraints.weighty = 1.0;
        headerPanel.add(residenceTxt, gridBagConstraints);
        ...
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
        searchPanel.add(patNoTxt, gridBagConstraints);
        ...
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
        actionPanel.add(patientCardviewBtn, gridBagConstraints);
    ...
    private void employeeSearchTxtCaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_employeeSearchTxtCaretUpdate
        if (employeeSearchTxt.getCaretPosition() < 2) {
            ...
            employeeSearchTable.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB, "select patient_no as service_no,first_name||' '||second_name||' '||last_name AS name,residence, (now()::date-year_of_birth::date)/365 AS age from hp_patient_register where ( first_name||' '||second_name||' '||last_name ILIKE '%" + employeeSearchTxt.getText() + "%' OR patient_no ILIKE '%" + employeeSearchTxt.getText() + "%' ) ORDER BY 1 "));
    ...
    private void employeeSearchTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_employeeSearchTableMouseClicked
        ...
        patNoTxt.setText(employeeSearchTable.getValueAt(employeeSearchTable.getSelectedRow(), 0).toString());
        patNameTxt.setText(employeeSearchTable.getValueAt(employeeSearchTable.getSelectedRow(), 1).toString());
        residenceTxt.setText(employeeSearchTable.getValueAt(employeeSearchTable.getSelectedRow(), 2).toString());
        ageTxt.setText(employeeSearchTable.getValueAt(employeeSearchTable.getSelectedRow(), 3).toString());
...
//
//            }
            documentIdentityTxt.setText(patNoTxt.getText() + " : " + patNameTxt.getText());
    ...
    private void attachDocsBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_attachDocsBtnActionPerformed
        ...
        if (patNoTxt.getText().length() > 1 && patNameTxt.getText().length() > 1) {

            //String orderNumber = com.afrisoftech.lib.ProcurementFunctions.getOrderNumber(connectDB, refNoTxt.getText());
            com.afrisoftech.hospinventory.DocumentationPatientIntfr docmanage = new com.afrisoftech.hospinventory.DocumentationPatientIntfr(connectDB, null);

            docmanage.refNotxt.setText(patNoTxt.getText());

            //        docmanage.orderNoTxt.setText(employeeNumberTxt.getText());
            docmanage.docNameTxt.setText(patNameTxt.getText());
            ...
            javax.swing.JOptionPane.showMessageDialog(this, "Please select a patient file!");
        }
    ...
    private void indexBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_indexBtnActionPerformed
        ...
        if (documentIdentityTxt.getText().length() > 5 && !folioTypeCmbx.getSelectedItem().toString().equalsIgnoreCase("-")) {
            ...
            try {
                ...
                pstmtIndex.setString(3, patNoTxt.getText());
...
//        }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if (patNoTxt.getText().length() > 2) {
            File file = null;
            String ref = patNoTxt.getText();
            indexingBodyPanel.removeAll();
            indexingBodyPanel.add(new javax.swing.JPanel());
            // String orderNumber = com.afrisoftech.lib.ProcurementFunctions.getOrderNumber(connectDB, ref);
            file = getSelectedPagesPDF(connectDB, ref, null);
...
//                dispose();
    ...
    private void patientCardviewBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_patientCardviewBtnActionPerformed
        ...
        //
        policyReport.PatientCardPdf(connectDB, transdatePicker.getDate(), transdatePicker.getDate(), patNoTxt.getText(),false);
                    ...
                    for (int page = 1; page <= n; page++) {
                        ...
                        try {
                            ...
                            if (folioTypeCmbx.getSelectedItem().equals("-")) {
                                ...
                                pstmtSelectPages.setString(1, patNoTxt.getText());
