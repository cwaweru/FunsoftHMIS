...
public class PatientDiagIntfr extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        */
        ...
        this.jComboBox1.setSelectedItem("");
        jComboBox1.setModel(com.afrisoftech.lib.ComboBoxModel.ComboBoxModel(connectDB, "select first_name||' '||middle_name as name from pb_doctors_list"));
        this.jComboBox1.setSelectedItem("");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
    ...
    private void jSearchTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jSearchTableMouseClicked
       String Sex =null;
        ...
        jTextField1.setText(jSearchTable.getValueAt(jSearchTable.getSelectedRow(), 1).toString());
         ...
         Sex = (jSearchTable.getValueAt(jSearchTable.getSelectedRow(), 3).toString());
    ...
    private void jTextField111CaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextField111CaretUpdate
        ...
        if(this.jCheckBox1.isSelected() && this.jCheckBox31.isSelected()){
            ...
            if(jTextField111.getCaretPosition() < 3){
                ...
                jSearchTable.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"SELECT patient_no, (upper(second_name||' '||first_name)) as name, year_of_birth,sex from hp_patient_register where patient_no ILIKE '%"+jTextField111.getText()+"%' and last_visit > current_date - 30 order by second_name"));
            ...
            if(this.jCheckBox1.isSelected() && this.jCheckBox4.isSelected()){
                if(jTextField111.getCaretPosition() < 2){
                    ...
                    jSearchTable.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"SELECT patient_no, (upper(second_name||' '||first_name)) as name, year_of_birth,sex residence from hp_patient_register where second_name||' '||first_name ILIKE '%"+jTextField111.getText()+"%' and last_visit > current_date - 60 order by second_name"));
        ...
        if(this.jCheckBox2.isSelected() && this.jCheckBox31.isSelected()){
            ...
            if(jTextField111.getCaretPosition() < 3){
                ...
                jSearchTable.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"SELECT patient_no, (upper(second_name||' '||first_name)) as name, year_of_birth,sex from hp_inpatient_register where patient_no ILIKE '%"+jTextField111.getText()+"%' order by second_name"));
            ...
            if(this.jCheckBox2.isSelected() && this.jCheckBox4.isSelected()){
                jSearchTable.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"SELECT patient_no, (upper(second_name||' '||first_name)) as name, year_of_birth, sex from hp_inpatient_register where second_name||' '||first_name ILIKE '%"+jTextField111.getText()+"%' order by second_name"));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(this.jCheckBox2.isSelected()){
         ...
         if(this.jCheckBox9.isSelected()){
             sex = this.jCheckBox9.getText(); 
        }
        else{
           sex = this.jCheckBox8.getText(); 
        }
        
        
         if(this.jCheckBox6.isSelected()){
             status = this.jCheckBox6.getText(); 
        }
        else{
          status = this.jCheckBox7.getText(); 
        }
        try {
            ...
            for (int i = 0; i < jTable1.getRowCount(); i++){
                if (jTable1.getModel().getValueAt(i,1) != null){
                    ...
                    pstmt.setString(10,datePicker11.getDate().toString());
                     ...
                     pstmt.setString(12,jTextField21.getText());
