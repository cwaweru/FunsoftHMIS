 ...
 * @author  root
 */
public class NurseProfIntfr extends javax.swing.JInternalFrame {
    ...
    public NurseProfIntfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        */
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Parameter", "Yes", "Don't Know", "Interested", "Not Interested"
            }
        ) {
    ...
    private void jTextField1131CaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextField1131CaretUpdate
        ...
        try {
            ...
            searchRowSet21.execute("SELECT distinct initcap(test) as test from pb_clinical where test ILIKE '"+jTextField1131.getText()+"%' and clinical ilike 'Nurs%'  order by test");
