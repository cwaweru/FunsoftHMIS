...
public class SpecimensIntfr extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jButton1.setText("Save specimen data");
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Set  lab specimens  here.", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Dialog", 1, 12), new java.awt.Color(0, 51, 255))); // NOI18N
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Specimen Code", "Specimen Description", "Specimen Source"
            }
        ));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        jTable1.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB, "SELECT code,specimen,source FROM pb_lab_specimen"));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            if (jButton1.getText().equalsIgnoreCase("update")) {
                ...
                java.sql.PreparedStatement pstmt = connectDB.prepareStatement("UPDATE pb_lab_specimen SET specimen = ? , source = ?, date = ? WHERE code = ?");
                for (int i = 0; i < jTable1.getRowCount(); i++) {
                    if (jTable1.getModel().getValueAt(i, 0) != null) {
                        ...
                        pstmt.setDate(3, new java.sql.Date(java.util.Calendar.getInstance().getTimeInMillis()));
