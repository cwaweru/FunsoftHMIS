...
public class LabReqByDocDetPdf implements java.lang.Runnable {
    ...
    public void LabReqByDocDetPdf(java.sql.Connection connDb, java.util.Date begindate, java.util.Date endate,java.lang.String combox2) {
            ...
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        java.sql.ResultSet rset4c = st4c.executeQuery("select initcap(activity) from pb_activity where code  = '"+MNo1+"'"); 
                        while(rset4c.next()){
                            Dept = rset4c.getObject(1).toString();
                        }
                    ...
                    com.lowagie.text.HeaderFooter footer = new com.lowagie.text.HeaderFooter(new Phrase("OutPatients List by doctor - Page: "), true);// FontFactory.getFont(com.lowagie.text.FontFactory.HELVETICA, 12, Font.BOLDITALIC,java.awt.Color.blue));
                    ...
                    try {
                        ...
                        int headerwidths[] = {8,10,10,18,12,8};
                      ...
                      phrase = new Phrase(""+Dept+" Requests ",pFontHeader);
                        ...
                        try {
                          //  java.lang.Object[] listofAct = this.getListofActivities();
                           ...
                           // java.sql.Statement st11 = connectDB.createStatement();
                                ...
                                java.sql.PreparedStatement st1 = connectDB.prepareStatement("select initcap(doctor), count(service),sum(amount) from pb_doctors_request WHERE trans_date::date BETWEEN '"+beginDate+"' AND '"+endDate+"' and gl_code  = '"+MNo1+"' group by doctor order by doctor ");
                      java.sql.PreparedStatement st11 = connectDB.prepareStatement("select sum(amount) from pb_doctors_request WHERE trans_date::date BETWEEN '"+beginDate+"' AND '"+endDate+"' and gl_code  = '"+MNo1+"' group by doctor order by doctor ");
                               ...
                               // st1.setString(1,listofAct[i].toString());
                                ...
                                osBalancebf = osBalancebf + rset.getDouble(3);
                            ...
                            table.addCell(phrase);
                                  osBalancet = osBalance*100/osBalance;
