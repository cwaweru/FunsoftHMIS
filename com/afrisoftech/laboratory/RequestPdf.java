                ...
                try {
                    ...
                    try {
                        ...
                        try {
                            ...
                            java.sql.ResultSet rset5 = st5.executeQuery("select service,quantity,amount,ROUND(sum(amount/quantity)) from hp_patient_billing where patient_no = '"+MNo+"' and inpatient_no = '"+Receipt+"' group by service,quantity,amount");
                            java.sql.ResultSet rset6 = st6.executeQuery("select distinct user_name from hp_patient_billing where inpatient_no = '"+Receipt+"'");
                            java.sql.ResultSet rset61 = st61.executeQuery("select distinct revenue_code from hp_patient_billing where inpatient_no = '"+Receipt+"'");
