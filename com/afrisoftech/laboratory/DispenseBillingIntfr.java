    ...
    private void initComponents() {
        ...
        */
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Drugs", "Qty", "Presc No", "Route", "Frequency", "No Of Days", "Dosage", "Paid"
            }
        ) {
            Class[] types = new Class [] {
...
*/
    ...
    private void populateTable1(java.lang.String patient_no) {
        ...
        try {
            ...
            java.sql.ResultSet rsetTable11 = stmtTable11.executeQuery("SELECT count(patient_no)  FROM pb_doctors_request WHERE patient_no = '" + patient_no + "' AND trans_date >= current_date - 1");
            ...
            if (j > 0) {
                ...
                java.sql.ResultSet rsetTable1 = stmtTable1.executeQuery("SELECT " +
                        ...
                        "bed_no,time_due,dosage,paid::boolean " +
                        "FROM pb_doctors_request WHERE patient_no = '" + patient_no + "' " +
                        " AND trans_date = '" + datePicker1.getDate().toString() + "' AND collected = false" +
                        " AND revenue_code ilike 'pharm%' group by service, quantity,inv_no,requisition_no,bed_no,time_due,dosage,paid");
                ...
                for (int i = 0; i < jTable1.getRowCount(); i++) {
                    ...
                    if (jTable1.getModel().getValueAt(i, 0) != null && jTable1.getModel().getValueAt(i, 7) != null) {
                        if (Boolean.valueOf(jTable1.getModel().getValueAt(i, 7).toString()) == java.lang.Boolean.TRUE) {
                            ...
                            java.sql.PreparedStatement pstmt46 = connectDB.prepareStatement("UPDATE hp_pharmacy SET collected = true where patient_no = '" + jTextField9.getText() + "' and description ilike '" + jTable1.getValueAt(i, 0).toString() + "' and date_prescribed > current_date - 2");
                            pstmt46.executeUpdate();
                        }
                    }
                }
    ...
    public void runGetListThread() {
        ...
        try {
            ...
            java.sql.ResultSet rsetTable12 = stmtTable12.executeQuery("select distinct trans_date,patient_no,patient_name,inv_no,doctor,paid  from pb_doctors_request where revenue_code ilike '%pharm%' AND trans_date >= current_date -1  group by trans_date,patient_no,patient_name,inv_no,doctor,paid ORDER BY inv_no asc");
