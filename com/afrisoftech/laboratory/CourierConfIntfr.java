 ...
 * @author  root
 */
public class CourierConfIntfr extends javax.swing.JInternalFrame implements java.lang.Runnable {
    ...
    public CourierConfIntfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        setMaximizable(true);
        setResizable(true);
        setTitle("Sent Couriers Confirmation");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Date", "Time", "Way Bill No", "From", "To", "Priority", "Received"
            }
        ) {
            Class[] types = new Class [] {
                java.lang.Object.class, java.lang.Object.class, java.lang.Object.class, java.lang.Object.class, java.lang.Object.class, java.lang.Object.class, java.lang.Boolean.class
        ...
        try {
            ...
            if (jTable1.getValueAt(i,0) != null){
                if (Boolean.valueOf(jTable1.getModel().getValueAt(i, 6).toString()) == java.lang.Boolean.TRUE) {
                    ...
                    java.sql.PreparedStatement pstmt46 = connectDB.prepareStatement("UPDATE pb_courier SET delivered = true,dev_time =current_timestamp where wbill_no = '"+jTable1.getValueAt(jTable1.getSelectedRow(),2).toString()+"'");
            ...
            //}
            javax.swing.JOptionPane.showMessageDialog(this,"Successfuly Confirmed","Confirmation Message",javax.swing.JOptionPane.INFORMATION_MESSAGE);
  ...
  */
    ...
    public void runGetListThread() {
        ...
        try {
            ...
            java.sql.ResultSet rsetTable11 = stmtTable11.executeQuery("select distinct count(wbill_no) from pb_courier where delivered = false and sent = true ");
            ...
            java.sql.ResultSet rsetTable1 = stmtTable1.executeQuery("select distinct date,input_time,wbill_no,consigner_comp,consignee_comp,priority,delivered,input_date from pb_courier where delivered = false and sent = true ORDER BY input_date asc");
