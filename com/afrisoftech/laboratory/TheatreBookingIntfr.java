...
public class TheatreBookingIntfr extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        */
        ...
        searchButton11.setToolTipText("Search patient name");
        ...
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
        jPanel61.add(jTextField911, gridBagConstraints);
        ...
        searchButton111.setToolTipText("Search Patient's Name");
        ...
        gridBagConstraints.gridx = 2;
        gridBagConstraints.gridy = 1;
        jPanel611.add(searchButton111, gridBagConstraints);
        ...
        gridBagConstraints.insets = new java.awt.Insets(0, 0, 0, 10);
        gridBagConstraints.weightx = 1.0;
        jPanel2.add(jPanel611, gridBagConstraints);
        ...
        jScrollPane1.setBorder(new javax.swing.border.TitledBorder(null, "Notes", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Dialog", 0, 11), new java.awt.Color(0, 0, 255)));
...
private void searchButton1Clicked() {
    ...
    private void jSearchTable12MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jSearchTable12MouseClicked
         jTextField3611.setText(jSearchTable12.getValueAt(jSearchTable12.getSelectedRow(), 0).toString());
     //   jTextField5.setText(jSearchTable12.getValueAt(jSearchTable12.getSelectedRow(), 1).toString());
    ...
    private void jTextField1112CaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextField1112CaretUpdate
       jSearchTable12.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"select distinct service_type from pb_operating_parameters where service_type ILIKE '%"+jTextField1112.getText().toString()+"%' and category ilike 'th%' ORDER BY service_type"));
 ...
 private void searchButton121Clicked() {
    ...
    private void jButton91ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton91ActionPerformed
        jSearchDialog11.dispose();jSearchDialog11.dispose();// Add your handling code here:
    ...
    private void searchButton11ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchButton11ActionPerformed
      searchButton12Clicked();  searchButton12Clicked();    // Add your handling code here:
 ...
 private void searchButton12Clicked() {
    ...
    private void jSearchTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jSearchTable1MouseClicked
       ...
       // jTextField1.setText(jSearchTable1.getValueAt(jSearchTable1.getSelectedRow(), 3).toString());  // Add your handling code here:
    ...
    private void jTextField111CaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextField111CaretUpdate
            ...
            if(jTextField111.getCaretPosition() < 3){
                ...
                jSearchTable1.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"SELECT patient_no, (upper(second_name||' '||first_name)) as name,address,tel_no from hp_patient_register where patient_no ILIKE '"+jTextField111.getText()+"%' order by second_name"));
            ...
            if(this.jCheckBox1.isSelected() && this.jCheckBox4.isSelected()){
                if(jTextField111.getCaretPosition() < 3){
                    ...
                    jSearchTable1.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"SELECT patient_no, (upper(second_name||' '||first_name)) as name, address,tel_no from hp_patient_register where second_name||' '||first_name ILIKE '"+jTextField111.getText()+"%' order by second_name"));
        ...
        if(this.jCheckBox2.isSelected() && this.jCheckBox3.isSelected()){
            ...
            if(jTextField111.getCaretPosition() < 3){
                ...
                jSearchTable1.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"SELECT patient_no, (upper(second_name||' '||first_name)) as name,address,tel_no from hp_inpatient_register where patient_no ILIKE '"+jTextField111.getText()+"%' order by second_name"));
            ...
            if(this.jCheckBox2.isSelected() && this.jCheckBox4.isSelected()){
                jSearchTable1.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"SELECT patient_no, (upper(second_name||' '||first_name)) as name, address,tel_no from hp_inpatient_register where second_name||' '||first_name||' '||last_name ILIKE '"+jTextField111.getText()+"%' order by second_name"));
                    jSearchTable1.setShowHorizontalLines(false);
                jSearchScrollPane1.setViewportView(jSearchTable1);
