 ...
 * @author  root
 */
public class LabPendingRequestsIntfr extends javax.swing.JInternalFrame implements java.lang.Runnable {
    ...
    public LabPendingRequestsIntfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
...
//        jPanel1.setVisible(false);
            ...
            while (rse121.next()) {
                ...
                glAcc = rse121.getObject(2).toString();
                    ...
                    /*java.sql.Statement stmtTable1 = connectDB.createStatement();
                        ...
                        " WHERE trans_date > (current_date - 2) AND patient_no = '" + this.jTextField9.getText() + "' " +
                        ...
                        pstmt46c.executeUpdate();
                        java.sql.PreparedStatement pstmt46 = connectDB.prepareStatement("UPDATE pb_doctors_request SET paid = false,collected = false,amount = '" + jTable1.getValueAt(i, 6).toString() + "',quantity = '" + jTable1.getValueAt(i, 5).toString() + "' where inv_no = '" + jTable1.getValueAt(i, 7).toString() + "' AND service = '" + jTable1.getValueAt(i, 4).toString() + "'");
                        pstmt46.executeUpdate();
                    }
                }
            }
    ...
    private void populateTable1(java.lang.String patient_no) {
        ...
        try {
            ...
            java.sql.ResultSet rsetTable1 = stmtTable1.executeQuery("select trans_date,patient_no,patient_name,pb.payment_mode,service,quantity,amount/quantity,inpatient_no,user_name,paid as seen,visit_id,trans_date,amount from hp_patient_billing pb, pb_activity pa WHERE pb.gl_code = pa.code AND pa.department ILIKE 'LAB' AND collected = false AND collected = false AND pb.trans_date > (current_date - 2) AND patient_no = '" + jTextField9.getText() + "' ORDER BY trans_date asc");
    ...
    public void runGetListThread() {
        ...
        try {
            ...
            java.sql.ResultSet rsetTable11 = stmtTable11.executeQuery("select distinct count(patient_no) from hp_patient_billing pb,pb_activity pa WHERE pb.gl_code = pa.code AND pa.department ILIKE 'LAB' AND collected = false AND collected = false AND trans_date > (current_date - 1)");
