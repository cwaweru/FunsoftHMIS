...
public class TurningChartPdf implements java.lang.Runnable {
    ...
    public void TurningChartPdf(java.sql.Connection connDb, java.lang.String combox) {
        MNo = combox;
       // MNo1 = combox1;
        connectDB = connDb;
            ...
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        int headerwidths[] = {7,15,10,10,25,10,15};
                        ...
                        Phrase phrase = new Phrase("Nurses Turning Chart");
                        ...
                        try {
                            ...
                            java.sql.ResultSet rset2 = st2.executeQuery("select initcap(pat_position),date,post_time,upper(input_by),upper(remarks) from hp_turning_chart where patient_no = '"+MNo+"' order by date");
                            ...
                            java.sql.ResultSet rset = st.executeQuery("select distinct patient_no,initcap(patient_name),ward,bed_no,date_admitted from hp_admission where patient_no = '"+MNo+"' order by date_admitted desc limit 1");
                            ...
                            while (rset.next()) {
                                ...
                                table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                                phrase = new Phrase("Bed No  : "+rset.getObject(4).toString(), pFontHeader);
                                table.addCell(phrase);
                                ...
                                table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                                phrase = new Phrase("Ward  : "+rset.getObject(3).toString(), pFontHeader);
                                table.addCell(phrase);
                        ...
                        table.addCell(phrase);
                        phrase = new Phrase("Position",pFontHeader);
                        table.addCell(phrase);
                        ...
                        table.addCell(phrase);
                        phrase = new Phrase("f",pFontHeader);
                        table.addCell(phrase);
                        
                        
                        
                        phrase = new Phrase("(g)",pFontHeader);
                        table.addCell(phrase);
                            ...
                            while (rset2.next()){
                                ...
                                table.addCell(phrase);
                                phrase = new Phrase(rset2.getObject(4).toString(), pFontHeader);
                                
                                table.addCell(phrase);
                                phrase = new Phrase(" ", pFontHeader);
                                
                                table.addCell(phrase);
                                 phrase = new Phrase(rset2.getObject(5).toString(), pFontHeader);
