 ...
 * @author  root
 */
public class PhysioResulIntfr extends javax.swing.JInternalFrame {
    ...
    public PhysioResulIntfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {
        ...
        */
        ...
        jCheckBox8.setText("Bleeding");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.weightx = 1.0;
        jPanel4.add(jCheckBox8, gridBagConstraints);

        buttonGroup3.add(jCheckBox9);
        jCheckBox9.setText("Disease");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.weightx = 1.0;
        jPanel4.add(jCheckBox9, gridBagConstraints);

        buttonGroup3.add(jCheckBox10);
        jCheckBox10.setText("Others");
        jPanel4.add(jCheckBox10, new java.awt.GridBagConstraints());
    ...
    private void jTextField1113CaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextField1113CaretUpdate
        jSearchTable3.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB, "SELECT (upper(AGENT_NAME)) as name  from pb_agents where CATEGORY ILIKE '%" + jTextField1113.getText() + "%' AND category ILIKE 'radiologist%' order by agent_name"));
    ...
    private void jTextField1112CaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextField1112CaretUpdate
        jSearchTable2.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB, "SELECT (upper(service_type)) as name,rate from pb_operating_parameters where service_type ILIKE '%" + jTextField1112.getText() + "%' AND MAIN_SERVICE ILIKE '%Physio%' order by service_type"));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (this.jCheckBox7.isSelected()) {
            Hist = this.jCheckBox7.getText();
        } else {
            if (this.jCheckBox8.isSelected()) {
                Hist = this.jCheckBox8.getText();
            } else {
                if (this.jCheckBox9.isSelected()) {
                    Hist = this.jCheckBox9.getText();
                } else {
                    Hist = this.jCheckBox10.getText();
                }
            }
        }
        ...
        try {
            ...
            java.sql.ResultSet rst11 = ps11.executeQuery("select 'Phy'||nextval('phy_no_seq'),current_user");
            while (rst11.next()) {
            ...
            pstmt.setDouble(10, java.lang.Double.valueOf(jTextField4.getText()));
            pstmt.setString(11, Categ);
            pstmt.setString(14, jTextField362.getText());
            if (Hist == null) {
                javax.swing.JOptionPane.showMessageDialog(this, "Tick History", "Error", javax.swing.JOptionPane.ERROR_MESSAGE);
            } else {

                pstmt.setString(12, Hist);
            }
