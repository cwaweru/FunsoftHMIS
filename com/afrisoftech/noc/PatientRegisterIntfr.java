...
public class PatientRegisterIntfr extends javax.swing.JInternalFrame implements java.lang.Runnable {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        jLabel6611.setText("Year of Birth (e.g. 1980)");
        ...
        jLabel572111.setText("Postal Address");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 2;
        ...
        jLabel311.setText("Residence (Physical Address)");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 2;
        ...
        jLabel511.setText("Telephone No.");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 2;
        gridBagConstraints.gridy = 3;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        ...
        jLabel58221.setText("Surname (Family Name)");
        gridBagConstraints = new java.awt.GridBagConstraints();
        ...
        jLabel411.setText("Next of kin (NOK names)");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 3;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        ...
        jLabel6.setText("Date of registry");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 4;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        ...
        jLabel11.setText("Last Patient Reg. No.");
        ...
        jButton30111.setMnemonic('R');
        jButton30111.setText("Register New Patient");
        ...
        jButton20211.setText("Clear entries");
        ...
        jButton25211.setText("Close this form");
        ...
        jButton111.setText("Seek assistance");
        gridBagConstraints = new java.awt.GridBagConstraints();
    ...
    private void jDialog3ComponentShown(java.awt.event.ComponentEvent evt) {//GEN-FIRST:event_jDialog3ComponentShown
        try {
            ...
            //  java.sql.ResultSet rs = stm.executeQuery("select currval('outpatient_no_seq')");
            java.sql.ResultSet rs = stm.executeQuery("SELECT patient_no, oid FROM hp_patient_register WHERE date IS NOT null ORDER BY oid DESC LIMIT 1");
            while (rs.next()){
                java.lang.String lastPatientNo = rs.getObject(1).toString();
                jTextField15.setText(lastPatientNo);
            ...
            javax.swing.JOptionPane.showMessageDialog(this, sqlExec.getMessage(), "Patient Registration No. Error", javax.swing.JOptionPane.ERROR_MESSAGE);
        }
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try{
          ...
          //          policy.SchemeCreditSlipPdf(connectDB, jTextField3.getText(),jTextField361.getText(),jTextField6.getText(),jTextField2.getText(),jTextField36.getText(),jTextField17.getText(),visitId);
                     policy.SchemeCreditSlipPdf(connectDB, jTextField3.getText(),jTextField361.getText(),jTextField6.getText(),jTextField2.getText(),jTextField36.getText(),visitId);
                }else{
                    java.sql.Statement stm = connectDB.createStatement();
                    java.sql.ResultSet rs = stm.executeQuery("select currval('visit_id')");
                    while (rs.next()){
    ...
    private void jSearchTable111MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jSearchTable111MouseClicked
        ...
        try {
            ...
            java.sql.Statement stmt = connectDB.createStatement();
            java.sql.ResultSet rset = stmt.executeQuery("select nok,residence,year_of_birth,tel_no,address,sex,last_visit,pay_mode from hp_patient_register where patient_no ilike '"+jTextField3.getText()+"%'");
            while (rset.next()){
              //  jComboBox1.setSelectedItem(dbObject.getDBObject(rset.getObject(8).toString(), "-"));
        ...
        try {
            ...
            java.sql.ResultSet rset1 = stmt1.executeQuery("select payer,description,account_no,member_name,expiry_date from hp_patient_register where patient_no ilike '"+jTextField3.getText()+"%'");
            while (rset1.next()){
                // jComboBox6.setSelectedItem(rset.getObject(1).toString());
                jTextField2.setText(dbObject.getDBObject(rset1.getObject(1), "-"));
                jTextField361.setText(dbObject.getDBObject(rset1.getObject(2), "-"));
                jTextField131.setText(dbObject.getDBObject(rset1.getObject(3), "-"));
                jTextField36.setText(dbObject.getDBObject(rset1.getObject(4), "-"));
                jTextField18.setText(dbObject.getDBObject(rset1.getObject(5), "-"));
    ...
    private void jTextField11111CaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextField11111CaretUpdate
        if(jTextField11111.getCaretPosition() < 3){
            ...
            jSearchTable111.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"SELECT patient_no, (upper(second_name||' '||first_name)) as name, year_of_birth, residence,CASE WHEN (card_no IS NULL) THEN '-' ELSE card_no END AS card_no from hp_patient_register where patient_no ILIKE '"+jTextField11111.getText()+"%' order by patient_no"));
    ...
    private void jSearchTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jSearchTableMouseClicked
        ...
        try {
            ...
            java.sql.ResultSet rset = stmt.executeQuery("select nok,residence,year_of_birth,tel_no,address,sex,last_visit,pay_mode from hp_patient_register where patient_no ilike '"+jTextField3.getText()+"%'");
            while (rset.next()){
               // jComboBox1.setSelectedItem(rset.getObject(8));
               jComboBox1.setSelectedItem(dbObject.getDBObject(rset.getObject(8), "-"));
                jTextField16.setText(dbObject.getDBObject(rset.getObject(7), "-"));
                jTextField1.setText(dbObject.getDBObject(rset.getObject(1), "-"));
                jTextField4.setText(dbObject.getDBObject(rset.getObject(2), "-"));
        ...
        try {
            ...
            java.sql.Statement stmt1 = connectDB.createStatement();
            java.sql.ResultSet rset1 = stmt1.executeQuery("select payer,description,account_no,member_name,expiry_date from hp_patient_register where patient_no ='"+jTextField3.getText()+"%'");
            while (rset1.next()){
                // jComboBox6.setSelectedItem(rset.getObject(1).toString());
                jTextField2.setText(dbObject.getDBObject(rset1.getObject(1), "-"));
                jTextField361.setText(dbObject.getDBObject(rset1.getObject(2), "-"));
  ...
  /*           if (jTextField17.getText().toString() == "-"){
    ...
    private void jTextField11CaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextField11CaretUpdate
        ...
        if(jTextField11.getCaretPosition() < 3){
            ...
            jSearchTable.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"SELECT patient_no, (upper(second_name||' '||first_name)) as name, year_of_birth, residence,CASE WHEN (card_no IS NULL) THEN '-' ELSE card_no END AS card_no from hp_patient_register where second_name||' '||first_name ILIKE '"+jTextField11.getText()+"%' order by second_name"));
    ...
    private void jButton301ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton301ActionPerformed
        ...
        try {
            ...
            if(CardNo > 0 && jTextField17.isEditable()) {
                ...
                if (CardNo > 0){
                    java.sql.PreparedStatement pstmt1 = connectDB.prepareStatement("UPDATE hp_patient_register set pay_mode = '"+jComboBox1.getSelectedItem().toString()+"',category = '"+jComboBox4.getSelectedItem().toString()+"',last_visit = current_date,card_no = '"+jTextField17.getText()+"'  WHERE patient_no = '"+jTextField3.getText()+"'");
                    pstmt1.executeUpdate();
                }
                ...
                if (jComboBox1.getSelectedItem().equals("Scheme") && jPanel5.isShowing()){
                    ...
                    java.sql.PreparedStatement pstmt11d = connectDB.prepareStatement("UPDATE hp_patient_register set description = '"+jTextField361.getText()+"',payer = '"+jTextField2.getText()+"',account_no ='"+jTextField13.getText()+"',expiry_date = '"+jTextField181.getText()+"',member_name ='"+jTextField36.getText()+"' WHERE patient_no = '"+jTextField3.getText()+"'");
