 ...
 */
public class RecordTxt implements java.lang.Runnable {
    ...
    public RecordTxt(java.sql.Connection connDb, java.lang.String receipt) {
    ...
    private void writeReport(java.io.RandomAccessFile txtRandomAccessFile){
        ...
        if (rHeader.equalsIgnoreCase("True")){
            ...
            table22.addCell("Address: "+Address);
        ...
        String ColumnModelTitle4[] = { "Doc. No.", "Date" };
        Object reportName[] = { "VITAL SIGNS"};
        ...
        try{
            ...
            java.sql.Statement st3 = connectDB.createStatement();
            java.sql.ResultSet rset7 = st7.executeQuery("select patient_no,initcap(patient_name) from hp_signs_record where pat_count = '"+Receipt+"'");
            ...
            java.sql.ResultSet rset5 = st5.executeQuery("select temp,pulse,resp,systolic,diastolic,systolic-diastolic,weight,height,((weight*10000)/(height*height)),blood_group,rhesus from hp_signs_record where pat_count = '"+Receipt+"'");
            java.sql.ResultSet rset6 = st6.executeQuery("select distinct initcap(input_by),initcap(input_by) from hp_signs_record where pat_count = '"+Receipt+"'");
            if (rHeader.equalsIgnoreCase("True")){
                ...
                table11.addCell("VALUE");
                
                
                while (rset5.next()){
                    
                    table1.addCell("Temperature(C)");
                    
                    
                    table1.addCell(dbObject.getDBObject(rset5.getObject(1), "-"));
                    table1.addCell("Pulse(B/M)");
                    
                    
                    table1.addCell(dbObject.getDBObject(rset5.getObject(2), "-"));
                    
                    table1.addCell("Respiratory Rate(B/M)");
                    
                    
                    table1.addCell(dbObject.getDBObject(rset5.getObject(3), "-"));
                    
                    table1.addCell("Systolic BP(mmHg)");
                    
                    
                    table1.addCell(dbObject.getDBObject(rset5.getObject(4), "-"));
                    
                    table1.addCell("Diastolic BP(mmHg)");
                    
                    
                    table1.addCell(dbObject.getDBObject(rset5.getObject(5), "-"));
                    
                    table1.addCell("Pulse Pressure(B/min)");
                    
                    
                    table1.addCell(dbObject.getDBObject(rset5.getObject(6), "-"));
                    
                    table1.addCell("Weight(Kg)");
                    
                    
                    table1.addCell(dbObject.getDBObject(rset5.getObject(7), "-"));
                    
                    table1.addCell("Height(cm)");
                    
                    
                    table1.addCell(dbObject.getDBObject(rset5.getObject(8), "-"));
                    
                    table1.addCell("BMI(Kg/M)");
                    
                    
                    table1.addCell(new com.afrisoftech.sys.Format2Currency().Format2Currency(rset5.getString(9)));
                    
                    table1.addCell("Blood Group");
                    
                    
                    table1.addCell(dbObject.getDBObject(rset5.getObject(10), "-"));
                    
                    table1.addCell("Rhesus");
                    
                    
                    table1.addCell(dbObject.getDBObject(rset5.getObject(11), "-"));
                ...
                while (rset7.next()){
                    MNo = dbObject.getDBObject(rset7.getObject(1), "-");
                    Name = dbObject.getDBObject(rset7.getObject(2), "-");
                }
                while (rset6.next()){
                    System.out.println("Cashier = "+Cashier);
                    System.out.println("Cashpoint " +Cashpoint);
                    Cashier = dbObject.getDBObject(rset6.getObject(1).toString(), "-");
                    
                    Cashpoint = dbObject.getDBObject(rset6.getObject(1), "-");
                    
                    
                }
                
                
                table4.addCell("Doc No : "+Receipt);
