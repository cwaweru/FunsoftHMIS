 ...
 */
public class PharCopyReceiptsTxt implements java.lang.Runnable {
    ...
    public PharCopyReceiptsTxt(java.sql.Connection connDb,java.lang.String receipt) {
    ...
    private void writeReport(java.io.RandomAccessFile txtRandomAccessFile){
        ...
        int horizontalAlignments11[] = {biz.systempartners.txtreports.Phrase.HORIZONTAL_ALIGNMENT_LEFT,
        biz.systempartners.txtreports.Phrase.HORIZONTAL_ALIGNMENT_RIGHT,
        biz.systempartners.txtreports.Phrase.HORIZONTAL_ALIGNMENT_RIGHT};
        ...
        double floats11[] = {60,20,20};
        
        int colSizes11[] = textReport.createTableHeader(3, floats11);
        
        for (int i = 0; i < colSizes11.length; i++) {
            // System.out.println(colSizes2[i]);
        }
        ...
        biz.systempartners.txtreports.PlainTextTable table1 = new biz.systempartners.txtreports.PlainTextTable(3);
        
        biz.systempartners.txtreports.PlainTextTable table11 = new biz.systempartners.txtreports.PlainTextTable(3);
        ...
        try{
            ...
            java.sql.ResultSet rset5 = st5.executeQuery("select initcap(description),sum(quantity),sum(debit),round(sum(debit/quantity)) from ac_cash_collection where receipt_no = '"+Receipt+"' group by description");
            java.sql.ResultSet rset6 = st6.executeQuery("select distinct user_name,cash_point,patient_no,dealer,date,payment_mode from ac_cash_collection where receipt_no = '"+Receipt+"'");
            if (rHeader.equalsIgnoreCase("True")){
                
                // table11.addCell("CODE ");
                
                
                table11.addCell("PARTICULARS");
                ...
                while (rset6.next()){
                    ...
                    MNo = dbObject.getDBObject(rset6.getObject(3), "-");
                    Name = dbObject.getDBObject(rset6.getObject(4), "-");
                    dates = dbObject.getDBObject(rset6.getObject(5), "-");
                    Paymode = dbObject.getDBObject(rset6.getObject(6), "-");
                ...
                table21.addCell("           Received from: "+MNo+ "  " +Name.toUpperCase());
                
                // table21.addCell("A sum of Kshs : ");
                
                java.sql.ResultSet rset_cash = st7.executeQuery("select initcap(replace(cash_words('"+osBalance+"'),'dollars','"+ks+"'))");
                ...
                tableF.addCell(" "+  Cashier.toUpperCase());
                ...
                java.sql.ResultSet rset_cash = st7.executeQuery("select replace(cash_words('"+osBalance+"'),'dollars','"+ks+"')");
        ...
        if (rHeader.equalsIgnoreCase("True")){
            ...
            textReport.addTable(table11, colSizes11, columnModel11, horizontalAlignments11);
            
            
            //       textReport.drawHorizontalLine(integers);
            
            textReport.addTable(table1, colSizes11, columnModel11, horizontalAlignments11);
