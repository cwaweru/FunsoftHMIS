 ...
 */
public class ReceiptsPerDeptCopyTxt implements java.lang.Runnable {
    ...
    public ReceiptsPerDeptCopyTxt(java.sql.Connection connDb, java.lang.String receipt, boolean printPreview) {
    ...
    private void writeReport(java.io.RandomAccessFile txtRandomAccessFile){
        ...
        try{
            ...
            java.sql.ResultSet rset6 = st6.executeQuery("select distinct user_name,cash_point,payment_mode from ac_cash_collection where receipt_no = '"+Receipt+"'");
            java.sql.ResultSet rset11 = st11.executeQuery("select cb.dealer,cb.patient_no from ac_cash_collection cb where cb.receipt_no = '"+Receipt+"'");
