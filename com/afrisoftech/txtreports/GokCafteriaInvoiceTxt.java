 ...
 */
public class GokCafteriaInvoiceTxt implements java.lang.Runnable {
    ...
    public GokCafteriaInvoiceTxt(java.sql.Connection connDb, java.lang.String combox, java.lang.String amount, java.lang.String receipt, java.lang.String paymode, java.lang.String cash, java.lang.String refund, java.lang.String shiftNo) {
    ...
    private void writeReport(java.io.RandomAccessFile txtRandomAccessFile) {
        ...
        Object reportName[] = {"CREDIT SALE - INVOICE"};
        ...
        try {
            ...
            java.sql.ResultSet rset1 = st1.executeQuery("SELECT date_part('day', "
                    ...
                    + "FROM hp_patient_card WHERE invoice_no = '" + getReceipt() + "'");
            java.sql.ResultSet rset5 = st5.executeQuery("SELECT initcap(service),sum(dosage),sum(debit),round(sum(debit/dosage)) from hp_patient_card where invoice_no = '" + getReceipt() + "' and transaction_type ilike 'billing' group by service");
            java.sql.ResultSet rset6 = st6.executeQuery("SELECT distinct user_name,cash_point,patient_no from hp_patient_card where invoice_no = '" + getReceipt() + "'");
            ...
            if (getRHeader().equalsIgnoreCase("True")) {
                ...
                while (rset6.next()) {
                    ...
                    pNumber = getDbObject().getDBObject(rset6.getObject(3), "-");
                ...
                table4.addCell("INVOICE No: " + getReceipt());
                ...
                table21.addCell("Staff No: " + pNumber);

                table21.addCell("STAFF NAME: " + getMNo().toUpperCase());
                ...
                table3.addCell("INVOICE AMOUNT");

                //  table3.addCell("");

                table3.addCell(new com.afrisoftech.sys.Format2Currency().Format2Currency(getDbObject().getDBObject(java.lang.String.valueOf(getTotal() - getWaiver()), "0.00")));
