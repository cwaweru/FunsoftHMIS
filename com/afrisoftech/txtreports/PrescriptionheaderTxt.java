 ...
 */
public class PrescriptionheaderTxt implements java.lang.Runnable {
    ...
    public PrescriptionheaderTxt(java.sql.Connection connDb, java.lang.String combox, java.lang.String name, java.lang.String receipt, java.lang.String paymode) {
    ...
    private void writeReport(java.io.RandomAccessFile txtRandomAccessFile){
        ...
        Object reportName[] = { "Prescription Note"};
        ...
        try{
            ...
            java.sql.ResultSet rset5 = st5.executeQuery("select initcap(description),sum(quantity),sum(amount),round(sum(amount/quantity)) from hp_pharmacy where prescription_no = '"+Receipt+"' group by description");
