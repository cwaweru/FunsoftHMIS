    ...
    private void writeReport(java.io.RandomAccessFile txtRandomAccessFile){
        ...
        for (int j = 0; j < listofStaffNos.length; j++) {
            ...
            try{
                ...
                java.sql.ResultSet rset31 = st31.executeQuery("SELECT DISTINCT pc.payee,sp.postal_code||' '||sp.address,sp.tel_main||' '||sp.other_tel,sp.main_fax from ac_schemes sp,ac_debtors pc where pc.account_no = sp.account_no and pc.invoice_no = '"+listofStaffNos[j]+"'");
