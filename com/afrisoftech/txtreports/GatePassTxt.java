 ...
 */
public class GatePassTxt implements java.lang.Runnable {
    ...
    public GatePassTxt(java.sql.Connection connDb, java.lang.String combox) {
    ...
    private void writeReport(java.io.RandomAccessFile txtRandomAccessFile){
        ...
        String ColumnModelTitle4[] = { "Gate Pass No", "Date" };
        Object reportName[] = { "GATE PASS SLIP"};
        ...
        try{
            ...
            java.sql.ResultSet rset5 = st5.executeQuery("select patient_no,patient_name,discharge_no,discharge_date,doctor,discharge_time,admission_date,user_name from hp_patient_discharge cb where discharge_no = '"+MNo+"'");
            java.sql.ResultSet rset6 = st6.executeQuery("select distinct current_user");
            if (rHeader.equalsIgnoreCase("True")){
                while (rset5.next()){
                    table21.addCell("Gate Pass No: "+ dbObject.getDBObject(rset5.getObject(3), "-"));
                    table21.addCell("Date: "+ dbObject.getDBObject(rset5.getObject(4), "-"));
                    table21.addCell("Patient No: "+ dbObject.getDBObject(rset5.getObject(1), "-"));
                    table21.addCell("Patient Name: "+ dbObject.getDBObject(rset5.getObject(2), "-"));
                    table21.addCell("Doctor: "+ dbObject.getDBObject(rset5.getObject(5), "-"));
                    table21.addCell("D.O.A: "+ dbObject.getDBObject(rset5.getObject(7), "-"));
                    table21.addCell("D.O.D: "+ dbObject.getDBObject(rset5.getObject(4), "-"));
                    table21.addCell("Time: "+ dbObject.getDBObject(rset5.getObject(6), "-"));
                    table21.addCell("Discharged By: "+ dbObject.getDBObject(rset5.getObject(8), "-"));
                }
                tableF.addCell( " ");
                tableF.addCell( " ");
                tableF.addCell( " ");
