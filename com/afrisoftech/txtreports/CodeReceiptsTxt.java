 ...
 */
public class CodeReceiptsTxt implements java.lang.Runnable {
    ...
    public CodeReceiptsTxt(java.sql.Connection connDb, java.lang.String combox, java.lang.String name, java.lang.String amount, java.lang.String receipt, java.lang.String paymode) {
    ...
    private void writeReport(java.io.RandomAccessFile txtRandomAccessFile){
        ...
        if (rHeader.equalsIgnoreCase("True")){
            ...
            table22.addCell("Tel : "+Tel.toUpperCase()+ "; Fax : "+Fax.toUpperCase());
        ...
        try{
            ...
            java.sql.ResultSet rset51 = st2.executeQuery("select distinct patient_no,dealer from ac_cash_collection where receipt_no = '"+Receipt+"'");
            
            java.sql.ResultSet rset5 = st5.executeQuery("select  CASE WHEN (journal_no != '') THEN initcap(journal_no) ELSE description END AS journal_no,sum(quantity),sum(debit),round(sum(debit/quantity)) from ac_cash_collection where receipt_no = '"+Receipt+"' group by journal_no,description");
            ...
            while(rset51.next()){
                MNo = dbObject.getDBObject(rset51.getString(1), "-");///rset51.getString(1);
                Name = dbObject.getDBObject(rset51.getString(2), "-");
            }
            if (rHeader.equalsIgnoreCase("True")){
                ...
                while (rset6.next()){
                    ...
                    //Name = dbObject.getDBObject(rset6.getObject(3), "-");
