 ...
 */
public class CreditSlipTxt implements java.lang.Runnable {
    ...
    public CreditSlipTxt(java.sql.Connection connDb, java.lang.String combox,java.lang.String scheme,java.lang.String patient,java.lang.String schpayer,java.lang.String membNo,int slipno) {
    ...
    private void writeReport(java.io.RandomAccessFile txtRandomAccessFile){
        ...
        int colSizes3[] = textReport.createTableHeader(1, floats3);
        ...
        */
        ...
        String ColumnModelTitle4[] = { "Slip No",  "Date" };
        Object reportName[] = { "CREDIT SLIP"};
        ...
        biz.systempartners.txtreports.PlainTextTable table21 = new biz.systempartners.txtreports.PlainTextTable(2);
        ...
        try{
            ...
            java.sql.Statement st3 = connectDB.createStatement();
            java.sql.ResultSet rset6 = st1.executeQuery("select CURRENT_TIMESTAMP(0)::time,current_user");
            java.sql.ResultSet rset = st.executeQuery("SELECT date('now')");
            java.sql.ResultSet rset2 = st2.executeQuery("SELECT initcap('"+Patient+"'),initcap('"+Scheme+"'),initcap('"+payer+"')");
            java.sql.ResultSet rset22 = st6.executeQuery("SELECT initcap(credit_terms) from interim_footer");
            
            while(rset22.next()){
                
                creditTerms = dbObject.getDBObject(rset22.getString(1), "-");
                
            }
            while(rset2.next()){
                
                Patient = dbObject.getDBObject(rset2.getString(1), "-");
                Scheme = dbObject.getDBObject(rset2.getString(2), "-");
                payer = dbObject.getDBObject(rset2.getString(3), "-");
            }
            table11.addCell("Service Provider Instructions");
            
            
            table11.addCell("(Valid for only one visit)");
            
            while (rset.next()){
                dates = dbObject.getDBObject(rset.getObject(1), "-");
                SlipNo = slipNo;
            }
            
            
            while (rset6.next()){
                Cashier = dbObject.getDBObject(rset6.getObject(2).toString().toUpperCase(), "-");
                
                Times = dbObject.getDBObject(rset6.getObject(1), "-");
                
                
            }
            
            
            table4.addCell("Slip No : "+SlipNo);
            
            table4.addCell("Valid: "+dates);
            
            table23.addCell("Please provide services to: "+Patient);
            
            table23.addCell("Patient No: "+patNo);
            
            table23.addCell("Scheme Payer/Category: "+payer);
            
            table23.addCell("Member No: "+MemNo);
            
            table23.addCell("Scheme Name: "+Scheme);
            table23.addCell("    ");
            //  table3.addCell("");
            
            //  table3.addCell("");
            
            table3.addCell(creditTerms);
            //  table3.addCell("         ");
            table3.addCell("         ");
            ...
            //  simpleReportFooter = "Prepared By:"+Cashier+"      Time :"+Times;
            
            tableF.addCell( "Prepared By:"+Cashier);
            
            tableF.addCell("Time :"+Times);
        ...
        textReport.addTable(tableF, colSizes4, ColumnModelTitle2, horizontalAlignments2);
