 ...
 */
public class StatementPerPayerTxtReport implements java.lang.Runnable {
    ...
    public StatementPerPayerTxtReport(java.sql.Connection connDb, java.util.Date begindate, java.util.Date endate,java.lang.String combox, boolean printPreview) {
    ...
    private void writeReport(java.io.RandomAccessFile txtRandomAccessFile){
        ...
        for (int j = 0; j < listofStaffNos.length; j++) {
            ...
            Object columnModel1[] = {"Date","Patient No","Names","Invoice No","Orig. Amt.","Balance","Running "+ks};
            
            
            String columnModel[] = {"This", "That", "Then", "when","This", "That", "Then"};
     ...
     /*           table4.addCell("Date ");
                ...
                table4.addCell("Patient No ");
      
                table4.addCell("Name ");
      
                table4.addCell("Invoice No ");
      
                table4.addCell("Member No. ");
      
                table4.addCell("Original Amt. ");
      
                table4.addCell("Current Amt. ");
      
                table4.addCell("Running Bal. ");
      */
    ...
    public void run() {
        ...
        while (threadCheck) {
            ...
            for (int i = 0; i < 7; i++){
                ...
                columnVector.addElement(columnModel[i].toString());
