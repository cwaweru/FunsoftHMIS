 ...
 */
public class PrescriptionTakenTxt implements java.lang.Runnable {
    ...
    public PrescriptionTakenTxt(java.sql.Connection connDb, java.lang.String combox, java.lang.String name, java.lang.String receipt, java.lang.String paymode) {
    ...
    private void writeReport(java.io.RandomAccessFile txtRandomAccessFile) {
        ...
        String ColumnModelTitle4[] = {"Prescription No", "Date"};
        Object reportName[] = {"Prescription Note (Paid)"};
        ...
        biz.systempartners.txtreports.PlainTextTable table3 = new biz.systempartners.txtreports.PlainTextTable(3);
        ...
        biz.systempartners.txtreports.PlainTextTable signat = new biz.systempartners.txtreports.PlainTextTable(1);
        ...
        try {
            ...
            java.sql.ResultSet rset5 = st5.executeQuery("select initcap(service),requisition_no,bed_no,dosage,time_due from pb_doctors_request where inv_no = '" + Receipt + "' AND paid = true group by service,requisition_no,bed_no,dosage,time_due");
            ...
            if (rHeader.equalsIgnoreCase("True")) {
                ...
                table11.addCell("ROUTE");

                table11.addCell("FREQCY");
                ...
                table4.addCell("Presc. No : " + Receipt);

                //  table4.addCell(" ");

                table4.addCell("Date : " + dates);

                table21.addCell("Received from : " + MNo + " " + Name);
                ...
                tableF.addCell("From: Pharmacy");

                tableF.addCell("Pharmacist: " + Cashier.toUpperCase());
