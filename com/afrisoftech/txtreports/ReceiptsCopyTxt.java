...
public class ReceiptsCopyTxt implements java.lang.Runnable {
    ...
    public ReceiptsCopyTxt(java.sql.Connection connDb, java.lang.String combox, boolean printPreview) {
    ...
    private void writeReport(java.io.RandomAccessFile txtRandomAccessFile){
        ...
        try{
            ...
            java.sql.ResultSet rset5 = st5.executeQuery("select initcap(description),sum(debit-credit) from ac_cash_collection where receipt_no = '"+Receipt+"' group by description ORDER BY SUM(debit) DESC");
            ...
            if (rHeader.equalsIgnoreCase("True")){
                ...
                table21.addCell("Patient No: "+MNo.toUpperCase()+ " Name:  " +Name.toUpperCase());
                ...
                // table21.addCell("Payment :"+ cash_words);
