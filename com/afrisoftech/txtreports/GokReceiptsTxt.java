 ...
 */
public class GokReceiptsTxt implements java.lang.Runnable {
    ...
    private void writeReport(java.io.RandomAccessFile txtRandomAccessFile) {
        ...
        String ColumnModelTitle4[] = {"R No.", "Date"};
        ...
        try {
            ...
            if (getRHeader().equalsIgnoreCase("True")) {
                ...
                table4.addCell("R No: " + getReceipt());
                ...
                table21.addCell("Unit Number :" + unitNumber);
                ...
                table3.addCell(new com.afrisoftech.sys.Format2Currency().Format2Currency(getDbObject().getDBObject(java.lang.String.valueOf(Refund), "0.00")));
