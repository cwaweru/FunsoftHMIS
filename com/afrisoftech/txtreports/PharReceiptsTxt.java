 ...
 */
public class PharReceiptsTxt implements java.lang.Runnable {
    ...
    public PharReceiptsTxt(java.sql.Connection connDb, java.lang.String combox, java.lang.String name, java.lang.String amount, java.lang.String receipt, java.lang.String paymode) {
    ...
    private void writeReport(java.io.RandomAccessFile txtRandomAccessFile){
        ...
        try{
            ...
            java.sql.ResultSet rset5 = st5.executeQuery("select initcap(description),sum(quantity),sum(debit),round(sum(debit/quantity)) from ac_cash_collection where patient_no = '"+MNo+"' and receipt_no = '"+Receipt+"' group by description");
