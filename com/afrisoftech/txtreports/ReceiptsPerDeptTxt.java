 ...
 */
public class ReceiptsPerDeptTxt implements java.lang.Runnable {
    ...
    public ReceiptsPerDeptTxt(java.sql.Connection connDb, java.lang.String combox, java.lang.String name, java.lang.String amount, java.lang.String receipt, java.lang.String paymode) {
    ...
    private void writeReport(java.io.RandomAccessFile txtRandomAccessFile){
        ...
        String ColumnModelTitle4[] = { "Receipt No", "Date" };
        ...
        try{
            ...
            java.sql.Statement st53 = connectDB.createStatement();
            ...
            java.sql.ResultSet rset5 = st5.executeQuery("select initcap(activity_code),sum(quantity),sum(debit-credit),round(sum(debit/quantity)) from ac_cash_collection where receipt_no = '"+Receipt+"' group by activity_code ORDER BY SUM(debit-credit) DESC");
            java.sql.ResultSet rset53 = st53.executeQuery("select distinct patient_no,dealer from ac_cash_collection where receipt_no = '"+Receipt+"'");
            ...
            while(rset53.next()){
                MNo = rset53.getString(1);
                Name = rset53.getString(2);
            }
            ...
            while (rset5.next()){
                ...
                java.sql.ResultSet rset51 = st51.executeQuery("select activity from pb_activity where code = '"+dbObject.getDBObject(rset5.getObject(1), "-")+"'");
                while (rset51.next()){
                    table1.addCell(dbObject.getDBObject(rset51.getObject(1), "-"));
            ...
            table21.addCell("Patient No : "+MNo+ " Patient Name : " +Name.toUpperCase());
