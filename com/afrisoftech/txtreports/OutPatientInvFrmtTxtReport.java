 ...
 */
public class OutPatientInvFrmtTxtReport implements java.lang.Runnable {
    ...
    String ks;
    public OutPatientInvFrmtTxtReport(java.sql.Connection connDb, java.lang.String inv1, java.lang.String inv2, boolean printPreview) {
        ...
        for (int j = 0; j < listofStaffNos.length; j++) {
          ...
          **/
            ...
            **/
            ...
            biz.systempartners.txtreports.PlainTextTable table21 = new biz.systempartners.txtreports.PlainTextTable(5);
            ...
            try{
                ...
                java.sql.ResultSet rset311 = st311.executeQuery("SELECT DISTINCT ap.payer_id from ac_debtors ac,ac_scheme_providers ap where ac.dealer = ap.scheme_manager AND ac.invoice_no = '"+listofStaffNos[j]+"'");
                java.sql.ResultSet rset31 = st31.executeQuery("SELECT DISTINCT pc.payee,sp.postal_code||' '||sp.address,sp.tel_main||' '||sp.other_tel,sp.main_fax,sp.account_no from ac_schemes sp,ac_debtors pc where pc.account_no = sp.account_no and pc.invoice_no = '"+listofStaffNos[j]+"'");
                java.sql.ResultSet rset4 = st4.executeQuery("SELECT DISTINCT dealer from ac_debtors where invoice_no = '"+listofStaffNos[j]+"'");
                java.sql.ResultSet rset5 = st5.executeQuery("SELECT DISTINCT pr.account_no,pr.member_name from hp_patient_register pr,ac_debtors db where db.invoice_no = '"+listofStaffNos[j]+"' and db.admission_no = pr.patient_no");
                java.sql.ResultSet rset = st.executeQuery("SELECT DISTINCT admission_no,initcap(item) from ac_debtors where invoice_no = '"+listofStaffNos[j]+"'");
                
                java.sql.ResultSet rset1 = st1.executeQuery("select date::date,initcap(service) as service,dosage,reference,SUM(debit-credit) from hp_patient_card where invoice_no = '"+listofStaffNos[j]+"' AND paid = true and service not ilike 'Invoice' AND reference NOT ILIKE 'C%' GROUP BY date::date,initcap(service),dosage,reference");
                java.sql.ResultSet rset1d = st1d.executeQuery("select date::date,initcap(service) as service,dosage,reference,SUM(debit-credit) from hp_patient_card where invoice_no = '"+listofStaffNos[j]+"' AND paid = true and service not ilike 'Invoice' AND reference ILIKE 'C%' GROUP BY date::date,initcap(service),dosage,reference");
                ...
                java.sql.ResultSet rset11 = st11.executeQuery("SELECT DISTINCT invoice_no from ac_debtors where invoice_no = '"+listofStaffNos[j]+"' and invoice_no IS NOT NULL");
                java.sql.ResultSet rset1x = st1x.executeQuery("SELECT DISTINCT credit_terms from interim_footer");
                ...
                while (rset31.next()){
                    ...
                    acNo = dbObject.getDBObject(rset31.getObject(4), "-");
                ...
                table2.addCell("C/O : " +dealer);
                
                table2.addCell("Patient Name : "+item.toUpperCase());
                
                table2.addCell("P.O. BOX : "+address);
                
                table2.addCell("Member No : "+mno);
                
                table2.addCell("Tel : "+mno);
                ...
                table21.addCell(new com.afrisoftech.sys.Format2Currency().Format2Currency(java.lang.String.valueOf(osBalance)));
                ...
                table31.addCell("Grand Total "+ks);
                ...
                table31.addCell(new com.afrisoftech.sys.Format2Currency().Format2Currency(java.lang.String.valueOf(osBalance)));
            ...
            try {
                ...
                textReport.getReportAccessFile().writeBytes( " \f ");
