...
public class GokReceiptsRCopyTxt implements java.lang.Runnable {
    ...
    public GokReceiptsRCopyTxt(java.sql.Connection connDb, java.lang.String receipt) {
        ...
        try {
            ...
            if (rHeader.equalsIgnoreCase("True")) {
                ...
                while (rset5.next()) {
                    ...
                    System.out.println("This is the description 1 " + rset5.getString(1));
                ...
                while (rset51.next()) {
                    ...
                    System.out.println("This is the description 2" + rset51.getString(1));
