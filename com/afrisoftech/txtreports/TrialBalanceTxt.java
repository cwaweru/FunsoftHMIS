        ...
        try {
            ...
            try {
                ...
                try{
                    ...
                    java.sql.ResultSet rset = st.executeQuery("SELECT tb.gl_code,sum(debit-credit) from detailed_trial_balance_view tb WHERE tb.date <= '"+endDate+"' group by tb.gl_code order by tb.gl_code");
