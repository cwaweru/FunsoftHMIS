 ...
 */
public class NoDetReceiptsTxt implements java.lang.Runnable {
    ...
    public NoDetReceiptsTxt(java.sql.Connection connDb, java.lang.String combox, java.lang.String name, java.lang.String amount, java.lang.String receipt, java.lang.String paymode) {
    ...
    private void writeReport(java.io.RandomAccessFile txtRandomAccessFile){
        ...
        biz.systempartners.txtreports.PlainTextTable table24 = new biz.systempartners.txtreports.PlainTextTable(1);
        ...
        try{
            ...
            java.sql.ResultSet rset5 = st5.executeQuery("select sum(debit),round(sum(debit/quantity)) from ac_cash_collection WHERE receipt_no = '"+Receipt+"'");
            ...
            if (rHeader.equalsIgnoreCase("True")){
                ...
                while (rset5.next()){
                    ...
                    osBalance = osBalance + rset5.getDouble(1);
                ...
                table21.addCell("          Client No: "+MNo.toUpperCase());
        ...
        if (rHeader.equalsIgnoreCase("True")){
            ...
            textReport.addTable(table24, colSizes21, ColumnModelTitle, horizontalAlignments21);
            //    textReport.drawHorizontalLine(integers);
