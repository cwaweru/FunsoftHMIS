 ...
 */
public class GokMobilePayReceiptsRCopyTxt implements java.lang.Runnable {
    ...
    public GokMobilePayReceiptsRCopyTxt(java.sql.Connection connDb, java.lang.String receipt) {
    ...
    private void writeReport(java.io.RandomAccessFile txtRandomAccessFile) {
        ...
        Object reportName[] = {"RECEIPT [REPINT - NOT ORIGINAL!]"};
        ...
        try {
            ...
            java.sql.ResultSet rset5 = st5.executeQuery("select initcap(description),sum(quantity),sum(debit),1.00 from ac_cash_collection where receipt_no = '" + Receipt + "' and debit > 0 group by description");
            ...
            if (rHeader.equalsIgnoreCase("True")) {
                ...
                while (rset5.next()) {
                    ...
                    table1.addCell(dbObject.getDBObject("MPESA PAYMENT", "-"));
                ...
                while (rset6.next()) {
                    ...
                    Cashier = dbObject.getDBObject("MPESA", "-");

                    Cashpoint = dbObject.getDBObject("MPESA", "-");
                   ...
                   Paymode = dbObject.getDBObject("Mobile Pay", "-");
                }
                ...
                while (rset51.next()) {
                    ...
                    table1.addCell("Reference/No: " + exemptionNumber);
                    //  table1.addCell(dbObject.getDBObject(rset5.getObject(2), "-"));
