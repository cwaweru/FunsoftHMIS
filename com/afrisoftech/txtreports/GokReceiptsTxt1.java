 ...
 */
public class GokReceiptsTxt1 implements java.lang.Runnable {
    ...
    public GokReceiptsTxt1(java.sql.Connection connDb, java.lang.String combox, java.lang.String amount, java.lang.String receipt, java.lang.String paymode, java.lang.String cash, java.lang.String refund) {
    ...
    private void writeReport(java.io.RandomAccessFile txtRandomAccessFile){
        ...
        try{
            ...
            if (rHeader.equalsIgnoreCase("True")){
                ...
                java.sql.ResultSet rset_cash = st7.executeQuery("select initcap(replace(cash_words('"+total+"'),'dollars','"+ks+"'))");
