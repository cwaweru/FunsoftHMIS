 ...
 */
public class SchemeStatementTxtReport implements java.lang.Runnable {
...
//    String[] columnModel1;
    ...
    public SchemeStatementTxtReport(java.sql.Connection connDb, java.util.Date begindate, java.util.Date endate, java.lang.String combox, boolean printPreview, java.lang.String targetSchemeName) {
...
//        com.afrisoftech.dbadmin.ExcelExport.excelDocFile = excelDocFile;
        ...
        for (int j = 0; j < listofStaffNos.length; j++) {
            ...
            try {
                ...
                while (rset2x.next()) {
                    ks = rset2x.getObject(1).toString().toLowerCase();
                }
            ...
            System.out.println("Table diagnostics : "+ table4.getColumnCount() + integers.length + columnModel.length + horizontalAlignments1.length);
...
////            com.afrisoftech.dbadmin.ExcelExport export2Excel = new com.afrisoftech.dbadmin.ExcelExport(table2Export,exportFile);
    ...
    public java.lang.Object[] getListofStaffNos() {
        ...
        try {
            ...
            java.sql.ResultSet rSet1 = stmt1.executeQuery("SELECT DISTINCT account_no FROM ac_debtors WHERE  dealer ilike '" + memNo + "%' and date::date BETWEEN '" + beginDate + "' AND '" + endDate + "' AND payee = '"+this.schemeName+"'  order by account_no");
