 ...
 */
public class DebtorsAgeingTxt implements java.lang.Runnable {
    ...
    public DebtorsAgeingTxt(java.sql.Connection connDb, java.util.Date begindate, java.util.Date endate, java.lang.String bal) {
    ...
    private void writeReport(java.io.RandomAccessFile txtRandomAccessFile){
        ...
        Object reportName[] = { "Debtors Ageing As At : " +dateFormat.format(endDate1).toUpperCase() };
            ...
            for (int i = 0; i < listofAct.length; i++) {
                ...
                if (name > 0){
                    ...
                    while (rset22.next()){
                        ...
                        java.sql.PreparedStatement pset111 = connectDB.prepareStatement("select sum(debit-credit) from ac_debtors WHERE account_no = ?  AND date <= '"+endDate+"'");//< '"+endDate+"'::date and date > '"+endDate+"'::date - 30 group by dealer");
                        ...
                        for (int t = ageingDates.length - 1; t >= 0; t--) {
                            ...
                            java.sql.PreparedStatement pset = connectDB.prepareStatement("select sum(debit),invoice_no from ac_debtors WHERE account_no = ?  AND date between '"+ageingDates[t][0]+"' AND '"+ageingDates[t][1]+"' and debit > 0  GROUP BY invoice_no");
    ...
    public java.lang.Object[] getListofActivities() {
        ...
        try {
            ...
            java.sql.PreparedStatement pSet1 = connectDB.prepareStatement("SELECT DISTINCT account_no,sum(debit-credit) as balance FROM ac_debtors WHERE date::date <= '"+endDate+"' and account_no is not null group by account_no HAVING sum(debit-credit) <> 0 order by 2 desc");
