 ...
 */
public class GokIpReceiptsTxt implements java.lang.Runnable {
    ...
    public GokIpReceiptsTxt(java.sql.Connection connDb, java.lang.String combox, java.lang.String amount, java.lang.String receipt, java.lang.String paymode, java.lang.String cash, java.lang.String refund, java.lang.String shiftNo) {
    ...
    private void writeReport(java.io.RandomAccessFile txtRandomAccessFile) {
        ...
        try {
            ...
            java.sql.ResultSet rset1 = st1.executeQuery("select date_part('day', receipt_time)||'-'||date_part('month', receipt_time)||'-'||date_part('year', receipt_time)||'@'||date_part('hour', receipt_time)||':'||date_part('minute', receipt_time) as receipt_time from ac_cash_collection where receipt_no = '" + getReceipt() + "'");
            ...
            java.sql.ResultSet rset = st.executeQuery("select sum(credit) from ac_cash_collection where receipt_no = '" + getReceipt() + "' and transaction_type = 'Receipts' AND credit > 0");
            while (rset.next()) {
                //credits = rset.getDouble(1);
                setDeposit(rset.getDouble(1));
            }
            ...
            if (getRHeader().equalsIgnoreCase("True")) {
                ...
                while (rset51.next()) {
                    ...
                    table1.addCell("Wvr/Exm., No: " + exemptionNumber);
                ...
                table4.addCell("RCPT No: " + getReceipt());
                ...
                table21.addCell("Patient No: " + pNumber);
                ...
                //  table3.addCell("");
                table3.addCell("Deposit");



                table3.addCell(new com.afrisoftech.sys.Format2Currency().Format2Currency(java.lang.String.valueOf(getDeposit())));


                table3.addCell("Cash Received");

                //  table3.addCell("");

                table3.addCell(new com.afrisoftech.sys.Format2Currency().Format2Currency(getDbObject().getDBObject(java.lang.String.valueOf(getTotal() - getWaiver() - getDeposit()), "0.00")));

                // table3.addCell("Tendered Amount");

                //  table3.addCell("");

                //table3.addCell(new com.afrisoftech.sys.Format2Currency().Format2Currency(getDbObject().getDBObject(java.lang.String.valueOf(getCash()), "0.00")));

                //table3.addCell("Change");

                //  table3.addCell("");

                //table3.addCell(new com.afrisoftech.sys.Format2Currency().Format2Currency(getDbObject().getDBObject(java.lang.String.valueOf(getRefund()), "0.00")));
                table3.addCell("Balance");

                //table3.addCell("");

                table3.addCell(new com.afrisoftech.sys.Format2Currency().Format2Currency(getDbObject().getDBObject(java.lang.String.valueOf(balance), "0.00")));
                //table3.addCell("0.00");
     ...
     * @param waiver the waiver to set
     */
    public void setDeposit(double credits) {
