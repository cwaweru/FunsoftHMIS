 ...
 *
 */
public class PayablesAuditIntfr extends javax.swing.JInternalFrame {
     ...
     */
    public PayablesAuditIntfr(java.sql.Connection connDB) {
    ...
    private void initComponents() {
        ...
        setMaximizable(true);
        setResizable(true);
        setTitle("Accounts Payable Audit");
        ...
        searchTextFieldTxt.setBorder(javax.swing.BorderFactory.createTitledBorder("Search box(Type creditor/supplier names, invoice number to search)"));
    ...
    private void searchTextFieldTxtCaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_searchTextFieldTxtCaretUpdate
        ...
        if (!searchTextFieldTxt.getText().isEmpty() && searchTextFieldTxt.getText().length() > 3) {
            this.auditTable.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB, "SELECT date, dealer, invoice_no, order_no, debit as payment, credit as invoice_amount, user_name, item as details_for_payment FROM ac_accounts_payable WHERE date BETWEEN '" + startDatePicker.getDate() + "' AND '" + endDatePicker.getDate() + "' AND (dealer ilike '%" + searchTextFieldTxt.getText() + "%' or invoice_no ilike '%" + searchTextFieldTxt.getText() + "%')  ORDER BY 1"));
        } else {
