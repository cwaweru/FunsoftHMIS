 ...
 *
 */
public class AccountsAuditTrailIntfr extends javax.swing.JInternalFrame {
     ...
     */
    public AccountsAuditTrailIntfr(java.sql.Connection connDB) {
    ...
    private void initComponents() {
        ...
        setMaximizable(true);
        setResizable(true);
        setTitle("General Ledger Accounts Audit Trail");
        ...
        searchTextFieldTxt.setBorder(javax.swing.BorderFactory.createTitledBorder("Search box(Type client names, client or accounting document number to search)"));
        ...
        invoiceDetailsPanel.setEnabled(false);
        invoiceDetailsPanel.setLayout(new java.awt.GridBagLayout());

        invoiceDetailsScrollPane.setBorder(javax.swing.BorderFactory.createTitledBorder(""));
        ...
        invoicesAuditTabbedPane.addTab("Transaction Details", invoiceDetailsPanel);
    ...
    private void searchTextFieldTxtCaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_searchTextFieldTxtCaretUpdate
        ...
        if (!searchTextFieldTxt.getText().isEmpty() && searchTextFieldTxt.getText().length() > 3) {
            this.auditTable.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB, "SELECT date, activity_code as gl_account, invoice_no as document_no, transaction_no, transaction_type, description, debit, credit FROM transaction_list_view WHERE date BETWEEN '" + startDatePicker.getDate() + "' AND '" + endDatePicker.getDate() + "' AND (invoice_no ilike '%" + searchTextFieldTxt.getText() + "%' or description ilike '%" + searchTextFieldTxt.getText() + "%' or transaction_type ilike '%" + searchTextFieldTxt.getText() + "%') ORDER BY 1"));
        } else {
