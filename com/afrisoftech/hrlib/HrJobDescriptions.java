 ...
 * @author  root
 */
public class HrJobDescriptions extends javax.swing.JDialog {
    ...
    public HrJobDescriptions(java.awt.Frame parent, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB, boolean modal, int repName, java.sql.Connection connectDb) {
    ...
    private void initComponents() {
        ...
        jButton1.setText("Get Job Description");
        ...
        jPanel4.setBorder(javax.swing.BorderFactory.createTitledBorder("Get Job Description By"));
        jPanel4.setLayout(new java.awt.GridBagLayout());

        searchLabel.setText("Enter Staff ID");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
...
this.dispose();            // Add your handling code here:
    ...
    private void jCheckBox1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jCheckBox1ActionPerformed
        ...
        searchLabel.setText("Enter Staff ID Number:");
   ...
   /* public java.util.Vector getBeginEndDates() {
    ...
    public void getReport(int reportName) {
        ...
        switch (reportName) {
            ...
            {
                com.afrisoftech.hr.JobDescription policy = new com.afrisoftech.hr.JobDescription();
                policy.SEARCH_BY=SEARCH_BY;
                policy.SearchText=searchtext.getText();
                policy.JD(connectDB,searchtext.getText());
