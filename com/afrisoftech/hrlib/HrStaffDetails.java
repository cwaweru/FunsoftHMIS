 ...
 * @author  root
 */
public class HrStaffDetails extends javax.swing.JDialog {
    ...
    public HrStaffDetails(java.awt.Frame parent, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB, boolean modal, int repName, java.sql.Connection connectDb) {
    ...
    private void initComponents() {
        ...
        jButton1.setText("Get Staff File");
        ...
        jPanel4.setBorder(javax.swing.BorderFactory.createTitledBorder("Get Staff File By"));
        jPanel4.setLayout(new java.awt.GridBagLayout());

        searchLabel.setText("Enter Staff Details");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
   ...
   /* public java.util.Vector getBeginEndDates() {
    ...
    public void getReport(int reportName) {
        ...
        switch (reportName) {
            ...
            {
                com.afrisoftech.hr.StaffFile policy = new com.afrisoftech.hr.StaffFile();
                policy.SEARCH_BY=SEARCH_BY;
                policy.SearchText=searchtext.getText();
                policy.StaffFile(connectDB,searchtext.getText());
