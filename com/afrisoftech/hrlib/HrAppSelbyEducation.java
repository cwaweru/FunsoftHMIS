 ...
 * @author  root
 */
public class HrAppSelbyEducation extends javax.swing.JDialog {
    ...
    public HrAppSelbyEducation(java.awt.Frame parent, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB, boolean modal, int repName, java.sql.Connection connectDb) {
        ...
        initComponents();
         crset1.setCommand("SELECT distinct initcap(edu_level) as name from hr.hr_appresume_basic order by name");
