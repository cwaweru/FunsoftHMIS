...
public class CafeteriaFinalInvoiceByinvPdf implements java.lang.Runnable {
  ...
  //  public void CafeteriaFinalInvoiceByinvPdf(){
  ...
  //  }
    ...
    public void CafeteriaFinalInvoiceByinvPdf(java.sql.Connection connDb, java.lang.String inv1, java.lang.String inv2) {
            ...
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        com.lowagie.text.HeaderFooter footer = new com.lowagie.text.HeaderFooter(new Phrase(Messg+". ENJOY YOUR MEAL, THANK YOU!"),false);// FontFactory.getFont(com.lowagie.text.FontFactory.HELVETICA, 14, Font.BOLDITALIC,java.awt.Color.blue)));
                    ...
                    try {
                        ...
                        for (int j = 0; j < listofStaffNos.length; j++) {
                            ...
                            try {
                                ...
                                phrase = new Phrase("CAFETERIA FINAL INVOICE", pFontHeader1);
                                table.addCell(phrase);
                                ...
                                while (rset4.next()){
                                    ...
                                    while (rset11.next()){
                                        ...
                                        while (rset31.next()){
                                            ...
                                            table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                                            phrase = new Phrase("Debtor Name: "+dbObject.getDBObject(rset31.getObject(1), "-"), pFontHeader1);
                                            table.addCell(phrase);
                                            ...
                                            while (rset12.next()){
                                                ...
                                                table.addCell(phrase);      //  table.getDefaultCell().setColspan(1);
                                                    ...
                                                    table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                                                    phrase = new Phrase(" Payroll Invoice No.: "+dbObject.getDBObject(rset11.getObject(1), "-"), pFontHeader);
                                                    //  phrase = new Phrase("Invoice No. ", pFontHeader);
                                                    ...
                                                    while (rset5.next()){
                                                        ...
                                                        while (rset.next()){
                                                            ...
                                                            table.getDefaultCell().setColspan(3);
                                                            table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                                                            phrase = new Phrase("Staff Name.: "+dbObject.getDBObject(rset.getObject(2), "-"), pFontHeader);
                                                            table.addCell(phrase);
                                                            ...
                                                            phrase = new Phrase("STAFF PF No.: "+dbObject.getDBObject(rset.getObject(1), "-"), pFontHeader);
