            ...
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        java.sql.ResultSet rset2x = st2.executeQuery("SELECT rep_currency from pb_hospitalprofile");
                        while(rset2x.next()){
                    ...
                    try {
                        ...
                        try {
                            ...
                            for (int i = 0; i < listofAct.length; i++) {
                                ...
                                //java.sql.Statement stmta1 = connectDB.createStatement();
                                java.sql.PreparedStatement pSeta1 = connectDB.prepareStatement("SELECT count(acc_no) FROM ac_doctors_ledger where  acc_no ilike '"+listofAct[i]+"' and credit_bal > 0");
                                java.sql.PreparedStatement pset22 = connectDB.prepareStatement("select distinct staff_no||' '||first_name||' '||middle_name from pb_doctors_list WHERE staff_no ilike ?");//< '"+endDate+"'::date and date > '"+endDate+"'::date - 30 group by dealer");
                                ...
                                if (name > 0){
                                    ...
                                    java.sql.PreparedStatement pset1 = connectDB.prepareStatement("select sum(credit_bal) from ac_doctors_ledger WHERE acc_no ilike ?  AND input_date < '"+ageingDates[0][0]+"'");//< '"+endDate+"'::date and date > '"+endDate+"'::date - 30 group by dealer");
                                    pset1.setString(1,listofAct[i].toString());
                                    java.sql.ResultSet rset1 = pset1.executeQuery();
                                    
                                    java.sql.PreparedStatement pset111 = connectDB.prepareStatement("select sum(credit_bal-debit_bal) from ac_doctors_ledger WHERE acc_no ilike ?  AND input_date < '"+endDate+"'");//< '"+endDate+"'::date and date > '"+endDate+"'::date - 30 group by dealer");
                                    pset111.setString(1,listofAct[i].toString());
                                    java.sql.ResultSet rset111 = pset111.executeQuery();
                                    java.sql.Statement st02 = connectDB.createStatement();
                                    
                                    
                                    java.sql.PreparedStatement pset112 = connectDB.prepareStatement("select sum(debit_bal) from ac_doctors_ledger WHERE acc_no ilike ? AND input_date < '"+endDate+"'");
                                    pset112.setString(1,listofAct[i].toString());
                                    java.sql.ResultSet rset112 = pset112.executeQuery();
    ...
    public java.lang.Object[] getListofActivities() {
        ...
        try {
            ...
            if(balType.equalsIgnoreCase("Both")){
                ...
                java.sql.PreparedStatement pSet1 = connectDB.prepareStatement("SELECT DISTINCT acc_no FROM ac_doctors_ledger where (acc_no IS NOT NULL OR acc_no !='') and credit_bal <> 0 order by acc_no");
