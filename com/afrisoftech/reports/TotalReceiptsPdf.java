                ...
                try {
                    ...
                    try {
                        ...
                        try {
                            ...
                            java.sql.ResultSet rset = st.executeQuery("select date,receipt_no,upper(dealer),user_name,payment_mode,cheque_no,sum(debit-credit) from ac_cash_collection WHERE date::DATE BETWEEN '"+beginDate+"' AND '"+endDate+"' AND transaction_type = 'Receipts' GROUP BY date,receipt_no,dealer,account_no,payment_mode,user_name,cheque_no ORDER BY date");
                            java.sql.ResultSet rsetTotals = st2.executeQuery("SELECT SUM(debit) from ac_cash_collection WHERE date::DATE BETWEEN '"+beginDate+"' AND '"+endDate+"' AND transaction_type = 'Receipts'");
