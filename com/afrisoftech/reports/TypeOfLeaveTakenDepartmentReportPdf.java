...
public class TypeOfLeaveTakenDepartmentReportPdf implements java.lang.Runnable {
    ...
    public void LeaveTakenDetailsPdf(java.sql.Connection connDb, java.util.Date begindate, java.util.Date endate, java.lang.String department
                ...
                try {
                    ...
                    try {
                        ...
                        try {
                            ...
                            java.sql.ResultSet rsetOne = stOne.executeQuery("SELECT employee_no, division, section FROM master_file "
