...
public class PatientRefundpdfs implements java.lang.Runnable {
  ...
  double allocation,total_commitments,balance1,this_entry,balance2;
    ...
    public void PatientRefundpdfs(java.sql.Connection connDb, java.lang.String voucno) {
                    ...
                    try {
                      ...
                      /*2*/  table.getDefaultCell().setBorder(Rectangle.TOP|Rectangle.RIGHT );
                        ...
                        /*3*/     table.getDefaultCell().setBorder(  Rectangle.LEFT);    
                            ...
                            //table.getDefaultCell().setBorderColor(java.awt.Color.BLACK);
                            phrase = new Phrase("PATIENT REFUND VOUCHER", pFontHeader31);
                         ...
                         /*4*/     table.getDefaultCell().setBorder( Rectangle.RIGHT );       
                           ...
                           // table.getDefaultCell().setBorderColor(java.awt.Color.WHITE);
                            ...
                            table.addCell(phrase);
/*5*/     table.getDefaultCell().setBorder(  Rectangle.RIGHT | Rectangle.LEFT);    
                             table.getDefaultCell().setColspan(6);
                                table.getDefaultCell().setBorderColor(java.awt.Color.BLACK);
                                table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
...
/*6*/     table.getDefaultCell().setBorder(  Rectangle.RIGHT | Rectangle.LEFT);                                
    ...
    java.sql.Statement st334 = connectDB.createStatement();
                ...
                table.getDefaultCell().setBorderColor(java.awt.Color.BLACK);
                         ...
                         //hapa 
                          ...
                          }else if(retention_amount!=0 && witholding_amount!=0){
                              table.getDefaultCell().setFixedHeight(35);
                          }else{
...
//addition
                           ...
                           table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                            phrase = new Phrase("Less Witholding Tax ", pFontHeader20);
                            table.addCell(phrase);
...
*/
                            ...
                            invoice_total_amt=String.valueOf(Double.parseDouble(invoice_total_amt)-(retention_amount+witholding_amount));
