...
public class AssetsRegPdf implements java.lang.Runnable {
    ...
    com.lowagie.text.Font pFontHeader3 = FontFactory.getFont(FontFactory.HELVETICA, 9, Font.ITALIC);
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    com.lowagie.text.HeaderFooter footer = new com.lowagie.text.HeaderFooter(new Phrase("Asset Register - Page: ", pFontHeader2), true);// FontFactory.getFont(com.lowagie.text.FontFactory.HELVETICA, 12, Font.BOLDITALIC,java.awt.Color.blue));
                    ...
                    try {
                        ...
                        int headerwidths[] = {8, 8, 30, 20, 20, 10, 10, 13, 10, 10, 20};
                        ...
                        Phrase phrase = new Phrase("Assets Register Report ".toUpperCase(), pFontHeader2);
                        ...
                        phrase = new Phrase("Index", pFontHeader3);
                        table.addCell(phrase);

                        phrase = new Phrase("Tag No", pFontHeader4);
                        table.addCell(phrase);

                        phrase = new Phrase("Asset Name", pFontHeader4);
                        table.addCell(phrase);

                        phrase = new Phrase("Department", pFontHeader4);
                        table.addCell(phrase);

                        phrase = new Phrase("Make", pFontHeader4);
                        table.addCell(phrase);

                        phrase = new Phrase("Serial No", pFontHeader4);
                        table.addCell(phrase);
                        phrase = new Phrase("Manf", pFontHeader4);
                        table.addCell(phrase);
                        phrase = new Phrase("Model", pFontHeader4);
                        table.addCell(phrase);
                        phrase = new Phrase("Orig Country", pFontHeader4);
                        table.addCell(phrase);
                        phrase = new Phrase("Supplier", pFontHeader4);
                        table.addCell(phrase);
                        table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_RIGHT);
                        phrase = new Phrase("Value" + "(" + ks + ")", pFontHeader4);
                        table.addCell(phrase);
                        table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                        ...
                        try {
                            ...
                            java.sql.ResultSet rset3 = st3.executeQuery("select tag_no,make,initcap(serial_registration_no),initcap(manufacturer),model,country_of_origin,supplier, asset_name, asset_value, dept_requested from asset_registration order by make");
                            ...
                            table.getDefaultCell().setColspan(1);
                            double assetValueTotal = 0.00;
                            int index = 1;
                            while (rset3.next()) {
                                table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                                phrase = new Phrase(String.valueOf(index), pFontHeader3);
                                table.addCell(phrase);
                                table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                                ...
                                table.addCell(phrase);
                                table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_RIGHT);
                                phrase = new Phrase(com.afrisoftech.lib.CurrencyFormatter.getFormattedDouble(rset3.getDouble(9)), pFontHeader1);
                                table.addCell(phrase);
                                assetValueTotal = assetValueTotal + rset3.getDouble(9);
                                index++;
                            ...
                            table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                            phrase = new Phrase("Asset Totals".toUpperCase(), pFontHeader2);
                            table.addCell(phrase);
//                            table.getDefaultCell().setColspan(1);
//                            while (rset33.next()) {
//                                table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
//                                phrase = new Phrase(dbObject.getDBObject(rset33.getObject(1), "-"), pFontHeader);
//                                table.addCell(phrase);
//                            }
                            ...
                            table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_RIGHT);
                            phrase = new Phrase(com.afrisoftech.lib.CurrencyFormatter.getFormattedDouble(assetValueTotal), pFontHeader2);
                            table.addCell(phrase);
