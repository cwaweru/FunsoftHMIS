            ...
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        int headerwidths[] = {6,10,10,30,12,7,23};
                        ...
                        try {
                            ...
                            java.sql.ResultSet rset = st.executeQuery("select DISTINCT date_admitted,patient_no,initcap(patient_name),ward,bed_no,ward_code from hp_admission WHERE date_admitted BETWEEN '"+beginDate+"' AND '"+endDate+"' order by date_admitted,patient_no");
