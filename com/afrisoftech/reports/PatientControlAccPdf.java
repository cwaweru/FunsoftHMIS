...
public class PatientControlAccPdf implements java.lang.Runnable {
    ...
    com.lowagie.text.Font pFontHeader1 = FontFactory.getFont(FontFactory.HELVETICA, 12, Font.BOLD);
      com.lowagie.text.Font pFontHeader11 = FontFactory.getFont(FontFactory.HELVETICA, 8, Font.BOLDITALIC);
    ...
    public void PatientControlAccPdf(java.sql.Connection connDb,java.util.Date begindate, java.util.Date endate) {
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    com.lowagie.text.HeaderFooter footer = new com.lowagie.text.HeaderFooter(new Phrase("Patient Control Account - Page: ", pFontHeader11), true);// FontFactory.getFont(com.lowagie.text.FontFactory.HELVETICA, 12, Font.BOLDITALIC,java.awt.Color.blue));
                    ...
                    try {
                        ...
                        int headerwidths[] = {5,10,15,25,15,15,15};
                        ...
                        try {
                            ...
                            phrase = new Phrase("PATIENT CONTROL ACCOUNT TRANSACTIONS : PERIOD " +dateFormat.format(endDate1)+ " - " +dateFormat.format(endDate11), com.lowagie.text.FontFactory.getFont(FontFactory.HELVETICA_BOLD,10));
                       ...
                       // table.addCell(phrase);
                        ...
                        try {
                          ...
                          //  java.lang.Object[] listofAct1 = this.getListofActivities1();
                            ...
                            java.sql.ResultSet rsetTotals = st21.executeQuery("SELECT sum(debit-credit) from patient_control_accdet where date BETWEEN '"+beginDate+"' AND '"+endDate+"' group by date");
                           ...
                           // for (int k = 0; k < listofAct1.length; k++) {
                              ...
                              //  System.out.println(""+listofAct1[k].toString());
                                java.sql.ResultSet rset1 = st2.executeQuery("SELECT date::date,patient_no,name,name,debit as debit,credit as credit, balance from patient_control_accdet WHERE date BETWEEN '"+beginDate+"' AND '"+endDate+"' group by patient_no,date,name,debit,credit,balance ORDER BY date");
                                 ...
                                 //   table.addCell(phrase);
                                    while (rset1.next()) {
                                        ...
                                        table.addCell(phrase);
                                         ...
                                         table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_RIGHT);
                                        phrase = new Phrase(new com.afrisoftech.sys.Format2Currency().Format2Currency(rset1.getString(5)),pFontNum);
                                        table.addCell(phrase);
                                         table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_RIGHT);
                                        phrase = new Phrase(new com.afrisoftech.sys.Format2Currency().Format2Currency(rset1.getString(6)),pFontNum);
                                        table.addCell(phrase);
                                        
                                        table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_RIGHT);
                                        phrase = new Phrase(new com.afrisoftech.sys.Format2Currency().Format2Currency(rset1.getString(7)),pFontNum);
                                        table.addCell(phrase);
                          ...
                          //  while (rsetTotals.next()) {
                                ...
                                phrase = new Phrase(new com.afrisoftech.sys.Format2Currency().Format2Currency(java.lang.String.valueOf(debits)), pFontHeader1);
                                
                                table.addCell(phrase);
                                
                                 phrase = new Phrase(new com.afrisoftech.sys.Format2Currency().Format2Currency(java.lang.String.valueOf(credits)), pFontHeader1);
