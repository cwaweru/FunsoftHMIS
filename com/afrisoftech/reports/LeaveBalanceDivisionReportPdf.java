...
public class LeaveBalanceDivisionReportPdf implements java.lang.Runnable {
            ...
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_CENTER);
                        Phrase phrase = new Phrase("LEAVE DAYS BALANCE DIVISION REPORT BETWEEN "+sdf.format(beginDate)+" AND "+sdf.format(endDate)+
                                "\n"+div.toUpperCase(), pFontHeader);
                        table.addCell(phrase); 
...
docPdf.close();  com.afrisoftech.lib.PDFRenderer.renderPDF(tempFile);
    ...
    public void getNoAndName() {
        ...
        try {
                ...
                java.sql.ResultSet rse = stm.executeQuery("SELECT DISTINCT employee_no, first_name, middle_name, last_name, employee_grade, "
                        + "leave_date, leave_days FROM master_file WHERE division = '"+div+"' "
    ...
    public void addTableItems(com.lowagie.text.pdf.PdfPTable table, java.lang.String number, java.lang.String name, java.lang.String jobG
        ...
        String ent_leave = " -- ", section = " ", department = " ", leaveDays = " ";
        ...
        try {
            ...
            java.sql.ResultSet rsetOne = stOne.executeQuery("SELECT department, section FROM master_file WHERE employee_no = '"+number+"'");

            while(rsetOne.next()) {
                department = dbObject.getDBObject(rsetOne.getObject(1), " ");
