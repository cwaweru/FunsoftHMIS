                ...
                try {
                    ...
                    try {
                        ...
                        try {
                            ...
                            java.sql.ResultSet rsetTotals = st2.executeQuery("select sum(credit) from doc_scm_view where acc_no = '"+memNo+"' AND input_date BETWEEN '"+beginDate+"' AND '"+endDate+"'");
                             for (int j = 0; j < listofStaffNos.length; j++) {
                                double OsBalance1 = 0.00;
                                double OsBalance2 = 0.00;
                                double OsBalance = 0.00;
                                java.sql.ResultSet rset1 = st1.executeQuery("select input_date, upper(name),pat_inv,credit from doc_scm_view where  scheme = '"+listofStaffNos[j]+"' AND acc_no = '"+memNo+"' AND input_date BETWEEN '"+beginDate+"' AND '"+endDate+"' order by input_date");
...
docPdf.close();  com.afrisoftech.lib.PDFRenderer.renderPDF(tempFile);
    ...
    public java.lang.Object[] getListofStaffNos() {
        ...
        try {
            ...
            java.sql.ResultSet rSet1 = stmt1.executeQuery("SELECT DISTINCT scheme FROM doc_scm_view WHERE input_date BETWEEN '"+beginDate+"' AND '"+endDate+"' and acc_no = '"+memNo+"' order by scheme");
