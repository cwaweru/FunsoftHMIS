...
public class LabWorkTimePdf implements java.lang.Runnable {
    ...
    public void LabWorkTimePdf(java.sql.Connection connDb, java.util.Date begindate, java.util.Date endate) {
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    com.lowagie.text.HeaderFooter footer = new com.lowagie.text.HeaderFooter(new Phrase("lab List - Page: ", pFontHeader1), true);// FontFactory.getFont(com.lowagie.text.FontFactory.HELVETICA, 12, Font.BOLDITALIC,java.awt.Color.blue));
                    ...
                    try {
                        ...
                        int headerwidths[] = {8, 10, 20, 7, 7, 8, 15, 20, 10, 12};
                        ...
                        Phrase phrase = new Phrase("Laboratory Results : ", com.lowagie.text.FontFactory.getFont(FontFactory.HELVETICA_BOLD, 10));
                        ...
                        phrase = new Phrase("Lab No", pFontHeader);
                        table.addCell(phrase);
                        ...
                        phrase = new Phrase("Time Sample Collected", pFontHeader);

                        table.addCell(phrase);

                        phrase = new Phrase("Results Time", pFontHeader);
                        ...
                        try {
                            ...
                            java.sql.ResultSet rset1 = st2.executeQuery("SELECT date,patient_no,INITCAP(patient_name),lab_no,age,gender,typeof_test,spec_time::TIME(0),input_date::TIME(0),input_date::TIMESTAMP(0)-spec_time::TIMESTAMP(0),pathologist FROM hp_lab_results WHERE date BETWEEN '" + beginDate + "' AND '" + endDate + "' GROUP BY date,patient_no,patient_name,lab_no,age,gender,typeof_test,pathologist,spec_time::TIME(0),input_date::TIME(0),input_date::TIMESTAMP(0),spec_time::TIMESTAMP(0) ORDER BY 1,4");
                            ...
                            while (rset1.next()) {
                                ...
                                table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                                // phrase = new Phrase(dbObject.getDBObject(rset1.getObject(10), "-"),pFontNum);
                                phrase = new Phrase(dbObject.getDBObject(rset1.getObject(10), "-"), pFontNum);
