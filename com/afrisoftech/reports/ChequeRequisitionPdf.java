...
public class ChequeRequisitionPdf implements java.lang.Runnable {
    ...
    public void ChequeRequisitionPdf(java.sql.Connection connDb, java.lang.String combox) {
            ...
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        int headerwidths[] = {15,30,15,10,20,10};
                        ...
                        try {
                            ...
                            java.sql.ResultSet rset1 = st1.executeQuery("select DISTINCT dealer,item from ac_accounts_payable where cash_point = '"+MNo+"'");
                            ...
                            java.sql.ResultSet rs = st.executeQuery("select DISTINCT cash_point,dealer from ac_accounts_payable where cash_point = '"+MNo+"'");
                            java.sql.ResultSet rset5 = st5.executeQuery("select sum(credit-debit) from ac_accounts_payable where cash_point = '"+MNo+"'");
                            ...
                            while (rset3.next()){
                                ...
                                phrase = new Phrase("Email :  "+rset3.getObject(6).toString()+"; "+"Website:"+"\t" +rset3.getObject(7).toString(), pFontHeader);
                                table.addCell(phrase);
                            ...
                            phrase = new Phrase("CHEQUE REQUISITION", pFontHeader3);
                            ...
                            while (rs.next()){
                                ...
                                phrase = new Phrase("Payee : "+ rs.getObject(2).toString(), pFontHeader);
                                
                                table.addCell(phrase);
                                table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_RIGHT);
                                phrase = new Phrase("Requisition No : "+ rs.getString(1), pFontHeader);
                                table.addCell(phrase);
                            }
                            ...
                            for (int i = 0; i < listofAct.length; i++) {
                                double bal = 0.00;
                                java.sql.ResultSet rset6 = st6.executeQuery("select invoice_no,sum(credit-debit),item from ac_accounts_payable where cash_point ='"+MNo+"' and item = '"+listofAct[i]+"' GROUP BY invoice_no,item");
                                table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                                table.getDefaultCell().setColspan(6);
                                ...
                                while (rset6.next()){
                                    ...
                                    table.addCell(phrase);
                                    bal = bal + rset6.getDouble(2);
                                    totals = totals + rset6.getDouble(2);
                                    table.getDefaultCell().setColspan(1);
                            ...
                            phrase = new Phrase("Requisitioned By : " +userName , pFontHeader1);
                            table.addCell(phrase);
    ...
    public java.lang.Object[] getListofActivities() {
        ...
        try {
            ...
            java.sql.ResultSet rSet1 = stmt1.executeQuery("select DISTINCT item from ac_accounts_payable WHERE cash_point = '"+MNo+"' ORDER BY item");
