...
public class GeneratedVoucherCrdNotePdf implements java.lang.Runnable {
    ...
    java.lang.String lponumber = null;
    ...
    public void GeneratedVoucherCrdNotePdf(java.sql.Connection connDb, java.lang.String lpo,java.lang.String invoice) {
            ...
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        java.sql.ResultSet rset2 = st3.executeQuery("SELECT distinct supplier from st_stock_cardex  where order_no ilike '%"+lponumber+"%'");
                        java.sql.ResultSet rset4 = st4.executeQuery("SELECT date('now') as Date");
                        while (rset2.next()) {
                            //compName = rset2.getObject(1).toString();
                            suppName = rset2.getObject(1).toString();
                        }
                        // while(rset4.next())
...
//                            }
                           ...
                           // table.getDefaultCell().setColspan(2);
                            ...
                            java.sql.Statement st454 = connectDB.createStatement();
                            java.sql.ResultSet rs454 = st454.executeQuery("select voucher_no from ac_accounts_payable   WHERE  order_no='" +lponumber+ "' and invoice_no='"+invs+"'");
                            while (rs454 .next()) {

                                voucher_nos=rs454.getString(1);
                            }
                            ...
                            //while (rset1.next()) {
                                ...
                                table.getDefaultCell().setBorderColor(java.awt.Color.WHITE);
                                table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                                phrase = new Phrase(suppName, pFontHeader);

                                table.addCell(phrase);
                                
                                 java.sql.ResultSet rset189 = st33.executeQuery("SELECT postal_address,pin_no,vat_no FROM st_suppliers WHERE supplier_name ILIKE '%" +suppName+ "%'");
                           ...
                           // table.getDefaultCell().setColspan(1);
                            ...
                            ////////////////////loading the particulars data
                             // java.sql.ResultSet rset8167 = st5.executeQuery("SELECT distinct supplier as supplier_name, st.item,  order_no,activity_code,invoice_no,debit  from st_stock_cardex st where st.approved=true and order_no ilike '%" +lponumber+ "%' and st.transaction_type ilike 'Receiving' and delivered_by!= 'Reversal'   group by supplier,order_no,st.item,activity_code,invoice_no,debit   order by supplier_name");

                             java.sql.ResultSet rset8167 = st5.executeQuery("select st.item ,ac.credit,ac.activity_code,ac.transaction_type from  st_stock_cardex st , ac_accounts_payable ac  where st.order_no=ac.order_no and ac.invoice_no='"+invs+"' and st.approved=true ");
                              String particulars="",lposnum=null;
                              lposnum=lponumber;
                            while (rset8167.next()) {
                                //this.suppName = rset8167.getString(1);
                                particulars=particulars+rset8167.getString("item")+",";
                                
                                
                              total_amount=Double.parseDouble(rset8167.getString("credit"));
                              
                            activity_code=rset8167.getString("activity_code").toString();
                            
                            transtype=rset8167.getString("transaction_type").toString();
                            ...
                            table.getDefaultCell().setColspan(3);
                           // table.getDefaultCell().setColspan(1);
                            phrase = new Phrase(lponumber, pFontHeader11);
                            table.addCell(phrase);
