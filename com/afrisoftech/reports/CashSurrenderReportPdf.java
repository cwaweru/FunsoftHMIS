...
public class CashSurrenderReportPdf implements java.lang.Runnable {
    ...
    public void CashSurrenderReportPdf(java.sql.Connection connDb, java.lang.String combox, java.lang.String cashPoint, java.lang.String userName) {
        memNo = combox;
                    ...
                    try {
                        ...
                        try {
                            ...
                            for (int i = 0; i < receiptNos.length; i++) {
                                ...
                                java.sql.ResultSet rsety = sty.executeQuery("select sum(debit),sum(credit),sum(debit-credit) from ac_cash_collection where receipt_no = '" + receiptNos[i] + "' AND shift_no = '" + memNo + "'  AND payment_mode = 'Cash' group by receipt_no");
                            ...
                            phrase = new Phrase(new com.afrisoftech.sys.Format2Currency().Format2Currency(java.lang.String.valueOf(cashBalTotal)), pFontHeader);
