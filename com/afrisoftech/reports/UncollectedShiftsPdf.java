...
public class UncollectedShiftsPdf implements java.lang.Runnable {
            ...
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        phrase = new Phrase("Net "+ks,pFontHeader);
                        table.addCell(phrase);
    ...
    public java.lang.Object[] getListofStaffNos() {
        ...
        try {
            ...
            java.sql.ResultSet rSet1 = stmt1.executeQuery("SELECT DISTINCT shift_no FROM ac_cash_collection WHERE reconciled ='false' and date between '"+beginDate+"'::date and  '"+endDate+"'");
