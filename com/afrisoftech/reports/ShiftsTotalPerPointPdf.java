...
public class ShiftsTotalPerPointPdf implements java.lang.Runnable {
    ...
    public void ShiftsTotalPerPointPdf(java.sql.Connection connDb, java.util.Date begindate, java.util.Date endate, java.lang.String cashPoint) {
            ...
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        int headerwidths[] = {5, 8, 10, 8, 5, 12, 12, 12, 12, 12, 9, 13, 12, 12, 10};
...
docPdf.close();  com.afrisoftech.lib.PDFRenderer.renderPDF(tempFile);
    ...
    public java.lang.Object[] getListofStaffNos() {
        ...
        try {
            ...
            java.sql.ResultSet rSet1 = stmt1.executeQuery("SELECT DISTINCT shift_no FROM ac_shifts WHERE start_date::date BETWEEN '" + beginDate + "'::date AND '" + endDate + "'::date AND cash_point = '"+CashPoint+"' ORDER BY 1 ASC");
