...
public class LeaveBalanceSectionReportPdf implements java.lang.Runnable {
    ...
    public void LeaveBalanceDetailsPdf(java.sql.Connection connDb, java.util.Date begindate, java.util.Date endate, java.lang.String section) {
            ...
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_CENTER);
                        Phrase phrase = new Phrase("LEAVE DAYS BALANCE SECTION REPORT BETWEEN "+sdf.format(beginDate)+" AND "+sdf.format(endDate)
                                +"\n"+sec.toUpperCase(), pFontHeader);
                        table.addCell(phrase); 
...
docPdf.close();  com.afrisoftech.lib.PDFRenderer.renderPDF(tempFile);
    ...
    public void getNoAndName() {
        ...
        try {
                ...
                java.sql.ResultSet rse = stm.executeQuery("SELECT DISTINCT employee_no, first_name, middle_name, last_name, employee_grade, "
                        + "leave_date, leave_days FROM master_file WHERE section = '"+sec+"' "
    ...
    public void addTableItems(com.lowagie.text.pdf.PdfPTable table, java.lang.String number, java.lang.String name, java.lang.String jobG
        ...
        String ent_leave = " -- ", division = " ", department = " ", leaveDays = " ";
        ...
        try {
            ...
            java.sql.ResultSet rsetOne = stOne.executeQuery("SELECT division, department FROM master_file WHERE employee_no = '"+number+"'");

            while(rsetOne.next()) {
                division = dbObject.getDBObject(rsetOne.getObject(1), " ");
                department = dbObject.getDBObject(rsetOne.getObject(2), " ");
            }
