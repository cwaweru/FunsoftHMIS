...
public class CreditorsAlphaPdf implements java.lang.Runnable {
    double Credit = 0.00;
    ...
    public void CreditorsAlphaPdf(java.sql.Connection connDb,java.util.Date begindate,java.util.Date endate, java.lang.String bType, java.lang.String actCode) {
        balType = bType;
        connectDB = connDb;
        beginDate = begindate;
        endDate = endate;
    ...
    public java.lang.Object[] getListofActivities() {
        ...
        try {
            ...
            if(balType.equalsIgnoreCase("both")){
                ...
                java.sql.PreparedStatement pSet1 = connectDB.prepareStatement("SELECT DISTINCT  CASE WHEN (dealer IS NULL) THEN '-' ELSE dealer END AS dealer, sum(credit-debit) FROM ac_accounts_payable WHERE date::date <= '"+endDate+"' AND activity_code = '"+activityCode+"'  GROUP BY  dealer HAVING sum(credit-debit) <> 0 order by 1 ASC");
