...
public class LeaveTakenDepSecReportPdf implements java.lang.Runnable {
            ...
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_CENTER);
                        Phrase phrase = new Phrase("LEAVE DAYS TAKEN REPORT BETWEEN "+sdf.format(beginDate)+" AND "+sdf.format(endDate)+""
