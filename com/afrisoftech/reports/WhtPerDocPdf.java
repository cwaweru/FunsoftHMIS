                ...
                try {
                  ...
                  */
                    ...
                    try {
                        ...
                        int headerwidths[] = {15,15,25,15,15,15,15};
                    ...
                    try {
                        ...
                        int headerwidths[] = {10,10,10,10,10,9,9,9,9,9,10};
                        ...
                        try {
                            ...
                            phrase = new Phrase("Net Pay "+ks,pFontHeader1);
                            table.addCell(phrase);
                            ...
                            for (int i = 0; i < listofAct.length; i++) {
                                ...
                                java.sql.ResultSet rset1 = st1.executeQuery("select distinct input_date::date,cheque_no,voucher_no,debit from ac_doctors_payments where account_no = '"+memNo+"' and input_date BETWEEN '"+beginDate+"' AND '"+endDate+"' and voucher_no = '"+listofAct[i]+"' and debit > 0 order by input_date::date");// union select date::date,initcap(service) as service,dosage,reference,credit from hp_patient_card where patient_no = '"+memNo+"' and credit > 0 order by date");
                            ...
                            table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                            phrase = new Phrase("Total "+ks, pFontHeaderT);
