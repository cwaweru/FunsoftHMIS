...
public class LeaveBalanceDivSecReportPdf implements java.lang.Runnable {
    ...
    public void LeaveBalanceDetailsPdf(java.sql.Connection connDb, java.util.Date begindate, java.util.Date endate, java.lang.String division, 
            ...
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        int headerwidths[] = {20, 20, 20, 20, 20, 20, 20, 20};
                        ...
                        table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_CENTER);
                        Phrase phrase = new Phrase("LEAVE BALANCE REPORT BETWEEN "+sdf.format(beginDate)+" AND "+sdf.format(endDate)+"\nDIVISION - "+div.toUpperCase()+" "
                        ...
                        System.out.println("Size of Job Group Vector - "+jobgrade.size());
                        
                        System.out.println("Will we populate this table, let's try...");
                        
                        for (int x = 0; x<no.size(); x++) {  
                            addTableItems(table, (String) no.elementAt(x), (String) name.elementAt(x), (String) jobgrade.elementAt(x)
...
docPdf.close();  com.afrisoftech.lib.PDFRenderer.renderPDF(tempFile);
    ...
    public void getNoAndName() {
        ...
        jobgrade = new java.util.Vector<String>();
        ...
        try {
                ...
                java.sql.ResultSet rse = stm.executeQuery("SELECT DISTINCT employee_no, first_name, middle_name, last_name, employee_grade, "
                        + "leave_date FROM master_file WHERE division = '"+div+"' AND section = '"+sec+"' "
                ...
                while (rse.next()) {
                    ...
                    jobgrade.add(dbObject.getDBObject(rse.getObject(5), " -- "));
    ...
    public void addTableItems(com.lowagie.text.pdf.PdfPTable table, java.lang.String number, java.lang.String name, java.lang.String jobG
        ...
        String ent_leave = " -- ", leaveDays = " ", department = " -- ";
        ...
        try {
            ...
            java.sql.ResultSet rsetTwo = stTwo.executeQuery("SELECT department FROM master_file WHERE employee_no = '"+number+"'");

            while(rsetTwo.next()) {
                department = dbObject.getDBObject(rsetTwo.getObject(1), " -- ");
            }
