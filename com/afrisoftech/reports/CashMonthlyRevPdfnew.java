...
public class CashMonthlyRevPdfnew implements java.lang.Runnable {
    ...
    public void CashMonthlyRevPdfnew(java.sql.Connection connDb, java.util.Date begindate, java.util.Date endate) {
...
java.sql.PreparedStatement psethq = connectDB.prepareStatement("SELECT '"+listofAct[i].toString()+"'::date");
                                java.sql.ResultSet rsethq = psethq.executeQuery();

                                while (rsethq.next()) {
                                    daiys = rsethq.getString(1);
                                }
                                ...
                                java.sql.PreparedStatement pset = connectDB.prepareStatement("select sum(amount) FROM mohanalysis WHERE date = '" + daiys + "' AND transaction_type != 'Banking'");
                                ...
                                java.sql.PreparedStatement psetwav = connectDB.prepareStatement("select sum(amount) FROM mohanalysis WHERE date = '" + daiys + "' AND transaction_type ilike 'waiv%'");
                                ...
                                java.sql.PreparedStatement psetwn2 = connectDB.prepareStatement("select sum(amount) FROM mohanalysis WHERE date = '" + daiys + "' AND transaction_type ILIKE 'Exemptio%'");
                                ...
                                java.sql.PreparedStatement pset11a = connectDB.prepareStatement("select gl_account from pb_operating_parameters WHERE category = 'IPP'");
                                java.sql.ResultSet rset11a = pset11a.executeQuery();
                                double currentIPPTotal = 0.00;
                                while (rset11a.next()) {
                                    ip = rset11a.getString(1);
                                    //    System.out.println("IPP receipt_time::date is : ["+listofAct[i].toString()+"]");
                                    //     System.out.println("Currently doing IPP gl code [ "+ip.toString()+" ]");
                                    //                                 java.sql.PreparedStatement pset1 = connectDB.prepareStatement("select sum(debit-credit) from ac_cash_collection WHERE receipt_time::date = '"+listofAct[i]+"' AND activity_code = '"+ip+"' AND transaction_type != 'Banking'");//< '"+endDate+"'::receipt_time::date and receipt_time::date > '"+endDate+"'::receipt_time::date - 30 group by dealer");

                                    // Get the value of the total debit-credit collected for all services for the respective receipt_time::date for IPP related services
                                    // This becomes the value of the column labeled IN-Patient services (Column 2) on the Report
                                    java.sql.PreparedStatement pset1 = connectDB.prepareStatement("select sum(amount) FROM mohanalysis WHERE date = '" + daiys + "' AND activity_code = '" + ip + "'");//< '"+endDate+"'::date and date > '"+endDate+"'::date - 30 group by dealer");
                                ...
                                java.sql.PreparedStatement psetj = connectDB.prepareStatement("select gl_account from pb_operating_parameters WHERE category = 'MAT'");
                                ...
                                while (rsetj.next()) {
                                    ...
                                    java.sql.PreparedStatement psetj1 = connectDB.prepareStatement("select sum(amount) FROM mohanalysis WHERE date = '" + daiys + "' AND activity_code = '" + mat + "'");
                                ...
                                java.sql.PreparedStatement pset11 = connectDB.prepareStatement("select gl_account from pb_operating_parameters WHERE category = 'XRY'");
                                ...
                                while (rset11.next()) {
                                    ...
                                    java.sql.PreparedStatement pset12 = connectDB.prepareStatement("select sum(amount) FROM mohanalysis WHERE date = '" + daiys + "' AND activity_code = '" + xray + "'");
                                ...
                                while (rset111.next()) {
                                    lab = rset111.getString(1);
                                    //     System.out.println("LAB receipt_time::date is : ["+listofAct[i].toString()+"]");
                                    //     System.out.println("Currently doing LAB gl code [ "+lab.toString()+" ]");
                                    java.sql.PreparedStatement pset121 = connectDB.prepareStatement("select sum(amount) FROM mohanalysis WHERE date = '" + daiys + "' AND activity_code = '" + lab + "'");
                                ...
                                while (rsets1.next()) {
                                    ...
                                    java.sql.PreparedStatement psets1e = connectDB.prepareStatement("select sum(amount) FROM mohanalysis WHERE date = '" + daiys + "' AND activity_code = '" + the + "'");
                                ...
                                while (rsetd1.next()) {
                                    ...
                                    java.sql.PreparedStatement psetd = connectDB.prepareStatement("select sum(amount) FROM mohanalysis WHERE date = '" + daiys + "' AND activity_code = '" + mot + "'");
                                ...
                                while (rsetp.next()) {
                                    ...
                                    java.sql.PreparedStatement psetp1 = connectDB.prepareStatement("select sum(amount) FROM mohanalysis WHERE date = '" + daiys + "' AND activity_code = '" + opp + "'");
                                ...
                                while (rseth.next()) {
                                    ...
                                    java.sql.PreparedStatement pseth1 = connectDB.prepareStatement("select sum(amount) FROM mohanalysis WHERE date = '" + daiys + "' AND activity_code = '" + pha + "'");
                                    java.sql.ResultSet rseth1 = pseth1.executeQuery();

                                    while (rseth1.next()) {
                                        currentPFTotal = currentPFTotal + rseth1.getDouble(1);
                                    // java.sql.PreparedStatement psetw = connectDB.prepareStatement("select sum(debit-credit) from ac_cash_collection WHERE receipt_time::date = '"+listofAct[i]+"' AND (activity_code NOT LIKE '"+pha+"' OR activity_code NOT LIKE '"+opp+"' OR activity_code NOT LIKE '"+mot+"' OR activity_code NOT LIKE '"+the+"' OR activity_code NOT LIKE '"+xray+"' OR activity_code NOT LIKE '"+mot+"')");
                                ...
                                java.sql.PreparedStatement psethb = connectDB.prepareStatement("select distinct gl_account from pb_operating_parameters WHERE category = 'AOT'");
                                ...
                                while (rsethb.next()) {
                                    ...
                                    java.sql.PreparedStatement psetw = connectDB.prepareStatement("select sum(amount) FROM mohanalysis WHERE date = '" + daiys + "' AND activity_code = '" + aot + "'");//(activity_code NOT LIKE '"+pha+"' OR activity_code NOT LIKE '"+opp+"' OR activity_code NOT LIKE '"+mot+"' OR activity_code NOT LIKE '"+the+"' OR activity_code NOT LIKE '"+xray+"' OR activity_code NOT LIKE '"+mot+"')");
                                    java.sql.ResultSet rsetw = psetw.executeQuery();
                                ...
                                java.sql.PreparedStatement psethb1 = connectDB.prepareStatement("select distinct gl_account from pb_operating_parameters WHERE category = 'AOT' ORDER BY gl_account");
                                ...
                                if (i < listofAct1.length) {
                                    java.sql.PreparedStatement psetcw = connectDB.prepareStatement("select sum(amount) FROM mohanalysis WHERE activity_code = '" + listofAct1[i] + "' AND date between '" + beginDate + "' AND '" + endDate + "'");// AND transaction_type ilike 'receipt%'");
                                ...
                                while (rsethbF.next()) {
                                    ...
                                    java.sql.PreparedStatement psetbk = connectDB.prepareStatement("select sum(amount) FROM mohanalysis WHERE date = '" + daiys + "' AND activity_code = '" + fct + "'");
                                ...
                                while (rsethbp.next()) {
                                    ...
                                    java.sql.PreparedStatement psetbp = connectDB.prepareStatement("select sum(amount) FROM mohanalysis WHERE date = '" + daiys + "' AND activity_code = '" + pmo + "'");
                                ...
                                while (rsetod.next()) {
                                    ...
                                    java.sql.PreparedStatement psethdt = connectDB.prepareStatement("select sum(amount) FROM mohanalysis WHERE date = '" + daiys + "' AND activity_code = '" + dbt + "'");
                                ...
                                while (rsethnh.next()) {
                                    ...
                                    java.sql.PreparedStatement psetwnh = connectDB.prepareStatement("select sum(amount) FROM mohanalysis WHERE date = '" + daiys + "' AND activity_code = '" + nhifs + "'");//(activity_code NOT LIKE '"+pha+"' OR activity_code NOT LIKE '"+opp+"' OR activity_code NOT LIKE '"+mot+"' OR activity_code NOT LIKE '"+the+"' OR activity_code NOT LIKE '"+xray+"' OR activity_code NOT LIKE '"+mot+"')");
                                    ...
                                    java.sql.PreparedStatement psetwn1d = connectDB.prepareStatement("select sum(debit-credit) from ac_debtors WHERE date = '" + daiys + "'  AND activity_code = '" + nhifs + "'  AND debit > 0");
                                    ...
                                    java.sql.PreparedStatement psetwn4 = connectDB.prepareStatement("select sum(debit-credit) from ac_debtors WHERE date = '" + daiys + "'  AND activity_code != '" + nhifs + "' AND debit > 0");
                                ...
                                java.sql.PreparedStatement psetwn = connectDB.prepareStatement("select sum(amount) FROM mohanalysis WHERE date = '" + daiys + "' AND transaction_type ILIKE 'Waiver'");
                                ...
                                java.sql.PreparedStatement psetwn3 = connectDB.prepareStatement("select sum(credit-debit) from ac_debtors WHERE date = '" + daiys + "' AND payee ILIKE 'ABS%'");
                                java.sql.ResultSet rsetwn3 = psetwn3.executeQuery();


                                java.sql.PreparedStatement psetz = connectDB.prepareStatement("select sum(credit-debit) from ac_debtors WHERE date = '" + daiys + "' AND transaction_type ILIKE 'Receipts'  AND activity_code = '" + nhifs + "'");
                                java.sql.ResultSet rsetz = psetz.executeQuery();

                                java.sql.PreparedStatement psetc = connectDB.prepareStatement("select sum(credit-debit) from ac_debtors WHERE date = '" + daiys + "' AND transaction_type ILIKE 'Receipts'  AND activity_code != '" + nhifs + "'");
                                java.sql.ResultSet rsetc = psetc.executeQuery();

                                java.sql.PreparedStatement psetcd = connectDB.prepareStatement("SELECT EXTRACT(DAY FROM DATE '" + daiys + "')");// AND transaction_type ILIKE 'Receipts' AND (payee NOT ILIKE 'nhif%' OR payee NOT ILIKE 'n.h.i.f%')");
                                ...
                                janu = Cashs + nhifdebts + othdebts + currentDRTotal;// + currentNHIFTotal;
