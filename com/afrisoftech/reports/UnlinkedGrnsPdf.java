...
public class UnlinkedGrnsPdf implements java.lang.Runnable {
    ...
    public void UnlinkedGrnsPdf(java.sql.Connection connDb,java.util.Date begindate, java.util.Date endate ) {
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    com.lowagie.text.HeaderFooter footer = new com.lowagie.text.HeaderFooter(new Phrase("Unlinked GRN's - Page: ",pFontHeader), true);// FontFactory.getFont(com.lowagie.text.FontFactory.HELVETICA, 12, Font.BOLDITALIC,java.awt.Color.blue));
                    ...
                    try {
                        ...
                        int headerwidths[] = {15,14,33,12,12,14};
                        ...
                        try {
                            ...
                            phrase = new Phrase("Unlinked GRN's List :     Period : From "  +dateFormat.format(endDate11)+" To "+dateFormat.format(endDate1), pFontHeader);
                        ...
                        try {
                            ...
                            java.sql.ResultSet rset = st.executeQuery("select invoice_no,date,dealer,sum(credit),sum(debit) from unlinkedgrns WHERE date BETWEEN '"+beginDate+"' AND '"+endDate+"' GROUP BY invoice_no,date,dealer ORDER BY date");
                            ...
                            while (rset.next()){
                                ...
                                osBalance1 = osBalance1 + (rset.getDouble(4) - rset.getDouble(5));
                                table.addCell(phrase);
