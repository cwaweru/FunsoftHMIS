                    ...
                    try {
                        ...
                        try {
                            ...
                            for (int i = 0; i < listofAct.length; i++) {
                                ...
                                while (rset11ag.next()) {
                                    java.sql.PreparedStatement psetwav = connectDB.prepareStatement("select sum(credit-debit) FROM ac_cash_collection WHERE receipt_time::date = '" + listofAct[i] + "' AND activity_code = '" + rset11ag.getString(1) + "'");
                                ...
                                while (rset11ag1.next()) {
                                    java.sql.PreparedStatement psetwn2 = connectDB.prepareStatement("select sum(credit-debit) FROM ac_cash_collection WHERE receipt_time::date = '" + listofAct[i] + "' AND activity_code = '" + rset11ag1.getString(1) + "'");
                                ...
                                while (rset11a.next()) {
                                    ...
                                    //java.sql.PreparedStatement pset1 = connectDB.prepareStatement("select sum(debit-credit) FROM ac_cash_collection WHERE receipt_time::date = '" + listofAct[i] + "' AND activity_code = '" + ip + "' ");//< '"+endDate+"'::date and date > '"+endDate+"'::date - 30 group by dealer");
                                ...
                                while (rsetj.next()) {
                                    ...
                                    java.sql.PreparedStatement psetj1 = connectDB.prepareStatement("select sum(debit-waived) FROM moh_reports WHERE receipt_time::date = '" + listofAct[i] + "' AND activity_code = '" + mat + "' ");
                                ...
                                while (rset11.next()) {
                                    ...
                                    java.sql.PreparedStatement pset12 = connectDB.prepareStatement("select sum(debit-waived) FROM moh_reports WHERE receipt_time::date = '" + listofAct[i] + "' AND activity_code = '" + xray + "' ");
                                ...
                                while (rset111.next()) {
                                    ...
                                    java.sql.PreparedStatement pset121 = connectDB.prepareStatement("select sum(debit-waived) FROM moh_reports WHERE receipt_time::date = '" + listofAct[i] + "' AND activity_code = '" + lab + "' ");
                                ...
                                while (rsets1.next()) {
                                    ...
                                    java.sql.PreparedStatement psets1e = connectDB.prepareStatement("select sum(debit-waived) FROM moh_reports WHERE receipt_time::date = '" + listofAct[i] + "' AND activity_code = '" + the + "' ");
                                ...
                                while (rsetd1.next()) {
                                    ...
                                    java.sql.PreparedStatement psetd = connectDB.prepareStatement("select sum(debit-waived) FROM moh_reports WHERE receipt_time::date = '" + listofAct[i] + "' AND activity_code = '" + mot + "' ");
                                ...
                                while (rsetp.next()) {
                                    ...
                                    java.sql.PreparedStatement psetp1 = connectDB.prepareStatement("select sum(debit-waived) FROM moh_reports WHERE receipt_time::date = '" + listofAct[i] + "' AND activity_code = '" + opp + "' ");
                                ...
                                while (rseth.next()) {
                                    ...
                                    java.sql.PreparedStatement pseth1 = connectDB.prepareStatement("select sum(debit-waived) FROM moh_reports WHERE receipt_time::date = '" + listofAct[i] + "' AND activity_code = '" + pha + "' ");
                                ...
                                while (rsethb.next()) {
                                    ...
                                    java.sql.PreparedStatement psetw = connectDB.prepareStatement("select sum(debit-waived) FROM moh_reports WHERE receipt_time::date = '" + listofAct[i] + "' AND activity_code = '" + aot + "' ");//(activity_code NOT LIKE '"+pha+"' OR activity_code NOT LIKE '"+opp+"' OR activity_code NOT LIKE '"+mot+"' OR activity_code NOT LIKE '"+the+"' OR activity_code NOT LIKE '"+xray+"' OR activity_code NOT LIKE '"+mot+"')");
                                    java.sql.ResultSet rsetw = psetw.executeQuery();
                                ...
                                if (i < listofAct1.length) {
                                    java.sql.PreparedStatement psetcw = connectDB.prepareStatement("select sum(debit-waived) FROM moh_reports WHERE activity_code = '" + listofAct1[i] + "' AND receipt_time::date between '" + beginDate + "' AND '" + endDate + "' ");// AND transaction_type ilike 'receipt%'");
                                ...
                                while (rset11agn.next()) {
                                    java.sql.PreparedStatement psetwn = connectDB.prepareStatement("select sum(credit-debit) FROM ac_cash_collection WHERE receipt_time::date = '" + listofAct[i] + "' AND activity_code = '" + rset11agn.getString(1) + "'");
