...
public class DentalResSlipPdf_1 implements java.lang.Runnable {
    ...
    public void DentalResSlipPdf(java.sql.Connection connDb,java.lang.String voucno) {
                ...
                try {
                    ...
                    try {
                        ...
                        try {
                            ...
                            java.sql.ResultSet rset = st.executeQuery("select input_date::timestamp(0),initcap(patient_no),patient_name,xray_no,age,gender,doctor,1,1,examination,xray_manager,ext_ref,pc,hpc,pdhs,exam,exam_notes,imp_inv,inv,diag,plan,notes,upper(user_name) from hp_xray_results where xray_no='"+vouchNo+"'");
