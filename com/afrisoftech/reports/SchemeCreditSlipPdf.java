...
public class SchemeCreditSlipPdf implements java.lang.Runnable {
    ...
    public void SchemeCreditSlipPdf(java.sql.Connection connDb,java.lang.String combox,java.lang.String scheme,java.lang.String patient,java.lang.String schpayer,java.lang.String membNo,int slipno) {
                ...
                try {
                    ...
                    try {
                        ...
                        try {
                            ...
                            java.sql.ResultSet rsetTotals22 = st22.executeQuery("SELECT current_user,CURRENT_TIMESTAMP(0)::time");
                            while (rset3.next()){
                            ...
                            phrase = new Phrase("Pat No : " +patNo, pFontHeader1);
