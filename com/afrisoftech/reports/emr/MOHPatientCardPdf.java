...
public class MOHPatientCardPdf implements java.lang.Runnable {
...
//                            table.addCell(phrase);
                            ...
                            table.getDefaultCell().setColspan(12);
                            phrase = new Phrase("Admission Date : " + com.afrisoftech.lib.PatientFile.getPatientAdmissionDate().toString(), pFontHeader);
                            table.addCell(phrase);
                            ...
                            phrase = new Phrase("Heart Rate", pFontHeader1);
                            table.addCell(phrase);
                            table.getDefaultCell().setColspan(1);
                            ...
                            phrase = new Phrase("SUMMARY ADMISSION/CLINICAL OUTCOME", pFontHeader22);
                            table.addCell(phrase);
                            table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                            table.getDefaultCell().setColspan(3);
                            phrase = new Phrase(" ", pFontHeader11);
                            ...
                            table.addCell(phrase);
                            table.getDefaultCell().setColspan(2);
                            phrase = new Phrase("Admission Info.", pFontHeader11);
                            table.addCell(phrase);
                            table.getDefaultCell().setColspan(16);
                            phrase = new Phrase("Reason for admission", pFontHeader11);
                            table.addCell(phrase);
                            table.getDefaultCell().setColspan(16);
                            phrase = new Phrase("Lenth of stay", pFontHeader11);
                            table.addCell(phrase);
                            table.getDefaultCell().setColspan(16);
                            phrase = new Phrase("Referred from:", pFontHeader11);
                            table.addCell(phrase);
                            table.getDefaultCell().setColspan(3);
                            phrase = new Phrase(" ", pFontHeader11);
                            table.addCell(phrase);
                            ...
                            table.addCell(phrase);
                            table.getDefaultCell().setColspan(2);
                            phrase = new Phrase("Care Summary", pFontHeader11);
                            table.addCell(phrase);
                            table.getDefaultCell().setColspan(16);
                            phrase = new Phrase("Mode of delivery", pFontHeader11);
                            table.addCell(phrase);
                            table.getDefaultCell().setColspan(16);
                            phrase = new Phrase("Duration of stay", pFontHeader11);
                            table.addCell(phrase);
                            table.getDefaultCell().setColspan(16);
                            phrase = new Phrase("Admission Outcome", pFontHeader11);
                            table.addCell(phrase);
                            table.getDefaultCell().setColspan(3);
                            phrase = new Phrase("Referred to", pFontHeader11);
                            table.addCell(phrase);
                            ...
                            phrase = new Phrase("Doctor Incharge:", pFontHeader11);
                            table.addCell(phrase);
                            table.getDefaultCell().setColspan(24);
                            phrase = new Phrase("Date and Time Discharge", pFontHeader11);
                            table.addCell(phrase);
                            table.getDefaultCell().setColspan(3);
                            phrase = new Phrase(" ", pFontHeader11);
                            table.addCell(phrase);
    ...
    public static JFreeChart getPartoChart() throws SQLException, IOException {
        ...
        XYSeries series5 = new XYSeries("BP_Systolic");
        XYSeries series6 = new XYSeries("BP_Diastolic");
        XYSeries series7 = new XYSeries("Weight");
        XYSeries series8 = new XYSeries("Height");
        XYSeries series9 = new XYSeries("BMI");
        int i = 0;
        while (rs.next()) {
            ...
            series5.add(i, rs.getDouble("systolic"));
            series6.add(i, rs.getDouble("diastolic"));
            series7.add(i, rs.getDouble("weight"));
            series8.add(i, rs.getDouble("height"));
            series9.add(i, rs.getDouble("bmi"));
            i++;
        }
        for (int j = i; j < 12; j++) {
            series1.add(j, null);
        ...
        seriesCollection.addSeries(series5);
        seriesCollection.addSeries(series6);
        seriesCollection.addSeries(series7);
        seriesCollection.addSeries(series8);
        seriesCollection.addSeries(series9);
        final JFreeChart chart = ChartFactory.createXYLineChart(
                "Patient Management Chart",
                "Hours",
                "Patient Vital Signs Values",
                seriesCollection,
