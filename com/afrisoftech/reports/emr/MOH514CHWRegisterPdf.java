...
public class MOH514CHWRegisterPdf implements java.lang.Runnable {
    ...
    public void MOH514CHWRegisterPdf(java.sql.Connection connDb, java.util.Date startDate, java.util.Date lastDate) {
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    com.lowagie.text.HeaderFooter footer = new com.lowagie.text.HeaderFooter(new Phrase("MOH - 514 : Community Health Worker (CHW) Household Register : Page: "), true);// FontFactory.getFont(com.lowagie.text.FontFactory.HELVETICA, 12, Font.BOLDITALIC,java.awt.Color.blue));
                    ...
                    try {
                        ...
                        int headerwidths[] = {5, 10, 10, 12, 12, 25, 12, 12, 12, 12, 9, 9, 9, 12, 12, 12, 12, 12, 12, 9, 9, 9, 9, 9, 9, 20, 9, 10, 10, 10, 20, 25};
                        ...
                        try {
                            ...
                            phrase = new Phrase("MOH 514_Community Health Worker Household Register", pFontHeader2);
                            ...
                            phrase = new Phrase("CHW Household REGISTER", pFontHeader22);
                            table.addCell(phrase);
                            ...
                            phrase = new Phrase("Date of data collection", pFontHeader11);
                            table.addCell(phrase);

                            phrase = new Phrase("Village Name", pFontHeader11);
                            table.addCell(phrase);

                            phrase = new Phrase("Household Number", pFontHeader11);
                            table.addCell(phrase);

                            phrase = new Phrase("Household has functional latrine in use", pFontHeader11);
                            table.addCell(phrase);

                            phrase = new Phrase("Household with hand washing facilities", pFontHeader11);
                            table.addCell(phrase);

                            phrase = new Phrase("Household using treated water", pFontHeader11);
                            table.addCell(phrase);

                            phrase = new Phrase("No. of pregnant women counselled on indivindual birth plan (BP)", pFontHeader11);
                            table.addCell(phrase);

                            phrase = new Phrase("Total no. of deliveries (with skilled and inskilled attendances)", pFontHeader11);
                            table.addCell(phrase);

                            phrase = new Phrase("No. of pregnant women who delivered under skilled birth attendants", pFontHeader11);
                            table.addCell(phrase);

                            phrase = new Phrase("No. of new-born visited at home within 48 hours of delivery", pFontHeader11);
                            table.addCell(phrase);

                            phrase = new Phrase("No. of mothers with new-borns counselled on Exclusive breast feeding (EBF)", pFontHeader11);
                            table.addCell(phrase);

                            phrase = new Phrase("No. of women (15-49 years) provided with Family planning commodities by CHWs", pFontHeader11);
                            table.addCell(phrase);

                            phrase = new Phrase("No. of children 0-59 months participating in growth monitoring", pFontHeader11);
                            table.addCell(phrase);

                            phrase = new Phrase("No. of children 0-59 months with MUAC indicating (Red) severe mulnutrition", pFontHeader11);
                            table.addCell(phrase);

                            phrase = new Phrase("No. of children 6-59 months with MUAC indicating (Yellow) moderate mulnutrition", pFontHeader11);
                            table.addCell(phrase);

                            phrase = new Phrase("No. of children 12-59 months dewormed", pFontHeader11);
                            table.addCell(phrase);

                            phrase = new Phrase("No. of pregnant women referred for ANC", pFontHeader11);
                            table.addCell(phrase);

                            phrase = new Phrase("No. of pregnant women referred for skilled delivery", pFontHeader11);
                            table.addCell(phrase);

                            phrase = new Phrase("No. of home deliveries referred for Post Natal Care (PNC) Services", pFontHeader11);
                            table.addCell(phrase);

                            phrase = new Phrase("No. of children 0-11 months referred for immunization", pFontHeader11);
                            table.addCell(phrase);

                            phrase = new Phrase("No. of Children 6-59 months referred for Vitamin A supplementation", pFontHeader11);
                            table.addCell(phrase);

                            phrase = new Phrase("No. of cases of cough more than 2 weeks referred", pFontHeader11);
                            table.addCell(phrase);

                            phrase = new Phrase("No. of indivinduals referred for HIV counselling and testing (HCT)", pFontHeader11);
                            table.addCell(phrase);

                            phrase = new Phrase("No. of elderly people (60+) referred for routine health checkups", pFontHeader11);
                            table.addCell(phrase);

                            phrase = new Phrase("Known cases of chronic illness referred (a=Diabetes, b=Cancer, c=Mental Illness, d=Hypertension, e=Chronic Respiratory Disease, f=Others (specify)", pFontHeader11);
                            table.addCell(phrase);

                            phrase = new Phrase("No. of ANC defaulters referred", pFontHeader11);
                            table.addCell(phrase);

                            phrase = new Phrase("No. of Immunization defaulters referred", pFontHeader11);
                            table.addCell(phrase);
                            
                            phrase = new Phrase("No. of TB treatment defaulters traced and referred", pFontHeader11);
                            table.addCell(phrase);
                            
                            phrase = new Phrase("No. of ART defaulters referred", pFontHeader11);
                            table.addCell(phrase);
                            
                            phrase = new Phrase("No. of deaths in the month (a=0-11months, b=12-59 months, c=Maternal, d=Other deaths)", pFontHeader11);
                            table.addCell(phrase);
