...
public class MOH513CHWHouseholdLogPdf implements java.lang.Runnable {
    ...
    public void MOH513CHWHouseholdLogPdf(java.sql.Connection connDb, java.util.Date startDate, java.util.Date lastDate) {
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    com.lowagie.text.HeaderFooter footer = new com.lowagie.text.HeaderFooter(new Phrase("MOH - 513 : Household Register : Page: "), true);// FontFactory.getFont(com.lowagie.text.FontFactory.HELVETICA, 12, Font.BOLDITALIC,java.awt.Color.blue));
                    ...
                    try {
                        ...
                        com.lowagie.text.pdf.PdfPTable table = new com.lowagie.text.pdf.PdfPTable(30);

                        int headerwidths[] = {5, 10, 10, 12, 12, 25, 30, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 20, 12, 10, 25, 35};
                        ...
                        try {
                            ...
                            phrase = new Phrase("MOH 513_Community Health Worker Household Register", pFontHeader2);
                            ...
                            phrase = new Phrase("Indivindual Code", pFontHeader11);
                            table.addCell(phrase);

                            phrase = new Phrase("Name of household member", pFontHeader11);
                            table.addCell(phrase);

                            phrase = new Phrase("Age in completed years (<1 for 1 Year or less)", pFontHeader11);
                            table.addCell(phrase);

                            phrase = new Phrase("Sex (M/F)", pFontHeader11);
                            table.addCell(phrase);

                            phrase = new Phrase("Relationship to HHH (1=HHH, 2=Spouse, Child(B), 4=Child(R), 5=Grandchild, 6=Brother/Sister, 7=Others)", pFontHeader11);
                            table.addCell(phrase);

                            phrase = new Phrase("Orphan(Y/N)", pFontHeader11);
                            table.addCell(phrase);

                            phrase = new Phrase("Birth Certificate (Y/N)", pFontHeader11);
                            table.addCell(phrase);

                            phrase = new Phrase("In School (Y/N)", pFontHeader11);
                            table.addCell(phrase);

                            phrase = new Phrase("Pregnant (Y/N)", pFontHeader11);
                            table.addCell(phrase);

                            phrase = new Phrase("Mother and Child Health Booklet (Y/N)", pFontHeader11);
                            table.addCell(phrase);

                            phrase = new Phrase("ANC (4 + times) (Y/N)", pFontHeader11);
                            table.addCell(phrase);

                            phrase = new Phrase("Skilled Birth Attendant(Y/N)", pFontHeader11);
                            table.addCell(phrase);

                            phrase = new Phrase("Exclusively Breastfeeding (Y/N)", pFontHeader11);
                            table.addCell(phrase);

                            phrase = new Phrase("Using FP Methods (1=Modern, 2=Traditional/Natural, 3=None)", pFontHeader11);
                            table.addCell(phrase);

                            phrase = new Phrase("Penta 1 Given (Y/N)", pFontHeader11);
                            table.addCell(phrase);

                            phrase = new Phrase("Penta 3 Given (Y/N)", pFontHeader11);
                            table.addCell(phrase);

                            phrase = new Phrase("Measles Given (Y/N)", pFontHeader11);
                            table.addCell(phrase);

                            phrase = new Phrase("Fully Immunised (Y/N)", pFontHeader11);
                            table.addCell(phrase);

                            phrase = new Phrase("Vitamin A Given (Y/N)", pFontHeader11);
                            table.addCell(phrase);

                            phrase = new Phrase("Children 6-23 months receiving 3 or more food groups three times a day (Y/N)", pFontHeader11);
                            table.addCell(phrase);

                            phrase = new Phrase("Severely Malnourished(MUAC indicating Red) (Y/N)", pFontHeader11);
                            table.addCell(phrase);

                            phrase = new Phrase("Moderately Malnourished(MUAC indicating Yellow) (Y/N)", pFontHeader11);
                            table.addCell(phrase);

                            phrase = new Phrase("LLIN use (Y/N)", pFontHeader11);
                            table.addCell(phrase);

                            phrase = new Phrase("Known chronic illness (1=Diabetes, 2=Cancer, 3=Mental Illness, 4=Hypertension, 5=Chronic Respiratory Diseases", pFontHeader11);
                            table.addCell(phrase);

                            phrase = new Phrase("Cough (2 weeks and above) (Y/N)", pFontHeader11);
                            table.addCell(phrase);

                            phrase = new Phrase("Knows HIV status (Y/N)", pFontHeader11);
                            table.addCell(phrase);

                            phrase = new Phrase("Disability (1=Visual, 2=Hearing, 3=Speech, 4=Physical, 5=Mental, 6=Other", pFontHeader11);
                            table.addCell(phrase);
