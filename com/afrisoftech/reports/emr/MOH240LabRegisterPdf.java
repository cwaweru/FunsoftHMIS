...
public class MOH240LabRegisterPdf implements java.lang.Runnable {
    ...
    public void MOH240LabRegisterPdf(java.sql.Connection connDb, java.util.Date startDate, java.util.Date lastDate) {
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    com.lowagie.text.HeaderFooter footer = new com.lowagie.text.HeaderFooter(new Phrase("MOH - 240 : Laboratory Register : Page: "), true);// FontFactory.getFont(com.lowagie.text.FontFactory.HELVETICA, 12, Font.BOLDITALIC,java.awt.Color.blue));
                    ...
                    try {
                        ...
                        int headerwidths[] = {5, 10, 10, 7, 7, 25, 7, 12, 12, 12, 9, 9, 9, 12, 12, 15,15, 7, 12, 9, 9, 9, 9, 20, 9, 20, 9};
                        ...
                        try {
                            ...
                            phrase = new Phrase("MOH 240_Laboratory Register", pFontHeader2);
                            ...
                            phrase = new Phrase("LABORATORY REGISTER", pFontHeader22);
                            table.addCell(phrase);
                            ...
                            phrase = new Phrase("Lab No.", pFontHeader11);
                            table.addCell(phrase);

                            phrase = new Phrase("Revisit No.", pFontHeader11);
                            table.addCell(phrase);
                            ...
                            phrase = new Phrase("Clinical Diagnosis", pFontHeader11);
                            table.addCell(phrase);

                            phrase = new Phrase("Prior Treatment", pFontHeader11);
                            table.addCell(phrase);

                            phrase = new Phrase("Type of Specimen", pFontHeader11);
                            table.addCell(phrase);

                            phrase = new Phrase("Condition of the Specimen", pFontHeader11);
                            table.addCell(phrase);

                            phrase = new Phrase("Investigation Required", pFontHeader11);
                            table.addCell(phrase);

                            phrase = new Phrase("Dare Sample Collected", pFontHeader11);
                            table.addCell(phrase);

                            phrase = new Phrase("Date Sample Received", pFontHeader11);
                            table.addCell(phrase);

                            phrase = new Phrase("Clinician Name", pFontHeader11);
                            table.addCell(phrase);

                            phrase = new Phrase("Date Sample Analysed", pFontHeader11);
                            table.addCell(phrase);

                            phrase = new Phrase("Results", pFontHeader11);
                            table.addCell(phrase);

                            phrase = new Phrase("Date Result Dispatched", pFontHeader11);
                            table.addCell(phrase);
                            ...
                            phrase = new Phrase("Name of analysing officer", pFontHeader11);
                            table.addCell(phrase);
