...
public class MOH204AOPUnder5RegisterPdf implements java.lang.Runnable {
    ...
    public void MOH204AOPUnder5RegisterPdf(java.sql.Connection connDb, java.util.Date startDate, java.util.Date lastDate) {
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    com.lowagie.text.HeaderFooter footer = new com.lowagie.text.HeaderFooter(new Phrase("MOH - 204A : OP Under 5 Yrs Register : Page: "), true);// FontFactory.getFont(com.lowagie.text.FontFactory.HELVETICA, 12, Font.BOLDITALIC,java.awt.Color.blue));
                    ...
                    try {
                        ...
                        try {
                            ...
                            phrase = new Phrase("MOH 204A_Under 5 Yrs Register", pFontHeader2);
                            ...
                            phrase = new Phrase("OP UNDER 5 YEARS REGISTER", pFontHeader22);
                            table.addCell(phrase);
                            ...
                            phrase = new Phrase("Danger Signs", pFontHeader11);
                            table.addCell(phrase);

                            phrase = new Phrase("Duration of Illness", pFontHeader11);
                            table.addCell(phrase);

                            phrase = new Phrase("Diagnosis/Classification", pFontHeader11);
                            table.addCell(phrase);

                            phrase = new Phrase("Given: 1=ORS, 2=Zinc, 3=Vit.A", pFontHeader11);
                            table.addCell(phrase);
                            ...
                            phrase = new Phrase("Follow Up (Y/N)", pFontHeader11);
                            table.addCell(phrase);
                        ...
                        try {
                            ...
                            for (int i = 0; i < listofAct.length; i++) {
                                ...
                                java.sql.PreparedStatement stw = connectDB.prepareStatement("SELECT DISTINCT "
                                        ...
                                        + " (SELECT temp::numeric(5,1) FROM hp_signs_record WHERE hp_signs_record.patient_no = hp_patient_visit.patient_no AND hp_signs_record.date = hp_patient_visit.date ORDER BY 1 DESC LIMIT 1) as temperature, "
                                        + " (SELECT urgency FROM hp_signs_record WHERE hp_signs_record.patient_no = hp_patient_visit.patient_no AND hp_signs_record.date = hp_patient_visit.date ORDER BY 1 DESC LIMIT 1) as danger_sign, "
                                        + "  (SELECT duration_of_illness FROM hp_clinical_results WHERE hp_clinical_results.patient_no = hp_patient_visit.patient_no AND hp_clinical_results.date = hp_patient_visit.date  ORDER BY 1 DESC LIMIT 1) as duration_of_illness, "
                                        ...
                                        + "  (SELECT (CASE WHEN suppliments_given ilike '%ors%' THEN '1' ELSE ''"
                                        + " END ||' '||CASE WHEN suppliments_given ilike '%zinc%' THEN '2' ELSE ''"
                                        + " END ||' '||CASE WHEN suppliments_given ilike '%vit%' THEN '3' ELSE ''"
                                        + " END) FROM key_health_indicators WHERE key_health_indicators.patient_no = "
                                        + " hp_patient_visit.patient_no) as suppliments,"
                                        ...
                                        + "ORDER BY 1 DESC LIMIT 1) as follow_up, "
                                        + " '', "
