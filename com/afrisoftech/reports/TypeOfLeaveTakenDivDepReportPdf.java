...
public class TypeOfLeaveTakenDivDepReportPdf implements java.lang.Runnable {
    ...
    public void LeaveTakenDetailsPdf(java.sql.Connection connDb, java.util.Date begindate, java.util.Date endate, 
            java.lang.String division, java.lang.String department, java.lang.String typeOfLeave) {
                ...
                try {
                    ...
                    try {
                        ...
                        Phrase phrase = new Phrase(TOL.toUpperCase()+" DAYS TAKEN REPORT BETWEEN "+sdf.format(beginDate)+" AND "+sdf.format(endDate)+
                                "\nDIVISION - "+div.toUpperCase()+" \nDEPARTMENT - "+depart.toUpperCase(), pFontHeader);
                        table.addCell(phrase); 
                        ...
                        try {
                            ...
                            java.sql.ResultSet rsetOne = stOne.executeQuery("SELECT employee_no, section FROM master_file "
                                    + "WHERE division = '"+div+"' AND department = '"+depart+"' ");
