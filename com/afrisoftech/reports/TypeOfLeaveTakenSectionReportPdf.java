...
public class TypeOfLeaveTakenSectionReportPdf implements java.lang.Runnable {
    ...
    public void LeaveTakenDetailsPdf(java.sql.Connection connDb, java.util.Date begindate, java.util.Date endate, java.lang.String section
                ...
                try {
                    ...
                    try {
                        ...
                        try {
                            ...
                            java.sql.ResultSet rsetOne = stOne.executeQuery("SELECT employee_no, division, department FROM master_file "
                                    + "WHERE section = '"+sec+"' ");
