...
public class ReceiptReprintPdf implements java.lang.Runnable {
    ...
    public void ReceiptReprintPdf(java.sql.Connection connDb, java.lang.String combox) {
                            ...
                            try {
                                ...
                                while (rset1.next()) {
                                    ...
                                    while (rset5.next()) {
                                        ...
                                        java.sql.ResultSet rset61 = st2.executeQuery("SELECT sum(debit-credit) FROM hp_patient_card WHERE patient_no = '" + rset1.getObject(3).toString() + "' AND patient_no !=''");
                                        while (rset61.next()) {
