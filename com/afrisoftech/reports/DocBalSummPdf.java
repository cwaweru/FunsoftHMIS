...
public class DocBalSummPdf implements java.lang.Runnable {
    ...
    public void DocBalSummPdf(java.sql.Connection connDb,java.util.Date begindate, java.util.Date endate) {
            ...
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        phrase = new Phrase("Cumm. Amt. "+ks, pFontHeader);
                        ...
                        try {
                            ...
                            for (int i = 0; i < listofAct.length; i++) {
                                ...
                                java.sql.ResultSet rset1 = st.executeQuery("select sum(credit_bal-debit_bal) from ac_doctors_ledger where acc_no ='"+listofAct[i]+"' and input_date <= '"+endDate+"'");// tn,debit_note db WHERE tn.policy_no != '' and tn.policy_no = db.policy_no GROUP BY tn.policy_no,db.policy_class");
