...
public class OtherPayVoucherPdf implements java.lang.Runnable {
    ...
    public void OtherPayVoucherPdf(java.sql.Connection connDb, java.lang.String voucno, boolean printPreview) {
                ...
                try {
                    ...
                    try {
                        ...
                        try {
                            ...
                            java.sql.ResultSet rs = st.executeQuery("select cb.voucher_no,cb.date,cb.cheque_no,initcap(cb.payment_mode) from ac_cash_book cb where cb.voucher_no = '"+vouchNo+"'");
