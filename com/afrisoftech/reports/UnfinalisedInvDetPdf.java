...
public class UnfinalisedInvDetPdf implements java.lang.Runnable {
    ...
    public void UnfinalisedInvDetPdf(java.sql.Connection connDb,java.util.Date begindate, java.util.Date endate) {
                ...
                try {
                    ...
                    try {
                        ...
                        try {
                            ...
                            phrase = new Phrase("OUT-PATIENT BILLS RECONCILIATION : PERIOD " +dateFormat.format(endDate1)+ " - " +dateFormat.format(endDate11), com.lowagie.text.FontFactory.getFont(FontFactory.HELVETICA_BOLD,10));
                       ...
                       // table.addCell(phrase);
                        ...
                        try {
                          ...
                          //  java.lang.Object[] listofAct1 = this.getListofActivities1();
                            ...
                            java.sql.ResultSet rsetTotals = st21.executeQuery("SELECT sum(debit-credit) from outpatient_bills where date BETWEEN '"+beginDate+"' AND '"+endDate+"' group by date");
                           ...
                           // for (int k = 0; k < listofAct1.length; k++) {
                              ...
                              //  System.out.println(""+listofAct1[k].toString());
                                java.sql.ResultSet rset1 = st2.executeQuery("SELECT date::date,patient_no,name,payment_mode,debit as debit,credit as credit, balance from outpatient_bills WHERE date BETWEEN '"+beginDate+"' AND '"+endDate+"'  and balance <>0  group by patient_no,payment_mode,date,name,debit,credit,balance ORDER BY date");
