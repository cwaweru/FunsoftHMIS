            ...
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        //      table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                        phrase = new Phrase("OS Balance "+ks,pFontHeader);
                        table.addCell(phrase);
                        /*
                         *
                         *
...
docPdf.close();  com.afrisoftech.lib.PDFRenderer.renderPDF(tempFile);
    ...
    public java.lang.Object[] getListofActivities() {
        ...
        try {
            ...
            java.sql.PreparedStatement pSet1 = connectDB.prepareStatement("SELECT DISTINCT  CASE WHEN (account_no IS NULL) THEN '-' ELSE account_no END AS dealer,payee FROM ac_debtors where account_no IS NOT NULL and account_no !='' and balance > 0 order by account_no");
