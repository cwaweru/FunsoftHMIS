...
public class TypeOfLeaveTakenDepSecReportPdf implements java.lang.Runnable {
            ...
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_CENTER);
                        Phrase phrase = new Phrase(TOL.toUpperCase()+" DAYS TAKEN REPORT BEWTEEN "+sdf.format(beginDate)+" AND "+sdf.format(endDate)+""
                        ...
                        try {
                            ...
                            java.sql.ResultSet rsetOne = stOne.executeQuery("SELECT employee_no, division FROM master_file "
                                    + "WHERE department = '"+depart+"' AND section = '"+sect+"' ");
