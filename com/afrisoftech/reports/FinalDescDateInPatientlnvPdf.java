...
public class FinalDescDateInPatientlnvPdf implements java.lang.Runnable {
    ...
    public void FinalDescDateInPatientlnvPdf(java.sql.Connection connDb, java.lang.String combox) {
        MNo = combox;
 ...
 String visitId = "";
                           ...
                           java.sql.ResultSet rsetc = stc.executeQuery("SELECT DISTINCT date_admitted,discharge_date::date,(discharge_date::date-date_admitted) FROM hp_admission where invoice_no = '"+memNo+"' "
                             ...
                             * while (rsetc.next()){
                             * table1.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                             * phrase = new Phrase("Adm Date:
                             * "+dbObject.getDBObject(rsetc.getObject(1), "-"),
                             * pFontHeader1); table1.addCell(phrase);
                             *
                             * table1.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                             * phrase7 = new Phrase("Discharge Date:
                             * "+dbObject.getDBObject(rsetc.getObject(2), "-"),
                             * pFontHeader1);
                             * table1.getDefaultCell().setColspan(6);
                             *
                             * table1.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                             * phrase8 = new Phrase("No.of Days :
                             * "+dbObject.getDBObject(rsetc.getObject(3), "-"),
                             * pFontHeader1);
                             *
                             * }
                             */
                    ...
                    try {
                        ...
                        int headerwidths[] = {12, 15, 15, 45, 5, 8, 15, 15};
                        ...
                        try {
                            ...
                            java.lang.Object getListofStaffNosdate[] = this.getListofStaffNosdate();
                            for (int x = 0; x < getListofStaffNosdate.length; x++) {
                                double dayTotal = 0.00;
                                table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                                table.getDefaultCell().setColspan(6);
                                phrase = new Phrase(getListofStaffNosdate[x].toString(), pFontHeader1);

                                table.addCell(phrase);
                                java.lang.Object listofStaffNos1[] = this.getListofStaffNos1(getListofStaffNosdate[x]);

                                for (int k = 0; k < listofStaffNos1.length; k++) {
                                    double osBalance1 = 0.00;
                                    java.sql.ResultSet rset1 = st1.executeQuery(" select date::date, billing_time::time, user_name, initcap(service) as service,dosage::int,reference,debit-credit from hp_patient_card where invoice_no = '" + memNo + "' and paid = 'true' and service != 'N.H.I.F' AND service not ilike 'Receipt%' AND service not ilike 'Receipt Adj' AND service not ilike 'Discou%' AND service != 'Invoice'  AND main_service ilike '" + listofStaffNos1[k] + "' AND date::date = '" + getListofStaffNosdate[x] + "' order by date::date");
                                    ...
                                    while (rset1.next()) {
                                        ...
                                        dayTotal = dayTotal + rset1.getDouble(7);
                                ...
                                phrase = new Phrase(new com.afrisoftech.sys.Format2Currency().Format2Currency(java.lang.String.valueOf(dayTotal)), pFontHeader11);
...
docPdf.close();  com.afrisoftech.lib.PDFRenderer.renderPDF(tempFile);
    ...
    public java.lang.Object[] getListofStaffNosdate() {

        java.lang.Object[] listofStaffNosdate = null;

        java.util.Vector listStaffNoVectordate = new java.util.Vector(1, 1);


        try {


            java.sql.PreparedStatement pSet1 = connectDB.prepareStatement("SELECT distinct date::date as date FROM hp_patient_card WHERE invoice_no = '" + MNo + "' order by date");
            ...
            while (rSet1.next()) {
                ...
                listStaffNoVectordate.addElement(rSet1.getObject(1).toString());
        ...
        listofStaffNosdate = listStaffNoVectordate.toArray();
        System.out.println("Done list of Staff Nos ...");
        return listofStaffNosdate;
    }

    public java.lang.Object[] getListofStaffNos1(java.lang.Object dates) {
        ...
        try {
            ...
            java.sql.PreparedStatement pSet1 = connectDB.prepareStatement("SELECT distinct upper(main_service) as main_service FROM hp_patient_card WHERE invoice_no = '" + MNo + "' AND date::date = '" + dates + "' order by main_service");
            //  pSet1.setString(1,beginDate.toString());
            //  pSet1.setString(2,endDate.toString());
            java.sql.ResultSet rSet1 = pSet1.executeQuery();
