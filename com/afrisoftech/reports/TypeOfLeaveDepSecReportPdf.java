...
public class TypeOfLeaveDepSecReportPdf implements java.lang.Runnable {
    ...
    java.util.Vector leave_days = null;  
    
    public java.lang.String dbUserName = null;  
    java.lang.String typ_leave = null;  
    java.lang.String depart = null;
    java.lang.String sect = null;    
    ...
    public void TypeOfLeaveDetailsPdf(java.sql.Connection connDb, java.util.Date begindate, java.util.Date endate, java.lang.String typeOfLeave,
            java.lang.String department, java.lang.String section) {
...
//                    com.lowagie.text.HeaderFooter footer = new com.lowagie.text.HeaderFooter(new Phrase("Nutrition Services Offered at "+ department +" - Page: ",pFontHeader), true);// FontFactory.getFont(com.lowagie.text.FontFactory.HELVETICA, 12, Font.BOLDITALIC,java.awt.Color.blue));
//                    
...
//                            table.getDefaultCell().setFixedHeight(16);
                        ...
                        table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_CENTER);
                        Phrase phrase = new Phrase(typ_leave.toUpperCase()+" Days Taken Departmental Report at "+depart.toUpperCase()+" \nSection "+sect.toUpperCase(), 
                                pFontHeader);
                        table.addCell(phrase); 
                        ...
                        for (int x = 0; x<no.size(); x++) {  
                            addTableItems(table, (String) no.elementAt(x), (String) name.elementAt(x), (String) jobgroup.elementAt(x)
                                    , (String) leave_date.elementAt(x), (String) leave_days.elementAt(x));
                        }
...
docPdf.close();  com.afrisoftech.lib.PDFRenderer.renderPDF(tempFile);
    ...
    public void getNoAndName() {
        ...
        leave_days = new java.util.Vector<String>();
        ...
        try {
                ...
                java.sql.ResultSet rse = stm.executeQuery("SELECT DISTINCT employee_no, first_name, middle_name, last_name, employee_group, "
                        + "leave_date, leave_days FROM master_file WHERE department = '"+depart+"' AND section = '"+sect+"' "
                        + "AND leave_date BETWEEN '"+beginDate+"' AND '"+endDate+"'"
                ...
                while (rse.next()) {
                    ...
                    leave_days.add(dbObject.getDBObject(rse.getObject(7), " -- "));
    ...
    public void addTableItems(com.lowagie.text.pdf.PdfPTable table, java.lang.String number, java.lang.String name, java.lang.String jobG
            , java.lang.String leaveDate, java.lang.String leaveDays) {
