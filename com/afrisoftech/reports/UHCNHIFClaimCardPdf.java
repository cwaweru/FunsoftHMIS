...
public class UHCNHIFClaimCardPdf implements java.lang.Runnable {
    ...
    String contibuterName = "";
    String hospitalCode = "";
    String contributorIDNumber = "";
    String claimNumber = "";
    String personalNumber = "";
    String opPatientNumber = "";
    String contibutorNHIFNumber = "";
    String employerName = "";
    String patientNames = "";
    String patientDOB = "";
    String patientContributorTelNo = "";
    String patientRelToContributor = "";
    String patientOccupation = "";
    String residenceTown = "";
    String icd10Codes = "";
    private String contributorNHIFNumber = "";
    ...
    public void UHCNHIFClaimCardPdf(java.sql.Connection connDb, java.lang.String inv1, java.lang.String inv2) {
                ...
                try {
                    ...
                    try {
                        ...
                        for (int j = 0; j < listofStaffNos.length; j++) {
                            ...
                            int headerwidths[] = {5, 15, 15, 15, 15, 15};
                            ...
                            Phrase phrase = new Phrase("NHIF NATIONAL COVER FORM\n\n" + compName.toUpperCase() + "\n P. O. Box "
                                    + Address + " " + Tel + " " + Fax + " " + Email, pFontHeader1);
                            ...
                            try {
                                ...
                                java.sql.ResultSet rset311 = st311.executeQuery("select ap.payer_id from ac_debtors ac,ac_scheme_providers ap where ac.account_no = ap.account_no AND ac.invoice_no = '" + listofStaffNos[j] + "'");
                                ...
                                java.sql.ResultSet rset5 = st5.executeQuery("select pr.account_no,pr.member_name, pr.employer_name, pr.nhif_number, pr.occupation, pr.nok_telno, pr.id_no, pr.tel_no, pr.nok_relationship, pr.year_of_birth::date, pr.residence from hp_patient_register pr,ac_debtors db where db.invoice_no = '" + listofStaffNos[j] + "' and db.admission_no = pr.patient_no");
                                ...
                                java.sql.ResultSet rset11 = st11.executeQuery("select invoice_no, claim_no from ac_debtors where invoice_no = '" + listofStaffNos[j] + "' and invoice_no IS NOT NULL");
                                    ...
                                    while (rset31.next()) {
                                        ...
                                        while (rset12.next()) {
                                            ...
                                            while (rset11.next()) {
                                                ...
                                                table.getDefaultCell().setColspan(3);
                                                claimNumber = dbObject.getDBObject(rset11.getObject(2), "-");
                                                table.getDefaultCell().setBorderColor(java.awt.Color.BLACK);
                                                ...
                                                table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                                                phrase = new Phrase("Claim No.: " + dbObject.getDBObject(rset11.getObject(2), ""), pFontHeader);
                                                ...
                                                while (rset5.next()) {
                                                    ...
                                                    phrase = new Phrase("Member No.: " + dbObject.getDBObject(rset5.getObject(4), "-"), pFontHeader);

                                                    //table.addCell(phrase);
                                                    contributorNHIFNumber = dbObject.getDBObject(rset5.getObject(4), "-");
                                                    ...
                                                    while (rset.next()) {
                                                        ...
                                                        //table.addCell(phrase);
                                                        patientNames = dbObject.getDBObject(rset.getObject(2), "-");
                                                        //       while (rset5.next()){

                                                        table.getDefaultCell().setColspan(3);
                                                        table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                                                        phrase = new Phrase("Member Name.: " + dbObject.getDBObject(rset5.getObject(2), "-").toUpperCase(), pFontHeader);
                                                        //table.addCell(phrase);
                                                        contibuterName = dbObject.getDBObject(rset5.getObject(2), "-");
                                                        ...
                                                        opPatientNumber = dbObject.getDBObject(rset.getObject(1), "");
                                                        //table.addCell(phrase);
                                                        patientRelToContributor = dbObject.getDBObject(rset5.getObject(9), "").toUpperCase();
                                                        patientContributorTelNo = dbObject.getDBObject(rset5.getObject(8), "").toUpperCase() + "/" + dbObject.getDBObject(rset5.getObject(6), "").toUpperCase();
                                                        patientDOB = dbObject.getDBObject(rset5.getObject(10), "").toUpperCase();
                                                        contributorIDNumber = dbObject.getDBObject(rset5.getObject(7), "").toUpperCase();
                                                        patientOccupation = dbObject.getDBObject(rset5.getObject(5), "").toUpperCase();
                                                        employerName = dbObject.getDBObject(rset5.getObject(3), "").toUpperCase();
                                                        residence = dbObject.getDBObject(rset5.getObject(11), "").toUpperCase();
                                                        table.getDefaultCell().setColspan(6);
                                                        phrase = new Phrase("CONTRIBUTOR INFORMATION", pFontHeader1);
                                                        table.addCell(phrase);
                                                        table.getDefaultCell().setColspan(2);
                                                        phrase = new Phrase("Contributor's Name", pFontHeader);
                                                        table.addCell(phrase);
                                                        table.getDefaultCell().setColspan(1);
                                                        phrase = new Phrase(contibuterName.toUpperCase(), pFontHeader);
                                                        table.addCell(phrase);
                                                        table.getDefaultCell().setColspan(2);
                                                        rebateCode = "";
                                                        java.sql.PreparedStatement pstmtCode = connectDB.prepareStatement("SELECT DISTINCT rebate_code FROM pb_nssf_rebeats WHERE rebate_code IS NOT NULL");
                                                        java.sql.ResultSet rsetCode = pstmtCode.executeQuery();
                                                        while (rsetCode.next()) {
                                                            rebateCode = rsetCode.getString(1);
                                                        }
                                                        phrase = new Phrase("Hospital Code", pFontHeader);
                                                        table.addCell(phrase);
                                                        table.getDefaultCell().setColspan(1);
                                                        phrase = new Phrase(rebateCode.toUpperCase(), pFontHeader);
                                                        table.addCell(phrase);
                                                        table.getDefaultCell().setColspan(2);
                                                        phrase = new Phrase("Contributor's ID No.", pFontHeader);
                                                        table.addCell(phrase);
                                                        table.getDefaultCell().setColspan(1);
                                                        phrase = new Phrase(contributorIDNumber, pFontHeader);
                                                        table.addCell(phrase);
                                                        table.getDefaultCell().setColspan(2);
                                                        phrase = new Phrase("Claim No.", pFontHeader);
                                                        table.addCell(phrase);
                                                        table.getDefaultCell().setColspan(1);
                                                        phrase = new Phrase(claimNumber, pFontHeader);
                                                        table.addCell(phrase);
                                                        table.getDefaultCell().setColspan(2);
                                                        phrase = new Phrase("Contributor's P.No.", pFontHeader);
                                                        table.addCell(phrase);
                                                        table.getDefaultCell().setColspan(1);
                                                        phrase = new Phrase(contributorIDNumber, pFontHeader);
                                                        table.addCell(phrase);
                                                        table.getDefaultCell().setColspan(2);
                                                        phrase = new Phrase("O/P Registration No.", pFontHeader);
                                                        table.addCell(phrase);
                                                        table.getDefaultCell().setColspan(1);
                                                        phrase = new Phrase(opPatientNumber.toUpperCase(), pFontHeader);
                                                        table.addCell(phrase);
                                                        table.getDefaultCell().setColspan(2);
                                                        phrase = new Phrase("Contributor's NHIF No", pFontHeader);
                                                        table.addCell(phrase);
                                                        table.getDefaultCell().setColspan(1);
                                                        phrase = new Phrase(contributorNHIFNumber.toUpperCase(), pFontHeader);
                                                        table.addCell(phrase);
                                                        table.getDefaultCell().setColspan(2);
                                                        phrase = new Phrase("Employer", pFontHeader);
                                                        table.addCell(phrase);
                                                        table.getDefaultCell().setColspan(1);
                                                        phrase = new Phrase(employerName.toUpperCase(), pFontHeader);
                                                        table.addCell(phrase);
                                                    }
                                                }
                                            }
                                ...
                                table.getDefaultCell().setColspan(6);
                                phrase = new Phrase("PART I: PATIENT'S PARTICULARS", pFontHeader1);
                                table.addCell(phrase);

                                table.getDefaultCell().setColspan(3);
                                phrase = new Phrase("Full Names", pFontHeader);
                                table.addCell(phrase);
                                phrase = new Phrase(patientNames.toUpperCase(), pFontHeader);
                                table.addCell(phrase);

                                phrase = new Phrase("Date of Birth", pFontHeader);
                                table.addCell(phrase);
                                phrase = new Phrase(patientDOB, pFontHeader);
                                table.addCell(phrase);

                                phrase = new Phrase("Patient/Contributor's Tel No.", pFontHeader);
                                table.addCell(phrase);
                                phrase = new Phrase(patientContributorTelNo, pFontHeader);
                                table.addCell(phrase);

                                phrase = new Phrase("Patient's Relationship to contributor", pFontHeader);
                                table.addCell(phrase);
                                phrase = new Phrase(patientRelToContributor, pFontHeader);
                                table.addCell(phrase);

                                phrase = new Phrase("If Child/ dependant, school attended", pFontHeader);
                                table.addCell(phrase);
                                phrase = new Phrase(schoolAttended, pFontHeader);
                                table.addCell(phrase);

                                phrase = new Phrase("Town", pFontHeader);
                                table.addCell(phrase);
                                phrase = new Phrase(residence.toUpperCase(), pFontHeader);
                                table.addCell(phrase);

                                table.getDefaultCell().setColspan(6);
                                phrase = new Phrase("", pFontHeader1);
                                table.addCell(phrase);
                                phrase = new Phrase("PART II: SERVICES RENDERED AND CHARGES", pFontHeader1);
                                table.addCell(phrase);
                                ...
                                table.addCell(phrase);
                                table.getDefaultCell().setColspan(2);
                                phrase = new Phrase("Items/Services", pFontHeader1);
                                table.addCell(phrase);
                                table.getDefaultCell().setColspan(1);
                                table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_CENTER);
...
//                                //table.addCell(phrase);
                                ...
                                for (int k = 0; k < listofStaffNos1.length; k++) {
                                    ...
                                    java.sql.ResultSet rset1 = st1.executeQuery("select date::date,initcap(service) as service,sum(dosage)::int,sum(debit-credit) from hp_patient_card where invoice_no = '" + listofStaffNos[j] + "' AND paid = true and service not ilike 'Invoice' AND main_service ilike '" + listofStaffNos1[k] + "' AND reference NOT ILIKE 'C%' GROUP BY 1,2 ORDER BY 2");

                                    table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                                    table.getDefaultCell().setColspan(6);
                                    phrase = new Phrase(listofStaffNos1[k].toString().toUpperCase(), pFontHeader1);
                                    ...
                                    while (rset1.next()) {
                                        ...
                                        table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                                        phrase = new Phrase(String.valueOf(i), pFontHeader);
...
//                                        table.addCell(phrase);
                                    ...
                                    phrase = new Phrase("Sub Total : " + listofStaffNos1[k].toString().toUpperCase(), pFontHeader11);
                                ...
                                while (rsetTotals.next()) {
                                    ...
                                    table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                                    phrase = new Phrase("Net Claim Value", pFontHeader11);
                                ...
                                // table.getDefaultCell().setColspan(1);
                                table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_RIGHT);
                                phrase = new Phrase("Total Claim Amount", pFontHeader1);
