...
public class SchemesDebtCollectPdf implements java.lang.Runnable {
                        ...
                        try {
                            ...
                            for (int k = 0; k < listofAct1.length; k++) {
                                ...
                                for (int j = 0; j < listofStaffNos.length; j++) {
                                    ...
                                    java.sql.ResultSet rset = st.executeQuery("select db.account_no,upper(db.scheme_name) from ac_schemes db "
                                            + "WHERE db.account_no = '"+listofStaffNos[j]+"' ORDER BY 2 ASC");// and (transaction_type = 'Raise Invoice' OR transaction_type = 'Stock Delivery' OR transaction_type = 'Stock Returns') and (description = 'Creditors Payable' OR description = 'Other Payables') GROUP BY invoice_no,date,dealer,item ORDER BY date");
    ...
    public java.lang.Object[] getListofStaffNos1() {
        ...
        try {
            ...
            java.sql.ResultSet rSet1 = stmt1.executeQuery("SELECT DISTINCT payer_name FROM ac_schemes  WHERE  contact3  ILIKE '"+Debtor+"' ORDER BY 1 ASC");
    ...
    public java.lang.Object[] getListofStaffNos(java.lang.Object suppName) {
        ...
        try {
            ...
            java.sql.ResultSet rSet1 = stmt1.executeQuery("SELECT DISTINCT ac.account_no FROM ac_debtors db ,ac_schemes ac "
                    + "WHERE  ac.contact3  ILIKE '"+Debtor+"' and ac.account_no = db.account_no and ac.payer_name ilike '"+suppName+"' order by ac.account_no");
