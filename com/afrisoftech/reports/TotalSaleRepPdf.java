...
public class TotalSaleRepPdf implements java.lang.Runnable {
    ...
    public void TotalSaleRepPdf(java.sql.Connection connDb,java.util.Date begindate, java.util.Date endate, String department) {
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    com.lowagie.text.HeaderFooter footer = new com.lowagie.text.HeaderFooter(new Phrase("Total Sales Report - Page: ", pFontHeader), true);// FontFactory.getFont(com.lowagie.text.FontFactory.HELVETICA, 12, Font.BOLDITALIC,java.awt.Color.blue));
                    ...
                    try {
                        ...
                        int headerwidths[] = {25,50,25,25,25};
                        ...
                        try {
                            ...
                            phrase = new Phrase(title+" Sales Breakdown:  Period : "  +dateFormat.format(endDate11)+" ------ "+dateFormat.format(endDate1), pFontHeader);
                        ...
                        phrase = new Phrase("Cash Amount "+ks, pFontHeader);
                        
                        table.addCell(phrase);
                        
                        phrase = new Phrase("Credit Amount "+ks, pFontHeader);
...
//                                table.getDefaultCell().setColspan(2);
//                                table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
//                                phrase = new Phrase(rsetTotals1.getObject(1).toString().toUpperCase(),pFontNum);
//                                
//                                table.addCell(phrase);
//                                table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_RIGHT);
//                                phrase = new Phrase(new com.afrisoftech.sys.Format2Currency().Format2Currency(rsetTotals1.getString(2)),pFontNum);
//                                table.addCell(phrase);
//                                amtT = amtT + rsetTotals1.getDouble(2);
//                                //  table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_RIGHT);
...
//                            table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_RIGHT);
//                            
//                            phrase = new Phrase(new com.afrisoftech.sys.Format2Currency().Format2Currency(java.lang.String.valueOf(amtT)), pFontHeader);
//                            
//                            table.addCell(phrase);
...
//                            table.getDefaultCell().setBorder(Rectangle.BOTTOM | Rectangle.TOP);
                            ...
                            while (rset.next()) {
                                table.getDefaultCell().setColspan(1);
                                table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                                phrase = new Phrase(rset.getObject(3).toString().toUpperCase(),pFontNum);

                                table.addCell(phrase);
                                table.getDefaultCell().setColspan(1);
                                table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                                phrase = new Phrase(rset.getObject(1).toString().toUpperCase(),pFontNum);
                                ...
                                table.addCell(phrase);
                                amt = amt + rset.getDouble(2);
                                
                                java.sql.ResultSet rsetx = stx.executeQuery("select  sum(debit-credit) from hp_patient_card WHERE   hp_patient_card.main_service  ilike  '"+rset.getString(1)+"' AND  service not ilike 'invoice' and date::date between '"+beginDate+"' AND '"+endDate+"' and service not ilike 'invoice'   ");
                                double credit_amt =0.00;
                            
                                while (rsetx.next()) {
                                    credit_amt = rsetx.getDouble(1);
                                ...
                                credit_Total += credit_amt;
                                  ...
                                  table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_RIGHT);
                                  phrase = new Phrase(new com.afrisoftech.sys.Format2Currency().Format2Currency(String.valueOf(credit_amt)),pFontNum);
                                  table.addCell(phrase);
                            }
                            ...
                            phrase = new Phrase(new com.afrisoftech.sys.Format2Currency().Format2Currency(java.lang.String.valueOf(credit_Total)), pFontHeader);
