...
public class InPatientIntmDatelnvPdf implements java.lang.Runnable {
    ...
    public void InPatientIntmDatelnvPdf(java.sql.Connection connDb, java.lang.String combox, java.lang.String pNo) {
        MNo = combox;
                ...
                try {
                    ...
                    try {
                        ...
                        try {
                            ...
                            java.sql.ResultSet rseta = sta.executeQuery("select distinct ad.ward,ad.bed_no,ad.doctor from hp_admission ad where ad.visit_id = '"+memNo+"'  AND ad.patient_no = '"+patNo+"'");
                    ...
                    try {
                        ...
                        try {
                            ...
                            java.sql.ResultSet rset11 = st11.executeQuery(" select date::date,initcap(service) as service,'No.'||doctor,CASE WHEN (service = 'Receipt') THEN requisition_no ELSE reference END AS reference,credit-debit from hp_patient_card where visit_id = '"+memNo+"' AND (service = 'N.H.I.F' or service ilike 'Receipt' or service ilike 'Receipt Adj'  OR service ilike 'Discou%') AND patient_no = '"+patNo+"' order by date::date");
                             java.sql.ResultSet rsetdb = stdb.executeQuery(" select date::date,initcap(service) as service,'No.'||doctor,reference,credit-debit from hp_patient_card where visit_id = '"+memNo+"' AND (service = 'N.H.I.F' or service ilike 'Receipt' or service ilike 'Receipt Adj'  OR service ilike 'Discou%') AND patient_no = '"+patNo+"' order by date::date");
                            ...
                            for (int k = 0; k < listofStaffNos1.length; k++) {
                                double osBalance1 = 0.00;
                                java.sql.ResultSet rset1 = st1.executeQuery(" select date::date,initcap(service) as service,dosage::int,reference,debit-credit from hp_patient_card where visit_id = '"+memNo+"' and service != 'N.H.I.F' AND service not ilike 'Receipt' AND service not ilike 'Receipt Adj' AND service not ilike 'Discou%' AND service != 'Invoice'  AND date::date = '"+listofStaffNos1[k]+"' AND patient_no = '"+patNo+"' order by date::date");
...
docPdf.close();  com.afrisoftech.lib.PDFRenderer.renderPDF(tempFile);
    ...
    public java.lang.Object[] getListofStaffNos1() {
        ...
        try {
            ...
            java.sql.PreparedStatement pSet1 = connectDB.prepareStatement("SELECT distinct date::date as date FROM hp_patient_card WHERE visit_id = '"+MNo+"' AND patient_no = '"+patNo+"' order by date");
