...
public class ShiftsTotalPerCashierPdf implements java.lang.Runnable {
    ...
    public void ShiftsTotalPerCashierPdf(java.sql.Connection connDb, java.util.Date begindate, java.util.Date endate, java.lang.String cashier) {
            ...
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        com.lowagie.text.pdf.PdfPTable table = new com.lowagie.text.pdf.PdfPTable(16);

                        int headerwidths[] = {5, 8, 10, 8, 5, 12, 12, 12, 12, 12, 12, 9, 13, 12, 12, 10};
                        ...
                        try {
                            ...
                            for (int i = 0; i < listofAct.length; i++) {
                                ...
                                while (rset1.next()) {
                                    ...
                                    phrase = new Phrase(new com.afrisoftech.sys.Format2Currency().Format2Currency(java.lang.String.valueOf(RctCash + RctCancelled)), pFontHeader);
                                ...
                                while (rset1dba.next()) {
                                    //table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                                    phrase = new Phrase(dbObject.getDBObject(rset1dba.getObject(1), "0.00"), pFontNum);
                                    dba = dba + rset1dba.getDouble(1);
                                    table.addCell(phrase);
                                }
                                ...
                                phrase = new Phrase(new com.afrisoftech.sys.Format2Currency().Format2Currency(java.lang.String.valueOf(RctCancelled)), pFontHeader);
                                table.addCell(phrase);
                            ...
                            phrase = new Phrase(new com.afrisoftech.sys.Format2Currency().Format2Currency(java.lang.String.valueOf(dba)), pFontHeader);
                            table.addCell(phrase);
...
docPdf.close();  com.afrisoftech.lib.PDFRenderer.renderPDF(tempFile);
    ...
    public java.lang.Object[] getListofStaffNos() {
        ...
        try {
            ...
            java.sql.ResultSet rSet1 = stmt1.executeQuery("SELECT DISTINCT shift_no FROM ac_shifts WHERE start_date::date BETWEEN '" + beginDate + "'::date AND '" + endDate + "'::date AND user_name = '" + Cashier + "' ORDER BY 1 ASC");
