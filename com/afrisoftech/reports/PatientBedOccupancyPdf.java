            ...
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        int headerwidths[] = {8,15,15,12,30,10,10,30,10,30};
                        ...
                        try {
                            ...
                            for (int i = 0; i < listofAct.length; i++) {
                                ...
                                java.sql.ResultSet rset3 = st3.executeQuery("select DISTINCT ad.date_admitted,ad.admission_no,initcap(ad.patient_name),(current_date-pr.year_of_birth::date)/365,bed_no,initcap(ad.doctor),pr.pay_mode,pr.description,ad.sub_chief from hp_admission ad,hp_inpatient_register pr where ad.ward ilike'"+listofAct[i]+"' and ad.discharge = false and pr.patient_no = ad.patient_no");
