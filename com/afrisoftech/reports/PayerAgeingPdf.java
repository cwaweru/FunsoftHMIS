                ...
                try {
                    ...
                    try {
                        ...
                        try {
                            ...
                            phrase = new Phrase(Debtor + ": Payer  Ageing as at " +dateFormat.format(endDate2), pFontHeader2);
                        ...
                        table.addCell(phrase);
                        phrase = new Phrase("Name",pFontHeader2);
                        table.addCell(phrase);
                        // table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_RIGHT);
                        ...
                        try {
                            ...
                            for (int i = 0; i < listofAct.length; i++) {
                                ...
                                java.sql.PreparedStatement pset11 = connectDB.prepareStatement("select sum(balance-credit_bal) from ac_debtors WHERE account_no = ? and dealer = '"+Debtor+"'  AND date <= '"+endDate+"'::date");//< '"+endDate+"'::date and date > '"+endDate+"'::date - 30 group by dealer");
                                ...
                                java.sql.ResultSet rset1k = pset11.executeQuery();
                                while (rset1k.next()){
                                    
                                    realBal = rset1k.getDouble(1);
                                ...
                                if(realBal > 0){
                                    ...
                                    table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                                    java.sql.PreparedStatement pset10 = connectDB.prepareStatement("select account_no||' '||scheme_name from ac_schemes"
                                            + " WHERE account_no = ? order by 1");//< '"+endDate+"'::date and date > '"+endDate+"'::date - 30 group by dealer");
                                    
                                    table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_RIGHT);
                                    phrase = new Phrase(""+lNo,pFontHeader1);
                                    table.addCell(phrase);
...
docPdf.close();  com.afrisoftech.lib.PDFRenderer.renderPDF(tempFile);
    ...
    public java.lang.Object[] getListofActivities() {
        ...
        try {
            ...
            java.sql.PreparedStatement pSet1 = connectDB.prepareStatement("SELECT DISTINCT account_no,sum(balance-credit_bal) FROM ac_debtors "
                    + "where dealer = '"+Debtor+"' and account_no IS NOT NULL and account_no != '' and date::date <= '"+endDate+"'"
                    + " group by account_no order by 1 ASC");
