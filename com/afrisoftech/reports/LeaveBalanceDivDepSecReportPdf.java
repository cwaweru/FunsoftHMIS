...
public class LeaveBalanceDivDepSecReportPdf implements java.lang.Runnable {
    ...
    public void getNoAndName() {
        ...
        try {
                ...
                java.sql.ResultSet rse = stm.executeQuery("SELECT DISTINCT employee_no, first_name, middle_name, last_name, employee_grade, "
                        + "leave_date FROM master_file WHERE division = '"+div+"' AND department = '"+depart+"' AND section = '"+sect+"' "
