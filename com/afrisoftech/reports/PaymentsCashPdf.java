...
public class PaymentsCashPdf implements java.lang.Runnable {
    ...
    public void PaymentsCashPdf(java.sql.Connection connDb,java.util.Date begindate,java.util.Date endate) {
            ...
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        int headerwidths[] = {10,10,25,10,30,15};
                        ...
                        try {
                            ...
                            java.sql.ResultSet rset = st.executeQuery("SELECT date,voucher_no,initcap(dealer),initcap(reason),sum(debit-credit) from ac_payroll_ledger WHERE date BETWEEN '"+beginDate+"' AND '"+endDate+"' AND transaction_type = 'Payment' AND item ilike '%cash%'  GROUP BY date,voucher_no,dealer,reason ORDER BY dealer");
                            
                            java.sql.ResultSet rsetTotals = st2.executeQuery("SELECT SUM(debit-credit) from ac_payroll_ledger WHERE date BETWEEN '"+beginDate+"' AND '"+endDate+"'  AND transaction_type = 'Payment' AND item ilike '%cash%'");
