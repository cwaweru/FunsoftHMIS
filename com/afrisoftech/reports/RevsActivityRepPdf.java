...
public class RevsActivityRepPdf implements java.lang.Runnable {
    ...
    public void RevsActivityRepPdf(java.sql.Connection connDb,java.util.Date begindate, java.util.Date endate) {
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    com.lowagie.text.HeaderFooter footer = new com.lowagie.text.HeaderFooter(new Phrase("Revenue/Activity - Page: ", pFontHeader), true);// FontFactory.getFont(com.lowagie.text.FontFactory.HELVETICA, 12, Font.BOLDITALIC,java.awt.Color.blue));
                    ...
                    try {
                        ...
                        int headerwidths[] = {5,30,10,10,15,15,15,10,15};
                        ...
                        try {
                            ...
                            phrase = new Phrase("Revenue/Activity :  Period : "  +dateFormat.format(endDate11)+" - "+dateFormat.format(endDate1), pFontHeader);
                        ...
                        phrase = new Phrase("Average per day Actual",pFontHeader);
                        table.addCell(phrase);
                        ...
                        try {
                            ...
                            for (int i = 0; i < listofAct.length; i++) {
                                ...
                                while (rset.next()) {
                                    while (rsetday.next()) {
                                        ...
                                        phrase = new Phrase(new com.afrisoftech.sys.Format2Currency().Format2Currency(java.lang.String.valueOf(revnu/dys)),pFontNum);
                            ...
                            phrase = new Phrase(new com.afrisoftech.sys.Format2Currency().Format2Currency(java.lang.String.valueOf((osBalance1/dys))),pFontHeader);
