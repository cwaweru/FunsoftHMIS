...
public class FpNumberByTypePdf implements java.lang.Runnable {
    ...
    public void FpNumberByTypePdf(java.sql.Connection connDb, java.util.Date begindate, java.util.Date endate) {
            ...
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        int headerwidths[] = {10,45,15,15,15};
                        ...
                        try{
                            ...
                            phrase = new Phrase("NUMBER OF FP CASES RECORDED PERIOD : "  +dateFormat.format(endDate11)+" - "+dateFormat.format(endDate1), pFontHeader);
                        ...
                        try {
                            ...
                            for (int i = 0; i < listofAct.length; i++) {
                                ...
                                java.sql.ResultSet rset3 = st3.executeQuery("SELECT COUNT(patient_type) FROM fprecord  WHERE patient_type ilike '"+listofAct[i]+"' AND date_seen::date BETWEEN '"+beginDate+"' AND '"+endDate+"'GROUP BY patient_type");
                                
                                java.sql.Statement st31 = connectDB.createStatement();
                                
                                java.sql.ResultSet rset31 = st31.executeQuery("SELECT fp_clients FROM fp_clients  WHERE code ilike '"+listofAct[i]+"'");
                                ...
                                while (rset3.next()){
                                    ...
                                    while (rset31.next()){
                                        table.getDefaultCell().setColspan(2);
                                        //  phrase = new Phrase(rset31.getString(1).toUpperCase(), pFontHeader1);
                                        phrase = new Phrase(dbObject.getDBObject(rset31.getObject(1).toString().toUpperCase(), "-"), pFontHeader1);
                                        
                                        table.addCell(phrase);
                                        table.getDefaultCell().setColspan(1);
                                        table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_RIGHT);
                                        //  phrase = new Phrase(rset3.getString(1).toUpperCase(), pFontHeader1);
                                        phrase = new Phrase(dbObject.getDBObject(rset3.getObject(1).toString().toUpperCase(), "-"), pFontHeader1);
                                        
                                        table.addCell(phrase);
                                        na = na + rset3.getInt(1);
                            ...
                            phrase = new Phrase(java.lang.String.valueOf(na), pFontHeader);
                    ...
                    try {
                        ...
                        try{
                            ...
                            phrase = new Phrase("ANALYSIS PER SEX" , pFontHeader);
                        ...
                        phrase = new Phrase("CUMMULATIVE",pFontHeader);
                        tablex.addCell(phrase);
                        ...
                        try {
                            ...
                            for (int x = 0; x < listofAct1.length; x++) {
                                ...
                                java.sql.ResultSet rset3d = st3d.executeQuery("SELECT CASE WHEN (patient_type IS NOT NULL) THEN COUNT(patient_type) ELSE '0' END AS patient_patient FROM fprecord  WHERE patient_type ilike '"+listofAct1[x]+"' AND date_seen::date BETWEEN '"+beginDate+"' AND '"+endDate+"' AND sex ilike 'M%' GROUP BY patient_type");
                                
                                java.sql.Statement st3xd = connectDB.createStatement();
                                
                                java.sql.ResultSet rset3xd = st3xd.executeQuery("SELECT CASE WHEN (patient_type IS NOT NULL) THEN COUNT(patient_type) ELSE '0' END AS patient_patient FROM fprecord  WHERE patient_type ilike '"+listofAct1[x]+"' AND date_seen::date BETWEEN '"+beginDate+"' AND '"+endDate+"' AND sex ilike 'F%' GROUP BY patient_type");
