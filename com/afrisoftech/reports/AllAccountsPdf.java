                       ...
                       // table.getDefaultCell().setBackgroundColor(java.awt.Color.LIGHT_GRAY);
                        ...
                        try {
                            ...
                            for (int i = 0; i < listofAct.length; i++) {
                               ...
                               java.sql.ResultSet rset = st.executeQuery("select distinct ma.main_code,upper(ma.description) from pb_accounts_setup ma, pb_sub_activities sa where ma.main_code = '"+listofAct[i].toString()+"'");
                                //
                                    ...
                                    for (int k = 0; k < listofAct1.length; k++) {
                                      ...
                                      //  java.sql.Statement st1 = connectDB.createStatement();
                                       ...
                                       // java.sql.Statement st2 = connectDB.createStatement();
                                        ...
                                        // java.sql.ResultSet rset = st.executeQuery("select sub_code,code,activity,payment_modes from pb_activity GROUP BY sub_code,code,activity,payment_modes order by code");
                                        java.sql.ResultSet rset1 = st1.executeQuery("select distinct sa.sub_code,initcap(sa.description) from pb_sub_activities sa, pb_accounts_setup ac where sa.sub_code = '"+listofAct1[k].toString()+"'  group by sa.sub_code,sa.description");// and pb_sub_activities.main_code = '"+listofAct[i].toString()+"'");
                                         while (rset1.next()){
                                        table.getDefaultCell().setColspan(1);
                                        ...
                                        java.sql.ResultSet rset2 = st2.executeQuery("select ac.code,initcap(ac.activity),ac.payment_modes from pb_activity ac where ac.sub_code = '"+listofAct1[k].toString()+"' GROUP BY ac.code,ac.activity,ac.payment_modes order by ac.code");
...
docPdf.close();  com.afrisoftech.lib.PDFRenderer.renderPDF(tempFile);
    ...
    public java.lang.Object[] getListofActivities1(java.lang.Object mCode) {
        ...
        try {
            ...
            java.sql.ResultSet rSet1 = stmt1.executeQuery("SELECT DISTINCT sub_code FROM pb_sub_activities WHERE main_code = '"+mCode+"' order by sub_code");
