...
public class InPatientIntmExDatelnvPdf implements java.lang.Runnable {
    ...
    public void InPatientIntmExDatelnvPdf(java.sql.Connection connDb, java.lang.String combox, java.lang.String pNo) {
        MNo = combox;
                ...
                try {
                    ...
                    try {
                        ...
                        try {
                            ...
                            java.sql.ResultSet rsetc = stc.executeQuery("select distinct date_admitted,discharge_date::date,(discharge_date::date-date_admitted) from hp_admission where visit_id = '"+memNo+"' AND patient_no = '"+patNo+"'");
                            
                            java.sql.ResultSet rsetb = stb.executeQuery("select distinct (hr.discharge_date - hr.adm_date),hr.account_no, hr.discharge_date from hp_inpatient_register hr,hp_patient_card pc where pc.patient_no = hr.patient_no and pc.visit_id = '"+memNo+"' AND patient_no = '"+patNo+"'");
                    ...
                    try {
                        ...
                        try {
                            ...
                            java.sql.ResultSet rsetTotals1 = st21.executeQuery("select sum(credit) from hp_patient_card where visit_id = '"+memNo+"' and (service = 'N.H.I.F' or service ilike 'Receipt' or service ilike 'Receipt Adj'  OR service ilike 'Discou%') AND main_service not ilike 'Consultants Control Account' AND main_service not ilike 'Doctors Control Account' AND patient_no = '"+patNo+"'");
                            java.sql.ResultSet rsetTotals = st2.executeQuery("select sum(debit - credit) from hp_patient_card where visit_id = '"+memNo+"' AND service != 'N.H.I.F' AND service not ilike 'Receipt' AND service not ilike 'Receipt Adj'  AND service not ilike 'Discou%' AND service != 'Invoice' and paid = 'true' AND main_service not ilike 'Consultants Control Account' AND main_service not ilike 'Doctors Control Account' AND patient_no = '"+patNo+"'");
                            java.sql.ResultSet rset11 = st11.executeQuery(" select date::date,initcap(service) as service,dosage::int,reference,credit from hp_patient_card where visit_id = '"+memNo+"' AND (service = 'N.H.I.F' or service ilike 'Receipt' or service ilike 'Receipt Adj'  OR service ilike 'Discou%') AND main_service not ilike 'Consultants Control Account' AND main_service not ilike 'Doctors Control Account' AND patient_no = '"+patNo+"' order by date::date");// union select date::date,initcap(service) as service,dosage,reference,credit from hp_patient_card where patient_no = '"+memNo+"' and credit > 0 order by date");
                            java.lang.Object listofStaffNos1[] = this.getListofStaffNos1();
                            
                            for (int k = 0; k < listofStaffNos1.length; k++) {
                                double osBalance1 = 0.00;
                                java.sql.ResultSet rset1 = st1.executeQuery(" select date::date,initcap(service) as service,dosage::int,CASE WHEN (service = 'Receipt') THEN requisition_no ELSE reference END AS reference,debit-credit from hp_patient_card where visit_id = '"+memNo+"' and service != 'N.H.I.F' AND service not ilike 'Receipt' AND service not ilike 'Receipt Adj' AND service not ilike 'Discou%' AND service != 'Invoice'  AND date::date = '"+listofStaffNos1[k]+"' AND main_service not ilike 'Consultants Control Account' AND main_service not ilike 'Doctors Control Account' AND patient_no = '"+patNo+"' order by date::date");// union select date::date,initcap(service) as service,dosage,reference,credit from hp_patient_card where patient_no = '"+memNo+"' and credit > 0 order by date");
...
docPdf.close();  com.afrisoftech.lib.PDFRenderer.renderPDF(tempFile);
    ...
    public java.lang.Object[] getListofStaffNos1() {
        ...
        try {
            ...
            java.sql.PreparedStatement pSet1 = connectDB.prepareStatement("SELECT distinct date::date as date FROM hp_patient_card WHERE visit_id = '"+MNo+"' and debit > 0 AND main_service not ilike 'Consultants Control Account' AND main_service not ilike 'Doctors Control Account' AND patient_no = '"+patNo+"' order by date");
