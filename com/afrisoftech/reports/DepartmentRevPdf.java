            ...
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        int headerwidths[] = {10, 50, 10, 20, 20};
                        ...
                        try {
                            ...
                            java.sql.ResultSet rset = st.executeQuery("select upper(service_type),COUNT(service_type),sum(credit-debit) from ac_ledger WHERE date BETWEEN '" + beginDate + "' AND '" + endDate + "' AND activity_code ilike '" + Code + "'  group by 1 order by 1");// tn,debit_note db WHERE tn.policy_no != '' and tn.policy_no = db.policy_no GROUP BY tn.policy_no,db.policy_class");
