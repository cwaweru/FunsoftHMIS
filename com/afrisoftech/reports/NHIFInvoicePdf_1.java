...
public class NHIFInvoicePdf_1 implements java.lang.Runnable {
  ...
  //  org.netbeans.lib.sql.pool.PooledConnectionSource pConnDB = null;
    ...
    public void NHIFInvoicePdf_1(java.sql.Connection connDb, java.lang.String name, java.util.Date begindate, java.util.Date endate) {
                    ...
                    for (int k = 0; k < listofStaffNos1.length; k++) {
                        ...
                        try {
                            ...
                            try {
                                ...
                                java.sql.ResultSet rset = st.executeQuery("select DISTINCT patient_no,initcap(first_name||' '||second_name||' '||last_name),address,adm_date,discharge_date from hp_inpatient_register where patient_no = '"+MNo+"'");
                                java.sql.ResultSet rset111 = st111.executeQuery("select DISTINCT disease from hp_patient_discharge where patient_no = '"+MNo+"' ORDER BY discharge_date DESC LIMIT 1");
                                java.sql.ResultSet rset1111 = st1111.executeQuery("select DISTINCT discharge_date-adm_date from hp_inpatient_register where patient_no = '"+MNo+"'");
