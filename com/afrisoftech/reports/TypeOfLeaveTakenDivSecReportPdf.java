...
public class TypeOfLeaveTakenDivSecReportPdf implements java.lang.Runnable {
    ...
    public void LeaveTakenDetailsPdf(java.sql.Connection connDb, java.util.Date begindate, java.util.Date endate, 
            java.lang.String division, java.lang.String section, java.lang.String typeOfLeave) {
                ...
                try {
                    ...
                    try {
                        ...
                        try {
                            ...
                            java.sql.ResultSet rsetOne = stOne.executeQuery("SELECT employee_no, department FROM master_file "
                                    + "WHERE division = '"+div+"' AND section = '"+sect+"' ");
