                    ...
                    try {
                        ...
                        try {
                            ...
                            for (int i = 0; i < listofAct.length; i++) {
                                ...
                                java.sql.ResultSet rsetMpay = stMpay.executeQuery("select sum(debit-credit) from ac_cash_collection where shift_no ='" + listofAct[i] + "' AND (payment_mode ILIKE 'MPAY' OR payment_mode ILIKE '%Mobile Pay%' OR payment_mode ILIKE '%pesa%')  AND transaction_type NOT ILIKE '%Bank%'");
