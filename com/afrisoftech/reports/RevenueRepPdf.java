            ...
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        int headerwidths[] = {8,50,20,20,20,20,20,20,20,20,20,10};
                        ...
                        phrase = new Phrase("Self "+ks, pFontHeader);
                        ...
                        try {
                            ...
                            for (int i = 0; i < listofAct.length; i++) {
                                ...
                                if (appearances > 0){
                                    ...
                                    java.sql.ResultSet rsetz = st31z.executeQuery("select ('"+endDate+"'::date)-('"+beginDate+"'::DATE)");
