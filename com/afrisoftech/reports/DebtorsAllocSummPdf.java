                ...
                try {
                    ...
                    try {
                        ...
                        try {
                            ...
                            phrase = new Phrase("Allocated "+ks,pFontHeader1);
                            table.addCell(phrase);
...
docPdf.close();  com.afrisoftech.lib.PDFRenderer.renderPDF(tempFile);
    ...
    public java.lang.Object[] getListofActivities() {
        ...
        try {
            ...
            java.sql.PreparedStatement pSet1 = connectDB.prepareStatement("SELECT DISTINCT CASE WHEN (dealer IS NULL) THEN '-' ELSE dealer END AS FROM ac_debtors where date BETWEEN '"+beginDate+"' AND '"+endDate+"' and dealer !='' and credit >0 and receipt_no is not null and receipt_no !='' order by dealer");
