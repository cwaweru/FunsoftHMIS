                    ...
                    try {
                        ...
                        try {
                            ...
                            for (int i = 0; i < listofAct.length; i++) {
                                ...
                                java.sql.ResultSet rset3 = st3.executeQuery("select distinct ward from hp_bed_setup where ward ilike '"+listofAct[i]+"'");
                                ...
                                java.sql.ResultSet rset1 = st1.executeQuery("select count(bed_no) from hp_bed_setup where occupied = false and ward = '"+listofAct[i]+"' and available ='Available'");
