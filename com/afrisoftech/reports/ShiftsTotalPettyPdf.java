...
public class ShiftsTotalPettyPdf implements java.lang.Runnable {
            ...
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        int headerwidths[] = {5, 8, 19, 8, 8, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 13, 12, 12,12, 10};
                        ...
                        try {
                            ...
                            for (int i = 0; i < listofAct.length; i++) {
                                ...
                                java.sql.ResultSet rsetGross = stGross.executeQuery("select sum(debit) from ac_cash_collection where shift_no ='" + listofAct[i] + "' AND "+ com.afrisoftech.lib.DBObject.addColumnCondition("receipt_no", "Numeric") +"  AND transaction_type NOT ILIKE '%Bank%'");// and date between '"+beginDate+"'::date and  '"+endDate+"'");// tn,debit_note db WHERE tn.policy_no != '' and tn.policy_no = db.policy_no GROUP BY tn.policy_no,db.policy_class");
                                java.sql.ResultSet rset1 = st1.executeQuery("select sum(debit-credit) from ac_cash_collection where shift_no ='" + listofAct[i] + "' AND "+ com.afrisoftech.lib.DBObject.addColumnCondition("receipt_no", "Numeric") +"  and payment_mode ILIKE 'Cash%' AND transaction_type NOT ILIKE '%Bank%'");// and date between '"+beginDate+"'::date and  '"+endDate+"'");// tn,debit_note db WHERE tn.policy_no != '' and tn.policy_no = db.policy_no GROUP BY tn.policy_no,db.policy_class");
                                java.sql.ResultSet rset1C = st2.executeQuery("select sum(debit-credit) from ac_cash_collection where shift_no ='" + listofAct[i] + "' AND "+ com.afrisoftech.lib.DBObject.addColumnCondition("receipt_no", "Numeric") +"  and payment_mode ILIKE 'Cheque%'  AND transaction_type NOT ILIKE '%Bank%'");// and date between '"+beginDate+"'::date and  '"+endDate+"'");// tn,debit_note db WHERE tn.policy_no != '' and tn.policy_no = db.policy_no GROUP BY tn.policy_no,db.policy_class");
                                java.sql.ResultSet rset1E = st1e.executeQuery("select sum(debit-credit) from ac_cash_collection where shift_no ='" + listofAct[i] + "' AND "+ com.afrisoftech.lib.DBObject.addColumnCondition("receipt_no", "Numeric") +"  AND (payment_mode ILIKE 'EFT' OR payment_mode ILIKE 'E.F.T%')  AND transaction_type NOT ILIKE '%Bank%'");// and date between '"+beginDate+"'::date and  '"+endDate+"'");// tn,debit_note db WHERE tn.policy_no != '' and tn.policy_no = db.policy_no GROUP BY tn.policy_no,db.policy_class");
                                java.sql.ResultSet rset1DB = stDB.executeQuery("select sum(debit-credit) from ac_cash_collection where shift_no ='" + listofAct[i] + "' AND "+ com.afrisoftech.lib.DBObject.addColumnCondition("receipt_no", "Numeric") +"  AND (payment_mode ILIKE 'DBA' OR payment_mode ILIKE '%DIRECT BANKING%')  AND transaction_type NOT ILIKE '%Bank%'");// and date between '"+beginDate+"'::date and  '"+endDate+"'");// tn,debit_note db WHERE tn.policy_no != '' and tn.policy_no = db.policy_no GROUP BY tn.policy_no,db.policy_class");
                                java.sql.ResultSet rset1CC = stCC.executeQuery("select sum(debit-credit) from ac_cash_collection where shift_no ='" + listofAct[i] + "' AND "+ com.afrisoftech.lib.DBObject.addColumnCondition("receipt_no", "Numeric") +"  AND (payment_mode ILIKE 'CCARD' OR payment_mode ILIKE '%Credit Card%'  OR payment_mode ILIKE '%pdq%')  AND transaction_type NOT ILIKE '%Bank%'");
                                java.sql.ResultSet rsetMpay = stMpay.executeQuery("select sum(debit-credit) from ac_cash_collection where shift_no ='" + listofAct[i] + "' AND "+ com.afrisoftech.lib.DBObject.addColumnCondition("receipt_no", "Numeric") +"  AND (payment_mode ILIKE 'MPAY' OR payment_mode ILIKE '%Mobile%' OR payment_mode ILIKE '%pesa%')  AND transaction_type NOT ILIKE '%Bank%'");
                                ...
                                java.sql.ResultSet rset21 = st21.executeQuery("select COUNT(DISTINCT receipt_no) from ac_cash_collection  where shift_no ='" + listofAct[i] + "' AND "+ com.afrisoftech.lib.DBObject.addColumnCondition("receipt_no", "Numeric") +"   AND transaction_type NOT ILIKE '%Bank%'");//and date between '"+beginDate+"'::date and  '"+endDate+"'");// tn,debit_note db WHERE tn.policy_no != '' and tn.policy_no = db.policy_no GROUP BY tn.policy_no,db.policy_class");
                                java.sql.ResultSet rset12 = st12.executeQuery("select sum(credit-debit) from ac_cash_collection,pb_activity where shift_no ='" + listofAct[i] + "' AND "+ com.afrisoftech.lib.DBObject.addColumnCondition("receipt_no", "Numeric") +"  AND transaction_type ILIKE 'Exemptions%' AND activity_code = code and activity_category = 'IEXE'  AND transaction_type NOT ILIKE '%Bank%'");//and date between '"+beginDate+"'::date and  '"+endDate+"'");// tn,debit_note db WHERE tn.policy_no != '' and tn.policy_no = db.policy_no GROUP BY tn.policy_no,db.policy_class");
                                java.sql.ResultSet rset13 = st13.executeQuery("select sum(credit-debit) from ac_cash_collection, pb_activity where shift_no ='" + listofAct[i] + "' AND "+ com.afrisoftech.lib.DBObject.addColumnCondition("receipt_no", "Numeric") +"  AND transaction_type ILIKE 'Waiver%' AND activity_code = code and activity_category = 'IEDS'  AND transaction_type NOT ILIKE '%Bank%'");// and date between '"+beginDate+"'::date and  '"+endDate+"'");// tn,debit_note db WHERE tn.policy_no != '' and tn.policy_no = db.policy_no GROUP BY tn.policy_no,db.policy_class");
                                ...
                                java.sql.ResultSet rset15 = st15.executeQuery("select sum(credit) from ac_cash_collection where shift_no ='" + listofAct[i] + "' AND "+ com.afrisoftech.lib.DBObject.addColumnCondition("receipt_no", "Numeric") +"  AND transaction_type = 'RECEIPT CANCELLATION'  AND transaction_type NOT ILIKE '%Bank%'");//and date between '"+beginDate+"'::date and  '"+endDate+"'");// tn,debit_note db WHERE tn.policy_no != '' and tn.policy_no = db.policy_no GROUP BY tn.policy_no,db.policy_class");
                                java.sql.ResultSet rset16 = st16.executeQuery("select sum(debit - credit) from ac_cash_collection where shift_no ='" + listofAct[i] + "' AND "+ com.afrisoftech.lib.DBObject.addColumnCondition("receipt_no", "Numeric") +"  AND transaction_type NOT ILIKE '%Bank%'");// and date between '"+beginDate+"'::date and  '"+endDate+"'");// tn,debit_note db WHERE tn.policy_no != '' and tn.policy_no = db.policy_no GROUP BY tn.policy_no,db.policy_class");
                                java.sql.ResultSet rset17 = st17.executeQuery("select sum(credit - debit) from ac_petty_cash where shift_no ='" + listofAct[i] + "'  ");
                                ...
                                while (rset17.next()) {
                                    //  table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                                  //  phrase = new Phrase(dbObject.getDBObject(rset13.getObject(1), "0.0"), pFontNum);
                                    phrase = new Phrase(new com.afrisoftech.sys.Format2Currency().Format2Currency(java.lang.String.valueOf(dbObject.getDBObject(rset17.getDouble(1), "0.0"))), pFontNum);
             
                                    Netrow = Netrow - Double.valueOf(dbObject.getDBObject(rset17.getObject(1), "0"));
                                    pettytotal = pettytotal + rset17.getDouble(1);
                                    rowPetty =  rset17.getDouble(1);
                                    table.addCell(phrase);
                                }
                                
                                double rowNet = rowGrossAmount - rowExemptions - rowRefunds - rowWaivers - rowPetty;
                            ...
                            phrase = new Phrase(new com.afrisoftech.sys.Format2Currency().Format2Currency(java.lang.String.valueOf(pettytotal)), pFontHeader);
                            table.addCell(phrase);

                            phrase = new Phrase(new com.afrisoftech.sys.Format2Currency().Format2Currency(java.lang.String.valueOf(Net - pettytotal )), pFontHeader);
                            table.addCell(phrase);
