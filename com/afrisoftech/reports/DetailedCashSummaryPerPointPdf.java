...
public class DetailedCashSummaryPerPointPdf implements java.lang.Runnable {
    ...
    public void DetailedCashSummaryPerPointPdf(java.sql.Connection connDb, java.util.Date begindate, java.util.Date endate, java.lang.String cashPoint) {
                ...
                try {
                    ...
                    try {
                        ...
                        try {
                            ...
                            phrase = new Phrase("DAILY COLLECTIONS REPORT BY CATEGORY  - Period : "  +dateFormat.format(endDate11)+" - "+dateFormat.format(endDate1), pFontHeader);
                        ...
                        try {
                            ...
                            for (int i = 0; i < listofAct.length; i++) {
                                ...
                                while (rset1.next()){
                                    ...
                                    java.sql.ResultSet rset = st5.executeQuery("select initcap(description),sum(quantity)::numeric(4,0),sum(debit-credit) from ac_cash_collection where date BETWEEN '"+beginDate+"' AND '"+endDate+"' and activity_code = '"+listofAct[i].toString()+"' AND transaction_type not ilike 'Bank%' AND cash_point = '"+CashPoint+"' group by description order by description");
                                    java.sql.Statement st52 = connectDB.createStatement();
                                    
                                    java.sql.ResultSet rset2 = st52.executeQuery("select count(description) from ac_cash_collection where date BETWEEN '"+beginDate+"' AND '"+endDate+"' and activity_code  = '"+listofAct[i].toString()+"' AND transaction_type not ilike 'Bank%' AND cash_point = '"+CashPoint+"' group by description order by description");
                                    while (rset2.next()) {
...
docPdf.close();  com.afrisoftech.lib.PDFRenderer.renderPDF(tempFile);
    ...
    public java.lang.Object[] getListofActivities() {
        ...
        try {
            ...
            java.sql.ResultSet rSet1 = stmt1.executeQuery("SELECT DISTINCT activity_code FROM ac_cash_collection where date BETWEEN '"+beginDate+"' AND '"+endDate+"' AND transaction_type not ilike 'Bank%' AND cash_point = '"+CashPoint+"' ORDER BY activity_code");
