            ...
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        int headerwidths[] = {8,40,20,17,24};
                        ...
                        table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_RIGHT);
                        table.getDefaultCell().setColspan(1);
                        phrase = new Phrase("Self".toUpperCase(), pFontHeader);
                        
                        table.addCell(phrase);
                        
                        phrase = new Phrase("Corporate".toUpperCase(), pFontHeader);
...
docPdf.close();  com.afrisoftech.lib.PDFRenderer.renderPDF(tempFile);
    ...
    public java.lang.Object[] getListofStaffNos() {
        ...
        try {
            ...
            java.sql.PreparedStatement pSet1 = connectDB.prepareStatement("SELECT distinct code from pb_activity pb,ac_ledger ac  where activity_category ilike '%I%' and ac.activity_code = pb.code and drawer ilike 'IP' and ac.date BETWEEN '"+beginDate+"' AND '"+endDate+"' order by code");
