...
public class UnfinCashTransactionsPdf implements java.lang.Runnable {
    ...
    public void UnfinCashTransactionsPdf(java.sql.Connection connDb,java.util.Date begindate, java.util.Date endate) {
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    com.lowagie.text.HeaderFooter footer = new com.lowagie.text.HeaderFooter(new Phrase("Out Patient Bills (Both Self & Scheme paying) - Page: ", pFontHeader11), true);// FontFactory.getFont(com.lowagie.text.FontFactory.HELVETICA, 12, Font.BOLDITALIC,java.awt.Color.blue));
                    ...
                    try {
                        ...
                        try {
                            ...
                            phrase = new Phrase("OUT-PATIENT CASH TRANSACTIONS : PERIOD " +dateFormat.format(endDate1)+ " - " +dateFormat.format(endDate11), com.lowagie.text.FontFactory.getFont(FontFactory.HELVETICA_BOLD,10));
                       ...
                       // table.addCell(phrase);
                        ...
                        try {
                          ...
                          //  java.lang.Object[] listofAct1 = this.getListofActivities1();
                            ...
                            java.sql.ResultSet rsetTotals = st21.executeQuery("SELECT sum(debit-credit) from outpatient_bills_CASH where date BETWEEN '"+beginDate+"' AND '"+endDate+"' group by date");
                           ...
                           // for (int k = 0; k < listofAct1.length; k++) {
                              ...
                              //  System.out.println(""+listofAct1[k].toString());
                                java.sql.ResultSet rset1 = st2.executeQuery("SELECT date::date,patient_no,name,payment_mode,debit as debit,credit as credit, balance from outpatient_bills_CASH WHERE date BETWEEN '"+beginDate+"' AND '"+endDate+"' group by patient_no,payment_mode,date,name,debit,credit,balance ORDER BY date");
