...
public class ShareByCatPdf implements java.lang.Runnable {
    ...
    public void ShareByCatPdf(java.sql.Connection connDb,java.util.Date begindate,java.util.Date endate,java.lang.String categ) {
    ...
    public void generatePdf() {
      ...
      */
                    ...
                    com.lowagie.text.HeaderFooter footer = new com.lowagie.text.HeaderFooter(new Phrase(Categ + " Report  - Page: ",pFontHeader), true);// FontFactory.getFont(com.lowagie.text.FontFactory.HELVETICA, 12, Font.BOLDITALIC,java.awt.Color.blue));
                    ...
                    try {
                        ...
                        try {
                            ...
                            java.sql.ResultSet rset31 = st31.executeQuery("select distinct date from ac_shares_ledger  where item ilike '"+Categ+"'");
                            while (rset31.next()){
                                
                                
                                CatDate = rset31.getObject(1).toString();
                            }
                    ...
                    try {
                        ...
                        int headerwidths[] = {8,35,7,10,7,15,7};
                        ...
                        try {
                            ...
                            phrase = new Phrase("As At : " +dateFormat.format(endDate1), pFontHeader);
                        ...
                        phrase = new Phrase("Issue Date: " +CatDate, pFontHeader);
                        table.addCell(phrase);
                        table.getDefaultCell().setColspan(4);
                        table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_RIGHT);
                        ...
                        try {
                            ...
                            java.sql.ResultSet rset1 = st.executeQuery("select sh.holders_name,sh.acc_no,sum(ac.credit) as amt from  pb_share_register sh,ac_shares_ledger ac  where item ilike '"+Categ+"' and ac.date between '"+beginDate+"' and '"+endDate+"' and ac.credit <>0 and sh.acc_no = ac.account_no group by sh.holders_name,sh.acc_no order by amt desc");// tn,debit_note db WHERE tn.policy_no != '' and tn.policy_no = db.policy_no GROUP BY tn.policy_no,db.policy_class");
                            java.sql.ResultSet rset11 = st2.executeQuery("select sum(credit) as amt from  ac_shares_ledger  where item ilike '"+Categ+"' and date between '"+beginDate+"' and '"+endDate+"' and credit <>0");// tn,debit_note db WHERE tn.policy_no != '' and tn.policy_no = db.policy_no GROUP BY tn.policy_no,db.policy_class");
                            ...
                            while (rset1.next()){
                                ...
                                String Dealer = null;
                                Dealer = rset1.getObject(1).toString();
                                ...
                                phrase = new Phrase(""+numberSeq+"   ",pFontNum);
                                table.addCell(phrase);
                                table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                                phrase = new Phrase(dbObject.getDBObject(rset1.getObject(1).toString(), "-"),pFontNum);
                                
                                table.addCell(phrase);
                                table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                                phrase = new Phrase(dbObject.getDBObject(rset1.getObject(2).toString(), "-"),pFontNum);
                                ...
                                osBalancet = osBalancet + rset1.getDouble(3);
                                
                                table.addCell(phrase);
                                
                                
                                phrase = new Phrase(new com.afrisoftech.sys.Format2Currency().Format2Currency(java.lang.String.valueOf(osBalance1*100/osBalance)),pFontHeader);
                                Pct = Pct + (osBalance1*100/osBalance);
                                table.addCell(phrase);
                                ...
                                table.addCell(phrase);
                                phrase = new Phrase(new com.afrisoftech.sys.Format2Currency().Format2Currency(java.lang.String.valueOf(Pct)),pFontHeader);
