...
public class TrialBalanceAnnPdf_1 implements java.lang.Runnable {
                ...
                try {
                    ...
                    try {
                        ...
                        try {
                            ...
                            java.sql.ResultSet rset = st.executeQuery("SELECT tb.gl_code,sum(debit-tb.credit) from tb_itemized_summary tb WHERE tb.date <= '"+endDate+"' group by tb.gl_code order by tb.gl_code");
                            
                            java.sql.ResultSet rsete = st21.executeQuery("SELECT tb.gl_code,sum(debit-tb.credit) from tb_itemized_summary tb WHERE tb.date <= '"+endDate+"' group by tb.gl_code order by tb.gl_code");
