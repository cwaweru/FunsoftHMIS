...
public class TransByAccountSummPdf implements java.lang.Runnable {
    ...
    public void TransByAccountSummPdf(java.sql.Connection connDb, java.util.Date begindate, java.util.Date endate, java.lang.String combox, java.lang.String ptype) {
            ...
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        int headerwidths[] = {12, 30, 20, 15, 13, 13};
                        ...
                        try {
                            ...
                            phrase = new Phrase(bank + "  " + Activity + " :  Transactions Report(Summary)  [" + paType + "]   Period : From " + dateFormat.format(endDate11) + " To " + dateFormat.format(endDate1), pFontHeader);
                        ...
                        phrase = new Phrase("Transaction Type", pFontHeader);
                        table.addCell(phrase);
                        
                        phrase = new Phrase("Document Number", pFontHeader);
                        table.addCell(phrase);
                        ...
                        try {
                            ...
                            if (paType.equalsIgnoreCase("OP")) {
                                java.sql.ResultSet rset = st.executeQuery("select date, service_type, transaction_type, invoice_no, debit,credit from ac_ledger WHERE date BETWEEN '" + beginDate + "' AND '" + endDate + "' AND activity_code = '" + bank + "' AND drawer = 'OP'  ORDER BY date ASC");// tn,debit_note db WHERE tn.policy_no != '' and tn.policy_no = db.policy_no GROUP BY tn.policy_no,db.policy_class");
                                ...
                                if (paType.equalsIgnoreCase("IP")) {
                                    java.sql.ResultSet rset = st.executeQuery("select date, service_type, transaction_type, invoice_no, debit, credit, from ac_ledger WHERE date BETWEEN '" + beginDate + "' AND '" + endDate + "' AND activity_code = '" + bank + "' AND drawer = 'IP'  ORDER BY date ASC");// tn,debit_note db WHERE tn.policy_no != '' and tn.policy_no = db.policy_no GROUP BY tn.policy_no,db.policy_class");
                                    ...
                                    java.sql.ResultSet rset = st.executeQuery("select date, description, transaction_type, invoice_no, debit, credit from transaction_list_view WHERE date BETWEEN '" + beginDate + "' AND '" + endDate + "' AND activity_code = '" + bank + "'  ORDER BY date ASC");// tn,debit_note db WHERE tn.policy_no != '' and tn.policy_no = db.policy_no GROUP BY tn.policy_no,db.policy_class");
