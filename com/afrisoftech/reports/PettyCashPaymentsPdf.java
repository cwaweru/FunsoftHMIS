            ...
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        int headerwidths[] = {12,8,20,25,16,14,13,16};
                        ...
                        try {
                            ...
                            java.sql.Statement st3 = connectDB.createStatement();
                            java.sql.ResultSet rset = st.executeQuery("SELECT date,voucher_no,initcap(payee),initcap(status),initcap(description),sum(debit-credit),transaction_no from ac_petty_cash WHERE date BETWEEN '"+beginDate+"' AND '"+endDate+"' AND paid = 'true' GROUP BY date,voucher_no,initcap(payee),initcap(status),description,transaction_no ORDER BY transaction_no");
