...
public class BalanceDetlSheetePdf implements java.lang.Runnable {
    ...
    public void BalanceDetlSheetePdf(java.sql.Connection connDb, java.util.Date begindate,java.util.Date endate) {
        connectDB = connDb;
        beginDate = begindate;
        endDate = endate;
                    ...
                    try {
                        ...
                        try {
                           ...
                           // java.sql.Statement st2 = connectDB.createStatement();
                            ...
                            java.sql.ResultSet rsetx = st2c.executeQuery("SELECT SUM(debit - credit) from tb_itemized_summary WHERE date BETWEEN '"+beginDate+"' AND '"+endDate+"'");
                            while (rsetx.next()) {
                      ...
                      /*      if (diff != 0.00){
                            ...
                            for (int i = 0; i < listofAct.length; i++) {
                                ...
                                java.sql.ResultSet rset3 = st3.executeQuery("select DISTINCT at.main_category from pb_activity at where at.main_code = '"+listofAct[i].toString()+"' AND at.category_class = 'ba'");
                                
                                java.sql.ResultSet rset = st.executeQuery("select ac.code,upper(ac.activity),sum(bv.debit-bv.credit) from tb_itemized_summary bv,pb_activity ac where ac.main_code = '"+listofAct[i].toString()+"' and bv.date between '"+beginDate+"' AND '"+endDate+"' and bv.gl_code = ac.code and ac.category_class = 'ba' group by ac.code,ac.activity order by ac.code");
                                
                                java.sql.ResultSet rsetTotals = st2.executeQuery("SELECT SUM(bv.debit-bv.credit) from tb_itemized_summary bv,pb_activity ac where ac.main_code = '"+listofAct[i].toString()+"' AND bv.gl_code = ac.code and bv.date between '"+beginDate+"' AND '"+endDate+"' and ac.category_class = 'ba' group by ac.main_code");
                            ...
                            for (int i = 0; i < listofAct1.length; i++) {
                                ...
                                java.sql.ResultSet rset6 = st6.executeQuery("select ac.code,ac.activity,sum(bv.debit-bv.credit) from tb_itemized_summary bv,pb_activity ac where ac.main_code = '"+listofAct1[i].toString()+"' and bv.date between '"+beginDate+"' AND '"+endDate+"' AND bv.gl_code = ac.code AND ac.category_class = 'bl' group by ac.code,ac.activity order by ac.code");
                                
                                java.sql.ResultSet rset7 = st7.executeQuery("SELECT SUM(bv.debit-bv.credit) from tb_itemized_summary bv,pb_activity ac where ac.main_code = '"+listofAct1[i].toString()+"' and bv.date between '"+beginDate+"' AND '"+endDate+"' AND bv.gl_code = ac.code AND ac.category_class = 'bl' group by ac.main_code");
                            ...
                            java.sql.ResultSet rset13m = st13m.executeQuery("SELECT SUM(bv.debit-bv.credit) FROM tb_itemized_summary bv, pb_activity ac where bv.gl_code = ac.code AND (ac.category_class ilike 'pli%' OR ac.category_class ilike 'ple%') and bv.date between '"+beginDate+"' AND '"+endDate+"'");
                            
                            java.sql.Statement st14 = connectDB.createStatement();
                            java.sql.ResultSet rset14= st14.executeQuery("select sum(bv.debit-bv.credit) FROM tb_itemized_summary bv, pb_activity ac where bv.gl_code = ac.code AND ac.category_class ilike 'ble' and bv.date between '"+beginDate+"' AND '"+endDate+"'");
                            ...
                            for (int i = 0; i < listofAct2.length; i++) {
                                ...
                                java.sql.ResultSet rset15 = st15.executeQuery("select ac.code,ac.activity,sum(bv.debit-bv.credit) from tb_itemized_summary bv,pb_activity ac where ac.main_code = '"+listofAct2[i].toString()+"' AND bv.date between '"+beginDate+"' AND '"+endDate+"' AND bv.gl_code = ac.code and ac.category_class ilike 'ble' group by ac.code,ac.activity order by ac.code");
