...
//                            phrase = new Phrase("CODE", pFontHeader);
                        ...
                        try {
                            ...
                            for (int i = 0; i < listofAct.length; i++) {
                                java.sql.ResultSet rsetu1 = stu1.executeQuery("SELECT  count(h.item) FROM st_sub_stores h,hp_patient_register p where store_name ilike '%pharmacy%' and (patient_source  ilike 'OP%'   ) AND trans_date::date BETWEEN '" + beginDate + "' AND '" + endDate + "' and h.patient_no=p.patient_no and (trans_date::date-year_of_birth::date)/365 < 1 and h.item='" + listofAct[i] + "' " + condition + " UNION "
                                        + "SELECT  count(h.item) FROM st_sub_stores h,hp_inpatient_register p where store_name ilike '%pharmacy%' and (patient_source  ilike 'IP%'  ) AND trans_date::date BETWEEN '" + beginDate + "' AND '" + endDate + "' and h.patient_no=p.patient_no and  (trans_date::date-year_of_birth::date)/365 < 1 and h.item='" + listofAct[i] + "' " + condition + "");
                                
                                java.sql.ResultSet rseto1 = st2k.executeQuery("SELECT  count(h.item) FROM st_sub_stores h,hp_patient_register p where store_name ilike '%pharmacy%' and (patient_source  ilike 'OP%'  ) AND trans_date::date BETWEEN '" + beginDate + "' AND '" + endDate + "' and h.patient_no=p.patient_no and (trans_date::date-year_of_birth::date)/365 BETWEEN 1 AND 4 and h.item='" + listofAct[i] + "' " + condition + " UNION "
                                ...
                                java.sql.ResultSet rset5 = st2l.executeQuery("SELECT  count(h.item) FROM st_sub_stores h,hp_patient_register p where store_name ilike '%pharmacy%' and (patient_source  ilike 'OP%'  ) AND trans_date::date BETWEEN '" + beginDate + "' AND '" + endDate + "' and h.patient_no=p.patient_no and (trans_date::date-year_of_birth::date)/365 BETWEEN 5 AND 14 and h.item='" + listofAct[i] + "' " + condition + " UNION "
                                        + "SELECT  count(h.item) FROM st_sub_stores h,hp_inpatient_register p where store_name ilike '%pharmacy%' and (patient_source  ilike 'IP%'  ) AND trans_date::date BETWEEN '" + beginDate + "' AND '" + endDate + "' and h.patient_no=p.patient_no and  (trans_date::date-year_of_birth::date)/365 BETWEEN 5 AND 14 and h.item='" + listofAct[i] + "' " + condition + "");
                                
                                java.sql.ResultSet rset15 = st15.executeQuery("SELECT  count(h.item) FROM st_sub_stores h,hp_patient_register p where store_name ilike '%pharmacy%' and (patient_source  ilike 'OP%'  ) AND trans_date::date BETWEEN '" + beginDate + "' AND '" + endDate + "' and h.patient_no=p.patient_no and (trans_date::date-year_of_birth::date)/365 BETWEEN 15 AND 44 and h.item='" + listofAct[i] + "' " + condition + " UNION "
                                        + "SELECT  count(h.item) FROM st_sub_stores h,hp_inpatient_register p where store_name ilike '%pharmacy%' and ( patient_source  ilike 'IP%'  ) AND trans_date::date BETWEEN '" + beginDate + "' AND '" + endDate + "' and h.patient_no=p.patient_no and  (trans_date::date-year_of_birth::date)/365 BETWEEN 15 AND 44 and h.item='" + listofAct[i] + "' " + condition + "");
                                
                                java.sql.ResultSet rset45 = st45.executeQuery("SELECT  count(h.item) FROM st_sub_stores h,hp_patient_register p where store_name ilike '%pharmacy%' and (patient_source  ilike 'OP%'  ) AND trans_date::date BETWEEN '" + beginDate + "' AND '" + endDate + "' and h.patient_no=p.patient_no and (trans_date::date-year_of_birth::date)/365 BETWEEN 45 AND 60 and h.item='" + listofAct[i] + "' " + condition + " UNION "
                                        + "SELECT  count(h.item) FROM st_sub_stores h,hp_inpatient_register p where store_name ilike '%pharmacy%' and (patient_source  ilike 'IP%'  ) AND trans_date::date BETWEEN '" + beginDate + "' AND '" + endDate + "' and h.patient_no=p.patient_no and  (trans_date::date-year_of_birth::date)/365 BETWEEN 45 AND 60 and h.item='" + listofAct[i] + "' " + condition + "");
                                
                                java.sql.ResultSet rset61 = st61.executeQuery("SELECT  count(h.item) FROM st_sub_stores h,hp_patient_register p where store_name ilike '%pharmacy%' and (patient_source  ilike 'OP%'  ) AND trans_date::date BETWEEN '" + beginDate + "' AND '" + endDate + "' and h.patient_no=p.patient_no and (trans_date::date-year_of_birth::date)/365 > 60 and h.item='" + listofAct[i] + "' " + condition + " UNION "
                                        + "SELECT  count(h.item) FROM st_sub_stores h,hp_inpatient_register p where store_name ilike '%pharmacy%' and ( patient_source  ilike 'IP%'  ) AND trans_date::date BETWEEN '" + beginDate + "' AND '" + endDate + "' and h.patient_no=p.patient_no and  (trans_date::date-year_of_birth::date)/365 > 60 and h.item='" + listofAct[i] + "' " + condition + "");
