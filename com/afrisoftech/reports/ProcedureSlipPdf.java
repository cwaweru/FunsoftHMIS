...
public class ProcedureSlipPdf implements java.lang.Runnable {
    ...
    public void ProcedureSlipPdf(java.sql.Connection connDb,java.lang.String voucno) {
            ...
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        phrase = new Phrase("Request Slip", pFontHeader);
                        ...
                        try {
                            ...
                            java.sql.ResultSet rset = st.executeQuery("select distinct trans_date,current_timestamp(0),patient_no,initcap(patient_name),initcap(doctor),initcap(revenue_code),inv_no from pb_doctors_request where inv_no='"+vouchNo+"' order by inv_no limit 1");
                            ...
                            while (rset.next()) {
                                ...
                                phrase = new Phrase("Revenue Dept : "+ rset.getObject(6).toString(), pFontHeader);
                                
                                table.addCell(phrase);
                                phrase = new Phrase("Doctor : "+rset.getObject(5).toString(), pFontHeader);
                                
                                table.addCell(phrase);
                                table.getDefaultCell().setColspan(2);
                                table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_CENTER);
                                phrase = new Phrase("Procedure ", pFontHeader);
                                table.addCell(phrase);
