            ...
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        int headerwidths[] = {15, 15, 30, 15, 15, 15, 15, 30, 15};
                        ...
                        try {
                            ...
                            table.addCell(phrase);
                            table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                            phrase = new Phrase("Billing Officer", pFontHeader1);
                            table.addCell(phrase);
                            phrase = new Phrase("Claim Number", pFontHeader1);
                            table.addCell(phrase);
                            //table
                            while (rset1.next()) {
                                table.getDefaultCell().setColspan(1);
                                ...
                                table.getDefaultCell().setColspan(1);
                                table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                                phrase = new Phrase(dbObject.getDBObject(" "+rset1.getString(7), "-").toUpperCase(), pFontHeader);
                                table.addCell(phrase);
                                table.getDefaultCell().setColspan(1);
                                table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                                phrase = new Phrase(dbObject.getDBObject(rset1.getString(8), "-").toUpperCase(), pFontHeader);
