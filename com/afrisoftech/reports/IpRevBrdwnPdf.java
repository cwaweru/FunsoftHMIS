...
public class IpRevBrdwnPdf implements java.lang.Runnable {
    ...
    public java.lang.Object[] getListofStaffNos1(java.lang.Object codes) {
        ...
        try {
            ...
            java.sql.PreparedStatement pSet1 = connectDB.prepareStatement("SELECT distinct service_type from ac_ledger  where activity_code = '"+codes+"' AND date  between '"+beginDate+"' AND '"+endDate+"' AND drawer ilike 'IP' order by service_type");
