                ...
                try {
                    ...
                    try {
                        ...
                        try {
                            ...
                            java.sql.ResultSet rset1 = st1.executeQuery("select date::date,initcap(service) as service,dosage,main_service, debit from hp_patient_card where patient_no = '"+memNo+"' AND invoice_no is null AND date::date BETWEEN '"+beginDate+"' AND '"+endDate+"' order by date::date");// union select date::date,initcap(service) as service,dosage,reference,credit from hp_patient_card where patient_no = '"+memNo+"' and credit > 0 order by date");
