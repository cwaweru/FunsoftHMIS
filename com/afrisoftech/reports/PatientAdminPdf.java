...
public class PatientAdminPdf implements java.lang.Runnable {
                ...
                try {
                    ...
                    try {
                        ...
                        if(servicepnt.equalsIgnoreCase("-"))
                         phrase = new Phrase("Admission Report ", pFontHeader);
                        else
                         phrase = new Phrase("Admission Report at  " +servicepnt, pFontHeader);
                        ...
                        try {
                            ...
                            java.sql.ResultSet rset33 = st33.executeQuery("SELECT count(admission_no) FROM hp_admission WHERE date_admitted::date BETWEEN '"+beginDate+"' AND '"+endDate+"'");
...
docPdf.close();  com.afrisoftech.lib.PDFRenderer.renderPDF(tempFile);
    ...
    public java.lang.Object[] getListofActivities() {
        ...
        try {
            ...
            if(servicepnt.equalsIgnoreCase("-")){
             rSet1 = stmt1.executeQuery("SELECT DISTINCT upper(ward) as ward FROM hp_admission WHERE date_admitted::date BETWEEN '"+beginDate+"' AND '"+endDate+"' order by ward");
            } else {
               rSet1 = stmt1.executeQuery("SELECT DISTINCT upper(ward) as ward FROM hp_admission WHERE date_admitted::date BETWEEN '"+beginDate+"' AND '"+endDate+"' and diagnosis3='"+servicepnt+"' order by ward");
            }
            while (rSet1.next()) {
