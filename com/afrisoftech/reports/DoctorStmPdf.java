            ...
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        int headerwidths[] = {12,32,12,13,13,13,13,17};
                        ...
                        try {
                            ...
                            phrase = new Phrase("Doctor's (Statement)".toUpperCase(), pFontHeader1);
                            table.addCell(phrase);
                            while (rset.next()){
                                
                                table.getDefaultCell().setColspan(8);
                                table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                                phrase = new Phrase("Account No.:  "+memNo, pFontHeader1);
                                table.addCell(phrase);
                                ...
                                table.getDefaultCell().setColspan(4);
                                table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                                phrase = new Phrase("Tel No : "+dbObject.getDBObject(rset.getObject(1), "-"), pFontHeader1);
                                table.addCell(phrase);
