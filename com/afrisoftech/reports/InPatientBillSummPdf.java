                    ...
                    try {
                        ...
                        try {
                         ...
                         java.sql.ResultSet rset22 = st32.executeQuery("SELECT DISTINCT header_name from pb_header");
                            ...
                            java.sql.ResultSet rsetsum = stsum.executeQuery("select now()::date, now()::time, current_user");
...
while(rsetsum.next()){
                            table.getDefaultCell().setColspan(6);
                            phrase = new Phrase("This summarised interim invoice was printed by : "+ rsetsum.getString(3).toUpperCase() +" on : "+rsetsum.getDate(1).toString() +" at :"+rsetsum.getTime(2).toString(), pFontHeader);
