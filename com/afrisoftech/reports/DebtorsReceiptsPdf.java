                ...
                try {
                    ...
                    try {
                        ...
                        try {
                            ...
                            java.sql.ResultSet rset = st.executeQuery("select date,receipt_no,payee,account_no,reason,cheque_no,credit-debit "
                                    + "from ac_debtors WHERE date BETWEEN '"+beginDate+"' AND '"+endDate+"' AND transaction_type ilike 'Receipts%' or transaction_type ilike 'Receipts Adj%' "
                                    + " AND reason not ilike '%Allocation%' ORDER BY receipt_no");
