                ...
                try {
                    ...
                    try {
                        ...
                        try {
                            ...
                            java.sql.ResultSet rset1 = st1.executeQuery("select Distinct payee,purpose from ac_petty_cash_requisition where requisition_no = '"+MNo+"' AND approved = false");
                            ...
                            java.sql.ResultSet rs = st.executeQuery("select Distinct requisition_no,date_required from ac_petty_cash_requisition where requisition_no = '"+MNo+"' AND approved = false");
                            java.sql.ResultSet rset5 = st5.executeQuery("select sum(credit-debit) from ac_petty_cash_requisition where requisition_no = '"+MNo+"' and approved = false");
                            java.sql.ResultSet rset6 = st6.executeQuery("select reason,credit-debit,code from ac_petty_cash_requisition where requisition_no ='"+MNo+"' and approved = false");
