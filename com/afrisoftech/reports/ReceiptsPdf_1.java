...
public class ReceiptsPdf_1 implements java.lang.Runnable {
    ...
    // public void ReceiptsPdf_1(java.sql.Connection connDb, java.lang.String begindate, java.lang.String endate, java.lang.String combox) {
    
    public void ReceiptsPdf(java.sql.Connection connDb, java.lang.String receipt) {
                ...
                try {
                    ...
                    try {
                        ...
                        try {
                            ...
                            java.sql.ResultSet rset5 = st5.executeQuery("select description,sum(quantity),sum(debit-credit),round(sum(debit/quantity)) from ac_cash_collection where patient_no = '"+MNo+"' and receipt_no = '"+Receipt+"' group by description ORDER BY sum(debit) DESC");
