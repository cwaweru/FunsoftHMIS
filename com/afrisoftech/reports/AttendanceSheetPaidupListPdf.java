...
public class AttendanceSheetPaidupListPdf implements java.lang.Runnable {
    ...
    public void AttendanceSheetPaidupListPdf(java.sql.Connection connDb,java.util.Date begindate, java.util.Date endate, java.lang.String cashPoint,java.lang.String glCode) {
            ...
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        int headerwidths[] = {8,8,9,20,8,10,10,15};
                        ...
                        try {
                            ...
                            phrase = new Phrase("Receipts List for "+CashPoint+" :     Period : From "  +dateFormat.format(endDate11)+" To "+dateFormat.format(endDate1), pFontHeader);
                        ...
                        table.addCell(phrase);
                         ...
                         phrase = new Phrase("Patient N0",pFontHeader);
                        table.addCell(phrase);
                        ...
                        try {
                            ...
                            java.sql.ResultSet rset = st.executeQuery("select date,receipt_no,patient_no,upper(dealer),user_name,payment_mode,cheque_no,sum(debit-credit) from ac_cash_collection WHERE date::DATE BETWEEN '"+beginDate+"' AND '"+endDate+"' AND transaction_type ILIKE 'Receipts' GROUP BY date,patient_no,receipt_no,dealer,account_no,payment_mode,user_name,cheque_no ORDER BY receipt_no::int");
                            java.sql.ResultSet rsetTotals = st2.executeQuery("SELECT SUM(debit) from ac_cash_collection WHERE date::DATE BETWEEN '"+beginDate+"' AND '"+endDate+"' AND transaction_type ILIKE 'Receipts' and activity_code='"+GlCode+"'");
                            ...
                            while (rset.next()) {
                                ...
                                osBalance1 = osBalance1 + rset.getDouble(8);
