...
public class DetailedCashSummaryPerShiftPdf implements java.lang.Runnable {

    java.lang.String memNo = null;
    java.lang.String UserName = null;
    java.lang.String ShiftNo = null;
    String ks;
    ...
    public void DetailedCashSummaryPerShiftPdf(java.sql.Connection connDb, java.lang.String shiftNo) {
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    com.lowagie.text.HeaderFooter footer = new com.lowagie.text.HeaderFooter(new Phrase("Workloads against cash collected report- Page: "), true);// FontFactory.getFont(com.lowagie.text.FontFactory.HELVETICA, 12, Font.BOLDITALIC,java.awt.Color.blue));
...
//                            java.util.Date endDate1 = dateFormat.parse(endDate.toLocaleString());//dateInstance.toLocaleString());
                        ...
                        phrase = new Phrase("DEPARTMENTAL WORKLOAD AGAINST DAILY COLLECTIONS REPORT BY CATEGORY  - SHIFT NO : " + ShiftNo, pFontHeader);
                        ...
                        try {
                            ...
                            for (int i = 0; i < listofAct.length; i++) {
                                ...
                                while (rset1.next()) {
                                    ...
                                    java.sql.ResultSet rset = st5.executeQuery("select initcap(description),sum(quantity)::numeric(10,0),sum(debit-credit) from ac_cash_collection WHERE shift_no = '" + ShiftNo + "' and activity_code = '" + listofAct[i].toString() + "' AND transaction_type not ilike 'Bank%' group by description order by description");
                                    java.sql.Statement st52 = connectDB.createStatement();

                                    java.sql.ResultSet rset2 = st52.executeQuery("select count(description) from ac_cash_collection WHERE shift_no = '" + ShiftNo + "' and activity_code  = '" + listofAct[i].toString() + "' AND transaction_type not ilike 'Bank%' group by description order by description");
                                    while (rset2.next()) {
                                    ...
                                    while (rset.next()) {
                                        ...
                                        if (numb == 1) {
                                            ...
                                            table.getDefaultCell().setColspan(1);
                                            table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_RIGHT);
                                            phrase = new Phrase(new com.afrisoftech.sys.Format2Currency().Format2Currency(String.valueOf(itemPrice * rset.getInt(2) - Double.parseDouble(rset.getString(3)))), pFontHeader1);
                                            table.addCell(phrase);
                                    ...
                                    table.addCell(phrase);
                                    phrase = new Phrase(new com.afrisoftech.sys.Format2Currency().Format2Currency(java.lang.String.valueOf(subTotalExpected - subTotal)), pFontHeader);
...
docPdf.close();  com.afrisoftech.lib.PDFRenderer.renderPDF(tempFile);
    ...
    public java.lang.Object[] getListofActivities() {
        ...
        try {
            ...
            java.sql.ResultSet rSet1 = stmt1.executeQuery("SELECT DISTINCT activity_code FROM ac_cash_collection WHERE shift_no = '" + ShiftNo + "' AND transaction_type not ilike 'Bank%'  ORDER BY activity_code");
