            ...
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        int headerwidths[] = {8,15,15,20,25,10,20};
                        ...
                        try {
                            ...
                            java.sql.ResultSet rset = st.executeQuery("select adm_date,patient_no,upper(first_name),UPPER(second_name),pay_mode,description from hp_inpatient_register WHERE adm_date BETWEEN '"+beginDate+"' AND '"+endDate+"' order by adm_date");
