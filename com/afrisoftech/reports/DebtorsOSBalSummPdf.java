            ...
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        int headerwidths[] = {30,5,12,12,12,6};
                        ...
                        try {
                            ...
                            phrase = new Phrase("Payment Bal. "+ks,pFontHeader1);
                           // table.addCell(phrase);
                            ...
                            for (int i = 0; i < listofAct.length; i++) {
                                ...
                                java.sql.ResultSet rset1 = st1.executeQuery("select distinct initcap(dealer) from ac_debtors where dealer ilike '"+listofAct[i]+"'");// union select date::date,initcap(service) as service,dosage,reference,credit from hp_patient_card where patient_no = '"+memNo+"' and credit > 0 order by date");
                                java.sql.ResultSet rset12 = st12.executeQuery("select count(invoice_no),sum(debit) ,sum(credit),sum(debit-credit),sum(credit) ,sum(debit-credit)*100/sum(debit)from ac_debtors where date <= '"+endDate+"' and dealer ilike '"+listofAct[i]+"'");
                           ...
                           // table.addCell(phrase);
                            ...
                            phrase = new Phrase(new com.afrisoftech.sys.Format2Currency().Format2Currency(java.lang.String.valueOf(osBalance1*100/osBalance)), pFontHeader1);
                            ...
                            table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                            phrase = new Phrase("Net Outstandig Balance % : " + new com.afrisoftech.sys.Format2Currency().Format2Currency(java.lang.String.valueOf(osBalance1*100/osBalance)),pFontHeader11);
                            ...
                            table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                            phrase = new Phrase("Avg. Amount Per Invoice : " + new com.afrisoftech.sys.Format2Currency().Format2Currency(java.lang.String.valueOf(osBalance/osBalancebf)), pFontHeader11);
...
docPdf.close();  com.afrisoftech.lib.PDFRenderer.renderPDF(tempFile);
    ...
    public java.lang.Object[] getListofActivities() {
        ...
        try {
            ...
            java.sql.PreparedStatement pSet1 = connectDB.prepareStatement("SELECT DISTINCT initcap(dealer) FROM ac_debtors where date <= '"+endDate+"' and dealer !='' and balance >0 order by initcap(dealer)");
