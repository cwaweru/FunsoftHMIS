                    ...
                    try {
                        ...
                        try {
                            ...
                            for (int k = 0; k < listofAct1.length; k++) {
                                ...
                                java.sql.ResultSet rset1 = st2.executeQuery("SELECT distinct ad.patient_no,UPPER(ad.patient_name),ad.date_admitted::date,ad.discharge_date::date from hp_admission ad, hp_patient_card pc where ad.patient_no = pc.patient_no AND pc.invoice_no = '"+listofAct1[k]+"' AND ad.date_admitted::date >= '"+beginDate+"'");
   ...
   /*
    ...
    public java.lang.Object[] getListofActivities1() {
        ...
        try {
            ...
            java.sql.ResultSet rSet1 = stmt1.executeQuery("SELECT distinct invoice_no from hp_admission where discharge_date::date BETWEEN '"+beginDate+"' AND '"+endDate+"' and invoice_no ilike 'I%' and mode_of_payment ilike 'Cash' order by invoice_no");
