...
public class StatementAccPerPayerPdf implements java.lang.Runnable {
    ...
    public void StatementAccPerPayerPdf(java.sql.Connection connDb, java.util.Date begindate, java.util.Date endate,java.lang.String combox1) {
    ...
    public java.lang.Object[] getListofActivities() {
        ...
        try {
            ...
            java.sql.PreparedStatement pSet1 = connectDB.prepareStatement("SELECT DISTINCT account_no FROM ac_debtors where account_no IS NOT NULL and dealer = '"+memNo1+"' and date::date BETWEEN '"+beginDate+"' AND '"+endDate+"' and balance > 0 order by account_no");
