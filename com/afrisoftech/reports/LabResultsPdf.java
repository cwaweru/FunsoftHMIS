            ...
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        phrase = new Phrase("Tested By", pFontHeader);
                        ...
                        try {
                            ...
                            java.sql.ResultSet rset1 = st2.executeQuery("SELECT date,patient_no,INITCAP(patient_name),lab_no,age,gender,typeof_test,INITCAP(parameter),INITCAP(out_come),pathologist FROM hp_lab_results WHERE date BETWEEN '"+beginDate+"' AND '"+endDate+"' GROUP BY date,patient_no,patient_name,lab_no,age,gender,typeof_test,pathologist,out_come,parameter ORDER BY 1,4");
