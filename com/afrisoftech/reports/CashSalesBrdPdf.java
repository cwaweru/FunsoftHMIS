        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    com.lowagie.text.HeaderFooter footer = new com.lowagie.text.HeaderFooter(new Phrase("RECEIPTs Breakdown - Page: "), true);// FontFactory.getFont(com.lowagie.text.FontFactory.HELVETICA, 12, Font.BOLDITALIC,java.awt.Color.blue));
                    ...
                    try {
                        ...
                        int headerwidths[] = {8,15, 20, 10, 35, 20, 8, 15, 15};
                        ...
                        try {
                            ...
                            phrase = new Phrase(bank + "  RECEIPTs Report" + "   Period : From " + dateFormat.format(endDate11) + " To " + dateFormat.format(endDate1), pFontHeader);
                        ...
                        try {
                            ...
                            java.sql.ResultSet rset = st.executeQuery("select date,patient_no,receipt_no,initcap(dealer),(debit-credit) from ac_cash_collection WHERE date BETWEEN '" + beginDate + "' AND '" + endDate + "' AND  activity_code ilike '" + Code + "'  order by receipt_no");// tn,debit_note db WHERE tn.policy_no != '' and tn.policy_no = db.policy_no GROUP BY tn.policy_no,db.policy_class");


                            while (rset.next()) {
                                java.sql.ResultSet rsetx = st2.executeQuery("select DISTINCT age,department FROM hp_patient_visit WHERE date BETWEEN '" + beginDate + "' AND '" + endDate + "' AND  patient_no = '" + rset.getObject(2) + "'");// tn,debit_note db WHERE tn.policy_no != '' and tn.policy_no = db.policy_no GROUP BY tn.policy_no,db.policy_class");
                                while (rsetx.next()) {
                                    x = x+1;
                                    table.getDefaultCell().setColspan(1);
                                      phrase = new Phrase(new com.afrisoftech.sys.Format2IntCurrency().Format2IntCurrency(java.lang.String.valueOf(x)), pFontHeader);
