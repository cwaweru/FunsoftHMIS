            ...
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        int headerwidths[] = {5,12,11,25,10,12,12,10,10,15};
                        ...
                        try {
                            ...
                            java.sql.ResultSet rsetTotals = st2.executeQuery("select sum(debit - credit) from ac_debtors where dealer ilike '"+memNo+"' AND date::date <= '"+endDate+"'");
                            ...
                            for (int j = 0; j < listofStaffNos.length; j++) {
                                ...
                                java.sql.ResultSet rsetTotals2 = st22.executeQuery("select sum(debit - credit) from ac_debtors where dealer ilike '"+memNo+"%' AND date::date <'"+beginDate+"' and payee ilike '"+listofStaffNos[j]+"'");
