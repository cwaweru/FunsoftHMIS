...
public class CashDailyRevPdf implements java.lang.Runnable {
    ...
    public void CashDailyRevPdf(java.sql.Connection connDb, java.util.Date begindate, java.util.Date endate) {
                        ...
                        String nhifs = null;
                            try {
                                try {
                                    ...
                                    com.afrisoftech.lib.DateFormatter dateFormatterz = new com.afrisoftech.lib.DateFormatter(dateFormat.parse(listofAct[i].toString().trim()), "dd MMM yyyy");
                                ...
                                java.sql.PreparedStatement pset11a = connectDB.prepareStatement("SELECT DISTINCT code FROM pb_activity WHERE department ILIKE 'IPP' ORDER BY code");
                                ...
                                while (rset11a.next()) {
                                    ...
                                    java.sql.PreparedStatement pset1 = connectDB.prepareStatement("select sum(debit-waived) from moh_reports WHERE receipt_time = '" + listofAct[i] + "' AND activity_code = '" + ip + "'");//< '"+endDate+"'::date and date > '"+endDate+"'::date - 30 group by dealer");
                                ...
                                java.sql.PreparedStatement psetj = connectDB.prepareStatement("SELECT DISTINCT code FROM pb_activity WHERE department ILIKE 'MAT' ORDER BY code");
                                ...
                                java.sql.PreparedStatement pset11 = connectDB.prepareStatement("SELECT DISTINCT code FROM pb_activity WHERE department ILIKE 'XRY' ORDER BY code");
                                ...
                                while (rset111.next()) {
                                    ...
                                    java.sql.PreparedStatement pset121 = connectDB.prepareStatement("select sum(debit-waived) from moh_reports WHERE receipt_time = '" + listofAct[i] + "' AND activity_code = '" + lab + "'");
                                ...
                                java.sql.PreparedStatement psets1 = connectDB.prepareStatement("SELECT DISTINCT code FROM pb_activity WHERE department ILIKE 'THE' ORDER BY code");
                                ...
                                while (rsets1.next()) {
                                    ...
                                    java.sql.PreparedStatement psets1e = connectDB.prepareStatement("select sum(debit-waived) from moh_reports WHERE receipt_time = '" + listofAct[i] + "' AND activity_code = '" + the + "'");
                                ...
                                java.sql.PreparedStatement psetd1 = connectDB.prepareStatement("SELECT DISTINCT code FROM pb_activity WHERE department ILIKE 'MOT' ORDER BY code");
                                ...
                                java.sql.PreparedStatement psetp = connectDB.prepareStatement("SELECT DISTINCT code FROM pb_activity WHERE department ILIKE 'OPP' ORDER BY code");
                            ...
                            /*    if (i < listofAct1.length) {
                                ...
                                while (rsethnh.next()) {
                                    ...
                                    java.sql.PreparedStatement psetwnh = connectDB.prepareStatement("select sum(debit-credit) from ac_cash_collection WHERE date::DATE = '" + listofAct[i] + "' AND activity_code = '" + nhifs + "'");//(activity_code NOT LIKE '"+pha+"' OR activity_code NOT LIKE '"+opp+"' OR activity_code NOT LIKE '"+mot+"' OR activity_code NOT LIKE '"+the+"' OR activity_code NOT LIKE '"+xray+"' OR activity_code NOT LIKE '"+mot+"')");
                                ...
                                java.sql.PreparedStatement psetwn = connectDB.prepareStatement("select sum(credit-debit) from ac_cash_collection WHERE date::DATE = '" + listofAct[i] + "' AND transaction_type ILIKE 'Waiver%'");
                                java.sql.ResultSet rsetwn = psetwn.executeQuery();

                                java.sql.PreparedStatement psetwn1 = connectDB.prepareStatement("select sum(debit-credit) from ac_debtors WHERE date = '" + listofAct[i] + "' AND (payee ILIKE 'NHIF%' OR payee ILIKE 'N H I F%' OR payee ILIKE 'N.H.I.F%')");
                                ...
                                java.sql.PreparedStatement psetwn4 = connectDB.prepareStatement("select sum(debit-credit) from ac_debtors WHERE date = '" + listofAct[i] + "' AND (payee NOT ILIKE 'NHIF%' OR payee NOT ILIKE 'N H I F%' OR payee NOT ILIKE 'N.H.I.F%')");
                                ...
                                java.sql.PreparedStatement psetc = connectDB.prepareStatement("select sum(credit-debit) from ac_debtors WHERE date = '" + listofAct[i] + "' AND transaction_type ILIKE 'Receipts' AND (payee NOT ILIKE 'nhif%' OR payee NOT ILIKE 'n.h.i.f%' OR payee  NOT ILIKE 'n h i%')");
                                ...
                                TnDebtors = TnDebtors + currentDRTotal;
                                Cashs = Cashs + currentDRTotal;
                                ...
                                table.getDefaultCell().setColspan(3);
                                table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_CENTER);
                                phrase = new Phrase("Total Amount Waived".toUpperCase(), pFontHeader1);
                                table.addCell(phrase);
