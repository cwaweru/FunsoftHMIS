...
public class CreditorsInvoicesSummPdf implements java.lang.Runnable {
    ...
    public void CreditorsInvoicesSummPdf(java.sql.Connection connDb,java.util.Date begindate, java.util.Date endate ) {
            ...
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        int headerwidths[] = {5,10,15,20,10,15,15,15};
                        ...
                        try {
                            ...
                            phrase = new Phrase("Creditors Invoices List Summary:     Period : From "  +dateFormat.format(endDate11)+" To "+dateFormat.format(endDate1), pFontHeader);
                     ...
                     //   table.addCell(phrase);
                      ...
                      //  table.addCell(phrase);
                        ...
                        try {
                            ...
                            java.sql.ResultSet rset = st.executeQuery("select dealer,sum(credit),sum(debit),sum(credit-debit) from ac_accounts_payable WHERE date BETWEEN '"+beginDate+"' AND '"+endDate+"' and (transaction_type ILIKE 'Stock%' OR transaction_type ILIKE 'Raise Invoice' OR transaction_type ILIKE 'INV') GROUP BY dealer ORDER BY dealer");
                            java.sql.ResultSet rsetTotals = st2.executeQuery("SELECT SUM(credit),sum(debit),sum(credit-debit) from ac_accounts_payable WHERE date BETWEEN '"+beginDate+"' AND '"+endDate+"' and (transaction_type ILIKE 'Stock%' OR transaction_type ILIKE 'Raise Invoice' OR transaction_type ILIKE 'INV')");
