            ...
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        int headerwidths[] = {10,10,25,30,10,15};
                        ...
                        try {
                            ...
                            java.sql.ResultSet rset = st.executeQuery("SELECT DISTINCT date,voucher_no,initcap(dealer),initcap(description),cheque_no,credit from ac_cash_book WHERE date BETWEEN '"+beginDate+"' AND '"+endDate+"' AND (transaction_type ilike 'Payment%' OR transaction_type ilike 'Char%') ORDER BY cheque_no,date");
                            
                            java.sql.ResultSet rsetTotals = st2.executeQuery("SELECT SUM(credit) from ac_cash_book WHERE date BETWEEN '"+beginDate+"' AND '"+endDate+"'  AND (transaction_type ilike 'Payment%' OR transaction_type ilike 'Char%')");
