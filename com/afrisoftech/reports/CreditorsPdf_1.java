...
public class CreditorsPdf_1 implements java.lang.Runnable {
    double Credit = 0.00;
    ...
    public void CreditorsPdf_1(java.sql.Connection connDb,java.util.Date begindate,java.util.Date endate, java.lang.String bType) {
        balType = bType;
        connectDB = connDb;
        beginDate = begindate;
        endDate = endate;
                        ...
                        try {
                            ...
                            for (int i = 0; i < listofAct.length; i++) {
                                ...
                                if (name > 0){
                                    ...
                                    java.sql.PreparedStatement pset1 = connectDB.prepareStatement("select sum(balance) from ac_accounts_payable WHERE dealer = ?  AND date <= '"+ageingDates[0][0]+"'");//< '"+endDate+"'::date and date > '"+endDate+"'::date - 30 group by dealer");
                                    ...
                                    for (int t = ageingDates.length - 1; t >= 0; t--) {
                                        ...
                                        java.sql.PreparedStatement pset = connectDB.prepareStatement("select sum(balance) from ac_accounts_payable WHERE dealer = ? AND date between '"+ageingDates[t][0]+"' AND '"+ageingDates[t][1]+"'");//< '"+endDate+"'::date and date > '"+endDate+"'::date - 30 group by dealer");
    ...
    public java.lang.Object[] getListofActivities() {
        ...
        try {
            ...
            if(balType.equalsIgnoreCase("both")){
                ...
                java.sql.PreparedStatement pSet1 = connectDB.prepareStatement("SELECT DISTINCT dealer FROM ac_accounts_payable order by dealer");
                ...
                if(balType.equalsIgnoreCase("neg")){
                    java.sql.Statement stmt1 = connectDB.createStatement();
                    java.sql.PreparedStatement pSet1 = connectDB.prepareStatement("SELECT DISTINCT dealer FROM creditors_account where dealer IS NOT NULL AND bal < 0 order by dealer");
