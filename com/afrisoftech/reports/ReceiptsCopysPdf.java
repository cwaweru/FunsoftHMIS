...
public class ReceiptsCopysPdf implements java.lang.Runnable {
    ...
    public void ReceiptsCopysPdf(java.sql.Connection connDb, java.lang.String combox) {
                ...
                try {
                    ...
                    try {
                        ...
                        try {
                            ...
                            java.sql.ResultSet rset1 = st1.executeQuery("SELECT DISTINCT cb.dealer,cb.account_no from ac_cash_collection cb where cb.receipt_no = '"+MNo+"' AND cb.transaction_type = 'Receipts'");
                            ...
                            java.sql.ResultSet rset51 = st51.executeQuery("select description,sum(debit-credit) from ac_cash_collection where receipt_no = '"+MNo+"' AND transaction_type = 'Receipts' group by account_no,description ORDER BY SUM(debit) DESC");
