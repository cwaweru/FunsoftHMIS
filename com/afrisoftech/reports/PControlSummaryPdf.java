...
public class PControlSummaryPdf implements java.lang.Runnable {
    ...
    public void PControlSummaryPdf(java.sql.Connection connDb,java.util.Date begindate, java.util.Date endate) {
            ...
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        int headerwidths[] = {5,2,15,25,15,15,15};
                        ...
                        try {
                            ...
                            phrase = new Phrase("PATIENT CONTROL ACCOUNT AS AT : " +dateFormat.format(endDate11), com.lowagie.text.FontFactory.getFont(FontFactory.HELVETICA_BOLD,10));
                        ...
                        try {
                            ...
                            java.sql.ResultSet rsetTotals = st21.executeQuery("SELECT sum(debit-credit) from patient_control_accdet where date <= '"+endDate+"'");
                            ...
                            java.sql.ResultSet rset1 = st2.executeQuery("SELECT '',patient_no,name,name,sum(debit) as debit,sum(credit) as credit, sum(balance) as balance from patient_control_accdet WHERE date <= '"+endDate+"' GROUP BY patient_no,name HAVING sum(balance) <> 0");
