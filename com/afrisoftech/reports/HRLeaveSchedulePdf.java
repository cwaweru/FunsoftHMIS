...
public class HRLeaveSchedulePdf implements java.lang.Runnable {
    ...
    public void generatePdf(java.util.Date tarehedb, String tarehe, String division, String department, String section, java.sql.Connection connDb) {
        ...
        try {
            ...
            try {
                ...
                "LEAVE SCHEDULE                                                                    Printed On: "+date+"                                         "
                ...
                try {
                    ...
                    float headerwidths[]= new float[13];
                    
                    headerwidths[0]=13;
                    
                    float restWidth=85/(13-1);
                    
                    for(int headerCounter=1; headerCounter<13;headerCounter++){
                    ...
                    table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                    table.getDefaultCell().setBackgroundColor(java.awt.Color.WHITE);                        
                    phrase = new Phrase("LEAVE SCHEDULE", pFontHeader);
                    table2.addCell(phrase);
                    ...
                    phrase = new Phrase("DIVISION - "+division+"  DEPARTMENT - "+department+"  SECTION - "+section+" "
                            + "\nLeave Schedule for the Whole Year ", pFontHeader);
                    table.addCell(phrase);                    
                    ...
                    for(int fillHeaders=1;fillHeaders<13;fillHeaders++){
                    ...
                    try{
                        ...
                        java.sql.ResultSet rset = st2.executeQuery("SELECT initcap(first_name) || ' '|| initcap(middle_name) || ' '|| initcap(last_name) AS employee_name, "
                            + "employee_no FROM master_file WHERE division = '"+division+"' "
                        ...
                        while (rset.next()) {
                            ...
                            do{
                                String sql2 = "SELECT leave, staffid FROM hr.hr_leave_assignment WHERE staffid = '"+rset.getString("employee_no")+"' "
                                        + "AND leave_month = '"+i+"' ";
                                ...
                                if (rs2.getRow() > 0){
                                    ...
                                    rs2.beforeFirst();
                                    rs2.next();
                                    phrase = new Phrase(rs2.getString("leave"), pFontHeader2);
                                    table.addCell(phrase);
                                    
                                    System.out.println("Division - '"+division+"'  , Department - '"+department+"' , Section - '"+section+"' ----------- "
                                    + "Staff ID - "+rs2.getString("staffid")+" --- Duties - '"+rs2.getString("leave")+"'");
                                } else{
                        ...
                        try {
                                ...
                                java.sql.ResultSet rse = stm.executeQuery("SELECT leave_code, leave_type FROM hr.hr_leave_type "
                                        + "WHERE leave_code BETWEEN '001' AND '006' ORDER BY leave_code");
                                
                                
                                    java.sql.Statement stmA = connectDB.createStatement();
                                    java.sql.ResultSet rseA = stmA.executeQuery("SELECT leave_code, leave_type FROM hr.hr_leave_type "
                                            + "WHERE leave_code BETWEEN '006' AND '012' ORDER BY leave_code");
                                ...
                                table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_RIGHT);
                                phrase = new Phrase("Leave Code ",pFontHeader5);
                                table.addCell(phrase);
                                ...
                                while (rse.next()) {
                                    ...
                                    phrase = new Phrase(rse.getObject(1).toString()+" - " ,pFontHeader5);
                                    table.addCell(phrase);
                                    
                                    table.getDefaultCell().setColspan(4);
                                    phrase = new Phrase( rse.getObject(2).toString(),pFontHeader5);
                                    table.addCell(phrase);
                                    ...
                                    while (rseA.next()) {
                                        ...
                                        table.getDefaultCell().setColspan(2);
                                        phrase = new Phrase(rseA.getObject(1).toString()+" - " ,pFontHeader5);
                                        table.addCell(phrase);

                                        table.getDefaultCell().setColspan(4);
                                        phrase = new Phrase( rseA.getObject(2).toString(),pFontHeader5);
                                        table.addCell(phrase);                                       
