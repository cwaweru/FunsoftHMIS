            ...
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        int headerwidths[] = {10, 15, 15, 15, 10, 40, 15, 15, 15, 10};
                        ...
                        try {
                            ...
                            while (rset1.next()) {
                                ...
                                table.addCell(phrase);
                                phrase = new Phrase(dbObject.getDBObject(rset1.getObject(9), "-").toUpperCase(), pFontHeader);
