            ...
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        phrase = new Phrase("PETTY CASH SHIFT REPORT", pFontHeader);
                        ...
                        try {
                            ...
                            phrase = new Phrase("Voucher Amt.", pFontHeader);
                            table.addCell(phrase);
                            ...
                            java.sql.ResultSet rset = st.executeQuery("select voucher_no,date,payee,description,sum(debit),sum(credit),sum(credit-debit),transaction_no from ac_petty_cash where shift_no = '"+memNo+"' AND cash_point = '"+CashPoint+"'  group by voucher_no,date,payee,description,transaction_no ORDER BY transaction_no");
