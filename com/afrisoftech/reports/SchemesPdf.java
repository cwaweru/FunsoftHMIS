                    ...
                    try {
                        ...
                        try {
                            ...
                            for (int k = 0; k < listofAct1.length; k++) {
                                java.sql.PreparedStatement st2 = connectDB.prepareStatement("SELECT scheme_name,account_no,scheme_limit,legal_status,tel_main,main_fax,address,email,building_name from ac_schemes where payer_name = ? order by scheme_name");
                                st2.setString(1, listofAct1[k].toString());
                                java.sql.ResultSet rset1 = st2.executeQuery();
