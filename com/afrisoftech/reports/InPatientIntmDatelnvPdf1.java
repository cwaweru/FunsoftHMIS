...
public class InPatientIntmDatelnvPdf1 implements java.lang.Runnable {
    ...
    public void InPatientIntmDatelnvPdf1(java.sql.Connection connDb, java.lang.String combox) {
        MNo = combox;
                ...
                try {
                    ...
                    try {
                        ...
                        try {
                            ...
                            java.sql.ResultSet rsetTotals = st2.executeQuery("select sum(debit - credit) from hp_patient_card where visit_id = '"+memNo+"' AND service != 'N.H.I.F' AND service not ilike 'Receipt' AND service not ilike 'Receipt Adj'  AND service not ilike 'Discou%' AND service != 'Invoice' and paid = 'true'");
                            
                            java.sql.ResultSet rset11 = st11.executeQuery(" select date::date,initcap(service) as service,dosage::int,CASE WHEN (service = 'Receipt') THEN requisition_no ELSE reference END AS reference,credit from hp_patient_card where visit_id = '"+memNo+"' AND (service = 'N.H.I.F' or service ilike 'Receipt' or service ilike 'Receipt Adj'  OR service ilike 'Discou%') order by date::date");// union select date::date,initcap(service) as service,dosage,reference,credit from hp_patient_card where patient_no = '"+memNo+"' and credit > 0 order by date");
                            ...
                            for (int k = 0; k < listofStaffNos1.length; k++) {
                                ...
                                table.addCell(phrase);
                                java.lang.Object listofStaffDesc[] = this.getListofStaffNosDesc(listofStaffNos1[k]);
                                for (int x = 0; x < listofStaffDesc.length; x++) {
                                    double gBalance = 0.00;
                                    table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                                    java.sql.ResultSet rset1 = st1.executeQuery(" select date::date,initcap(service) as service,dosage::int,reference,debit-credit from hp_patient_card where visit_id = '"+memNo+"' and service != 'N.H.I.F' AND service not ilike 'Receipt' AND service not ilike 'Receipt Adj' AND service not ilike 'Discou%' AND service != 'Invoice'  AND date::date = '"+listofStaffNos1[k]+"' AND main_service ilike '"+listofStaffDesc[x]+"' order by date::date");// union select date::date,initcap(service) as service,dosage,reference,credit from hp_patient_card where patient_no = '"+memNo+"' and credit > 0 order by date");
                                    table.getDefaultCell().setBorderColor(java.awt.Color.WHITE);
                                    table.getDefaultCell().setColspan(1);
                                    ...
                                    phrase = new Phrase(listofStaffDesc[x].toString(),pFontHeader1);
                                    ...
                                    while (rset1.next()){
                                        ...
                                        table.addCell(phrase);
                                        gBalance = gBalance + rset1.getDouble(5);
                                    ...
                                    table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_RIGHT);
                                    table.getDefaultCell().setColspan(1);
                                    phrase = new Phrase(new com.afrisoftech.sys.Format2Currency().Format2Currency(java.lang.String.valueOf(gBalance)), pFontHeader11);
                              ...
                              //  table.getDefaultCell().setBorder(Rectangle.BOTTOM | Rectangle.TOP);
                                phrase = new Phrase("Daily Total",pFontHeader11);
...
docPdf.close();  com.afrisoftech.lib.PDFRenderer.renderPDF(tempFile);
    ...
    public java.lang.Object[] getListofStaffNos1() {
        ...
        try {
            ...
            java.sql.PreparedStatement pSet1 = connectDB.prepareStatement("SELECT distinct date::date as date FROM hp_patient_card WHERE visit_id = '"+MNo+"' and debit > 0 order by date");
    ...
    public java.lang.Object[] getListofStaffNosDesc(java.lang.Object dates) {
        
        java.lang.Object[] listofStaffNosdesc = null;
        
        java.util.Vector listStaffNoVectordesc = new java.util.Vector(1,1);
        
        
        try {
            
            
            java.sql.PreparedStatement pSet1 = connectDB.prepareStatement("SELECT distinct initcap(main_service) as main_service FROM hp_patient_card WHERE visit_id = '"+MNo+"' and debit > 0 AND date::date = '"+dates+"' order by main_service");
            //  pSet1.setString(1,beginDate.toString());
            //  pSet1.setString(2,endDate.toString());
            java.sql.ResultSet rSet1 = pSet1.executeQuery();
            ...
            while (rSet1.next()) {
                ...
                listStaffNoVectordesc.addElement(rSet1.getObject(1).toString());
        ...
        listofStaffNosdesc = listStaffNoVectordesc.toArray();
        System.out.println("Done list of Staff Nos ...");
        return listofStaffNosdesc;
    }
