...
public class ProfitlTdPdf implements java.lang.Runnable {
    ...
    public void ProfitlTdPdf(java.sql.Connection connDb,java.util.Date begindate, java.util.Date endate) {
                ...
                try {
                    ...
                    try {
                        ...
                        try {
                            ...
                            phrase = new Phrase("INCOME STATEMENT SUMMARY : As At : " +dateFormat.format(endDate1), pFontHeader);
                        ...
                        try {
                            ...
                            java.sql.ResultSet rset = st.executeQuery("select sum(ac.credit-ac.debit) from tb_itemized_summary ac,pb_activity pb where pb.code = ac.gl_code and pb.category_class ilike 'pli%' and ac.date BETWEEN '"+beginDate+"' AND '"+endDate+"'");
                            
                            java.sql.ResultSet rsetx = st7.executeQuery("select sum(ac.debit-ac.credit) from tb_itemized_summary ac,pb_activity pb where pb.code = ac.gl_code and pb.category_class ilike 'pled' and ac.date BETWEEN '"+beginDate+"' AND '"+endDate+"'");
                            ...
                            while (rset.next()) {
                                ...
                                phrase = new Phrase("Sales", pFontHeader2);
                                ...
                                phrase = new Phrase(new com.afrisoftech.sys.Format2Currency().Format2Currency(rset.getString(1)), pFontHeader);
                                
                                table.addCell(phrase);
                                
                                amount = amount + rset.getDouble(1);
                            ...
                            while (rsetx.next()) {
                                table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                                phrase = new Phrase("Less Cost of Sales", pFontHeader2);
                            ...
                            table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_RIGHT);
                            //profit = amount;
                            phrase = new Phrase(new com.afrisoftech.sys.Format2Currency().Format2Currency(java.lang.String.valueOf(amount-cos)), pFontHeader1);
                            gross = amount-cos;
                            ...
                            for (int k = 0; k < listofAct1x.length; k++){
                                ...
                                java.sql.ResultSet rset2 = st2.executeQuery("select sum(ac.debit-ac.credit) from tb_itemized_summary ac WHERE ac.gl_code ilike '"+listofAct1x[k]+"%' AND ac.date BETWEEN '"+beginDate+"' AND '"+endDate+"'");
                                while (rset2a.next()) {
                                    while (rset2.next()) {
                                        table.getDefaultCell().setColspan(1);
                                        ...
                                        phrase = new Phrase(rset2a.getObject(1).toString(), pFontHeader);
                                        ...
                                        table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                                        phrase = new Phrase(rset2a.getObject(2).toString(), pFontHeader);
                                        ...
                                        Expenses = Expenses + rset2.getDouble(1);
                            ...
                            table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_RIGHT);
                            // profit = amount;
                            phrase = new Phrase(new com.afrisoftech.sys.Format2Currency().Format2Currency(java.lang.String.valueOf(gross-Expenses)), pFontHeader1);
