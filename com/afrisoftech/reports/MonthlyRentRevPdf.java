...
public class MonthlyRentRevPdf implements java.lang.Runnable {
    double Credit = 0.00;
    ...
    public void MonthlyRentRevPdf(java.sql.Connection connDb,java.util.Date begindate,java.util.Date endate) {
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    com.lowagie.text.HeaderFooter footer = new com.lowagie.text.HeaderFooter(new Phrase("Report  Page: ",pFontHeader), true);// FontFactory.getFont(com.lowagie.text.FontFactory.HELVETICA, 12, Font.BOLDITALIC,java.awt.Color.blue));
                    ...
                    try {
                        ...
                        try {
                            ...
                            phrase = new Phrase("Monthly Rent Revenue as at " +dateFormat.format(endDate2), pFontHeader5);
        ...
        public java.lang.Object[] getListofActivities() {
            ...
            try {
               ...
               // java.sql.PreparedStatement pSet1 = connectDB.prepareStatement("SELECT DISTINCT code,activity FROM pb_activity where (activity_category ilike 'I%') order by code");
                java.sql.PreparedStatement pSet1 = connectDB.prepareStatement("SELECT DISTINCT code,activity FROM pb_activity where (code ilike '620%' or code ilike '%61021') order by code");
