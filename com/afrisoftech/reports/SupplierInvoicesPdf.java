                ...
                try {
                    ...
                    try {
                        ...
                        try {
                            ...
                            java.sql.ResultSet rset = st.executeQuery("select invoice_no,date,dealer,sum(credit),sum(debit) from ac_accounts_payable WHERE date BETWEEN '"+beginDate+"' AND '"+endDate+"' and (transaction_type ILIKE 'Stock%' or transaction_type ilike 'inv%') GROUP BY invoice_no,date,dealer ORDER BY date");
