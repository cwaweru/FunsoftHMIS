...
public class FarewellGatePassPdf implements java.lang.Runnable {
...
//    ////java.awt.Desktop deskTop = Desktop.getDesktop();
    ...
    public void FarewellGatePassPdf(java.sql.Connection connDb, java.lang.String combox, String invNo) {
                ...
                try {
                    ...
                    try {
                        ...
                        try {
                            ...
                            java.sql.ResultSet rs = st.executeQuery("select patient_no,diceased_name,permit_number,date_collected,'', date_part('hour', release_time::time) ||':' || date_part('min', release_time::time) ||':'||round(date_part('sec', release_time::time)),admission_date,user_name,collector||' ID No.: '||id_no, release_serial_no from hp_body_collector cb where invoice_no = '" + invoiceNo + "'");
                            ...
                            table.getDefaultCell().setColspan(6);
                            phrase = new Phrase("BODY RELEASE FORM", pFontHeader1);
                          ...
                          //  }
                            ...
                            while (rs.next()) {
                                table.getDefaultCell().setColspan(2);
                                table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                                phrase = new Phrase("Serial No : ".toUpperCase() + rs.getInt(10), pFontHeader2);

                                table.addCell(phrase);
                                table.getDefaultCell().setColspan(2);
                                phrase = new Phrase("Printed by : ".toUpperCase() + com.afrisoftech.lib.UserName.getUserName(connectDB).toUpperCase(), pFontHeader2);
                                ...
                                table.getDefaultCell().setColspan(2);
                                phrase = new Phrase("Body No : ".toUpperCase() + patNo.toUpperCase(), pFontHeader);

                                table.addCell(phrase);
                                table.getDefaultCell().setColspan(2);
                                phrase = new Phrase("Deceased Name : ".toUpperCase() + rs.getObject(2).toString().toUpperCase(), pFontHeader);
...
//                                }
                                ...
                                phrase = new Phrase("Body Registration Date : ".toUpperCase() + rs.getString(7).toUpperCase(), pFontHeader);

                                table.addCell(phrase);

                                table.getDefaultCell().setColspan(2);
                                phrase = new Phrase("Release Date : ".toUpperCase() + rs.getObject(4).toString().toUpperCase(), pFontHeader);

                                table.addCell(phrase);
                                table.getDefaultCell().setColspan(4);
                                phrase = new Phrase("Person Collecting Body : ".toUpperCase() + rs.getObject(9).toString().toUpperCase(), pFontHeader);
                            ...
                            table.addCell(phrase);
                            table.getDefaultCell().setColspan(2);
                            phrase = new Phrase("Farewell Home Clearance : _______________________".toUpperCase(), pFontHeader);
                            table.addCell(phrase);
                            ...
                            phrase = new Phrase(" ", pFontHeader);
                            table.addCell(phrase);
                            phrase = new Phrase("NB This form should be filled in duplicate, one copy to be retained in the ward and the other one be left at the Main Gate. PLEASE NOTE THAT CHECK-OUT DATE MUST BE THE DATE THE BODY LEAVES THE HOSPITAL", pFontHeader11);
