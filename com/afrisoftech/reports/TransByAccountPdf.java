...
public class TransByAccountPdf implements java.lang.Runnable {
    ...
    public void TransByAccountPdf(java.sql.Connection connDb, java.util.Date begindate, java.util.Date endate, java.lang.String combox, java.lang.String ptype) {
                        ...
                        try {
                            ...
                            if(paType.equalsIgnoreCase("OP")){
                                ...
                                while (rset.next()) {
                                    ...
                                    table.addCell(phrase);
                                    bal = bal + (rset.getDouble(6)-rset.getDouble(7));
                                ...
                                if(paType.equalsIgnoreCase("IP")){
                                    ...
                                    java.sql.ResultSet rset = st.executeQuery("select date,transaction_no,initcap(description) as description,transaction_type,invoice_no,sum(debit),sum(credit) from transaction_list_view WHERE date BETWEEN '"+beginDate+"' AND '"+endDate+"' AND activity_code = '"+bank+"' GROUP BY date,description,transaction_no,transaction_type,invoice_no ORDER BY date ASC");
                                    while (rset21.next()) {
