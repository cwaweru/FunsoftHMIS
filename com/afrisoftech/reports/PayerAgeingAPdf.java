                            ...
                            for (int i = 0; i < listofAct.length; i++) {
                                ...
                                //for (int t = 0; t < rangeDates.length; t++) {
                                  for (int t = rangeDates.length - 1; t >= 0; t--) {  
                                    ...
                                    java.sql.PreparedStatement pset = connectDB.prepareStatement("select sum(balance) from ac_debtors WHERE account_no = ? and dealer = '"+Debtor+"' AND date between '"+rangeDates[t][0]+"' AND '"+rangeDates[t][1]+"'");//< '"+endDate+"'::date and date > '"+endDate+"'::date - 30 group by dealer");
