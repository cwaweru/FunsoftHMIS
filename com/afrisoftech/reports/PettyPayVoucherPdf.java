            ...
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        int headerwidths[] = {15,40,15,10,10,10};
                        ...
                        try {
                            ...
                            java.sql.ResultSet rset1 = st1.executeQuery("select DISTINCT payee,description from ac_petty_cash where voucher_no = '"+MNo+"'");
                            ...
                            java.sql.ResultSet rset6 = st6.executeQuery("select status,credit-debit,code from ac_petty_cash where voucher_no ='"+MNo+"'");
