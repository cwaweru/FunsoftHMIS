...
public class DetailedDiagPerPatDatePdf implements java.lang.Runnable {
    ...
    public void DetailedDiagPerPatDatePdf(java.sql.Connection connDb, java.util.Date begindate, java.util.Date endate, java.lang.String cashPoint,java.lang.String names) {
                ...
                try {
                    ...
                    try {
                        ...
                        try {
                            ...
                            phrase = new Phrase("PATIENT CARD  [ DIAGNOSIS ]  - Period : "  +dateFormat.format(endDate11)+" - "+dateFormat.format(endDate1), pFontHeader);
   ...
   /* public java.lang.Object[] getDates() {
    ...
    public java.lang.Object[] getListofActivities() {
        ...
        try {
            ...
            java.sql.ResultSet rSet1 = stmt1.executeQuery("SELECT DISTINCT ph.date FROM doctors_notes ph where date BETWEEN '"+beginDate+"' AND '"+endDate+"'  AND ph.patient_no ilike '"+CashPoint+"' ORDER BY ph.date");
