...
public class NutritionAdultPatientRegimeFormPdf implements java.lang.Runnable {
            ...
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        String time = "Unknown", feed = "Unknown", amount = "Unknown", t_prot = "Unknown", t_cho = "Unknown", t_fats = "Unknown", t_cal = "Unknown";
                        ...
                        try {
                            ...
                            java.sql.ResultSet rse2 = stm2.executeQuery(
                                    "SELECT time, feed, amount, t_prot, t_cho, t_fats, t_cal FROM nutrition.nutr_patient_feeding_regime "
                                    + "WHERE patient_no='" + patientNumber + "' "
                                    + "AND date = '" + date + "'");
