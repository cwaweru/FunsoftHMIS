...
public class ShiftsCombinedTotalPdf implements java.lang.Runnable {
    ...
    public void ShiftsCombinedTotalPdf(java.sql.Connection connDb,java.util.Date begindate,java.util.Date endate) {
    ...
    public void generatePdf() {
      ...
      */
                    ...
                    try {
                        ...
                        int headerwidths[] = {6,12,15,30,15,10,15,10,18};
                    ...
                    try {
                        ...
                        int headerwidths[] = {6,8,10,10,14,14,14,15,15};
    ...
    public java.lang.Object[] getListofStaffNos() {
        ...
        try {
            ...
            java.sql.ResultSet rSet1 = stmt1.executeQuery("SELECT DISTINCT shift_no,start_date::date FROM ac_shifts WHERE start_date::date between '"+beginDate+"'::date and  '"+endDate+"' Order by start_date::date ASC");
