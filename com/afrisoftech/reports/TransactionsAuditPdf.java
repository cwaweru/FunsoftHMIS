...
public class TransactionsAuditPdf implements java.lang.Runnable {
    ...
    public void TransactionsAuditPdf(java.sql.Connection connDb,java.util.Date begindate, java.util.Date endate) {
            ...
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        int headerwidths[] = {20,1,20,20,20};
                        ...
                        try {
                            ...
                            phrase = new Phrase("Transactions Audit Per Day:     Period : From "  +dateFormat.format(endDate11)+" To "+dateFormat.format(endDate1), pFontHeader);
                      ...
                      //  table.addCell(phrase);
                        ...
                        try {
                           ...
                           java.sql.ResultSet rset = st.executeQuery("SELECT date,SUM(debit) as debit,SUM(credit) as credit,sum(debit-credit) as balance from tb_itemized_summary WHERE date BETWEEN '"+beginDate+"' AND '"+endDate+"' GROUP BY date ORDER BY date ASC");
