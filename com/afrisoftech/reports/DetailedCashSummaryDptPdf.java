...
public class DetailedCashSummaryDptPdf implements java.lang.Runnable {

    java.lang.String memNo = null;
    java.lang.String UserName = null;
    java.lang.String CashPoint = null;
    java.lang.String Gl_Code = null;
    String ks;
    ...
    public void DetailedCashSummaryDptPdf(java.sql.Connection connDb, java.util.Date begindate, java.util.Date endate, java.lang.String glcode) {
                ...
                try {
                    ...
                    try {
                        ...
                        try {
                            ...
                            phrase = new Phrase("DEPARTMENTAL WORKLOAD AGAINST DAILY COLLECTIONS REPORT BY CATEGORY  - Period : " + dateFormat.format(endDate11) + " - " + dateFormat.format(endDate1), pFontHeader);
                        ...
                        try {
                            ...
                            for (int i = 0; i < listofAct.length; i++) {
                                ...
                                while (rset1.next()) {
                                    ...
                                    java.sql.ResultSet rset = st5.executeQuery("select initcap(description),sum(quantity)::numeric(10,0),sum(debit-credit) from ac_cash_collection where date BETWEEN '" + beginDate + "' AND '" + endDate + "' and activity_code = '" + listofAct[i].toString() + "' AND transaction_type not ilike 'Bank%' group by description order by description");
...
docPdf.close();  com.afrisoftech.lib.PDFRenderer.renderPDF(tempFile);
    ...
    public java.lang.Object[] getListofActivities() {
        ...
        try {
            ...
            java.sql.ResultSet rSet1 = stmt1.executeQuery("SELECT DISTINCT activity_code FROM ac_cash_collection where date BETWEEN '" + beginDate + "' AND '" + endDate + "' AND transaction_type not ilike 'Bank%' AND activity_code = '"+Gl_Code+"' ORDER BY activity_code");
