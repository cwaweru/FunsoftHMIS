...
public class LeaveBalanceDepSecReportPdf implements java.lang.Runnable {
...
docPdf.close();  com.afrisoftech.lib.PDFRenderer.renderPDF(tempFile);
    ...
    public void getNoAndName() {
        ...
        try {
                ...
                java.sql.ResultSet rse = stm.executeQuery("SELECT DISTINCT employee_no, first_name, middle_name, last_name, employee_grade, "
                        + "leave_date FROM master_file WHERE department = '"+depart+"' AND section = '"+sec+"' "
    ...
    public void addTableItems(com.lowagie.text.pdf.PdfPTable table, java.lang.String number, java.lang.String name, java.lang.String jobG
        ...
        String ent_leave = " -- ", leaveDays = " ", division = " -- ";
        ...
        try {
            ...
            java.sql.ResultSet rsetTwo = stTwo.executeQuery("SELECT division FROM master_file WHERE employee_no = '"+number+"'");

            while(rsetTwo.next()) {
                division = dbObject.getDBObject(rsetTwo.getObject(1), " -- ");
            }
