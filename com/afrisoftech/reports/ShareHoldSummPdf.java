...
public class ShareHoldSummPdf implements java.lang.Runnable {
 ...
 java.util.Date beginDate = null;
    ...
    public void ShareHoldSummPdf(java.sql.Connection connDb,java.util.Date begindate,java.util.Date endate) {
    ...
    public void generatePdf() {
      ...
      */
                    ...
                    com.lowagie.text.HeaderFooter footer = new com.lowagie.text.HeaderFooter(new Phrase("Shareholders Summary Report  - Page: ",pFontHeader), true);// FontFactory.getFont(com.lowagie.text.FontFactory.HELVETICA, 12, Font.BOLDITALIC,java.awt.Color.blue));
                    ...
                    try {
                        ...
                        Phrase phrase = new Phrase("", pFontHeader);
                         table.getDefaultCell().setColspan(7);
                            ...
                            phrase = new Phrase("Share Holders Shares Report", pFontHeader);
                            table.addCell(phrase);
                       ...
                       //  java.util.Date endDate1 = dateFormat.parse(endDate.toLocaleString());//dateInstance.toLocaleString());
                        java.util.Date endDate11 = dateFormat.parse(endDate.toLocaleString());//dateInstance.toLocaleString());
                        //
                        //System.out.println(""+endDate1);
                         phrase = new Phrase("As At : " +endDate11, pFontHeader);
                     ...
                     phrase = new Phrase("No.",pFontHeader);
                        ...
                        phrase = new Phrase("No of Shares", pFontHeader);
                        
                        table.addCell(phrase);
                        
                        phrase = new Phrase("Holding %", pFontHeader);
                       ...
                       // table.getDefaultCell().setBorderColor(java.awt.Color.WHITE);
                        ...
                        try {
                          ...
                          // for (int i = 0; i < listofAct.length; i++) {
                                ...
                                java.sql.ResultSet rset1 = st.executeQuery("select initcap(dealer),account_no,sum(credit-debit ) as amt from  ac_shares_ledger  where transaction_type ilike 'Sh%' and date <= '"+endDate+"' group by dealer,account_no order by amt desc");// tn,debit_note db WHERE tn.policy_no != '' and tn.policy_no = db.policy_no GROUP BY tn.policy_no,db.policy_class");
                             java.sql.ResultSet rset11 = st2.executeQuery("select sum(credit-debit ) as amt from  ac_shares_ledger  where transaction_type ilike 'Sh%' and date <= '"+endDate+"'");// tn,debit_note db WHERE tn.policy_no != '' and tn.policy_no = db.policy_no GROUP BY tn.policy_no,db.policy_class");
