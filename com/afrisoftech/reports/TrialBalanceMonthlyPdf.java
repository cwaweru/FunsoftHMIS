...
public class TrialBalanceMonthlyPdf implements java.lang.Runnable {
    ...
    public void TrialBalanceMonthlyPdf(java.sql.Connection connDb,java.util.Date begindate, java.util.Date endate) {
                    ...
                    try {
                        ...
                        try {
                           ...
                           /* java.sql.Statement st2x = connectDB.createStatement();
                            ...
                            java.sql.ResultSet rset = st.executeQuery("SELECT tb.gl_code,sum(debit-tb.credit) from tb_itemized_summary tb WHERE tb.date BETWEEN  '"+beginDate+"' AND '"+endDate+"' group by tb.gl_code order by tb.gl_code");
