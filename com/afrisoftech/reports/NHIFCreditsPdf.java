...
public class NHIFCreditsPdf implements java.lang.Runnable {
            ...
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        int headerwidths[] = {8,10,10,25,17,13,7,15,10,10};
                        ...
                        table.addCell(phrase);
                        //  table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_RIGHT);
                        phrase = new Phrase("Amount Claimed "+ks,pFontHeader);
                        table.addCell(phrase);
                        ...
                        try {
                            ...
                            for (int i = 0; i < listofAct.length; i++) {
                                ...
                                for (int k = 0; k < listofAct1.length; k++) {
                                    ...
                                    java.sql.ResultSet rset = st.executeQuery("select dt.invoice_no,'',initcap(dt.item),dt.journal_no,pc.invoice_no,dt.debit,'' from ac_debtors dt,hp_patient_card pc WHERE dt.date BETWEEN '"+beginDate+"' AND '"+endDate+"' and dt.payee = 'N H I F' and dt.admission_no ='"+listofAct[i]+"' and dt.admission_no = pc.patient_no and pc.reference = dt.invoice_no and pc.visit_id =  '"+listofAct1[k]+"' order by dt.invoice_no");
                                    
                                    java.sql.Statement st1 = connectDB.createStatement();
                                    java.sql.ResultSet rset1 = st1.executeQuery("select discharge_date::date-date_admitted::date,bed_no  FROM hp_admission WHERE admission_no ='"+listofAct[i]+"' and visit_id = '"+listofAct1[k]+"'");
    ...
    public java.lang.Object[] getListofStaffNos1(java.lang.Object patNo) {
        ...
        try {
            ...
            java.sql.ResultSet rSet1 = stmt1.executeQuery("SELECT DISTINCT visit_id FROM hp_admission WHERE  date_admitted BETWEEN '"+beginDate+"' AND '"+endDate+"' and patient_no = '"+patNo+"' ORDER BY visit_id");
