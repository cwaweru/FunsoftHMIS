            ...
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        int headerwidths[] = {12,10,21,25,12};
                        ...
                        try {
                            ...
                            java.sql.ResultSet rset1 = st2.executeQuery("SELECT date,invoice_no,initcap(payee),initcap(journal_no||' '|| item),sum(credit) from ac_debtors where date BETWEEN '"+beginDate+"' AND '"+endDate+"' and transaction_type ILIKE 'credit not%' and credit > 0 GROUP BY date,invoice_no,payee,journal_no||' '|| item order by date,invoice_no");
                            table.getDefaultCell().setColspan(1);
