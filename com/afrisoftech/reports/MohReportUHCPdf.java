...
public class MohReportUHCPdf implements java.lang.Runnable {
            ...
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        com.lowagie.text.pdf.PdfPTable table = new com.lowagie.text.pdf.PdfPTable(28);
                        ...
                        int headerwidths[] = {3, 15, 10, 10, 10,10,10,10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10};
                        ...
                        try {
                            ...
                            double Tuhcdebts = 0.00;
                            double Telderlydebt = 0.00;
                            ...
                            for (int i = 0; i < listofAct.length; i++) {
                               ...
                               /* java.sql.PreparedStatement pset11ag1 = connectDB.prepareStatement("select code from pb_activity WHERE activity_category ilike 'IEXE'");
                                ...
                                while (rsethnh.next()) {
                                    ...
                                    System.out.println("select sum(debit-credit) from ac_debtors WHERE date = '" + listofAct[i] + "'  AND  payee = 'UNIVERSAL HEALTH CARE'  AND debit > 0"
...
//                                            "and service not ilike '%Receipt%' and service not ilike '%invoice%') ) as foo ) ");
                                    ...
                                    while (rsetwn1d.next()) {
                                        table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_RIGHT);
                                        elderlydebts = rsetwn1d.getDouble(1);
                                        Telderlydebt = Telderlydebt + elderlydebts;

                                    }

                                    java.sql.PreparedStatement psetwn4 = connectDB.prepareStatement("select sum(debit-credit) from ac_debtors WHERE date = '" + listofAct[i] + "'  AND activity_code != '" + nhifs + "' AND  payee != 'UNIVERSAL HEALTH CARE'  AND payee != 'FREE ELDERLY H.S' AND debit > 0");
                ...
                //                java.sql.PreparedStatement psetwn = connectDB.prepareStatement("select sum(amount*-1) FROM moh_reporting WHERE receipt_time = '" + listofAct[i] + "'  AND receipt_source = 'IEDS'");
                                ...
                                java.sql.PreparedStatement psetjb = connectDB.prepareStatement("select sum(debit-credit) FROM ac_cash_collection ac,pb_activity WHERE ac.date = '" + listofAct[i] + "' AND transaction_type != 'Banking' and activity_code=code and uhc_tag   ilike 'UHC' AND "+ com.afrisoftech.lib.DBObject.addColumnCondition("receipt_no", "Numeric") +"  ");
                                java.sql.ResultSet rsetjb = psetjb.executeQuery();

                                while (rsetjb.next()) {
                                    uhcfee = uhcfee + rsetjb.getDouble(1);
                                }
                                Tuhcfee = Tuhcfee + uhcfee;
                                Cashs = Cashs + uhcfee;
                                ...
                                janu = Cashs + nhifdebts + othdebts + waiver + exedebts + absdebts+uhcdebts+elderlydebts;
                                ...
                                phrase = new Phrase(new com.afrisoftech.sys.Format2Currency().Format2Currency(dbObject.getDBObject(java.lang.String.valueOf(uhcfee), "0.00")), pFontHeader1);
                                table.addCell(phrase);
                                ...
                                phrase = new Phrase(new com.afrisoftech.sys.Format2Currency().Format2Currency(dbObject.getDBObject(java.lang.String.valueOf(elderlydebts), "0.00")), pFontHeader1);
                                table.addCell(phrase);
                                ...
                                java.sql.PreparedStatement psetwb = connectDB.prepareStatement("select (SELECT activity FROM  pb_activity WHERE code = activity_code),sum(amount) FROM moh_reporting WHERE receipt_time \n" +
                                " = '" + listofAct[i] + "'  AND (receipt_source = 'AOT' OR receipt_source = 'OTH') GROUP BY 1 having sum(amount) >0 order by 2 desc ");//(activity_code NOT LIKE '"+pha+"' OR activity_code NOT LIKE '"+opp+"' OR activity_code NOT LIKE '"+mot+"' OR activity_code NOT LIKE '"+the+"' OR activity_code NOT LIKE '"+xray+"' OR activity_code NOT LIKE '"+mot+"')");
...
//                                        
                            ...
                            phrase = new Phrase(new com.afrisoftech.sys.Format2Currency().Format2Currency(dbObject.getDBObject(java.lang.String.valueOf(Tuhcfee), "0.00")), pFontHeader1);
                                table.addCell(phrase);//uhc fee total
                            ...
                            phrase = new Phrase(new com.afrisoftech.sys.Format2Currency().Format2Currency(dbObject.getDBObject(java.lang.String.valueOf(Tuhcdebts), "0.00")), pFontHeader1);
                                table.addCell(phrase);//uhc total
                                
                                phrase = new Phrase(new com.afrisoftech.sys.Format2Currency().Format2Currency(dbObject.getDBObject(java.lang.String.valueOf(Telderlydebt), "0.00")), pFontHeader1);
                                table.addCell(phrase);//free elderly
