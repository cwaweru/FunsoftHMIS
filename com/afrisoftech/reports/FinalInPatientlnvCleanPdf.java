...
public class FinalInPatientlnvCleanPdf implements java.lang.Runnable {
    ...
    public void FinalInPatientlnvCleanPdf(java.sql.Connection connDb, java.lang.String combox) {
        MNo = combox;
            ...
            try {
                 ...
                 */
                    ...
                    try {
                        ...
                        int headerwidths[] = {10,30,10,10,13,15};
                    ...
                    try {
                        ...
                        int headerwidths[] = {12,25,10,11,13,15};
                        ...
                        try {
                            ...
                            java.sql.ResultSet rset1 = st1.executeQuery(" select date::date,initcap(service) as service,sum(dosage)::int,sum(debit-credit) from hp_patient_card where invoice_no = '"+memNo+"' and paid = 'true' and service != 'N.H.I.F' AND (service not ilike 'Receipt' and service not ilike 'Receipt Adj') AND service != 'Invoice' group by date::date,initcap(service) order by date");// union select date::date,initcap(service) as service,dosage,reference,credit from hp_patient_card where patient_no = '"+memNo+"' and credit > 0 order by date");
                            ...
                            java.sql.ResultSet rset11 = st11.executeQuery(" select date::date,initcap(service) as service,dosage::int,credit from hp_patient_card where invoice_no = '"+memNo+"' AND (service = 'N.H.I.F' or service ilike 'Receipt' or service ilike 'Receipt Adj') order by date::date");// union select date::date,initcap(service) as service,dosage,reference,credit from hp_patient_card where patient_no = '"+memNo+"' and credit > 0 order by date");
                           ...
                           // table.addCell(phrase);
                            ...
                            while (rset11.next()){
                                ...
                                osBalance1 = osBalance1 + rset11.getDouble(4);
