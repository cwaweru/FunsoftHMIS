...
public class TypeOfLeaveTakenDivDepSecReportPdf implements java.lang.Runnable {
    ...
    public void LeaveTakenDetailsPdf(java.sql.Connection connDb, java.util.Date begindate, java.util.Date endate, java.lang.String division, 
            java.lang.String department, java.lang.String section, java.lang.String typeOfLeave) {
            ...
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_CENTER);
                        Phrase phrase = new Phrase(TOL.toUpperCase()+" DAYS TAKEN REPORT BETWEEN "+sdf.format(beginDate)+" AND "+sdf.format(endDate)+"\nDIVISION - "+div.toUpperCase()+" "
                                + "DEPARTMENT - "+depart.toUpperCase()+" SECTION - "+sect.toUpperCase(), 
                                pFontHeader);
                        table.addCell(phrase); 
                        ...
                        try {
                            ...
                            java.sql.ResultSet rsetOne = stOne.executeQuery("SELECT employee_no FROM master_file "
                                    + "WHERE division = '"+div+"' AND department = '"+depart+"' AND section = '"+sect+"'");
                            ...
                            while(rsetOne.next()) {
                                ...
                                try {
                                    ...
                                    java.sql.ResultSet rset = st.executeQuery("SELECT DISTINCT emp_no, emp_name, job_group, "
                                            ...
                                            + "WHERE emp_no = '"+dbObject.getDBObject(rsetOne.getObject(1), "0000")+"' AND type_of_leave = '"+TOL+"' "
                                            + "AND date_approved BETWEEN '"+beginDate+"' AND '"+endDate+"' "
                                            + "GROUP BY emp_no, emp_name, job_group, "
                                            + "leave_days, applied_leave_days");
