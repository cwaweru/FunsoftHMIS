...
public class Department extends javax.swing.JFrame
{
   ...
   java.sql.Connection connectDB = null;
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        nBCachedRowSet1.setCommand("select * from fleet_schema.departments");
        nBCachedRowSet1.setConnectionSource(pConnDB);
        nBCachedRowSet1.setPassword("02bbe0eb0402c6927c34c05618fbce94bec5cae90583ac9276f68b2a7d23844b", true);
        try {
            nBCachedRowSet1.setTableName("fleet_schema.departments");
        } catch (java.sql.SQLException e1) {
            e1.printStackTrace();
        }
        try {
        ...
        jTable1.setModel(new org.netbeans.lib.sql.models.TableModel(nBCachedRowSet1, new org.netbeans.lib.sql.models.TableModel.Column[] {
            new org.netbeans.lib.sql.models.TableModel.Column("department_code", "Department code", true),
            new org.netbeans.lib.sql.models.TableModel.Column("department_name", "Department name", true)
        }));
