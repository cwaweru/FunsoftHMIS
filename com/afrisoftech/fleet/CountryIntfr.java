...
public class CountryIntfr extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
        subMainPanel.add(LablePanel, gridBagConstraints);
    ...
    private void newActionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_newActionActionPerformed
        try {
            java.sql.PreparedStatement pstmt = connectDB.prepareStatement("insert into fleet_schema.country values(?,?)");
            if(countryidTxt.getText().equals("")){
                ...
                pstmt.setString(1,countryidTxt.getText());
            }
            if(countrynameTxt.getText().equals("")){
                ...
                pstmt.setString(2,countrynameTxt.getText());
            }   pstmt.executeUpdate();
