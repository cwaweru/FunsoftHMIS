...
public class CasualLevelListPdf1 implements java.lang.Runnable {
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    int headerwidths[] = {8,17,50,13,12};
                    ...
                    phrase = new Phrase("Casual Jobs Available  " , pFontHeader3);
                    ...
                    phrase = new Phrase("Casual ID",pFontHeader1);
                    table.addCell(phrase);
                    ...
                    table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_CENTER);
                    phrase = new Phrase("Renewable",pFontHeader1);
                    table.addCell(phrase);
                    ...
                    try{
                        ...
                        java.sql.ResultSet rset = st2.executeQuery("Select hr.hr_casual_levels.casual_job_id,hr.hr_casual_levels.department,hr.hr_casual_levels.casual_designation_description as Description,hr.hr_casual_levels.renewable,hr.hr_casual_levels.maximum_tenure_period from hr.hr_casual_levels");
                        ...
                        while (rset.next()) {
                            ...
                            String renewable="unknown";
                            
                            if(dbObject.getDBObject(rset.getObject(4), "-")=="false"){
                            ...
                            phrase = new Phrase(renewable, pFontHeader);
