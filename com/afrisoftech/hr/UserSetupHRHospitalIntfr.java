 ...
 */
public class UserSetupHRHospitalIntfr extends javax.swing.JInternalFrame {

    java.sql.Connection connectDB = null;
    org.netbeans.lib.sql.pool.PooledConnectionSource pConnDB = null;

    public UserSetupHRHospitalIntfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {
        ...
        setMaximizable(true);
        setResizable(true);
        setTitle("User Access Control - HUMAN CAPITAL MANAGEMENT");
        ...
        jList4.setModel(com.afrisoftech.lib.ListModel.listModel(connectDB, "SELECT item_desc FROM menu_item_list WHERE app_name = 'hospital_hr' ORDER BY item_desc"));
        ...
        removeGroupCmbx1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                removeGroupCmbx1ActionPerformed(evt);
            }
        });
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        ...
        jList1.setModel(com.afrisoftech.lib.ListModel.listModel(connectDB, "SELECT item_desc FROM menu_item_list WHERE app_name = 'hospital_hr' ORDER BY item_desc"));
    ...
    private void removeGroupCmbx1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_removeGroupCmbx1ActionPerformed
        ...
        try {
            ...
            java.sql.ResultSet rs = stmt.executeQuery("select menu_list from secure_menu_access_group where login_name = '" + removeGroupCmbx1.getSelectedItem().toString() + "'  AND sys_name ilike 'hospital_hr' ORDER BY menu_list");
    ...
    }//GEN-LAST:event_removeGroupCmbx1ActionPerformed
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        ...
        try {
            ...
            java.sql.PreparedStatement pmstmt = connectDB.prepareStatement("UPDATE secure_menu_access_group SET menu_list = ? WHERE login_name = ? AND sys_name ilike 'hospital_hr'");

            pmstmt.setArray(1, arraySet);
            System.out.println("Array posted !!!");
            pmstmt.setObject(2, removeGroupCmbx1.getSelectedItem().toString());
            pmstmt.executeUpdate();

            java.sql.Statement pstmt1 = connectDB.createStatement();
            java.sql.PreparedStatement pmstmt1 = connectDB.prepareStatement("UPDATE secure_menu_access SET menu_list = ? WHERE group_name = ? AND sys_name ilike 'hospital_hr'");
            pmstmt1.setArray(1, arraySet);
            pmstmt1.setObject(2, removeGroupCmbx1.getSelectedItem().toString());
           ...
           // connectDB.setAutoCommit(true);
            ...
            javax.swing.JOptionPane.showMessageDialog(this, "Successfuly updated access privileges for group : [ " + this.removeGroupCmbx1.getSelectedItem().toString().toUpperCase() + " ]");
    ...
    private void registerNewGroupBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_registerNewGroupBtnActionPerformed
        ...
        if (this.newGroupNameTxt.getText().equals("")) {
            ...
            try {
                ...
                pstmt1.setObject(4, "");
                pstmt1.setObject(5, "");
                pstmt1.setObject(6, "hospital_hr");
                ...
                pstmt5.setObject(4, "");
                pstmt5.setObject(5, "");
                pstmt5.setObject(6, "hospital_hr");
...
// TODO add your handling code here:
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        try {
            ...
            java.sql.PreparedStatement pstmt = connectDB.prepareStatement("UPDATE secure_menu_access SET menu_list = (SELECT menu_list FROM secure_menu_access WHERE login_name = ? AND sys_name = 'hospital_hr') WHERE login_name = ? AND sys_name = 'hospital_hr'");


            pstmt.setString(1, jComboBox1.getSelectedItem().toString());

            pstmt.setString(2, jComboBox12.getSelectedItem().toString());

            pstmt.executeUpdate();

            javax.swing.JOptionPane.showMessageDialog(this, "Successfully updated the system access profile for user : [ " + jComboBox12.getSelectedItem().toString().toUpperCase() + " ]");
...
/*
    ...
    private void jComboBox1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBox1ActionPerformed
        ...
        try {
            ...
            java.sql.ResultSet rs = stmt.executeQuery("select menu_list from secure_menu_access where login_name = '" + jComboBox1.getSelectedItem().toString() + "'  AND sys_name ilike 'hospital_hr' ORDER BY menu_list");
...
//        str = "{"+str+"}";
        ...
        try {
            ...
            java.sql.Statement pstmt = connectDB.createStatement();
            java.sql.PreparedStatement pmstmt = connectDB.prepareStatement("UPDATE secure_menu_access SET menu_list = ? WHERE login_name = ? AND sys_name ilike 'hospital_hr'");
...
//            pmstmt.setObject(1,"{"+str+"}");
          ...
          //  connectDB.setAutoCommit(true);
            ...
            javax.swing.JOptionPane.showMessageDialog(this, "Successfuly updated access privileges for user : [ " + this.jComboBox1.getSelectedItem().toString().toUpperCase() + " ]");
        } catch (java.sql.SQLException sq) {
            sq.printStackTrace();
            javax.swing.JOptionPane.showMessageDialog(this, sq.getMessage(), "Error Message!", javax.swing.JOptionPane.ERROR_MESSAGE);
            try {
        ...
        if (this.jTextField582.getText().equals("")) {
            ...
            try {
               ...
               // connectDB.setAutoCommit(false);
                ...
                java.sql.ResultSet rs = stmt.executeQuery("SELECT menu_list from secure_menu_access_group WHERE login_name = '" + removeGroupCmbx2.getSelectedItem().toString() + "'  AND sys_name ilike 'hospital_hr' ORDER BY menu_list");
                ...
                java.sql.ResultSet rs2 = stmt2.executeQuery("SELECT menu_list from secure_menu_access_group WHERE login_name = '" + removeGroupCmbx2.getSelectedItem().toString() + "'  AND sys_name ilike 'hospital_hr' ORDER BY menu_list");
               ...
               // java.sql.PreparedStatement pstmt3 = connectDB.prepareStatement("GRANT SELECT ON secure_passwd TO " + jTextField582.getText());
                ...
                pstmt2.setObject(4, "hospital_hr");
    ...
    private void jButton3012ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3012ActionPerformed
        ...
        try {
            ...
            java.sql.ResultSet rs = stmt.executeQuery("SELECT menu_list from secure_menu_access_group WHERE login_name = '" + jComboBox5.getSelectedItem().toString() + "'  AND sys_name ilike 'hospital_hr' ORDER BY menu_list");
            ...
            java.sql.Statement pstmt = connectDB.createStatement();
            java.sql.PreparedStatement pmstmt = connectDB.prepareStatement("UPDATE secure_menu_access SET menu_list = ?, group_name = ?  WHERE login_name = ? AND sys_name ilike 'hospital_hr'");
