...
public class ProfessionalLicencesIntfr extends javax.swing.JInternalFrame {
    ...
    public ProfessionalLicencesIntfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
        ...
        initComponents();
         nBCachedRowSet1.setCommand("Select distinct(division_name) from hr.hr_divisions");
    ...
    private void initComponents() {
        ...
        qualificationCbx.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                qualificationCbxActionPerformed(evt);
            }
        });
        gridBagConstraints = new java.awt.GridBagConstraints();
    ...
    private void qualificationCbxActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_qualificationCbxActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_qualificationCbxActionPerformed

    private void jComboBox1ItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jComboBox1ItemStateChanged
        nBCachedRowSet11.setCommand("Select distinct(qualification_desc) from hr.hr_professional_qualification");
        nBCachedRowSet11.setConnectionSource(pConnDB);
