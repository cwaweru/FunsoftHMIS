 ...
 * @author  postgres
 */
public class JobGradeIntfr extends javax.swing.JInternalFrame {
    ...
    public JobGradeIntfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {
        ...
        idNoLbl.setText("Job Grade ID No: ");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 1;
        gridBagConstraints.weightx = 1.0;
        ...
        roleorresponsiblityLbl.setText("Job Grade Description ");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 2;
        gridBagConstraints.weightx = 1.0;
    ...
    private void newActionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_newActionActionPerformed
        try {
               ...
               java.sql.PreparedStatement checkDB=connectDB.prepareStatement("select grade_id from hr.hr_job_grade where grade_id='"+idNo.getText()+"' or grade_desc='"+roleorresponsibilityTxt.getText()+"'");
            ResultSet rs=checkDB.executeQuery();
            
            
            connectDB.setAutoCommit(false);
            java.sql.PreparedStatement pstmt = connectDB.prepareStatement("insert into hr.hr_job_grade(grade_id,grade_desc) values(?,?)");
            pstmt.setObject(1,idNo.getText());
            pstmt.setObject(2,roleorresponsibilityTxt.getText());
            if(rs.next()){
               javax.swing.JOptionPane.showMessageDialog(this, "Job Grade already exists","Operation failed",javax.swing.JOptionPane.INFORMATION_MESSAGE);  
            }else if(idNo.getText().equals("") || roleorresponsibilityTxt.getText().equals("") ){
                javax.swing.JOptionPane.showMessageDialog(this,"Please fill in all fields. ","Operation Failed",javax.swing.JOptionPane.INFORMATION_MESSAGE);
            }else{
            pstmt.executeUpdate();
            connectDB.commit();
