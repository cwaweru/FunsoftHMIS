...
public class JobDescription implements java.lang.Runnable {
    ...
    public void JD(java.sql.Connection connDb, String staff) {
        //public void OutstOrdersPdf(java.sql.Connection connDb) {
        
        connectDB = connDb;
        this.SearchText = staff;
            ...
            try {
                ...
                try {
                    ...
                    try{
                        ...
                        java.sql.ResultSet rset = st2.executeQuery("select * from hr.hr_job_descriptions left join hr.hr_staff_job_description on hr.hr_job_descriptions.job_description_id=hr.hr_staff_job_description.job_description_id left join hr.hr_staffresume_fileinfo on hr.hr_staffresume_fileinfo.staff_id=hr.hr_staff_job_description.staff_id where hr.hr_staff_job_description.staff_id='"+this.SearchText+"'"); 
                       int counter=1;
                        while (rset.next()) {
                    ...
                    int headerwidths[] = {10,20,40,10,20};
                    ...
                    Phrase phrase = new Phrase("JOB DESCRIPTION");
                   ...
                   phrase = new Phrase("JOB TITLE: "+rset.getObject(3));
                   table.addCell(phrase);
                   
                   table.getDefaultCell().setColspan(3);
                    //table.getDefaultCell().setBorderColor(java.awt.Color.WHITE);
                    table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_CENTER);
                   phrase = new Phrase("JOB GROUP "+rset.getObject(12));
                   table.addCell(phrase);
                   ...
                   // table.getDefaultCell().setBorderColor(java.awt.Color.WHITE);
                    //table.getDefaultCell().setBackgroundColor(java.awt.Color.LIGHT_GRAY);
                    phrase = new Phrase("NAME: "+rset.getObject(19)+" "+rset.getObject(20)+" "+rset.getObject(21));
                    table.addCell(phrase);
                   ...
                   counter++;
                          ...
                          table.getDefaultCell().setColspan(3);
                            ...
                            table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                            Phrase dept = new Phrase(dbObject.getDBObject(rset.getObject(2), "-"));
                          table.addCell(dept);
                           ...
                           table.getDefaultCell().setColspan(2);
                            ...
                            table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                            phrase = new Phrase("REPORTING TO ");
                          table.addCell(phrase);
                          
                          table.getDefaultCell().setColspan(3);
                             table.getDefaultCell().setBackgroundColor(java.awt.Color.WHITE);
                            table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                            Phrase reportTO = new Phrase(dbObject.getDBObject(rset.getObject(10), "-"));
                          table.addCell(reportTO);
                          ...
                          //////////////////////////////
                            ...
                            table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                            phrase = new Phrase("JOB PURPOSE");
                          table.addCell(phrase);
                          table.getDefaultCell().setBackgroundColor(java.awt.Color.WHITE);
                          table.getDefaultCell().setColspan(3);
                            
                            table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                            Phrase jp = new Phrase(dbObject.getDBObject(rset.getObject(5), "-"));
                          table.addCell(jp);
                           ...
                           table.getDefaultCell().setColspan(2);
                            ...
                            table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                            phrase = new Phrase("RESPONSIBILITIES ");
                          table.addCell(phrase);
                          
                          table.getDefaultCell().setColspan(3);
                            table.getDefaultCell().setBackgroundColor(java.awt.Color.WHITE);
                            table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                            Phrase resp = new Phrase(dbObject.getDBObject(rset.getObject(6), "-"));
                          table.addCell(resp);
                          ...
                          //////////////////////////////
                            ...
                            table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                            phrase = new Phrase("MINIMUM REQUIREMENTS");
                          table.addCell(phrase);
                          table.getDefaultCell().setBackgroundColor(java.awt.Color.WHITE);
                          table.getDefaultCell().setColspan(3);
                            
                            table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                            Phrase minr = new Phrase(dbObject.getDBObject(rset.getObject(7), "-"));
                          table.addCell(minr);
                           ...
                           table.getDefaultCell().setColspan(2);
                            ...
                            table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                            phrase = new Phrase("SKILLS AND COMPETENCIES ");
                          table.addCell(phrase);
                          table.getDefaultCell().setColspan(3);
                             table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                            phrase = new Phrase("PERFORMANCE INDICATORS ");
                          table.addCell(phrase);
                          
                          table.getDefaultCell().setColspan(2);
                            table.getDefaultCell().setBackgroundColor(java.awt.Color.WHITE);
                            table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                            Phrase skills = new Phrase(dbObject.getDBObject(rset.getObject(8), "-"));
                          table.addCell(skills);
                          
                          table.getDefaultCell().setColspan(3);
                            table.getDefaultCell().setBackgroundColor(java.awt.Color.WHITE);
                            table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                            Phrase kpi = new Phrase(dbObject.getDBObject(rset.getObject(9), "-"));
                          table.addCell(kpi);
