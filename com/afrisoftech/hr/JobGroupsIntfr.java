...
public class JobGroupsIntfr extends javax.swing.JInternalFrame {
    ...
    public JobGroupsIntfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
       ...
       // jPanel4.setBorder(new javax.swing.border.TitledBorder("Select Education Level"));
        ...
        setTitle("Job Group ");
        departmentsCbx.addItem("Select the Combo box");
        
        departmentsCbx.setModel(new org.netbeans.lib.sql.models.ComboBoxModel (nBCachedRowSet1, "job_family", null, null, null));
