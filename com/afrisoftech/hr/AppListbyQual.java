...
public class AppListbyQual implements java.lang.Runnable {
      ...
      */
                ...
                "FunSoft Human Resources Management Systems                         Printed On: "+date+"               Page:",pFontHeader2), true);// FontFactory.getFont(com.lowagie.text.FontFactory.HELVETICA, 12, Font.BOLDITALIC,java.awt.Color.blue));
                    ...
                    try {
                        ...
                        phrase = new Phrase(dept + " Applicants " , pFontHeader3);
                        ...
                        phrase = new Phrase("Education Level",pFontHeader);
                        table.addCell(phrase);
                    ...
                    table.getDefaultCell().setBorderColor(java.awt.Color.WHITE);
                        try {
                            ...
                            for (int j = 0; j < listofStaffNos.length; j++) {
                                ...
                                java.sql.ResultSet rset1 = st1.executeQuery("select app_id,initcap(fname||' '||sname||' '||others) AS staff_names,gender,app_position from  hr.hr_appresume_basic where app_id = '"+listofStaffNos[j]+"'");
                                java.sql.ResultSet rset2 = st2.executeQuery("select edu_level,app_position from hr.hr_appresume_basic where app_id = '"+listofStaffNos[j]+"'");
                                
                                System.out.println("select app_id,initcap(fname||' '||sname||' '||others) AS staff_names,gender,app_position from  hr.hr_appresume_basic where app_id = '"+listofStaffNos[j]+"'");
...
docPdf.close();  com.afrisoftech.lib.PDFRenderer.renderPDF(tempFile);
    ...
    public java.lang.Object[] getListofStaffNos() {
        ...
        try {
            ...
            java.sql.ResultSet rSet1 = stmt1.executeQuery("SELECT distinct app_id from hr.hr_appresume_basic WHERE edu_level ILIKE  initcap('"+dept+"%')");
            System.out.println("SELECT distinct edu_level from hr.hr_appresume_basic WHERE edu_level ILIKE  initcap('"+dept+"%')");
