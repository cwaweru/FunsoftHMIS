...
public class SectionsIntfr extends javax.swing.JInternalFrame {
    ...
    public SectionsIntfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
        ...
        initComponents();
        nBCachedRowSet1.setCommand("SELECT distinct initcap(depart_name) as name from pb_main_department order by name");
    ...
    private void initComponents() {
        ...
        roleorresponsiblityLbl.setText("Section Name");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 1;
        gridBagConstraints.weightx = 1.0;
        ...
        jLabel3.setText("Department/Unit");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 3;
        fieldsPanel.add(jLabel3, gridBagConstraints);

        deptcbx.setModel(com.afrisoftech.lib.ComboBoxModel.ComboBoxModel(connectDB, "SELECT DISTINCT depart_name FROM pb_main_department ORDER BY 1")
        );
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 3;
    ...
    private void newActionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_newActionActionPerformed
        try {
            ...
            java.sql.PreparedStatement pstmt = connectDB.prepareStatement("insert into hr.hr_sections (section_id,section,dept) values(?,?,?)");
