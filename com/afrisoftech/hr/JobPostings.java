...
public class JobPostings implements java.lang.Runnable {
    ...
    public void ApplicationList(java.sql.Connection connDb) {
            ...
            try {
                ...
                try {
                    ...
                    try{
                        ...
                        java.sql.ResultSet rset = st2.executeQuery("select reference_no,initcap(title) AS title,job_group,no_of_pos,purpose,type,expiry_date,posting_date,key_responsibilities,qualifications from hr.hr_job_requisition"); 
                       int counter=1;
                        while (rset.next()) {
                 ...
                 //   phrase = new Phrase("Job Postings " , pFontHeader3);
                    ...
                    table.getDefaultCell().setBorderColor(java.awt.Color.WHITE);
                    //table.getDefaultCell().setBackgroundColor(java.awt.Color.LIGHT_GRAY);
                    phrase = new Phrase(counter+". "+dbObject.getDBObject(rset.getObject(2),"-"),pFontHeader3);
                    table.addCell(phrase);
                   ...
                   counter++;
                          ...
                          table.getDefaultCell().setColspan(1);
                            ...
                            table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                            Phrase referenceNo = new Phrase(dbObject.getDBObject(rset.getObject(1), "-"));
                          table.addCell(referenceNo);
                           ...
                           table.getDefaultCell().setColspan(2);
                            ...
                            table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                            phrase = new Phrase("Job Group:");
                          table.addCell(phrase);
                          
                          table.getDefaultCell().setColspan(1);
                            
                            table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                            Phrase jobGroup = new Phrase(dbObject.getDBObject(rset.getObject(3), "-"));
                          table.addCell(jobGroup);
                          ...
                          table.getDefaultCell().setColspan(1);
                            ...
                            table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                            phrase = new Phrase(dbObject.getDBObject(rset.getObject(4), "-"));
                            ...
                            table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                            phrase = new Phrase(dbObject.getDBObject(rset.getObject(6), "-"));
                            ...
                            table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                            phrase = new Phrase("Job Purpose ",pFontHeader3);
                       table.addCell(phrase);
                       ...
                       table.addCell(phrase);
                             ...
                             table.getDefaultCell().setBorderColor(java.awt.Color.WHITE);
                            table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                            phrase = new Phrase(dbObject.getDBObject(rset.getObject(5), "-"));
 ...
 ///////////////////////////////////////////////
                       ...
                       table.addCell(phrase);
                         ...
                         System.out.println("This is what we are trying to print"+dbObject.getDBObject(rset.getObject(8),"-"));
                       
                       
                       if(!dbObject.getDBObject(rset.getObject(9), "-").equals("-")){
                                      table.getDefaultCell().setColspan(5);
                            
                            table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                            phrase = new Phrase("Key Responsibilities ",pFontHeader3);
                       table.addCell(phrase);
                          table.getDefaultCell().setColspan(5);
                       ...
                       table.addCell(phrase);
                            ...
                            if(!dbObject.getDBObject(rset.getObject(10), "-").equals("-")){
                                     table.getDefaultCell().setColspan(5);
