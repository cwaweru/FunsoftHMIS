...
public class JobGroupClassificationListPdf111 implements java.lang.Runnable {
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    phrase = new Phrase("Jobs Titles Available  " , pFontHeader3);
                    ...
                    phrase = new Phrase("Job ID",pFontHeader1);
                    table.addCell(phrase);
                    
                    phrase = new Phrase("Department",pFontHeader1);
                    table.addCell(phrase);
                    
                    phrase = new Phrase("Job Title",pFontHeader1);
                    table.addCell(phrase);
                    ...
                    try{
                        ...
                        java.sql.ResultSet rset = st2.executeQuery("Select hr.hr_job_descriptions.job_id,hr.hr_job_descriptions.department,hr.hr_job_descriptions.job_title,hr.hr_job_descriptions.sections from hr.hr_job_descriptions");
