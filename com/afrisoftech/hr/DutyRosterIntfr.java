 ...
 * @author afro
 */
public class DutyRosterIntfr extends javax.swing.JInternalFrame {
     ...
     */
    public DutyRosterIntfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {
        ...
        dutyAllocationTable = new com.afrisoftech.dbadmin.JTable();
        ...
        setMaximizable(true);
        setResizable(true);
        setTitle("Staff Acheduling and Duty  Roster Management");
        try {
            setSelected(true);
        ...
        datePanel.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Select the Duty Rota Date", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(255, 0, 0))); // NOI18N
        ...
        dateLbl.setText("Duty Rota Start Date");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 0;
        gridBagConstraints.weightx = 1.0;
        ...
        buttonsPanel.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Save & Print Buttons ", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(0, 0, 204))); // NOI18N
        ...
        while(r2<r){
            try {
                ...
                for(int tempCount=0; tempCount<14; tempCount++){
                    ...
                    stmt3.execute("UPDATE hr.hr_duty_assignment" +
                                    "   SET duty = '"+value+"', duty_division = '"+divisionCmbx.getSelectedItem()+"', " +
                                    "       duty_department = '"+departmentCmbx.getSelectedItem()+"', " +
                                    "       duty_section = '"+sectionCmbx.getSelectedItem()+"', " +
                ...
                Logger.getLogger(DutyRosterIntfr.class.getName()).log(Level.SEVERE, null, ex);
            }
                r2++;
            }

        JOptionPane.showMessageDialog(null, "Duty Rota Created and Saved Successfully!", 
                "Duty Rota Created.", JOptionPane.INFORMATION_MESSAGE);
...
//            headers[a]=sdf3.format("%tl:%tM", cal.getTime(), cal.getTime()).toString();
//            times.add(sdf3.format("%tl:%tM", cal.getTime(), cal.getTime()).toString());
//
//            System.out.println("Headers["+a+"] - "+headers[a]+" Time - "+sdf3);
//         }
         
         
         try {
                String sql = "SELECT initcap(first_name) || ' '|| initcap(middle_name) || ' '|| initcap(last_name) AS employee_name, "
                                + "employee_no FROM master_file WHERE unit_division = '"+divisionCmbx.getSelectedItem()+"' "
                ...
                while (rs.next()) {
                    ...
                    int i=1;
                     do{
                        ...
                        String sql2="SELECT duty FROM hr.hr_duty_assignment "
                                + "WHERE staffid = '"+rs.getString("employee_no")+"' "
                                + "AND date_assigned = '"+sdf2.format(cal2.getTime())+"' "
                                + "AND duty_division='"+divisionCmbx.getSelectedItem()+"' "
                        ...
                        if(rs2.getRow() > 0){
                            ...
                            Statement stmt3 = connectDB.createStatement();
                            stmt3.execute( "INSERT INTO hr.hr_duty_assignment (staffid, duty, duty_division, duty_department, duty_section, "
                ...
                String sql2 = "SELECT duty_code FROM hr.hr_duty_setup "
                ...
                if(rs2.getRow()>0){
                    rs2.beforeFirst();
                    while(rs2.next()){
                        cbx.addItem(rs2.getString("duty_code"));
                    }
                }
    ...
    private void PrintDutyRoster() {
        com.afrisoftech.reports.HRDutyRostertPdf.connectDB = connectDB;
            com.afrisoftech.reports.HRDutyRostertPdf regForm = new com.afrisoftech.reports.HRDutyRostertPdf();
