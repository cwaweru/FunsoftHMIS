...
public class HRCompNameIntfr extends javax.swing.JInternalFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
                     java.sql.PreparedStatement pstmt = connectDB.prepareStatement("insert into hr.hr_period_setup(company_name,short_name,period_from,period_to) values(?,?,?::date,?::date)");
            //pstmt.setString(1,);
          ...
          if(jTextField2.getText().equals("")){
           ...
           //   Date from = java.sql.Date.valueOf(datePicker1.getDate().toString());
               
        //   Date to = java.sql.Date.valueOf(datePicker2.getDate().toString());
            ...
            jLabel3.setText("Sorry. Insert not Successful");
              ...
              jLabel3.setForeground(java.awt.Color.red);
            jLabel3.setText("An error ocurred. Insert not Successful");
