...
public class JobDesignationIntfr extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        departmentscbx.addItemListener(new java.awt.event.ItemListener() {
            public void itemStateChanged(java.awt.event.ItemEvent evt) {
                departmentscbxItemStateChanged(evt);
            }
        });
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridy = 1;
    ...
    private void departmentscbxItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_departmentscbxItemStateChanged
        // TODO add your handling code here:
        
        nBCachedRowSet2.setCommand("Select section  as name from hr.hr_sections where dept ='"+departmentscbx.getSelectedItem()+"'");
        nBCachedRowSet2.setConnectionSource(pConnDB);
       // jPanel4.setBorder(new javax.swing.border.TitledBorder("Select Education Level"));
        ...
        sectionscbx1.setModel(new org.netbeans.lib.sql.models.ComboBoxModel (nBCachedRowSet2, "name", null, null, null));

    }//GEN-LAST:event_departmentscbxItemStateChanged
