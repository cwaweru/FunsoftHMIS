...
public class CompanyProfIntfr extends javax.swing.JInternalFrame implements java.lang.Runnable {
    ...
    public CompanyProfIntfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
        ...
        initComponents();
        rset1.setCommand("select DISTINCT country_name from hr.hr_country order by country_name");
        ...
        rset2.setCommand("select DISTINCT county_name from hr.hr_districts order by county_name");
        rset2.setConnectionSource(pConnDB);
        jComboBox2.setModel(new org.netbeans.lib.sql.models.ComboBoxModel (rset2, "county_name", null, null, null));
        jComboBox3.addItem("Limited Liability");
...
//      jTextField582.setText("");
    ...
    private void jButton301ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton301ActionPerformed
        ...
        try {
            ...
            java.sql.PreparedStatement pstmt = connectDB.prepareStatement("insert into hr.hr_company_profile values( ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?::date,?,?,?::date,?::numeric,?::numeric,?::numeric,?)");
            //pstmt.setInt(1,5);
        ...
        pstmt.setString(3,jComboBox1.getSelectedItem().toString());
          pstmt.setString(4,jComboBox2.getSelectedItem().toString());
            ...
            pstmt.setString(26,datePicker2.getDate().toString());
            pstmt.setString(27,jTextField11.getText());
            pstmt.setString(28,jTextField7.getText());
           pstmt.setString(29,datePicker1.getDate().toString());
