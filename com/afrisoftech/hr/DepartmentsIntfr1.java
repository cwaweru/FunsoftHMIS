 ...
 * @author  postgres
 */
public class DepartmentsIntfr1 extends javax.swing.JInternalFrame {
    ...
    public DepartmentsIntfr1(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
        ...
        initComponents();
        nBCachedRowSet1.setCommand("SELECT distinct initcap(donor) as name from ac_branch order by 1");
       ...
       // jLabel4.setText("Get Applicants by education Level");
        //  setTitle("Applicants");
           deptcbx.setModel(new org.netbeans.lib.sql.models.ComboBoxModel (nBCachedRowSet1, "name", null, null, null));
    }
    ...
    private void initComponents() {
        ...
        deptcbx = new javax.swing.JComboBox();
        ...
        jLabel1.setText("Please register your Department/Unit here");
        ...
        idNoLbl.setText("Department/Unit No.");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
        ...
        roleorresponsiblityLbl.setText("Name");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 1;
        gridBagConstraints.weightx = 1.0;
        ...
        fieldsPanel.add(deptcbx, gridBagConstraints);
        ...
        typecbx.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Department", "Unit" }));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 4;
        gridBagConstraints.weighty = 2.0;
        fieldsPanel.add(typecbx, gridBagConstraints);
    ...
    private void newActionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_newActionActionPerformed
        try {
            ...
            java.sql.PreparedStatement pstmt = connectDB.prepareStatement("insert into hr.hr_department (department_id,department_name,remarks,type) values(?,?,?,?)");
            pstmt.setObject(1,idNo.getText());
            pstmt.setObject(2,roleorresponsibilityTxt.getText());
           pstmt.setString(3,deptcbx.getSelectedItem().toString());
            pstmt.setString(4,typecbx.getSelectedItem().toString());
            pstmt.executeUpdate();
            ...
            javax.swing.JOptionPane.showMessageDialog(this, "The Department/Unit Already Exists","Error Message!",javax.swing.JOptionPane.ERROR_MESSAGE);
            try {
                connectDB.rollback();
    ...
    private javax.swing.JComboBox deptcbx;
