 ...
 * @author  root
 */
public class TypeOfLeaveReport extends javax.swing.JDialog {
    ...
    public TypeOfLeaveReport(java.awt.Frame parent, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB, boolean modal, int repName, java.sql.Connection connectDb) {
    ...
    private void initComponents() {
        ...
        typeOfLeavePanel = new javax.swing.JPanel();
        typeOfLeaveLabel = new javax.swing.JLabel();
        typeOfLeaveCmbx = new javax.swing.JComboBox();

        setTitle("Type Of Leave Report - (Select Beginning and End Date)");
        ...
        typeOfLeavePanel.setBorder(javax.swing.BorderFactory.createTitledBorder("Select the Type Of Leave Here"));
        typeOfLeavePanel.setLayout(new java.awt.GridBagLayout());
        ...
        gridBagConstraints.weighty = 1.0;
        gridBagConstraints.insets = new java.awt.Insets(10, 10, 0, 0);
        typeOfLeavePanel.add(typeOfLeaveLabel, gridBagConstraints);

        typeOfLeaveCmbx.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                typeOfLeaveCmbxActionPerformed(evt);
            }
        });
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        ...
        gridBagConstraints.weighty = 1.0;
        gridBagConstraints.insets = new java.awt.Insets(10, 0, 0, 10);
        typeOfLeavePanel.add(typeOfLeaveCmbx, gridBagConstraints);
        ...
        gridBagConstraints.weighty = 1.0;
        gridBagConstraints.insets = new java.awt.Insets(5, 5, 5, 5);
        getContentPane().add(typeOfLeavePanel, gridBagConstraints);

        setSize(new java.awt.Dimension(760, 474));
    ...
    private void typeOfLeaveCmbxActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_typeOfLeaveCmbxActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_typeOfLeaveCmbxActionPerformed
        ...
        switch (reportName) {
            case 7: {
                if (divisionChkBx.isSelected() && departmentChckBox.isSelected() && sectionChckBox.isSelected()) {
                    ...
                    com.afrisoftech.reports.TypeOfLeaveTakenDivDepSecReportPdf policyOne = new com.afrisoftech.reports.TypeOfLeaveTakenDivDepSecReportPdf();
                
                    policyOne.LeaveTakenDetailsPdf(connectDB, this.beginDatePicker.getDate(), this.endDatePicker.getDate(), 
                            divisionCmbx.getSelectedItem().toString(), departmentCmbx.getSelectedItem().toString(), 
                            sectionCbx.getSelectedItem().toString(), typeOfLeaveCmbx.getSelectedItem().toString());

                    this.dispose();
                } else if (divisionChkBx.isSelected() && departmentChckBox.isSelected()) {
                    System.out.println("Both the Division and Department have been Selected.");
                    com.afrisoftech.reports.TypeOfLeaveTakenDivDepReportPdf policyOne = new com.afrisoftech.reports.TypeOfLeaveTakenDivDepReportPdf();
                
                    policyOne.LeaveTakenDetailsPdf(connectDB, this.beginDatePicker.getDate(), this.endDatePicker.getDate(), 
                            divisionCmbx.getSelectedItem().toString(), departmentCmbx.getSelectedItem().toString(),
                            typeOfLeaveCmbx.getSelectedItem().toString());

                    this.dispose();
                } else if (divisionChkBx.isSelected() && sectionChckBox.isSelected()) {
                    System.out.println("Both the Division and Section have been Selected.");
                    com.afrisoftech.reports.TypeOfLeaveTakenDivSecReportPdf policyOne = new com.afrisoftech.reports.TypeOfLeaveTakenDivSecReportPdf();
                    ...
                    System.out.println("Both the Department and Section have been Selected.");
                    com.afrisoftech.reports.TypeOfLeaveTakenDepSecReportPdf policyOne = new com.afrisoftech.reports.TypeOfLeaveTakenDepSecReportPdf();
                    ...
                    com.afrisoftech.reports.TypeOfLeaveTakenDivisionReportPdf policyTwo = new com.afrisoftech.reports.TypeOfLeaveTakenDivisionReportPdf();
                
                    policyTwo.LeaveTakenDetailsPdf(connectDB, this.beginDatePicker.getDate(), this.endDatePicker.getDate(), 
                    ...
                    com.afrisoftech.reports.TypeOfLeaveTakenDepartmentReportPdf policyTwo = new com.afrisoftech.reports.TypeOfLeaveTakenDepartmentReportPdf();
                    ...
                    com.afrisoftech.reports.TypeOfLeaveTakenSectionReportPdf policyThree = new com.afrisoftech.reports.TypeOfLeaveTakenSectionReportPdf();
                
                    policyThree.LeaveTakenDetailsPdf(connectDB, this.beginDatePicker.getDate(), this.endDatePicker.getDate(), 
    ...
    private void populateCmbox() {
        typeOfLeaveCmbx.setModel(com.afrisoftech.lib.ComboBoxModel.ComboBoxModel(connectDB, "SELECT DISTINCT leave_type FROM hr.hr_leave_type "
                + "ORDER BY leave_type"));
        typeOfLeaveCmbx.addActionListener(new java.awt.event.ActionListener() {
    ...
    private javax.swing.JComboBox typeOfLeaveCmbx;
    private javax.swing.JLabel typeOfLeaveLabel;
    private javax.swing.JPanel typeOfLeavePanel;
