...
public class ApplicationList implements java.lang.Runnable {
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    phrase = new Phrase("Job Applications List  " , pFontHeader3);
                    ...
                    phrase = new Phrase("Application No",pFontHeader1);
                    table.addCell(phrase);
                    ...
                    table.addCell(phrase);
                    phrase = new Phrase("Position",pFontHeader1);
                    table.addCell(phrase);
                    ...
                    try{
                        ...
                        java.sql.ResultSet rset = st2.executeQuery("select app_id,initcap(sname||' '||fname||' '||others) AS staff_names,gender,birth_date,app_position from hr.hr_appresume_basic");
